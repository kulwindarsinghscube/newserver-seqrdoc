...
<div class="container">
	<div class="container-fluid">
        ...
        <div class="row">
            ...
            <form method="post" id="processExcelForm" class="form-horizontal" enctype="multipart/form-data" action="<?=route('newrrmu-certificate.uploadfile')?>">
...
function uploadfile(){
	...
	$.ajax({
		url:'<?= route('newrrmu-certificate.uploadfile')?>',
	    type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,

    ...
    public function build()
    {
        ...
        $subdomain = explode('.', $domain);
                ...
                if($subdomain[0] == 'galgotias')
                {
                    ...
                    return $this->view('verify.login_otp_mail_galgotias')
                    //->cc('rushik994@gmail.com')
                    //->bcc('rushik994@gmail.com')
                    ->with([ 'fullname' => $this->data['fullname'],'OTP' => $this->data['OTP']]);
                   
                }elseif($subdomain[0] == 'monad'||$subdomain[0] == 'demo'){
                     return $this->view('verify.login_otp_mail_monad')
                    ->with([ 'fullname' => $this->data['fullname'],'OTP' => $this->data['OTP']]);
                    
                }else{
                    
                     return $this->view('verify.login_otp_mail')
                    ->with([ 'fullname' => $this->data['fullname'],'OTP' => $this->data['OTP']]);
                }

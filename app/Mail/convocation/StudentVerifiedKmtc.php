...
class StudentVerifiedKmtc extends Mailable
{
    ...
    {
        $email = $this->subject('KMTC - Login Credentials for Convocation Registration | PRN NO :'.@$this->student['prn'])
                    ->view('convodataverification.emails.registration_kmtc')
                    ->with([
        ...
        // $email->attach(public_path().'/demo/SSL STUDENT SUPPORT MANUAL - V1.0_10-09-2024.pdf', [

...
class PdfGenerateSuranaJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        // Start Update code for batchwise genration
            ...
            // \Log::debug("pdfbig",["pdfBig"=>$pdfBig]);
        ...
        foreach ($studentDataOrg as $studentData) {
            ...
            if($studentData[$Photo_key]!=''){
                ...
                try{
                    ...
                    // dd($profile_path_org, $uv_location);
                }
            ...
            $pdfBig->MultiCell(75, 114.5, '', 'LRTB', 'C', 0, 0); //Marks
            $pdfBig->MultiCell(8, 114.5, '', 'LRTB', 'C', 0, 0); //GRADE POINTS
            $pdfBig->MultiCell(8, 114.5, '', 'LRTB', 'C', 0, 0); //CREDITS ASSIGNED
            $pdfBig->MultiCell(7, 114.5, '', 'LRTB', 'C', 0, 0); //CREDIT POINTS
            $pdfBig->MultiCell(15, 114.5, '', 'LRTB', 'C', 0, 0); //REMARKS
			...
			$pdfBig->MultiCell(65, 0, 'REMARKS', 0, 'L', 0, 0, 180.5, 85, true, 0, true); //REMARKS
			...
			$pdfBig->MultiCell(28, 104.5, '','TR', 'L', 0, 0); //Course Total
			...
			$pdfBig->MultiCell(7, 97, '','TR', 'L', 0, 0); //Min
			$pdfBig->MultiCell(13, 97, '','TR', 'L', 0, 0); //Secured
			$pdfBig->MultiCell(7.5, 0, 'MAX',0, 'L', 0, 0, 129.5, 94.5, true, 0, true); //Max
			$pdfBig->MultiCell(7.5, 0, 'MIN',0, 'L', 0, 0, 137.5, 94.5, true, 0, true); //Min
			$pdfBig->MultiCell(14, 0, 'SECURED',0, 'L', 0, 0, 143.8, 94.5, true, 0, true); //Secured
			//end pdfBig
            //start pdf
            $pdf->SetXY(15, 75.5);
            ...
            $pdf->MultiCell(75, 114.5, '', 'LRTB', 'C', 0, 0); //Marks
            $pdf->MultiCell(8, 114.5, '', 'LRTB', 'C', 0, 0); //GRADE POINTS
            $pdf->MultiCell(8, 114.5, '', 'LRTB', 'C', 0, 0); //CREDITS ASSIGNED
            $pdf->MultiCell(7, 114.5, '', 'LRTB', 'C', 0, 0); //CREDIT POINTS
            $pdf->MultiCell(15, 114.5, '', 'LRTB', 'C', 0, 0); //REMARKS
			...
			$pdf->MultiCell(65, 0, 'REMARKS', 0, 'L', 0, 0, 178, 85, true, 0, true); //REMARKS
			...
			$pdf->MultiCell(28, 104.5, '','TR', 'L', 0, 0); //Course Total
            ...
            foreach ($subjectsArr as $subjectDatas){
                ...
                $pdfBig->MultiCell(8, 11, $TP_Min,0, 'C', 0, 0, 90, $subj_y);
                ...
                $pdfBig->MultiCell(8, 11, $CT_Min,0, 'C', 0, 0, 136, $subj_y);
                $pdfBig->MultiCell(11, 11, $CT_Sec,0, 'C', 0, 0, 144, $subj_y);				
				$pdfBig->MultiCell(8, 11, $Grade_Points,0, 'C', 0, 0, 156.5, $subj_y);
				$pdfBig->MultiCell(8, 11, $credits_Assigned,0, 'C', 0, 0, 164.5, $subj_y);
				$pdfBig->MultiCell(8, 11, $Credit_Points,0, 'C', 0, 0, 172.5, $subj_y);
				$pdfBig->MultiCell(19, 11, $Remark,0, 'C', 0, 0, 177.5, $subj_y);
                ...
                $pdf->MultiCell(8, 11, $CT_Min,0, 'C', 0, 0, 136, $subj_y);
                $pdf->MultiCell(11, 11, $CT_Sec,0, 'C', 0, 0, 144, $subj_y);				
				$pdf->MultiCell(8, 11, $Grade_Points,0, 'C', 0, 0, 156.5, $subj_y);
				$pdf->MultiCell(8, 11, $credits_Assigned,0, 'C', 0, 0, 164.5, $subj_y);
				$pdf->MultiCell(8, 11, $Credit_Points,0, 'C', 0, 0, 172.5, $subj_y);
				$pdf->MultiCell(19, 11, $Remark,0, 'C', 0, 0, 177.5, $subj_y);  				
			...
			$pdfBig->MultiCell(8, 11, '',0, 'C', 0, 0);
			$pdfBig->MultiCell(12, 11, '',0, 'C', 0, 0);				
			$pdfBig->MultiCell(7.8, 11, $GrandTotal_CT_Max,0, 'C', 0, 0);
			$pdfBig->MultiCell(8, 11, $GrandTotal_CT_Min,0, 'C', 0, 0);
			$pdfBig->MultiCell(12.2, 11, $GrandTotal_CT_Sec,0, 'C', 0, 0);				
			$pdfBig->MultiCell(8, 11, $GrandTotal_GP,0, 'C', 0, 0);
			$pdfBig->MultiCell(8, 11, $GrandTotal_CA,0, 'C', 0, 0);
			$pdfBig->MultiCell(8, 11, $GrandTotal_CP,0, 'C', 0, 0);
			...
			$pdfBig->SetFont($arialNarrowB, '', 8, '', false); 
			$pdfBig->SetXY(15, 192); 
			$pdfBig->Cell(180, 0, 'GRAND TOTAL MARKS SECURED '.$this->getNumberWords((float)$GrandTotal_CT_Sec), 'LRB', $ln=0, 'L', 0, '', 0, false, 'C', 'C');
			...
			$pdfBig->MultiCell(36, 6, 'Alpha-Sign Grade', 1, 'C', 0, 0);
			$pdfBig->MultiCell(36, 6, 'Credits Earned', 1, 'C', 0, 0);
			$pdfBig->MultiCell(36, 6, 'Program % age of Marks', 1, 'C', 0, 0);
			$pdfBig->MultiCell(36, 6, 'Class Description', 1, 'C', 0, 0);
			...
			$pdf->MultiCell(8, 11, '',0, 'C', 0, 0);
			$pdf->MultiCell(12.5, 11, '',0, 'C', 0, 0);				
			$pdf->MultiCell(7.8, 11, $GrandTotal_CT_Max,0, 'C', 0, 0);
			$pdf->MultiCell(8, 11, $GrandTotal_CT_Min,0, 'C', 0, 0);
			$pdf->MultiCell(12.2, 11, $GrandTotal_CT_Sec,0, 'C', 0, 0);				
			$pdf->MultiCell(8, 11, $GrandTotal_GP,0, 'C', 0, 0);
			$pdf->MultiCell(8, 11, $GrandTotal_CA,0, 'C', 0, 0);
			$pdf->MultiCell(8, 11, $GrandTotal_CP,0, 'C', 0, 0);
			...
			$pdf->SetFont($arialNarrowB, '', 8, '', false); 
			$pdf->SetXY(15, 192); 
			$pdf->Cell(180, 0, 'GRAND TOTAL MARKS SECURED '.$this->getNumberWords((float)$GrandTotal_CT_Sec), 'LRB', $ln=0, 'L', 0, '', 0, false, 'C', 'C');
			...
			$pdf->MultiCell(36, 6, 'Alpha-Sign Grade', 1, 'C', 0, 0);
			$pdf->MultiCell(36, 6, 'Credits Earned', 1, 'C', 0, 0);
			$pdf->MultiCell(36, 6, 'Program % age of Marks', 1, 'C', 0, 0);
			$pdf->MultiCell(36, 6, 'Class Description', 1, 'C', 0, 0);
			$pdf->SetXY(15, 223.5); 
            ...
            $codeContents = "Name: ".$candidate_name."\nRegistration No.: ".$Registration_No."\nMonths & Year of Examination: ".$Month_Year_of_Examination."\n\n".$encryptedString;

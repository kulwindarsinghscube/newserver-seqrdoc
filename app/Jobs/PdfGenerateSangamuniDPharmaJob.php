...
class PdfGenerateSangamuniDPharmaJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        if($studentDataOrg&&!empty($studentDataOrg)){
            foreach ($studentDataOrg as $studentData) {
                ...
                $specialization = $studentData[6];
                $year = \PhpOffice\PhpSpreadsheet\Shared\Date::excelToDateTimeObject($studentData[7])->format('F, Y');
                $division = $studentData[8];
                $date = \PhpOffice\PhpSpreadsheet\Shared\Date::excelToDateTimeObject($studentData[9])->format('jS F, Y');
                ...
                $pdfBig->SetFont('Clearface', '', 18, '', false); 
                $pdfBig->setXY(10,178);
                $pdfBig->MultiCell(186, 4, "has passed the examination of", '', 'C', 0, 1);
                ...
                $pdfBig->SetFont('Clearface', '', 18, '', false); 
                $pdfBig->setXY(10, 209);
                $pdfBig->MultiCell(187, 4, "in testimony of his/her having successfully completed the\nprescribed programme in ". $year." \nsecuring ".$division."\nand awarded on ".$date."\nunder the seal of the Sangam University, Bhilwara", '', 'C', 0, 1);
                ...
                $pdf->SetFont('Clearface', '', 18, '', false); 
                $pdf->setXY(10,178);
                $pdf->MultiCell(186, 4, "has passed the examination of", '', 'C', 0, 1);
    			...
    			// get the number of lines
    			$linespdf = $pdf->MultiCell(186, 4, $degree, 0, 'C', 0, 0, '', '', true, 0, false,true, 0);
    			// restore previous object
                ...
                $pdf->SetFont('Clearface', '', 18, '', false); 
                $pdf->setXY(10, 209);
                $pdf->MultiCell(187, 4, "in testimony of his/her having successfully completed the\nprescribed programme in ". $year." \nsecuring ".$division."\nand awarded on ".$date."\nunder the seal of the Sangam University, Bhilwara", '', 'C', 0, 1);

...
class ValidateExcelSCUBEJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        if ($dropdown_template_id == 1) {
            if ($columnsCount1 == 74) {  // âœ… Fix here
                $columnArr = array(
                    "STUDENT NAME", "MOTHER NAME", "REGISTRATION NO", "UNIVERSITY ENROLLMENT NO", "TERM", "EXAMINATION", 
            "PROGRAMME", "DEPARTMENT", "EXAM REGISTRATION CREDITS", "EARN CREDITS", "GRADE POINTS EARNED", "SGPA", 
            "CUMULATIVE CREDITS", "CUMULATIVE EGP", "CGPA","PHOTO",

            "COURSE CODE", "COURSE NAME", "CREDITS", "GRADES",
            "COURSE CODE.1", "COURSE NAME.1", "CREDITS.1", "GRADES.1",
            "COURSE CODE.2", "COURSE NAME.2", "CREDITS.2", "GRADES.2",
            "COURSE CODE.4", "COURSE NAME.4", "CREDITS.4", "GRADES.4",
            "COURSE CODE.5", "COURSE NAME.5", "CREDITS.5", "GRADES.5",
            "COURSE CODE.6", "COURSE NAME.6", "CREDITS.6", "GRADES.6",
            "COURSE CODE.7", "COURSE NAME.7", "CREDITS.7", "GRADES.7",
            "COURSE CODE.8", "COURSE NAME.8", "CREDITS.8", "GRADES.8",
            "COURSE CODE.9", "COURSE NAME.9", "CREDITS.9", "GRADES.9",
            "COURSE CODE.10", "COURSE NAME.10", "CREDITS.10", "GRADES.10",
            "COURSE CODE.11", "COURSE NAME.11", "CREDITS.11", "GRADES.11",

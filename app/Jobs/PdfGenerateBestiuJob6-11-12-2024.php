...
class PdfGenerateBestiuJob6
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
			...
			$VII_SEM=trim($studentData[318]);
			$SEM7_COURSE_CODE_1=trim($studentData[319]);
			$SEM7_COURSE_TITLE_1=trim($studentData[320]);
			$SEM7_CREDIT_HOURS_1=trim($studentData[321]);
			$SEM7_GRADE_POINT_1=trim($studentData[322]);
			$SEM7_CREDIT_POINTS_1=trim($studentData[323]);
			$SEM7_COURSE_CODE_2=trim($studentData[324]);
			$SEM7_COURSE_TITLE_2=trim($studentData[325]);
			$SEM7_CREDIT_HOURS_2=trim($studentData[326]);
			$SEM7_GRADE_POINT_2=trim($studentData[327]);
			$SEM7_CREDIT_POINTS_2=trim($studentData[328]);
			$SEM7_COURSE_CODE_3=trim($studentData[329]);
			$SEM7_COURSE_TITLE_3=trim($studentData[330]);
			$SEM7_CREDIT_HOURS_3=trim($studentData[331]);
			$SEM7_GRADE_POINT_3=trim($studentData[332]);
			$SEM7_CREDIT_POINTS_3=trim($studentData[333]);
			$SEM7_COURSE_CODE_4=trim($studentData[334]);
			$SEM7_COURSE_TITLE_4=trim($studentData[335]);
			$SEM7_CREDIT_HOURS_4=trim($studentData[336]);
			$SEM7_GRADE_POINT_4=trim($studentData[337]);
			$SEM7_CREDIT_POINTS_4=trim($studentData[338]);
			$SEM7_COURSE_CODE_5=trim($studentData[339]);
			$SEM7_COURSE_TITLE_5=trim($studentData[340]);
			$SEM7_CREDIT_HOURS_5=trim($studentData[341]);
			$SEM7_GRADE_POINT_5=trim($studentData[342]);
			$SEM7_CREDIT_POINTS_5=trim($studentData[343]);
			$SEM7_COURSE_CODE_6=trim($studentData[344]);
			$SEM7_COURSE_TITLE_6=trim($studentData[345]);
			$SEM7_CREDIT_HOURS_6=trim($studentData[346]);
			$SEM7_GRADE_POINT_6=trim($studentData[347]);
			$SEM7_CREDIT_POINTS_6=trim($studentData[348]);
            $SEM7_COURSE_CODE_7=trim($studentData[349]);
			$SEM7_COURSE_TITLE_7=trim($studentData[350]);
			$SEM7_CREDIT_HOURS_7=trim($studentData[351]);
			$SEM7_GRADE_POINT_7=trim($studentData[352]);
			$SEM7_CREDIT_POINTS_7=trim($studentData[353]);	
            $SEM7_COURSE_CODE_8=trim($studentData[354]);
			$SEM7_COURSE_TITLE_8=trim($studentData[355]);
			$SEM7_CREDIT_HOURS_8=trim($studentData[356]);
			$SEM7_GRADE_POINT_8=trim($studentData[357]);
			$SEM7_CREDIT_POINTS_8=trim($studentData[358]);

			$VIII_SEM=trim($studentData[359]);
			$SEM8_COURSE_CODE_1=trim($studentData[360]);
			$SEM8_COURSE_TITLE_1=trim($studentData[361]);
			$SEM8_CREDIT_HOURS_1=trim($studentData[362]);
			$SEM8_GRADE_POINT_1=trim($studentData[363]);
			$SEM8_CREDIT_POINTS_1=trim($studentData[364]);
			$SEM8_COURSE_CODE_2=trim($studentData[365]);
			$SEM8_COURSE_TITLE_2=trim($studentData[366]);
			$SEM8_CREDIT_HOURS_2=trim($studentData[367]);
			$SEM8_GRADE_POINT_2=trim($studentData[368]);
			$SEM8_CREDIT_POINTS_2=trim($studentData[369]);
			$TOTAL_CREDITS_CREDIT_HOURS=trim($studentData[370]);
			$TOTAL_CREDITS_CREDIT_POINTS=trim($studentData[371]);
			$OVERALL_GRADE_POINT_AVERAGE=trim($studentData[372]);
			$DATE=trim($studentData[373]);
			$Photo=trim($studentData[374]);

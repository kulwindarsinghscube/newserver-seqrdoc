...
class PdfGenerateBiharEstampCertificateJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        // foreach ($studentDataOrg as $studentData) {
            ...
            $high_res_bg="biharestamp_blank.jpg"; 
            ...
            // }
                $fontSize = 10;
                $results = [
                    'Certificate No.' => $studentDataOrg['Certificate No.'], 
                    'Certificate Issued Date' => $studentDataOrg['Certificate Issued Date'],
                    'Account Reference' => $studentDataOrg['Account Reference'],
                    'Unique Doc. Reference' => $studentDataOrg['Unique Doc. Reference'],
                    'Purchased by' => $studentDataOrg['Purchased by'],
                    'Description of Document' => $studentDataOrg['Description of Document'],
                    'Property Description' => $studentDataOrg['Property Description'],
                    'Consideration Price (Rs.)' => $studentDataOrg['Consideration Price (Rs.)'],
                    'First Party' => $studentDataOrg['First Party'],
                    'Second Party' => $studentDataOrg['Second Party'],
                    'Stamp Duty Paid By' => $studentDataOrg['Stamp Duty Paid By'],
                    'Stamp Duty Paid (Rs.)' => $studentDataOrg['Stamp Duty Paid (Rs.)'],
                    'Reg. fee (Rs.)' => $studentDataOrg['Reg. fee (Rs.)'],
                    'LLR & P Fee (Rs.)' => $studentDataOrg['LLR & P Fee (Rs.)'],
                    'Miscellaneous Fee (Rs.)' => $studentDataOrg['Miscellaneous Fee (Rs.)'],
                    'Discore SC (Rs.)' => $studentDataOrg['Discore SC (Rs.)'],
                    'Total Amount (Rs.)' => $studentDataOrg['Total Amount (Rs.)'],
                    'Paper Number' => $studentDataOrg['Paper Number']
                ];
                $serial_no=$GUID=$studentDataOrg['Certificate No.'];
                $name = $studentDataOrg['Purchased by'];
                $certificateNo = $studentDataOrg['Certificate No.'];
                $dt = date("_ymdHis");
                $str=$certificateNo.$dt;
                    
                $encryptedString = strtoupper(md5($str));
               // $codeContents = "Purchased By: ".$name."\nCertificate No.: ".$certificateNo."\n\n".$encryptedString;

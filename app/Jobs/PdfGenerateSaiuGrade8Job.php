...
class PdfGenerateSaiuGrade8Job
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
            ...
            $SGPA_6 = trim($studentData[234]);
                    ...
                    $VII_SEMESTER = trim($studentData[235]);
            $COURSE_CODE_71 = trim($studentData[236]);
            $COURSE_71 = trim($studentData[237]);
            $CREDIT_71 = trim($studentData[238]);
            $GRADE_71 = trim($studentData[239]);
            $COURSE_CODE_72 = trim($studentData[240]);
            $COURSE_72 = trim($studentData[241]);
            $CREDIT_72 = trim($studentData[242]);
            $GRADE_72 = trim($studentData[243]);
            $COURSE_CODE_73 = trim($studentData[244]);
            $COURSE_73 = trim($studentData[245]);
            $CREDIT_73 = trim($studentData[246]);
            $GRADE_73 = trim($studentData[247]);
            $COURSE_CODE_74 = trim($studentData[248]);
            $COURSE_74 = trim($studentData[249]);
            $CREDIT_74 = trim($studentData[250]);
            $GRADE_74 = trim($studentData[251]);
            $COURSE_CODE_75 = trim($studentData[252]);
            $COURSE_75 = trim($studentData[253]);
            $CREDIT_75 = trim($studentData[254]);
            $GRADE_75 = trim($studentData[255]);
            $COURSE_CODE_76 = trim($studentData[256]);
            $COURSE_76 = trim($studentData[257]);
            $CREDIT_76 = trim($studentData[258]);
            $GRADE_76 = trim($studentData[259]);
            $COURSE_CODE_77 = trim($studentData[260]);
            $COURSE_77 = trim($studentData[261]);
            $CREDIT_77 = trim($studentData[262]);
            $GRADE_77 = trim($studentData[263]);
            $COURSE_CODE_78 = trim($studentData[264]);
            $COURSE_78 = trim($studentData[265]);
            $CREDIT_78 = trim($studentData[266]);
            $GRADE_78 = trim($studentData[267]);
            $COURSE_CODE_79 = trim($studentData[268]);
            $COURSE_79 = trim($studentData[269]);
            $CREDIT_79 = trim($studentData[270]);
            $GRADE_79 = trim($studentData[271]);
            $SGPA_7 = trim($studentData[272]);

            $VIII_SEMESTER = trim($studentData[273]);
            $COURSE_CODE_81 = trim($studentData[274]);
            $COURSE_81 = trim($studentData[275]);
            $CREDIT_81 = trim($studentData[276]);
            $GRADE_81 = trim($studentData[277]);
            $COURSE_CODE_82 = trim($studentData[278]);
            $COURSE_82 = trim($studentData[279]);
            $CREDIT_82 = trim($studentData[280]);
            $GRADE_82 = trim($studentData[281]);
            $COURSE_CODE_83 = trim($studentData[282]);
            $COURSE_83 = trim($studentData[283]);
            $CREDIT_83 = trim($studentData[284]);
            $GRADE_83 = trim($studentData[285]);
            $COURSE_CODE_84 = trim($studentData[286]);
            $COURSE_84 = trim($studentData[287]);
            $CREDIT_84 = trim($studentData[288]);
            $GRADE_84 = trim($studentData[289]);
            $COURSE_CODE_85 = trim($studentData[290]);
            $COURSE_85 = trim($studentData[291]);
            $CREDIT_85 = trim($studentData[292]);
            $GRADE_85 = trim($studentData[293]);
            $COURSE_CODE_86 = trim($studentData[294]);
            $COURSE_86 = trim($studentData[295]);
            $CREDIT_86 = trim($studentData[296]);
            $GRADE_86 = trim($studentData[297]);
            $COURSE_CODE_87 = trim($studentData[298]);
            $COURSE_87 = trim($studentData[299]);
            $CREDIT_87 = trim($studentData[300]);
            $GRADE_87 = trim($studentData[301]);
            $COURSE_CODE_88 = trim($studentData[302]);
            $COURSE_88 = trim($studentData[303]);
            $CREDIT_88 = trim($studentData[304]);
            $GRADE_88 = trim($studentData[305]);
            $COURSE_CODE_89 = trim($studentData[306]);
            $COURSE_89 = trim($studentData[307]);
            $CREDIT_89 = trim($studentData[308]);
            $GRADE_89 = trim($studentData[309]);
            $SGPA_8 = trim($studentData[310]);


            $Academic_year_1 = trim($studentData[311]);
            $Academic_year_2 = trim($studentData[312]);
            $Academic_year_3 = trim($studentData[313]);
            $Academic_year_4 = trim($studentData[314]);
            ...
            // ------------------ Invisible candidate name ------------------
            $pdfBig->SetFont($arialb, '', 8, '', false); 
            $pdfBig->SetTextColor(255, 255, 0);
            $pdfBig->SetXY(76, 43.5);
            $pdfBig->Cell(0, 0, $candidate_name, 0, false, 'L');
            $pdfBig->SetTextColor(0, 0, 0);

            // ------------------ First Row: Name and PRN ------------------
            $pdfBig->setCellPaddings(1, 0.5, '', '');

            $pdfBig->SetFont($arial, '', 8, '', false);
            $pdfBig->SetXY(11, 47);
            $pdfBig->MultiCell(94, 5.7, "", 'LTB', "L", 0, 0, '', '', true, 0, true);

            $pdfBig->SetFont($arialb, '', 8, '', false);
            $pdfBig->SetXY(15, 48);
            $pdfBig->MultiCell(24, 4.9, 'Student Name', 0, "L", 0, 0, '', '', true, 0, true);

            $pdfBig->SetFont($arial, '', 8, '', false);
            $pdfBig->SetXY(39, 48);
            $pdfBig->MultiCell(5, 4.9, ':', 0, "L", 0, 0, '', '', true, 0, true);

            $pdfBig->SetXY(44, 48);
            $pdfBig->MultiCell(56, 4.9, $candidate_name, 0, "L", 0, 0, '', '', true, 0, true);

            // PRN Box
            $pdfBig->SetXY(105, 47);
            $pdfBig->MultiCell(94, 5.7, "", 'LRTB', "L", 0, 0, '', '', true, 0, true);

            $pdfBig->SetFont($arialb, '', 8.7, '', false);
            $pdfBig->SetXY(109, 48);
            $pdfBig->MultiCell(26, 4.9, 'PRN', 0, "L", 0, 0, '', '', true, 0, true);

            $pdfBig->SetFont($arial, '', 7.7, '', false);
            $pdfBig->SetXY(135, 48);
            $pdfBig->MultiCell(5, 4.9, ':', 0, "L", 0, 0, '', '', true, 0, true);

            $pdfBig->SetXY(140, 48);
            $pdfBig->MultiCell(34, 4.9, $prnNo, 0, "L", 0, 0, '', '', true, 0, true);

            // Invisible PRN
            $pdfBig->SetFont($arialb, '', 8, '', false); 
            $pdfBig->SetTextColor(255, 255, 0);
            $pdfBig->SetXY(165, 48.5);
            $pdfBig->Cell(0, 0, $prnNo, 0, false, 'L');
            $pdfBig->SetTextColor(0, 0, 0);

            // ------------------ Second Row: Transcript Issue Date and GPA ------------------
            $pdfBig->SetFont($arial, '', 8, '', false);
            $pdfBig->SetXY(11, 52.5); 
            $pdfBig->MultiCell(94, 6.2, "", 'LB', "L", 0, 0, '', '', true, 0, true);

            $pdfBig->SetFont($arialb, '', 7.7, '', false);
            $pdfBig->SetXY(15, 53.5);
            $pdfBig->MultiCell(39, 7, "Transcript Issue Date", 0, "L", 0, 0, '', '', true, 0, true);

            $pdfBig->SetFont($arial, '', 8, '', false);
            $pdfBig->SetXY(54, 53.5);
            $pdfBig->MultiCell(5, 7, ':', 0, "L", 0, 0, '', '', true, 0, true);

            $pdfBig->SetXY(59, 53.5);
            $pdfBig->MultiCell(50, 7, $TransIssueDate, 0, "L", 0, 0, '', '', true, 0, true);




            // GPA Box
            $pdfBig->SetXY(105, 52.5);
            $pdfBig->MultiCell(94, 6.2, "", 'LRB', "L", 0, 0, '', '', true, 0, true);

            // Left field: Cumulative GPA
            $pdfBig->SetFont($arialb, '', 8, '', false);
            $pdfBig->SetXY(109, 53.5);
            $pdfBig->MultiCell(28, 7, "Cumulative GPA", 0, "L", 0, 0, '', '', true, 0, true);

            $pdfBig->SetFont($arial, '', 8, '', false);
            $pdfBig->SetXY(136.5, 53.5);
            $pdfBig->MultiCell(3, 5.5, ':', 0, "L", 0, 0, '', '', true, 0, true);

            $pdfBig->SetXY(140, 53.5);
            $pdfBig->MultiCell(15, 7, $cumulativeGpa, 0, "L", 0, 0, '', '', true, 0, true);

            // Right field: Earned Credits
            $pdfBig->SetFont($arialb, '', 8, '', false);
            $pdfBig->SetXY(160, 53.5);
            $pdfBig->MultiCell(24, 7, "Earned Credits", 0, "L", 0, 0, '', '', true, 0, true);

            $pdfBig->SetFont($arial, '', 8, '', false);
            $pdfBig->SetXY(184.5, 53.5);
            $pdfBig->MultiCell(3, 5.5, ':', 0, "L", 0, 0, '', '', true, 0, true);


            $pdfBig->SetXY(188, 53.5);
            $pdfBig->MultiCell(15, 7, $earnedCredit, 0, "L", 0, 0, '', '', true, 0, true);
            ...
            $pdfBig->SetFont($arial, '', 8, '', false);
            $pdfBig->SetXY(11, 58);
            $pdfBig->MultiCell(188, 5.7, "", 'LRB', "L", 0, 0, '', '', true, 0, true);

            $pdfBig->SetFont($arialb, '', 8, '', false);
            $pdfBig->SetXY(15, 59);
            $pdfBig->MultiCell(24, 7, "Programme", 0, "L", 0, 0, '', '', true, 0, true);
            ...
            $pdfBig->SetXY(44, 59);
            $pdfBig->MultiCell(121, 7, $programme, 0, "L", 0, 0, '', '', true, 0, true);
            ...
            foreach ($subjectData as $index => $sem) {
                if ($index % 2 == 0) {
                    ...
                    // $pdfBig->MultiCell(20, $BorderHeight, '', '1', "C", 0, 0);
                    // $pdfBig->SetXY(31, $leftBorderY);
                    // $pdfBig->MultiCell(51, $BorderHeight, '', 1, "C", 0, 0);
                    // $pdfBig->SetXY(82, $leftBorderY);
                    // $pdfBig->MultiCell(12, $BorderHeight, '', 1, "C", 0, 0);
                    // $pdfBig->SetXY(94, $leftBorderY);
                    // $pdfBig->MultiCell(11, $BorderHeight, '', 1, "C", 0, 0);
                    ...
                    $pdfBig->SetFont($arialNarrowB, '',8, '', false);
                    $pdfBig->SetXY(11, ($leftBorderY+ $BorderHeight-4));
                    if($semester1) {
                    ...
                    $pdfBig->setCellPaddings( $left = '1', $top = '0.4', $right = '', $bottom = ''); 
                    $pdfBig->SetFont($arialNarrowB, '',8, '', false);
                    $pdfBig->SetXY(105, ($rightBorderY+ $BorderHeight-4));
                    if($semester2) {
                    ...
                    $tableLeftY = $tableLeftY+4;
                    $tableRightY = $tableRightY+4;
            ...
            $pdf->SetXY(11, 47);
            $pdf->MultiCell(94, 5.7, "", 'LTB', "L", 0, 0, '', '', true, 0, true);

            $pdf->SetFont($arialb, '', 8, '', false);
            $pdf->SetXY(15, 48);
            $pdf->MultiCell(24, 4.9, 'Name', 0, "L", 0, 0, '', '', true, 0, true);

            $pdf->SetFont($arial, '', 8, '', false);
            $pdf->SetXY(39, 48);
            $pdf->MultiCell(5, 4.9, ':', 0, "L", 0, 0, '', '', true, 0, true);

            $pdf->SetXY(44, 48);
            $pdf->MultiCell(56, 4.9, $candidate_name, 0, "L", 0, 0, '', '', true, 0, true);

            // PRN Box
            $pdf->SetXY(105, 47);
            $pdf->MultiCell(94, 5.7, "", 'LRTB', "L", 0, 0, '', '', true, 0, true);

            $pdf->SetFont($arialb, '', 8.7, '', false);
            $pdf->SetXY(109, 48);
            $pdf->MultiCell(26, 4.9, 'PRN', 0, "L", 0, 0, '', '', true, 0, true);

            $pdf->SetFont($arial, '', 7.7, '', false);
            $pdf->SetXY(135, 48);
            $pdf->MultiCell(5, 4.9, ':', 0, "L", 0, 0, '', '', true, 0, true);

            $pdf->SetXY(140, 48);
            $pdf->MultiCell(34, 4.9, $prnNo, 0, "L", 0, 0, '', '', true, 0, true);
            ...
            $pdf->SetFont($arial, '', 8, '', false);
            $pdf->SetXY(11, 52.5); 
            $pdf->MultiCell(94, 6.2, "", 'LB', "L", 0, 0, '', '', true, 0, true);

            $pdf->SetFont($arialb, '', 7.7, '', false);
            $pdf->SetXY(15, 53.5);
            $pdf->MultiCell(39, 7, "Transcript Issue Date", 0, "L", 0, 0, '', '', true, 0, true);
            ...
            $pdf->SetXY(59, 53.5);
            $pdf->MultiCell(50, 7, $TransIssueDate, 0, "L", 0, 0, '', '', true, 0, true);


            // GPA Box
            $pdf->SetXY(105, 52.5);
            $pdf->MultiCell(94, 6.2, "", 'LRB', "L", 0, 0, '', '', true, 0, true);

            // Left field: Cumulative GPA
            $pdf->SetFont($arialb, '', 8, '', false);
            $pdf->SetXY(109, 53.5);
            $pdf->MultiCell(28, 7, "Cumulative GPA", 0, "L", 0, 0, '', '', true, 0, true);

            $pdf->SetFont($arial, '', 8, '', false);
            $pdf->SetXY(136.5, 53.5);
            $pdf->MultiCell(3, 5.5, ':', 0, "L", 0, 0, '', '', true, 0, true);

            $pdf->SetXY(140, 53.5);
            $pdf->MultiCell(15, 7, $cumulativeGpa, 0, "L", 0, 0, '', '', true, 0, true);

            // Right field: Earned Credits
            $pdf->SetFont($arialb, '', 8, '', false);
            $pdf->SetXY(160, 53.5);
            $pdf->MultiCell(24, 7, "Earned Credits", 0, "L", 0, 0, '', '', true, 0, true);

            $pdf->SetFont($arial, '', 8, '', false);
            $pdf->SetXY(184.5, 53.5);
            $pdf->MultiCell(3, 5.5, ':', 0, "L", 0, 0, '', '', true, 0, true);


            $pdf->SetXY(188, 53.5);
            $pdf->MultiCell(15, 7, $earnedCredit, 0, "L", 0, 0, '', '', true, 0, true);
            ...
            $pdf->SetFont($arial, '', 8, '', false);
            $pdf->SetXY(11, 58);
            $pdf->MultiCell(188, 5.7, "", 'LRB', "L", 0, 0, '', '', true, 0, true);

            $pdf->SetFont($arialb, '', 8, '', false);
            $pdf->SetXY(15, 59);
            $pdf->MultiCell(24, 7, "Programme", 0, "L", 0, 0, '', '', true, 0, true);
            ...
            $pdf->SetXY(44, 59);
            $pdf->MultiCell(121, 7, $programme, 0, "L", 0, 0, '', '', true, 0, true);
            ...
            foreach ($subjectData as $index => $sem) {
                if ($index % 2 == 0) {
                    ...
                    $pdf->SetXY(11, ($leftBorderY+ $BorderHeight-4));
                    if($semester1) {
                    ...
                    $pdf->setCellPaddings( $left = '1', $top = '0.4', $right = '', $bottom = ''); 
                    $pdf->SetFont($arialNarrowB, '',8, '', false);
                    $pdf->SetXY(105, ($rightBorderY+ $BorderHeight-4));
                    if($semester2) {

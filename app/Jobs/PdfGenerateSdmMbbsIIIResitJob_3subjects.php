...
use Helper;
class PdfGenerateSdmMbbsIIIResitJob_3subjects
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
			...
			// $batch_of_qr = trim($studentData[80]);
			// $aadhar_number_qr = trim($studentData[81]);
			// $DOB = trim($studentData[82]);			
			// $course = strtoupper(trim($studentData[83]));  
			...
			*/
            ...
            $pdfBig->image($COE,$COE_x,$COE_y,$COE_Width,$COE_Height,"",'','L',true,300);
            $pdfBig->setPageMark();
			$pdf->image($COE,$COE_x,$COE_y,$COE_Width,$COE_Height,"",'','L',true,300);
            $pdf->setPageMark();

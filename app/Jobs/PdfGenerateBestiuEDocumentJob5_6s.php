...
use Carbon\Carbon;
use Helper;
class PdfGenerateBestiuEDocumentJob5_6s
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        // echo"<pre>";print_r($subjectDataOrg);die();
        $subjectsArr = array();
        if($subjectDataOrg) {
        ...
        if($studentDataOrg&&!empty($studentDataOrg)){
            foreach ($studentDataOrg as $studentData) {
               ...
               $pdfBig->SetTextColor(0,0,0);
                ...
                $totalHeight = 0;
                // echo "<br>Term: ".$term;
                if ($term == "I SEMESTER" || $term == "III SEMESTER" ) {
                    ...
                    foreach($term_array as $key => $val){
                        ...
                        if ($lines == 3 && $courselines > 1) {
                            $subjectTableHeight = 18;
                        }elseif ($lines == 2 || $courselines >= 1) {
                            $subjectTableHeight = 12;
                        } else {
                            $subjectTableHeight = 6;
                        }
                ...
                } else if ($term == "II SEMESTER" || $term == "IV SEMESTER" ) {
                    // $tableSecondStart
                    if($term == "IV SEMESTER"){
                ...
                if($term == "II SEMESTER" || $term == "IV SEMESTER") {
                ...
                if($term == "II SEMESTER" || $term == "IV SEMESTER" ) {
                    ...
                    // $leftCurrentY = $leftCurrentY-4;
                    $pdfBig->setCellPaddings( $left = '', $top = '0.4', $right = '', $bottom = '');
                    $pdfBig->SetFont($arialb, '', $font_size_new+1, '', false); 
                    $pdfBig->SetXY(12, $leftCurrentY);
               ...
               $pdf->SetTextColor(0,0,0);
                ...
                if($term == "II SEMESTER" || $term == "IV SEMESTER" ) {
                    ...
                    // $leftCurrentY = $leftCurrentY-4;
                    $pdf->setCellPaddings( $left = '', $top = '0.4', $right = '', $bottom = '');
                    $pdf->SetFont($arialb, '', $font_size_new+1, '', false); 
                    $pdf->SetXY(12, $leftCurrentY);

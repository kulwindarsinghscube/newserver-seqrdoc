...
class ValidateExcelPepolesuniConsolidatedVIIIJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        if($columnsCount1==48&&$columnsCount2==12){

            $columnArr=array("Sr No","Enrollmentno","NameofStudent","FatherName","MotherName","CourseName","InstituteName","Specialization","EnrolledSession","Exam_Result_MonthYear","MarksheetNo","exam1_myop","exam1_status","exam1_tec","exam1_sgpa","exam2_myop","exam2_status","exam2_tec","exam2_sgpa","exam3_myop","exam3_status","exam3_tec","exam3_sgpa","exam4_myop","exam4_status","exam4_tec","exam4_sgpa","exam5_myop","exam5_status","exam5_tec","exam5_sgpa","exam6_myop","exam6_status","exam6_tec","exam6_sgpa","exam7_myop","exam7_status","exam7_tec","exam7_sgpa","exam8_myop","exam8_status","exam8_tec","exam8_sgpa","final_cgpa","final_result","division","place","issue_date");
            ...
            // print_r($columnArr);
            $columnArr=array("Enrollmentno","semester","Paper Code","Paper Name","paper_th","Th_Cr_A","Th_Cr_E","Th_Grade","paper_pr","Pr_Cr_A","Pr_Cr_E","Pr_Grade");
        ...
        foreach ($rowData1 as $key1 => $value1) {
            ...
            $profile_path_jpg = public_path().'\\'.$subdomain[0].'\backend\templates\100\\'.trim($value1[1]).'.jpg';
            $profile_path_jpeg = public_path().'\\'.$subdomain[0].'\backend\templates\100\\'.trim($value1[1]).'.jpeg';
            $profile_path_png = public_path().'\\'.$subdomain[0].'\backend\templates\100\\'.trim($value1[1]).'.png';


            if (!file_exists($profile_path_jpg)) {
                if(!file_exists($profile_path_png)){
                    if(!file_exists($profile_path_jpeg)){
                        array_push($profErrArr, $value1[1]);
                    }
                } 
            }

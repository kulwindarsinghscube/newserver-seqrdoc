        ...
        if($studentDataOrg&&!empty($studentDataOrg)){
            foreach ($studentDataOrg as $studentData) {
                ...
                */
                ...
                //$session2 = $studentData[154];
                //$IssueDate = $studentData[155];
                
                /*$MaxMarks = $studentData[151];
                $totalMarksObt = $studentData[152];
                $Result_SGPA = $studentData[153];
                $session2 = $studentData[154];
                $Photo = $studentData[155];*/
                $MaxMarks = $studentData[177];
                $totalMarksObt = $studentData[178];
                $Result_SGPA = $studentData[179];
                $session2 = $studentData[180];
                $Photo = $studentData[181];
                $date_of_issue = $studentData[182];
                $date_of_issue =$this->convertExcelDate($studentData[182]);
                // dd($date_of_issue);
                ...
                //$subjectData = array_slice($studentData, 8, 143);
                $subjectData = array_slice($studentData, 8, 169);
                $subjectsArr=array_chunk($subjectData, 13);
                //print_r($subjectsArr);
                ...
                for ($i=0; $i < $actual_subj_count ; $i++) { 
                    ...
                    $pdf->MultiCell(10, $cell_height, trim($subjectsArr[$i][10]), $cell_border, 'C', 0, 0);
                    ...
                    if($numlines_pdfBig >= 3){
                        $pdfBig->SetFont($arialb, '', 8.5, '', false); 
                    }
                ...
                $pdf->SetFont($arialb, '', 10, '', false);   
                $pdf->SetTextColor(0, 0, 0);
                $pdf->SetXY(13.4,246.5);
                $pdf->Cell(0, 0, 'Marks Obtained', 0, false, 'L');       
                $pdf->SetXY(48.7,246.5);
                $pdf->Cell(0, 0, ':', 0, false, 'L');   
                $pdf->SetXY(51.6,246.5);
                $pdf->Cell(0, 0, $totalMarksObt, 0, false, 'L');  
                $pdf->SetTextColor(258, 255, 0);     
                $pdf->SetXY(59.6, 246.5);
                $pdf->Cell(0, 0, $totalMarksObt, 0, false, 'L');     
                
                $pdf->SetFont($arialb, '', 10, '', false);   
                $pdf->SetTextColor(0, 0, 0);
                $pdf->SetXY(13.4, 251.2);
                $pdf->Cell(0, 0, 'Max. Marks', 0, false, 'L');       
                $pdf->SetXY(48.7, 251.2);
                $pdf->Cell(0, 0, ':', 0, false, 'L');   
                $pdf->SetXY(51.6, 251.2);
                $pdf->Cell(0, 0, $MaxMarks, 0, false, 'L'); 

                $pdf->SetFont($arialb, '', 10, '', false);   
                $pdf->SetTextColor(0, 0, 0);
                $pdf->SetXY(13.4, 256);
                //$pdf->Cell(0, 0, 'Date of Issue : '.$date_of_issue, 0, false, 'L');
                $pdf->MultiCell(0, 0, 'Date of Issue : <span style="color:blue;">'.$date_of_issue.'</span>', 0, 'L', 0, 0, '', '', true, 0, true);
                
                $pdf->SetFont($arialb, '', 10, '', false);   
                $pdf->SetTextColor(0, 0, 0);
                $pdf->SetXY(133, 252);
                $pdf->Cell(0, 0, 'Result/SGPA', 0, false, 'L');       
                $pdf->SetXY(156, 252);
                $pdf->Cell(0, 0, ':', 0, false, 'L');   
                $pdf->SetXY(160, 252);
                $pdf->Cell(0, 0, $Result_SGPA, 0, false, 'L');
                ...
                $pdfBig->SetFont($arialb, '', 10, '', false);   
                $pdfBig->SetTextColor(0, 0, 0);
                $pdfBig->SetXY(13.4,246.5);
                $pdfBig->Cell(0, 0, 'Marks Obtained', 0, false, 'L');       
                $pdfBig->SetXY(48.7,246.5);
                $pdfBig->Cell(0, 0, ':', 0, false, 'L');   
                $pdfBig->SetXY(51.6,246.5);
                $pdfBig->Cell(0, 0, $totalMarksObt, 0, false, 'L');  
                $pdfBig->SetTextColor(258, 255, 0);     
                $pdfBig->SetXY(59.6, 246.5);
                $pdfBig->Cell(0, 0, $totalMarksObt, 0, false, 'L');     
                
                $pdfBig->SetFont($arialb, '', 10, '', false);   
                $pdfBig->SetTextColor(0, 0, 0);
                $pdfBig->SetXY(13.4, 251.2);
                $pdfBig->Cell(0, 0, 'Max. Marks', 0, false, 'L');       
                $pdfBig->SetXY(48.7, 251.2);
                $pdfBig->Cell(0, 0, ':', 0, false, 'L');   
                $pdfBig->SetXY(51.6, 251.2);
                $pdfBig->Cell(0, 0, $MaxMarks, 0, false, 'L'); 

                $pdfBig->SetFont($arialb, '', 10, '', false);   
                $pdfBig->SetTextColor(0, 0, 0);
                $pdfBig->SetXY(13.4, 256);
                //$pdfBig->Cell(0, 0, 'Date of Issue : '.$date_of_issue, 0, false, 'L');
                $pdfBig->MultiCell(0, 0, 'Date of Issue : <span style="color:blue;">'.$date_of_issue.'</span>', 0, 'L', 0, 0, '', '', true, 0, true);
                
                $pdfBig->SetFont($arialb, '', 10, '', false);   
                $pdfBig->SetTextColor(0, 0, 0);
                $pdfBig->SetXY(133, 252);
                $pdfBig->Cell(0, 0, 'Result/SGPA', 0, false, 'L');       
                $pdfBig->SetXY(156, 252);
                $pdfBig->Cell(0, 0, ':', 0, false, 'L');   
                $pdfBig->SetXY(160, 252);
                $pdfBig->Cell(0, 0, $Result_SGPA, 0, false, 'L');
                //$pdfBig->Cell(0, 0, number_format((float)$Result_SGPA, 2, '.', ''), 0, false, 'L');
        ...
        ftp_close($connId);
        	...
        	public function convertExcelDate($dateFromExcel)
            {
                if (is_numeric($dateFromExcel)) {
                    ...
                    $formats = ['d/m/Y', 'd-m-Y', 'Y-m-d', 'm/d/Y', 'd M Y', 'd F Y', 'd-M-Y', 'd-F-Y']; // Add more if needed

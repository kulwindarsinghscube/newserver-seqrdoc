...
use Helper;
class PdfGenerateSdmBdsResitJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
			...
			$pdfBig->SetXY(145, 97);	
			$pdfBig->MultiCell(33, 13, '', 'R', 'C', 0, 0); //Total
			$pdfBig->SetXY(172, 97);	
			$pdfBig->MultiCell(18, 9, '', 0, 'C', 0, 0); //Remark
			...
			$pdfBig->MultiCell(9, 0, 'MAX', 0, 'C', 0, 0);
			$pdfBig->MultiCell(9, 0, 'SEC', 0, 'C', 0, 0);
			$pdfBig->SetXY(150.5, 106.5);
			$pdfBig->MultiCell(8, 0, 'MAX', 0, 'C', 0, 0);
			$pdfBig->MultiCell(9.5, 0, 'MIN', 0, 'C', 0, 0);
			$pdfBig->MultiCell(9, 0, 'SEC', 0, 'C', 0, 0);
			/******End pdfBig ******/ 
			...
			$pdf->SetXY(145, 97);	
			$pdf->MultiCell(33, 13, '', 'R', 'C', 0, 0); //Total
			$pdf->SetXY(172, 97);	
			$pdf->MultiCell(18, 9, '', 0, 'C', 0, 0); //Remark
			...
			$pdf->SetXY(147, 100);
			$pdf->MultiCell(32, 5, 'TOTAL', 0, 'C', 0, 0);
			$pdf->SetXY(172, 100);
			$pdf->MultiCell(27, 5, 'REMARK', 0, 'C', 0, 0);
			...
			$pdf->MultiCell(9, 0, 'MAX', 0, 'C', 0, 0);
			$pdf->MultiCell(9, 0, 'SEC', 0, 'C', 0, 0);
            $pdf->SetXY(150.5, 106.5);
			$pdf->MultiCell(8, 0, 'MAX', 0, 'C', 0, 0);
			$pdf->MultiCell(9.5, 0, 'MIN', 0, 'C', 0, 0);
			$pdf->MultiCell(9, 0, 'SEC', 0, 'C', 0, 0);
			...
			foreach ($subjectsArr as $subjectDatas){
				...
				if ($th_pr_val == 'TH|PR') {
					...
					$pdfBig->MultiCell(10, $th_height_half, $T_Max_TH, 1, 'C', 0, 0);
					$pdfBig->MultiCell(9, $th_height_half, $T_Min_TH, 1, 'C', 0, 0);
					$pdfBig->MultiCell(10, $th_height_half, $T_Sec_TH, 1, 'C', 0, 0);
					...
					$pdfBig->MultiCell(10, $th_height_half, $T_Max_PR, 1, 'C', 0, 0);
					$pdfBig->MultiCell(9, $th_height_half, $T_Min_PR, 1, 'C', 0, 0);
					$pdfBig->MultiCell(10, $th_height_half, $T_Sec_PR, 1, 'C', 0, 0);
					...
					$pdf->MultiCell(10, $th_height_half2, $T_Max_TH, 1, 'C', 0, 0);
					$pdf->MultiCell(9, $th_height_half2, $T_Min_TH, 1, 'C', 0, 0);
					$pdf->MultiCell(10, $th_height_half2, $T_Sec_TH, 1, 'C', 0, 0);
					...
					$pdf->MultiCell(10, $th_height_half2, $T_Max_PR, 1, 'C', 0, 0);
					$pdf->MultiCell(9, $th_height_half2, $T_Min_PR, 1, 'C', 0, 0);
					$pdf->MultiCell(10, $th_height_half2, $T_Sec_PR, 1, 'C', 0, 0);
			...
			$pdfBig->MultiCell(10, 5, $Grand_Total_Sec, 1, 'C', 0, 0); 
			...
			*/
			...
			$pdf->MultiCell(10, 5, $Grand_Total_Sec, 1, 'C', 0, 0); 

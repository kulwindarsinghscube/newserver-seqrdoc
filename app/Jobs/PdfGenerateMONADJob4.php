        ...
        if($studentDataOrg&&!empty($studentDataOrg)){  
            foreach ($studentDataOrg as $studentData) {
                ...
                */
                ...
                $upload_logo_org = $uvlogo_path;
                $pathInfo = pathinfo($uvlogo_path);
                $uvlogo_path = public_path().'\\'.$subdomain[0].'\backend\\templates\\100\\'.$pathInfo['filename']."_$studentData[0].".$pathInfo['extension'];
                \File::copy($upload_logo_org,$uvlogo_path); 

                $pdfBig->image($uvlogo_path,$uvlogo_x,$uvlogo_y,$uvlogo_Width,$uvlogo_Height,"PNG",'','L',true,3600);        
                $pdfBig->setPageMark();
                ...
                $upload_sign1_org = $uvsign_path;
                $pathInfo = pathinfo($uvsign_path);
                $uvsign_path = public_path().'\\'.$subdomain[0].'\backend\\templates\\100\\'.$pathInfo['filename']."_$studentData[0].".$pathInfo['extension'];
                \File::copy($upload_sign1_org,$uvsign_path); 


                $pdfBig->image($uvsign_path,$uvsign_x,$uvsign_y,$uvsign_Width,$uvsign_Height,"PNG",'','L',true,3600);         
                $pdfBig->setPageMark();
                ...
                //1st 6 columns
                $pdfBig->MultiCell(68.4, 19, '',1, 'L', 0, 0);
                $pdfBig->MultiCell(7.2, 19, '', 1, 'C', 0, 0);
                $pdfBig->MultiCell(40, 19, '', 1, 'C', 0, 0);     
                $pdfBig->MultiCell(40, 19, '', 1, 'C', 0, 0);     
                $pdfBig->MultiCell(20, 19, '', 1, 'C', 0, 0);
                $pdfBig->MultiCell(8.4, 19, '', 1, 'C', 0, 0); 
                ...
                $session2 = $studentData[189];
                //$IssueDate = $studentData[189];
                $date_of_issue = $studentData[191];
                //Start pdf        
                //Static Title
                ...
                //$pdfBig->SetXY($right_str_x, $left_title3_y+3.5);
                //$pdfBig->Cell(0, 0, $session2, 0, false, 'L');   
                ...
                $pdf->Cell(0, 0, 'Grand Total', 0, false, 'C');
                ...
                $pdfBig->SetXY(88.6, 104);
                $pdfBig->MultiCell(20, 4.5, 'Theory', 1, 'C', 0, 0);     
                $pdfBig->MultiCell(20, 4.5, 'Practical', 1, 'C', 0, 0);
                $pdfBig->SetXY(88.6, 109.1);
                $pdfBig->MultiCell(10, 10, 'MM', 'LR', 'C', 0, 0);
                $pdfBig->MultiCell(10, 10, 'MO', 'LR', 'C', 0, 0);
                $pdfBig->MultiCell(10, 10, 'MM', 'LR', 'C', 0, 0);
                $pdfBig->MultiCell(10, 10, 'MO', 'LR', 'C', 0, 0);

                $pdfBig->SetXY(128.6, 104);
                $pdfBig->MultiCell(20, 4.5, 'Theory', 1, 'C', 0, 0);     
                $pdfBig->MultiCell(20, 4.5, 'Practical', 1, 'C', 0, 0);
                $pdfBig->SetXY(128.6, 109.1);
                $pdfBig->MultiCell(10, 10, 'MM', 'LR', 'C', 0, 0);
                $pdfBig->MultiCell(10, 10, 'MO', 'LR', 'C', 0, 0);
                $pdfBig->MultiCell(10, 10, 'MM', 'LR', 'C', 0, 0);
                $pdfBig->MultiCell(10, 10, 'MO', 'LR', 'C', 0, 0);

                $pdfBig->SetXY(168.6, 109.1);
                $pdfBig->MultiCell(10, 10, 'MM', 'LRT', 'C', 0, 0);
                $pdfBig->MultiCell(10, 10, 'MO', 'LRT', 'C', 0, 0);

                $pdfBig->SetXY(13, 115);
                $pdfBig->MultiCell(3, 10, '','LT', 'L', 0, 0);
                $pdfBig->MultiCell(65.4, 10, '','RT', 'L', 0, 0);
                $pdfBig->MultiCell(7.2, 10, '', 'LRT', 'C', 0, 0);
                $pdfBig->MultiCell(10, 10, '', 'LRT', 'C', 0, 0);
                $pdfBig->MultiCell(10, 10, '', 'LRT', 'C', 0, 0);
                $pdfBig->MultiCell(10, 10, '', 'LRT', 'C', 0, 0);
                $pdfBig->MultiCell(10, 10, '', 'LRT', 'C', 0, 0);
                $pdfBig->MultiCell(10, 10, '', 'LRT', 'C', 0, 0);
                ...
                $pdfBig->MultiCell(10, 10, '', 'LRT', 'C', 0, 0);
                $pdfBig->MultiCell(10, 10, '', 'LRT', 'C', 0, 0);
                $pdfBig->MultiCell(8.4, 10, '', 'LRT', 'C', 0, 0);       

                $pdfBig->SetFont($arialb, '', 10, '', false);
                $pdfBig->SetTextColor(0, 0, 0);
                $pdfBig->SetXY(82.3, 115);
                $pdfBig->StartTransform();
                $pdfBig->Rotate(90);
                $pdfBig->Cell(0, 0, '(C) Credit', 0, false, 'L');
                $pdfBig->StopTransform();
                $pdfBig->SetXY(190, 115);
                $pdfBig->StartTransform();
                $pdfBig->Rotate(90);
                $pdfBig->Cell(0, 0, '(P) Grade', 0, false, 'L');
                $pdfBig->StopTransform();        
                $pdfBig->SetXY(157.2, 101.6);
                $pdfBig->SetFont($arialb, '', 9.5, '', false);
                $pdfBig->Cell(0, 0, 'Grand Total', 0, false, 'C');
                $pdfBig->SetFont($arialb, '', 11, '', false);
                $pdfBig->SetXY(25, 103);
                $pdfBig->Cell(0, 0, 'Course Name/Code', 0, false, 'L');
                $pdfBig->SetFont($arialb, '', 10.5, '', false);
                $pdfBig->SetXY(89.5, 97.5);
                $pdfBig->Cell(0, 0, 'Internal Assessment', 0, false, 'L');
                $pdfBig->SetXY(129, 97.5);
                $pdfBig->Cell(0, 0, 'External Assessment', 0, false, 'L'); 
                // end    
                

                $subjectData = array_slice($studentData, 8, 143); //start subject and end subject 
                $subjectsArr=array_chunk($subjectData, 13); //fields of one subject
                //print_r($subjectsArr);        
                ...
                for ($i=0; $i < $actual_subj_count ; $i++) { 
                    ...
                    $numlines_pdf = $pdf->getNumLines($subjectsArr[$i][0], 65.4);
                    $numlines_pdfBig = $pdfBig->getNumLines($subjectsArr[$i][0], 65.4);
                    
                    $pdf->SetXY(13, $subj_y);
                    $pdf->SetFont($arialb, '', $fontsize_str, '', false);
                    $pdf->MultiCell(3, $cell_height, '',$cell_border_empty, 'L', 0, 0);
                    if($numlines_pdf>2){
                        $pdf->SetFont($arialb, '', 9, '', false); 
                    }
                    $pdf->MultiCell(65.4, $cell_height, trim($subjectsArr[$i][0]),$cell_border_sub, 'L', 0, 0);
                    $pdf->SetFont($arialb, '', $fontsize_str, '', false);
                    $pdf->MultiCell(7.2, $cell_height, trim($subjectsArr[$i][12]), $cell_border, 'C', 0, 0);
                    //$pdf->MultiCell(7.2, $cell_height, '', $cell_border, 'C', 0, 0);
                    $pdf->MultiCell(10, $cell_height, trim($subjectsArr[$i][1]), $cell_border, 'C', 0, 0);
                    $pdf->MultiCell(10, $cell_height, trim($subjectsArr[$i][2]), $cell_border, 'C', 0, 0);
                    $pdf->MultiCell(10, $cell_height, trim($subjectsArr[$i][3]), $cell_border, 'C', 0, 0);
                    $pdf->MultiCell(10, $cell_height, trim($subjectsArr[$i][4]), $cell_border, 'C', 0, 0);
                    $pdf->MultiCell(10, $cell_height, trim($subjectsArr[$i][5]), $cell_border, 'C', 0, 0);
                    $pdf->MultiCell(10, $cell_height, trim($subjectsArr[$i][6]), $cell_border, 'C', 0, 0);
                    $pdf->MultiCell(10, $cell_height, trim($subjectsArr[$i][7]), $cell_border, 'C', 0, 0);
                    $pdf->MultiCell(10, $cell_height, trim($subjectsArr[$i][8]), $cell_border, 'C', 0, 0);
                    $pdf->MultiCell(10, $cell_height, trim($subjectsArr[$i][9]), $cell_border, 'C', 0, 0);
                    $pdf->MultiCell(10, $cell_height, trim($subjectsArr[$i][10]), $cell_border, 'C', 0, 0, '', '', true, 0, true);
                    $pdf->MultiCell(8.4, $cell_height, trim($subjectsArr[$i][11]), $cell_border, 'C', 0, 0);  
                                
                    $pdfBig->SetXY(13, $subj_y);
                    $pdfBig->SetFont($arialb, '', $fontsize_str, '', false);
                    $pdfBig->MultiCell(3, $cell_height, '',$cell_border_empty, 'L', 0, 0);
                    if($numlines_pdfBig>2){
                        $pdfBig->SetFont($arialb, '', 9, '', false); 
                    }
                    $pdfBig->MultiCell(65.4, $cell_height, trim($subjectsArr[$i][0]),$cell_border_sub, 'L', 0, 0);
                    $pdfBig->SetFont($arialb, '', $fontsize_str, '', false); 
                    $pdfBig->MultiCell(7.2, $cell_height, trim($subjectsArr[$i][12]), $cell_border, 'C', 0, 0);
                    //$pdfBig->MultiCell(7.2, $cell_height, '', $cell_border, 'C', 0, 0);
                    $pdfBig->MultiCell(10, $cell_height, trim($subjectsArr[$i][1]), $cell_border, 'C', 0, 0);
                    $pdfBig->MultiCell(10, $cell_height, trim($subjectsArr[$i][2]), $cell_border, 'C', 0, 0);
                    $pdfBig->MultiCell(10, $cell_height, trim($subjectsArr[$i][3]), $cell_border, 'C', 0, 0);
                    $pdfBig->MultiCell(10, $cell_height, trim($subjectsArr[$i][4]), $cell_border, 'C', 0, 0);
                    $pdfBig->MultiCell(10, $cell_height, trim($subjectsArr[$i][5]), $cell_border, 'C', 0, 0);
                    $pdfBig->MultiCell(10, $cell_height, trim($subjectsArr[$i][6]), $cell_border, 'C', 0, 0);
                    $pdfBig->MultiCell(10, $cell_height, trim($subjectsArr[$i][7]), $cell_border, 'C', 0, 0);
                    $pdfBig->MultiCell(10, $cell_height, trim($subjectsArr[$i][8]), $cell_border, 'C', 0, 0);
                    $pdfBig->MultiCell(10, $cell_height, trim($subjectsArr[$i][9]), $cell_border, 'C', 0, 0);
                    $pdfBig->MultiCell(10, $cell_height, trim($subjectsArr[$i][10]).'<br><span style="color:yellow;">'.trim($subjectsArr[$i][10]).'</span>', $cell_border, 'C', 0, 0, '', '', true, 0, true);
                    $pdfBig->MultiCell(8.4, $cell_height, trim($subjectsArr[$i][11]), $cell_border, 'C', 0, 0);  
                                
                    $subj_y=$subj_y+$subj_y_increase;    
                ...
                if($count_upto != $actual_subj_count){
                    for ($t=1; $t <= $total_rows_remain ; $t++){                
                        ...
                        $pdf->MultiCell(3, $cell_height, '',$cell_border_empty, 'L', 0, 0);
                        $pdf->MultiCell(65.4, $cell_height, '',$cell_border_sub, 'L', 0, 0);
                        $pdf->MultiCell(7.2, $cell_height, '', $cell_border, 'C', 0, 0);
                        $pdf->MultiCell(10, $cell_height, '', $cell_border, 'C', 0, 0);
                        $pdf->MultiCell(10, $cell_height, '', $cell_border, 'C', 0, 0);
                        $pdf->MultiCell(10, $cell_height, '', $cell_border, 'C', 0, 0);
                        $pdf->MultiCell(10, $cell_height, '', $cell_border, 'C', 0, 0);
                        $pdf->MultiCell(10, $cell_height, '', $cell_border, 'C', 0, 0);
                        ...
                        $pdf->MultiCell(10, $cell_height, '', $cell_border, 'C', 0, 0);
                        $pdf->MultiCell(10, $cell_height, '', $cell_border, 'C', 0, 0);
                        $pdf->MultiCell(8.4, $cell_height, '', $cell_border, 'C', 0, 0);   
                        
                        $pdfBig->MultiCell(3, $cell_height, '',$cell_border_empty, 'L', 0, 0);
                        $pdfBig->MultiCell(65.4, $cell_height, '',$cell_border_sub, 'L', 0, 0);
                        $pdfBig->MultiCell(7.2, $cell_height, '', $cell_border, 'C', 0, 0);
                        $pdfBig->MultiCell(10, $cell_height, '', $cell_border, 'C', 0, 0);
                        $pdfBig->MultiCell(10, $cell_height, '', $cell_border, 'C', 0, 0);
                        $pdfBig->MultiCell(10, $cell_height, '', $cell_border, 'C', 0, 0);
                        $pdfBig->MultiCell(10, $cell_height, '', $cell_border, 'C', 0, 0);
                        $pdfBig->MultiCell(10, $cell_height, '', $cell_border, 'C', 0, 0);
                        ...
                        $pdfBig->MultiCell(10, $cell_height, '', $cell_border, 'C', 0, 0);
                        $pdfBig->MultiCell(10, $cell_height, '', $cell_border, 'C', 0, 0);
                        $pdfBig->MultiCell(8.4, $cell_height, '', $cell_border, 'C', 0, 0);   
                        $subj_y=$subj_y+$subj_y_increase;         
                    }
                }
                ...
                $pdf->MultiCell(50, 4, $studentData[152], 0, 'L', 0, 0);     
                $pdf->MultiCell(35, 4, "", 0, 'L', 0, 0);     
                $pdf->MultiCell(34, 4, "", 0, 'L', 0, 0);
                $pdf->SetXY(13, 222);          
                $pdf->MultiCell(30, 4, "Maximum Marks", 0, 'L', 0, 0);
                $pdf->MultiCell(5, 4, ":",0, 'L', 0, 0);
                $pdf->MultiCell(50, 4, $studentData[151], 0, 'L', 0, 0);     
                $pdf->MultiCell(35, 4, "", 0, 'L', 0, 0);     
                $pdf->MultiCell(34, 4, "", 0, 'L', 0, 0);
                $pdf->SetXY(13, 218);          
                $pdf->MultiCell(150, 4, "Result/SGPA  :", 0, 'R', 0, 0);  
                $pdf->MultiCell(0, 4, $studentData[153], 0, 'L', 0, 0);    
                //$pdf->MultiCell(15, 4, number_format((float)$studentData[153], 2, '.', ''), 0, 'L', 0, 0);    
                /*$pdf->SetFont($arial, '', 10.2, '', false);   
                $pdf->SetTextColor(0, 0, 0);
                $pdf->SetXY(13.3, 250.5);
                $pdf->Cell(0, 0, $IssueDate, 0, false, 'L'); */
                //
                $pdfBig->SetFont($arialb, '', 10, '', false);
                $pdfBig->SetXY(13, 218);          
                $pdfBig->MultiCell(30, 4, "Marks Obtained", 0, 'L', 0, 0);
                $pdfBig->MultiCell(5, 4, ":",0, 'L', 0, 0);
                $pdfBig->MultiCell(50, 4, $studentData[152], 0, 'L', 0, 0);     
                $pdfBig->MultiCell(35, 4, "", 0, 'L', 0, 0);     
                $pdfBig->MultiCell(34, 4, "", 0, 'L', 0, 0);
                $pdfBig->SetXY(13, 223);          
                $pdfBig->MultiCell(30, 4, "Maximum Marks", 0, 'L', 0, 0);
                $pdfBig->MultiCell(5, 4, ":",0, 'L', 0, 0);
                $pdfBig->MultiCell(50, 4, $studentData[151], 0, 'L', 0, 0);     
                $pdfBig->MultiCell(35, 4, "", 0, 'L', 0, 0);     
                $pdfBig->MultiCell(34, 4, "", 0, 'L', 0, 0);
                $pdfBig->SetXY(13, 218);          
                $pdfBig->MultiCell(150, 4, "Result/SGPA  :", 0, 'R', 0, 0);  
                $pdfBig->MultiCell(0, 4, $studentData[153], 0, 'L', 0, 0);    
                //$pdfBig->MultiCell(15, 4, number_format((float)$studentData[153], 2, '.', ''), 0, 'L', 0, 0);    
                /*$pdfBig->SetFont($arial, '', 10.2, '', false);   
                $pdfBig->SetTextColor(0, 0, 0);
                $pdfBig->SetXY(13.3, 250.5);
                $pdfBig->Cell(0, 0, $IssueDate, 0, false, 'L');*/
                ...
                $pdf->SetXY(13, 232.7);          
                $pdf->MultiCell(34, 0, "Max. Marks", 1, 'L', 0, 0);
                $pdf->MultiCell(13, 0, $studentData[154], 1, 'C', 0, 0);
                $pdf->MultiCell(13, 0, $studentData[158],1, 'C', 0, 0);   
                $pdf->MultiCell(13, 0, $studentData[162], 1, 'C', 0, 0);
                $pdf->MultiCell(13, 0, $studentData[166], 1, 'C', 0, 0);
                $pdf->MultiCell(13, 0, $studentData[170], 1, 'C', 0, 0);
                $pdf->MultiCell(13, 0, $studentData[174], 1, 'C', 0, 0);
                $pdf->MultiCell(13, 0, $studentData[178], 1, 'C', 0, 0);
                $pdf->MultiCell(13, 0, $studentData[182], 1, 'C', 0, 0);
                $pdf->MultiCell(24, 0, $studentData[186], 1, 'C', 0, 0);   
                $pdf->setCellPaddings( $left = '', $top = '7', $right = '', $bottom = '');
                //$pdf->MultiCell(22, 18.6, $studentData[188], 1, 'C', 0, 0);    
                $pdf->MultiCell(22, 18.6, number_format((float)$studentData[188], 2, '.', ''), 1, 'C', 0, 0);    
                $pdf->setCellPaddings( $left = '', $top = '0', $right = '', $bottom = '');
                $pdf->SetXY(13, 237.2);          
                $pdf->MultiCell(34, 0, "Marks Obtained", 1, 'L', 0, 0);
                $pdf->MultiCell(13, 0, $studentData[155], 1, 'C', 0, 0);
                $pdf->MultiCell(13, 0, $studentData[159],1, 'C', 0, 0);   
                $pdf->MultiCell(13, 0, $studentData[163], 1, 'C', 0, 0);
                $pdf->MultiCell(13, 0, $studentData[167], 1, 'C', 0, 0);
                $pdf->MultiCell(13, 0, $studentData[171], 1, 'C', 0, 0);
                $pdf->MultiCell(13, 0, $studentData[175], 1, 'C', 0, 0);
                $pdf->MultiCell(13, 0, $studentData[179], 1, 'C', 0, 0);
                $pdf->MultiCell(13, 0, $studentData[183], 1, 'C', 0, 0);
                $pdf->MultiCell(24, 0, $studentData[187], 1, 'C', 0, 0);  
                $pdf->SetXY(13, 241.8);          
                $pdf->MultiCell(34, 0, "SGPA", 1, 'L', 0, 0);
                $pdf->MultiCell(13, 0, $studentData[156], 1, 'C', 0, 0);
                $pdf->MultiCell(13, 0, $studentData[160],1, 'C', 0, 0);   
                $pdf->MultiCell(13, 0, $studentData[164], 1, 'C', 0, 0);
                $pdf->MultiCell(13, 0, $studentData[168], 1, 'C', 0, 0);
                $pdf->MultiCell(13, 0, $studentData[172], 1, 'C', 0, 0);
                $pdf->MultiCell(13, 0, $studentData[176], 1, 'C', 0, 0);
                $pdf->MultiCell(13, 0, $studentData[180], 1, 'C', 0, 0);
                $pdf->MultiCell(13, 0, $studentData[184], 1, 'C', 0, 0);
                $pdf->MultiCell(24, 0, "", 1, 'C', 0, 0);   
                /*$pdf->MultiCell(13, 0, number_format((float)$studentData[156], 2, '.', ''), 1, 'C', 0, 0);
                $pdf->MultiCell(13, 0, number_format((float)$studentData[160], 2, '.', ''),1, 'C', 0, 0);   
                $pdf->MultiCell(13, 0, number_format((float)$studentData[164], 2, '.', ''), 1, 'C', 0, 0);
                $pdf->MultiCell(13, 0, number_format((float)$studentData[168], 2, '.', ''), 1, 'C', 0, 0);
                $pdf->MultiCell(13, 0, number_format((float)$studentData[172], 2, '.', ''), 1, 'C', 0, 0);
                $pdf->MultiCell(13, 0, number_format((float)$studentData[176], 2, '.', ''), 1, 'C', 0, 0);
                $pdf->MultiCell(13, 0, number_format((float)$studentData[180], 2, '.', ''), 1, 'C', 0, 0);
                $pdf->MultiCell(13, 0, number_format((float)$studentData[184], 2, '.', ''), 1, 'C', 0, 0);
                $pdf->MultiCell(24, 0, "-", 1, 'C', 0, 0);  */ 
                $pdf->SetXY(13, 246.6);          
                $pdf->MultiCell(34, 0, "Passed In Year", 1, 'L', 0, 0);
                $pdf->MultiCell(13, 0, $studentData[157], 1, 'C', 0, 0);
                $pdf->MultiCell(13, 0, $studentData[161],1, 'C', 0, 0);   
                $pdf->MultiCell(13, 0, $studentData[165], 1, 'C', 0, 0);
                $pdf->MultiCell(13, 0, $studentData[169], 1, 'C', 0, 0);
                $pdf->MultiCell(13, 0, $studentData[173], 1, 'C', 0, 0);
                $pdf->MultiCell(13, 0, $studentData[177], 1, 'C', 0, 0);
                $pdf->MultiCell(13, 0, $studentData[181], 1, 'C', 0, 0);
                $pdf->MultiCell(13, 0, $studentData[185], 1, 'C', 0, 0);
                $pdf->MultiCell(24, 0, "-", 1, 'C', 0, 0);
                ...
                $pdfBig->SetXY(13, 228);          
                $pdfBig->MultiCell(34, 0, "Semester", 1, 'L', 0, 0);
                $pdfBig->MultiCell(13, 0, "I", 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, "II",1, 'C', 0, 0);   
                $pdfBig->MultiCell(13, 0, "III", 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, "IV", 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, "V", 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, "VI", 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, "VII", 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, "VIII", 1, 'C', 0, 0);
                $pdfBig->MultiCell(24, 0, "Total", 1, 'C', 0, 0);    
                $pdfBig->MultiCell(22, 0, "CGPA", 1, 'C', 0, 0);    
                $pdfBig->SetXY(13, 232.7);          
                $pdfBig->MultiCell(34, 0, "Max. Marks", 1, 'L', 0, 0);
                $pdfBig->MultiCell(13, 0, $studentData[154], 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, $studentData[158],1, 'C', 0, 0);   
                $pdfBig->MultiCell(13, 0, $studentData[162], 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, $studentData[166], 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, $studentData[170], 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, $studentData[174], 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, $studentData[178], 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, $studentData[182], 1, 'C', 0, 0);
                $pdfBig->MultiCell(24, 0, $studentData[186], 1, 'C', 0, 0);   
                $pdfBig->setCellPaddings( $left = '', $top = '7', $right = '', $bottom = '');
                //$pdfBig->MultiCell(22, 18.5, $studentData[188], 1, 'C', 0, 0);    
                $pdfBig->MultiCell(22, 18.5, number_format((float)$studentData[188], 2, '.', ''), 1, 'C', 0, 0);    
                $pdfBig->setCellPaddings( $left = '', $top = '0', $right = '', $bottom = '');
                $pdfBig->SetXY(13, 237.2);          
                $pdfBig->MultiCell(34, 0, "Marks Obtained", 1, 'L', 0, 0);
                $pdfBig->MultiCell(13, 0, $studentData[155], 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, $studentData[159],1, 'C', 0, 0);   
                $pdfBig->MultiCell(13, 0, $studentData[163], 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, $studentData[167], 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, $studentData[171], 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, $studentData[175], 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, $studentData[179], 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, $studentData[183], 1, 'C', 0, 0);
                $pdfBig->MultiCell(24, 0, $studentData[187], 1, 'C', 0, 0);  
                $pdfBig->SetXY(13, 241.8);          
                $pdfBig->MultiCell(34, 0, "SGPA", 1, 'L', 0, 0);
                $pdfBig->MultiCell(13, 0, $studentData[156], 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, $studentData[160],1, 'C', 0, 0);   
                $pdfBig->MultiCell(13, 0, $studentData[164], 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, $studentData[168], 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, $studentData[172], 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, $studentData[176], 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, $studentData[180], 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, $studentData[184], 1, 'C', 0, 0);
                $pdfBig->MultiCell(24, 0, "-", 1, 'C', 0, 0);   
                /*$pdfBig->MultiCell(13, 0, number_format((float)$studentData[156], 2, '.', ''), 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, number_format((float)$studentData[160], 2, '.', ''),1, 'C', 0, 0);   
                $pdfBig->MultiCell(13, 0, number_format((float)$studentData[164], 2, '.', ''), 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, number_format((float)$studentData[168], 2, '.', ''), 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, number_format((float)$studentData[172], 2, '.', ''), 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, number_format((float)$studentData[176], 2, '.', ''), 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, number_format((float)$studentData[180], 2, '.', ''), 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, number_format((float)$studentData[184], 2, '.', ''), 1, 'C', 0, 0);
                $pdfBig->MultiCell(24, 0, "-", 1, 'C', 0, 0);  */  
                $pdfBig->SetXY(13, 246.6);         
                $pdfBig->MultiCell(34, 0, "Passed In Year", 1, 'L', 0, 0);
                $pdfBig->MultiCell(13, 0, $studentData[157], 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, $studentData[161],1, 'C', 0, 0);   
                $pdfBig->MultiCell(13, 0, $studentData[165], 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, $studentData[169], 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, $studentData[173], 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, $studentData[177], 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, $studentData[181], 1, 'C', 0, 0);
                $pdfBig->MultiCell(13, 0, $studentData[185], 1, 'C', 0, 0);
                $pdfBig->MultiCell(24, 0, "-", 1, 'C', 0, 0);
...
file_put_contents($local_server_file_path, file_get_contents($destinationURL));
    ...
    public function addCertificate($serial_no, $certName, $dt,$template_id,$admin_id)
    {
        ...
        $resultu = StudentTable::where('serial_no',(string)$serial_no)->update(['status'=>'0']);
        // Insert the new record

...
use Helper;
class PdfGenerateSdmNursingJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        if($studentDataOrg&&!empty($studentDataOrg)){
			...
			$pdfBig->SetXY(100, 106);	
			$pdfBig->MultiCell(81, 0, '', 'T', 'C', 0, 0);	//UIT HR Line
			$pdfBig->SetXY($left_str_x, 110);	
			$pdfBig->MultiCell(180, 0, '', 'T', 'C', 0, 0);	//SSUITR HR Line
			/*
			$pdfBig->SetXY(24.5, 97);	
			$pdfBig->MultiCell(71.5, 13, '', 'LR', 'C', 0, 0);  //Subject
            ...
            */
            $pdfBig->SetXY(24.5, 97);	
			$pdfBig->MultiCell(75.5, 13, '', 'LR', 'C', 0, 0);  //Subject
			$pdfBig->MultiCell(27, 13, '', 'LR', 'C', 0, 0); //UE
			$pdfBig->MultiCell(27, 13, '', 'R', 'C', 0, 0); //IA
			$pdfBig->MultiCell(27, 13, '', 'R', 'C', 0, 0); //Total
			$pdfBig->MultiCell(14, 9, '', 'L', 'C', 0, 0); //Remark
			...
			$pdfBig->SetXY(25, 102);
			$pdfBig->MultiCell(75.5, 5, 'SUBJECT', 0, 'C', 0, 0);
			$pdfBig->SetXY(100, 98);
			$pdfBig->MultiCell(27, 5, 'UNIVERSITY EXAMINATION', 0, 'C', 0, 0);
			$pdfBig->SetXY(127, 98);
			$pdfBig->MultiCell(27, 5, 'INTERNAL ASSESSMENT', 0, 'C', 0, 0);
			$pdfBig->SetXY(154, 100);
			$pdfBig->MultiCell(27, 5, 'TOTAL', 0, 'C', 0, 0);
			$pdfBig->SetXY(180.5, 102);
			$pdfBig->MultiCell(14, 5, 'REMARK', 0, 'C', 0, 0);
			...
			$pdf->SetXY(100, 106);	
			$pdf->MultiCell(81, 0, '', 'T', 'C', 0, 0);	//UIT HR Line
			$pdf->SetXY($left_str_x, 110);	
			$pdf->MultiCell(180, 0, '', 'T', 'C', 0, 0);	//SSUITR HR Line
			
			$pdf->SetXY(24.5, 97);	
			$pdf->MultiCell(75.5, 13, '', 'LR', 'C', 0, 0);  //Subject
			$pdf->MultiCell(27, 13, '', 'LR', 'C', 0, 0); //UE
			$pdf->MultiCell(27, 13, '', 'R', 'C', 0, 0); //IA
			$pdf->MultiCell(27, 13, '', 'R', 'C', 0, 0); //Total
			$pdf->MultiCell(14, 9, '', 'L', 'C', 0, 0); //Remark
			
			$pdf->SetFont($MyriadProRegular, '', 8.5, '', false);
			$pdf->SetXY(14.5, 102);
			$pdf->MultiCell(12.5, 5, 'SL. NO.', 0, 'L', 0, 0);
			$pdf->SetXY(25, 102);
			$pdf->MultiCell(75.5, 5, 'SUBJECT', 0, 'C', 0, 0);
			$pdf->SetXY(100, 98);
			$pdf->MultiCell(27, 5, 'UNIVERSITY EXAMINATION', 0, 'C', 0, 0);
			$pdf->SetXY(127, 98);
			$pdf->MultiCell(27, 5, 'INTERNAL ASSESSMENT', 0, 'C', 0, 0);
			$pdf->SetXY(154, 100);
			$pdf->MultiCell(27, 5, 'TOTAL', 0, 'C', 0, 0);
			$pdf->SetXY(180.5, 102);
			$pdf->MultiCell(14, 5, 'REMARK', 0, 'C', 0, 0);
			...
			$specilisation = strtoupper(trim($studentData[5]));
			...
			// if($course=="B.Sc. NURSING (BASIC)" || $course=="B.SC. NURSING (BASIC)" || $course=="B.sc. NURSING (BASIC)" || $course=="B.Sc. Nursing (Basic)"){
			// 	$note="Eligibility for University Examination: Minimum 50% in Internal Assessment of Theory and Practical separately in each Subject\nMinimum Marks to Pass: 50% aggregate in Theory and 50% aggregate in Practical of University Examination, separately.";				
			// 	$OBT_SEC="OBT";
			// }
            // elseif($course=="B.Sc. NURSING" || $course=="B.SC. NURSING" || $course=="B.sc. NURSING" || $course=="B.Sc. Nursing"){
			// 	$note="Minimum Marks to Pass: 50% aggregate in Theory and 50% aggregate in Practical of University Examination, separately.";
			// 	$OBT_SEC="SEC";
			// }elseif($course=="M.Sc. NURSING" || $course=="M.SC. NURSING" || $course=="M.sc. NURSING" || $course=="M.Sc. Nursing"){
			// 	$note="Eligibility for University Examination: Minimum 50% in Internal Assessment of Theory and Practical separately.\nMinimum Marks to Pass: 50% aggregate in Theory and 50% aggregate in Practical of University Examination Separately.";
			// 	$OBT_SEC="OBT";
			// }elseif($course==strtoupper("General Duty Healthcare Assistant (GDHA)")){
			// 	$note="Eligibility for University Examination: Minimum 50% in Internal Assessment of Theory and Practical separately in each Subject\nMinimum Marks to Pass: 50% aggregate in Theory and 50% aggregate in Practical of University Examination, separately.";
			// 	$OBT_SEC="SEC";
			// }elseif($course==""){
			// 	$note="Minimum Marks to Pass: 50% aggregate in Theory and 50% aggregate in Practical of University Examination, separately.";
           ...
           // Normalize the course input by converting it to lowercase and removing spaces
            $normalized_course = strtolower(str_replace(' ', '', $course));

            if ($normalized_course === "b.sc.nursing(basic)") {
                $note="Eligibility for University Examination: Minimum 50% in Internal Assessment of Theory and Practical separately in each Subject\nMinimum Marks to Pass: 50% aggregate in Theory and 50% aggregate in Practical of University Examination, separately.";	
                $OBT_SEC = "OBT";
            } elseif ($normalized_course === "b.sc.nursing") {
                $note="Minimum Marks to Pass: 50% aggregate in Theory and 50% aggregate in Practical of University Examination, separately.";
                $OBT_SEC = "SEC";
            } elseif ($normalized_course === "m.sc.nursing") {
                $note="Eligibility for University Examination: Minimum 50% in Internal Assessment of Theory and Practical separately.\nMinimum Marks to Pass: 50% aggregate in Theory and 50% aggregate in Practical of University Examination Separately.";
                $OBT_SEC = "OBT";
            } elseif ($normalized_course === strtolower(str_replace(' ', '', "General Duty Healthcare Assistant (GDHA)"))) {
                $note="Eligibility for University Examination: Minimum 50% in Internal Assessment of Theory and Practical separately in each Subject\nMinimum Marks to Pass: 50% aggregate in Theory and 50% aggregate in Practical of University Examination, separately.";
                $OBT_SEC = "SEC";
            } elseif (empty($course)) {
                $note="Minimum Marks to Pass: 50% aggregate in Theory and 50% aggregate in Practical of University Examination, separately.";
			...
			$pdfBig->SetFont($MyriadProRegular, '', 8.5, '', false);
			$pdfBig->SetXY(100, 106.5);
			$pdfBig->MultiCell(9, 0, 'MAX', 0, 'C', 0, 0);
			$pdfBig->MultiCell(9, 0, 'MIN', 0, 'C', 0, 0);
			$pdfBig->MultiCell(9, 0, $OBT_SEC, 0, 'C', 0, 0);
			$pdfBig->MultiCell(9, 0, 'MAX', 0, 'C', 0, 0);
			$pdfBig->MultiCell(9, 0, 'MIN', 0, 'C', 0, 0);
			$pdfBig->MultiCell(9, 0, $OBT_SEC, 0, 'C', 0, 0);
			$pdfBig->MultiCell(9, 0, 'MAX', 0, 'C', 0, 0);
			...
			$pdf->MultiCell(9, 0, 'MAX', 0, 'C', 0, 0);
			$pdf->MultiCell(9, 0, 'MIN', 0, 'C', 0, 0);
			$pdf->MultiCell(9, 0, $OBT_SEC, 0, 'C', 0, 0);
			$pdf->MultiCell(9, 0, 'MAX', 0, 'C', 0, 0);
			$pdf->MultiCell(9, 0, 'MIN', 0, 'C', 0, 0);
			$pdf->MultiCell(9, 0, $OBT_SEC, 0, 'C', 0, 0);
			$pdf->MultiCell(9, 0, 'MAX', 0, 'C', 0, 0);
			...
			foreach ($subjectsArr as $subjectDatas){
				...
				$T_Max = trim($subjectDatas[8]);	
				$T_Min = trim($subjectDatas[9]);	
				$T_Sec = trim($subjectDatas[10]);	
				$Remark = strtoupper(trim($subjectDatas[11]));	
				/*start pdfbig line*/
				// store current object
				$pdfBig->startTransaction();
				$pdfBig->SetFont($MyriadProRegular, '', 10, '', false);	 				
				// get the number of lines
				$lines = $pdfBig->MultiCell(75.5, 0, $Subject_Name, 0, 'L', 0, 0, '', '', true, 0, false,true, 0);
				...
				// get the number of lines
				$lines_pdf = $pdf->MultiCell(75.5, 0, $Subject_Name, 0, 'L', 0, 0, '', '', true, 0, false,true, 0);
				// restore previous object
				...
				$pdf->SetFont($MyriadProRegular, '', 10, '', false);					
					...
					$pdfBig->MultiCell(75.5, $th_height, $Subject_Name, 'LR', 'L', 0, 0);					
					$pdfBig->SetXY(100, $subj_y);
					
					$pdf->SetXY($left_str_x, $subj_y);
					$pdf->MultiCell(9.5, $th_height, $Sr_no, 'LR', 'C', 0, 0);
					$pdf->MultiCell(75.5, $th_height, $Subject_Name, 'LR', 'L', 0, 0);					
					$pdf->SetXY(100, $subj_y);
					
					$pdfBig->MultiCell(9, $th_height_half, $UE_Max, 'LR', 'C', 0, 0);
					$pdfBig->MultiCell(9, $th_height_half, $UE_Min, 'LR', 'C', 0, 0);
					$pdfBig->MultiCell(9, $th_height_half, $UE_Sec, 'LR', 'C', 0, 0);
					$pdfBig->MultiCell(9, $th_height_half, $IA_Max, 'LR', 'C', 0, 0);
					$pdfBig->MultiCell(9, $th_height_half, $IA_Min, 'LR', 'C', 0, 0);
					$pdfBig->MultiCell(9, $th_height_half, $IA_Sec, 'LR', 'C', 0, 0);
					$pdfBig->MultiCell(9, $th_height_half, $T_Max, 'LR', 'C', 0, 0);
					$pdfBig->MultiCell(9, $th_height_half, $T_Min, 'LR', 'C', 0, 0);
					$pdfBig->MultiCell(9, $th_height_half, $T_Sec, 'LR', 'C', 0, 0);
					$pdfBig->MultiCell(14, $th_height_half, $Remark, 'LR', 'C', 0, 0);
					
                    /*$pdf->MultiCell(10, $th_height_half, $UE_Max, 'LR', 'C', 0, 0);
					$pdf->MultiCell(10, $th_height_half, $UE_Min, 'LR', 'C', 0, 0);
					$pdf->MultiCell(10.3, $th_height_half, $UE_Sec, 'LR', 'C', 0, 0);
					$pdf->MultiCell(10.2, $th_height_half, $IA_Max, 'LR', 'C', 0, 0);
					$pdf->MultiCell(9.5, $th_height_half, $IA_Min, 'LR', 'C', 0, 0);
					$pdf->MultiCell(9.5, $th_height_half, $IA_Sec, 'LR', 'C', 0, 0);
					$pdf->MultiCell(7.666666666666667, $th_height_half, $T_Max, 'LR', 'C', 0, 0);
					$pdf->MultiCell(7.666666666666667, $th_height_half, $T_Min, 'LR', 'C', 0, 0);
					$pdf->MultiCell(7.666666666666667, $th_height_half, $T_Sec, 'LR', 'C', 0, 0);
					$pdf->MultiCell(16, $th_height_half, $Remark, 'LR', 'C', 0, 0);*/

					$pdf->MultiCell(9, $th_height_half, $UE_Max, 'LR', 'C', 0, 0);
					$pdf->MultiCell(9, $th_height_half, $UE_Min, 'LR', 'C', 0, 0);
					$pdf->MultiCell(9, $th_height_half, $UE_Sec, 'LR', 'C', 0, 0);
					$pdf->MultiCell(9, $th_height_half, $IA_Max, 'LR', 'C', 0, 0);
					$pdf->MultiCell(9, $th_height_half, $IA_Min, 'LR', 'C', 0, 0);
					$pdf->MultiCell(9, $th_height_half, $IA_Sec, 'LR', 'C', 0, 0);
					$pdf->MultiCell(9, $th_height_half, $T_Max, 'LR', 'C', 0, 0);
					$pdf->MultiCell(9, $th_height_half, $T_Min, 'LR', 'C', 0, 0);
					$pdf->MultiCell(9, $th_height_half, $T_Sec, 'LR', 'C', 0, 0);
					$pdf->MultiCell(14, $th_height_half, $Remark, 'LR', 'C', 0, 0);
			...
			$pdfBig->SetXY($left_str_x, $subj_y);	
			$pdfBig->MultiCell(139, 5, 'GRAND TOTAL:', 'LTRB', 'R', 0, 0); 
			$pdfBig->SetFont($MyriadProRegular, '', 9, '', false);
			...
			*/
			...
			$pdf->SetXY($left_str_x, $subj_y2);	
            
			$pdf->MultiCell(139, 5, 'GRAND TOTAL:', 'LTRB', 'R', 0, 0); 
			$pdf->SetFont($MyriadProRegular, '', 10, '', false);

...
class PdfGenerateKESSCJob3
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        $profile_path_org = public_path().'\\'.$subdomain[0].'\backend\templates\100\\'.$studentData[201];
...
$pdfBig->Text(110, 92, 'Yellow');*/
   ...
   /* imagefilter($profile_path, IMG_FILTER_GRAYSCALE);
    ...
    $subjectData = array_slice($studentData, 9, 120);
    ...
    <th style="width:6%;text-align:center;"><b>'.$studentData[153].'<br></b></th>
    <th style="width:7%;text-align:center;"><b>'.$studentData[154].'<br></b></th>
    <th style="width:6%;text-align:center;"><b>'.$studentData[155].'<br></b></th>
    <th style="width:7%;text-align:center;"><b>'.$studentData[156].'<br></b></th>
    <th style="width:5%;text-align:center;"><b>'.$studentData[157].'<br></b></th>
    <th style="width:5%;text-align:center;"><b></b></th>
    <th style="width:6%;text-align:center;"><b>'.$studentData[158].'<br></b></th>
    <th style="width:6%;text-align:center;"><b>'.$studentData[159].'<br></b></th>
    <th style="width:6%;text-align:center;"><b>'.$studentData[160].'<br></b></th>
    <th style="width:6%;text-align:center;"><b>'.$studentData[161].'<br></b></th>
   </tr>';

    $strtdBig .= '<tr>
    <th style="width:11%;text-align:center;"></th>
    <th style="width:29%;text-align:center;">Total</th>
    <th style="width:6%;text-align:center;"><b>'.$studentData[153].'<br><span style="color:yellow;">'.$studentData[153].'</span></b></th>
    <th style="width:7%;text-align:center;"><b>'.$studentData[154].'<br><span style="color:yellow;">'.$studentData[154].'</span></b></th>
    <th style="width:6%;text-align:center;"><b>'.$studentData[155].'<br><span style="color:yellow;">'.$studentData[155].'</span></b></th>
    <th style="width:7%;text-align:center;"><b>'.$studentData[156].'<br><span style="color:yellow;">'.$studentData[156].'</span></b></th>
    <th style="width:5%;text-align:center;"><b>'.$studentData[157].'<br><span style="color:yellow;">'.$studentData[157].'</span></b></th>
    <th style="width:5%;text-align:center;"><b></b></th>
    <th style="width:6%;text-align:center;"><b>'.$studentData[158].'<br><span style="color:yellow;">'.$studentData[158].'</span></b></th>
    <th style="width:6%;text-align:center;"><b>'.$studentData[159].'<br><span style="color:yellow;">'.$studentData[159].'</span></b></th>
    <th style="width:6%;text-align:center;"><b>'.$studentData[160].'<br><span style="color:yellow;">'.$studentData[160].'</span></b></th>
    <th style="width:6%;text-align:center;"><b>'.$studentData[161].'<br><span style="color:yellow;">'.$studentData[161].'</span></b></th>
   </tr>';
    $html = <<<EOD
<style>
 th{
...
<table id="table4" cellspacing="0" cellpadding="2" border="0.1" width="99%">
    <tr>
    <th colspan="2" style="width:20%;text-align:left;">Remark : {$studentData[162]}</th>
    <th style="width:16%;text-align:left;">Grade : {$studentData[163]}</th>
    <th style="width:16%;text-align:left;">Credit Earned : {$studentData[164]}</th>
    <th style="width:16%;text-align:left;">SGPA : {$studentData[165]}</th>
    <th style="width:16%;text-align:left;">CGPA : {$studentData[166]}</th>
    <th style="width:16%;text-align:left;">Overall : {$studentData[167]}</th>
    </tr>
    <tr>
      <td style="width:16%;text-align:left;">Credit Earned</td>
    <td style="width:14%;text-align:left;">Sem I : <b>{$studentData[168]}</b></td>
    <td style="width:14%;text-align:left;">Sem II : <b>{$studentData[169]}</b></td>
    <td style="width:14%;text-align:left;">Sem III : <b>{$studentData[170]}</b></td>
    <td style="width:14%;text-align:left;">Sem IV : <b>{$studentData[171]}</b></td>
    <td style="width:14%;text-align:left;">Sem V : <b>{$studentData[172]}</b></td>
    <td style="width:14%;text-align:left;">Sem VI: <b>{$studentData[173]}</b></td>
    </tr>
    <tr>
      <td style="width:16%;text-align:left;">SGPA</td>
    <td style="width:14%;text-align:left;">Sem I : <b>{$studentData[174]}</b></td>
    <td style="width:14%;text-align:left;">Sem II : <b>{$studentData[175]}</b></td>
    <td style="width:14%;text-align:left;">Sem III : <b>{$studentData[176]}</b></td>
    <td style="width:14%;text-align:left;">Sem IV : <b>{$studentData[177]}</b></td>
    <td style="width:14%;text-align:left;">Sem V : <b>{$studentData[178]}</b></td>
    <td style="width:14%;text-align:left;">Sem VI: <b>{$studentData[179]}</b></td>
    </tr>
  </table>
EOD;
...
$pdfBig->writeHTMLCell($w=0, $h=0, $x='12', $y='194.7', $html, $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true);
     ...
     $semArr[1]=array($studentData[193],$studentData[194],$studentData[195],$studentData[196],$studentData[197],$studentData[198]);

    $z=0;
    $sr='';
    $strtd='';
    if(!empty($studentData[180])){
        $sr=$z=$z+1;
        $strtd .='<tr>
    <td style="width:9%;text-align:center;"><b>'.$z.'</b></td>
    <td colspan="2" style="width:54%;text-align:left;">'.$studentData[180].'</td>
    <td style="width:12%;text-align:center;">'.$studentData[181].'</td>
    <td style="width:12%;text-align:center;">'.$semArr[0][$z-1].'</td>
    <td style="width:13%;text-align:center;">'.$semArr[1][$z-1].'</td>
    </tr>';
    }
    
    if(!empty($studentData[182])){
        $sr=$z=$z+1;
    
   $strtd .='<tr>
    <td style="width:9%;text-align:center;"><b>'.$z.'</b></td>
    <td colspan="2" style="width:54%;text-align:left;">'.$studentData[182].'</td>
    <td style="width:12%;text-align:center;">'.$studentData[183].'</td>
    <td style="width:12%;text-align:center;">'.$semArr[0][$z-1].'</td>
    <td style="width:13%;text-align:center;">'.$semArr[1][$z-1].'</td>
    </tr>'; 
    }
    if(!empty($studentData[184])){
        $sr=$z=$z+1;
    
    $strtd .='<tr>
    <td style="width:9%;text-align:center;">'.$z.'</td>
    <td colspan="2" style="width:54%;text-align:left;">'.$studentData[184].'</td>
    <td style="width:12%;text-align:center;">'.$studentData[185].'</td>
    <td style="width:12%;text-align:center;">'.$semArr[0][$z-1].'</td>
    <td style="width:13%;text-align:center;">'.$semArr[1][$z-1].'</td>
    </tr>';
    }
    if(!empty($studentData[186])){
        $sr=$z=$z+1;
    
    $strtd .='<tr>
    <td style="width:9%;text-align:center;">'.$z.'</td>
    <td colspan="2" style="width:54%;text-align:left;">'.$studentData[186].'</td>
    <td style="width:12%;text-align:center;">'.$studentData[187].'</td>
    <td style="width:12%;text-align:center;">'.$semArr[0][$z-1].'</td>
    <td style="width:13%;text-align:center;">'.$semArr[1][$z-1].'</td>
    </tr>';
    }

    if(!empty($studentData[188])){
        $sr=$z=$z+1;
    
    $strtd .='<tr>
    <td style="width:9%;text-align:center;">'.$z.'</td>
    <td colspan="2" style="width:54%;text-align:left;">'.$studentData[188].'</td>
    <td style="width:12%;text-align:center;">'.$studentData[189].'</td>
    <td style="width:12%;text-align:center;">'.$semArr[0][$z-1].'</td>
    <td style="width:13%;text-align:center;">'.$semArr[1][$z-1].'</td>
    </tr>';
    }

    if(!empty($studentData[190])){
        $sr=$z=$z+1;
    
    $strtd .='<tr>
    <td style="width:9%;text-align:center;">'.$z.'</td>
    <td colspan="2" style="width:54%;text-align:left;">'.$studentData[190].'</td>
    <td style="width:12%;text-align:center;">'.$studentData[191].'</td>
    <td style="width:12%;text-align:center;">'.$semArr[0][$z-1].'</td>
    <td style="width:13%;text-align:center;">'.$semArr[1][$z-1].'</td>
    </tr>';
    }
    if($z<=4){
        ...
        $z=6;
        $strtd .='<tr>
    <th style="width:25%;text-align:left;" class="no-border-right">Place : '.$studentData[199].'</th>
    <th style="width:26%;text-align:center;" class="no-border-right">Date : '.$studentData[200].'</th>
    <th style="width:12%;text-align:center;">Total Credit</th>
    <th style="width:12%;text-align:center;">'.$studentData[192].'</th>
    <td style="width:12%;text-align:center;">'.$semArr[0][$z-1].'</td>
    <td style="width:13%;text-align:center;">'.$semArr[1][$z-1].'</td>
    </tr>';
    ...
    <td style="width:13%;text-align:center;">'.$semArr[1][$z-1].'</td>
        ...
        if(!empty($studentData[200])){
            $dateCert=date('d/m/Y',strtotime($studentData[200]));
        }else{
            $dateCert='';
        }
        ...
        $strtd .='<tr>
    <th style="width:25%;text-align:left;" class="no-border-right">Place : '.$studentData[199].'</th>
    <th style="width:26%;text-align:center;" class="no-border-right">Date : '.$dateCert.'</th>
    <th style="width:12%;text-align:center;">Total Credit</th>
    <th style="width:12%;text-align:center;">'.$studentData[192].'</th>
    <td style="width:12%;text-align:center;"></td>
...
// Ghost image
        ...
        $codeContents = "Name of the Learner: ".$studentData[1]."\nPRN/Reg.No: ".$studentData[7]."\nMonths & Year of Examination: ".$studentData[6]."\n\n".$encryptedString;
       ...
       if($previewPdf!=1){
        $this->updateCardNo('KESSC-GC2',$card_serial_no-$cardDetails->starting_serial_no,$card_serial_no);
       }
       $msg = '';
        
        $file_name =  str_replace("/", "_",'KESSC-GC2'.date("Ymdhms")).'.pdf';

        ...
        if($studentDataOrg&&!empty($studentDataOrg)){  
            foreach ($studentDataOrg as $studentData) {
                ...
                */
                ...
                /*******Hindi*******/
                $pdfBig->SetFont('kokila', 'R', 18);
                $pdfBig->SetTextColor(0, 0, 0);
                $pdfBig->SetXY(20, 163);
                $pdfBig->MultiCell(46, 0, 'प्रमाणित किया जाता है कि', 0, 'L'); 
                $pdfBig->SetFont('kokila', 'B', 23);
                $pdfBig->SetTextColor(52, 57, 138);
                $pdfBig->SetDash(1,1);
                $pdfBig->Line(65,165,230,165);
                $pdfBig->SetXY(66, 154);
                $pdfBig->MultiCell(132, 10, $hindi_candidate_name, 0, 'C');
                $pdfBig->SetFont('kokila', 'R', 18);
                $pdfBig->SetTextColor(0, 0, 0);
                $pdfBig->SetXY(20, 174);
                $pdfBig->MultiCell(44, 0, 'आत्मज / आत्मजा श्री.', 0, 'L', 0, 0);
                $pdfBig->SetFont('kokila', 'B', 18);
                $pdfBig->SetTextColor(52, 57, 138);
                $pdfBig->SetDash(1,1);
                $pdfBig->SetXY(59, 166); 
                $pdfBig->MultiCell(78, 10, $Hindi_Father_Name, 'B', 'C');
                $pdfBig->SetFont('kokila', 'R', 18);
                $pdfBig->SetTextColor(0, 0, 0);
                $pdfBig->SetXY(137, 174);
                $pdfBig->MultiCell(24, 0, 'एवं श्रीमती.', 0, 'L', 0, 0);
                $pdfBig->SetFont('kokila', 'B', 18);
                $pdfBig->SetTextColor(52, 57, 138);
                $pdfBig->SetXY(157.5, 166);
                $pdfBig->MultiCell(73, 10, $Hindi_Mother_Name, 'B', 'C');
                $pdfBig->SetFont('kokila', 'R', 18);
                $pdfBig->SetTextColor(0, 0, 0);
                $pdfBig->SetXY(20, 184);
                $pdfBig->MultiCell(49, 0, 'को इस विश्‍वविद्यालय से सन्', 0, 'L', 0, 0);
                $pdfBig->SetFont('kokila', 'B', 18);
                $pdfBig->SetTextColor(52, 57, 138);
                $pdfBig->SetXY(69, 176);
                $pdfBig->MultiCell(40, 10, $Exam_Year, 'B', 'C');
                $pdfBig->SetFont('kokila', 'R', 18);
                $pdfBig->SetTextColor(0, 0, 0);
                ...
                $pdfBig->SetTextColor(0, 0, 0);
                $pdfBig->SetXY(20, 194);
                $pdfBig->MultiCell(33, 0, 'पाठ्यक्रम परीक्षा में', 0, 'L', 0, 0);
                $pdfBig->SetFont('kokila', 'B', 18);
                $pdfBig->SetTextColor(52, 57, 138);
                $pdfBig->SetXY(52, 186);
                $pdfBig->MultiCell(152, 10, $Hindi_Degree, 'B', 'C'); 
                $pdfBig->SetFont('kokila', 'R', 18);
                $pdfBig->SetTextColor(0, 0, 0);
                $pdfBig->SetXY(204, 194);
                $pdfBig->MultiCell(31, 0, 'की सनद/उपाधि', 0, 'L', 0, 0);
                $pdfBig->SetFont('kokila', 'B', 18);
                $pdfBig->SetTextColor(52, 57, 138);
                $pdfBig->SetXY(21, 196);
                ...
                $pdfBig->MultiCell(44, 0, 'श्रेणी में प्रदत्त की गयी है।', 0, 'L', 0, 0);			
                /*******English*******/
                ...
                $pdfBig->SetDash(1,1);
                $pdfBig->SetXY(34, 251);
                $pdfBig->MultiCell(122, 10, $Degree_In, 'B', 'C');
                $pdfBig->SetFont('timesi', '', 15);
                $pdfBig->SetTextColor(0, 0, 0);
                $pdfBig->SetXY(155, 259);
                $pdfBig->MultiCell(50, 0, 'course examination of', 0, 'L', 0, 0);			
                $pdfBig->SetFont('timesb', '', 16);
                $pdfBig->SetTextColor(52, 57, 138);				
                $pdfBig->SetXY(205, 251);			
                $pdfBig->MultiCell(23, 10, $Exam_Year, 'B', 'C');
                ...
                $pdfBig->MultiCell(46, 0, 'of this University in', 0, 'L', 0, 0);
                $pdfBig->SetDash(1,1);
                //$pdfBig->Line(50,268,210,268);
                $pdfBig->SetFont('timesb', '', 16);
                $pdfBig->SetXY(65, 261);
                $pdfBig->SetTextColor(52, 57, 138);
                $pdfBig->MultiCell(142.5, 10, $Remark, 'B', 'C');
                $pdfBig->SetFont('timesi', '', 15);
                $pdfBig->SetTextColor(0, 0, 0);
                $pdfBig->SetXY(209, 269);
                $pdfBig->MultiCell(28, 0, 'Division.', 0, 'L');
                
                $pdfBig->SetFont('times', 'R', 17.5);	
                $pdfBig->SetXY(15, 312);
                ...
                /*******Hindi*******/
                $pdf->SetFont('kokila', 'R', 18);
                $pdf->SetTextColor(0, 0, 0);
                $pdf->SetXY(20, 163);
                $pdf->MultiCell(46, 0, 'प्रमाणित किया जाता है कि', 0, 'L'); 
                $pdf->SetFont('kokila', 'B', 23);
                $pdf->SetTextColor(52, 57, 138);
                $pdf->SetDash(1,1);
                $pdf->Line(65,165,230,165);
                $pdf->SetXY(65, 154);
                $pdf->MultiCell(166, 10, $hindi_candidate_name, 0, 'C');
                $pdf->SetFont('kokila', 'R', 18);
                $pdf->SetTextColor(0, 0, 0);
                $pdf->SetXY(20, 174);
                $pdf->MultiCell(44, 0, 'आत्मज / आत्मजा श्री.', 0, 'L', 0, 0);
                $pdf->SetFont('kokila', 'B', 18);
                $pdf->SetTextColor(52, 57, 138);
                $pdf->SetDash(1,1);
                $pdf->SetXY(59, 166); 
                $pdf->MultiCell(78, 10, $Hindi_Father_Name, 'B', 'C');
                $pdf->SetFont('kokila', 'R', 18);
                $pdf->SetTextColor(0, 0, 0);
                $pdf->SetXY(137, 174);
                $pdf->MultiCell(24, 0, 'एवं श्रीमती.', 0, 'L', 0, 0);
                $pdf->SetFont('kokila', 'B', 18);
                $pdf->SetTextColor(52, 57, 138);
                $pdf->SetXY(157.5, 166);
                $pdf->MultiCell(73, 10, $Hindi_Mother_Name, 'B', 'C');
                $pdf->SetFont('kokila', 'R', 18);
                $pdf->SetTextColor(0, 0, 0);
                $pdf->SetXY(20, 184);
                $pdf->MultiCell(49, 0, 'को इस विश्‍वविद्यालय से सन्', 0, 'L', 0, 0);
                $pdf->SetFont('kokila', 'B', 18);
                $pdf->SetTextColor(52, 57, 138);
                $pdf->SetXY(69, 176);
                $pdf->MultiCell(40, 10, $Exam_Year, 'B', 'C');
                $pdf->SetFont('kokila', 'R', 18);
                $pdf->SetTextColor(0, 0, 0);
                $pdf->SetXY(107, 184);
                ...
                $pdf->SetTextColor(0, 0, 0);
                $pdf->SetXY(20, 194);
                $pdf->MultiCell(33, 0, 'पाठ्यक्रम परीक्षा में', 0, 'L', 0, 0);
                $pdf->SetFont('kokila', 'B', 18);
                $pdf->SetTextColor(52, 57, 138);
                $pdf->SetXY(52, 186);
                $pdf->MultiCell(152, 10, $Hindi_Degree, 'B', 'C'); 
                $pdf->SetFont('kokila', 'R', 18);
                $pdf->SetTextColor(0, 0, 0);
                $pdf->SetXY(204, 194);
                $pdf->MultiCell(31, 0, 'की सनद/उपाधि', 0, 'L', 0, 0);
                $pdf->SetFont('kokila', 'B', 18);
                $pdf->SetTextColor(52, 57, 138);
                $pdf->SetXY(21, 196);
                ...
                $pdf->SetTextColor(0, 0, 0);
                $pdf->SetXY(191, 204);
                $pdf->MultiCell(44, 0, 'श्रेणी में प्रदत्त की गयी है।', 0, 'L', 0, 0);			
                /*******English*******/
                ...
                $pdf->SetTextColor(52, 57, 138);				
                $pdf->SetXY(205, 251);			
                $pdf->MultiCell(23, 10, $Exam_Year, 'B', 'C');
                ...
                $pdf->SetFont('timesi', '', 15);
                $pdf->SetXY(20.5, 269);
                $pdf->MultiCell(46, 0, 'of this University in', 0, 'L', 0, 0);
                $pdf->SetDash(1,1);
                //$pdf->Line(50,268,210,268);
                $pdf->SetFont('timesb', '', 16);
                $pdf->SetXY(65, 261);
                $pdf->SetTextColor(52, 57, 138);
                $pdf->MultiCell(142.5, 10, $Remark, 'B', 'C');
                $pdf->SetFont('timesi', '', 15);
                $pdf->SetTextColor(0, 0, 0);
                $pdf->SetXY(209, 269);
                $pdf->MultiCell(28, 0, 'Division.', 0, 'L');
                
                $pdf->SetFont('times', 'R', 17.5);	
                $pdf->SetXY(15, 312);

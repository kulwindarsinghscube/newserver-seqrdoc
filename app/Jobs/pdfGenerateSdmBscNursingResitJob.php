...
use Helper;
class pdfGenerateSdmBscNursingResitJob{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
            ...
            // vertical line between Marks OBTINED PASS MARKS OUT OF 
			...
			$pdfBig->MultiCell(14, 0, 'MARKS OBTINED', 0, 'C', 0, 0); //UA
			$pdfBig->MultiCell(14, 0, 'PASS MARKS OUT OF', 0, 'C', 0, 0);
			$pdfBig->MultiCell(19.5, 0, 'MARKS OBTINED', 0, 'C', 0, 0); //IN
            ...
            $pdf->SetFont($MyriadProRegular, '', 7.5, '', false);
			$pdf->SetXY(90, 108.5);
			$pdf->MultiCell(14, 0, 'MARKS OBTINED', 0, 'C', 0, 0); //UA
			$pdf->MultiCell(14, 0, 'PASS MARKS OUT OF', 0, 'C', 0, 0);
			$pdf->MultiCell(19.5, 0, 'MARKS OBTINED', 0, 'C', 0, 0); //IN
            ...
            foreach ($subjectsArr as $subjectDatas){
                ...
                if ($th_pr_val == 'TH|PR') {
                    ...
                    $pdfBig->setCellPaddings(2, 4, 6, 8);

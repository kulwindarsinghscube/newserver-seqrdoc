...
class ValidateExcelChanakyaPhdJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        // dd($columnsCount2);
                if($dropdown_template_id==4)
                {
                    ...
                    if($columnsCount1==11 &&$columnsCount2==8)

                    {
                        // dd($columnsCount1);
                        // $columnArr=array('Register ID','student Name','Terms','Course_Code','Subject_Title','Credits','Grade','Grade Point ','CGP');
                        $columnArr=array('Unique_Id','student Name','Programme','Register No','Terms','SGPA Secured','SGPA_Total credit of all semesters','CGPA Secured','CGPA_Total credit of all semesters','serial_no','PHD_title');
                        // dd( $columnArr);

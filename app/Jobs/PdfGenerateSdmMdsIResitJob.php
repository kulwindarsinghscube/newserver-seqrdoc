...
use Helper;
class PdfGenerateSdmMdsIResitJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
			...
			$pdfBig->MultiCell(180, 42, '', 'LRTB', 'C', 0, 0);	//Entire Table
			...
			$pdfBig->MultiCell(112, 42, '', 'L', 'C', 0, 0); //middle vline
			...
			$pdf->MultiCell(180, 42, '', 'LRTB', 'C', 0, 0);	//Entire Table
			...
			$pdf->SetXY(123, 102);	
			$pdf->MultiCell(112, 42, '', 'L', 'C', 0, 0); //middle vline

...
$pdfBig->writeHTMLCell($w=0, $h=0, $x='12', $y='194.7', $html, $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true);
   ...
   $strtd .='<tr>
    ...
    if($z<=4){
        ...
        $z=6;
        $strtd .='<tr>
    <th style="width:25%;text-align:left;" class="no-border-right">Place : '.$studentData[139].'</th>
    <th style="width:26%;text-align:center;" class="no-border-right">Date : '.$studentData[140].'</th>

...
use Helper;
class PdfGenerateSdmNursingResitJob
{
        ...
        if($studentDataOrg&&!empty($studentDataOrg)){
            foreach ($studentDataOrg as $studentData) {
                ...
                foreach ($subjectsArr as $subjectDatas){
                    ...
                    // get the number of lines
                    $lines_pdf = $pdf->MultiCell(71.5, 0, $Subject_Name, 0, 'L', 0, 0, '', '', true, 0, false,true, 0);
                    // restore previous object
                    ...
                    */
                    ...
                    if($Subject_Name!=""){
                        ...
                        $pdfBig->MultiCell(75.5, $th_height, $Subject_Name, 1, 'L', 0, 0);					
                        $pdfBig->SetXY(100, $subj_y);
                        
                        $pdf->SetXY($left_str_x, $subj_y);
                        $pdf->MultiCell(9.5, $th_height, $Sr_no, 1, 'C', 0, 0);
                        $pdf->MultiCell(75.5, $th_height, $Subject_Name, 1, 'L', 0, 0);					
                        $pdf->SetXY(100, $subj_y);
                        
                        $pdfBig->MultiCell(9, $th_height_half, $UE_Max, 1, 'C', 0, 0);
                        ...
                        $pdfBig->MultiCell(14, $th_height_half, $Remark, 1, 'C', 0, 0);
                        
                        // $pdf->MultiCell(10, $th_height_half, $UE_Max, 1, 'C', 0, 0);
                        // $pdf->MultiCell(10, $th_height_half, $UE_Min, 1, 'C', 0, 0);
                        // $pdf->MultiCell(10.3, $th_height_half, $UE_Sec, 1, 'C', 0, 0);
                        // $pdf->MultiCell(10.2, $th_height_half, $IA_Max, 1, 'C', 0, 0);
                        // $pdf->MultiCell(9.5, $th_height_half, $IA_Min, 1, 'C', 0, 0);
                        // $pdf->MultiCell(9.5, $th_height_half, $IA_Sec, 1, 'C', 0, 0);
                        // $pdf->MultiCell(7.666666666666667, $th_height_half, $T_Max, 1, 'C', 0, 0);
                        // $pdf->MultiCell(7.666666666666667, $th_height_half, $T_Min, 1, 'C', 0, 0);
                        // $pdf->MultiCell(7.666666666666667, $th_height_half, $T_Sec, 1, 'C', 0, 0);
                        // $pdf->MultiCell(14, $th_height_half, $Remark, 1, 'C', 0, 0);	
                        
                        $pdf->MultiCell(9, $th_height_half, $UE_Max, 1, 'C', 0, 0);
                ...
                $subj_single_y = $subj_y;
                /******Start pdfBig ******/ 
                /*Grand Total*/
                $pdfBig->SetFont($MyriadProBold, 'B', 10, '', false);
                $pdfBig->SetXY($left_str_x, $subj_y);	
                $pdfBig->MultiCell(139, 5, 'GRAND TOTAL:', 'LRB', 'R', 0, 0); 
                $pdfBig->SetFont($MyriadProRegular, '', 10, '', false);
                ...
                */
                ...
                /******Start pdf ******/
                /*Grand Total*/
                // dd($subj_y,$subj_single_y);
                $subj_y = $subj_single_y;
                
                $pdf->SetFont($MyriadProBold, 'B', 10, '', false);
                $pdf->SetXY($left_str_x, $subj_y);	
                $pdf->MultiCell(139, 5, 'GRAND TOTAL:', 'LRB', 'R', 0, 0); 
                $pdf->SetFont($MyriadProRegular, '', 10, '', false);
                ...
                $pdf->MultiCell(139, 5, 'GRAND TOTAL IN WORDS:', 'LR', 'R', 0, 0); 
                $pdf->MultiCell(41, 5, $Grand_Total_In_Words, 'R', 'L', 0, 0);
                ...
                $pdf->MultiCell(139, 5, 'RESULT:', 'LRB', 'R', 0, 0); 
                $pdf->MultiCell(41, 5, $Result, 'LRB', 'L', 0, 0);
                // dd($subj_y);
                $pdf->SetXY(14, $subj_y+21.5);
                $pdf->SetFont($MyriadProItalic, 'I', 10, '', false);
                $pdf->MultiCell(0, 0, $note, 0, 'L', 0, 0);			
                $subj_y=$pdf->GetY();
                /*2nd box start*/ 
                /*2nd box start*/
                $pdf->SetFont($arialNarrow, '', 2, '', false);

...
class PdfGenerateCavendishBITLAWAESS2Job
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        $log_serial_no = 1;
        //$cardDetails=$this->getNextCardNo('CAVENDISH-BIT-LAW-AESS-2');
        ...
        $excelFolderPath = public_path().'\\'.$subdomain[0].'\backend\upload_excel\bit_law_aess_2_year\excel';
        ...
        foreach($files as $file) {
            ...
            $records = $this->getArrayFromBIT_AESS_2_Excel($sheet1);
            ...
            $imagePath = $subdomain[0].'\backend\upload_excel\bit_law_aess_2_year\photo/'.$fileDetail['filename'].'.PNG';
            $pdfBig->SetXY(177, 12);
            ...
            if($previewPdf!=1){
                ...
                $this->addPrintDetails($username, $print_datetime, $printer_name, $print_count, $print_serial_no, $serial_no,'CAVENDISH-BIT-LAW-AESS-2',$admin_id,$card_serial_no);
        ...
        //if($previewPdf!=1){
            //$this->updateCardNo('CAVENDISH-BIT-LAW-AESS-2',$card_serial_no-$cardDetails->starting_serial_no,$card_serial_no);
        //}
        if($previewPdf!=1){
            $this->updateCardNo('CAVENDISH-BIT-LAW-AESS-2',$card_serial_no-$cardDetails->starting_serial_no,$card_serial_no);
        }
        $msg = '';
        $file_name =  str_replace("/", "_",'CAVENDISH-BIT-LAW-AESS-2'.date("Ymdhms")).'.pdf';
        ...
        if($previewPdf!=1){
            ...
            $template_name="CAVENDISH-BIT-LAW-AESS-2";
    ...
    public function getArrayFromBIT_AESS_2_Excel($sheet1) {
        $records = array();

...
class PdfGenerateMvsrTranscriptJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
		...
		if($studentDataOrg&&!empty($studentDataOrg)){
			foreach ($studentDataOrg as $studentData) {
				...
				$pdfBig->SetFont($Cambria_Bold_11, 'B', 11, '', false); 
				$pdfBig->SetXY(13, 38);
				$pdfBig->Cell(186, 0, 'TRANSCRIPT', 0, false, 'C');

				$pdfBig->SetFont($arialb, '', 8, '', false); 
				$pdfBig->SetXY(12, 42.7);
				$pdfBig->Cell(186, 0, $course_name.' ['.$course_year.']', 0, false, 'C');
				$pdfBig->SetXY(12, 46.7);
				$pdfBig->Cell(186, 0, 'Examination : '.$monthYearExam, 0, false, 'C');
				
				$pdfBig->SetFont($arial, '', 8, '', false);
				$pdfBig->SetXY($left_pos, 51);		
				$pdfBig->Cell(10, 0, 'Ref No.', 0, false, 'L');	
				$pdfBig->SetXY(36, 51);		
				$pdfBig->Cell(101, 0, ': ', 0, false, 'L');		
				$pdfBig->SetFont($arialb, '', 8, '', false);
				$pdfBig->SetXY(39, 51);		
				$pdfBig->Cell(91, 0, $ref_no, 0, false, 'L');
				
				$pdfBig->SetFont($arial, '', 8, '', false);
				$pdfBig->SetXY($left_pos, 55.5);		
				$pdfBig->Cell(0, 0, "Roll No", 0, false, 'L');
				$pdfBig->SetXY(36, 55.5);		
				$pdfBig->Cell(101, 0, ': ', 0, false, 'L');
				$pdfBig->SetFont($arialb, '', 8, '', false);
				$pdfBig->SetXY(39, 55.5);		
				$pdfBig->Cell(83, 0, $Roll_No, 0, false, 'L');
				...
				$pdfBig->SetFont($arialb, '', 8, '', false);
				$pdfBig->SetXY(39, 60);
				$pdfBig->Cell(74, 0, $Name, 0, false, 'L');
				
				$pdfBig->SetFont($arial, '', 8, '', false);
				$pdfBig->SetXY($left_pos, 64.5);		
				$pdfBig->Cell(101, 0, 'Father`s Name', 0, false, 'L');
				$pdfBig->SetXY(36, 64.5);		
				$pdfBig->Cell(101, 0, ': ', 0, false, 'L');
				$pdfBig->SetFont($arialb, '', 8, '', false);
				$pdfBig->SetXY(39, 65);		
				...
				$pdfBig->Cell(0, 0, 'Course', 0, false, 'L');
				$pdfBig->SetXY(145, 55.5);		
				$pdfBig->Cell(0, 0, ': ', 0, false, 'L');
				$pdfBig->SetFont($arialb, '', 8, '', false);
				$pdfBig->SetXY(147, 55.5);		
				$pdfBig->Cell(0, 0, $course_name, 0, false, 'L');
				...
				$pdfBig->SetXY(15.5, 69.9);	
				$pdfBig->MultiCell(9.5, 7, 'SL.<br>NO.', 1, 'C', 0, 0, '', '', true, 0, true);

				$pdfBig->SetXY($pdfBig->getX(), 69.9);
				$pdfBig->setCellPaddings( $left = '', $top = '2', $right = '', $bottom = '');
				
				$pdfBig->SetXY($pdfBig->getX(), 69.9);
				$pdfBig->MultiCell(52.5, 7, 'COURSE TITLE', 1, 'C', 0, 0, '', '', true, 0, true);
				...
				foreach($subjects as $term => $term_array){
					...
					if ($term == "I SEMESTER" || $term == "III SEMESTER" || $term == "V SEMESTER" || $term == "VII SEMESTER" ) {
						...
						foreach($term_array as $key => $val){
							...
							$lines = $pdfBig->MultiCell(52.5, 0, $val[3], 0, 'L', 0, 0, '', '', true, 0, false,true, 0);
							...
							$pdfBig->MultiCell(9.5, $subjectTableHeight, $val[2], '', 'C', 0, 0, '', '', true, 0, true);

							$pdfBig->SetXY($pdfBig->getX(), $pdfBig->getY());
							$pdfBig->MultiCell(52.5, $subjectTableHeight, $val[3], '', 'L', 0, 0, '', '', true, 0, true);
						...
						foreach($term_array as $key => $val){
							...
							$pdfBig->MultiCell(9.5, $subjectTableHeight, $val[2], '0', 'C', 0, 0, '', '', true, 0, true);

							$pdfBig->SetXY($pdfBig->getX(), $pdfBig->getY());
							$pdfBig->MultiCell(52.5, $subjectTableHeight, $val[3], '0', 'L', 0, 0, '', '', true, 0, true);
					...
					$pdfBig->MultiCell(9.5, $totalHeight, '', 'LR', 'C', 0, 0, '', '', true, 0, true);

					$pdfBig->SetXY($pdfBig->getX(), $tableBorderStartY);
					$pdfBig->MultiCell(52.5, $totalHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
				...
				$left_pos=15.5;
				$left_pos_two=125;
				$pdf->SetFont($Cambria_Bold_11, 'B', 11, '', false); 
				$pdf->SetXY(13, 38);
				$pdf->Cell(186, 0, 'TRANSCRIPT', 0, false, 'C');

				$pdf->SetFont($arialb, '', 8, '', false); 
				$pdf->SetXY(12, 42.7);
				$pdf->Cell(186, 0, $course_name.' ['.$course_year.']', 0, false, 'C');
				$pdf->SetXY(12, 46.7);
				$pdf->Cell(186, 0, 'Examination : '.$monthYearExam, 0, false, 'C');
				
				$pdf->SetFont($arial, '', 8, '', false);
				$pdf->SetXY($left_pos, 51);		
				$pdf->Cell(10, 0, 'Ref No.', 0, false, 'L');	
				$pdf->SetXY(36, 51);		
				$pdf->Cell(101, 0, ': ', 0, false, 'L');		
				$pdf->SetFont($arialb, '', 8, '', false);
				$pdf->SetXY(39, 51);		
				$pdf->Cell(91, 0, $ref_no, 0, false, 'L');
				...
				$pdf->SetFont($arialb, '', 8, '', false);
				$pdf->SetXY(39, 55.5);		
				$pdf->Cell(83, 0, $Roll_No, 0, false, 'L');
				...
				$pdf->SetFont($arialb, '', 8, '', false);
				$pdf->SetXY(39, 60);
				$pdf->Cell(74, 0, $Name, 0, false, 'L');
				
				$pdf->SetFont($arial, '', 8, '', false);
				$pdf->SetXY($left_pos, 64.5);		
				$pdf->Cell(101, 0, 'Father`s Name', 0, false, 'L');
				$pdf->SetXY(36, 64.5);		
				$pdf->Cell(101, 0, ': ', 0, false, 'L');
				$pdf->SetFont($arialb, '', 8, '', false);
				$pdf->SetXY(39, 65);		
				...
				$pdf->Cell(0, 0, 'Course', 0, false, 'L');
				$pdf->SetXY(145, 55.5);		
				$pdf->Cell(0, 0, ': ', 0, false, 'L');
				$pdf->SetFont($arialb, '', 8, '', false);
				$pdf->SetXY(147, 55.5);		
				$pdf->Cell(0, 0, $course_name, 0, false, 'L');
				...
				$pdf->SetXY(15.5, 69.9);	
				$pdf->MultiCell(9.5, 7, 'SL.<br>NO.', 1, 'C', 0, 0, '', '', true, 0, true);

				$pdf->SetXY($pdf->getX(), 69.9);
				$pdf->setCellPaddings( $left = '', $top = '2', $right = '', $bottom = '');
				
				$pdf->SetXY($pdf->getX(), 69.9);
				$pdf->MultiCell(52.5, 7, 'COURSE TITLE', 1, 'C', 0, 0, '', '', true, 0, true);
				...
				foreach($subjects as $term => $term_array){
					...
					if ($term == "I SEMESTER" || $term == "III SEMESTER" || $term == "V SEMESTER" || $term == "VII SEMESTER" ) {
						...
						foreach($term_array as $key => $val){
							...
							$pdf->SetFont($arial, '', 7, '', false);  
							// get the number of lines
							$lines = $pdf->MultiCell(52.5, 0, $val[3], 0, 'L', 0, 0, '', '', true, 0, false,true, 0);
							...
							$pdf->MultiCell(9.5, $subjectTableHeight, $val[2], '', 'C', 0, 0, '', '', true, 0, true);

							$pdf->SetXY($pdf->getX(), $pdf->getY());
							$pdf->MultiCell(52.5, $subjectTableHeight, $val[3], '', 'L', 0, 0, '', '', true, 0, true);
						...
						foreach($term_array as $key => $val){
							...
							$pdf->MultiCell(9.5, $subjectTableHeight, $val[2], '0', 'C', 0, 0, '', '', true, 0, true);

							$pdf->SetXY($pdf->getX(), $pdf->getY());
							$pdf->MultiCell(52.5, $subjectTableHeight, $val[3], '0', 'L', 0, 0, '', '', true, 0, true);
					...
					$pdf->MultiCell(9.5, $totalHeight, '', 'LR', 'C', 0, 0, '', '', true, 0, true);

					$pdf->SetXY($pdf->getX(), $tableBorderStartY);
					$pdf->MultiCell(52.5, $totalHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);

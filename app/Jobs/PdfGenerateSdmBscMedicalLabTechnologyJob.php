...
use Helper;
// F:\wamp64\www\seqrdoc\app\Jobs\PdfGenerateSdmBscMedicalLabTechnologyJob.php
class PdfGenerateSdmBscMedicalLabTechnologyJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
			...
			//FIRST - B.Sc. Medical Lab Technology (1) code    
			$dt = date("_ymdHis");
			$str=$GUID.$dt;

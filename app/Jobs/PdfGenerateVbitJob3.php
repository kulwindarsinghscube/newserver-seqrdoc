    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        $ghostImgArr = array();
             ...
             if($generated_documents == 0){
                ...
                $pdfBig = new TCPDF('P', 'mm', array('210', '297'), true, 'UTF-8', false);                $pdfBig->SetCreator(PDF_CREATOR);
        ...
        foreach ($studentDataOrg as $studentData) {
            ...
            $pdf->SetFont($arialNarrowB, '', 7, '', false);
			$pdf->SetXY(12, 260);
			$pdf->MultiCell(0, 0, $Note, 0, 'L', 0, 0, '', '', true, 0, true);
			...
			$pdfBig->Cell(190, 0, $arrayEnrollment1, 0, false, 'L');
            ...
            $upload_sign1_org = $COE;
            $pathInfo = pathinfo($COE);
            $COE = public_path().'\\'.$subdomain[0].'\backend\\templates\\100\\'.$pathInfo['filename']."_$serial_no.".$pathInfo['extension'];
            \File::copy($upload_sign1_org,$COE); 
            ...
            $upload_sign2_org = $Principal;
            $pathInfo = pathinfo($Principal);
            $Principal = public_path().'\\'.$subdomain[0].'\backend\\templates\\100\\'.$pathInfo['filename']."_$serial_no.".$pathInfo['extension'];
            \File::copy($upload_sign2_org,$Principal);

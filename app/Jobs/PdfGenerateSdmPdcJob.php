...
class PdfGenerateSdmPdcJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
			...
			$PDC_No = trim($studentData[4]);
			$Date = trim($studentData[5]);
			$Student_Image = trim($studentData[6]);
			
			$batch_of_qr = trim($studentData[7]);
			$aadhar_number_qr = trim($studentData[8]);
			$course_qr = strtoupper(trim($studentData[9]));
			$year_qr = strtoupper(trim($studentData[10]));
			$DOB = trim($studentData[11]);
			...
			*/	
			...
			//$pdfBig->MultiCell(92, 0, "SDM College of Physiotherapy, Sattur, Dharwad-580009, Karnataka, India",0, 'L', 0, 0);			
			//End pdfBig 
			...
			$pdf->SetXY(51.5, 283);
			//$pdf->MultiCell(92, 0, "SDM College of Physiotherapy, Sattur, Dharwad-580009, Karnataka, India",0, 'L', 0, 0);			
			//End pdf			

...
class pdfGenerateSdmBscNursingJob{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
			...
			$pdfBig->MultiCell(12, 0, 'PASS MARKS OUT OF', 0, 'C', 0, 0);	
			...
			$pdf->MultiCell(12, 0, 'PASS MARKS OUT OF', 0, 'C', 0, 0);	
            ...
            // $pdfBig->SetXY($left_str_x, $subj_y);	
			// $pdfBig->MultiCell(134.8, 5, 'SGPA', 'LB', 'R', 0, 0); 
			// $pdfBig->MultiCell(45.8, 5, $sgpa, 'RB', 'L', 0, 0);
            // $pdf->SetXY($left_str_x, $subj_y);	
            // $pdf->MultiCell(134.8, 5, 'SGPA', 'LB', 'R', 0, 0); 
            // $pdf->MultiCell(45.8, 5, $sgpa, 'RB', 'L', 0, 0);
            ...
            if($year == trim("I SEMESTER")){
                ...
                $pdfBig->MultiCell(134.8, 5, 'CGPA', 'LB', 'R', 0, 0); 
                $pdfBig->MultiCell(45.8, 5,$cgpa, 'RB', 'L', 0, 0);
                ...
                $pdf->MultiCell(134.8, 5, 'CGPA', 'LB', 'R', 0, 0); 
                $pdf->MultiCell(45.8, 5, $cgpa, 'RB', 'L', 0, 0);
			...
			$pdfBig->MultiCell(18,  8.2, 'PERCENTAGE OF MARKS', 1, 'L', 0, 0);
			...
			$pdfBig->MultiCell(18, 8.2, 'LETTER GRADE', 1, 'L', 0, 0);
			...
			$pdfBig->MultiCell(18, 8.2, 'GRADE POINT', 1, 'L', 0, 0);
			...
			$pdfBig->MultiCell(18, 8.2, 'REMARKS', 1, 'L', 0, 0);
			...
			$pdf->MultiCell(18,  8.2, 'PERCENTAGE OF MARKS', 1, 'L', 0, 0);
			...
			$pdf->MultiCell(18, 8.2, 'LETTER GRADE', 1, 'L', 0, 0);
			...
			$pdf->MultiCell(18, 8.2, 'GRADE POINT', 1, 'L', 0, 0);
			...
			$pdf->MultiCell(18, 8.2, 'REMARKS', 1, 'L', 0, 0);

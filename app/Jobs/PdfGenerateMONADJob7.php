    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        if($studentDataOrg&&!empty($studentDataOrg)){  
            foreach ($studentDataOrg as $studentData) {
                ...
                //1st 6 columns
                $pdfBig->MultiCell(75.6, 19, '',1, 'L', 0, 0);
                ...
                $session2 = $studentData[197];
                //$IssueDate = $studentData[164];
                $date_of_issue = $studentData[199];
                ...
                $pdf->MultiCell(72.6, 10, '','RT', 'L', 0, 0);
                ...
                $pdfBig->MultiCell(72.6, 10, '','RT', 'L', 0, 0);
                ...
                $subjectData = array_slice($studentData, 8, 150); //start subject and end subject 
                ...
                for ($i=0; $i < $actual_subj_count ; $i++) { 
                    ...
                    $numlines_pdf = $pdf->getNumLines($subjectsArr[$i][0], 72.6);
                    $numlines_pdfBig = $pdfBig->getNumLines($subjectsArr[$i][0], 72.6);
                    ...
                    $pdf->MultiCell(72.6, $cell_height, trim($subjectsArr[$i][0]),$cell_border_sub, 'L', 0, 0);
                    $pdf->SetFont($arialb, '', 10, '', false);
                    //$pdf->MultiCell(7.2, $cell_height, $subjectsArr[$i][12], $cell_border, 'C', 0, 0);
                    ...
                    $pdfBig->MultiCell(72.6, $cell_height, trim($subjectsArr[$i][0]),$cell_border_sub, 'L', 0, 0);
                    $pdfBig->SetFont($arialb, '', 10, '', false); 
                    //$pdfBig->MultiCell(7.2, $cell_height, $subjectsArr[$i][12], $cell_border, 'C', 0, 0);
                ...
                if($count_upto != $actual_subj_count){
                    for ($t=1; $t <= $total_rows_remain ; $t++){                
                        ...
                        $pdf->MultiCell(3, $cell_height, '',$cell_border_empty, 'L', 0, 0);
                        $pdf->MultiCell(72.6, $cell_height, '',$cell_border_sub, 'L', 0, 0);
                        //$pdf->MultiCell(7.2, $cell_height, '', $cell_border, 'C', 0, 0);
                        ...
                        $pdfBig->MultiCell(3, $cell_height, '',$cell_border_empty, 'L', 0, 0);
                        $pdfBig->MultiCell(72.6, $cell_height, '',$cell_border_sub, 'L', 0, 0);
                        //$pdfBig->MultiCell(7.2, $cell_height, '', $cell_border, 'C', 0, 0);
               ...
               $pdf->SetFont($arialb, '', 10, '', false);
                $pdf->SetXY(13, 228);          
                $pdf->MultiCell(31, 4, "Marks Obtained", 0, 'L', 0, 0);
                $pdf->MultiCell(4, 4, ":", 0, 'L', 0, 0);
                $pdf->MultiCell(40, 4, $studentData[152],0, 'L', 0, 0);

                $pdf->SetXY(13, 232);          
                $pdf->MultiCell(31, 4, "Max. Marks", 0, 'L', 0, 0);
                $pdf->MultiCell(4, 4, ":", 0, 'L', 0, 0);
                $pdf->MultiCell(40, 4, $studentData[151],0, 'L', 0, 0);
                $pdf->SetXY(13, 229.5);          
                $pdf->MultiCell(150, 4, "Result/SGPA :  ".$studentData[153], 0, 'R', 0, 0);
                ...
                $pdf->MultiCell(31, 4, "Semester",1, 'C', 0, 0);
                $pdf->MultiCell(12.5, 4, 'I', 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, "II", 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, "III", 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, "IV", 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, "V", 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, "VI", 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, "VII", 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, "VIII", 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, "IX", 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, "X", 1, 'C', 0, 0);
                $pdf->MultiCell(14, 4, "Total", 1, 'C', 0, 0); 
                // $pdf->MultiCell(13, 4, "%", 1, 'C', 0, 0);
                $pdf->MultiCell(14, 4, "CGPA", 1, 'C', 0, 0);

                $pdf->SetXY(13, 240.5);   
                 $pdf->MultiCell(31, 4, "Maximum Marks",1, 'C', 0, 0);
                $pdf->MultiCell(12.5, 4, $studentData[154], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[158], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[162], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[166], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[170], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[174], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[178], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[182], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[186], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[190], 1, 'C', 0, 0);
                $pdf->MultiCell(14, 4, $studentData[194], 1, 'C', 0, 0); 
                $pdf->setCellPaddings( $left = '', $top = '5', $right = '', $bottom = '');
                // $pdf->MultiCell(13, 16, $studentData[175], 1, 'C', 0, 0);
                $pdf->MultiCell(14, 16, $studentData[196], 1, 'C', 0, 0);
                $pdf->setCellPaddings( $left = '', $top = '0', $right = '', $bottom = '');
                  $pdf->SetXY(13, 244.5);   

                 $pdf->MultiCell(31, 4, "Marks Obtained",1, 'C', 0, 0);
                $pdf->MultiCell(12.5, 4, $studentData[155], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[159], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[163], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[167], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[171], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[175], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[179], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[183], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[187], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[191], 1, 'C', 0, 0);
                $pdf->MultiCell(14, 4, $studentData[195], 1, 'C', 0, 0); 
                // $pdf->MultiCell(13, 4, "%", 1, 'C', 0, 0);
                // $pdf->MultiCell(13, 4, "Division", 1, 'C', 0, 0);


                 $pdf->SetXY(13, 248.5);   
                 $pdf->MultiCell(31, 4, "SGPA",1, 'C', 0, 0);
                $pdf->MultiCell(12.5, 4, $studentData[156], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[160], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[164], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[168], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[172], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[176], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[180], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[184], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[188], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[192], 1, 'C', 0, 0);
                $pdf->MultiCell(14, 4, "-", 1, 'C', 0, 0);


                $pdf->SetXY(13, 252.5);   
                $pdf->MultiCell(31, 4, "Passed In Year",1, 'C', 0, 0);
                $pdf->MultiCell(12.5, 4, $studentData[157], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[161], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[165], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[169], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[173], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[177], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[181], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[185], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[189], 1, 'C', 0, 0); 
                $pdf->MultiCell(12.5, 4, $studentData[193], 1, 'C', 0, 0);
                $pdf->MultiCell(14, 4, "-", 1, 'C', 0, 0); 
                // $pdf->MultiCell(13, 4, "%", 1, 'C', 0, 0);
                // $pdf->MultiCell(13, 4, "Division", 1, 'C', 0, 0);
                 $pdf->setCellPaddings( $left = '', $top = '0', $right = '', $bottom = '');
                ...
                $pdfBig->SetFont($arialb, '', 10, '', false);
                $pdfBig->SetXY(13, 228);          
                $pdfBig->MultiCell(31, 4, "Marks Obtained", 0, 'L', 0, 0);
                $pdfBig->MultiCell(4, 4, ":", 0, 'L', 0, 0);
                $pdfBig->MultiCell(40, 4, $studentData[152],0, 'L', 0, 0);

                $pdfBig->SetXY(13, 232);          
                $pdfBig->MultiCell(31, 4, "Max. Marks", 0, 'L', 0, 0);
                $pdfBig->MultiCell(4, 4, ":", 0, 'L', 0, 0);
                $pdfBig->MultiCell(40, 4, $studentData[151],0, 'L', 0, 0);
                $pdfBig->SetXY(13, 229.5);          
                $pdfBig->MultiCell(150, 4, "Result/SGPA :  ".$studentData[153], 0, 'R', 0, 0);
               
                $pdfBig->SetFont($arial, '', 9, '', false);

                $pdfBig->SetXY(13, 236.5);         
                $pdfBig->SetFillColor(255, 255, 255);
                $pdfBig->SetTextColor(0, 0, 0);  
                $pdfBig->setCellPaddings( $left = '', $top = '0', $right = '', $bottom = '');
                $pdfBig->MultiCell(31, 4, "Semester",1, 'C', 0, 0);
                $pdfBig->MultiCell(12.5, 4, 'I', 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, "II", 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, "III", 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, "IV", 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, "V", 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, "VI", 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, "VII", 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, "VIII", 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, "IX", 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, "X", 1, 'C', 0, 0);
                $pdfBig->MultiCell(14, 4, "Total", 1, 'C', 0, 0); 
                // $pdfBig->MultiCell(13, 4, "%", 1, 'C', 0, 0);
                $pdfBig->MultiCell(14, 4, "CGPA", 1, 'C', 0, 0);

                $pdfBig->SetXY(13, 240.5);   
                 $pdfBig->MultiCell(31, 4, "Maximum Marks",1, 'C', 0, 0);
                $pdfBig->MultiCell(12.5, 4, $studentData[154], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[158], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[162], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[166], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[170], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[174], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[178], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[182], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[186], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[190], 1, 'C', 0, 0);
                $pdfBig->MultiCell(14, 4, $studentData[194], 1, 'C', 0, 0); 
                $pdfBig->setCellPaddings( $left = '', $top = '5', $right = '', $bottom = '');
                // $pdfBig->MultiCell(13, 16, $studentData[175], 1, 'C', 0, 0);
                $pdfBig->MultiCell(14, 16, $studentData[196], 1, 'C', 0, 0);
                $pdfBig->setCellPaddings( $left = '', $top = '0', $right = '', $bottom = '');
                  $pdfBig->SetXY(13, 244.5);   

                 $pdfBig->MultiCell(31, 4, "Marks Obtained",1, 'C', 0, 0);
                $pdfBig->MultiCell(12.5, 4, $studentData[155], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[159], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[163], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[167], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[171], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[175], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[179], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[183], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[187], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[191], 1, 'C', 0, 0);
                $pdfBig->MultiCell(14, 4, $studentData[195], 1, 'C', 0, 0); 
                // $pdfBig->MultiCell(13, 4, "%", 1, 'C', 0, 0);
                // $pdfBig->MultiCell(13, 4, "Division", 1, 'C', 0, 0);


                 $pdfBig->SetXY(13, 248.5);   
                 $pdfBig->MultiCell(31, 4, "SGPA",1, 'C', 0, 0);
                $pdfBig->MultiCell(12.5, 4, $studentData[156], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[160], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[164], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[168], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[172], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[176], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[180], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[184], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[188], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[192], 1, 'C', 0, 0);
                $pdfBig->MultiCell(14, 4, "-", 1, 'C', 0, 0);


                $pdfBig->SetXY(13, 252.5);   
                $pdfBig->MultiCell(31, 4, "Passed In Year",1, 'C', 0, 0);
                $pdfBig->MultiCell(12.5, 4, $studentData[157], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[161], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[165], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[169], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[173], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[177], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[181], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[185], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[189], 1, 'C', 0, 0); 
                $pdfBig->MultiCell(12.5, 4, $studentData[193], 1, 'C', 0, 0);
                $pdfBig->MultiCell(14, 4, "-", 1, 'C', 0, 0); 
                // $pdfBig->MultiCell(13, 4, "%", 1, 'C', 0, 0);
                // $pdfBig->MultiCell(13, 4, "Division", 1, 'C', 0, 0);
                 $pdfBig->setCellPaddings( $left = '', $top = '0', $right = '', $bottom = '');
                $pdfBig->SetFont($arialb, '', 9, '', false);
                $pdfBig->SetXY(13, 256.5);          

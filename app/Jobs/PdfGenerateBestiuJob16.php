    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
		...
		if($studentDataOrg&&!empty($studentDataOrg)){
			foreach ($studentDataOrg as $studentData) {
				...
				$Mother_Name=trim($studentData[8]);
				// $Date_of_Declaration_of_Result=trim($studentData[9]);
				$Class_Awarded=trim($studentData[9]);
				$Aadhar_No=trim($studentData[10]);
				...
				$SEM1_COURSE_CODE_11=trim($studentData[63]);
				$SEM1_COURSE_TITLE_11=trim($studentData[64]);
				$SEM1_CREDIT_HOURS_11=trim($studentData[65]);
				$SEM1_GRADE_POINT_11=trim($studentData[66]);
				$SEM1_CREDIT_POINTS_11=trim($studentData[67]);

				$II_SEM=trim($studentData[68]);
				$SEM2_COURSE_CODE_1=trim($studentData[69]);
				$SEM2_COURSE_TITLE_1=trim($studentData[70]);
				$SEM2_CREDIT_HOURS_1=trim($studentData[71]);
				$SEM2_GRADE_POINT_1=trim($studentData[72]);
				$SEM2_CREDIT_POINTS_1=trim($studentData[73]);
				$SEM2_COURSE_CODE_2=trim($studentData[74]);
				$SEM2_COURSE_TITLE_2=trim($studentData[75]);
				$SEM2_CREDIT_HOURS_2=trim($studentData[76]);
				$SEM2_GRADE_POINT_2=trim($studentData[77]);
				$SEM2_CREDIT_POINTS_2=trim($studentData[78]);
				$SEM2_COURSE_CODE_3=trim($studentData[79]);
				$SEM2_COURSE_TITLE_3=trim($studentData[80]);
				$SEM2_CREDIT_HOURS_3=trim($studentData[81]);
				$SEM2_GRADE_POINT_3=trim($studentData[82]);
				$SEM2_CREDIT_POINTS_3=trim($studentData[83]);
				$SEM2_COURSE_CODE_4=trim($studentData[84]);
				$SEM2_COURSE_TITLE_4=trim($studentData[85]);
				$SEM2_CREDIT_HOURS_4=trim($studentData[86]);
				$SEM2_GRADE_POINT_4=trim($studentData[87]);
				$SEM2_CREDIT_POINTS_4=trim($studentData[88]);
				$SEM2_COURSE_CODE_5=trim($studentData[89]);
				$SEM2_COURSE_TITLE_5=trim($studentData[90]);
				$SEM2_CREDIT_HOURS_5=trim($studentData[91]);
				$SEM2_GRADE_POINT_5=trim($studentData[92]);
				$SEM2_CREDIT_POINTS_5=trim($studentData[93]);
				$SEM2_COURSE_CODE_6=trim($studentData[94]);
				$SEM2_COURSE_TITLE_6=trim($studentData[95]);
				$SEM2_CREDIT_HOURS_6=trim($studentData[96]);
				$SEM2_GRADE_POINT_6=trim($studentData[97]);
				$SEM2_CREDIT_POINTS_6=trim($studentData[98]);
				$SEM2_COURSE_CODE_7=trim($studentData[99]);
				$SEM2_COURSE_TITLE_7=trim($studentData[100]);
				$SEM2_CREDIT_HOURS_7=trim($studentData[101]);
				$SEM2_GRADE_POINT_7=trim($studentData[102]);
				$SEM2_CREDIT_POINTS_7=trim($studentData[103]);
				$SEM2_COURSE_CODE_8=trim($studentData[104]);
				$SEM2_COURSE_TITLE_8=trim($studentData[105]);
				$SEM2_CREDIT_HOURS_8=trim($studentData[106]);
				$SEM2_GRADE_POINT_8=trim($studentData[107]);
				$SEM2_CREDIT_POINTS_8=trim($studentData[108]);
				$SEM2_COURSE_CODE_9=trim($studentData[109]);
				$SEM2_COURSE_TITLE_9=trim($studentData[110]);
				$SEM2_CREDIT_HOURS_9=trim($studentData[111]);
				$SEM2_GRADE_POINT_9=trim($studentData[112]);
				$SEM2_CREDIT_POINTS_9=trim($studentData[113]);
				// $SEM2_COURSE_CODE_10=trim($studentData[114]);
				// $SEM2_COURSE_TITLE_10=trim($studentData[115]);
				// $SEM2_CREDIT_HOURS_10=trim($studentData[116]);
				// $SEM2_GRADE_POINT_10=trim($studentData[117]);
				// $SEM2_CREDIT_POINTS_10=trim($studentData[118]);			

				$III_SEM=trim($studentData[119]);
				$SEM3_COURSE_CODE_1=trim($studentData[120]);
				$SEM3_COURSE_TITLE_1=trim($studentData[121]);
				$SEM3_CREDIT_HOURS_1=trim($studentData[122]);
				$SEM3_GRADE_POINT_1=trim($studentData[123]);
				$SEM3_CREDIT_POINTS_1=trim($studentData[124]);
				$SEM3_COURSE_CODE_2=trim($studentData[125]);
				$SEM3_COURSE_TITLE_2=trim($studentData[126]);
				$SEM3_CREDIT_HOURS_2=trim($studentData[127]);
				$SEM3_GRADE_POINT_2=trim($studentData[128]);
				$SEM3_CREDIT_POINTS_2=trim($studentData[129]);
				$SEM3_COURSE_CODE_3=trim($studentData[130]);
				$SEM3_COURSE_TITLE_3=trim($studentData[131]);
				$SEM3_CREDIT_HOURS_3=trim($studentData[132]);
				$SEM3_GRADE_POINT_3=trim($studentData[133]);
				$SEM3_CREDIT_POINTS_3=trim($studentData[134]);
				$SEM3_COURSE_CODE_4=trim($studentData[135]);
				$SEM3_COURSE_TITLE_4=trim($studentData[136]);
				$SEM3_CREDIT_HOURS_4=trim($studentData[137]);
				$SEM3_GRADE_POINT_4=trim($studentData[138]);
				$SEM3_CREDIT_POINTS_4=trim($studentData[139]);
				$SEM3_COURSE_CODE_5=trim($studentData[140]);
				$SEM3_COURSE_TITLE_5=trim($studentData[141]);
				$SEM3_CREDIT_HOURS_5=trim($studentData[142]);
				$SEM3_GRADE_POINT_5=trim($studentData[143]);
				$SEM3_CREDIT_POINTS_5=trim($studentData[144]);
				$SEM3_COURSE_CODE_6=trim($studentData[145]);
				$SEM3_COURSE_TITLE_6=trim($studentData[146]);
				$SEM3_CREDIT_HOURS_6=trim($studentData[147]);
				$SEM3_GRADE_POINT_6=trim($studentData[148]);
				$SEM3_CREDIT_POINTS_6=trim($studentData[149]);
				$SEM3_COURSE_CODE_7=trim($studentData[150]);
				$SEM3_COURSE_TITLE_7=trim($studentData[151]);
				$SEM3_CREDIT_HOURS_7=trim($studentData[152]);
				$SEM3_GRADE_POINT_7=trim($studentData[153]);
				$SEM3_CREDIT_POINTS_7=trim($studentData[154]);
				$SEM3_COURSE_CODE_8=trim($studentData[155]);
				$SEM3_COURSE_TITLE_8=trim($studentData[156]);
				$SEM3_CREDIT_HOURS_8=trim($studentData[157]);
				$SEM3_GRADE_POINT_8=trim($studentData[158]);
				$SEM3_CREDIT_POINTS_8=trim($studentData[159]);
				$SEM3_COURSE_CODE_9=trim($studentData[160]);
				$SEM3_COURSE_TITLE_9=trim($studentData[161]);
				$SEM3_CREDIT_HOURS_9=trim($studentData[162]);
				$SEM3_GRADE_POINT_9=trim($studentData[163]);
				$SEM3_CREDIT_POINTS_9=trim($studentData[164]);
				
				$IV_SEM=trim($studentData[165]);
				$SEM4_COURSE_CODE_1=trim($studentData[166]);
				$SEM4_COURSE_TITLE_1=trim($studentData[167]);
				$SEM4_CREDIT_HOURS_1=trim($studentData[168]);
				$SEM4_GRADE_POINT_1=trim($studentData[169]);
				$SEM4_CREDIT_POINTS_1=trim($studentData[170]);
				$SEM4_COURSE_CODE_2=trim($studentData[171]);
				$SEM4_COURSE_TITLE_2=trim($studentData[172]);
				$SEM4_CREDIT_HOURS_2=trim($studentData[173]);
				$SEM4_GRADE_POINT_2=trim($studentData[174]);
				$SEM4_CREDIT_POINTS_2=trim($studentData[175]);
				$SEM4_COURSE_CODE_3=trim($studentData[176]);
				$SEM4_COURSE_TITLE_3=trim($studentData[177]);
				$SEM4_CREDIT_HOURS_3=trim($studentData[178]);
				$SEM4_GRADE_POINT_3=trim($studentData[179]);
				$SEM4_CREDIT_POINTS_3=trim($studentData[180]);
				$SEM4_COURSE_CODE_4=trim($studentData[181]);
				$SEM4_COURSE_TITLE_4=trim($studentData[182]);
				$SEM4_CREDIT_HOURS_4=trim($studentData[183]);
				$SEM4_GRADE_POINT_4=trim($studentData[184]);
				$SEM4_CREDIT_POINTS_4=trim($studentData[185]);
				$SEM4_COURSE_CODE_5=trim($studentData[186]);
				$SEM4_COURSE_TITLE_5=trim($studentData[187]);
				$SEM4_CREDIT_HOURS_5=trim($studentData[188]);
				$SEM4_GRADE_POINT_5=trim($studentData[189]);
				$SEM4_CREDIT_POINTS_5=trim($studentData[190]);
				$SEM4_COURSE_CODE_6=trim($studentData[191]);
				$SEM4_COURSE_TITLE_6=trim($studentData[192]);
				$SEM4_CREDIT_HOURS_6=trim($studentData[193]);
				$SEM4_GRADE_POINT_6=trim($studentData[194]);
				$SEM4_CREDIT_POINTS_6=trim($studentData[195]);
				$SEM4_COURSE_CODE_7=trim($studentData[196]);
				$SEM4_COURSE_TITLE_7=trim($studentData[197]);
				$SEM4_CREDIT_HOURS_7=trim($studentData[198]);
				$SEM4_GRADE_POINT_7=trim($studentData[199]);
				$SEM4_CREDIT_POINTS_7=trim($studentData[200]);
				$SEM4_COURSE_CODE_8=trim($studentData[201]);
				$SEM4_COURSE_TITLE_8=trim($studentData[202]);
				$SEM4_CREDIT_HOURS_8=trim($studentData[203]);
				$SEM4_GRADE_POINT_8=trim($studentData[204]);
				$SEM4_CREDIT_POINTS_8=trim($studentData[205]);
				$SEM4_COURSE_CODE_9=trim($studentData[206]);
				$SEM4_COURSE_TITLE_9=trim($studentData[207]);
				$SEM4_CREDIT_HOURS_9=trim($studentData[208]);
				$SEM4_GRADE_POINT_9=trim($studentData[209]);
				$SEM4_CREDIT_POINTS_9=trim($studentData[210]);
				$SEM4_COURSE_CODE_10=trim($studentData[211]);
				$SEM4_COURSE_TITLE_10=trim($studentData[212]);
				$SEM4_CREDIT_HOURS_10=trim($studentData[213]);
				$SEM4_GRADE_POINT_10=trim($studentData[214]);
				$SEM4_CREDIT_POINTS_10=trim($studentData[215]);
				
				$V_SEM=trim($studentData[216]);
				$SEM5_COURSE_CODE_1=trim($studentData[217]);
				$SEM5_COURSE_TITLE_1=trim($studentData[218]);
				$SEM5_CREDIT_HOURS_1=trim($studentData[219]);
				$SEM5_GRADE_POINT_1=trim($studentData[220]);
				$SEM5_CREDIT_POINTS_1=trim($studentData[221]);
				$SEM5_COURSE_CODE_2=trim($studentData[222]);
				$SEM5_COURSE_TITLE_2=trim($studentData[223]);
				$SEM5_CREDIT_HOURS_2=trim($studentData[224]);
				$SEM5_GRADE_POINT_2=trim($studentData[225]);
				$SEM5_CREDIT_POINTS_2=trim($studentData[226]);
				$SEM5_COURSE_CODE_3=trim($studentData[227]);
				$SEM5_COURSE_TITLE_3=trim($studentData[228]);
				$SEM5_CREDIT_HOURS_3=trim($studentData[229]);
				$SEM5_GRADE_POINT_3=trim($studentData[230]);
				$SEM5_CREDIT_POINTS_3=trim($studentData[231]);
				$SEM5_COURSE_CODE_4=trim($studentData[232]);
				$SEM5_COURSE_TITLE_4=trim($studentData[233]);
				$SEM5_CREDIT_HOURS_4=trim($studentData[234]);
				$SEM5_GRADE_POINT_4=trim($studentData[235]);
				$SEM5_CREDIT_POINTS_4=trim($studentData[236]);
				$SEM5_COURSE_CODE_5=trim($studentData[237]);
				$SEM5_COURSE_TITLE_5=trim($studentData[238]);
				$SEM5_CREDIT_HOURS_5=trim($studentData[239]);
				$SEM5_GRADE_POINT_5=trim($studentData[240]);
				$SEM5_CREDIT_POINTS_5=trim($studentData[241]);
				$SEM5_COURSE_CODE_6=trim($studentData[242]);
				$SEM5_COURSE_TITLE_6=trim($studentData[243]);
				$SEM5_CREDIT_HOURS_6=trim($studentData[244]);
				$SEM5_GRADE_POINT_6=trim($studentData[245]);
				$SEM5_CREDIT_POINTS_6=trim($studentData[246]);
				$SEM5_COURSE_CODE_7=trim($studentData[247]);
				$SEM5_COURSE_TITLE_7=trim($studentData[248]);
				$SEM5_CREDIT_HOURS_7=trim($studentData[249]);
				$SEM5_GRADE_POINT_7=trim($studentData[250]);
				$SEM5_CREDIT_POINTS_7=trim($studentData[251]);
				$SEM5_COURSE_CODE_8=trim($studentData[252]);
				$SEM5_COURSE_TITLE_8=trim($studentData[253]);
				$SEM5_CREDIT_HOURS_8=trim($studentData[254]);
				$SEM5_GRADE_POINT_8=trim($studentData[255]);
				$SEM5_CREDIT_POINTS_8=trim($studentData[256]);
				$SEM5_COURSE_CODE_9=trim($studentData[257]);
				$SEM5_COURSE_TITLE_9=trim($studentData[258]);
				$SEM5_CREDIT_HOURS_9=trim($studentData[259]);
				$SEM5_GRADE_POINT_9=trim($studentData[260]);
				$SEM5_CREDIT_POINTS_9=trim($studentData[261]);			
				$SEM5_COURSE_CODE_10=trim($studentData[262]);
				$SEM5_COURSE_TITLE_10=trim($studentData[263]);
				$SEM5_CREDIT_HOURS_10=trim($studentData[264]);
				$SEM5_GRADE_POINT_10=trim($studentData[265]);
				$SEM5_CREDIT_POINTS_10=trim($studentData[266]);

				$VI_SEM=trim($studentData[267]);
				$SEM6_COURSE_CODE_1=trim($studentData[268]);
				$SEM6_COURSE_TITLE_1=trim($studentData[269]);
				$SEM6_CREDIT_HOURS_1=trim($studentData[270]);
				$SEM6_GRADE_POINT_1=trim($studentData[271]);
				$SEM6_CREDIT_POINTS_1=trim($studentData[272]);
				$SEM6_COURSE_CODE_2=trim($studentData[273]);
				$SEM6_COURSE_TITLE_2=trim($studentData[274]);
				$SEM6_CREDIT_HOURS_2=trim($studentData[275]);
				$SEM6_GRADE_POINT_2=trim($studentData[276]);
				$SEM6_CREDIT_POINTS_2=trim($studentData[277]);
				$SEM6_COURSE_CODE_3=trim($studentData[278]);
				$SEM6_COURSE_TITLE_3=trim($studentData[279]);
				$SEM6_CREDIT_HOURS_3=trim($studentData[280]);
				$SEM6_GRADE_POINT_3=trim($studentData[281]);
				$SEM6_CREDIT_POINTS_3=trim($studentData[282]);
				$SEM6_COURSE_CODE_4=trim($studentData[283]);
				$SEM6_COURSE_TITLE_4=trim($studentData[284]);
				$SEM6_CREDIT_HOURS_4=trim($studentData[285]);
				$SEM6_GRADE_POINT_4=trim($studentData[286]);
				$SEM6_CREDIT_POINTS_4=trim($studentData[287]);
				$SEM6_COURSE_CODE_5=trim($studentData[288]);
				$SEM6_COURSE_TITLE_5=trim($studentData[289]);
				$SEM6_CREDIT_HOURS_5=trim($studentData[290]);
				$SEM6_GRADE_POINT_5=trim($studentData[291]);
				$SEM6_CREDIT_POINTS_5=trim($studentData[292]);
				$SEM6_COURSE_CODE_6=trim($studentData[293]);
				$SEM6_COURSE_TITLE_6=trim($studentData[294]);
				$SEM6_CREDIT_HOURS_6=trim($studentData[295]);
				$SEM6_GRADE_POINT_6=trim($studentData[296]);
				$SEM6_CREDIT_POINTS_6=trim($studentData[297]);
				$SEM6_COURSE_CODE_7=trim($studentData[298]);
				$SEM6_COURSE_TITLE_7=trim($studentData[299]);
				$SEM6_CREDIT_HOURS_7=trim($studentData[300]);
				$SEM6_GRADE_POINT_7=trim($studentData[301]);
				$SEM6_CREDIT_POINTS_7=trim($studentData[302]);
				$SEM6_COURSE_CODE_8=trim($studentData[303]);
				$SEM6_COURSE_TITLE_8=trim($studentData[304]);
				$SEM6_CREDIT_HOURS_8=trim($studentData[305]);
				$SEM6_GRADE_POINT_8=trim($studentData[306]);
				$SEM6_CREDIT_POINTS_8=trim($studentData[307]);
				$SEM6_COURSE_CODE_9=trim($studentData[308]);
				$SEM6_COURSE_TITLE_9=trim($studentData[309]);
				$SEM6_CREDIT_HOURS_9=trim($studentData[310]);
				$SEM6_GRADE_POINT_9=trim($studentData[311]);
				$SEM6_CREDIT_POINTS_9=trim($studentData[312]);
				$SEM6_COURSE_CODE_10=trim($studentData[313]);
				$SEM6_COURSE_TITLE_10=trim($studentData[314]);
				$SEM6_CREDIT_HOURS_10=trim($studentData[315]);
				$SEM6_GRADE_POINT_10=trim($studentData[316]);
				$SEM6_CREDIT_POINTS_10=trim($studentData[317]);
				$SEM6_COURSE_CODE_11=trim($studentData[318]);
				$SEM6_COURSE_TITLE_11=trim($studentData[319]);
				$SEM6_CREDIT_HOURS_11=trim($studentData[320]);
				$SEM6_GRADE_POINT_11=trim($studentData[321]);
				$SEM6_CREDIT_POINTS_11=trim($studentData[322]);
							

				$VII_SEM=trim($studentData[323]);
				$SEM7_COURSE_CODE_1=trim($studentData[324]);
				$SEM7_COURSE_TITLE_1=trim($studentData[325]);
				$SEM7_CREDIT_HOURS_1=trim($studentData[326]);
				$SEM7_GRADE_POINT_1=trim($studentData[327]);
				$SEM7_CREDIT_POINTS_1=trim($studentData[328]);
				$SEM7_COURSE_CODE_2=trim($studentData[329]);
				$SEM7_COURSE_TITLE_2=trim($studentData[330]);
				$SEM7_CREDIT_HOURS_2=trim($studentData[331]);
				$SEM7_GRADE_POINT_2=trim($studentData[332]);
				$SEM7_CREDIT_POINTS_2=trim($studentData[333]);
				$SEM7_COURSE_CODE_3=trim($studentData[334]);
				$SEM7_COURSE_TITLE_3=trim($studentData[335]);
				$SEM7_CREDIT_HOURS_3=trim($studentData[336]);
				$SEM7_GRADE_POINT_3=trim($studentData[337]);
				$SEM7_CREDIT_POINTS_3=trim($studentData[338]);
				

				$VIII_SEM=trim($studentData[339]);
				$SEM8_COURSE_CODE_1=trim($studentData[340]);
				$SEM8_COURSE_TITLE_1=trim($studentData[341]);
				$SEM8_CREDIT_HOURS_1=trim($studentData[342]);
				$SEM8_GRADE_POINT_1=trim($studentData[343]);
				$SEM8_CREDIT_POINTS_1=trim($studentData[344]);
				$SEM8_COURSE_CODE_2=trim($studentData[345]);
				$SEM8_COURSE_TITLE_2=trim($studentData[346]);
				$SEM8_CREDIT_HOURS_2=trim($studentData[347]);
				$SEM8_GRADE_POINT_2=trim($studentData[348]);
				$SEM8_CREDIT_POINTS_2=trim($studentData[349]);
				$SEM8_COURSE_CODE_3=trim($studentData[350]);
				$SEM8_COURSE_TITLE_3=trim($studentData[351]);
				$SEM8_CREDIT_HOURS_3=trim($studentData[352]);
				$SEM8_GRADE_POINT_3=trim($studentData[353]);
				$SEM8_CREDIT_POINTS_3=trim($studentData[354]);
				$SEM8_COURSE_CODE_4=trim($studentData[355]);
				$SEM8_COURSE_TITLE_4=trim($studentData[356]);
				$SEM8_CREDIT_HOURS_4=trim($studentData[357]);
				$SEM8_GRADE_POINT_4=trim($studentData[358]);
				$SEM8_CREDIT_POINTS_4=trim($studentData[359]);
				$SEM8_COURSE_CODE_5=trim($studentData[360]);
				$SEM8_COURSE_TITLE_5=trim($studentData[361]);
				$SEM8_CREDIT_HOURS_5=trim($studentData[362]);
				$SEM8_GRADE_POINT_5=trim($studentData[363]);
				$SEM8_CREDIT_POINTS_5=trim($studentData[364]);
				$SEM8_COURSE_CODE_6=trim($studentData[365]);
				$SEM8_COURSE_TITLE_6=trim($studentData[366]);
				$SEM8_CREDIT_HOURS_6=trim($studentData[367]);
				$SEM8_GRADE_POINT_6=trim($studentData[368]);
				$SEM8_CREDIT_POINTS_6=trim($studentData[369]);
				$SEM8_COURSE_CODE_7=trim($studentData[370]);
				$SEM8_COURSE_TITLE_7=trim($studentData[371]);
				$SEM8_CREDIT_HOURS_7=trim($studentData[372]);
				$SEM8_GRADE_POINT_7=trim($studentData[373]);
				$SEM8_CREDIT_POINTS_7=trim($studentData[374]);	
				$SEM8_COURSE_CODE_8=trim($studentData[375]);
				$SEM8_COURSE_TITLE_8=trim($studentData[376]);
				$SEM8_CREDIT_HOURS_8=trim($studentData[377]);
				$SEM8_GRADE_POINT_8=trim($studentData[378]);
				$SEM8_CREDIT_POINTS_8=trim($studentData[379]);


				$TOTAL_CREDITS_CREDIT_HOURS=trim($studentData[380]);
				$TOTAL_CREDITS_CREDIT_POINTS=trim($studentData[381]);
				$OVERALL_GRADE_POINT_AVERAGE=trim($studentData[382]);
				$DATE=trim($studentData[383]);
				$Photo=trim($studentData[384]);
				...
				$pdfBig->SetFont($arialb, '', 8, '', false);
				$pdfBig->SetXY(31, 55.5);		
				$pdfBig->Cell(83, 0, $Fathers_Name, 0, false, 'L');
							
				$pdfBig->SetFont($arial, '', 8, '', false);
				$pdfBig->SetXY($left_pos, 60);		
				$pdfBig->Cell(0, 0, 'Mother Name :', 0, false, 'L');
				$pdfBig->SetFont($arialb, '', 8, '', false);
				$pdfBig->SetXY(30, 60);
				$pdfBig->Cell(74, 0, $Mother_Name, 0, false, 'L');
				
				$pdfBig->SetFont($arial, '', 8, '', false);
				$pdfBig->SetXY($left_pos, 64.5);		
				$pdfBig->Cell(101, 0, 'College :', 0, false, 'L');
				$pdfBig->SetFont($arialb, '', 8, '', false);
				$pdfBig->SetXY(23, 64.5);		
				$pdfBig->Cell(83, 0, $College, 0, false, 'L');//department
				...
				$pdfBig->Cell(92.8, 4.2, $I_SEM, 'LRB', false, 'C');
				...
				$pdfBig->SetXY(11.5, $y_axis);
				$pdfBig->SetFont($arialNarrowB, '', 7, '', false);
				$pdfBig->Cell(92.8, 4.2, $II_SEM, 'LRB', false, 'C');
				$y_axis=$y_axis+4.1;
				$pdfBig->SetFont($arialNarrow, '', 7, '', false);
				//SEM 2
				for ($x = 1; $x <= 9; $x++) {
				...
				$pdfBig->SetXY(11.5, $y_axis);
				$pdfBig->SetFont($arialNarrowB, '', 7, '', false);
				$pdfBig->Cell(92.8, 4.2, $III_SEM, 'LRB', false, 'C');
				$y_axis=$y_axis+4.1;
				$pdfBig->SetFont($arialNarrow, '', 7, '', false);
				//SEM 3
				for ($x = 1; $x <= 9; $x++) {
				...
				$pdfBig->SetXY(11.5, $y_axis);
				$pdfBig->SetFont($arialNarrowB, '', 7, '', false);
				$pdfBig->Cell(92.8, 4.2, $IV_SEM, 'LRB', false, 'C');
				$y_axis=$y_axis+4.5;
				$pdfBig->SetFont($arialNarrow, '', 7, '', false);
				//SEM 4
				for ($x = 1; $x <= 8; $x++) {
				...
				$pdfBig->SetXY(106, $y_axis);
				$pdfBig->SetFont($arialNarrowB, '', 7, '', false);
				$pdfBig->Cell(92.8, 4.2, $V_SEM, 'LRB', false, 'C');
				$y_axis=$y_axis+4.1;
				$pdfBig->SetFont($arialNarrow, '', 7, '', false);
				//SEM 5
				for ($x = 1; $x <= 10; $x++) {
				...
				$pdfBig->SetXY(106, $y_axis);
				$pdfBig->SetFont($arialNarrowB, '', 7, '', false);
				$pdfBig->Cell(92.8, 4.2, $VI_SEM, 'LRB', false, 'C');
				$y_axis=$y_axis+4.1;
				$pdfBig->SetFont($arialNarrow, '', 7, '', false);
				//SEM 6
				for ($x = 1; $x <= 11; $x++) {
				...
				$pdfBig->SetXY(106, $y_axis);
				$pdfBig->SetFont($arialNarrowB, '', 7, '', false);
				$pdfBig->Cell(92.8, 4.2, $VII_SEM, 'LRB', false, 'C');
				$y_axis=$y_axis+4.2;
				$pdfBig->SetFont($arialNarrow, '', 7, '', false);
				//SEM 7
				for ($x = 1; $x <= 2; $x++) {
					...
					if($x == 1){
						...
						$pdfBig->MultiCell(11, 8, ${"SEM7_COURSE_CODE_" . $x}, 'LB', 'L', 0, 0, '', '', true, 0, true);
						$pdfBig->setCellPaddings( $left = '', $top = '0', $right = '', $bottom = '');
					}
					$pdfBig->SetXY(115.5, $y_axis);
					$pdfBig->MultiCell(52.5, 4, ${"SEM7_COURSE_TITLE_" . $x}, 'LRB', 'L', 0, 0, '', '', true, 0, true);
					$pdfBig->MultiCell(10.3, 4, ${"SEM7_CREDIT_HOURS_" . $x}, 'LRB', 'C', 0, 0, '', '', true, 0, true);
					$pdfBig->MultiCell(10.4, 4, ${"SEM7_GRADE_POINT_" . $x}, 'LRB', 'C', 0, 0, '', '', true, 0, true);
					$pdfBig->MultiCell(10, 4, ${"SEM7_CREDIT_POINTS_" . $x}, 'LRB', 'C', 0, 0, '', '', true, 0, true);
					$y_axis +=4;
				}
				$y_axis=$y_axis-0.2;
				$pdfBig->SetXY(106, $y_axis);
				$pdfBig->SetFont($arialNarrowB, '', 7, '', false);
				$pdfBig->Cell(92.8, 4.2, $VIII_SEM, 'LRB', false, 'C');
				$y_axis=$y_axis+4.2;
				$pdfBig->SetFont($arialNarrow, '', 7, '', false);
				//SEM 8
				for ($x = 1; $x <= 8; $x++) {
					...
					$pdfBig->SetXY(106, $y_axis);
					if($x == 1){
						$pdfBig->setCellPaddings( $left = '', $top = '12', $right = '', $bottom = '');
						$pdfBig->MultiCell(11, 31, ${"SEM8_COURSE_CODE_" . $x}, 'LB', 'L', 0, 0, '', '', true, 0, true);
						$pdfBig->setCellPaddings( $left = '', $top = '0', $right = '', $bottom = '');
					}
					if($x == 8){
						$pdfBig->MultiCell(11, 4, ${"SEM8_COURSE_CODE_" . $x}, 'LB', 'L', 0, 0, '', '', true, 0, true);
					}
					$pdfBig->SetXY(115.5, $y_axis);
					$pdfBig->MultiCell(52.5, $cell_height2, ${"SEM8_COURSE_TITLE_" . $x}, 'LRB', 'L', 0, 0, '', '', true, 0, true);
					$pdfBig->MultiCell(10.3, $cell_height3, ${"SEM8_CREDIT_HOURS_" . $x}, 'LRB', 'C', 0, 0, '', '', true, 0, true);
					$pdfBig->MultiCell(10.4, $cell_height4, ${"SEM8_GRADE_POINT_" . $x}, 'LRB', 'C', 0, 0, '', '', true, 0, true);
					$pdfBig->MultiCell(10, $cell_height5, ${"SEM8_CREDIT_POINTS_" . $x}, 'LRB', 'C', 0, 0, '', '', true, 0, true);
					if($x == 6){
						$y_axis +=7;
					}else{
						$y_axis +=4;
				...
				$pdfBig->Cell(0, 0, 'Controller of Examination', 0, false, 'L');  
				//End pdfBig 
				
				//Start pdf
				$pdf->SetFont($arial, '', 8, '', false); 
				$pdf->SetTextColor(0, 0, 0);    
				$pdf->SetXY($left_pos, 12);
				$pdf->MultiCell(0, 0, 'ID No.: <b>'.$ID_No.'</b>', 0, 'L', 0, 0, '', '', true, 0, true);
				$pdf->SetFont($arial, '', 8, '', false); 
				$pdf->SetTextColor(0, 0, 0);    
				$pdf->SetXY($left_pos, 36);
				...
				$pdf->SetFont($arialb, '', 8, '', false);
				$pdf->SetXY(31, 55.5);		
				$pdf->Cell(83, 0, $Fathers_Name, 0, false, 'L');
							
				$pdf->SetFont($arial, '', 8, '', false);
				$pdf->SetXY($left_pos, 60);		
				$pdf->Cell(0, 0, 'Mother Name :', 0, false, 'L');
				$pdf->SetFont($arialb, '', 8, '', false);
				$pdf->SetXY(30, 60);
				$pdf->Cell(74, 0, $Mother_Name, 0, false, 'L');
				
				$pdf->SetFont($arial, '', 8, '', false);
				$pdf->SetXY($left_pos, 64.5);		
				$pdf->Cell(101, 0, 'College :', 0, false, 'L');
				$pdf->SetFont($arialb, '', 8, '', false);
				$pdf->SetXY(23, 64.5);		
				$pdf->Cell(83, 0, $College, 0, false, 'L');//department
				...
				$pdf->SetXY(11.5, 80);
				$pdf->Cell(92.8, 4.2, $I_SEM, 'LRB', false, 'C');
				...
				$pdf->SetXY(11.5, $y_axis);
				$pdf->SetFont($arialNarrowB, '', 7, '', false);
				$pdf->Cell(92.8, 4.2, $II_SEM, 'LRB', false, 'C');
				$y_axis=$y_axis+4.1;
				$pdf->SetFont($arialNarrow, '', 7, '', false);
				//SEM 2
				for ($x = 1; $x <= 9; $x++) {
				...
				$pdf->SetXY(11.5, $y_axis);
				$pdf->SetFont($arialNarrowB, '', 7, '', false);
				$pdf->Cell(92.8, 4.2, $III_SEM, 'LRB', false, 'C');
				$y_axis=$y_axis+4.1;
				$pdf->SetFont($arialNarrow, '', 7, '', false);
				//SEM 3
				for ($x = 1; $x <= 9; $x++) {
				...
				$pdf->SetXY(11.5, $y_axis);
				$pdf->SetFont($arialNarrowB, '', 7, '', false);
				$pdf->Cell(92.8, 4.2, $IV_SEM, 'LRB', false, 'C');
				$y_axis=$y_axis+4.5;
				$pdf->SetFont($arialNarrow, '', 7, '', false);
				//SEM 4
				for ($x = 1; $x <= 8; $x++) {
				...
				$pdf->SetXY(106, $y_axis);
				$pdf->SetFont($arialNarrowB, '', 7, '', false);
				$pdf->Cell(92.8, 4.2, $V_SEM, 'LRB', false, 'C');
				$y_axis=$y_axis+4.1;
				$pdf->SetFont($arialNarrow, '', 7, '', false);
				//SEM 5
				for ($x = 1; $x <= 10; $x++) {
				...
				$pdf->SetXY(106, $y_axis);
				$pdf->SetFont($arialNarrowB, '', 7, '', false);
				$pdf->Cell(92.8, 4.2, $VI_SEM, 'LRB', false, 'C');
				$y_axis=$y_axis+4.1;
				$pdf->SetFont($arialNarrow, '', 7, '', false);
				//SEM 6
				for ($x = 1; $x <= 11; $x++) {
				...
				$pdf->SetXY(106, $y_axis);
				$pdf->SetFont($arialNarrowB, '', 7, '', false);
				$pdf->Cell(92.8, 4.2, $VII_SEM, 'LRB', false, 'C');
				$y_axis=$y_axis+4.2;
				$pdf->SetFont($arialNarrow, '', 7, '', false);
				//SEM 7
				for ($x = 1; $x <= 2; $x++) {
					...
					if($x == 1){
						...
						$pdf->MultiCell(11, 8, ${"SEM7_COURSE_CODE_" . $x}, 'LB', 'L', 0, 0, '', '', true, 0, true);
						$pdf->setCellPaddings( $left = '', $top = '0', $right = '', $bottom = '');
					}
					$pdf->SetXY(115.5, $y_axis);
					$pdf->MultiCell(52.5, 4, ${"SEM7_COURSE_TITLE_" . $x}, 'LRB', 'L', 0, 0, '', '', true, 0, true);
					$pdf->MultiCell(10.3, 4, ${"SEM7_CREDIT_HOURS_" . $x}, 'LRB', 'C', 0, 0, '', '', true, 0, true);
					$pdf->MultiCell(10.4, 4, ${"SEM7_GRADE_POINT_" . $x}, 'LRB', 'C', 0, 0, '', '', true, 0, true);
					$pdf->MultiCell(10, 4, ${"SEM7_CREDIT_POINTS_" . $x}, 'LRB', 'C', 0, 0, '', '', true, 0, true);
					$y_axis +=4;
				}
				$y_axis=$y_axis-0.2;
				$pdf->SetXY(106, $y_axis);
				$pdf->SetFont($arialNarrowB, '', 7, '', false);
				$pdf->Cell(92.8, 4.2, $VIII_SEM, 'LRB', false, 'C');
				$y_axis=$y_axis+4.2;
				$pdf->SetFont($arialNarrow, '', 7, '', false);
				//SEM 8
				for ($x = 1; $x <= 8; $x++) {
					...
					$pdf->SetXY(106, $y_axis);
					if($x == 1){
						$pdf->setCellPaddings( $left = '', $top = '12', $right = '', $bottom = '');
						$pdf->MultiCell(11, 31, ${"SEM8_COURSE_CODE_" . $x}, 'LB', 'L', 0, 0, '', '', true, 0, true);
						$pdf->setCellPaddings( $left = '', $top = '0', $right = '', $bottom = '');
					}
					if($x == 8){
						$pdf->MultiCell(11, 4, ${"SEM8_COURSE_CODE_" . $x}, 'LB', 'L', 0, 0, '', '', true, 0, true);
					}
					$pdf->SetXY(115.5, $y_axis);
					$pdf->MultiCell(52.5, $cell_height2, ${"SEM8_COURSE_TITLE_" . $x}, 'LRB', 'L', 0, 0, '', '', true, 0, true);
					$pdf->MultiCell(10.3, $cell_height3, ${"SEM8_CREDIT_HOURS_" . $x}, 'LRB', 'C', 0, 0, '', '', true, 0, true);
					$pdf->MultiCell(10.4, $cell_height4, ${"SEM8_GRADE_POINT_" . $x}, 'LRB', 'C', 0, 0, '', '', true, 0, true);
					$pdf->MultiCell(10, $cell_height5, ${"SEM8_CREDIT_POINTS_" . $x}, 'LRB', 'C', 0, 0, '', '', true, 0, true);
					if($x == 6){
						$y_axis +=7;
					}else{
						$y_axis +=4;
				...
				$pdf->SetXY(145, 261.5);
				$pdf->Cell(0, 0, 'Controller of Examination', 0, false, 'L');    					           
				//End pdf			

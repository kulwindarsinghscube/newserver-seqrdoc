...
class PdfGenerateWOXSENTranscript10Job
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
            ...
            $Total_Credits_Earned=$studentData[28];
			$CGPA=$studentData[29];
			$Major1=$studentData[31];
			$Major2=$studentData[32];
			$Major_Minor=$studentData[33];
            ...
            //data processing
            $subjectsData=$subjectsArr[$studentData[7]];
            //Separate semesters 
            $subjects = array();
           ...
           //data processing
                ...
                $profile_path_org_jpg = public_path().'\\'.$subdomain[0].'\backend\templates\100\\'.$studentData[7].'.jpg';
                $profile_path_org_jpeg = public_path().'\\'.$subdomain[0].'\backend\templates\100\\'.$studentData[7].'.jpeg';
                $profile_path_org_png = public_path().'\\'.$subdomain[0].'\backend\templates\100\\'.$studentData[7].'.png';
                ...
                $str=$studentData[0];
                $codeContents = "";
                $codeContents .= $studentData[1];
                $codeContents .="\n";
                $codeContents .= $studentData[5];
                $codeContents .="\n";
                
                $codeContents .= $studentData[7];
                $codeContents .="\n\n".strtoupper(md5($str));
                ...
                $pdfBig->Cell(0, 0, $studentData[30], 0, false, 'L');

                $pdf->SetFont('E-13B_0', '', 12, '', false);
                $pdf->SetXY($card_serial_nox, $card_serial_noy);
                $pdf->Cell(0, 0, $studentData[30], 0, false, 'L');
...
//   <tr>
//     <td width="60%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Student Name: <b>{$studentData[1]}</b></td>
//     <td width="40%">Father Name: <b>{$studentData[3]}</b></td>
//    </tr>
//    <tr>
//     <td width="60%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Program: <b>{$studentData[4]}</b></td>
//     <td width="40%">Academic Year: <b>{$studentData[5]}</b></td>
//    </tr>
//    <tr>
//     <td width="60%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Specialization: <b>{$studentData[6]}</b></td>
//     <td width="40%">Student ID: <b>{$studentData[7]}</b></td>
//    </tr>
//   </table>
// EOD;
...
<table id="table1" cellspacing="0" cellpadding="3" rules="rows" border="0.1" width="47%">
  <tr>
    <td width="100%" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Student Name: <b>{$studentData[1]}</b></td>
   </tr>
   <tr>
    <td width="60%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Father Name: <b>{$studentData[3]}</b></td>
    <td width="40%">Mother Name: <b>{$studentData[2]}</b></td>
   </tr>
   <tr>
    <td width="60%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Program: <b>{$studentData[4]}</b></td>
    <td width="40%">Academic Session: <b>{$studentData[5]}</b></td>
  </tr>
   <tr>
    <td width="60%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Specialization: <b>{$studentData[6]}</b></td>    
    <td width="40%">Student ID: <b>{$studentData[7]}</b></td>
...
EOD;
        ...
        foreach($subjects as $term => $term_array){
            ...
            if($term < 5)
            {
                $strtd .= '<tr>
                        ...
                        <td colspan="6" style="text-align:center;border-right:0px solid black;"><B style="text-decoration: underline;">Semester - '.$term.'</B></td>
                      </tr>';
                ...
                foreach($term_array as $key => $val)
                {
                    $GlobalSubject++;
                    $strtd .= '<tr>
                                    <td style="widtd:12%;text-align:center;border-right:0px solid black;border-left:0px solid black;"><B>'.$val[2].'</B></td>
                                    <td style="widtd:47%;text-align:left;"><B>'.$val[3].'</B></td>
                                    <td style="widtd:12%;text-align:center;"><B></B></td>
                                    <td style="widtd:7%;text-align:center;"><B>'.$val[4].'</B></td>';
                    $align = strlen($val[5]) ? 'left' : 'center';
                    $strtd .=       '<td style="widtd:6%;text-align:'.$align.';"><B>'.$val[5].'</B></td>';
                    $strtd .=       '<td style="widtd:16%;text-align:center;border-right:0px solid black;"><B></B></td>
                                </tr>';
                }
                // $strtd .= '<tr>
                //                 <td style="text-align:center;border-right:0px solid black;border-left:0px solid black;"><B></B></td>
                ...
                if($term == 1){
                    $strtd .=   '<tr style="line-height:0.5px;">
                                <td style="widtd:12%;text-align:center;border-right:0px solid black;border-left:0px solid black;"><B></B></td>
                                <td style="widtd:47%;text-align:left;"><B>Total Credits : '.round($studentData[$IndividualDataIndex-1],2) .'</B></td>
                                <td style="widtd:12%;text-align:center;"><B></B></td>
                                <td style="widtd:7%;text-align:center;"><B></B></td>
                                <td style="widtd:6%;text-align:center;"><B></B></td>
                                <td style="widtd:16%;text-align:center;border-right:0px solid black;"><B>GPA - 0'.$term.' : '.number_format(round($studentData[$IndividualDataIndex],2),2).'</B></td>
                            </tr>';
                        //$IndividualDataIndex++;  
                    ...
                    //     //             <td style="widtd:7%;text-align:center;"><B></B></td>
                    //     //             <td style="widtd:6%;text-align:center;"><B></B></td>
                    //     //             <td style="widtd:19%;text-align:center;border-right:0px solid black;"><B>CGPA - 0'.$term.' : '.round($studentData[$IndividualDataIndex],2).'</B></td>
                    //     //         </tr>';
                    //     // $IndividualDataIndex += 2;
                    // }else{
                    ...
                    //                     <td style="widtd:19%;text-align:center;border-bottom:0px solid black;border-right:0px solid black;"><B>CGPA - 0'.$term.' : '.round($studentData[$IndividualDataIndex],2).'</B></td>
                    //             </tr>';
                    //     $IndividualDataIndex += 2;    
                    // }            
                ...
                foreach($term_array as $key => $val)
                {
                    ...
                    $strtr .=   '<tr>
                                    ...
                                    <td style="widtd:7%;text-align:center;"><B>'.$val[4].'</B></td>';
                    $align = strlen($val[5]) ? 'left' : 'center';
                    $strtr .=       '<td style="widtd:6%;text-align:'.$align.';"><B>'.$val[5].'</B></td>';
                    $strtr .=       '<td style="widtd:16%;text-align:center;border-right:0px solid black;"><B></B></td>
                                </tr>';
                }
                    // $strtr .= '<tr>
                    //                 <td style="text-align:center;border-right:0px solid black;border-left:0px solid black;"><B></B></td>
                    ...
                    $strtr .=   '<tr  style="line-height:0.5px;">
                                    <td style="widtd:12%;text-align:center;border-right:0px solid black;border-left:0px solid black;"><B></B></td>
                                    <td style="widtd:47%;text-align:left;"><B>Total Credits : '.round($studentData[$IndividualDataIndex-1],2) .'</B></td>
                                    <td style="widtd:12%;text-align:center;"><B></B></td>
                                    <td style="widtd:7%;text-align:center;"><B></B></td>
        ...
        $strtr .=   '<tr>
                    <td style="widtd:12%;text-align:center;border-right:0px solid black;border-left:0px solid black;"><B></B></td>
                    <td style="widtd:47%;text-align:left;"><B></B></td>
                    <td style="widtd:12%;text-align:center;"><B></B></td>
                    <td style="widtd:7%;text-align:center;"><B></B></td>
                    <td style="widtd:6%;text-align:center;"><B></B></td>
                    <td style="widtd:16%;text-align:center;border-right:0px solid black;"><B>CGPA: '.number_format(round($CGPA,2),2).'</B></td>
                </tr>';

        if($Major1!=''){
                $strtr .=   '<tr>
                                <td style="widtd:12%;text-align:center;border-right:0px solid black;border-left:0px solid black;"><B></B></td>
                                <td style="widtd:47%;text-align:left;"><B>'.$Major1_title.': '.$Major1.'</B></td>
                                <td style="widtd:12%;text-align:center;"><B></B></td>
                                <td style="widtd:7%;text-align:center;"><B></B></td>
                                <td style="widtd:6%;text-align:center;"><B></B></td>
                                <td style="widtd:16%;text-align:center;border-right:0px solid black;"><B></B></td>
                            </tr>';
        }
        ...
        if($Major2!=''){
            ...
            $strtr .=  '<tr>
                            <td style="widtd:12%;text-align:center;border-left: 0px solid black;border-right: 0px solid black;border-bottom: 0px solid black;"><B></B></td>
                            <td style="widtd:60%;text-align:left;border-bottom: 0px solid black;"><B>'.$Major2_title.': '.$Major2.'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Total Credit Score: '.$Total_Credits_Earned.'</B></td>
            ...
            $strtr .=   '<tr>
                            <td style="widtd:12%;text-align:center;border-left: 0px solid black;border-right: 0px solid black;border-bottom: 0px solid black;"><B></B></td>
                            <td style="widtd:60%;text-align:left;border-bottom: 0px solid black;"><B>Total Credit Score: '.round($Total_Credits_Earned,2) .'</B></td>
                            <td colspan="4" style="widtd:13%;text-align:center;border-bottom: 0px solid black;border-right: 0px solid black;"><B></B></td>
                        </tr>';
        }
        ...
        // $strtr .=   '<tr>
        //                 <td style="width:12%;text-align:center;"><B></B></td>
        //                 <td style="width:59%;text-align:left;" colspan="2"><B></B></td>
        //                 <td style="width:7%;text-align:center;"><B></B></td>
        //                 <td style="width:6%;text-align:center;"><B></B></td>
        //                 <td style="width:16%;text-align:center;"><B>CGPA: '.number_format(round($CGPA,2),2).'</B></td>
        //             </tr>';

        // if($Major1!=''){
        //     $strtr .=   '<tr>
        //                     <td style="width:12%;text-align:center;"><B></B></td>
        //                     <td style="width:59%;text-align:left;" colspan="2"><B>'.$Major1_title.': '.$Major1.'</B></td>
        //                     <td style="width:7%;text-align:center;"><B></B></td>
        //                     <td style="width:6%;text-align:center;"><B></B></td>
        //                     <td style="width:16%;text-align:center;"><B></B></td>
        //                 </tr>';
        // }
        // if($Major2!=''){
        //     $strtr .=   '<tr style="line-height:0.5px;">
        //                         <td style="width:12%;text-align:center;"><B></B></td>
        //                         <td style="width:23%;text-align:left;" colspan="2"><B>'.$Major2_title.': '.$Major2.'</B></td>
        ...
        //     $strtr .=   '<tr style="line-height:0.5px;">
        //                     <td style="width:12%;text-align:center;"><B></B></td>
        //                     <td style="width:23%;text-align:left;" colspan="2"><B></B></td>
        //                     <td style="width:40%;text-align:center;"><B>Total Credit Score: '.$Total_Credits_Earned.'</B></td>
        //                     <td style="width:15%;text-align:center;"><B></B></td>
        //                     <td style="width:10%;text-align:center;"><B></B></td>
        //                 </tr>';
        ...
        // }
                    ...
                    // $strtd .=   '<tr>
                    //                 <td style="widtd:12%;text-align:center;border-right:0px solid black;border-left:0px solid black;"><B></B></td>
                    //                 <td style="widtd:47%;text-align:left;"><B>Total Credit : '.round($studentData[$IndividualDataIndex-1],2).'</B></td>
                    //                 <td style="widtd:12%;text-align:center;"><B></B></td>
                    //                 <td style="widtd:7%;text-align:center;"><B></B></td>
                    //                 <td style="widtd:6%;text-align:center;"><B></B></td>
                    //                 <td style="widtd:16%;text-align:center;border-right:0px solid black;"><B>GPA - 0'.$term.' : '.round($studentData[$IndividualDataIndex],2).'</B></td>
                    //             </tr>';
                    //     $IndividualDataIndex += 2;


        if((strpos(trim($studentData[4]), "Bachelor of Design") !== false) ) {

            $strtd = $strtd.''.$strtr;


            $modifiedHtml =  preg_replace('/<\/tr>/', '</tr>~', $strtd);

            $trArr=explode('~', $modifiedHtml);

            // Index to split the array
            $index = 33;

            // Split the array into two parts
            $first_part = array_slice($trArr, 0, $index); // Elements from index 0 to $index-1
            $second_part = array_slice($trArr, $index); // Elements from index $index to end

            

            // print_r($trArr);
            $strtd = implode('',$first_part);
            $strtr = implode('',$second_part);
        } else if((strpos(trim($studentData[4]), "Bachelor of Technology") !== false)) {
            ...
            $strtd = implode('',$first_part);
            $strtr = implode('',$second_part);
        }else if((strpos(trim($studentData[4]), "Bachelor of Architecture") !== false)) {
        ...
        $strtd .= '<tr>
                    <td style="widtd:12%;text-align:center;border-right:0px solid black;border-left:0px solid black;border-bottom:0px solid black;"><B></B></td>
                    <td style="widtd:47%;text-align:left;border-bottom:0px solid black;"></td>
                    <td style="widtd:12%;text-align:center;border-bottom:0px solid black;"><B></B></td>
                    <td style="widtd:7%;text-align:center;border-bottom:0px solid black;"><B></B></td>
                    <td style="widtd:6%;text-align:center;border-bottom:0px solid black;"><B></B></td>
                    <td style="widtd:16%;text-align:center;border-right:0px solid black;border-bottom:0px solid black;"></td>
                </tr>';




        // echo htmlspecialchars($strtd);
    
        // echo "<br>";

        // $splitPoint = 35; // Adjust this to split at a different number of rows
        // [$strtd, $strtr] = $this->splitByTrCount(htmlspecialchars($strtd), $splitPoint);
        ...
        // $strtd = htmlspecialchars($strtd);
        // $strtr = htmlspecialchars($strtr);
...
<table id="table2" class="t-table borderspace" cellspacing="0" cellpadding="2" width="47%">
  <tr>
    <th style="width:12%;text-align:center;border-top:0px solid black;border-bottom:0px solid black;border-right:0px solid black;border-left:0px solid black;"><B>Course Code</B></th>
    <th style="width:47%;text-align:center;border-top:0px solid black;border-bottom:0px solid black;margin-top:40px;"><B>Course Name</B></th>
    <th style="width:12%;text-align:center;border-top:0px solid black;border-bottom:0px solid black;"><B></B></th>
    ...
    <th style="width:16%;text-align:center;border-top:0px solid black;border-bottom:0px solid black;border-right:0px solid black;"><B></B></th>
   </tr>
   {$strtd} 
  </table>
EOD;
        $pdfBig->writeHTMLCell($w = 0, $h = 0, $x = '11', $y = '76', $html, $border = 0, $ln = 1, $fill = 0, $reseth = true, $align = '', $autopadding = true);//71
...
<table id="table3" cellspacing="0" cellpadding="2" width="98.5%">
  <tr>
    <th style="width:12%;text-align:center;border-top:0px solid black;border-bottom:0px solid black;border-right:0px solid black;border-left:0px solid black;"><B>Course Code</B></th>
    <th style="width:47%;text-align:center;border-top:0px solid black;border-bottom:0px solid black;"><B>Course Name</B></th>
    <th style="width:12%;text-align:center;border-top:0px solid black;border-bottom:0px solid black;"><B></B></th>
    <th style="width:7%;text-align:center;border-top:0px solid black;border-bottom:0px solid black;"><B>Credits</B></th>
    <th style="width:6%;text-align:center;border-top:0px solid black;border-bottom:0px solid black;"><B>Grade</B></th>
    <th style="width:16%;text-align:center;border-top:0px solid black;border-bottom:0px solid black;border-right:0px solid black;"><B></B></th>
...
EOD;
        ...
        // month_and_year
        $pdf->SetFont($timesNewRomanB, '', 11, '', false);
        $pdf->SetXY(300, 275);   //295, 275
        $pdf->MultiCell(0, 0, $month_and_year,'', 'L', 0, 0);

        $pdfBig->SetFont($timesNewRomanB, '', 11, '', false);
        $pdfBig->SetXY(300, 275);   //295, 275
        $pdfBig->MultiCell(0, 0, $month_and_year,'', 'L', 0, 0);
        ...
        if($previewPdf!=1){
            ...
            $msg = "<b>Click <a href='".$path.$subdomain[0]."/backend/tcpdf/examples/".$file_name."'class='downloadpdf' target='_blank'>Here</a> to download file<b>";
        }else{

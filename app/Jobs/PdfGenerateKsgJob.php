    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
		...
		if($studentDataOrg&&!empty($studentDataOrg)){
			foreach ($studentDataOrg as $studentData) {
                ...
                $serial_no=$studentData['usn'];
                $name=$studentData['name'];

				$str=strtoupper($studentData['name'].$studentData['usn'].$studentData['course'].$studentData['course_month']);							
                    ...
                    $pdfBig->SetXY(15, $y);
                    $pdfBig->Cell(0, 10, $studentData['name'], 0, false, 'C');
                    ...
                    // $pdfBig->Cell(0, 10, $studentData['course'], 0, false, 'C');
                        ...
                        if (!empty($studentData['course']) && !empty($studentData['course_2'])) {
                        
                            $pdfBig->SetXY($x+10, $y);
                            $pdfBig->MultiCell(0, 7, $studentData['course'], 0, 'C', false);
                            $pdfBig->SetXY($x+10, $pdfBig->getY()); 
                            $pdfBig->MultiCell(0, 6, $studentData['course_2'], 0, 'C', false);

                        } elseif (!empty($studentData['course']) && !empty($studentData['credit']) && empty($studentData['course_2'])) {
                            $pdfBig->SetXY($x+10, $y);
                            $pdfBig->MultiCell(0, 7, $studentData['course'], 0, 'C', false);
                            $pdfBig->SetFont($bookantiqua_bold, 'B', 22, '', false);
                            $pdfBig->SetXY($x+10, $pdfBig->getY()); 
                            $pdfBig->MultiCell(0, 6, $studentData['credit'], 0, 'C', false);
                        }
                        else if(!empty($studentData['course'])&& (empty($studentData['course_2'])|| empty($studentData['credit']))){
                            $pdfBig->SetXY($x+10, $y);
                                $pdfBig->MultiCell(0, 7, $studentData['course'], 0, 'C', false);
                    ...
                    $pdfBig->MultiCell(0, 10,'on this &nbsp;&nbsp;<span style="color:#004AA4; font-size:22;"><font face="'.$bookantiqua_bold.'">'. $studentData['course_date'].'</font></span> &nbsp;&nbsp;day of  &nbsp;&nbsp;<span style="color:#004AA4;font-size:22;"><font face="'.$bookantiqua_bold.'">'. $studentData['course_month'].'</font></span>',0,'C', 0, 0, '', '', true, 
				...
				//Start pdf
                   $pdf->SetFont($arial, '', 5, '', false);
                    ...
                    $pdf->SetXY(15, $y);
                    $pdf->Cell(0, 10, $studentData['name'], 0, false, 'C');
                    ...
                    // $pdf->Cell(0, 10, $studentData['course'], 0, false, 'C');
                        ...
                        if (!empty($studentData['course']) && !empty($studentData['course_2'])) {
                            ...
                            $pdf->SetXY($x+10, $y);
                            $pdf->MultiCell(0, 7, $studentData['course'], 0, 'C', false);
                            $pdf->SetXY($x+10, $pdf->getY()); 
                            $pdf->MultiCell(0, 6, $studentData['course_2'], 0, 'C', false);
                            ...
                            $pdf->SetXY($x+10, $pdf->getY()); 
                            $pdf->MultiCell(0, 6, $studentData['credit'], 0, 'C', false);
                        }
                        else if(!empty($studentData['course'])&& (empty($studentData['course_2'])|| empty($studentData['credit']))){
                            $pdf->SetXY($x+10, $y);
                                $pdf->MultiCell(0, 7, $studentData['course'], 0, 'C', false);
                    ...
                    $pdf->MultiCell(0, 10,'on this &nbsp;&nbsp;<span style="color:#004AA4; font-size:22;"><font face="'.$bookantiqua_bold.'">'. $studentData['course_date'].'</font></span> &nbsp;&nbsp;day of  &nbsp;&nbsp;<span style="color:#004AA4;font-size:22;"><font face="'.$bookantiqua_bold.'">'. $studentData['course_month'].'</font></span>',0,'C', 0, 0, '', '', true, 
                    0,  true,   true,  0, 'T', true);
                    $y= $pdf->getY();
                    $pdf->SetXY(0, $y+14); 
        ...
        if($previewPdf!=1){
			//$this->updateCardNo('KSG',$card_serial_no-$cardDetails->starting_serial_no,$card_serial_no);
        }
        $msg = '';

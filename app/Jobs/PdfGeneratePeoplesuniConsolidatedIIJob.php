...
class PdfGeneratePeoplesuniConsolidatedIIJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
            ...
            $rightX3 = 142;
            $pdfBig->SetFont($timesb, '', 9, '', false);
            $pdfBig->SetXY($rightX1, 64);
            $pdfBig->MultiCell(44, $headerHeight, 'PROGRAM', 0, 'L', 0, 0, '', '', true, 0, true);

            $pdfBig->SetFont($timesb, '', 9, '', false);
            $pdfBig->SetXY($rightX2, 64);
            $pdfBig->MultiCell(4, $headerHeight, ':', 0, 'L', 0, 0, '', '', true, 0, true);

            $pdfBig->SetFont($times, '', 9, '', false);
            $pdfBig->SetXY($rightX3, 64);
            ...
            foreach($subjects as $term => $term_array){
                    ...
                    $pdfBig->SetXY(22, $tableY);
                    $pdfBig->MultiCell(55, 5, 'SEMESTER-'.$term, 'LT', 'L', 0, 0, '', '', true, 0, true);
    
                    $pdfBig->SetFont($timesb, '', 8, '', false);
                    $pdfBig->SetXY($pdfBig->GetX(), $tableY);
                    $pdfBig->MultiCell(55, 5, 'MYOP : '.trim($studentData[$IndividualDataIndex]), 'LT', 'L', 0, 0, '', '', true, 0, true);
                    $IndividualDataIndex++; 
    
                    $pdfBig->SetFont($timesb, '', 8, '', false);
                    $pdfBig->SetXY($pdfBig->GetX(), $tableY);
                    $pdfBig->MultiCell(55, 5, 'STATUS : '.trim($studentData[$IndividualDataIndex]), 'LTR', 'L', 0, 0, '', '', true, 0, true);
                    $IndividualDataIndex++; 
                    $pdfBig->Ln();
    
                    $pdfBig->SetFont($times, '', 8, '', false);
                    $pdfBig->SetXY(22, $pdfBig->GetY());
                    $pdfBig->setCellHeightRatio(0.9);
                    $pdfBig->setCellPaddings( $left = '', $top = '3', $right = '', $bottom = '');
                    $pdfBig->MultiCell(26, 10, 'PAPER CODE', 'LTR', 'C', 0, 0, '', '', true, 0, true);
                    $pdfBig->setCellHeightRatio(1);
    
                    $pdfBig->SetFont($times, '', 8, '', false);
                    $pdfBig->SetXY($pdfBig->GetX(), $pdfBig->GetY());
                    $pdfBig->setCellPaddings( $left = '', $top = '3', $right = '', $bottom = '');
                    $pdfBig->MultiCell(74, 10, 'NAME OF PAPER', 'LTR', 'C', 0, 0, '', '', true, 0, true);
    
                    $pdfBig->SetFont($times, '', 8, '', false);
                    $pdfBig->SetXY($allotedCrX = $pdfBig->GetX(), $gradeY = $pdfBig->GetY());
                    $pdfBig->setCellPaddings( $left = '', $top = '1', $right = '', $bottom = '0');
                    $pdfBig->MultiCell(44, 5, 'CREDITS', 'LTR', 'C', 0, 0, '', '', true, 0, true);
    
    
                    $pdfBig->SetFont($times, '', 8, '', false);
                    $pdfBig->SetXY($allotedCrX, $pdfBig->GetY() + 5);
                    $pdfBig->setCellPaddings( $left = '', $top = '1', $right = '', $bottom = '0');
                    $pdfBig->MultiCell(22, 5, 'ALLOTED', 'LTR', 'C', 0, 0, '', '', true, 0, true);
    
                    $pdfBig->SetFont($times, '', 8, '', false);
                    $pdfBig->SetXY($pdfBig->GetX(), $pdfBig->GetY());
                    $pdfBig->MultiCell(22, 5, 'EARNED', 'LTR', 'C', 0, 0, '', '', true, 0, true);
    
                    
                    $pdfBig->SetFont($times, '', 8, '', false);
                    $pdfBig->SetXY($pdfBig->GetX(), $gradeY);
                    $pdfBig->setCellPaddings( $left = '', $top = '3', $right = '', $bottom = '');
                    $pdfBig->MultiCell(21, 10, 'GRADE', 'LTR', 'C', 0, 0, '', '', true, 0, true);
                    ...
                    foreach($term_array as $key => $val){
                        ...
                        $pdfBig->SetFont($times, '', 8, '', false);
                        $pdfBig->SetXY(22, $SecondTableY);
                        $pdfBig->setCellHeightRatio(0.9);
                        $pdfBig->setCellPaddings( $left = '', $top = '2', $right = '', $bottom = '');
                        $pdfBig->MultiCell(26, 8, $val[2], 'LTRB', 'C', 0, 0, '', '', true, 0, true);
                        $pdfBig->setCellHeightRatio(1);
                        ...
                        $lines = $pdfBig->MultiCell(70, 0, $val[3], 0, 'L', 0, 0, '', '', true, 0, false,true, 0);
                        ...
                        $pdfBig->MultiCell(70, 8, $val[3], 'LTRB', 'L', 0, 0, '', '', true, 0, true);
    
                        $pdfBig->SetFont($times, '', 8, '', false);
                        $pdfBig->SetXY($belowtableX = $pdfBig->GetX(), $SecondTableY);
                        $pdfBig->setCellPaddings( $left = '', $top = '0.5', $right = '', $bottom = '0');
                        $pdfBig->MultiCell(4, 4,$val[4], 'LTRB', 'C', 0, 0, '', '', true, 0, true);
    
                        $pdfBig->SetFont($times, '', 8, '', false);
                        $pdfBig->SetXY($pdfBig->GetX(), $SecondTableY);
                        $pdfBig->setCellPaddings( $left = '', $top = '0.5', $right = '', $bottom = '0');
                        $pdfBig->MultiCell(22, 4, $val[5], 'LTRB', 'C', 0, 0, '', '', true, 0, true);
    
                        $pdfBig->SetFont($times, '', 8, '', false);
                        $pdfBig->SetXY($pdfBig->GetX(), $SecondTableY);
                        $pdfBig->MultiCell(22, 4, $val[6], 'LTRB', 'C', 0, 0, '', '', true, 0, true);
    
                        $pdfBig->SetFont($times, '', 8, '', false);
                        $pdfBig->SetXY($pdfBig->GetX(), $SecondTableY);
                        // $pdfBig->setCellPaddings($left = '', $top = '1.8', $right = '', $bottom = '');
                        $pdfBig->MultiCell(21, 4, $val[7], 'LTRB', 'C', 0, 0, '', '', true, 0, true);
    
    
                        $pdfBig->SetFont($times, '', 8, '', false);
                        $pdfBig->SetXY($belowtableX, $SecondTableY+4);
                        $pdfBig->setCellPaddings($left = '', $top = '0.5', $right = '', $bottom = '0');
                        $pdfBig->MultiCell(4, 4,$val[8], 'LTRB', 'C', 0, 0, '', '', true, 0, true);
    
                        $pdfBig->SetFont($times, '', 8, '', false);
                        $pdfBig->SetXY($pdfBig->GetX(), $SecondTableY+4);
                        $pdfBig->setCellPaddings($left = '', $top = '0.5', $right = '', $bottom = '0');
                        $pdfBig->MultiCell(22, 4, $val[9], 'LTRB', 'C', 0, 0, '', '', true, 0, true);
    
                        $pdfBig->SetFont($times, '', 8, '', false);
                        $pdfBig->SetXY($pdfBig->GetX(), $SecondTableY+4);
                        $pdfBig->MultiCell(22, 4, $val[10], 'LTRB', 'C', 0, 0, '', '', true, 0, true);
    
                        
                        $pdfBig->SetFont($times, '', 8, '', false);
                        $pdfBig->SetXY($pdfBig->GetX(), $SecondTableY+4);
                        // $pdfBig->setCellPaddings($left = '', $top = '1.8', $right = '', $bottom = '');
                        $pdfBig->MultiCell(21, 4, $val[11], 'LTRB', 'C', 0, 0, '', '', true, 0, true);
                    ...
                    $pdfBig->SetFont($times, '', 8, '', false);
                    $pdfBig->SetXY(22, $pdfBig->GetY());
                    $pdfBig->MultiCell(137, 5, 'TEC : '.trim($studentData[$IndividualDataIndex]), 'LTB', 'L', 0, 0, '', '', true, 0, true);
                    $IndividualDataIndex++; 

                    $pdfBig->setCellPaddings($left = '', $top = '1', $right = '', $bottom = '');
                    $pdfBig->SetFont($times, '', 8, '', false);
                    $pdfBig->SetXY($pdfBig->GetX(), $pdfBig->GetY());
                    $pdfBig->MultiCell(28, 5, 'SGPA :'.trim($studentData[$IndividualDataIndex]), 'TRB', 'L', 0, 0, '', '', true, 0, true);
                    $IndividualDataIndex++; 
                    $pdfBig->Ln();
                    $tableY = $pdfBig->GetY();
            ...
            $pdfBig->SetFont($times, '', 7, '', false);
            $pdfBig->SetXY($pdfBig->GetX(), $pdfBig->GetY());
            $pdfBig->MultiCell(20, 3.5, trim($result), 1, 'C', 0, 0, '', '', true, 0, true);
            ...
            $pdfBig->SetFont($times, '', 7, '', false);
            $pdfBig->SetXY($pdfBig->GetX(), $pdfBig->GetY());
            $pdfBig->MultiCell(20, $height, trim($division), 1, 'C', 0, 0, '', '', true, 0, true);
            ...
            foreach($subjects as $term => $term_array){
                    ...
                    $pdf->SetXY(22, $tableY);
                    $pdf->MultiCell(55, 5, 'SEMESTER-'.$term, 'LT', 'L', 0, 0, '', '', true, 0, true);
    
                    $pdf->SetFont($timesb, '', 8, '', false);
                    $pdf->SetXY($pdf->GetX(), $tableY);
                    $pdf->MultiCell(55, 5, 'MYOP : '.trim($studentData[$IndividualDataIndex]), 'LT', 'L', 0, 0, '', '', true, 0, true);
                    $IndividualDataIndex++; 
    
                    $pdf->SetFont($timesb, '', 8, '', false);
                    $pdf->SetXY($pdf->GetX(), $tableY);
                    $pdf->MultiCell(55, 5, 'STATUS : '.trim($studentData[$IndividualDataIndex]), 'LTR', 'L', 0, 0, '', '', true, 0, true);
                    $IndividualDataIndex++; 
                    $pdf->Ln();
                    ...
                    $pdf->MultiCell(26, 10, 'PAPER CODE', 'LTR', 'C', 0, 0, '', '', true, 0, true);
                    $pdf->setCellHeightRatio(1);
    
                    $pdf->SetFont($times, '', 8, '', false);
                    $pdf->SetXY($pdf->GetX(), $pdf->GetY());
                    $pdf->setCellPaddings( $left = '', $top = '3', $right = '', $bottom = '');
                    $pdf->MultiCell(74, 10, 'NAME OF PAPER', 'LTR', 'C', 0, 0, '', '', true, 0, true);
    
                    $pdf->SetFont($times, '', 8, '', false);
                    $pdf->SetXY($allotedCrX = $pdf->GetX(), $gradeY = $pdf->GetY());
                    $pdf->setCellPaddings( $left = '', $top = '1', $right = '', $bottom = '0');
                    $pdf->MultiCell(44, 5, 'CREDITS', 'LTR', 'C', 0, 0, '', '', true, 0, true);
    
    
                    $pdf->SetFont($times, '', 8, '', false);
                    $pdf->SetXY($allotedCrX, $pdf->GetY() + 5);
                    $pdf->setCellPaddings( $left = '', $top = '1', $right = '', $bottom = '0');
                    $pdf->MultiCell(22, 5, 'ALLOTED', 'LTR', 'C', 0, 0, '', '', true, 0, true);
    
                    $pdf->SetFont($times, '', 8, '', false);
                    $pdf->SetXY($pdf->GetX(), $pdf->GetY());
                    $pdf->MultiCell(22, 5, 'EARNED', 'LTR', 'C', 0, 0, '', '', true, 0, true);
    
                    
                    $pdf->SetFont($times, '', 8, '', false);
                    $pdf->SetXY($pdf->GetX(), $gradeY);
                    $pdf->setCellPaddings( $left = '', $top = '3', $right = '', $bottom = '');
                    $pdf->MultiCell(21, 10, 'GRADE', 'LTR', 'C', 0, 0, '', '', true, 0, true);
                    ...
                    foreach($term_array as $key => $val){
                        ...
                        $pdf->SetFont($times, '', 8, '', false);
                        $pdf->SetXY(22, $SecondTableY);
                        $pdf->setCellHeightRatio(0.9);
                        $pdf->setCellPaddings( $left = '', $top = '2', $right = '', $bottom = '');
                        $pdf->MultiCell(26, 8, $val[2], 'LTRB', 'C', 0, 0, '', '', true, 0, true);
                        $pdf->setCellHeightRatio(1);
                        ...
                        // get the number of lines
                        $lines = $pdf->MultiCell(70, 0, $val[3], 0, 'L', 0, 0, '', '', true, 0, false,true, 0);
                        ...
                        $pdf->MultiCell(70, 8, $val[3], 'LTRB', 'L', 0, 0, '', '', true, 0, true);
    
                        $pdf->SetFont($times, '', 8, '', false);
                        $pdf->SetXY($belowtableX = $pdf->GetX(), $SecondTableY);
                        $pdf->setCellPaddings( $left = '', $top = '0.5', $right = '', $bottom = '0');
                        $pdf->MultiCell(4, 4,$val[4], 'LTRB', 'C', 0, 0, '', '', true, 0, true);
    
                        $pdf->SetFont($times, '', 8, '', false);
                        $pdf->SetXY($pdf->GetX(), $SecondTableY);
                        $pdf->setCellPaddings( $left = '', $top = '0.5', $right = '', $bottom = '0');
                        $pdf->MultiCell(22, 4, $val[5], 'LTRB', 'C', 0, 0, '', '', true, 0, true);
    
                        $pdf->SetFont($times, '', 8, '', false);
                        $pdf->SetXY($pdf->GetX(), $SecondTableY);
                        $pdf->MultiCell(22, 4, $val[6], 'LTRB', 'C', 0, 0, '', '', true, 0, true);
    
                        $pdf->SetFont($times, '', 8, '', false);
                        $pdf->SetXY($pdf->GetX(), $SecondTableY);
                        // $pdf->setCellPaddings($left = '', $top = '1.8', $right = '', $bottom = '');
                        $pdf->MultiCell(21, 4, $val[7], 'LTRB', 'C', 0, 0, '', '', true, 0, true);
    
    
                        $pdf->SetFont($times, '', 8, '', false);
                        $pdf->SetXY($belowtableX, $SecondTableY+4);
                        $pdf->setCellPaddings($left = '', $top = '0.5', $right = '', $bottom = '0');
                        $pdf->MultiCell(4, 4,$val[8], 'LTRB', 'C', 0, 0, '', '', true, 0, true);
    
                        $pdf->SetFont($times, '', 8, '', false);
                        $pdf->SetXY($pdf->GetX(), $SecondTableY+4);
                        $pdf->setCellPaddings($left = '', $top = '0.5', $right = '', $bottom = '0');
                        $pdf->MultiCell(22, 4, $val[9], 'LTRB', 'C', 0, 0, '', '', true, 0, true);
    
                        $pdf->SetFont($times, '', 8, '', false);
                        $pdf->SetXY($pdf->GetX(), $SecondTableY+4);
                        $pdf->MultiCell(22, 4, $val[10], 'LTRB', 'C', 0, 0, '', '', true, 0, true);
    
                        
                        $pdf->SetFont($times, '', 8, '', false);
                        $pdf->SetXY($pdf->GetX(), $SecondTableY+4);
                        // $pdf->setCellPaddings($left = '', $top = '1.8', $right = '', $bottom = '');
                        $pdf->MultiCell(21, 4, $val[11], 'LTRB', 'C', 0, 0, '', '', true, 0, true);
                    ...
                    $pdf->SetFont($times, '', 8, '', false);
                    $pdf->SetXY(22, $pdf->GetY());
                    $pdf->MultiCell(137, 5, 'TEC : '.trim($studentData[$IndividualDataIndex]), 'LTB', 'L', 0, 0, '', '', true, 0, true);
                    $IndividualDataIndex++; 

                    $pdf->setCellPaddings($left = '', $top = '1', $right = '', $bottom = '');
                    $pdf->SetFont($times, '', 8, '', false);
                    $pdf->SetXY($pdf->GetX(), $pdf->GetY());
                    $pdf->MultiCell(28, 5, 'SGPA :'.trim($studentData[$IndividualDataIndex]), 'TRB', 'L', 0, 0, '', '', true, 0, true);
                    $IndividualDataIndex++; 
                    $pdf->Ln();
                    $tableY = $pdf->GetY();
            ...
            $pdf->SetFont($times, '', 7, '', false);
            $pdf->SetXY($pdf->GetX(), $pdf->GetY());
            $pdf->MultiCell(20, 3.5, trim($result), 1, 'C', 0, 0, '', '', true, 0, true);
            ...
            $pdf->SetFont($times, '', 7, '', false);
            $pdf->SetXY($pdf->GetX(), $pdf->GetY());
            $pdf->MultiCell(20, $height, trim($division), 1, 'C', 0, 0, '', '', true, 0, true);

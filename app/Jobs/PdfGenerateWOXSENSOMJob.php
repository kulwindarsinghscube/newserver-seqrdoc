...
class PdfGenerateWOXSENSOMJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
            ...
            //print_r($studentData);
            //data processing
            $subjectsData=$subjectsArr[$studentData[5]];
            //Separate semesters 
            $subjects = array();
           ...
           //data processing
                ...
                $profile_path_org_jpg = public_path().'\\'.$subdomain[0].'\backend\templates\100\\'.$studentData[6].'.jpg';
                $profile_path_org_jpeg = public_path().'\\'.$subdomain[0].'\backend\templates\100\\'.$studentData[6].'.jpeg';
                $profile_path_org_png = public_path().'\\'.$subdomain[0].'\backend\templates\100\\'.$studentData[6].'.png';
                ...
                $codeContents .="\n";
                $codeContents .= $studentData[4];
                $codeContents .="\n";
                
                $codeContents .= $studentData[6];
                $codeContents .="\n\n".strtoupper(md5($str));
                ...
                $pdfBig->Cell(0, 0, $studentData[23], 0, false, 'L');

                $pdf->SetFont('E-13B_0', '', 12, '', false);
                $pdf->SetXY($card_serial_nox, $card_serial_noy);
                $pdf->Cell(0, 0, $studentData[23], 0, false, 'L');
...
<table id="table1" cellspacing="0" cellpadding="3" rules="rows" border="0.1" width="47%">
  <tr>
    ...
    <td width="40%">Father Name: <b>{$studentData[2]}</b></td>
   </tr>
   <tr>
    <td width="60%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Program: <b>{$studentData[3]}</b></td>
    <td width="40%">Academic Year: <b>{$studentData[4]}</b></td>
   </tr>
   <tr>
    <td width="60%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PGID No.: <b>{$studentData[5]}</b></td>
    <td width="40%">Student ID: <b>{$studentData[6]}</b></td>
   </tr>
  </table>
EOD;
        ...
        foreach($subjects as $term => $term_array){
            ...
            if($term < 5)
            {
                $strtd .= '<tr>
                        ...
                        <td colspan="6" style="text-align:center;border-right:0px solid black;"><B>Term - '.$term.'</B></td>
                      </tr>';
                ...
                foreach($term_array as $key => $val)
                {
                    $GlobalSubject++;
                    $strtd .= '<tr>
                                    <td style="widtd:10%;text-align:center;border-right:0px solid black;border-left:0px solid black;"><B>'.$val[2].'</B></td>
                                    <td style="widtd:45%;text-align:left;"><B>'.$val[3].'</B></td>
                    ...
                    $strtd .=       '<td style="widtd:19%;text-align:center;border-right:0px solid black;"><B></B></td>
                                </tr>';
                }
                $strtd .= '<tr>
                                <td style="text-align:center;border-right:0px solid black;border-left:0px solid black;"><B></B></td>
                ...
                if($term == 1){
                    $strtd .=   '<tr>
                                ...
                                <td style="widtd:19%;text-align:center;border-right:0px solid black;"><B>GPA - 0'.$term.' : '.round($studentData[$IndividualDataIndex],2).'</B></td>
                            </tr>';
                    $IndividualDataIndex++;         
                }else{
                    $strtd .=   '<tr>
                ...
                $strtr .= '<tr>
                            <td style="text-align:center;border-right:0px solid black;border-left:0px solid black;"><B></B></td>
                            <td colspan="6" style="text-align:center;border-right:0px solid black;"><B>Term - 0'.$term.'</B></td>
                          </tr>';
                ...
                foreach($term_array as $key => $val)
                {
                    ...
                    $strtr .=       '<td style="widtd:19%;text-align:center;border-right:0px solid black;"><B></B></td>
                                </tr>';
                }
                    $strtr .= '<tr>
                                    <td style="text-align:center;border-right:0px solid black;border-left:0px solid black;"><B></B></td>
        ...
        $strtr .=   '<tr>
                        ...
                        <td style="widtd:45%;text-align:center;border-bottom: 0px solid black;"><B>Total Credit Score: '.$studentData[$IndividualDataIndex].'</B></td>
...
EOD;
        $pdfBig->writeHTMLCell($w = 0, $h = 0, $x = '11', $y = '71', $html, $border = 0, $ln = 1, $fill = 0, $reseth = true, $align = '', $autopadding = true);

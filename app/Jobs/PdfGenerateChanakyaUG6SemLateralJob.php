...
class PdfGenerateChanakyaUG6SemLateralJob
{
				...
				$rightCurrentY = $tableSecondStart;
                  ...
                  $printvalue=array();
                    ...
                    if ($term == "I SEMESTER" || $term == "III SEMESTER" || $term == "V SEMESTER" || $term == "VII SEMESTER" ||$term == "I TRIMESTER" || $term == "III TRIMESTER" || $term == "V TRIMESTER" || $term == "VII TRIMESTER") {
                        ...
                        {                            
						$pdfBig->MultiCell(88.5, 6, $term.'( Transferred from Mangalore University) *' , 'TB', 'C', 0, 0, '', '', true, 0, true);
                        }
                        else{                           
						...
						foreach($term_array as $key => $val){
                            ...
                            if($lines==2){
								$subjectTableHeight = 6.2;
							}else if($lines==3){
                                $subjectTableHeight = 9;
                            }
                             else {
								$subjectTableHeight = 3.6;
							}
							...
							$pdfBig->SetXY($pdfBig->getX(), $pdfBig->getY());
							$pdfBig->MultiCell(13.2, $subjectTableHeight, trim($val[4]), '', 'L', 0, 0, '', '', true, 0, true);
							$pdfBig->setCellPaddings( $left = '1', $top = '', $right = '', $bottom = '');

							$pdfBig->SetXY($pdfBig->getX(), $pdfBig->getY());
							$pdfBig->MultiCell(13.3, $subjectTableHeight, trim($val[5]), '', 'C', 0, 0, '', '', true, 0, true);
						...
						foreach($term_array as $key => $val){
							...
							$pdfBig->SetXY($pdfBig->getX(), $pdfBig->getY());
							$pdfBig->MultiCell(13.3, $subjectTableHeight, trim($val[5]), '0', 'C', 0, 0, '', '', true, 0, true);
                  ...
                  $printvalue=array();
                    ...
                    if ($term == "I SEMESTER" || $term == "III SEMESTER" || $term == "V SEMESTER" || $term == "VII SEMESTER" ||$term == "I TRIMESTER" || $term == "III TRIMESTER" || $term == "V TRIMESTER" || $term == "VII TRIMESTER") {
                        ...
                        $pdf->setCellPaddings( $left = '', $top = '1', $right = '', $bottom = '');
                         if( ($term == "I SEMESTER" || $term == "III SEMESTER")&& !empty($studentData[7]))
                        {                            
                        $pdf->MultiCell(88.5, 6, $term.'( Transferred from Mangalore University) *' , 'TB', 'C', 0, 0, '', '', true, 0, true);
                        }
                        else{                           
                        ...
                        foreach($term_array as $key => $val){
                            ...
                            $pdf->MultiCell(8, $subjectTableHeight, trim($val[2]), '', 'C', 0, 0, '', '', true, 0, true);
                            ...
                            $pdf->SetXY($pdf->getX(), $pdf->getY());
                            $pdf->MultiCell(13.2, $subjectTableHeight, trim($val[4]), '', 'L', 0, 0, '', '', true, 0, true);
                            $pdf->setCellPaddings( $left = '1', $top = '', $right = '', $bottom = '');

                            $pdf->SetXY($pdf->getX(), $pdf->getY());
                            $pdf->MultiCell(13.3, $subjectTableHeight, trim($val[5]), '', 'C', 0, 0, '', '', true, 0, true);
                            $totalHeight += $subjectTableHeight;
                            $pdf->ln();
                        }
                        ...
                        foreach($term_array as $key => $val){
                            ...
                            $pdf->MultiCell(8, $subjectTableHeight, trim($val[2]), '0', 'C', 0, 0, '', '', true, 0, true);
                            ...
                            $pdf->SetXY($pdf->getX(), $pdf->getY());
                            $pdf->MultiCell(13.3, $subjectTableHeight, trim($val[5]), '0', 'C', 0, 0, '', '', true, 0, true);

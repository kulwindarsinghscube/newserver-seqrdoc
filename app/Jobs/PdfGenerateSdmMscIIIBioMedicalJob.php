...
use Helper;
class PdfGenerateSdmMscIIIBioMedicalJob{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
			...
			foreach ($subjectsArr as $subjectDatas){
				...
				// F:\wamp64\www\seqrdoc\app\Jobs\PdfGenerateSdmMscIIIBioMedicalJob.php
				/*if($lines == 2){
					$th_height = 6;
					$th_height_half = 6;
				} else if($lines == 3){
            ...
            $pdfBig->SetXY($left_str_x, $subj_y+25.1);	
			...
			$pdfBig->SetXY($left_str_x, $subj_y+30.1);

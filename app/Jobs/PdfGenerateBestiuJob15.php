  ...
  //       dd([
		...
		if($studentDataOrg&&!empty($studentDataOrg)){
			foreach ($studentDataOrg as $studentData) {
	            ...
	            $SEM1_SGPA=trim($studentData[58]);

	            
	            $II_SEM=trim($studentData[59]);
	            $SEM2_COURSE_CODE_1=trim($studentData[60]);
	            $SEM2_COURSE_TITLE_1=trim($studentData[61]);
	            $SEM2_CREDIT_HOURS_1=trim($studentData[62]);
	            $SEM2_GRADE_POINT_1=trim($studentData[63]);
	            $SEM2_CREDIT_POINTS_1=trim($studentData[64]);

	            $SEM2_COURSE_CODE_2=trim($studentData[65]);
	            $SEM2_COURSE_TITLE_2=trim($studentData[66]);
	            $SEM2_CREDIT_HOURS_2=trim($studentData[67]);
	            $SEM2_GRADE_POINT_2=trim($studentData[68]);
	            $SEM2_CREDIT_POINTS_2=trim($studentData[69]);

	            $SEM2_COURSE_CODE_3=trim($studentData[70]);
	            $SEM2_COURSE_TITLE_3=trim($studentData[71]);
	            $SEM2_CREDIT_HOURS_3=trim($studentData[72]);
	            $SEM2_GRADE_POINT_3=trim($studentData[73]);
	            $SEM2_CREDIT_POINTS_3=trim($studentData[74]);

	            $SEM2_COURSE_CODE_4=trim($studentData[75]);
	            $SEM2_COURSE_TITLE_4=trim($studentData[76]);
	            $SEM2_CREDIT_HOURS_4=trim($studentData[77]);
	            $SEM2_GRADE_POINT_4=trim($studentData[78]);
	            $SEM2_CREDIT_POINTS_4=trim($studentData[79]);

	            $SEM2_COURSE_CODE_5=trim($studentData[80]);
	            $SEM2_COURSE_TITLE_5=trim($studentData[81]);
	            $SEM2_CREDIT_HOURS_5=trim($studentData[82]);
	            $SEM2_GRADE_POINT_5=trim($studentData[83]);
	            $SEM2_CREDIT_POINTS_5=trim($studentData[84]);

	            $SEM2_COURSE_CODE_6=trim($studentData[85]);
	            $SEM2_COURSE_TITLE_6=trim($studentData[86]);
	            $SEM2_CREDIT_HOURS_6=trim($studentData[87]);
	            $SEM2_GRADE_POINT_6=trim($studentData[88]);
	            $SEM2_CREDIT_POINTS_6=trim($studentData[89]);

	            $SEM2_COURSE_CODE_7=trim($studentData[90]);
	            $SEM2_COURSE_TITLE_7=trim($studentData[91]);
	            $SEM2_CREDIT_HOURS_7=trim($studentData[92]);
	            $SEM2_GRADE_POINT_7=trim($studentData[93]);
	            $SEM2_CREDIT_POINTS_7=trim($studentData[94]);

	            $SEM2_COURSE_CODE_8=trim($studentData[95]);
	            $SEM2_COURSE_TITLE_8=trim($studentData[96]);
	            $SEM2_CREDIT_HOURS_8=trim($studentData[97]);
	            $SEM2_GRADE_POINT_8=trim($studentData[98]);
	            $SEM2_CREDIT_POINTS_8=trim($studentData[99]);

	            $SEM2_COURSE_CODE_9=trim($studentData[100]);
	            $SEM2_COURSE_TITLE_9=trim($studentData[101]);
	            $SEM2_CREDIT_HOURS_9=trim($studentData[102]);
	            $SEM2_GRADE_POINT_9=trim($studentData[103]);
	            $SEM2_CREDIT_POINTS_9=trim($studentData[104]);
	            ...
	            $SEM2_SGPA=trim($studentData[105]);	

	            $III_SEM=trim($studentData[106]);
	            $SEM3_COURSE_CODE_1=trim($studentData[107]);
	            $SEM3_COURSE_TITLE_1=trim($studentData[108]);
	            $SEM3_CREDIT_HOURS_1=trim($studentData[109]);
	            $SEM3_GRADE_POINT_1=trim($studentData[110]);
	            $SEM3_CREDIT_POINTS_1=trim($studentData[111]);

	            $SEM3_COURSE_CODE_2=trim($studentData[112]);
	            $SEM3_COURSE_TITLE_2=trim($studentData[113]);
	            $SEM3_CREDIT_HOURS_2=trim($studentData[114]);
	            $SEM3_GRADE_POINT_2=trim($studentData[115]);
	            $SEM3_CREDIT_POINTS_2=trim($studentData[116]);

	            $SEM3_COURSE_CODE_3=trim($studentData[117]);
	            $SEM3_COURSE_TITLE_3=trim($studentData[118]);
	            $SEM3_CREDIT_HOURS_3=trim($studentData[119]);
	            $SEM3_GRADE_POINT_3=trim($studentData[120]);
	            $SEM3_CREDIT_POINTS_3=trim($studentData[121]);

	            $SEM3_COURSE_CODE_4=trim($studentData[122]);
	            $SEM3_COURSE_TITLE_4=trim($studentData[123]);
	            $SEM3_CREDIT_HOURS_4=trim($studentData[124]);
	            $SEM3_GRADE_POINT_4=trim($studentData[125]);
	            $SEM3_CREDIT_POINTS_4=trim($studentData[126]);

	            $SEM3_COURSE_CODE_5=trim($studentData[127]);
	            $SEM3_COURSE_TITLE_5=trim($studentData[128]);
	            $SEM3_CREDIT_HOURS_5=trim($studentData[129]);
	            $SEM3_GRADE_POINT_5=trim($studentData[130]);
	            $SEM3_CREDIT_POINTS_5=trim($studentData[131]);

	            $SEM3_COURSE_CODE_6=trim($studentData[132]);
	            $SEM3_COURSE_TITLE_6=trim($studentData[133]);
	            $SEM3_CREDIT_HOURS_6=trim($studentData[134]);
	            $SEM3_GRADE_POINT_6=trim($studentData[135]);
	            $SEM3_CREDIT_POINTS_6=trim($studentData[136]);

	            $SEM3_COURSE_CODE_7=trim($studentData[137]);
	            $SEM3_COURSE_TITLE_7=trim($studentData[138]);
	            $SEM3_CREDIT_HOURS_7=trim($studentData[139]);
	            $SEM3_GRADE_POINT_7=trim($studentData[140]);
	            $SEM3_CREDIT_POINTS_7=trim($studentData[141]);

	            $SEM3_COURSE_CODE_8=trim($studentData[142]);
	            $SEM3_COURSE_TITLE_8=trim($studentData[143]);
	            $SEM3_CREDIT_HOURS_8=trim($studentData[144]);
	            $SEM3_GRADE_POINT_8=trim($studentData[145]);
	            $SEM3_CREDIT_POINTS_8=trim($studentData[146]);
	            
	            //kamini
	            $SEM3_COURSE_CODE_9=trim($studentData[147]);
	            $SEM3_COURSE_TITLE_9=trim($studentData[148]);
	            $SEM3_CREDIT_HOURS_9=trim($studentData[149]);
	            $SEM3_GRADE_POINT_9=trim($studentData[150]);
	            $SEM3_CREDIT_POINTS_9=trim($studentData[151]);
	            ...
	            $SEM4_COURSE_CODE_9=trim($studentData[194]);
	            $SEM4_COURSE_TITLE_9=trim($studentData[195]);
	            $SEM4_CREDIT_HOURS_9=trim($studentData[196]);
	            $SEM4_GRADE_POINT_9=trim($studentData[197]);
	            $SEM4_CREDIT_POINTS_9=trim($studentData[198]);
	            $SEM4_SGPA=trim($studentData[199]);

	            $V_SEM=trim($studentData[200]);
	            $SEM5_COURSE_CODE_1=trim($studentData[201]);
	            $SEM5_COURSE_TITLE_1=trim($studentData[202]);
	            $SEM5_CREDIT_HOURS_1=trim($studentData[203]);
	            $SEM5_GRADE_POINT_1=trim($studentData[204]);
	            $SEM5_CREDIT_POINTS_1=trim($studentData[205]);

	            $SEM5_COURSE_CODE_2=trim($studentData[206]);
	            $SEM5_COURSE_TITLE_2=trim($studentData[207]);
	            $SEM5_CREDIT_HOURS_2=trim($studentData[208]);
	            $SEM5_GRADE_POINT_2=trim($studentData[209]);
	            $SEM5_CREDIT_POINTS_2=trim($studentData[210]);

	            $SEM5_COURSE_CODE_3=trim($studentData[211]);
	            $SEM5_COURSE_TITLE_3=trim($studentData[212]);
	            $SEM5_CREDIT_HOURS_3=trim($studentData[213]);
	            $SEM5_GRADE_POINT_3=trim($studentData[214]);
	            $SEM5_CREDIT_POINTS_3=trim($studentData[215]);

	            $SEM5_COURSE_CODE_4=trim($studentData[216]);
	            $SEM5_COURSE_TITLE_4=trim($studentData[217]);
	            $SEM5_CREDIT_HOURS_4=trim($studentData[218]);
	            $SEM5_GRADE_POINT_4=trim($studentData[219]);
	            $SEM5_CREDIT_POINTS_4=trim($studentData[220]);

	            $SEM5_COURSE_CODE_5=trim($studentData[221]);
	            $SEM5_COURSE_TITLE_5=trim($studentData[222]);
	            $SEM5_CREDIT_HOURS_5=trim($studentData[223]);
	            $SEM5_GRADE_POINT_5=trim($studentData[224]);
	            $SEM5_CREDIT_POINTS_5=trim($studentData[225]);

	            $SEM5_COURSE_CODE_6=trim($studentData[226]);
	            $SEM5_COURSE_TITLE_6=trim($studentData[227]);
	            $SEM5_CREDIT_HOURS_6=trim($studentData[228]);
	            $SEM5_GRADE_POINT_6=trim($studentData[229]);
	            $SEM5_CREDIT_POINTS_6=trim($studentData[230]);

	            $SEM5_COURSE_CODE_7=trim($studentData[231]);
	            $SEM5_COURSE_TITLE_7=trim($studentData[232]);
	            $SEM5_CREDIT_HOURS_7=trim($studentData[233]);
	            $SEM5_GRADE_POINT_7=trim($studentData[234]);
	            $SEM5_CREDIT_POINTS_7=trim($studentData[235]);

	            $SEM5_COURSE_CODE_8=trim($studentData[236]);
	            $SEM5_COURSE_TITLE_8=trim($studentData[237]);
	            $SEM5_CREDIT_HOURS_8=trim($studentData[238]);
	            $SEM5_GRADE_POINT_8=trim($studentData[239]);
	            $SEM5_CREDIT_POINTS_8=trim($studentData[240]);

	            $SEM5_COURSE_CODE_9=trim($studentData[241]);
	            $SEM5_COURSE_TITLE_9=trim($studentData[242]);
	            $SEM5_CREDIT_HOURS_9=trim($studentData[243]);
	            $SEM5_GRADE_POINT_9=trim($studentData[244]);
	            $SEM5_CREDIT_POINTS_9=trim($studentData[245]);
	            $SEM5_SGPA=trim($studentData[246]);


	            $VI_SEM=trim($studentData[247]);
	            $SEM6_COURSE_CODE_1=trim($studentData[248]);
	            $SEM6_COURSE_TITLE_1=trim($studentData[249]);
	            $SEM6_CREDIT_HOURS_1=trim($studentData[250]);
	            $SEM6_GRADE_POINT_1=trim($studentData[251]);
	            $SEM6_CREDIT_POINTS_1=trim($studentData[252]);

	            $SEM6_COURSE_CODE_2=trim($studentData[253]);
	            $SEM6_COURSE_TITLE_2=trim($studentData[254]);
	            $SEM6_CREDIT_HOURS_2=trim($studentData[255]);
	            $SEM6_GRADE_POINT_2=trim($studentData[256]);
	            $SEM6_CREDIT_POINTS_2=trim($studentData[257]);

	            $SEM6_COURSE_CODE_3=trim($studentData[258]);
	            $SEM6_COURSE_TITLE_3=trim($studentData[259]);
	            $SEM6_CREDIT_HOURS_3=trim($studentData[260]);
	            $SEM6_GRADE_POINT_3=trim($studentData[261]);
	            $SEM6_CREDIT_POINTS_3=trim($studentData[262]);

	            $SEM6_COURSE_CODE_4=trim($studentData[263]);
	            $SEM6_COURSE_TITLE_4=trim($studentData[264]);
	            $SEM6_CREDIT_HOURS_4=trim($studentData[265]);
	            $SEM6_GRADE_POINT_4=trim($studentData[266]);
	            $SEM6_CREDIT_POINTS_4=trim($studentData[267]);

	            $SEM6_COURSE_CODE_5=trim($studentData[268]);
	            $SEM6_COURSE_TITLE_5=trim($studentData[269]);
	            $SEM6_CREDIT_HOURS_5=trim($studentData[270]);
	            $SEM6_GRADE_POINT_5=trim($studentData[271]);
	            $SEM6_CREDIT_POINTS_5=trim($studentData[272]);
	            $SEM6_COURSE_CODE_6=trim($studentData[273]);
	            $SEM6_COURSE_TITLE_6=trim($studentData[274]);
	            $SEM6_CREDIT_HOURS_6=trim($studentData[275]);
	            $SEM6_GRADE_POINT_6=trim($studentData[276]);
	            $SEM6_CREDIT_POINTS_6=trim($studentData[277]);

	            $SEM6_COURSE_CODE_7=trim($studentData[278]);
	            $SEM6_COURSE_TITLE_7=trim($studentData[279]);
	            $SEM6_CREDIT_HOURS_7=trim($studentData[280]);
	            $SEM6_GRADE_POINT_7=trim($studentData[281]);
	            $SEM6_CREDIT_POINTS_7=trim($studentData[282]);

	            $SEM6_COURSE_CODE_8=trim($studentData[283]);
	            $SEM6_COURSE_TITLE_8=trim($studentData[284]);
	            $SEM6_CREDIT_HOURS_8=trim($studentData[285]);
	            $SEM6_GRADE_POINT_8=trim($studentData[286]);
	            $SEM6_CREDIT_POINTS_8=trim($studentData[287]);

	            $SEM6_COURSE_CODE_9=trim($studentData[288]);
	            $SEM6_COURSE_TITLE_9=trim($studentData[289]);
	            $SEM6_CREDIT_HOURS_9=trim($studentData[290]);
	            $SEM6_GRADE_POINT_9=trim($studentData[291]);
	            $SEM6_CREDIT_POINTS_9=trim($studentData[292]);

	            $SEM6_COURSE_CODE_10=trim($studentData[293]);
	            $SEM6_COURSE_TITLE_10=trim($studentData[294]);
	            $SEM6_CREDIT_HOURS_10=trim($studentData[295]);
	            $SEM6_GRADE_POINT_10=trim($studentData[296]);
	            $SEM6_CREDIT_POINTS_10=trim($studentData[297]);

	            $SEM6_COURSE_CODE_11=trim($studentData[298]);
	            $SEM6_COURSE_TITLE_11=trim($studentData[299]);
	            $SEM6_CREDIT_HOURS_11=trim($studentData[300]);
	            $SEM6_GRADE_POINT_11=trim($studentData[301]);
	            $SEM6_CREDIT_POINTS_11=trim($studentData[302]);

	            $SEM6_SGPA=trim($studentData[303]);

	            $VII_SEM=trim($studentData[304]);
	            $SEM7_COURSE_CODE_1=trim($studentData[305]);
	            $SEM7_COURSE_TITLE_1=trim($studentData[306]);
	            $SEM7_CREDIT_HOURS_1=trim($studentData[307]);
	            $SEM7_GRADE_POINT_1=trim($studentData[308]);
	            $SEM7_CREDIT_POINTS_1=trim($studentData[309]);
	            $SEM7_COURSE_CODE_2=trim($studentData[310]);
	            $SEM7_COURSE_TITLE_2=trim($studentData[311]);
	            $SEM7_CREDIT_HOURS_2=trim($studentData[312]);
	            $SEM7_GRADE_POINT_2=trim($studentData[313]);
	            $SEM7_CREDIT_POINTS_2=trim($studentData[314]);
	            $SEM7_COURSE_CODE_3=trim($studentData[315]);
	            $SEM7_COURSE_TITLE_3=trim($studentData[316]);
	            $SEM7_CREDIT_HOURS_3=trim($studentData[317]);
	            $SEM7_GRADE_POINT_3=trim($studentData[318]);
	            $SEM7_CREDIT_POINTS_3=trim($studentData[319]);
	            $SEM7_COURSE_CODE_4=trim($studentData[320]);
	            $SEM7_COURSE_TITLE_4=trim($studentData[321]);
	            $SEM7_CREDIT_HOURS_4=trim($studentData[322]);
	            $SEM7_GRADE_POINT_4=trim($studentData[323]);
	            $SEM7_CREDIT_POINTS_4=trim($studentData[324]);

	            $SEM7_COURSE_CODE_5=trim($studentData[325]);
	            $SEM7_COURSE_TITLE_5=trim($studentData[326]);
	            $SEM7_CREDIT_HOURS_5=trim($studentData[327]);
	            $SEM7_GRADE_POINT_5=trim($studentData[328]);
	            $SEM7_CREDIT_POINTS_5=trim($studentData[329]);
	            $SEM7_COURSE_CODE_6=trim($studentData[330]);
	            $SEM7_COURSE_TITLE_6=trim($studentData[331]);
	            $SEM7_CREDIT_HOURS_6=trim($studentData[332]);
	            $SEM7_GRADE_POINT_6=trim($studentData[333]);
	            $SEM7_CREDIT_POINTS_6=trim($studentData[334]);
	            

	            $VIII_SEM=trim($studentData[335]);
	            $SEM8_COURSE_CODE_1=trim($studentData[336]);
	            $SEM8_COURSE_TITLE_1=trim($studentData[337]);
	            $SEM8_CREDIT_HOURS_1=trim($studentData[338]);
	            $SEM8_GRADE_POINT_1=trim($studentData[339]);
	            $SEM8_CREDIT_POINTS_1=trim($studentData[340]);
	            $SEM8_COURSE_CODE_2=trim($studentData[341]);
	            $SEM8_COURSE_TITLE_2=trim($studentData[342]);
	            $SEM8_CREDIT_HOURS_2=trim($studentData[343]);
	            $SEM8_GRADE_POINT_2=trim($studentData[344]);
	            $SEM8_CREDIT_POINTS_2=trim($studentData[345]);
	            $SEM8_COURSE_CODE_3=trim($studentData[346]);
	            $SEM8_COURSE_TITLE_3=trim($studentData[347]);
	            $SEM8_CREDIT_HOURS_3=trim($studentData[348]);
	            $SEM8_GRADE_POINT_3=trim($studentData[349]);
	            $SEM8_CREDIT_POINTS_3=trim($studentData[350]);

	            $TOTAL_CREDITS_CREDIT_HOURS=trim($studentData[351]);
	            $TOTAL_CREDITS_CREDIT_POINTS=trim($studentData[352]);
	            $OVERALL_GRADE_POINT_AVERAGE=trim($studentData[353]);
	            $PERCENTAGE_OF_MARKS=trim($studentData[354]);
	            $Month_of_Declaration_of_Results=trim($studentData[355]);
	            $DATE=trim($studentData[356]);
	            $Photo=trim($studentData[357]);
	            $year1=trim($studentData[358]);
	            $year2=trim($studentData[359]);
	            $year3=trim($studentData[360]);
	            $year4=trim($studentData[361]);
	            $mother_name=trim($studentData[362]);
	            $SEM7_SGPA=trim($studentData[363]);
	            $SEM8_SGPA=trim($studentData[364]);
	            ...
	            // $pdfBig->MultiCell(10.3, 5.5, 'Points', 0, 'C', 0, 0, '', '', true, 0, true);
	            $pdfBig->SetFont($arialNarrowB, '', 7, '', false);
	            $pdfBig->SetXY(11.5, 82);
	            $pdfBig->Cell(72.3, 4, $I_SEM, 'LB', false, 'C');
	            $pdfBig->Cell(31.5, 4, $year1, 'B', false, 'C');
	            $pdfBig->Cell(83.3, 4, $II_SEM, 'RB', false, 'C');
	            
	            $SingleLineHeight = 2.7;
	            $twoLineHeight = 5.6;
	            $threeLineHeight = 8.4 ;
	            // 1st year start
	            $y_axis=86;
	            $sem1TableStart=$y_axis;
	            ...
	            for ($x = 1; $x <= 9; $x++) {
	                ...
	                if($lines>1){
	                    ...
	                    $chight=$twoLineHeight;
	                }else{
	                    $pdfBig->SetXY(11.5, $y_axis);
	                    $chight=$SingleLineHeight;	     
	                }
	            ...
	            for ($x = 1; $x <= 9; $x++) {
	                ...
	                /*Left Part Start*/
	                if($lines2>1){
	                    $pdfBig->SetXY($x_axis, $y1_axis);
	                    $chight2=$twoLineHeight;
	                            
	                }else{
	                    $pdfBig->SetXY($x_axis, $y1_axis);
	                    $chight2=$SingleLineHeight;	
	                ...
	                $y1_axis=$y1_axis+$chight2;
	                $secondTableHight += $chight2;
	                
	            }

	            if($firstTableHight > $secondTableHight) {
	                $FirstYearBorderHeight = $firstTableHight;
	            } else if($firstTableHight < $secondTableHight) {
	                $FirstYearBorderHeight = $secondTableHight;
	            } else {
	                $FirstYearBorderHeight = $firstTableHight;
	            }
	            $FirstYearBorderHeight = $FirstYearBorderHeight + 1.2;
	            // First Table Border 
	            $pdfBig->SetXY(11.5, $sem1TableStart);
	            $pdfBig->MultiCell(15, $FirstYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->MultiCell(45.2, $FirstYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->MultiCell(11.2, $FirstYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->MultiCell(11.3, $FirstYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->MultiCell(11.4, $FirstYearBorderHeight, '', 'L', 'L', 0, 0, '', '', true, 0, true);

	            // Second Table Border
	            $pdfBig->SetXY($x_axis, $sem2TableStart);
	            $pdfBig->MultiCell(15, $FirstYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->MultiCell(45.2, $FirstYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->MultiCell(11.2, $FirstYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->MultiCell(11.3, $FirstYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->MultiCell(11.4, $FirstYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);

	            /*2nd sem end*/

	            $bottomText = $sem1TableStart + $FirstYearBorderHeight;
	            $pdfBig->SetFont($arialNarrowB, '', 7, '', false);
	            $pdfBig->SetXY(11.5, $bottomText);
	            //$pdfBig->setCellPaddings( $left = '5.5', $top = '', $right = '', $bottom = '');
	            $pdfBig->Cell(93, 4, 'SGPA: '.$SEM1_SGPA, 'LRTB', false, 'L');
	            $pdfBig->Cell(94.1, 4,'SGPA: '. $SEM2_SGPA, 'LRTB', false, 'L');
	            // 1st year end
	            ...
	            $pdfBig->Cell(72.3, 4, $III_SEM, 'LB', false, 'C');
	            $pdfBig->Cell(31.5, 4, $year2, 'B', false, 'C');
	            $pdfBig->Cell(83.3, 4, $IV_SEM, 'RB', false, 'C');
	            

	            $secondYear_y_axis=$pdfBig->GetY()+4;
	            
	            /*3rd sem Start*/
	            // $y_axis=$pdfBig->GetY()+4.5;
	            $y_axis=$pdfBig->GetY()+4;
	            $sem3TableStart = $y_axis;
	            
	            // $y_axis = $secondYear_y_axis;
	            $pdfBig->SetFont($arialNarrow, '', 6.5, '', false);
	            // $no=0;
	            $thirdTableHight = 0;
	            for ($x = 1; $x <= 9; $x++) {
	            ...
	            for ($x = 1; $x <= 9; $x++) {
	                ...
	                $fourthTableHight += $chight2;
	            }
	            /*4th sem end*/
	            
	            if($thirdTableHight > $fourthTableHight) {
	                $SecondYearBorderHeight = $thirdTableHight;
	            } else if($thirdTableHight < $fourthTableHight) {
	                $SecondYearBorderHeight = $fourthTableHight;
	            } else {
	                $SecondYearBorderHeight = $thirdTableHight;
	            }
	            $SecondYearBorderHeight = $SecondYearBorderHeight + 1.2;
	            // First Table Border 
	            $pdfBig->SetXY(11.5, $secondYear_y_axis);
	            $pdfBig->MultiCell(15, $SecondYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->MultiCell(45.2, $SecondYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->MultiCell(11.2, $SecondYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->MultiCell(11.3, $SecondYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->MultiCell(11.4, $SecondYearBorderHeight, '', 'L', 'L', 0, 0, '', '', true, 0, true);

	            // Second Table Border
	            $pdfBig->SetXY($x_axis, $secondYear_y_axis);
	            $pdfBig->MultiCell(15, $SecondYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->MultiCell(45.2, $SecondYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->MultiCell(11.2, $SecondYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->MultiCell(11.3, $SecondYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->MultiCell(11.4, $SecondYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            

	            $bottomText = $secondYear_y_axis + $SecondYearBorderHeight;

	            $pdfBig->SetFont($arialNarrowB, '', 7, '', false);
	            $pdfBig->SetXY(11.5, $bottomText);
	            //$pdfBig->setCellPaddings( $left = '5.5', $top = '', $right = '', $bottom = '');
	            $pdfBig->Cell(93, 4, 'SGPA: '.$SEM3_SGPA, 'LRTB', false, 'L');
	            $pdfBig->Cell(94.1, 4,'SGPA: '. $SEM4_SGPA, 'LRTB', false, 'L');
	            /* 2nd year end*/
	            /*3rd year start*/
	            $y_axis=$pdfBig->GetY();

	            $thirdYear_y_axis = $y_axis; 
	            
	            $pdfBig->SetFont($arialNarrowB, '', 7, '', false);
	            $pdfBig->SetXY(11.5, $y_axis+4);
	            $pdfBig->Cell(72.3, 4, $V_SEM, 'LB', false, 'C');
	            $pdfBig->Cell(31.5, 4, $year3, 'B', false, 'C');
	            $pdfBig->Cell(83.3, 4, $VI_SEM, 'RB', false, 'C');
	            
	            /*5th sem Start*/
	            $thirdYear_y_axis=$pdfBig->GetY()+4;
	            $y_axis=$thirdYear_y_axis;
	            ...
	            for ($x = 1; $x <= 11; $x++) {
	                ...
	                $y_axis=$y_axis+$chight2;
	                $sixTableHight += $chight2;
	                
	            }
	            /*6th sem end*/


	            if($fiveTableHight > $sixTableHight) {
	                $thirdYearBorderHeight = $fiveTableHight;
	            } else if($fiveTableHight < $sixTableHight) {
	                $thirdYearBorderHeight = $sixTableHight;
	            } else {
	                $thirdYearBorderHeight = $fiveTableHight;
	            }
	            $thirdYearBorderHeight = $thirdYearBorderHeight + 1.2;
	            // First Table Border 
	            $pdfBig->SetXY(11.5, $thirdYear_y_axis);
	            $pdfBig->MultiCell(15, $thirdYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->MultiCell(45.2, $thirdYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->MultiCell(11.2, $thirdYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->MultiCell(11.3, $thirdYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->MultiCell(11.4, $thirdYearBorderHeight, '', 'L', 'L', 0, 0, '', '', true, 0, true);

	            // Second Table Border
	            $pdfBig->SetXY($x_axis, $thirdYear_y_axis);
	            $pdfBig->MultiCell(15, $thirdYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->MultiCell(45.2, $thirdYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->MultiCell(11.2, $thirdYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->MultiCell(11.3, $thirdYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->MultiCell(11.4, $thirdYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            

	            $bottomText = $thirdYear_y_axis + $thirdYearBorderHeight;
	            ...
	            $pdfBig->SetFont($arialNarrowB, '', 7, '', false);
	            $pdfBig->SetXY(11.5, $y_axis+4);
	            $pdfBig->Cell(72.3, 4, $VII_SEM, 'LB', false, 'C');
	            $pdfBig->Cell(31.5, 4, $year4, 'B', false, 'C');
	            $pdfBig->Cell(83.3, 4, $VIII_SEM, 'RB', false, 'C');
	                

	            /*7th sem Start*/
	            $y_axis=$pdfBig->GetY()+4;
	            $fourthYear_y_axis=$y_axis;
	            $pdfBig->SetFont($arialNarrow, '', 6.5, '', false);
	            $sevenTableHight = 0;
	            for ($x = 1; $x <= 6; $x++) {
	                ...
	                $y_axis=$y_axis+$chight;
	                $sevenTableHight += $chight;
	                
	            }
	            /*7th sem end*/
	            /*8th sem Start*/
	            $x_axis=104.5;
	            $y_axis=$fourthYear_y_axis;
	            $pdfBig->SetXY($x_axis, $y_axis);
	            $pdfBig->SetFont($arialNarrow, '', 6.5, '', false);
	            $eightTableHight = 0;
	            for ($x = 1; $x <= 8; $x++) {
	                ...
	                $y_axis=$y_axis+$chight2;
	                $eightTableHight += $chight2;
	                
	            }
	            // $pdfBig->SetXY(11.5, $y_axis+0.8);
	            // $pdfBig->MultiCell(187, 1, '', 'T', 'L', 0, 0, '', '', true, 0, true);
	            
	            if($sevenTableHight > $eightTableHight) {
	                $fourYearBorderHeight = $sevenTableHight;
	            } else if($sevenTableHight < $eightTableHight) {
	                $fourYearBorderHeight = $eightTableHight;
	            } else {
	                $fourYearBorderHeight = $sevenTableHight;
	            }
	            $fourYearBorderHeight = $fourYearBorderHeight + 1.2;
	            // First Table Border 
	            $pdfBig->SetXY(11.5, $fourthYear_y_axis);
	            $pdfBig->MultiCell(15, $fourYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->MultiCell(45.2, $fourYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->MultiCell(11.2, $fourYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->MultiCell(11.3, $fourYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->MultiCell(11.4, $fourYearBorderHeight, '', 'L', 'L', 0, 0, '', '', true, 0, true);

	            // Second Table Border
	            $pdfBig->SetXY($x_axis, $fourthYear_y_axis);
	            $pdfBig->MultiCell(15, $fourYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->MultiCell(45.2, $fourYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->MultiCell(11.2, $fourYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->MultiCell(11.3, $fourYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->MultiCell(11.4, $fourYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            

	            $bottomText = $fourthYear_y_axis + $fourYearBorderHeight;

	            /*8th sem end*/
	            $pdfBig->SetFont($arialNarrowB, '', 7, '', false);
	            $pdfBig->SetXY(11.5, $bottomText);
	            //$pdfBig->setCellPaddings( $left = '5.5', $top = '', $right = '', $bottom = '');
	            $pdfBig->Cell(93, 4, 'SGPA: '.$SEM7_SGPA, 'LRTB', false, 'L');
	            $pdfBig->Cell(94.1, 4,'SGPA: '. $SEM8_SGPA, 'LRTB', false, 'L');		
	            /*4th year end*/

	            /*Right Part End*/
	            $pdfBig->ln();
	            $bottonLineY = $pdfBig->GetY();


	            $pdfBig->SetFont($arialNarrow, '', 7, '', false); 
	            $pdfBig->SetXY(10.5, $bottonLineY);
	            $pdfBig->MultiCell(0, 0, 'Total Credit Hours: <b>'.$TOTAL_CREDITS_CREDIT_HOURS.'</b>', 0, 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->SetXY(35.5, $bottonLineY);
	            $pdfBig->MultiCell(0, 0, 'Total Credit points: <b>'.$TOTAL_CREDITS_CREDIT_POINTS.'</b>', 0, 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->SetXY(82.5, $bottonLineY);
	            $pdfBig->MultiCell(0, 0, 'OVERALL GRADE POINT AVERAGE:&nbsp;&nbsp;<b>'.$OVERALL_GRADE_POINT_AVERAGE.'</b>&nbsp;&nbsp;(10.00 basis)', 0, 'L', 0, 0, '', '', true, 0, true);
	            $pdfBig->SetXY(140.5, $bottonLineY);
	            $pdfBig->MultiCell(0, 0, '<b> PERCENTAGE OF MARKS: '.$PERCENTAGE_OF_MARKS.'% </b>', 0, 'L', 0, 0, '', '', true, 0, true);



	            $pdfBig->SetXY(10.5, $bottonLineY + 3.5); // 257.5
	            ...
	            $pdfBig->SetTextColor(0, 0, 0);    
	            $pdfBig->SetXY(10.5, 262); //262 // $bottonLineY + 8
	            ...
	            $pdf->SetFont($arialNarrowB, '', 7, '', false);
	            $pdf->SetXY(11.5, 82);
	            $pdf->Cell(72.3, 4, $I_SEM, 'LB', false, 'C');
	            $pdf->Cell(31.5, 4, $year1, 'B', false, 'C');
	            $pdf->Cell(83.3, 4, $II_SEM, 'RB', false, 'C');
	            ...
	            $FirstYearBorderHeight = $FirstYearBorderHeight + 1.2;
	            // First Table Border 
	            $pdf->SetXY(11.5, $sem1TableStart);
	            $pdf->MultiCell(15, $FirstYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdf->MultiCell(45.2, $FirstYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdf->MultiCell(11.2, $FirstYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdf->MultiCell(11.3, $FirstYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdf->MultiCell(11.4, $FirstYearBorderHeight, '', 'L', 'L', 0, 0, '', '', true, 0, true);

	            // Second Table Border
	            $pdf->SetXY($x_axis, $sem2TableStart);
	            $pdf->MultiCell(15, $FirstYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdf->MultiCell(45.2, $FirstYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdf->MultiCell(11.2, $FirstYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdf->MultiCell(11.3, $FirstYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdf->MultiCell(11.4, $FirstYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);

	            /*2nd sem end*/

	            $bottomText = $sem1TableStart + $FirstYearBorderHeight;
	            $pdf->SetFont($arialNarrowB, '', 7, '', false);
	            $pdf->SetXY(11.5, $bottomText);
	            //$pdf->setCellPaddings( $left = '5.5', $top = '', $right = '', $bottom = '');
	            $pdf->Cell(93, 4, 'SGPA: '.$SEM1_SGPA, 'LRTB', false, 'L');
	            $pdf->Cell(94.1, 4,'SGPA: '. $SEM2_SGPA, 'LRTB', false, 'L');
	            // 1st year end
	            ...
	            $pdf->Cell(72.3, 4, $III_SEM, 'LB', false, 'C');
	            $pdf->Cell(31.5, 4, $year2, 'B', false, 'C');
	            $pdf->Cell(83.3, 4, $IV_SEM, 'RB', false, 'C');
	            

	            $secondYear_y_axis=$pdf->GetY()+4;
	            ...
	            $SecondYearBorderHeight = $SecondYearBorderHeight + 1.2;
	            // First Table Border 
	            $pdf->SetXY(11.5, $secondYear_y_axis);
	            $pdf->MultiCell(15, $SecondYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdf->MultiCell(45.2, $SecondYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdf->MultiCell(11.2, $SecondYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdf->MultiCell(11.3, $SecondYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdf->MultiCell(11.4, $SecondYearBorderHeight, '', 'L', 'L', 0, 0, '', '', true, 0, true);

	            // Second Table Border
	            $pdf->SetXY($x_axis, $secondYear_y_axis);
	            $pdf->MultiCell(15, $SecondYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdf->MultiCell(45.2, $SecondYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdf->MultiCell(11.2, $SecondYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdf->MultiCell(11.3, $SecondYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdf->MultiCell(11.4, $SecondYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            ...
	            $pdf->SetXY(11.5, $bottomText);
	            //$pdf->setCellPaddings( $left = '5.5', $top = '', $right = '', $bottom = '');
	            $pdf->Cell(93, 4, 'SGPA: '.$SEM3_SGPA, 'LRTB', false, 'L');
	            $pdf->Cell(94.1, 4,'SGPA: '. $SEM4_SGPA, 'LRTB', false, 'L');
	            /* 2nd year end*/
	            /*3rd year start*/
	            $y_axis=$pdf->GetY();
	            ...
	            $pdf->SetFont($arialNarrowB, '', 7, '', false);
	            $pdf->SetXY(11.5, $y_axis+4);
	            $pdf->Cell(72.3, 4, $V_SEM, 'LB', false, 'C');
	            $pdf->Cell(31.5, 4, $year3, 'B', false, 'C');
	            $pdf->Cell(83.3, 4, $VI_SEM, 'RB', false, 'C');
	            
	            /*5th sem Start*/
	            $thirdYear_y_axis=$pdf->GetY()+4;
	            $y_axis=$thirdYear_y_axis;
	            ...
	            $thirdYearBorderHeight = $thirdYearBorderHeight + 1.2;
	            // First Table Border 
	            $pdf->SetXY(11.5, $thirdYear_y_axis);
	            $pdf->MultiCell(15, $thirdYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdf->MultiCell(45.2, $thirdYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdf->MultiCell(11.2, $thirdYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdf->MultiCell(11.3, $thirdYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdf->MultiCell(11.4, $thirdYearBorderHeight, '', 'L', 'L', 0, 0, '', '', true, 0, true);

	            // Second Table Border
	            $pdf->SetXY($x_axis, $thirdYear_y_axis);
	            $pdf->MultiCell(15, $thirdYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdf->MultiCell(45.2, $thirdYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdf->MultiCell(11.2, $thirdYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdf->MultiCell(11.3, $thirdYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdf->MultiCell(11.4, $thirdYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            ...
	            $pdf->SetFont($arialNarrowB, '', 7, '', false);
	            $pdf->SetXY(11.5, $y_axis+4);
	            $pdf->Cell(72.3, 4, $VII_SEM, 'LB', false, 'C');
	            $pdf->Cell(31.5, 4, $year4, 'B', false, 'C');
	            $pdf->Cell(83.3, 4, $VIII_SEM, 'RB', false, 'C');
	            ...
	            $fourYearBorderHeight = $fourYearBorderHeight + 1.2;
	            // First Table Border 
	            $pdf->SetXY(11.5, $fourthYear_y_axis);
	            $pdf->MultiCell(15, $fourYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdf->MultiCell(45.2, $fourYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdf->MultiCell(11.2, $fourYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdf->MultiCell(11.3, $fourYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdf->MultiCell(11.4, $fourYearBorderHeight, '', 'L', 'L', 0, 0, '', '', true, 0, true);

	            // Second Table Border
	            $pdf->SetXY($x_axis, $fourthYear_y_axis);
	            $pdf->MultiCell(15, $fourYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdf->MultiCell(45.2, $fourYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdf->MultiCell(11.2, $fourYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdf->MultiCell(11.3, $fourYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            $pdf->MultiCell(11.4, $fourYearBorderHeight, '', 'LR', 'L', 0, 0, '', '', true, 0, true);
	            ...
	            $pdf->SetTextColor(0, 0, 0);    
	            $pdf->SetXY(10.5, 262); //262   // $bottonLineY + 8

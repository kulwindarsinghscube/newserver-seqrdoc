...
use Helper;
// F:\wamp64\www\seqrdoc\app\Jobs\PdfGenerateSdmBscAlliedJob.php
class PdfGenerateSdmBscAlliedJob1
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
			...
			$pdfBig->SetXY(80.5, 106);	
			$pdfBig->MultiCell(99.5, 0, '', 'T', 'C', 0, 0);	//UIT HR Line
			$pdfBig->SetXY($left_str_x, 110);	
			$pdfBig->MultiCell(180, 0, '', 'T', 'C', 0, 0);	//SSUITR HR Line
			
			$pdfBig->SetXY(24.5, 97);	
			$pdfBig->MultiCell(56, 13, '', 'LR', 'C', 0, 0);  //Subject
			...
			$pdf->SetXY(80.5, 106);	
			$pdf->MultiCell(99.5, 0, '', 'T', 'C', 0, 0);	//UIT HR Line
			$pdf->SetXY($left_str_x, 110);	
			$pdf->MultiCell(180, 0, '', 'T', 'C', 0, 0);	//SSUITR HR Line
			
			$pdf->SetXY(24.5, 97);	
			$pdf->MultiCell(56, 13, '', 'LR', 'C', 0, 0);  //Subject
			...
			foreach ($subjectsArr as $subjectDatas){
				...
				$lines = $pdfBig->MultiCell(56, 0, $Subject_Name, 0, 'L', 0, 0, '', '', true, 0, false,true, 0);
				$lines = $pdf->MultiCell(56, 0, $Subject_Name, 0, 'L', 0, 0, '', '', true, 0, false,true, 0);
                ...
                $pdfBig->MultiCell(56, $th_height, $Subject_Name, 1, 'L', 0, 0);					
                $pdfBig->SetXY(80.5, $subj_y);					
                ...
                $pdf->MultiCell(56, $th_height, $Subject_Name, 1, 'L', 0, 0);					
                $pdf->SetXY(80.5, $subj_y);					

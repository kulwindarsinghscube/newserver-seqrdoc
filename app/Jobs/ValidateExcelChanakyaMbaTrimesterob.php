...
class ValidateExcelChanakyaMbaTrimesterob
{
    ...
    //    dd($columnsCount2);
                ...
                {
                    if($columnsCount1==7 &&$columnsCount2==8)
                    {
                       
                        $columnArr=array('Unique_Id','student Name','Programme','Register No',
                        'Sem/Term/Trimester','serial_no','mba_title');
                        ...
                        $columnArr2=array('Register No','Sem/Term/Trimester','Sr_no','Subject_Title','Grade','Credits','SGPA','CGPA');
                ...
                else if($dropdown_template_id==6||$dropdown_template_id==7)
                {
                     if($columnsCount1==9 &&$columnsCount2==8)
                    {
                       
                        $columnArr=array('Unique_Id','student Name','Programme','Register No',
                        'Sem/Term/Trimester','serial_no','UG_title','Lateral Entry','Total Marks');

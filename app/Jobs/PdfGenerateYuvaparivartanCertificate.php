...
class PdfGenerateYuvaparivartanCertificate
{
       ...
       // $signature_path = public_path().'\\'.$subdomain[0].'\backend\canvas\images\Vice Chancellor.png';
        ...
        if($studentDataOrg&&!empty($studentDataOrg)){
            foreach ($studentDataOrg as $studentData) 
            {
                ...
                $pdfBig->SetFont($OLD_ENGL_mt, 'U', 30, '', false);
                $pdfBig->SetXY(15, 63);
                $pdfBig->Cell(0, 10, 'Certificate', 0, false, 'C');
                ...
                // $lines = $pdfBig->MultiCell(180, 0, '<span style="font-size:23px;font-family:'.$MTCORSVA.'">S/o,D/o,W/o, Guardian</span> '.$studentData[3].' ', 0, 'C', 0, 0, '', '', true, 0, false,true, 0);
                ...
                // $pdfBig->SetFont($MTCORSVA, '', 23, '', false);
                // $pdfBig->SetXY(15,$y + 23);        
                // $pdfBig->MultiCell(72, 11, 'S/o,D/o,W/o, Guardian', 0, "L", 0, 0, '', '', true, 0, true);

                // $pdfBig->SetFont($Times_New_Roman, 'BI', 20, '', false);
                // $pdfBig->SetXY($pdfBig->getX(),$y + 23);        
                // $pdfBig->MultiCell(108, 11, $studentData[3], 0, "L", 0, 0, '', '', true, 0, true);
                ...
                $pdfBig->SetXY(18, 220);
                $pdfBig->Cell(0, 0, 'President / Trustee / CEO', 0, false, 'L');
                $pdfBig->SetXY(145, 220);
                $pdfBig->Cell(0, 0, 'Manager / Partner', 0, false, 'L');
                ...
                $pdf->SetFont($OLD_ENGL_mt, 'U', 30, '', false);
                $pdf->SetXY(15, 63);
                $pdf->Cell(0, 10, 'Certificate', 0, false, 'C');

                $x=15;
                $y=80;

                $pdf->SetTextColor(0,0,0);
                $pdf->SetFont($Times_New_Roman, 'BI', 23, '', false);
                $pdf->SetXY($x, $y-1);
                $pdf->Cell(0, 10, 'Awarded to', 0, false, 'C');
                

                // Old Code kamini
                // $pdf->SetTextColor(255, 0, 0);
                // $pdf->SetFont($Times_New_Roman, 'B', 25, '', false);
                // $pdf->SetXY($x, $y+10);
                // $pdf->Cell(0, 10, $studentData[2], 0, false, 'C');   
                // $pdf->SetTextColor(0,0,0);
                // $pdf->SetFont($MTCORSVA, '', 23, '', false);
            
                // $text = 'S/o,D/o,W/o, Guardian ' . $studentData[3] ;
                // $totalWidth = $pdf->GetStringWidth($text); 
                // $pageWidth = $pdf->GetPageWidth(); 
                // $centerX = ($pageWidth - $totalWidth) / 2; 
                // $pdf->SetXY($centerX, $y + 23); 
                // $pdf->SetFont($MTCORSVA, '', 23, '', false);
                // $pdf->Write(0, 'S/o,D/o,W/o, Guardian '); 
                // $pdf->SetFont($Times_New_Roman, 'BI', 20, '', false);
                // $pdf->Write(0, $studentData[3]);
                // old code kamini
                ...
                $width1 = 180;
                $pdf->SetFont($Times_New_Roman, 'B', 25, '', false);
                $textWidth1 = $pdf->GetStringWidth($studentData[2]);
                ...
                $pdf->SetTextColor(255, 0, 0);
                $pdf->SetFont($Times_New_Roman, 'B', $adjustedFontSize1, '', false);
                $pdf->SetXY(15, $y+10);
                $pdf->MultiCell(180, 10, $studentData[2], 0, "C", 0, 0, '', '', true, 0, true);
                // $pdf->Cell(0, 10, $studentData[2], 0, false, 'C');   
                $pdf->SetTextColor(0,0,0);
                ...
                $font_size = 20;
                $width = 180;
                $textWidth = $pdf->GetStringWidth('S/o,D/o,W/o, Guardian '.$studentData[3]);
                ...
                $pdf->SetFont($Times_New_Roman, 'BI', $adjustedFontSize, '', false);
                $pdf->SetXY(15,$y + 23);        
                $pdf->MultiCell(180, 11, '<span style="font-family:'.$MTCORSVA.'"> S/o,D/o,W/o, Guardian </span>'.$studentData[3], 0, "C", 0, 0, '', '', true, 0, true);
                ...
                // $pdf->SetFont($Times_New_Roman, 'BI', 20, '', false);
                // // get the number of lines
                // $lines = $pdf->MultiCell(180, 0, '<span style="font-size:23px;font-family:'.$MTCORSVA.'">S/o,D/o,W/o, Guardian</span> '.$studentData[3].' ', 0, 'C', 0, 0, '', '', true, 0, false,true, 0);
                ...
                // $pdf->SetFont($MTCORSVA, '', 23, '', false);
                // $pdf->SetXY(15,$y + 23);        
                // $pdf->MultiCell(72, 11, 'S/o,D/o,W/o, Guardian', 0, "L", 0, 0, '', '', true, 0, true);

                // $pdf->SetFont($Times_New_Roman, 'BI', 20, '', false);
                // $pdf->SetXY($pdf->getX(),$y + 23);        
                // $pdf->MultiCell(108, 11, $studentData[3], 0, "L", 0, 0, '', '', true, 0, true);
                ...
                $pdf->SetFont($MTCORSVA, '', 23, '', false);
                $pdf->SetXY($x, $y+33);
                $pdf->Cell(0, 10, 'for the course of', 0, false, 'C');
                $pdf->SetFont($Times_New_Roman, 'BI', 20, '', false);
                $pdf->SetXY($x, $y+43);
                $pdf->Cell(0, 10, $studentData[4], 0, false, 'C');
                ...
                $pageWidth = $pdf->GetPageWidth(); 
                $centerX = ($pageWidth - $totalWidth) / 2; 
                $pdf->SetXY($centerX, $y + 53); 
                $pdf->SetFont($MTCORSVA, '', 23, '', false);
                $pdf->Write(0, 'in ');
                $pdf->SetFont($Times_New_Roman, 'BI', 20, '', false);
                $pdf->Write(0, $studentData[5] . ' ');
                $pdf->SetFont($MTCORSVA, '', 23, '', false);
                $pdf->Write(0, 'Sector');
                ...
                $pageWidth = $pdf->GetPageWidth(); 
                $centerX = ($pageWidth - $totalWidth) / 2; 
                $pdf->SetXY($centerX, $y + 63);
                $pdf->SetFont($MTCORSVA, '', 23, '', false);
                $pdf->Write(0, 'with Grade  ');
                $pdf->SetFont($Times_New_Roman, 'BI', 20, '', false);
                $pdf->Write(0, $studentData[6] . ' ');

                $pdf->SetXY($x, $y+74);
                $pdf->SetFont($MTCORSVA, '', 23, '', false);
                $pdf->Cell(0, 10, 'Conducted at', 0, false, 'C');
                ...
                $pageWidth = $pdf->GetPageWidth(); 
                $centerX = ($pageWidth - $totalWidth) / 2; 
                $pdf->SetXY($centerX, $y + 84);
                $pdf->SetFont($MTCORSVA, '', 23, '', false);
                $pdf->Write(0, 'Center - Location ');
                $pdf->SetFont($Times_New_Roman, 'BI', 20, '', false);
                $pdf->Write(0, $studentData[7] . ' ');
                ...
                $pageWidth = $pdf->GetPageWidth(); 
                $centerX = ($pageWidth - $totalWidth) / 2; 
                $pdf->SetXY($centerX, $y + 94);
                $pdf->SetFont($MTCORSVA, '', 23, '', false);
                $pdf->Write(0, 'from ');
                $pdf->SetFont($Times_New_Roman, 'BI', 20, '', false);
                $pdf->Write(0, $studentData[8] . ' ');
                $pdf->SetFont($MTCORSVA, '', 23, '', false);
                $pdf->Write(0, ' to ');
                $pdf->SetFont($Times_New_Roman, 'BI', 20, '', false);
                $pdf->Write(0, $studentData[9] . ' ');

                $pdf->SetFont($MTCORSVA, '', 15, '', false);
                $pdf->SetXY(20, $y+165);
                $pdf->Cell(0, 0, 'Cerificate No: '.$studentData[0], 0, false, 'L');
                $pdf->SetXY(140, $y+165);
                $pdf->Cell(0, 0, 'Date of issue: '.$studentData[1], 0, false, 'L');

                $pdf->SetFont($Times_New_Normal, '', 8, '', false);
                $pdf->SetXY(10, $y+164);
                $pdf->Cell(0, 0, '75 - 100 = "A+" grade, 60 - 74 = "A" grade,', 0, false, 'C');
                $pdf->SetXY(10, $y+169);
                $pdf->Cell(0, 0, '50 - 59 = "B" grade, 35 - 49 = "C" Grade,', 0, false, 'C');

                $pdf->SetFont($Times_New_Normal, '', 15, '', false);
                $pdf->SetXY(18, 220);
                $pdf->Cell(0, 0, 'President / Trustee / CEO', 0, false, 'L');
                $pdf->SetXY(145, 220);
                $pdf->Cell(0, 0, 'Manager / Partner', 0, false, 'L');

                // $pdf->SetFont($Frutiger_45, 'B', 10, '', false);
                // $pdf->SetXY(0, $y+175);
                // $pdf->Cell(0, 0, 'Associated with', 0, false, 'C');
                //end pdf

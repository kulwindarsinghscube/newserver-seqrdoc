...
class PdfGenerateYuvaparivartanCertificateNewJob
{
       ...
       // $signature_path = public_path().'\\'.$subdomain[0].'\backend\canvas\images\Vice Chancellor.png';
        ...
        if($studentDataOrg&&!empty($studentDataOrg)){
            foreach ($studentDataOrg as $studentData) 
            {
                ...
                $pdf->MultiCell(180, 20, '<span style="text-decoration:underline">Certificate</span>', 0, "C", 0, 0, '', '', true, 0, true);
                $pdf->ln();
                ...
                $pdf->SetFont($MTCORSVA, '', 16, '', false);
                $pdf->SetXY(15, $pdf->getY());
                $pdf->MultiCell(180, 15, 'Date of Issue : '.$issue_date, 0, "L", 0, 0, '', '', true, 0, true);
                $pdf->ln();

...
class ValidateExcelDemoSOMJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        $rowData1[0] = array_filter($rowData1);
        ...
        if($dropdown_template_id==1){
            // if($columnsCount1==14){
            //     $columnArr=array('Unique_No','Roll_No','Enroll_No','Serial_No','Name','Division','Degree','Specialization','Name_in_Hindi','Division_in_Hindi','Degree_in_Hindi','Specialization_in_Hindi','Institute_Name','Year');

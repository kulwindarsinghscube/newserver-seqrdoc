...
class PdfGenerateChanakyaPhdJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
       ...
       // $signature_path = public_path().'\\'.$subdomain[0].'\backend\canvas\images\Vice Chancellor.png';
        ...
        {
            $card_serial_no = trim($studentData[3]);
            $serial_no=$studentData[9];
            $GUID=$studentData[0];
       ...
       // Start PDF Big
            ...
            $pdfBig->SetFont($times, '', 11, '', false);
            $pdfBig->SetXY($x, $y);
            $pdfBig->Cell(20, 7, "Programme: ", 0, 0, 'L');
            $pdfBig->SetFont($times, 'B', 11, '', false);
            $pdfBig->SetXY($pdfBig->GetX(), $y); 
            $pdfBig->Cell(100, 7, $studentData[2], 0, 0, 'L');
            $pdfBig->SetFont($times, '', 11, '', false);
            $pdfBig->SetXY($x+125, $y);
            $pdfBig->Cell(0, 7, "Semesters: ".$studentData[4], 0, false, 'L');
            //Table's Titles
            ...
            $pdfBig->MultiCell($cellWidth1, 7, 'Name Of the Course', 'LTR', 'C', 0, 0, '', '', true, 0, true);
            $pdfBig->SetXY(11 + $cellWidth1, $title_y);
            $pdfBig->MultiCell($cellWidth2, 7, 'Credit Scores', 'TR', 'C', 0, 0, '', '', true, 0, true);
            $pdfBig->setCellPaddings( $left = '', $top = '1', $right = '', $bottom = '');
            $pdfBig->SetFont($arialb, 'B', 10, '', false);  
            $pdfBig->SetXY(11, $title_y);
            $pdfBig->Ln();
            $title_y=$pdfBig->GetY();
            $pdfBig->SetXY(11, $title_y);
            $pdfBig->MultiCell($Width, 7, 'Discipline Core', 'TL', 'C', 0, 0, '', '', true, 0, true);
            $pdfBig->SetXY($pdfBig->GetX(), $title_y);
            $pdfBig->MultiCell($codeCellWidth, 7, 'Code', 'TL', 'C', 0, 0, '', '', true, 0, true);
            $pdfBig->SetXY($pdfBig->GetX(), $title_y);
            $pdfBig->MultiCell($codeCellWidth, 7, 'Credit', 'TL', 'C', 0, 0, '', '', true, 0, true);
            $pdfBig->SetXY($pdfBig->GetX(), $title_y);
            $pdfBig->MultiCell($codeCellWidth, 7, 'Grade', 'TL', 'C', 0, 0, '', '', true, 0, true);
            $pdfBig->SetXY($pdfBig->GetX(), $title_y);
            $pdfBig->MultiCell($codeCellWidth, 7, 'GP', 'TL', 'C', 0, 0, '', '', true, 0, true);
            $pdfBig->SetXY($pdfBig->GetX(), $title_y);
            $pdfBig->MultiCell($codeCellWidth, 7, 'CP', 'TLR', 'C', 0, 0, '', '', true, 0, true);
            $pdfBig->Ln();
...
// dd($subjects);
            foreach($subjects as $term => $term_array){
                ...
                $pdfBig->MultiCell($Width, 4,  $term, 'L', 'C', 0, 0, '', '', true, 0, true); 
                $pdfBig->SetXY($pdfBig->GetX(),  $sem_heading_y );
                $pdfBig->MultiCell($codeCellWidth, 4, '', 'L', 'C', 0, 0, '', '', true, 0, true); 
                $pdfBig->SetXY($pdfBig->GetX(),  $sem_heading_y );
                $pdfBig->MultiCell($codeCellWidth, 4, '', 'L', 'C', 0, 0, '', '', true, 0, true); 
                $pdfBig->SetXY($pdfBig->GetX(),  $sem_heading_y );
                $pdfBig->MultiCell($codeCellWidth, 4, '', 'L', 'C', 0, 0, '', '', true, 0, true); 
            ...
            $pdfBig->SetFont($arialb, 'B', 10, '', false);  
            $pdfBig->SetXY(11, $sem_heading_y);
            $pdfBig->MultiCell($Width, 7, 'Name Of the Course', 'TL', 'C', 0, 0, '', '', true, 0, true);
            $pdfBig->SetXY($pdfBig->GetX(), $sem_heading_y);
            $pdfBig->MultiCell(30, 7, 'Code', 'TL', 'C', 0, 0, '', '', true, 0, true);
            $pdfBig->SetXY($pdfBig->GetX(), $sem_heading_y);
            $pdfBig->MultiCell(20, 7, 'Credit', 'TL', 'C', 0, 0, '', '', true, 0, true);
            $pdfBig->SetXY($pdfBig->GetX(), $sem_heading_y);
            $pdfBig->MultiCell(50, 7, 'Remarks', 'TLR', 'C', 0, 0, '', '', true, 0, true);
            $pdfBig->Ln();
            $pdfBig->SetXY(11, $pdfBig->GetY());
            $pdfBig->MultiCell(186, 0, '', 'T', 'C', 0, 0);
            $table_y = $pdfBig->GetY();
            $pdfBig->SetFont($arialb, '', 10, '', false);  
            $pdfBig->SetXY(11, $table_y);
            $pdfBig->MultiCell($Width, 7, 'Teaching Pedagogy', 'LB', 'L', 0, 0, '', '', true, 0, true);
            $pdfBig->SetXY($pdfBig->GetX(), $table_y);
            $pdfBig->MultiCell(30, 7, 'ADL601', 'LB', 'C', 0, 0, '', '', true, 0, true);
            $pdfBig->SetXY($pdfBig->GetX(), $table_y);
            $pdfBig->MultiCell(20, 7, '2', 'LB', 'C', 0, 0, '', '', true, 0, true);
            $pdfBig->SetXY($pdfBig->GetX(), $table_y);
            $pdfBig->MultiCell(50, 7, 'Completed', 'LBR', 'C', 0, 0, '', '', true, 0, true);

            $pdfBig->Ln();
            $table_y = $pdfBig->GetY();
            $pdfBig->SetFont($arialb, '', 10, '', false);  
            $pdfBig->SetXY(11, $table_y);
            $pdfBig->MultiCell($Width, 7, 'Conference &amp; Workshops', 'LB', 'L', 0, 0, '', '', true, 0, true);
            $pdfBig->SetXY($pdfBig->GetX(), $table_y);
            $pdfBig->MultiCell(30, 7, 'ADL602', 'LB', 'C', 0, 0, '', '', true, 0, true);
            $pdfBig->SetXY($pdfBig->GetX(), $table_y);
            $pdfBig->MultiCell(20, 7, '1', 'LB', 'C', 0, 0, '', '', true, 0, true);
            $pdfBig->SetXY($pdfBig->GetX(), $table_y);
            $pdfBig->MultiCell(50, 7, 'Completed', 'LBR', 'C', 0, 0, '', '', true, 0, true);
            ...
            // $pdfBig->setCellPaddings( $left = '', $top = '1', $right = '', $bottom = '');
            // $pdfBig->SetXY(16, $y);   
            // $pdfBig->MultiCell(20, 6, 'SGPA','LT', 'C', 0, 0);
            // $pdfBig->SetXY($pdfBig->GetX(), $y);
            // $pdfBig->MultiCell(135, 6, 'Total Credit Points/ Total Credits: '.$studentData[6], 'LT', 'L', 0, 0);
            // $pdfBig->SetXY($pdfBig->GetX(), $y);
            // $pdfBig->MultiCell(20, 6, $studentData[5], 'LTR', 'C', 0, 0);
            // $pdfBig->Ln();
            $pdfBig->SetXY(16, $y);
            $pdfBig->MultiCell(175, 0, '', 'T', 'C', 0, 0);
            $y=$pdfBig->GetY();	
            $pdfBig->setCellPaddings( $left = '', $top = '1', $right = '', $bottom = '');
            $pdfBig->SetXY(16, $y);   
            $pdfBig->MultiCell(20, 6, 'CGPA','LB', 'C', 0, 0);
            $pdfBig->SetXY($pdfBig->GetX(), $y);
            $pdfBig->MultiCell(135, 6, 'Credit points secured in all subjects/ Total credit of all semesters: '.$studentData[8], 'LB', 'L', 0, 0);
            $pdfBig->SetXY($pdfBig->GetX(), $y);
            $pdfBig->MultiCell(20, 6, $studentData[7], 'LBR', 'C', 0, 0);
            ...
            $pdf->SetFont($times, '', 11, '', false);
            $pdf->SetXY($x, $y);
            $pdf->Cell(20, 7, "Programme: ", 0, 0, 'L');
            $pdf->SetFont($times, 'B', 11, '', false);
            $pdf->SetXY($pdf->GetX(), $y); 
            $pdf->Cell(100, 7, $studentData[2], 0, 0, 'L');
            $pdf->SetFont($times, '', 11, '', false);
            $pdf->SetXY($x+125, $y);
            $pdf->Cell(0, 7, "Semesters: ".$studentData[4], 0, false, 'L');
            //Table's Titles
            $pdf->SetXY(17, 77.6);
            ...
            $pdf->MultiCell($cellWidth1, 7, 'Name Of the Course', 'LTR', 'C', 0, 0, '', '', true, 0, true);
            $pdf->SetXY(11 + $cellWidth1, $title_y);
            $pdf->MultiCell($cellWidth2, 7, 'Credit Scores', 'TR', 'C', 0, 0, '', '', true, 0, true);
            $pdf->setCellPaddings( $left = '', $top = '1', $right = '', $bottom = '');
            $pdf->SetFont($arialb, 'B', 10, '', false);  
            $pdf->SetXY(11, $title_y);
            $pdf->Ln();
            $title_y=$pdf->GetY();
            $pdf->SetXY(11, $title_y);
            $pdf->MultiCell($Width, 7, 'Discipline Core', 'TL', 'C', 0, 0, '', '', true, 0, true);
            $pdf->SetXY($pdf->GetX(), $title_y);
            $pdf->MultiCell($codeCellWidth, 7, 'Code', 'TL', 'C', 0, 0, '', '', true, 0, true);
            $pdf->SetXY($pdf->GetX(), $title_y);
            $pdf->MultiCell($codeCellWidth, 7, 'Credit', 'TL', 'C', 0, 0, '', '', true, 0, true);
            $pdf->SetXY($pdf->GetX(), $title_y);
            $pdf->MultiCell($codeCellWidth, 7, 'Grade', 'TL', 'C', 0, 0, '', '', true, 0, true);
            $pdf->SetXY($pdf->GetX(), $title_y);
            $pdf->MultiCell($codeCellWidth, 7, 'GP', 'TL', 'C', 0, 0, '', '', true, 0, true);
            $pdf->SetXY($pdf->GetX(), $title_y);
            $pdf->MultiCell($codeCellWidth, 7, 'CP', 'TLR', 'C', 0, 0, '', '', true, 0, true);
            $pdf->Ln();
...
// dd($subjects);
            foreach($subjects as $term => $term_array){
                ...
                $pdf->MultiCell($Width, 4,  $term, 'L', 'C', 0, 0, '', '', true, 0, true); 
                $pdf->SetXY($pdf->GetX(),  $sem_heading_y );
                $pdf->MultiCell($codeCellWidth, 4, '', 'L', 'C', 0, 0, '', '', true, 0, true); 
                $pdf->SetXY($pdf->GetX(),  $sem_heading_y );
                $pdf->MultiCell($codeCellWidth, 4, '', 'L', 'C', 0, 0, '', '', true, 0, true); 
                $pdf->SetXY($pdf->GetX(),  $sem_heading_y );
                $pdf->MultiCell($codeCellWidth, 4, '', 'L', 'C', 0, 0, '', '', true, 0, true); 
            ...
            $pdf->SetFont($arialb, 'B', 10, '', false);  
            $pdf->SetXY(11, $sem_heading_y);
            $pdf->MultiCell($Width, 7, 'Name Of the Course', 'TL', 'C', 0, 0, '', '', true, 0, true);
            $pdf->SetXY($pdf->GetX(), $sem_heading_y);
            $pdf->MultiCell(30, 7, 'Code', 'TL', 'C', 0, 0, '', '', true, 0, true);
            $pdf->SetXY($pdf->GetX(), $sem_heading_y);
            $pdf->MultiCell(20, 7, 'Credit', 'TL', 'C', 0, 0, '', '', true, 0, true);
            $pdf->SetXY($pdf->GetX(), $sem_heading_y);
            $pdf->MultiCell(50, 7, 'Remarks', 'TLR', 'C', 0, 0, '', '', true, 0, true);
            $pdf->Ln();
            $pdf->SetXY(11, $pdf->GetY());
            $pdf->MultiCell(186, 0, '', 'T', 'C', 0, 0);
            $table_y = $pdf->GetY();
            $pdf->SetFont($arialb, '', 10, '', false);  
            $pdf->SetXY(11, $table_y);
            $pdf->MultiCell($Width, 7, 'Teaching Pedagogy', 'LB', 'L', 0, 0, '', '', true, 0, true);
            $pdf->SetXY($pdf->GetX(), $table_y);
            $pdf->MultiCell(30, 7, 'ADL601', 'LB', 'C', 0, 0, '', '', true, 0, true);
            $pdf->SetXY($pdf->GetX(), $table_y);
            $pdf->MultiCell(20, 7, '2', 'LB', 'C', 0, 0, '', '', true, 0, true);
            $pdf->SetXY($pdf->GetX(), $table_y);
            $pdf->MultiCell(50, 7, 'Completed', 'LBR', 'C', 0, 0, '', '', true, 0, true);

            $pdf->Ln();
            $table_y = $pdf->GetY();
            $pdf->SetFont($arialb, '', 10, '', false);  
            $pdf->SetXY(11, $table_y);
            $pdf->MultiCell($Width, 7, 'Conference &amp; Workshops', 'LB', 'L', 0, 0, '', '', true, 0, true);
            $pdf->SetXY($pdf->GetX(), $table_y);
            $pdf->MultiCell(30, 7, 'ADL602', 'LB', 'C', 0, 0, '', '', true, 0, true);
            $pdf->SetXY($pdf->GetX(), $table_y);
            $pdf->MultiCell(20, 7, '1', 'LB', 'C', 0, 0, '', '', true, 0, true);
            $pdf->SetXY($pdf->GetX(), $table_y);
            $pdf->MultiCell(50, 7, 'Completed', 'LBR', 'C', 0, 0, '', '', true, 0, true);
            ...
            // $pdf->setCellPaddings( $left = '', $top = '1', $right = '', $bottom = '');
            // $pdf->SetXY(16, $y);   
            // $pdf->MultiCell(20, 6, 'SGPA','LT', 'C', 0, 0);
            // $pdf->SetXY($pdf->GetX(), $y);
            // $pdf->MultiCell(135, 6, 'Total Credit Points/ Total Credits: '.$studentData[6], 'LT', 'L', 0, 0);
            // $pdf->SetXY($pdf->GetX(), $y);
            // $pdf->MultiCell(20, 6, $studentData[5], 'LTR', 'C', 0, 0);
            // $pdf->Ln();
            $pdf->SetXY(16,  $y);
            $pdf->MultiCell(175, 0, '', 'T', 'C', 0, 0);
            $y=$pdf->GetY(); 
            $pdf->setCellPaddings( $left = '', $top = '1', $right = '', $bottom = '');
            $pdf->SetXY(16, $y);   
            $pdf->MultiCell(20, 6, 'CGPA','LB', 'C', 0, 0);
            $pdf->SetXY($pdf->GetX(), $y);
            $pdf->MultiCell(135, 6, 'Credit points secured in all subjects/ Total credit of all semesters: '.$studentData[8], 'LB', 'L', 0, 0);
            $pdf->SetXY($pdf->GetX(), $y);
            $pdf->MultiCell(20, 6, $studentData[7], 'LBR', 'C', 0, 0);

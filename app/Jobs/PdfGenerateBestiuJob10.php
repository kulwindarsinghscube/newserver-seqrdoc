    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        if($studentDataOrg&&!empty($studentDataOrg)){
            foreach ($studentDataOrg as $studentData) {
                ...
                $pdfBig->SetXY(12, 43.5);
                $pdfBig->Cell(186, 0, 'SEMESTER GRADE CARD', 0, false, 'C');
                
                $pdfBig->SetFont($arial, '', 9.5, '', false);
                $pdfBig->SetXY($left_pos, 52.5);		
                $pdfBig->Cell(162, 6.5, 'Student Name:', 1, false, 'L');
                $pdfBig->SetXY($left_pos, 59);		
                $pdfBig->Cell(117.5, 6, "Father's Name:", 'LTB', false, 'L');	
                $pdfBig->Cell(44.5, 6, "Date: ", 'TRB', false, 'L');	
                $pdfBig->SetXY($left_pos, 65);		
                $pdfBig->Cell(117.5, 6.5, "Semester:", 'LTB', false, 'L');	
                $pdfBig->Cell(44.5, 6.5, "ID No.:", 'TRB', false, 'L');	
                $pdfBig->SetXY($left_pos, 71.5);		
                $pdfBig->Cell(162, 6, 'Course :', 1, false, 'L');
                
                $pdfBig->SetFont($arialb, '', 9.5, '', false);
                $pdfBig->SetXY(36, 52.5);		
                $pdfBig->Cell(0, 6.5, $candidate_name, 0, false, 'L');
                $pdfBig->SetXY(36, 59);		
                $pdfBig->Cell(0, 6, $Fathers_Name, 0, false, 'L');
                $pdfBig->SetXY(139, 59);	
                $pdfBig->Cell(0, 6, $DATE, 0, false, 'L');
                $pdfBig->SetXY(29, 65);		
                $pdfBig->Cell(0, 6.5, $semester, 0, false, 'L');
                $pdfBig->SetXY(141, 65);				
                $pdfBig->Cell(0, 6.5, $ID_No, 0, false, 'L');
                $pdfBig->SetXY(26, 71.5);		
                $pdfBig->Cell(0, 6, $course, 0, false, 'L');	
                
                
                
                $pdfBig->SetXY($left_pos, 91.5);
                $pdfBig->Cell(185, 0, "", 'T', false, 'L');
                
                $pdfBig->SetFont($arialb, '', 9.5, '', false);
                $pdfBig->SetXY(12, 84.3);	
                $pdfBig->MultiCell(13, 10, 'Sl. No.', 0, 'C');
                $pdfBig->SetXY(23.5, 81.9);
                $pdfBig->MultiCell(18, 10, 'Course Code', 0, 'C');
                $pdfBig->SetXY(42, 84);
                $pdfBig->MultiCell(105.5, 10, 'Course Title', 0, 'C');
                $pdfBig->SetXY(146.5, 81.9);
                $pdfBig->MultiCell(17, 10, 'Credit Hours', 0, 'C');
                $pdfBig->SetXY(163.5, 81.9);
                $pdfBig->MultiCell(17, 10, '^Grade Point', 0, 'C');
                $pdfBig->SetXY(180.5, 81.9);
                ...
                $pdfBig->SetXY(12.5, $subjectArrYaxisValue+80);
                ...
                $pdf->SetFont($arial, '', 9, '', false); 
                $pdfBig->SetFont($arial, '', 9, '', false); 
                $subj_y=$subjectArrYaxisValue+89.6;
                $subjectSEYaxis = 0;
                $subjectSECount = 0;
                ...
                $pdfBig->SetXY($left_pos, $subjectArrYaxisValue+89);
                ...
                $pdfBig->SetXY($left_pos, $subjectArrYaxisValue+89+$subjectSEYaxis);
                $pdfBig->SetFont($arialb, '', 9.5, '', false);
                ...
                $pdfBig->SetXY($left_pos, $subjectArrYaxisValue+89+$subjectSEYaxis+6);
                $pdfBig->SetFont($arialb, '', 9.5, '', false);
                ...
                $pdfBig->SetTextColor(0, 0, 0);
                $pdfBig->SetXY(12, $subjectArrYaxisValue+89+$subjectSEYaxis+13);
                $pdfBig->SetFont($arial, '', 9, '', false);
                ...
                $pdf->SetXY($left_pos, 52.5);		
                $pdf->Cell(162, 6.5, 'Student Name:', 1, false, 'L');
                $pdf->SetXY($left_pos, 59);		
                $pdf->Cell(117.5, 6, "Father's Name:", 'LTB', false, 'L');	
                $pdf->Cell(44.5, 6, "Date: ", 'TRB', false, 'L');	
                $pdf->SetXY($left_pos, 65);		
                $pdf->Cell(117.5, 6.5, "Semester:", 'LTB', false, 'L');	
                $pdf->Cell(44.5, 6.5, "ID No.:", 'TRB', false, 'L');	
                $pdf->SetXY($left_pos, 71.5);		
                $pdf->Cell(162, 6, 'Course :', 1, false, 'L');
                
                $pdf->SetFont($arialb, '', 9.5, '', false);
                $pdf->SetXY(36, 52.5);		
                $pdf->Cell(0, 6.5, $candidate_name, 0, false, 'L');
                $pdf->SetXY(36, 59);		
                $pdf->Cell(0, 6, $Fathers_Name, 0, false, 'L');
                $pdf->SetXY(139, 59);	
                $pdf->Cell(0, 6, $DATE, 0, false, 'L');
                $pdf->SetXY(29, 65);		
                $pdf->Cell(0, 6.5, $semester, 0, false, 'L');
                $pdf->SetXY(141, 65);				
                $pdf->Cell(0, 6.5, $ID_No, 0, false, 'L');
                $pdf->SetXY(26, 71.5);		
                $pdf->Cell(0, 6, $course, 0, false, 'L');	
                
                
                
                $pdf->SetXY($left_pos, 91.5);
                ...
                $pdf->SetXY(146.5, 81.9);
                $pdf->MultiCell(17, 10, 'Credit Hours', 0, 'C');
                $pdf->SetXY(163.5, 81.9);
                $pdf->MultiCell(17, 10, '^Grade Point', 0, 'C');
                $pdf->SetXY(180.5, 81.9);
                ...
                $pdf->SetXY(12.5, $subjectArrYaxisValue+80);
                ...
                $pdf->SetXY($left_pos, $subjectArrYaxisValue+89);
                ...
                $pdf->SetXY($left_pos, $subjectArrYaxisValue+89+$subjectSEYaxis);
                $pdf->SetFont($arialb, '', 9.5, '', false);
                ...
                $pdf->SetXY($left_pos, $subjectArrYaxisValue+89+$subjectSEYaxis+6);
                $pdf->SetFont($arialb, '', 9.5, '', false);
                $pdf->Cell(134.5, 6, 'SGPA: '.$sgpa, 1, false, 'L');
                $pdf->Cell(50.8, 6, 'CGPA: '.$cgpa, 1, false, 'L');
                
                $pdf->SetXY(12, $subjectArrYaxisValue+89+$subjectSEYaxis+13);
                $pdf->SetFont($arial, '', 9, '', false);

...
class PdfGenerateAnuBTCCJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        if ($studentDataOrg && !empty($studentDataOrg)) {
            foreach ($studentDataOrg as $studentData) {
                ...
                $high_res_bg = "anu_gradecard_front.jpg"; // bestiu_pdc_bg, TranscriptData.jpg
                ...
                //$pdfBig->setPageMark();
                //Table's Titles  
                $unique_id = trim($studentData['Unique_ID']);


                // $points=="10_2";
                $Issue_date = $this->convertExcelDate($studentData['Issue_date']);
                $D_O_B = $this->convertExcelDate($studentData['D_O_B']);
                // dd($D_O_B);
                $grandTotCreditMax = $studentData['GRAND_TOT_CREDIT_MAX'] ?? '';
                $grandTotCreditMax = is_numeric($grandTotCreditMax) ? number_format((float)$grandTotCreditMax, 1) : '';
                $grandTotCreditMaxPoint = $studentData['GRAND_TOT_CREDIT_POINTS'];
                $grandTotCreditMaxPoint = is_numeric($grandTotCreditMaxPoint) ? number_format((float)$grandTotCreditMaxPoint, 1) : '';

                $TOT_CREDIT_MAX = $studentData['TOT_CREDIT_MAX'];
                //  dd( $TOT_CREDIT_MAX);
                $TOT_CREDIT_MAX = is_numeric($TOT_CREDIT_MAX) ? number_format((float) $TOT_CREDIT_MAX, 1) : '';

                $TOT_CREDIT_POINTS = $studentData['TOT_CREDIT_POINTS'];
                $TOT_CREDIT_POINTS = is_numeric($TOT_CREDIT_POINTS) ? number_format((float) $TOT_CREDIT_POINTS, 1) : '';
                $serial_no = $GUID = $studentData['Unique_ID'];
                // dd($GUID,'yes');
                //start Bigpdf
                $pdfBig->SetTextColor(0, 0, 0);
                $pdfBig->SetFont($trebuc, '', 10, '', false);
                $pdfBig->SetXY(155, 8);
                if (!empty($studentData['ABC_ACCOUNT_ID'])) {
                    $pdfBig->MultiCell(0, 0, "APAAR ID:" . $studentData['ABC_ACCOUNT_ID'], 0, "L", 0, 0, '', '', true, 0, true);
                }
                ...
                $pdfBig->SetXY(12, 43);
                $pdfBig->MultiCell(185, 0, $studentData['TERM_TYPE'], 0, 'C', 0, 0, '', '', true, 0, true);
                $pdfBig->Ln();
                $pdfBig->SetFont($trebucb, '', 10, '', false);
                $pdfBig->SetXY(12, 53);
                $pdfBig->SetTextColor(0, 0, 0);
                $pdfBig->MultiCell(32.5, 0, "Student Name:", 0, "R", 0, 0, '', '', true, 0, true);
                $pdfBig->MultiCell(125.5, 0, '<span style="font-family:' . $trebuc . ';">' . $studentData['CNAME'] . '</span>', 0, "L", 0, 0, '', '', true, 0, true);
                ...
                $pdfBig->MultiCell(43, 0, '<span style="font-family:' . $trebuc . ';">' . $studentData['REGN_NO'] . '</span>', 0, "L", 0, 0, '', '', true, 0, true);


                $pdfBig->SetXY(90, $idy);
                $pdfBig->MultiCell(27, 0, "Date of Birth :", 0, "R", 0, 0, '', '', true, 0, true);
                $pdfBig->MultiCell(58, 0, '<span style="font-family:' . $trebuc . ';">' . $D_O_B . '</span>', 0, "L", 0, 0, '', '', true, 0, true);

                $pdfBig->Ln();
                $BatchY = $pdfBig->GetY();
                $pdfBig->SetXY($X, $BatchY);
                $pdfBig->MultiCell(32.5, 0, "Batch:", 0, "R", 0, 0, '', '', true, 0, true);
                $pdfBig->MultiCell(43, 0, '<span style="font-family:' . $trebuc . ';">' . $studentData['ADMISSION_YEAR'] . '</span>', 0, "L", 0, 0, '', '', true, 0, true);
                $pdfBig->Ln();
                $SemY = $pdfBig->GetY();
                $pdfBig->SetXY(90, $BatchY);
                $pdfBig->MultiCell(27, 0, "Programme:", 0, "R", 0, 0, '', '', true, 0, true);
                $pdfBig->MultiCell(55, 0, '<span style="font-family:' . $trebuc . ';">' . $studentData['COURSE_NAME'] . '</span>', 0, "L", 0, 0, '', '', true, 0, true);
                $pdfBig->Ln();
                $MajorY = $pdfBig->GetY();
                ...
                $pdfBig->MultiCell(43, 0, '<span style="font-family:' . $trebuc . ';">' . $studentData['SEM'] . '</span>', 0, "L", 0, 0, '', '', true, 0, true);
                $pdfBig->Ln();
                $ReportY = $pdfBig->GetY();

                if (!empty($studentData['STREAM'] && strtolower($studentData['COURSE_NAME']) != strtolower('Bachelor of Technology in Climate Change'))) {
                    $pdfBig->SetXY(90, $MajorY);
                    $pdfBig->MultiCell(27, 0, "Major:", 0, "R", 0, 0, '', '', true, 0, true);
                    $pdfBig->MultiCell(58, 0, '<span style="font-family:' . $trebuc . ';">' . $studentData['STREAM'] . '</span>', 0, "L", 0, 0, '', '', true, 0, true);
                    $pdfBig->Ln();
                    $MajorY = $pdfBig->GetY();
                }
                $pdfBig->Ln();
                $pdfBig->SetXY($X, $ReportY);
                $pdfBig->MultiCell(32.5, 0, "Report Issue Date:", 0, "L", 0, 0, '', '', true, 0, true);
                $pdfBig->MultiCell(43, 0, '<span style="font-family:' . $trebuc . ';">' . $Issue_date . '</span>', 0, "L", 0, 0, '', '', true, 0, true);


                if (!empty($studentData['SPECIALIZATION_MAJOR'])) {
                    $pdfBig->SetXY(90, $MajorY);
                    $pdfBig->MultiCell(27, 0, "Specialisation:", 0, "R", 0, 0, '', '', true, 0, true);
                    $pdfBig->MultiCell(58, 0, '<span style="font-family:' . $trebuc . ';">' . $studentData['SPECIALIZATION_MAJOR'] . '</span>', 0, "L", 0, 0, '', '', true, 0, true);
                }

                $pdfBig->Ln();
                // dd($Issue_date);
                $tableY = $pdfBig->GetY() + 2;
                $pdfBig->SetXY($X, $tableY);
                $pdfBig->MultiCell(22, 135, '', 'LTB', 'L', 0, 0);
                $pdfBig->MultiCell(97.6, 135, '', 'LTB', 'C', 0, 0);
                $pdfBig->MultiCell(16, 135, '', 'LTB', 'C', 0, 0);
                $pdfBig->MultiCell(16, 135, '', 'LTB', 'C', 0, 0);
                $pdfBig->MultiCell(16, 135, '', 'LTB', 'C', 0, 0);
                $pdfBig->MultiCell(17.5, 135, '', 'LRTB', 'C', 0, 0);
                $pdfBig->Ln();
                $BigTable_y = $pdfBig->GetY() + 1;
                $pdfBig->SetXY($X, $tableY);
                ...
                $pdfBig->MultiCell(16, 0, 'Credits<br>Enrolled', 0, 'C', 0, 0, '', '', true, 0, true);
                $pdfBig->MultiCell(16, 0, 'Credits<br>Earned', 0, 'C', 0, 0, '', '', true, 0, true);
                $pdfBig->setCellPaddings($left = '', $top = '2', $right = '', $bottom = '');
                $pdfBig->MultiCell(16, 0, 'Grade', 0, 'C', 0, 0, '', '', true, 0, true);
                $pdfBig->setCellPaddings($left = '', $top = '0', $right = '', $bottom = '');
                $pdfBig->MultiCell(18, 0, 'Grade<br>Points', 0, 'C', 0, 0, '', '', true, 0, true);
                $pdfBig->Ln();
                $pdfBig->SetXY($X, $pdfBig->GetY());
                $pdfBig->MultiCell(185, 0, '', 'T', 'L', 0, 0);

                $subj_y = $pdfBig->GetY() - 6;
                $subjectTableHeight = 7;

                $pdfBig->SetFont($trebuc, '', 9, '', false);

                for ($s = 0; $s < 17; $s++) {

                    /* ---------------- SUBJECT NAME (NO NC HERE) ---------------- */
                    $keyNm = 'SUB' . $s . 'NM';
                    $Subject_name = trim($studentData[$keyNm] ?? '');

                    /* --------- CALCULATE ROW HEIGHT BASED ON SUBJECT ---------- */
                    $pdfBig->startTransaction();
                    $pdfBig->SetFont($arial, '', 10, '', false);

                    $lines = $pdfBig->MultiCell(
                        97,
                        0,
                        $Subject_name,
                        0,
                    ...
                    $subjectTableHeight = ($lines > 1) ? 11.5 : 7;

                    /* ---------------- SUBJECT CODE ---------------- */
                    $key = 'SUB' . $s;
                    $Subject_Code = $studentData[$key] ?? '';

                    $pdfBig->SetXY(12, $subj_y);
                    $pdfBig->MultiCell(22, $subjectTableHeight, $Subject_Code, 0, 'R', 0, 0);

                    /* ---------------- SUBJECT NAME ---------------- */
                    $pdfBig->MultiCell(97, $subjectTableHeight, $Subject_name, 0, 'L', 0, 0);

                    /* ---------------- CREDITS ENROLLED ---------------- */
                    $key = 'SUB' . $s . '_CREDIT_MAX';
                    $raw = trim($studentData[$key] ?? '');

                    if (strtoupper($raw) === 'NC') {
                        $Credits_Enrolled = 'NC';
                    } elseif (is_numeric($raw)) {
                        $Credits_Enrolled = number_format((float)$raw, 1);
                    } else {
                        $Credits_Enrolled = $raw;
                    }

                    $pdfBig->MultiCell(16, $subjectTableHeight, $Credits_Enrolled, 0, 'C', 0, 0);
                    ...
                    if (strtoupper($raw) === 'NC') {
                        ...
                        $Credits_Earned = number_format((float)$raw, 1);
                    } else {
                        $Credits_Earned = $raw;
                    }

                    $pdfBig->MultiCell(16, $subjectTableHeight, $Credits_Earned, 0, 'C', 0, 0);

                    /* ---------------- GRADE ---------------- */
                    $key = 'SUB' . $s . '_GRADE';
                    $raw = trim($studentData[$key] ?? '');

                    $Grade = (strtoupper($raw) === 'NC') ? 'NC' : $raw;

                    $pdfBig->MultiCell(16, $subjectTableHeight, $Grade, 0, 'C', 0, 0);

                    /* ---------------- GRADE POINTS ---------------- */
                    $key = 'SUB' . $s . '_GRADE_POINTS';
                    $raw = trim($studentData[$key] ?? '');

                    if (strtoupper($raw) === 'NC') {
                        $Grade_Points = 'NC';
                    } elseif (is_numeric($raw)) {
                        $Grade_Points = number_format((float)$raw, 1);
                    } else {
                        $Grade_Points = $raw;
                    }

                    $pdfBig->MultiCell(16, $subjectTableHeight, $Grade_Points, 0, 'C', 0, 0);

                    /* ---------------- NEXT ROW ---------------- */
                    $subj_y += $subjectTableHeight;
                }
                ...
                $pdfBig->SetXY(12, $BigTable_y + 8);
                $pdfBig->setCellPaddings($left = '', $top = '2.5', $right = '', $bottom = '');
                $pdfBig->SetFont($trebuc, '', 9.5, '', false);
                $pdfBig->MultiCell(26.5, 10, 'Credits', "LRB", 'C', 0, 0, '', '', true, 0, true);
                ...
                $pdfBig->MultiCell(30.5, 10, 'SGPA', "B", 'C', 0, 0, '', '', true, 0, true);
                $pdfBig->setCellPaddings($left = '', $top = '1.3', $right = '', $bottom = '');
                $pdfBig->SetFont($trebuc, '', 9.5, '', false);
                $pdfBig->MultiCell(31, 10, 'Total<br> Credits', "LRB", 'C', 0, 0, '', '', true, 0, true);
                ...
                $pdfBig->SetFont($trebuc, '', 9.5, '', false);
                $pdfBig->SetTextColor(0, 0, 0);
                $pdfBig->SetXY(12, $BigTable_y + 18);
                $pdfBig->setCellPaddings($left = '', $top = '3', $right = '', $bottom = '');

                $pdfBig->MultiCell(26.5, 12, $TOT_CREDIT_MAX, "LRB", 'C', 0, 0, '', '', true, 0, true);
                $pdfBig->MultiCell(35.5, 12, $TOT_CREDIT_POINTS, "TBR", 'C', 0, 0, '', '', true, 0, true);
                $pdfBig->setCellPaddings($left = '', $top = '1.5', $right = '', $bottom = '');
                $pdfBig->SetFont($trebucb, '', 9.5, '', false);
                $pdfBig->MultiCell(30.5, 12, $studentData['SGPA'] . '<br>' . $studentData['SGPA _Desc'], "B", 'C', 0, 0, '', '', true, 0, true);

                $pdfBig->setCellPaddings($left = '', $top = '3', $right = '', $bottom = '');
                $pdfBig->SetFont($trebuc, '', 9.5, '', false);
                $pdfBig->MultiCell(31, 12, $grandTotCreditMax, "LTRB", 'C', 0, 0, '', '', true, 0, true);
                $pdfBig->MultiCell(30.5, 12, $grandTotCreditMaxPoint, "RB", 'C', 0, 0, '', '', true, 0, true);
                $pdfBig->SetFont($trebucb, '', 9.5, '', false);
                $pdfBig->setCellPaddings($left = '', $top = '1.5', $right = '', $bottom = '');
                $pdfBig->MultiCell(31, 12, $studentData['CGPA_'] . '<br>' . $studentData['CGPA_Desc'], "RB", 'C', 0, 0, '', '', true, 0, true);
                $pdfBig->setCellPaddings($left = '', $top = '0', $right = '', $bottom = '');
                ...
                //left side
                $pdfBig->SetXY(44, 272);
                $pdfBig->Cell(0, 0, $studentData['Name1'], 0, false, 'L');
                $pdfBig->SetXY(44, 275.5);
                $pdfBig->Cell(0, 0, $studentData['Designation1'], 0, false, 'L');

                $pdfBig->SetXY(132.5, 272);
                $pdfBig->Cell(0, 0, $studentData['Name2'], 0, false, 'L');
                $pdfBig->SetXY(132.5, 275.5);
                $pdfBig->Cell(0, 0, $studentData['Designation2'], 0, false, 'L');
                //end Bigpdf
                ...
                $pdf->SetXY(155, 8);
                if (!empty($studentData['ABC_ACCOUNT_ID'])) {
                    $pdf->MultiCell(0, 0, "APAAR ID:" . $studentData['ABC_ACCOUNT_ID'], 0, "L", 0, 0, '', '', true, 0, true);
                }
                ...
                $pdf->SetXY(12, 43);
                $pdf->SetTextColor(0, 0, 0);
                $pdf->MultiCell(185, 0, $studentData['TERM_TYPE'], 0, 'C', 0, 0, '', '', true, 0, true);
                $pdf->Ln();
                $pdf->SetFont($trebucb, '', 10, '', false);
                $pdf->SetXY(12, 53);
                $pdf->MultiCell(32.5, 0, "Student Name:", 0, "R", 0, 0, '', '', true, 0, true);
                $pdf->MultiCell(125.5, 0, '<span style="font-family:' . $trebuc . ';">' . $studentData['CNAME'] . '</span>', 0, "L", 0, 0, '', '', true, 0, true);
                ...
                $pdf->MultiCell(43, 0, '<span style="font-family:' . $trebuc . ';">' . $studentData['REGN_NO'] . '</span>', 0, "L", 0, 0, '', '', true, 0, true);


                $pdf->SetXY(90, $idy);
                $pdf->MultiCell(27, 0, "Date of Birth :", 0, "R", 0, 0, '', '', true, 0, true);
                $pdf->MultiCell(58, 0, '<span style="font-family:' . $trebuc . ';">' . $D_O_B . '</span>', 0, "L", 0, 0, '', '', true, 0, true);

                $pdf->Ln();
                $BatchY = $pdf->GetY();
                $pdf->SetXY($X, $BatchY);
                $pdf->MultiCell(32.5, 0, "Batch:", 0, "R", 0, 0, '', '', true, 0, true);
                $pdf->MultiCell(43, 0, '<span style="font-family:' . $trebuc . ';">' . $studentData['ADMISSION_YEAR'] . '</span>', 0, "L", 0, 0, '', '', true, 0, true);
                $pdf->Ln();
                $SemY = $pdf->GetY();
                $pdf->SetXY(90, $BatchY);
                $pdf->MultiCell(27, 0, "Programme:", 0, "R", 0, 0, '', '', true, 0, true);
                $pdf->MultiCell(55, 0, '<span style="font-family:' . $trebuc . ';">' . $studentData['COURSE_NAME'] . '</span>', 0, "L", 0, 0, '', '', true, 0, true);
                $pdf->Ln();
                $MajorY = $pdf->GetY();
                ...
                $pdf->MultiCell(43, 0, '<span style="font-family:' . $trebuc . ';">' . $studentData['SEM'] . '</span>', 0, "L", 0, 0, '', '', true, 0, true);
                $pdf->Ln();
                $ReportY = $pdf->GetY();
                ...
                if (!empty($studentData['STREAM'] && strtolower($studentData['COURSE_NAME']) != strtolower('Bachelor of Technology in Climate Change'))) {
                    ...
                    $pdf->MultiCell(58, 0, '<span style="font-family:' . $trebuc . ';">' . $studentData['STREAM'] . '</span>', 0, "L", 0, 0, '', '', true, 0, true);
                    $pdf->Ln();
                    $MajorY = $pdf->GetY();
                }
                $pdf->Ln();
                ...
                $pdf->MultiCell(43, 0, '<span style="font-family:' . $trebuc . ';">' . $Issue_date . '</span>', 0, "L", 0, 0, '', '', true, 0, true);


                if (!empty($studentData['SPECIALIZATION_MAJOR'])) {
                    $pdf->SetXY(90, $MajorY);
                    $pdf->MultiCell(27, 0, "Specialisation:", 0, "R", 0, 0, '', '', true, 0, true);
                    $pdf->MultiCell(58, 0, '<span style="font-family:' . $trebuc . ';">' . $studentData['SPECIALIZATION_MAJOR'] . '</span>', 0, "L", 0, 0, '', '', true, 0, true);
                }
                ...
                $tableY = $pdf->GetY() + 2;
                $pdf->SetXY($X, $tableY);
                $pdf->MultiCell(22, 135, '', 'LTB', 'L', 0, 0);
                $pdf->MultiCell(97.6, 135, '', 'LTB', 'C', 0, 0);
                $pdf->MultiCell(16, 135, '', 'LTB', 'C', 0, 0);
                $pdf->MultiCell(16, 135, '', 'LTB', 'C', 0, 0);
                $pdf->MultiCell(16, 135, '', 'LTB', 'C', 0, 0);
                $pdf->MultiCell(17.5, 135, '', 'LRTB', 'C', 0, 0);
                $pdf->Ln();
                $BigTable_y = $pdf->GetY() + 1;
                $pdf->SetXY($X, $tableY);
                ...
                $pdf->MultiCell(16, 0, 'Credits<br>Enrolled', 0, 'C', 0, 0, '', '', true, 0, true);
                $pdf->MultiCell(16, 0, 'Credits<br>Earned', 0, 'C', 0, 0, '', '', true, 0, true);
                $pdf->setCellPaddings($left = '', $top = '2', $right = '', $bottom = '');
                $pdf->MultiCell(16, 0, 'Grade', 0, 'C', 0, 0, '', '', true, 0, true);
                $pdf->setCellPaddings($left = '', $top = '0', $right = '', $bottom = '');
                $pdf->MultiCell(18, 0, 'Grade<br>Points', 0, 'C', 0, 0, '', '', true, 0, true);
                $pdf->Ln();
                $pdf->SetXY($X, $pdf->GetY());
                $pdf->MultiCell(185, 0, '', 'T', 'L', 0, 0);
                ...
                for ($s = 0; $s < 17; $s++) {
                    ...
                    $pdf->SetXY(12, $subj_y);
                    $pdf->MultiCell(22, $subjectTableHeight, $Subject_Code, 0, 'R', 0, 0);

                    /* ---------------- SUBJECT NAME ---------------- */
                    $pdf->MultiCell(97, $subjectTableHeight, $Subject_name, 0, 'L', 0, 0);
                    ...
                    $pdf->MultiCell(16, $subjectTableHeight, $Credits_Enrolled, 0, 'C', 0, 0);
                    ...
                    $pdf->MultiCell(16, $subjectTableHeight, $Credits_Earned, 0, 'C', 0, 0);
                    ...
                    $pdf->MultiCell(16, $subjectTableHeight, $Grade, 0, 'C', 0, 0);
                    ...
                    $pdf->MultiCell(16, $subjectTableHeight, $Grade_Points, 0, 'C', 0, 0);
                ...
                $pdf->SetXY(12, $BigTable_y + 8);
                $pdf->setCellPaddings($left = '', $top = '2.5', $right = '', $bottom = '');
                $pdf->SetFont($trebuc, '', 9.5, '', false);
                $pdf->MultiCell(26.5, 10, 'Credits', "LRB", 'C', 0, 0, '', '', true, 0, true);
                ...
                $pdf->MultiCell(30.5, 10, 'SGPA', "B", 'C', 0, 0, '', '', true, 0, true);
                $pdf->setCellPaddings($left = '', $top = '1.3', $right = '', $bottom = '');
                $pdf->SetFont($trebuc, '', 9.5, '', false);
                $pdf->MultiCell(31, 10, 'Total<br> Credits', "LRB", 'C', 0, 0, '', '', true, 0, true);
                ...
                $pdf->SetFont($trebuc, '', 9.5, '', false);
                $pdf->SetTextColor(0, 0, 0);
                $pdf->SetXY(12, $BigTable_y + 18);
                $pdf->setCellPaddings($left = '', $top = '3', $right = '', $bottom = '');

                $pdf->MultiCell(26.5, 12, $TOT_CREDIT_MAX, "LRB", 'C', 0, 0, '', '', true, 0, true);
                $pdf->MultiCell(35.5, 12, $TOT_CREDIT_POINTS, "TBR", 'C', 0, 0, '', '', true, 0, true);
                $pdf->setCellPaddings($left = '', $top = '1.5', $right = '', $bottom = '');
                $pdf->SetFont($trebucb, '', 9.5, '', false);
                $pdf->MultiCell(30.5, 12, $studentData['SGPA'] . '<br>' . $studentData['SGPA _Desc'], "B", 'C', 0, 0, '', '', true, 0, true);

                $pdf->setCellPaddings($left = '', $top = '3', $right = '', $bottom = '');
                $pdf->SetFont($trebuc, '', 9.5, '', false);
                $pdf->MultiCell(31, 12, $grandTotCreditMax, "LTRB", 'C', 0, 0, '', '', true, 0, true);
                $pdf->MultiCell(30.5, 12, $grandTotCreditMaxPoint, "RB", 'C', 0, 0, '', '', true, 0, true);
                $pdf->SetFont($trebucb, '', 9.5, '', false);
                $pdf->setCellPaddings($left = '', $top = '1.5', $right = '', $bottom = '');
                $pdf->MultiCell(31, 12, $studentData['CGPA_'] . '<br>' . $studentData['CGPA_Desc'], "RB", 'C', 0, 0, '', '', true, 0, true);
                $pdf->setCellPaddings($left = '', $top = '0', $right = '', $bottom = '');
                ...
                //left side
                $pdf->SetXY(44, 272);
                $pdf->Cell(0, 0, $studentData['Name1'], 0, false, 'L');
                $pdf->SetXY(44, 275.5);
                $pdf->Cell(0, 0, $studentData['Designation1'], 0, false, 'L');

                $pdf->SetXY(132.5, 272);
                $pdf->Cell(0, 0, $studentData['Name2'], 0, false, 'L');
                $pdf->SetXY(132.5, 275.5);
                $pdf->Cell(0, 0, $studentData['Designation2'], 0, false, 'L');
                ...
                $profile_path_org = public_path() . '\\' . $subdomain[0] . '\backend\templates\100\\' . $studentData['PHOTO'];
                //set profile image   
                $profilex = 170;
                $profiley = 40;
                $profileWidth = 27.18;
                ...
                if ($studentData['Name1'] == "Dr. Sridhar B Reddy") {
                    $sign1 = public_path() . '\\' . $subdomain[0] . '\backend\canvas\images\Dr_Sridhar_Reddy_Signature.png';
                }
                //left side  Brijesh_Kumar_Singh
                elseif ($studentData['Name1'] == "Brijesh Kumar Singh") {
                    $sign1 = public_path() . '\\' . $subdomain[0] . '\backend\canvas\images\Brijesh_Kumar_Singh.png';

                    $sign1_Width = 25;
                    $sign1_Height = 21.5;
                } elseif (strpos($studentData['Name1'], 'Hrishikesh Trivedi') !== FALSE) {
                    $sign1 = public_path() . '\\' . $subdomain[0] . '\backend\canvas\images\Hrishikesh_Trivedi_Sign_new.png';
                } elseif (strpos($studentData['Name1'], 'Jigisha Patel') !== FALSE) {
                    $sign1 = public_path() . '\\' . $subdomain[0] . '\backend\canvas\images\Jigisha_Patel_Sign_new.png';
                } elseif (strpos($studentData['Name1'], 'Jasmine Gohil') !== FALSE) {
                    //if($name3=="Dr. Sridhar B Reddy"){
                    $sign1 = public_path() . '\\' . $subdomain[0] . '\backend\canvas\images\JasmineGohil_new.png';
                } elseif (strpos($studentData['Name1'], 'Suhas Toshniwal') !== FALSE) {
                    $sign1 = public_path() . '\\' . $subdomain[0] . '\backend\canvas\images\Suhas_Toshniwal_Sign_new.png';
                } else if ($studentData['Name1'] == "Sanjay Bhatnagar") {
                    $sign1 = public_path() . '\\' . $subdomain[0] . '\backend\canvas\images\sanjay_new.png';
                    $sign1_Width = 17;
                } elseif (strpos($studentData['Name1'], 'Dr Sanjeev Vidyarthi') !== FALSE) {
                ...
                $dt = date("_ymdHis");
                $str = $GUID . $dt;
                // $codeContents = $studentData['QR_Output']."\n\n".strtoupper(md5($str));
                ...
                $pdfBig->Cell(21, 0, $studentData['QR_Code_No'], 0, false, 'C');

                $pdf->SetFont($graduateR, '', 8, '', false);
                $pdf->SetTextColor(0, 0, 0);
                $pdf->SetXY(12, 275.5);
                $pdf->Cell(21, 0, $studentData['QR_Code_No'], 0, false, 'C');
                ...
                */
                ...
                if ($previewPdf != 1) {
                    ...
                    $mintData = array();
                    $mintData['documentType'] = "Marksheet";
                    $mintData['description'] = " Anant National University";
                    $mintData['metadata1'] = ["label" => "Student ID", "value" => $studentData['REGN_NO']];
                    $mintData['metadata2'] = ["label" => "Student Name", "value" => $studentData['CNAME']];
                    $mintData['metadata3'] = ["label" => "Session", "value" => $studentData['TERM_TYPE']];
                    $mintData['metadata4'] = ["label" => "Programme", "value" => $studentData['COURSE_NAME']];
                    $mintData['metadata5'] = ["label" => "CGPA", "value" => $studentData['CGPA_']];
                    $mintData['metadata6'] = ["label" => "Specialisation", "value" => $studentData['SPECIALIZATION_MAJOR']];
                    if (!empty($studentData['STREAM'])) {
                        $mintData['metadata7'] = ["label" => "Major", "value" => $studentData['STREAM']];
                    }

                    $mintData['uniqueHash'] = $encryptedString;
                    $serial_no = $studentData['Unique_ID'];
        ...
        if ($previewPdf != 1) {
            $this->updateCardNo('anuBTCC', $card_serial_no - $cardDetails->starting_serial_no, $card_serial_no);
        }
        $msg = '';

        $file_name =  str_replace("/", "_", 'anuBTCC' . date("Ymdhms")) . '.pdf';
    ...
    public function convertExcelDate($dateFromExcel)
    {
        if (is_numeric($dateFromExcel)) {
            ...
            try {
                ...
                return Carbon::instance($excelDate)->format('d F Y');
            } catch (\Throwable $th) {
                Log::error("Excel Date Conversion Error: " . $th->getMessage() . " for value: " . $dateFromExcel);
                return null;
            }
        } else {
            // Handle string date formats (including '3 November 2005')
            $formats = [
                'd/m/Y',
                'd-m-Y',
                'd F Y',   // 3 November 2005
                'j F Y'    // 3 November 2005 (without leading zero)
            ];

            foreach ($formats as $format) {
                try {
                    return Carbon::createFromFormat($format, trim($dateFromExcel))->format('d F Y');
                } catch (\Throwable $th) {
                    // try next format
                }
            }

            // Final fallback – let Carbon try automatically
            try {
                return Carbon::parse($dateFromExcel)->format('d F Y');
            } catch (\Throwable $th) {
    ...
    public function convertExcelDateold($dateFromExcel)
    {
        if (is_numeric($dateFromExcel)) {
            ...
            try {
                $excelDate = \PhpOffice\PhpSpreadsheet\Shared\Date::excelToDateTimeObject($dateFromExcel);
                return Carbon::instance($excelDate)->format('d F Y'); // Returns DD-MM-YYYY
            } catch (\Throwable $th) {
                Log::error("Excel Date Conversion Error: " . $th->getMessage() . " for value: " . $dateFromExcel);
                return null;
            }
            ...
            foreach ($formats as $format) {
                try {
                    return Carbon::createFromFormat($format, $dateFromExcel)->format('d F Y');
                } catch (\Throwable $th) {
                    // Try next format
                }
            }

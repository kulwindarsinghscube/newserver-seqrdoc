...
class PdfGenerateChanakyaTranscriptJob
{
       ...
       // $signature_path = public_path().'\\'.$subdomain[0].'\backend\canvas\images\Vice Chancellor.png';
        ...
        if($studentDataOrg&&!empty($studentDataOrg)){
            foreach ($studentDataOrg as $studentData) 
            {
                ...
                $pdfBig->SetXY(168, 11);
                $pdfBig->Cell(0, 0,'No. '. $studentData[7].'/2024-25', 0, false, 'C');
                ...
                //Table's Titles
                $pdfBig->SetXY(17, $pdfBig->GetY());//77.6);
                ...
                $pdfBig->SetFont($arialb, 'B', 10, '', false);  
                $pdfBig->SetXY(11, $title_y);
                $pdfBig->MultiCell($Width, 7, 'Discipline Core', 'TLB', 'C', 0, 0, '', '', true, 0, true);
                $pdfBig->SetXY($pdfBig->GetX(), $title_y);
                $pdfBig->MultiCell($codeCellWidth, 7, 'Code', 'TLB', 'C', 0, 0, '', '', true, 0, true);
                $pdfBig->SetXY($pdfBig->GetX(), $title_y);
                $pdfBig->MultiCell($codeCellWidth, 7, 'Credit', 'TLB', 'C', 0, 0, '', '', true, 0, true);
                $pdfBig->SetXY($pdfBig->GetX(), $title_y);
                $pdfBig->MultiCell($codeCellWidth, 7, 'Grade', 'TLB', 'C', 0, 0, '', '', true, 0, true);
                $pdfBig->SetXY($pdfBig->GetX(), $title_y);
                $pdfBig->MultiCell($codeCellWidth, 7, 'GP', 'TLB', 'C', 0, 0, '', '', true, 0, true);
                $pdfBig->SetXY($pdfBig->GetX(), $title_y);
                $pdfBig->MultiCell($codeCellWidth, 7, 'CP', 'TLRB', 'C', 0, 0, '', '', true, 0, true);
                ...
                foreach($subjects as $term => $term_array){
                    ...
                    $pdfBig->MultiCell($Width, 4,  $term, 'LR', 'C', 0, 0, '', '', true, 0, true); 
                    $pdfBig->SetXY($pdfBig->GetX(),  $sem_heading_y );
                    $pdfBig->MultiCell($codeCellWidth, 4, '', 'LR', 'C', 0, 0, '', '', true, 0, true); 
                    $pdfBig->SetXY($pdfBig->GetX(),  $sem_heading_y );
                    $pdfBig->MultiCell($codeCellWidth, 4, '', 'LR', 'C', 0, 0, '', '', true, 0, true); 
                    $pdfBig->SetXY($pdfBig->GetX(),  $sem_heading_y );
                    $pdfBig->MultiCell($codeCellWidth, 4, '', 'LR', 'C', 0, 0, '', '', true, 0, true); 
                    ...
                    foreach($term_array as $key => $val){
                        ...
                        if($lines>1){
                            $table_content_height1 = 8;
                        }else{
                            $table_content_height1 = $tableHeight;
                        }

                        $borderStyle = 'LT';
                        $pdfBig->setCellPaddings( $left = '', $top = '0.5', $right = '', $bottom = '0.5');
                        $pdfBig->SetXY(11, $subDetY);
                        $pdfBig->SetFont($arial, '', $subj_font_size, '', false); 
                        $pdfBig->MultiCell($Width, $table_content_height1, $val[2], $borderStyle, 'L', 0, 0);
                        $pdfBig->SetXY($pdfBig->GetX(), $subDetY);
                        ...
                        $pdfBig->SetXY($pdfBig->GetX(), $subDetY);
                        $pdfBig->MultiCell($codeCellWidth, $table_content_height1, $val[7], 'LTR', 'C', 0, 0);  
                        $pdfBig->Ln();
                        $subDetY=$pdfBig->GetY();	
                ...
                $value = number_format((float)$studentData[5], 2, '.', '');
                $pdfBig->MultiCell(20, 5,  $value, 'TBR', 'C', 0, 0);
                $pdfBig->Ln();
                $title_y = $pdfBig->GetY();
                if (!empty($additional_courses)) {
                            $pdfBig->SetXY(11, $title_y);
                            $pdfBig->MultiCell(91, 4, '	Additional Courses', 0, 'L', 0, 0, '', '', true, 0, true);
                            $pdfBig->Ln();
                            $title_y = $pdfBig->GetY();
                            ...
                            $pdfBig->SetFont($arialb, 'B', 8, '', false);  
                            $pdfBig->SetXY(11, $title_y);
                            $pdfBig->MultiCell(15, 4, 'Sr No.', 'TL', 'C', 0, 0, '', '', true, 0, true);
                            $pdfBig->SetXY($pdfBig->GetX(), $title_y);
                            $pdfBig->MultiCell(91, 4, '	Course Name', 'TL', 'C', 0, 0, '', '', true, 0, true);
                            $pdfBig->SetXY($pdfBig->GetX(), $title_y);
                            $pdfBig->MultiCell($codeCellWidth, 4, 'Course Code', 'TL', 'C', 0, 0, '', '', true, 0, true);
                            $pdfBig->SetXY($pdfBig->GetX(), $title_y);
                            $pdfBig->MultiCell($codeCellWidth, 4, 'Credit Point', 'TL', 'C', 0, 0, '', '', true, 0, true);
                            $pdfBig->SetXY($pdfBig->GetX(), $title_y);
                            $pdfBig->MultiCell($codeCellWidth, 4, 'Grade Point', 'TL', 'C', 0, 0, '', '', true, 0, true);
                            $pdfBig->SetXY($pdfBig->GetX(), $title_y);
                            $pdfBig->MultiCell($codeCellWidth, 4, 'Grade', 'TLR', 'C', 0, 0, '', '', true, 0, true);
                            $pdfBig->setCellPaddings( $left = '', $top = '0', $right = '', $bottom = '');
                            $pdfBig->Ln();
                        $subDetY = $pdfBig->GetY();
                    // dd($additional_courses);
                    ...
                    $pdfBig->startTransaction();
                    $lines = $pdfBig->MultiCell(91, 4, $val[2], 'LR', 'C', 0, 0, '', '', true, 0, false, true, 0);
                    $pdfBig = $pdfBig->rollbackTransaction();	
                ...
                $pdf->SetXY(168, 11);
                $pdf->Cell(0, 0,'No. '. $studentData[7].'/2024-25', 0, false, 'C');
                ...
                $pdf->SetFont($arialb, 'B', 10, '', false);  
                $pdf->SetXY(11, $title_y);
                $pdf->MultiCell($Width, 7, 'Discipline Core', 'TLB', 'C', 0, 0, '', '', true, 0, true);
                $pdf->SetXY($pdf->GetX(), $title_y);
                $pdf->MultiCell($codeCellWidth, 7, 'Code', 'TLB', 'C', 0, 0, '', '', true, 0, true);
                $pdf->SetXY($pdf->GetX(), $title_y);
                $pdf->MultiCell($codeCellWidth, 7, 'Credit', 'TLB', 'C', 0, 0, '', '', true, 0, true);
                $pdf->SetXY($pdf->GetX(), $title_y);
                $pdf->MultiCell($codeCellWidth, 7, 'Grade', 'TLB', 'C', 0, 0, '', '', true, 0, true);
                $pdf->SetXY($pdf->GetX(), $title_y);
                $pdf->MultiCell($codeCellWidth, 7, 'GP', 'TLB', 'C', 0, 0, '', '', true, 0, true);
                $pdf->SetXY($pdf->GetX(), $title_y);
                $pdf->MultiCell($codeCellWidth, 7, 'CP', 'TLRB', 'C', 0, 0, '', '', true, 0, true);
                ...
                foreach($subjects as $term => $term_array){
                    ...
                    $pdf->MultiCell($Width, 4,  $term, 'LR', 'C', 0, 0, '', '', true, 0, true); 
                    $pdf->SetXY($pdf->GetX(),  $sem_heading_y );
                    $pdf->MultiCell($codeCellWidth, 4, '', 'LR', 'C', 0, 0, '', '', true, 0, true); 
                    $pdf->SetXY($pdf->GetX(),  $sem_heading_y );
                    $pdf->MultiCell($codeCellWidth, 4, '', 'LR', 'C', 0, 0, '', '', true, 0, true); 
                    $pdf->SetXY($pdf->GetX(),  $sem_heading_y );
                    $pdf->MultiCell($codeCellWidth, 4, '', 'LR', 'C', 0, 0, '', '', true, 0, true); 
                    ...
                    foreach($term_array as $key => $val){
                        ...
                        $pdf->SetXY($pdf->GetX(), $subDetY);
                        $pdf->MultiCell($codeCellWidth, $table_content_height1, $val[7], 'LTR', 'C', 0, 0);  
                        $pdf->Ln();
                        $subDetY=$pdf->GetY(); 
                ...
                $pdf->MultiCell(146, 5, 'Credit points secured in all subject /Total credit of all semisters : '.$studentData[6], 1, 'L', 0, 0);
                  $value = number_format((float)$studentData[5], 2, '.', '');
                $pdf->MultiCell(20, 5,  $value, 'TBR', 'C', 0, 0);
                $pdf->Ln();
                $title_y = $pdf->GetY();
                if (!empty($additional_courses)) {
                            $pdf->SetXY(11, $title_y);
                            $pdf->MultiCell(91, 4, ' Additional Courses', 0, 'L', 0, 0, '', '', true, 0, true);
                            $pdf->Ln();
                            $title_y = $pdf->GetY();
                            ...
                            $pdf->SetFont($arialb, 'B', 8, '', false);  
                            $pdf->SetXY(11, $title_y);
                            $pdf->MultiCell(15, 4, 'Sr No.', 'TL', 'C', 0, 0, '', '', true, 0, true);
                            $pdf->SetXY($pdf->GetX(), $title_y);
                            $pdf->MultiCell(91, 4, ' Course Name', 'TL', 'C', 0, 0, '', '', true, 0, true);
                            $pdf->SetXY($pdf->GetX(), $title_y);
                            $pdf->MultiCell($codeCellWidth, 4, 'Course Code', 'TL', 'C', 0, 0, '', '', true, 0, true);
                            $pdf->SetXY($pdf->GetX(), $title_y);
                            $pdf->MultiCell($codeCellWidth, 4, 'Credit Point', 'TL', 'C', 0, 0, '', '', true, 0, true);
                            $pdf->SetXY($pdf->GetX(), $title_y);
                            $pdf->MultiCell($codeCellWidth, 4, 'Grade Point', 'TL', 'C', 0, 0, '', '', true, 0, true);
                            $pdf->SetXY($pdf->GetX(), $title_y);
                            $pdf->MultiCell($codeCellWidth, 4, 'Grade', 'TLR', 'C', 0, 0, '', '', true, 0, true);
                            $pdf->setCellPaddings( $left = '', $top = '0', $right = '', $bottom = '');
                            $pdf->Ln();
                        $subDetY = $pdf->GetY();
                    // dd($additional_courses);
                    ...
                    $pdf->startTransaction();
                    $lines = $pdf->MultiCell(91, 4, $val[2], 'LR', 'C', 0, 0, '', '', true, 0, false, true, 0);
                    $pdf = $pdf->rollbackTransaction(); 
                    $table_content_height1 = ($lines > 1) ? 8 : $tableHeight;

        ...
        if($studentDataOrg&&!empty($studentDataOrg)){
            foreach ($studentDataOrg as $studentData) {
                ...
                */
                ...
                $session2 = $studentData[163];
                //$IssueDate = $studentData[164];
                $date_of_issue = $studentData[165];
                ...
                $pdf->SetXY(13, 232);          
                $pdf->MultiCell(35, 4, "Max. Marks:", 0, 'L', 0, 0);
                ...
                $pdf->MultiCell(22, 8.2, "Year", 1, 'C', 0, 0);
                $pdf->setCellPaddings( $left = '', $top = '0', $right = '', $bottom = '');
                $pdf->MultiCell(32, 4, "1st Year",1, 'C', 0, 0);
                $pdf->MultiCell(32, 4, "2nd Year", 1, 'C', 0, 0);     
                $pdf->MultiCell(32, 4, "Total", 1, 'C', 0, 0);     
                $pdf->MultiCell(32, 4, "Percentage", 1, 'C', 0, 0);
                $pdf->MultiCell(34, 4, "Division", 1, 'C', 0, 0);
                $pdf->SetXY(13, 241.2);    
                $pdf->SetFont($arial, '', 8, '', false);    
                $pdf->SetFillColor(255, 255, 255);
                $pdf->SetTextColor(0, 0, 0);  
                $pdf->MultiCell(22, 4, "", 0, 'C', 0, 0);
                $pdf->MultiCell(16, 4, "In Theory","LRB", 'C', 0, 0);
                $pdf->MultiCell(16, 4, "In Practical", "LRB", 'C', 0, 0);     
                $pdf->MultiCell(16, 4, "In Theory", "LRB", 'C', 0, 0);     
                $pdf->MultiCell(16, 4, "In Practical", "LRB", 'C', 0, 0);
                $pdf->MultiCell(16, 4, "In Theory", "LRB", 'C', 0, 0);
                $pdf->MultiCell(16, 4, "In Practical", "LRB", 'C', 0, 0);
                $pdf->MultiCell(16, 4, "In Theory", "LRB", 'C', 0, 0);
                $pdf->MultiCell(16, 4, "In Practical", "LRB", 'C', 0, 0);
                $pdf->MultiCell(17, 4, "In Theory", "LRB", 'C', 0, 0);
                $pdf->MultiCell(17, 4, "In Practical", "LRB", 'C', 0, 0);
                $pdf->SetXY(13, 245);    
                $pdf->SetFont($arial, '', 8, '', false);    
                $pdf->SetFillColor(255, 255, 255);
                $pdf->SetTextColor(0, 0, 0); 
                $pdf->MultiCell(22, 4, "Max. Marks", "LRB", 'L', 0, 0);
                $pdf->SetFont($arial, '', 8, '', false);
                $pdf->MultiCell(16, 4, $studentData[145],"LRB", 'C', 0, 0);
                $pdf->MultiCell(16, 4, $studentData[147], "LRB", 'C', 0, 0);     
                $pdf->MultiCell(16, 4, $studentData[150], "LRB", 'C', 0, 0);     
                $pdf->MultiCell(16, 4, $studentData[152], "LRB", 'C', 0, 0);
                $pdf->MultiCell(16, 4, $studentData[155], "LRB", 'C', 0, 0);
                $pdf->MultiCell(16, 4, $studentData[157], "LRB", 'C', 0, 0);
                $pdf->setCellPaddings( $left = '', $top = '4', $right = '', $bottom = '');        
                //$pdf->MultiCell(16, 12, $studentData[159], "LRB", 'C', 0, 0); // Percentage In Theory 
                //$pdf->MultiCell(16, 12, $studentData[160], "LRB", 'C', 0, 0); // Percentage In Practical
                $pdf->MultiCell(16, 12, number_format((float)$studentData[159], 2, '.', ''), "LRB", 'C', 0, 0); // Percentage In Theory 
                $pdf->MultiCell(16, 12, number_format((float)$studentData[160], 2, '.', ''), "LRB", 'C', 0, 0); // Percentage In Practical        
                $pdf->MultiCell(17, 12, $studentData[161], "LRB", 'C', 0, 0); // Division In Theory
                $pdf->MultiCell(17, 12, $studentData[162], "LRB", 'C', 0, 0); // Division In Practical
                ...
                $pdf->SetFillColor(255, 255, 255);
                $pdf->SetTextColor(0, 0, 0);  
                $pdf->MultiCell(22, 4, "Marks Obtained", "LRB", 'L', 0, 0);
                $pdf->SetFont($arial, '', 8, '', false);
                $pdf->MultiCell(16, 4, $studentData[146],"LRB", 'C', 0, 0);
                $pdf->MultiCell(16, 4, $studentData[148], "LRB", 'C', 0, 0);     
                $pdf->MultiCell(16, 4, $studentData[151], "LRB", 'C', 0, 0);     
                $pdf->MultiCell(16, 4, $studentData[153], "LRB", 'C', 0, 0);
                $pdf->MultiCell(16, 4, $studentData[156], "LRB", 'C', 0, 0);
                $pdf->MultiCell(16, 4, $studentData[158], "LRB", 'C', 0, 0);
                $pdf->SetXY(13, 253);    
                $pdf->SetFont($arial, '', 8, '', false);    
                $pdf->SetFillColor(255, 255, 255);
                $pdf->SetTextColor(0, 0, 0); 
                $pdf->MultiCell(22, 4, "Academic Year", "LRB", 'L', 0, 0);
                $pdf->SetFont($arial, '', 8, '', false); 
                $pdf->MultiCell(32, 4, $studentData[149],"LRB", 'C', 0, 0);
                $pdf->MultiCell(32, 4, $studentData[154], "LRB", 'C', 0, 0);     
                $pdf->MultiCell(32, 4, "NA", "LRB", 'C', 0, 0); 
                ...
                $pdfBig->MultiCell(22, 8.2, "Year", 1, 'C', 0, 0);
                $pdfBig->setCellPaddings( $left = '', $top = '0', $right = '', $bottom = '');
                $pdfBig->MultiCell(32, 4, "1st Year",1, 'C', 0, 0);
                $pdfBig->MultiCell(32, 4, "2nd Year", 1, 'C', 0, 0);     
                $pdfBig->MultiCell(32, 4, "Total", 1, 'C', 0, 0);     
                $pdfBig->MultiCell(32, 4, "Percentage", 1, 'C', 0, 0);
                $pdfBig->MultiCell(34, 4, "Division", 1, 'C', 0, 0);
                $pdfBig->SetXY(13, 241.2);    
                $pdfBig->SetFont($arial, '', 8, '', false);    
                $pdfBig->SetFillColor(255, 255, 255);
                $pdfBig->SetTextColor(0, 0, 0);  
                $pdfBig->MultiCell(22, 4, "", 0, 'C', 0, 0);
                $pdfBig->MultiCell(16, 4, "In Theory","LRB", 'C', 0, 0);
                $pdfBig->MultiCell(16, 4, "In Practical", "LRB", 'C', 0, 0);     
                $pdfBig->MultiCell(16, 4, "In Theory", "LRB", 'C', 0, 0);     
                $pdfBig->MultiCell(16, 4, "In Practical", "LRB", 'C', 0, 0);
                $pdfBig->MultiCell(16, 4, "In Theory", "LRB", 'C', 0, 0);
                $pdfBig->MultiCell(16, 4, "In Practical", "LRB", 'C', 0, 0);
                $pdfBig->MultiCell(16, 4, "In Theory", "LRB", 'C', 0, 0);
                $pdfBig->MultiCell(16, 4, "In Practical", "LRB", 'C', 0, 0);
                $pdfBig->MultiCell(17, 4, "In Theory", "LRB", 'C', 0, 0);
                $pdfBig->MultiCell(17, 4, "In Practical", "LRB", 'C', 0, 0);
                $pdfBig->SetXY(13, 245);    
                $pdfBig->SetFont($arial, '', 8, '', false);    
                $pdfBig->SetFillColor(255, 255, 255);
                $pdfBig->SetTextColor(0, 0, 0); 
                $pdfBig->MultiCell(22, 4, "Max. Marks", "LRB", 'L', 0, 0);
                $pdfBig->SetFont($arial, '', 8, '', false);
                $pdfBig->MultiCell(16, 4, $studentData[145],"LRB", 'C', 0, 0);
                $pdfBig->MultiCell(16, 4, $studentData[147], "LRB", 'C', 0, 0);     
                $pdfBig->MultiCell(16, 4, $studentData[150], "LRB", 'C', 0, 0);     
                $pdfBig->MultiCell(16, 4, $studentData[152], "LRB", 'C', 0, 0);
                $pdfBig->MultiCell(16, 4, $studentData[155], "LRB", 'C', 0, 0);
                $pdfBig->MultiCell(16, 4, $studentData[157], "LRB", 'C', 0, 0);
                $pdfBig->setCellPaddings( $left = '', $top = '4', $right = '', $bottom = '');
                //$pdfBig->MultiCell(16, 12, $studentData[159], "LRB", 'C', 0, 0); // Percentage In Theory
                //$pdfBig->MultiCell(16, 12, $studentData[160], "LRB", 'C', 0, 0); // Percentage In Practical
                $pdfBig->MultiCell(16, 12, number_format((float)$studentData[159], 2, '.', ''), "LRB", 'C', 0, 0); // Percentage In Theory 
                $pdfBig->MultiCell(16, 12, number_format((float)$studentData[160], 2, '.', ''), "LRB", 'C', 0, 0); // Percentage In Practical    
                $pdfBig->MultiCell(17, 12, $studentData[161], "LRB", 'C', 0, 0); // Division In Theory
                $pdfBig->MultiCell(17, 12, $studentData[162], "LRB", 'C', 0, 0); // Division In Practical
                ...
                $pdfBig->SetFillColor(255, 255, 255);
                $pdfBig->SetTextColor(0, 0, 0);  
                $pdfBig->MultiCell(22, 4, "Marks Obtained", "LRB", 'L', 0, 0);
                $pdfBig->SetFont($arial, '', 8, '', false);
                $pdfBig->MultiCell(16, 4, $studentData[146],"LRB", 'C', 0, 0);
                $pdfBig->MultiCell(16, 4, $studentData[148], "LRB", 'C', 0, 0);     
                $pdfBig->MultiCell(16, 4, $studentData[151], "LRB", 'C', 0, 0);     
                $pdfBig->MultiCell(16, 4, $studentData[153], "LRB", 'C', 0, 0);
                $pdfBig->MultiCell(16, 4, $studentData[156], "LRB", 'C', 0, 0);
                $pdfBig->MultiCell(16, 4, $studentData[158], "LRB", 'C', 0, 0);
                $pdfBig->SetXY(13, 253);    
                $pdfBig->SetFont($arial, '', 8, '', false);    
                $pdfBig->SetFillColor(255, 255, 255);
                $pdfBig->SetTextColor(0, 0, 0); 
                $pdfBig->MultiCell(22, 4, "Academic Year", "LRB", 'L', 0, 0);
                $pdfBig->SetFont($arial, '', 8, '', false); 
                $pdfBig->MultiCell(32, 4, $studentData[149],"LRB", 'C', 0, 0);
                $pdfBig->MultiCell(32, 4, $studentData[154], "LRB", 'C', 0, 0);     
                $pdfBig->MultiCell(32, 4, "NA", "LRB", 'C', 0, 0);  

        ...
        if($studentDataOrg&&!empty($studentDataOrg)){  
            foreach ($studentDataOrg as $studentData) {
                ...
                */
                ...
                $session2 = $studentData[173];
                //$IssueDate = $studentData[164];
                $date_of_issue = $studentData[175];
                ...
                $subjectsArr=array_chunk($subjectData, 12); //fields of one subject
                //print_r($subjectsArr);
                ...
                $pdf->MultiCell(40, 4, $studentData[140]." (In Theory)",0, 'L', 0, 0);
                $pdf->MultiCell(40, 4, $studentData[141]." (In Practical)", 0, 'L', 0, 0);     
                $pdf->MultiCell(35, 4, "", 0, 'L', 0, 0);     
                $pdf->MultiCell(34, 4, $studentData[144]." (In Theory)", 0, 'L', 0, 0);
                $pdf->SetXY(13, 232);          
                $pdf->MultiCell(31, 4, "Max. Marks", 0, 'L', 0, 0);
                $pdf->MultiCell(4, 4, ":", 0, 'L', 0, 0);
                $pdf->MultiCell(40, 4, $studentData[142]." (In Theory)",0, 'L', 0, 0);
                $pdf->MultiCell(40, 4, $studentData[143]." (In Practical)", 0, 'L', 0, 0);     
                $pdf->MultiCell(35, 4, "", 0, 'L', 0, 0);     
                $pdf->MultiCell(34, 4, $studentData[144]." (In Practical)", 0, 'L', 0, 0);
                $pdf->SetXY(13, 229.5);          
                ...
                $pdfBig->MultiCell(40, 4, $studentData[140]." (In Theory)",0, 'L', 0, 0);
                $pdfBig->MultiCell(40, 4, $studentData[141]." (In Practical)", 0, 'L', 0, 0);     
                $pdfBig->MultiCell(35, 4, "", 0, 'L', 0, 0);     
                $pdfBig->MultiCell(34, 4, $studentData[144]." (In Theory)", 0, 'L', 0, 0);
                $pdfBig->SetXY(13, 232);          
                $pdfBig->MultiCell(31, 4, "Max. Marks", 0, 'L', 0, 0);
                $pdfBig->MultiCell(4, 4, ":", 0, 'L', 0, 0);
                $pdfBig->MultiCell(40, 4, $studentData[142]." (In Theory)",0, 'L', 0, 0);
                $pdfBig->MultiCell(40, 4, $studentData[143]." (In Practical)", 0, 'L', 0, 0);     
                $pdfBig->MultiCell(35, 4, "", 0, 'L', 0, 0);     
                $pdfBig->MultiCell(34, 4, $studentData[144]." (In Practical)", 0, 'L', 0, 0);
                ...
                $pdf->MultiCell(16, 8.2, "Year", 1, 'C', 0, 0);
                $pdf->setCellPaddings( $left = '', $top = '0', $right = '', $bottom = '');
                $pdf->MultiCell(24, 4, "1st Year",1, 'C', 0, 0);
                $pdf->MultiCell(24, 4, "2nd Year", 1, 'C', 0, 0);   
                $pdf->MultiCell(24, 4, "3rd Year",1, 'C', 0, 0);
                $pdf->MultiCell(24, 4, "4th Year", 1, 'C', 0, 0);     
                $pdf->MultiCell(24, 4, "Total", 1, 'C', 0, 0);     
                $pdf->MultiCell(24, 4, "Percentage", 1, 'C', 0, 0);
                $pdf->MultiCell(24, 4, "Division", 1, 'C', 0, 0);
                $pdf->SetXY(13, 240.7);    
                $pdf->SetFont($arial, '', 6, '', false);    
                $pdf->SetFillColor(255, 255, 255);
                $pdf->SetTextColor(0, 0, 0);  
                $pdf->setCellPaddings( $left = '', $top = '0.5', $right = '', $bottom = '');
                $pdf->MultiCell(16, 4, "", 0, 'C', 0, 0);
                $pdf->MultiCell(12, 4, "Theory","LRB", 'C', 0, 0);
                $pdf->MultiCell(12, 4, "Practical", "LRB", 'C', 0, 0);     
                $pdf->MultiCell(12, 4, "Theory", "LRB", 'C', 0, 0);     
                $pdf->MultiCell(12, 4, "Practical", "LRB", 'C', 0, 0);
                $pdf->MultiCell(12, 4, "Theory","LRB", 'C', 0, 0);
                $pdf->MultiCell(12, 4, "Practical", "LRB", 'C', 0, 0);     
                ...
                $pdf->SetTextColor(0, 0, 0);
                $pdf->setCellPaddings( $left = '', $top = '0.5', $right = '', $bottom = '');
                $pdf->MultiCell(16, 4, "Max. Marks", "LRB", 'L', 0, 0);
                $pdf->SetFont($arial, '', 6, '', false);
                $pdf->MultiCell(12, 4, $studentData[145],"LRB", 'C', 0, 0);
                $pdf->MultiCell(12, 4, $studentData[147], "LRB", 'C', 0, 0);     
                $pdf->MultiCell(12, 4, $studentData[150], "LRB", 'C', 0, 0);     
                $pdf->MultiCell(12, 4, $studentData[152], "LRB", 'C', 0, 0);
                $pdf->MultiCell(12, 4, $studentData[155],"LRB", 'C', 0, 0);
                $pdf->MultiCell(12, 4, $studentData[157], "LRB", 'C', 0, 0);     
                $pdf->MultiCell(12, 4, $studentData[160], "LRB", 'C', 0, 0);     
                $pdf->MultiCell(12, 4, $studentData[162], "LRB", 'C', 0, 0);
                $pdf->MultiCell(12, 4, $studentData[165], "LRB", 'C', 0, 0);
                $pdf->MultiCell(12, 4, $studentData[167], "LRB", 'C', 0, 0);
                $pdf->setCellPaddings( $left = '', $top = '6', $right = '', $bottom = '');
                //$pdf->MultiCell(12, 12, $studentData[159], "LRB", 'C', 0, 0); // Percentage In Theory
                //$pdf->MultiCell(12, 12, $studentData[120], "LRB", 'C', 0, 0); // Percentage In Practical
                $pdf->MultiCell(12, 11.9, number_format((float)$studentData[169], 2, '.', ''), "LRB", 'C', 0, 0); // Percentage In Theory 
                $pdf->MultiCell(12, 11.9, number_format((float)$studentData[170], 2, '.', ''), "LRB", 'C', 0, 0); // Percentage In Practical    
                $pdf->MultiCell(12, 11.9, $studentData[171], "LRB", 'C', 0, 0); // Division In Theory
                $pdf->MultiCell(12, 11.9, $studentData[172], "LRB", 'C', 0, 0); // Division In Practical
                ...
                $pdf->SetFillColor(255, 255, 255);
                $pdf->SetTextColor(0, 0, 0);  
                $pdf->MultiCell(16, 4, "Marks Obt.", "LRB", 'L', 0, 0);
                $pdf->SetFont($arial, '', 6, '', false);
                // $pdf->setCellPaddings( $left = '', $top = '1.5', $right = '', $bottom = '');
                $pdf->MultiCell(12, 4, $studentData[146],"LRB", 'C', 0, 0);
                $pdf->MultiCell(12, 4, $studentData[148], "LRB", 'C', 0, 0);     
                $pdf->MultiCell(12, 4, $studentData[151], "LRB", 'C', 0, 0);     
                $pdf->MultiCell(12, 4, $studentData[153], "LRB", 'C', 0, 0);
                $pdf->MultiCell(12, 4, $studentData[156],"LRB", 'C', 0, 0);
                $pdf->MultiCell(12, 4, $studentData[158], "LRB", 'C', 0, 0);     
                $pdf->MultiCell(12, 4, $studentData[161], "LRB", 'C', 0, 0);     
                $pdf->MultiCell(12, 4, $studentData[163], "LRB", 'C', 0, 0);
                $pdf->MultiCell(12, 4, $studentData[166], "LRB", 'C', 0, 0);
                $pdf->MultiCell(12, 4, $studentData[168], "LRB", 'C', 0, 0);
                $pdf->SetXY(13, 252.5);    
                $pdf->SetFont($arial, '', 6, '', false);    
                $pdf->SetFillColor(255, 255, 255);
                $pdf->SetTextColor(0, 0, 0);
                // $pdf->setCellPaddings( $left = '', $top = '.', $right = '', $bottom = '');
                $pdf->MultiCell(16, 4, "Acad. Year", "LRB", 'L', 0, 0);
                $pdf->SetFont($arial, '', 6, '', false); 
                // $pdf->setCellPaddings( $left = '', $top = '1.5', $right = '', $bottom = '');
                $pdf->MultiCell(24, 4, $studentData[149],"LRB", 'C', 0, 0);
                $pdf->MultiCell(24, 4, $studentData[154], "LRB", 'C', 0, 0);
                $pdf->MultiCell(24, 4, $studentData[159],"LRB", 'C', 0, 0);
                $pdf->MultiCell(24, 4, $studentData[164], "LRB", 'C', 0, 0);     
                $pdf->MultiCell(24, 4, "NA", "LRB", 'C', 0, 0);  
                ...
                // $pdf->SetFont($arialb, '', 10, '', false);
                // $pdf->SetXY(13, 257);          
                // $pdf->MultiCell(35, 4, "Issue Date", 0, 'L', 0, 0);
                ...
                $pdfBig->MultiCell(16, 8.2, "Year", 1, 'C', 0, 0);
                $pdfBig->setCellPaddings( $left = '', $top = '0', $right = '', $bottom = '');
                $pdfBig->MultiCell(24, 4, "1st Year",1, 'C', 0, 0);
                $pdfBig->MultiCell(24, 4, "2nd Year", 1, 'C', 0, 0);   
                $pdfBig->MultiCell(24, 4, "3rd Year",1, 'C', 0, 0);
                $pdfBig->MultiCell(24, 4, "4th Year", 1, 'C', 0, 0);     
                $pdfBig->MultiCell(24, 4, "Total", 1, 'C', 0, 0);     
                $pdfBig->MultiCell(24, 4, "Percentage", 1, 'C', 0, 0);
                $pdfBig->MultiCell(24, 4, "Division", 1, 'C', 0, 0);
                $pdfBig->SetXY(13, 240.7);    
                $pdfBig->SetFont($arial, '', 6, '', false);    
                $pdfBig->SetFillColor(255, 255, 255);
                $pdfBig->SetTextColor(0, 0, 0);  
                $pdfBig->setCellPaddings( $left = '', $top = '0.5', $right = '', $bottom = '');
                $pdfBig->MultiCell(16, 4, "", 0, 'C', 0, 0);
                $pdfBig->MultiCell(12, 4, "Theory","LRB", 'C', 0, 0);
                $pdfBig->MultiCell(12, 4, "Practical", "LRB", 'C', 0, 0);     
                $pdfBig->MultiCell(12, 4, "Theory", "LRB", 'C', 0, 0);     
                $pdfBig->MultiCell(12, 4, "Practical", "LRB", 'C', 0, 0);
                $pdfBig->MultiCell(12, 4, "Theory","LRB", 'C', 0, 0);
                $pdfBig->MultiCell(12, 4, "Practical", "LRB", 'C', 0, 0);     
                ...
                $pdfBig->MultiCell(12, 4, "Theory", "LRB", 'C', 0, 0);
                $pdfBig->MultiCell(12, 4, "Practical", "LRB", 'C', 0, 0);
                $pdfBig->SetXY(13, 244.6);    
                $pdfBig->SetFont($arial, '', 6, '', false);    
                $pdfBig->SetFillColor(255, 255, 255);
                $pdfBig->SetTextColor(0, 0, 0);
                $pdfBig->setCellPaddings( $left = '', $top = '0.5', $right = '', $bottom = '');
                $pdfBig->MultiCell(16, 4, "Max. Marks", "LRB", 'L', 0, 0);
                $pdfBig->SetFont($arial, '', 6, '', false);
                $pdfBig->MultiCell(12, 4, $studentData[145],"LRB", 'C', 0, 0);
                $pdfBig->MultiCell(12, 4, $studentData[147], "LRB", 'C', 0, 0);     
                $pdfBig->MultiCell(12, 4, $studentData[150], "LRB", 'C', 0, 0);     
                $pdfBig->MultiCell(12, 4, $studentData[152], "LRB", 'C', 0, 0);
                $pdfBig->MultiCell(12, 4, $studentData[155],"LRB", 'C', 0, 0);
                $pdfBig->MultiCell(12, 4, $studentData[157], "LRB", 'C', 0, 0);     
                $pdfBig->MultiCell(12, 4, $studentData[160], "LRB", 'C', 0, 0);     
                $pdfBig->MultiCell(12, 4, $studentData[162], "LRB", 'C', 0, 0);
                $pdfBig->MultiCell(12, 4, $studentData[165], "LRB", 'C', 0, 0);
                $pdfBig->MultiCell(12, 4, $studentData[167], "LRB", 'C', 0, 0);
                $pdfBig->setCellPaddings( $left = '', $top = '6', $right = '', $bottom = '');
                //$pdfBig->MultiCell(12, 12, $studentData[159], "LRB", 'C', 0, 0); // Percentage In Theory
                //$pdfBig->MultiCell(12, 12, $studentData[120], "LRB", 'C', 0, 0); // Percentage In Practical
                $pdfBig->MultiCell(12, 11.9, number_format((float)$studentData[169], 2, '.', ''), "LRB", 'C', 0, 0); // Percentage In Theory 
                $pdfBig->MultiCell(12, 11.9, number_format((float)$studentData[170], 2, '.', ''), "LRB", 'C', 0, 0); // Percentage In Practical    
                $pdfBig->MultiCell(12, 11.9, $studentData[171], "LRB", 'C', 0, 0); // Division In Theory
                $pdfBig->MultiCell(12, 11.9, $studentData[172], "LRB", 'C', 0, 0); // Division In Practical
                
                $pdfBig->setCellPaddings( $left = '', $top = '0.5', $right = '', $bottom = '');
                $pdfBig->SetXY(13, 248.6);    
                $pdfBig->SetFont($arial, '', 6, '', false);    
                $pdfBig->SetFillColor(255, 255, 255);
                $pdfBig->SetTextColor(0, 0, 0);  
                $pdfBig->MultiCell(16, 4, "Marks Obt.", "LRB", 'L', 0, 0);
                $pdfBig->SetFont($arial, '', 6, '', false);
                // $pdfBig->setCellPaddings( $left = '', $top = '1.5', $right = '', $bottom = '');
                $pdfBig->MultiCell(12, 4, $studentData[146],"LRB", 'C', 0, 0);
                $pdfBig->MultiCell(12, 4, $studentData[148], "LRB", 'C', 0, 0);     
                $pdfBig->MultiCell(12, 4, $studentData[151], "LRB", 'C', 0, 0);     
                $pdfBig->MultiCell(12, 4, $studentData[153], "LRB", 'C', 0, 0);
                $pdfBig->MultiCell(12, 4, $studentData[156],"LRB", 'C', 0, 0);
                $pdfBig->MultiCell(12, 4, $studentData[158], "LRB", 'C', 0, 0);     
                $pdfBig->MultiCell(12, 4, $studentData[161], "LRB", 'C', 0, 0);     
                $pdfBig->MultiCell(12, 4, $studentData[163], "LRB", 'C', 0, 0);
                $pdfBig->MultiCell(12, 4, $studentData[166], "LRB", 'C', 0, 0);
                $pdfBig->MultiCell(12, 4, $studentData[168], "LRB", 'C', 0, 0);
                $pdfBig->SetXY(13, 252.5);    
                $pdfBig->SetFont($arial, '', 6, '', false);    
                $pdfBig->SetFillColor(255, 255, 255);
                $pdfBig->SetTextColor(0, 0, 0);
                // $pdfBig->setCellPaddings( $left = '', $top = '.', $right = '', $bottom = '');
                $pdfBig->MultiCell(16, 4, "Acad. Year", "LRB", 'L', 0, 0);
                $pdfBig->SetFont($arial, '', 6, '', false); 
                // $pdfBig->setCellPaddings( $left = '', $top = '1.5', $right = '', $bottom = '');
                $pdfBig->MultiCell(24, 4, $studentData[149],"LRB", 'C', 0, 0);
                $pdfBig->MultiCell(24, 4, $studentData[154], "LRB", 'C', 0, 0);
                $pdfBig->MultiCell(24, 4, $studentData[159],"LRB", 'C', 0, 0);
                $pdfBig->MultiCell(24, 4, $studentData[164], "LRB", 'C', 0, 0);     
                $pdfBig->MultiCell(24, 4, "NA", "LRB", 'C', 0, 0);  

                $pdfBig->setCellPaddings( $left = '', $top = '0', $right = '', $bottom = '');
                $pdfBig->SetFont($arialb, '', 9, '', false);
                $pdfBig->SetXY(13, 257.5);          

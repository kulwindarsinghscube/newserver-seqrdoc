       ...
       // $signature_path = public_path().'\\'.$subdomain[0].'\backend\canvas\images\Vice Chancellor.png';
        ...
        foreach ($studentDataOrg as $studentData) 
        {
           ...
           // $template_img_generate = public_path().'\\'.$subdomain[0].'\backend\canvas\bg_images\chanakya_convocation.jpg';
            ...
            $x = 24;
            $y = 41;
            $pdfBig->SetFont($ariali, '', 12, '', false);
            $pdfBig->SetXY($x, $y);
            $pdfBig->Cell(0, 0, $studentData[8], 0, false, 'L');
            $pdfBig->SetXY(254, $y);
            $pdfBig->Cell(0, 0, $studentData[1], 0, false, 'L');

            $pdf->SetFont($ariali, '', 12, '', false);
            $pdf->SetXY($x, $y);
            $pdf->Cell(0, 0, $studentData[8], 0, false, 'L');
            $pdf->SetXY(255, $y);
            $pdf->Cell(0, 0, $studentData[1], 0, false, 'L');

            $x = 0;
            $y = 75;
            $pdfBig->SetFont($times, '', 18, '', false);
            $pdfBig->SetXY($x, $y);
            $pdfBig->Cell(0, 0, "This is certify that ".$studentData[2]." has been", 0, false, 'C');
            $pdfBig->SetXY($x, $y+10);
            $pdfBig->Cell(0, 0, "awarded the degree of ".$studentData[3]." at the annual convocation", 0, false, 'C');
            $pdfBig->SetXY($x, $y+20);
            $pdfBig->Cell(0, 0, "held on ".$studentData[4]." day of ".$studentData[5]." month in the year ".$studentData[6].".", 0, false, 'C');
            $pdfBig->SetXY($x, $y+30);
            $pdfBig->Cell(0, 0, "on being certified as eligible by the competent authority on the", 0, false, 'C');
            $pdfBig->SetXY($x, $y+40);
            $pdfBig->Cell(0, 0, "successful qualification with ".$studentData[7]." grade.", 0, false, 'C');
            $pdfBig->SetXY($x, $y+65);
            $pdfBig->Cell(0, 0, "Issued under the seal of the University", 0, false, 'C');


            $pdf->SetFont($times, '', 18, '', false);
            $pdf->SetXY($x, $y);
            $pdf->Cell(0, 0, "This is certify that ".$studentData[2]." has been", 0, false, 'C');
            $pdf->SetXY($x, $y+10);
            $pdf->Cell(0, 0, "awarded the degree of ".$studentData[3]." at the annual convocation", 0, false, 'C');
            $pdf->SetXY($x, $y+20);
            $pdf->Cell(0, 0, "held on ".$studentData[4]." day of ".$studentData[5]." month in the year ".$studentData[6].".", 0, false, 'C');
            $pdf->SetXY($x, $y+30);
            $pdf->Cell(0, 0, "on being certified as eligible by the competent authority on the", 0, false, 'C');
            $pdf->SetXY($x, $y+40);
            $pdf->Cell(0, 0, "successful qualification with ".$studentData[7]." grade.", 0, false, 'C');
            $pdf->SetXY($x, $y+65);
            $pdf->Cell(0, 0, "Issued under the seal of the University", 0, false, 'C');

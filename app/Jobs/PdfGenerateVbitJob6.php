...
class PdfGenerateVbitJob6
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
            ...
            $pdfBig->SetXY(14, 85.5);     
            $pdfBig->MultiCell(182.5, 2, '','T', 'L', 0, 0);
			
			//1st Sem            
            $pdfBig->SetXY(14, 94);   
            $pdfBig->MultiCell(8, 25, '','LRTB', 'L', 0, 0);
            $pdfBig->MultiCell(119, 25, '', 'LRTB', 'C', 0, 0);
            $pdfBig->MultiCell(18, 25, '', 'LRTB', 'C', 0, 0);
            $pdfBig->MultiCell(18, 25, '', 'LRTB', 'C', 0, 0);
            $pdfBig->MultiCell(19.5, 25, '', 'LRTB', 'C', 0, 0);            
            	
            //2nd Sem            
            $pdfBig->SetXY(14, 127.5);   
            $pdfBig->MultiCell(8, 25, '','LRTB', 'L', 0, 0);
            $pdfBig->MultiCell(119, 25, '', 'LRTB', 'C', 0, 0);
            $pdfBig->MultiCell(18, 25, '', 'LRTB', 'C', 0, 0);
            $pdfBig->MultiCell(18, 25, '', 'LRTB', 'C', 0, 0);
            ...
            $pdfBig->SetXY(94, 89);
			$pdfBig->Cell(0, 0, 'III-I SEMESTER', 0, false, 'L');
			$pdfBig->SetXY(94, 122);
			$pdfBig->Cell(0, 0, 'III-II SEMESTER', 0, false, 'L');
			$pdfBig->SetXY(94, 155);
			$pdfBig->Cell(0, 0, 'IV-I SEMESTER', 0, false, 'L');
			$pdfBig->SetXY(94, 188);
			$pdfBig->Cell(0, 0, 'IV-II SEMESTER', 0, false, 'L');
			...
			//1st Sem            
            $pdf->SetXY(14, 94);   
            $pdf->MultiCell(8, 25, '','LRTB', 'L', 0, 0);
            $pdf->MultiCell(119, 25, '', 'LRTB', 'C', 0, 0);
            $pdf->MultiCell(18, 25, '', 'LRTB', 'C', 0, 0);
            $pdf->MultiCell(18, 25, '', 'LRTB', 'C', 0, 0);
            $pdf->MultiCell(19.5, 25, '', 'LRTB', 'C', 0, 0);            
            ...
            $pdf->SetXY(94, 89);
			$pdf->Cell(0, 0, 'III-I SEMESTER', 0, false, 'L');
			$pdf->SetXY(94, 122);
			$pdf->Cell(0, 0, 'III-II SEMESTER', 0, false, 'L');
			$pdf->SetXY(94, 155);
			$pdf->Cell(0, 0, 'IV-I SEMESTER', 0, false, 'L');
			$pdf->SetXY(94, 188);
			$pdf->Cell(0, 0, 'IV-II SEMESTER', 0, false, 'L');
            ...
            $Credits_Secured = trim($studentData[12]); //CGPA_Secured
            $Class_Awarded =  trim($studentData[13]); 
            $Credits_Registered =  trim($studentData[14]);
            $Credits_Secured_in =  trim($studentData[15]);
			...
			$array_sem1=array(); //III-I Semester
			$array_sem2=array(); // III-II Semester
			$array_sem3=array(); // IV-I Semester
			$array_sem4=array(); //	IV-II Semester	
			...
			foreach ($array_sem2 as $semData){
                ...
                $pdf->SetXY(142, $sem2_y);
                $pdf->MultiCell(16, 11, $GradePoints, 0, 'C', 0, 0);     
                $pdf->MultiCell(20, 11, $Grades, 0, 'C', 0, 0);   
                $pdf->MultiCell(20, 11, $Credit, 0, 'C', 0, 0);
				
                $pdfBig->SetXY(16, $sem2_y);
                $pdfBig->SetFont($arial, '', $subj_font_size, '', false); 
				$pdfBig->MultiCell(9, 11, $SrNo, 0, 'L', 0, 0);
                $pdfBig->SetXY(22, $sem2_y);
                $pdfBig->MultiCell(118, 11, $SubjectTitle,0, 'L', 0, 0);
                $pdfBig->SetXY(142, $sem2_y);
                $pdfBig->MultiCell(16, 11, $GradePoints, 0, 'C', 0, 0);     
                $pdfBig->MultiCell(20, 11, $Grades, 0, 'C', 0, 0);   
                $pdfBig->MultiCell(20, 11, $Credit, 0, 'C', 0, 0);
                $sem2_y=$sem2_y+3.8;				
			...
			foreach ($array_sem3 as $semData){
                ...
                $pdf->SetXY(22, $sem3_y);
                $pdf->MultiCell(118, 11, $SubjectTitle,0, 'L', 0, 0);
                $pdf->SetXY(142, $sem3_y);
                $pdf->MultiCell(16, 11, $GradePoints, 0, 'C', 0, 0);     
                $pdf->MultiCell(20, 11, $Grades, 0, 'C', 0, 0);   
                $pdf->MultiCell(20, 11, $Credit, 0, 'C', 0, 0);
				
                $pdfBig->SetXY(16, $sem3_y);
                $pdfBig->SetFont($arial, '', $subj_font_size, '', false); 
				$pdfBig->MultiCell(9, 11, $SrNo, 0, 'L', 0, 0);
                $pdfBig->SetXY(22, $sem3_y);
                $pdfBig->MultiCell(118, 11, $SubjectTitle,0, 'L', 0, 0);
                $pdfBig->SetXY(142, $sem3_y);
                $pdfBig->MultiCell(16, 11, $GradePoints, 0, 'C', 0, 0);     
                $pdfBig->MultiCell(20, 11, $Grades, 0, 'C', 0, 0);   
                $pdfBig->MultiCell(20, 11, $Credit, 0, 'C', 0, 0);
                $sem3_y=$sem3_y+3.8;				
			...
			foreach ($array_sem4 as $semData){
                ...
                $pdf->SetXY(22, $sem4_y);
                $pdf->MultiCell(118, 11, $SubjectTitle,0, 'L', 0, 0);
                $pdf->SetXY(142, $sem4_y);
                $pdf->MultiCell(16, 11, $GradePoints, 0, 'C', 0, 0);     
                $pdf->MultiCell(20, 11, $Grades, 0, 'C', 0, 0);   
                $pdf->MultiCell(20, 11, $Credit, 0, 'C', 0, 0);
				
                $pdfBig->SetXY(16, $sem4_y);
                $pdfBig->SetFont($arial, '', $subj_font_size, '', false); 
				$pdfBig->MultiCell(9, 11, $SrNo, 0, 'L', 0, 0);
                $pdfBig->SetXY(22, $sem4_y);
                $pdfBig->MultiCell(118, 11, $SubjectTitle,0, 'L', 0, 0);
                $pdfBig->SetXY(142, $sem4_y);
                $pdfBig->MultiCell(16, 11, $GradePoints, 0, 'C', 0, 0);     
                $pdfBig->MultiCell(20, 11, $Grades, 0, 'C', 0, 0);   
                $pdfBig->MultiCell(20, 11, $Credit, 0, 'C', 0, 0);
                $sem4_y=$sem4_y+3.8;				
            ...
            $pdfBig->SetFont($arialNarrow, '', 9, '', false);
            $pdfBig->SetXY(39, 222);	
			...
			$pdfBig->SetXY(116, 222);	
			$pdfBig->SetFont($arialNarrow, '', 9, '', false);
			$pdfBig->MultiCell(0, 11, $Class_Awarded.'&nbsp;&nbsp;', 0, 'L', 0, 0, '', '', true, 0, true);

            $pdfBig->SetFont($arialNarrow, '', 9, '', false);
            $pdfBig->SetXY(16, 227);	
			$pdfBig->writeHTML('<b>Number of Credits Registered in '.$resultFor.' Program :</b> '.$Credits_Registered, true, 0, true, 0);
			$pdfBig->SetXY(16, 231);	
			$pdfBig->writeHTML('<b>Number of Credits Secured in '.$resultFor.' Program :</b> '.$Credits_Secured_in, true, 0, true, 0);
			...
			$pdfBig->SetXY(12, 251.5);
			$pdfBig->SetFont($arialb, '', 9, '', false);	
			$pdfBig->MultiCell(0, 0, 'DATE :',0, 'L', 0, 0);
			$pdfBig->SetXY(23, 251.5);
			$pdfBig->SetFont($arial, '', 9, '', false);
			$pdfBig->MultiCell(0, 0, $Date,0, 'L', 0, 0);
            ...
            $pdf->SetFont($arialNarrow, '', 9, '', false);
            $pdf->SetXY(39, 222);
            ...
            $pdf->SetFont($arialNarrow, '', 9, '', false);
            $pdf->SetXY(16, 227);	
			$pdf->writeHTML('<b>Number of Credits Registered in '.$resultFor.' Program :</b> '.$Credits_Registered, true, 0, true, 0);
			$pdf->SetXY(16, 231);	
			$pdf->writeHTML('<b>Number of Credits Secured in '.$resultFor.' Program :</b> '.$Credits_Secured_in, true, 0, true, 0);
            ...
            // below microline
            $fullStr =$candidate_name.$Serial_No.$Credits_Secured;

...
class PdfGenerateBestiuJob7
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
			...
			$SEM7_COURSE_CODE_6=trim($studentData[340]);
			$SEM7_COURSE_TITLE_6=trim($studentData[341]);
			$SEM7_CREDIT_HOURS_6=trim($studentData[342]);
			$SEM7_GRADE_POINT_6=trim($studentData[343]);
			$SEM7_CREDIT_POINTS_6=trim($studentData[344]);
			$SEM7_COURSE_CODE_7=trim($studentData[345]);
			$SEM7_COURSE_TITLE_7=trim($studentData[346]);
			$SEM7_CREDIT_HOURS_7=trim($studentData[347]);
			$SEM7_GRADE_POINT_7=trim($studentData[348]);
			$SEM7_CREDIT_POINTS_7=trim($studentData[349]);
			$VIII_SEM=trim($studentData[309]);
			$SEM8_COURSE_CODE_1=trim($studentData[310]);
			$SEM8_COURSE_TITLE_1=trim($studentData[311]);
			$SEM8_CREDIT_HOURS_1=trim($studentData[312]);
			$SEM8_GRADE_POINT_1=trim($studentData[313]);
			$SEM8_CREDIT_POINTS_1=trim($studentData[314]);
			$SEM8_COURSE_CODE_2=trim($studentData[315]);
			$SEM8_COURSE_TITLE_2=trim($studentData[316]);
			$SEM8_CREDIT_HOURS_2=trim($studentData[317]);
			$SEM8_GRADE_POINT_2=trim($studentData[318]);
			$SEM8_CREDIT_POINTS_2=trim($studentData[319]);
            $SEM8_COURSE_CODE_3=trim($studentData[320]);
			$SEM8_COURSE_TITLE_3=trim($studentData[321]);
			$SEM8_CREDIT_HOURS_3=trim($studentData[322]);
			$SEM8_GRADE_POINT_3=trim($studentData[323]);
			$SEM8_CREDIT_POINTS_3=trim($studentData[324]);
			$SEM8_COURSE_CODE_4=trim($studentData[325]);
			$SEM8_COURSE_TITLE_4=trim($studentData[326]);
			$SEM8_CREDIT_HOURS_4=trim($studentData[327]);
			$SEM8_GRADE_POINT_4=trim($studentData[328]);
			$SEM8_CREDIT_POINTS_4=trim($studentData[329]);
            $SEM8_COURSE_CODE_5=trim($studentData[330]);
			$SEM8_COURSE_TITLE_5=trim($studentData[331]);
			$SEM8_CREDIT_HOURS_5=trim($studentData[332]);
			$SEM8_GRADE_POINT_5=trim($studentData[333]);
			$SEM8_CREDIT_POINTS_5=trim($studentData[334]);
			$SEM8_COURSE_CODE_6=trim($studentData[335]);
			$SEM8_COURSE_TITLE_6=trim($studentData[336]);
			$SEM8_CREDIT_HOURS_6=trim($studentData[337]);
			$SEM8_GRADE_POINT_6=trim($studentData[338]);
			$SEM8_CREDIT_POINTS_6=trim($studentData[339]);
			...
			for ($x = 1; $x <= 7; $x++) {								
                ...
                if($x == 7){
                    $pdf->MultiCell(11, 4, ${"SEM7_COURSE_CODE_" . $x}, 'LBT', 'L', 0, 0, '', '', true, 0, true);
                }

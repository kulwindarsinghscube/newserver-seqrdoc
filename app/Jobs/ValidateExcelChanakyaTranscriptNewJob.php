...
class ValidateExcelChanakyaTranscriptNewJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        $columnsCount2=count($rowData2[0]);
                ...
                {
                    if($columnsCount1==9 &&$columnsCount2==9)
                    {
                        ...
                        $columnArr2=array('Register No','Terms','Course Type','Course_Name','Code','Credit','Grade','GP','CP');

                                ...
                                if($FID['infinite_height'][$extra_fields] != 1){
                                    ...
                                    if ($FID['visible'][$extra_fields] == 0) {
                                        ...
                                        if(($extra_fields==86&&isset($FID['data'][86])&&$template_name=="GalgotiyaUniversity")||($extra_fields==111&&isset($FID['data'][111])&&$template_name=="GalgotiyaUniversity-copy")||($subdomain[0]=="cu" && $FID['template_id']==1 && $extra_fields==9 && isset($FID['data'][9]))){
                                            ...
                                            $pdfBig->MultiCell($width, $height, $str,0, $text_align, 0, 0);
                                    ...
                                    if ($FID['visible_varification'][$extra_fields] == 0) {
                                        if(($extra_fields==86&&isset($FID['data'][86])&&$template_name=="GalgotiyaUniversity")||($extra_fields==111&&isset($FID['data'][111])&&$template_name=="GalgotiyaUniversity-copy")||($subdomain[0]=="cu" && $FID['template_id']==1 && $extra_fields==9 && isset($FID['data'][9]))){
                                               $strArr = str_split($str);
                                                ...
                                                $pdf->MultiCell($width, $height, $str,0, $text_align, 0, 0);
                                  ...
                                  /*if($subdomain[0]=="test"){
                                    ...
                                    if($FID['is_transparent_image'][$extra_fields] == 1){
                                        ...
                                        if($FID['visible'][$extra_fields] == 0){
                                            ...
                                            $pdfBig->image($upload_image,$x,$y,$width / 3.34,$height / 3.34);

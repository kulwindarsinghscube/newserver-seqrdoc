...
class PdfGenerateSaiuGrade6Job
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
			...
			$fatherName = trim($studentData[3]);
			$motherName = trim($studentData[4]);
			$programme = trim($studentData[5]);
			$monthYearOfPassing = trim($studentData[6]);
			$doi = trim($studentData[7]);
            
            $sl1 = trim($studentData[8]);
            $Code_1 = trim($studentData[9]);
            $CourseTitle1 = trim($studentData[10]);
            $Grade1 = trim($studentData[11]);
            $Credits1 = trim($studentData[12]);

            $sl1 = trim($studentData[13]);
            $Code_2 = trim($studentData[14]);
            $CourseTitle2 = trim($studentData[15]);
            $Grade2 = trim($studentData[16]);
            $Credits2 = trim($studentData[17]);

            $sl3 = trim($studentData[18]);
            $Code_3 = trim($studentData[19]);
            $CourseTitle3 = trim($studentData[20]);
            $Grade3 = trim($studentData[21]);
            $Credits3 = trim($studentData[22]);


            $sl4 = trim($studentData[23]);
            $Code_4 = trim($studentData[24]);
            $CourseTitle4 = trim($studentData[25]);
            $Grade4 = trim($studentData[26]);
            $Credits4 = trim($studentData[27]);

            $sl5 = trim($studentData[28]);
            $Code_5 = trim($studentData[29]);
            $CourseTitle5 = trim($studentData[30]);
            $Grade5 = trim($studentData[31]);
            $Credits5 = trim($studentData[32]);


            $sl6 = trim($studentData[33]);
            $Code_6 = trim($studentData[34]);
            $CourseTitle6 = trim($studentData[35]);
            $Grade6 = trim($studentData[36]);
            $Credits6 = trim($studentData[37]);

            $sl7 = trim($studentData[38]);
            $Code_7 = trim($studentData[39]);
            $CourseTitle7 = trim($studentData[40]);
            $Grade7 = trim($studentData[41]);
            $Credits7 = trim($studentData[42]);


            $sl8 = trim($studentData[43]);
            $Code_8 = trim($studentData[44]);
            $CourseTitle8 = trim($studentData[45]);
            $Grade8 = trim($studentData[46]);
            $Credits8 = trim($studentData[47]);


            $sl9 = trim($studentData[48]);
            $Code_9 = trim($studentData[49]);
            $CourseTitle9 = trim($studentData[50]);
            $Grade9 = trim($studentData[51]);
            $Credits9 = trim($studentData[52]);

            $semester = trim($studentData[53]);
            $sgpa = trim($studentData[54]);
            $creditEarned = trim($studentData[55]);
            $deanSign = trim($studentData[56]);
            $coeSign = trim($studentData[57]);
            ...
            $pdfBig->SetXY(15, 57);
            $pdfBig->MultiCell(29, 7, 'Name', 0, "L", 0, 0, '', '', true, 0, true);

            $pdfBig->SetFont($arialb, '',10, '', false);
            $pdfBig->SetXY(50, 57);
            $pdfBig->MultiCell(5, 7, ':', 0, "L", 0, 0, '', '', true, 0, true);
            
            $pdfBig->SetFont($arialb, '',10, '', false);
            $pdfBig->SetXY(55, 57);
            $pdfBig->MultiCell(50, 7, $candidate_name, 0, "L", 0, 0, '', '', true, 0, true);

            // right side
            $pdfBig->SetFont($arialb, '',10, '', false);
            $pdfBig->SetXY(109, 57);
            $pdfBig->MultiCell(31, 7, 'Semester', 0, "L", 0, 0, '', '', true, 0, true);
            ...
            $pdfBig->SetFont($arialb, '',10, '', false);
            $pdfBig->SetXY(145, 57);
            $pdfBig->MultiCell(50, 7, $semester, 0, "L", 0, 0, '', '', true, 0, true);


            $pdfBig->SetFont($arialb, '',10, '', false);
            $pdfBig->SetXY(15, 63);
            $pdfBig->MultiCell(29, 7, 'PRN No', 0, "L", 0, 0, '', '', true, 0, true);
            ...
            $pdfBig->SetFont($arialb, '',10, '', false);
            $pdfBig->SetXY(55, 63);
            $pdfBig->MultiCell(50, 7, $prnNo, 0, "L", 0, 0, '', '', true, 0, true);

            // right side
            $pdfBig->SetFont($arialb, '',10, '', false);
            $pdfBig->SetXY(109, 63);
            $pdfBig->MultiCell(31, 7, 'Program', 0, "L", 0, 0, '', '', true, 0, true);
            ...
            $pdfBig->SetFont($arialb, '',10, '', false);
            $pdfBig->SetXY(145, 63);
            $pdfBig->MultiCell(50, 7, $programme, 0, "L", 0, 0, '', '', true, 0, true);



            $pdfBig->SetFont($arialb, '',10, '', false);
            $pdfBig->SetXY(15, 69);
            $pdfBig->MultiCell(29, 7, "Father's Name", 0, "L", 0, 0, '', '', true, 0, true);
            ...
            $pdfBig->SetFont($arialb, '',10, '', false);
            $pdfBig->SetXY(55, 69);
            $pdfBig->MultiCell(50, 7, $fatherName, 0, "L", 0, 0, '', '', true, 0, true);

            // right side
            $pdfBig->SetFont($arialb, '',10, '', false);
            $pdfBig->SetXY(109, 69);
            $pdfBig->MultiCell(31, 7, 'Month & Year of Examination', 0, "L", 0, 0, '', '', true, 0, true);
            ...
            $pdfBig->SetFont($arialb, '',10, '', false);
            $pdfBig->SetXY(145, 69);
            $pdfBig->MultiCell(50, 7, $monthYearOfPassing, 0, "L", 0, 0, '', '', true, 0, true);


            $pdfBig->SetFont($arialb, '',10, '', false);
            $pdfBig->SetXY(15, 75);
            $pdfBig->MultiCell(29, 7, "Mother's Name", 0, "L", 0, 0, '', '', true, 0, true);
            ...
            $pdfBig->SetFont($arialb, '',10, '', false);
            $pdfBig->SetXY(55, 75);
            $pdfBig->MultiCell(50, 7, $motherName, 0, "L", 0, 0, '', '', true, 0, true);


            // right side
            $pdfBig->SetFont($arialb, '',10, '', false);
            $pdfBig->SetXY(109, 79);
            $pdfBig->MultiCell(31, 7, 'Date of Issue', 0, "L", 0, 0, '', '', true, 0, true);
            ...
            $pdfBig->SetFont($arialb, '',10, '', false);
            $pdfBig->SetXY(145, 79);
            $pdfBig->MultiCell(50, 7, $doi, 0, "L", 0, 0, '', '', true, 0, true);
            ...
            $pdfBig->SetXY(0, 100);
            $pdfBig->SetTextColor(46,109,164);
            $pdfBig->Cell(210, 0, 'GRADE SHEET', 0, false, 'C');
            ...
            $pdfBig->SetFont($arialb, '',10, '', false);
            $pdfBig->SetXY(15, 110);
            $pdfBig->Cell(16, 9, 'Sl.No.', 1, $ln=0, 'C', 0, '', 0, false, 'T', 'C');

            $pdfBig->SetFont($arialb, '',10, '', false);
            $pdfBig->SetXY(31, 110);
            $pdfBig->Cell(31, 9, 'Course Code', 1, $ln=0, 'C', 0, '', 0, false, 'T', 'C');


            $pdfBig->SetFont($arialb, '',10, '', false);
            $pdfBig->SetXY(62, 110);
            $pdfBig->Cell(82, 9, 'Course Name', 1, $ln=0, 'C', 0, '', 0, false, 'T', 'C');


            $pdfBig->SetFont($arialb, '',10, '', false);
            $pdfBig->SetXY(144, 110);
            $pdfBig->Cell(24, 9, 'Grades', 1, $ln=0, 'C', 0, '', 0, false, 'T', 'C');


            $pdfBig->SetFont($arialb, '',10, '', false);
            $pdfBig->SetXY(168, 110);
            $pdfBig->Cell(28, 9, 'Credits', 1, $ln=0, 'C', 0, '', 0, false, 'T', 'C');
            ...
            for ($i=1; $i < 10; $i++) { 
                ...
                $lines = $pdfBig->MultiCell(82, 0, trim($studentData[$subIndex+2]), 0, 'L', 0, 0, '', '', true, 0, false,true, 0);
                $pdfBig=$pdfBig->rollbackTransaction(); // restore previous object

                if($lines>1){
                    // $tableY = $tableY+5;
                    $tableHeight = 12;
                    $pdfBig->setCellPaddings( $left = 0, $top = 4, $right = 0, $bottom = 0);
                }else{
                    $tableHeight =9;
                    $pdfBig->setCellPaddings( $left = 0, $top = 2, $right = 0, $bottom = 0);
                }

                $pdfBig->SetFont($arialb, '',10, '', false);
                $pdfBig->SetXY(15, $tableY);
                // $pdfBig->Cell(16, $tableHeight, trim($studentData[$subIndex]), 1, $ln=0, 'C', 0, '', 0, true, 'T', 'C');
                $pdfBig->MultiCell(16, $tableHeight, trim($studentData[$subIndex]), 1, 'C', 0, 0, '', '', true, 0, false,true, 0);
                $subIndex = $subIndex+1;

                $pdfBig->SetFont($arialb, '',10, '', false);
                $pdfBig->SetXY(31, $tableY);
                // $pdfBig->Cell(31, $tableHeight,  trim($studentData[$subIndex]), 1, $ln=0, 'C', 0, '', 0, true, 'T', 'C');
                $pdfBig->MultiCell(31, $tableHeight, trim($studentData[$subIndex]), 1, 'C', 0, 0, '', '', true, 0, false,true, 0);
                $subIndex = $subIndex+1;

                $pdfBig->SetFont($arialb, '',10, '', false);
                $pdfBig->SetXY(62, $tableY);
                
                if($lines>1){
                    $pdfBig->setCellPaddings( $left = 0, $top = 2, $right = 0, $bottom = 0);
                }
                // $pdfBig->Cell(82, $tableHeight,  trim($studentData[$subIndex]), 1, $ln=0, 'C', 0, '', 0, true, 'T', 'C');
                $pdfBig->MultiCell(82, $tableHeight, trim($studentData[$subIndex]), 1, 'C', 0, 0, '', '', true, 0, false,true, 0);
                $subIndex = $subIndex+1;
                if($lines>1){
                    $pdfBig->setCellPaddings( $left = 0, $top = 4, $right = 0, $bottom = 0);
                }
                $pdfBig->SetFont($arialb, '',10, '', false);
                $pdfBig->SetXY(144, $tableY);
                // $pdfBig->Cell(24, $tableHeight,  trim($studentData[$subIndex]), 1, $ln=0, 'C', 0, '', 0, true, 'T', 'C');
                $pdfBig->MultiCell(24, $tableHeight, trim($studentData[$subIndex]), 1, 'C', 0, 0, '', '', true, 0, false,true, 0);
                $subIndex = $subIndex+1;

                $pdfBig->SetFont($arialb, '',10, '', false);
                $pdfBig->SetXY(168, $tableY);
                // $pdfBig->Cell(28, $tableHeight,  trim($studentData[$subIndex]), 1, $ln=0, 'C', 0, '', 0, true, 'T', 'C');
                $pdfBig->MultiCell(28, $tableHeight, trim($studentData[$subIndex]), 1, 'C', 0, 0, '', '', true, 0, false,true, 0);
                $subIndex = $subIndex+1;
                $tableY= $tableY+$tableHeight;

                if(empty($studentData[$subIndex])) {
                    break;
                }
            ...
            $pdfBig->SetFont($arialb, '',10, '', false);
            $pdfBig->SetXY(15, 215);
            $pdfBig->MultiCell(60, 18, '', 1, 'C', 0, 0, '', '', true, 0, false,true, 0);
            $pdfBig->SetXY(15, 224);
            $pdfBig->MultiCell(60, 18, 'SEMESTER '.$semester, 0, 'C', 0, 0, '', '', true, 0, false,true, 0);


            $pdfBig->SetFont($arialb, '',10, '', false);
            $pdfBig->SetXY(75, 215);
            $pdfBig->MultiCell(60, 7, 'SGPA', 1, 'C', 0, 0, '', '', true, 0, false,true, 0);
            $pdfBig->SetXY(75, 222);
            $pdfBig->setCellPaddings($left = 0, $top = 3, $right = 0, $bottom = 0);
            $pdfBig->MultiCell(60, 11, $sgpa, 1, 'C', 0, 0, '', '', true, 0, false,true, 0);


            $pdfBig->setCellPaddings($left = 0, $top = 1, $right = 0, $bottom = 0);
            $pdfBig->SetFont($arialb, '',10, '', false);
            $pdfBig->SetXY(135, 215);
            $pdfBig->MultiCell(61, 7, 'Credits Earned', 1, 'C', 0, 0, '', '', true, 0, false,true, 0);
            $pdfBig->SetXY(135, 222);
            $pdfBig->setCellPaddings($left = 0, $top = 3, $right = 0, $bottom = 0);
            $pdfBig->MultiCell(61, 11, $creditEarned, 1, 'C', 0, 0, '', '', true, 0, false,true, 0);
            ...
            $pdf->SetXY(15, 57);
            $pdf->MultiCell(29, 7, 'Name', 0, "L", 0, 0, '', '', true, 0, true);

            $pdf->SetFont($arialb, '',10, '', false);
            $pdf->SetXY(50, 57);
            $pdf->MultiCell(5, 7, ':', 0, "L", 0, 0, '', '', true, 0, true);
            
            $pdf->SetFont($arialb, '',10, '', false);
            $pdf->SetXY(55, 57);
            $pdf->MultiCell(50, 7, $candidate_name, 0, "L", 0, 0, '', '', true, 0, true);

            // right side
            $pdf->SetFont($arialb, '',10, '', false);
            $pdf->SetXY(109, 57);
            $pdf->MultiCell(31, 7, 'Semester', 0, "L", 0, 0, '', '', true, 0, true);
            ...
            $pdf->SetFont($arialb, '',10, '', false);
            $pdf->SetXY(145, 57);
            $pdf->MultiCell(50, 7, $semester, 0, "L", 0, 0, '', '', true, 0, true);


            $pdf->SetFont($arialb, '',10, '', false);
            $pdf->SetXY(15, 63);
            $pdf->MultiCell(29, 7, 'PRN No', 0, "L", 0, 0, '', '', true, 0, true);
            ...
            $pdf->SetFont($arialb, '',10, '', false);
            $pdf->SetXY(55, 63);
            $pdf->MultiCell(50, 7, $prnNo, 0, "L", 0, 0, '', '', true, 0, true);

            // right side
            $pdf->SetFont($arialb, '',10, '', false);
            $pdf->SetXY(109, 63);
            $pdf->MultiCell(31, 7, 'Program', 0, "L", 0, 0, '', '', true, 0, true);
            ...
            $pdf->SetFont($arialb, '',10, '', false);
            $pdf->SetXY(145, 63);
            $pdf->MultiCell(50, 7, $programme, 0, "L", 0, 0, '', '', true, 0, true);



            $pdf->SetFont($arialb, '',10, '', false);
            $pdf->SetXY(15, 69);
            $pdf->MultiCell(29, 7, "Father's Name", 0, "L", 0, 0, '', '', true, 0, true);
            ...
            $pdf->SetFont($arialb, '',10, '', false);
            $pdf->SetXY(55, 69);
            $pdf->MultiCell(50, 7, $fatherName, 0, "L", 0, 0, '', '', true, 0, true);

            // right side
            $pdf->SetFont($arialb, '',10, '', false);
            $pdf->SetXY(109, 69);
            $pdf->MultiCell(31, 7, 'Month & Year of Examination', 0, "L", 0, 0, '', '', true, 0, true);
            ...
            $pdf->SetFont($arialb, '',10, '', false);
            $pdf->SetXY(145, 69);
            $pdf->MultiCell(50, 7, $monthYearOfPassing, 0, "L", 0, 0, '', '', true, 0, true);


            $pdf->SetFont($arialb, '',10, '', false);
            $pdf->SetXY(15, 75);
            $pdf->MultiCell(29, 7, "Mother's Name", 0, "L", 0, 0, '', '', true, 0, true);
            ...
            $pdf->SetFont($arialb, '',10, '', false);
            $pdf->SetXY(55, 75);
            $pdf->MultiCell(50, 7, $motherName, 0, "L", 0, 0, '', '', true, 0, true);


            // right side
            $pdf->SetFont($arialb, '',10, '', false);
            $pdf->SetXY(109, 79);
            $pdf->MultiCell(31, 7, 'Date of Issue', 0, "L", 0, 0, '', '', true, 0, true);
            ...
            $pdf->SetFont($arialb, '',10, '', false);
            $pdf->SetXY(145, 79);
            $pdf->MultiCell(50, 7, $doi, 0, "L", 0, 0, '', '', true, 0, true);
            ...
            $pdf->SetXY(0, 100);
            $pdf->SetTextColor(46,109,164);
            $pdf->Cell(210, 0, 'GRADE SHEET', 0, false, 'C');
            ...
            $pdf->SetFont($arialb, '',10, '', false);
            $pdf->SetXY(15, 110);
            $pdf->Cell(16, 9, 'Sl.No.', 1, $ln=0, 'C', 0, '', 0, false, 'T', 'C');

            $pdf->SetFont($arialb, '',10, '', false);
            $pdf->SetXY(31, 110);
            $pdf->Cell(31, 9, 'Course Code', 1, $ln=0, 'C', 0, '', 0, false, 'T', 'C');


            $pdf->SetFont($arialb, '',10, '', false);
            $pdf->SetXY(62, 110);
            $pdf->Cell(82, 9, 'Course Name', 1, $ln=0, 'C', 0, '', 0, false, 'T', 'C');


            $pdf->SetFont($arialb, '',10, '', false);
            $pdf->SetXY(144, 110);
            $pdf->Cell(24, 9, 'Grades', 1, $ln=0, 'C', 0, '', 0, false, 'T', 'C');


            $pdf->SetFont($arialb, '',10, '', false);
            $pdf->SetXY(168, 110);
            $pdf->Cell(28, 9, 'Credits', 1, $ln=0, 'C', 0, '', 0, false, 'T', 'C');
            ...
            for ($i=1; $i < 10; $i++) { 
                ...
                $pdf->SetFont($arialb, '', 10, '', false);  
                // get the number of lines
                $lines = $pdf->MultiCell(82, 0, trim($studentData[$subIndex+2]), 0, 'L', 0, 0, '', '', true, 0, false,true, 0);
                $pdf=$pdf->rollbackTransaction(); // restore previous object

                if($lines>1){
                    // $tableY = $tableY+5;
                    $tableHeight = 12;
                    $pdf->setCellPaddings( $left = 0, $top = 4, $right = 0, $bottom = 0);
                }else{
                    $tableHeight =9;
                    $pdf->setCellPaddings( $left = 0, $top = 2, $right = 0, $bottom = 0);
                }

                $pdf->SetFont($arialb, '',10, '', false);
                $pdf->SetXY(15, $tableY);
                // $pdf->Cell(16, $tableHeight, trim($studentData[$subIndex]), 1, $ln=0, 'C', 0, '', 0, true, 'T', 'C');
                $pdf->MultiCell(16, $tableHeight, trim($studentData[$subIndex]), 1, 'C', 0, 0, '', '', true, 0, false,true, 0);
                $subIndex = $subIndex+1;

                $pdf->SetFont($arialb, '',10, '', false);
                $pdf->SetXY(31, $tableY);
                // $pdf->Cell(31, $tableHeight,  trim($studentData[$subIndex]), 1, $ln=0, 'C', 0, '', 0, true, 'T', 'C');
                $pdf->MultiCell(31, $tableHeight, trim($studentData[$subIndex]), 1, 'C', 0, 0, '', '', true, 0, false,true, 0);
                $subIndex = $subIndex+1;
                ...
                // $pdf->Cell(82, $tableHeight,  trim($studentData[$subIndex]), 1, $ln=0, 'C', 0, '', 0, true, 'T', 'C');
                $pdf->MultiCell(82, $tableHeight, trim($studentData[$subIndex]), 1, 'C', 0, 0, '', '', true, 0, false,true, 0);
                $subIndex = $subIndex+1;
                if($lines>1){
                    $pdf->setCellPaddings( $left = 0, $top = 4, $right = 0, $bottom = 0);
                }
                $pdf->SetFont($arialb, '',10, '', false);
                $pdf->SetXY(144, $tableY);
                // $pdf->Cell(24, $tableHeight,  trim($studentData[$subIndex]), 1, $ln=0, 'C', 0, '', 0, true, 'T', 'C');
                $pdf->MultiCell(24, $tableHeight, trim($studentData[$subIndex]), 1, 'C', 0, 0, '', '', true, 0, false,true, 0);
                $subIndex = $subIndex+1;

                $pdf->SetFont($arialb, '',10, '', false);
                $pdf->SetXY(168, $tableY);
                // $pdf->Cell(28, $tableHeight,  trim($studentData[$subIndex]), 1, $ln=0, 'C', 0, '', 0, true, 'T', 'C');
                $pdf->MultiCell(28, $tableHeight, trim($studentData[$subIndex]), 1, 'C', 0, 0, '', '', true, 0, false,true, 0);
                $subIndex = $subIndex+1;
                $tableY= $tableY+$tableHeight;
            ...
            $pdf->SetFont($arialb, '',10, '', false);
            $pdf->SetXY(15, 215);
            $pdf->MultiCell(60, 18, '', 1, 'C', 0, 0, '', '', true, 0, false,true, 0);
            $pdf->SetXY(15, 224);
            $pdf->MultiCell(60, 18, 'SEMESTER '.$semester, 0, 'C', 0, 0, '', '', true, 0, false,true, 0);


            $pdf->SetFont($arialb, '',10, '', false);
            $pdf->SetXY(75, 215);
            $pdf->MultiCell(60, 7, 'SGPA', 1, 'C', 0, 0, '', '', true, 0, false,true, 0);
            $pdf->SetXY(75, 222);
            $pdf->setCellPaddings($left = 0, $top = 3, $right = 0, $bottom = 0);
            $pdf->MultiCell(60, 11, $sgpa, 1, 'C', 0, 0, '', '', true, 0, false,true, 0);


            $pdf->setCellPaddings($left = 0, $top = 1, $right = 0, $bottom = 0);
            $pdf->SetFont($arialb, '',10, '', false);
            $pdf->SetXY(135, 215);
            $pdf->MultiCell(61, 7, 'Credits Earned', 1, 'C', 0, 0, '', '', true, 0, false,true, 0);
            $pdf->SetXY(135, 222);
            $pdf->setCellPaddings($left = 0, $top = 3, $right = 0, $bottom = 0);
            $pdf->MultiCell(61, 11, $creditEarned, 1, 'C', 0, 0, '', '', true, 0, false,true, 0);

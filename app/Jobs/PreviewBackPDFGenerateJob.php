...
class PreviewBackPDFGenerateJob
{
    ...
    protected $back_bg_template_img_generate;
    protected $back_bg_template_width_generate;
    protected $back_bg_template_height_generate;
    protected $back_bg_template_img;
    protected $back_bg_template_width;
    protected $back_bg_template_height;
    ...
    public function __construct($isPreview,$highestRow,$highestColumn,$FID,$Orientation,$template_Width,$template_height,$back_bg_template_img_generate,$back_bg_template_width_generate,$back_bg_template_height_generate,$back_bg_template_img,$back_bg_template_width,$back_bg_template_height,$mapped_excel_col_unique_serial_no,$ext,$fullpath,$tmpDir,$excelfile,$timezone,$printer_name,$style2D,$style1D,$style1Da,$fonts_array,$font_name,$admin_id)
    {
        ...
        $this->back_bg_template_img_generate = $back_bg_template_img_generate;
        $this->back_bg_template_width_generate = $back_bg_template_width_generate;
        $this->back_bg_template_height_generate = $back_bg_template_height_generate;
        $this->back_bg_template_img = $back_bg_template_img;
        $this->back_bg_template_width = $back_bg_template_width;
        $this->back_bg_template_height = $back_bg_template_height;
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        $back_bg_template_img_generate = $this->back_bg_template_img_generate;
        $back_bg_template_width_generate = $this->back_bg_template_width_generate;
        $back_bg_template_height_generate = $this->back_bg_template_height_generate;
        $back_bg_template_img = $this->back_bg_template_img;
        $back_bg_template_width = $this->back_bg_template_width;
        $back_bg_template_height = $this->back_bg_template_height;
        ...
        $pdfBig = new TCPDF($Orientation, 'mm', array($back_bg_template_width, $back_bg_template_height), true, 'UTF-8', false);
                ...
                switch  ($security_type) {
                    ...
                    case 'Normal':
                                ...
                                if(isset($FID['infinite_height'][$extra_fields-2]) && $FID['infinite_height'][$extra_fields-2] != 1){
                                    ...
                                    if(($extra_fields==87&&isset($FID['data'][87])&&$template_name=="GalgotiyaUniversity")||($extra_fields==111&&isset($FID['data'][111])&&$template_name=="GalgotiyaUniversity-copy")||($subdomain[0]=="cu" && ($FID['template_id']==1 ||$FID['template_id']==2 ||$FID['template_id']==3||$FID['template_id']==4 )&& $extra_fields==9 && isset($FID['data'][9]))){
                    ...
                    case 'UV Repeat Fullpage':
                        ...
                        if($FID['field_extra_visible'][$extra_fields - 2] == 0){
                            ...
                            if ($back_bg_template_width < $back_bg_template_height){
                                $pdfWidth = 210;
                                $pdfHeight = 297;
                            }else{
                                $pdfWidth = $back_bg_template_width;
                                $pdfHeight = $back_bg_template_height;
                            }

...
class PdfGenerateSaiuGrade4Job
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
            ...
            $pdfBig->SetFont($arial, '',10, '', false);
            $pdfBig->SetXY(11, 74);
            $pdfBig->MultiCell(188, 11.5, "", 'LRB', "L", 0, 0, '', '', true, 0, true);
            ...
            $pdfBig->MultiCell(150, 8, $programme, 0, "L", 0, 0, '', '', true, 0, true);
           ...
           $pdfBig->setCellPaddings( $left = '1', $top = '1.5', $right = '', $bottom = '');
            ...
            $pdfBig->SetFont($arial, '',8, '', false);
            $pdfBig->SetXY(31, 253);
            $pdfBig->MultiCell(26, 15, '', 1, "C", 0, 0, '', '', true, 0, true);
            $pdfBig->SetXY(31, 258);
            $pdfBig->MultiCell(26, 7.5, 'Result', 0, "C", 0, 0, '', '', true, 0, true);


            $pdfBig->setCellPaddings( $left = '1', $top = '1', $right = '', $bottom = '');
            $pdfBig->SetFont($arial, '',8, '', false);
            $pdfBig->SetXY(57, 253);
            $pdfBig->MultiCell(124, 15, '', 1, "C", 0, 0, '', '', true, 0, true);
            $pdfBig->SetXY(57, 258);
            $pdfBig->MultiCell(124, 7.5, $Result, 0, "C", 0, 0, '', '', true, 0, true);
            ...
            $pdf->SetFont($arial, '',10, '', false);
            $pdf->SetXY(11, 74);
            $pdf->MultiCell(188, 11.5, "", 'LRB', "L", 0, 0, '', '', true, 0, true);
            ...
            $pdf->SetFont($arial, '',10, '', false);
            $pdf->SetXY(49, 75.5);
            $pdf->MultiCell(150, 8, $programme, 0, "L", 0, 0, '', '', true, 0, true);
           ...
           $pdf->setCellPaddings( $left = '1', $top = '1.5', $right = '', $bottom = '');
            ...
            $pdf->SetFont($arial, '',8, '', false);
            $pdf->SetXY(31, 253);
            $pdf->MultiCell(26, 15, '', 1, "C", 0, 0, '', '', true, 0, true);
            $pdf->SetXY(31, 258);
            $pdf->MultiCell(26, 7.5, 'Result', 0, "C", 0, 0, '', '', true, 0, true);


            $pdf->setCellPaddings( $left = '1', $top = '1', $right = '', $bottom = '');
            $pdf->SetFont($arial, '',8, '', false);
            $pdf->SetXY(57, 253);
            $pdf->MultiCell(124, 15, '', 1, "C", 0, 0, '', '', true, 0, true);
            $pdf->SetXY(57, 258);
            $pdf->MultiCell(124, 7.5, $Result, 0, "C", 0, 0, '', '', true, 0, true);

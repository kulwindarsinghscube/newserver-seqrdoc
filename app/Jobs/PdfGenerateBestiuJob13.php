...
class PdfGenerateBestiuJob13 
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        $sgpa_key=59;
        $total_credit_earn_key=60;
        $total_credit_points_key=61;
        $cgpa_key=62;
        $percentage_key=63;
		$subj_col=5; 
		$subj_start=9;
        ...
        foreach ($studentDataOrg as $studentData) {
           ...
           // print_r($subjectsArr);
            ...
            $pdf->SetXY($left_pos, 43);
            $pdf->Cell(0, 0, 'CONSOLIDATED MARKS MEMO/GRADE SHEET/CREDIT SHEET', 0, false, 'C'); 

            $pdf->SetFont($arialb, '', 8, '', false);
			$pdf->SetXY($left_pos, 52);		

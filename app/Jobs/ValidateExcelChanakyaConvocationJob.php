...
class ValidateExcelChanakyaConvocationJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        // dd($columnsCount1);
                if($dropdown_template_id==1){
                    if($columnsCount1==11){
                        $columnArr=array("Reg. No.", "Serial No", "Date", "Name", "Degree", "specialization ", "Convocation Day", "Convocation Month", "Convocation Year", "Grade","Unique id",'Specialization');

    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        if ($studentDataOrg && !empty($studentDataOrg)) {
            foreach ($studentDataOrg as $studentData) {
                ...
                if (!empty($upload_sign2_org) && file_exists($upload_sign2_org)) {
                    // echo $upload_sign2_org;
                    // echo "<br>";
                    // echo $sign2;
        ...
        if ($previewPdf != 1) {
            ...
            // $source=\Config::get('constant.directoryPathBackward')."\\".$subdomain[0]."\\backend\\pdf_file\\".$certName;

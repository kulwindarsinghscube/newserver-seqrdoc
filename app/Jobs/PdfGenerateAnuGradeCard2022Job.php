...
class PdfGenerateAnuGradeCard2022Job
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        if ($studentDataOrg && !empty($studentDataOrg)) {
            foreach ($studentDataOrg as $studentData) {
                ...
                $name2 = trim($studentData[135]);
                $designation2 = $studentData[136];
                $name3 = $studentData[137];
                $designation3 = $studentData[138];
                ...
                $pdfBig->MultiCell(26.5, 10, 'Credits', "LTRB", 'C', 0, 0, '', '', true, 0, true);
                ...
                $pdfBig->SetFont($trebuc, '', 9.5, '', false);
                $pdfBig->MultiCell(31, 10, 'Total<br>Credits', "LTRB", 'C', 0, 0, '', '', true, 0, true);
                ...
                $pdfBig->SetXY(93, 272);
                $pdfBig->Cell(0, 0, $name3, 0, false, 'L');
                $pdfBig->SetXY(90, 275.5);
                $pdfBig->Cell(0, 0, $designation3, 0, false, 'L');
                ...
                $pdf->MultiCell(26.5, 10, ' Credits', "LTRB", 'C', 0, 0, '', '', true, 0, true);
                ...
                $pdf->SetFont($trebuc, '', 9.5, '', false);
                $pdf->MultiCell(31, 10, 'Total<br> Credits', "LTRB", 'C', 0, 0, '', '', true, 0, true);
                ...
                if ($name1 == "Ms. Jigisha Patel" || $name1 == "Prof. Suhas Toshniwal" || $name1 == "Prof. Jasmine Gohil" || $name1 == "Jigisha Patel" || $name1 == "Suhas Toshniwal" || $name1 == "Jasmine Gohil" || $name1 == "Hrishikesh Trivedi" || $name1 == "Sanjay Bhatnagar" || $name1 == "Preeth Padmanabhan") {
                ...
                if ($name3 == "Ms. Jigisha Patel" || $name3 == "Prof. Suhas Toshniwal" || $name3 == "Prof. Jasmine Gohil" || $name3 == "Jigisha Patel" || $name3 == "Suhas Toshniwal" || $name3 == "Jasmine Gohil" || $name3 == "Hrishikesh Trivedi" || $name3 == "Sanjay Bhatnagar" || $name3 == "Preeth Padmanabhan" || $name3 == "Brijesh Kumar Singh") {
                    //right side
                    $pdf->SetXY(132.5, 272);
                    $pdf->Cell(0, 0, $name3, 0, false, 'L');
                    $pdf->SetXY(132.5, 275.5);
                    $pdf->Cell(0, 0, $designation3, 0, false, 'L');
                    /*end pdf*/
                }


                if ($name2 == "Ms. Jigisha Patel" || $name2 == "Prof. Suhas Toshniwal" || $name2 == "Prof. Jasmine Gohil" || $name2 == "Jigisha Patel" || $name2 == "Suhas Toshniwal" || $name2 == "Jasmine Gohil" || $name2 == "Hrishikesh Trivedi" || $name2 == "Sanjay Bhatnagar" || $name2 == "Preeth Padmanabhan") {
                    //right side
                    $pdf->SetXY(132.5, 272);
                ...
                if ($name2 == "Dr. Sridhar B Reddy") {
                    ...
                    $sign2_Width = 33;
                    $sign2_Height = 13;
                } elseif ($name3 == "Brijesh Kumar Singh") {
                    $sign3 = public_path() . '\\' . $subdomain[0] . '\backend\canvas\images\Brijesh_Kumar_Singh.png';
        ...
        if ($previewPdf != 1) {
            //Kamini changes on 20/05/2025    code optimize 
            if (!empty($sftpData)) {

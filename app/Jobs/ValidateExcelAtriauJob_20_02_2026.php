       ...
       $rowData2=$pdf_data['subjectsMark'];
        ...
        if ($dropdown_template_id==1){
           ...
           $columnsCount2=count($rowData2[0]);
              ...
              if($columnsCount1==13 && $columnsCount2==7){

                   $columnArr=array("Unique No", "Name ", "Reg No", "Transcript No", "Year of Addmission", "Programme", "Duration of Program", "Medium of  Instruction", "Date of Issue", "Year of Completion", "Credit ", "CGPA", "Photo");
                 $mismatchColArr=array_diff($rowData1[0], $columnArr);
                        if(count($mismatchColArr)>0){
                          ...
                          $columnArr2=array("Reg No", "Sr NO", "Course Code", "Course Title", "Credits ", "Grade", "Month and Year of Completion");

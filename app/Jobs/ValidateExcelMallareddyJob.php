...
class ValidateExcelMallareddyJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        if($dropdown_template_id==1){
            if($columnsCount1 == 15 && $columnsCount2==8){
                $columnArr=array("unique_no","cgcs_no","programme","hall_ticket_no","name","father_name","year_of_admission","month_and_year_of_pass","class_awarded","credit_registered","cgpa","credits_of_cgpa","min_no_credit_award_degree","date","photo");
                ...
                $columnArr2=array("hall_ticket_no","year","semester","course_code","course_title","Grade","credit","month_year_of_pass");

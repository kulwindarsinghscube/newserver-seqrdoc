...
use Carbon\Carbon;
use Helper;
class PdfGenerateBestiuEDocumentJob7
{
               ...
               $pdfBig->SetTextColor(0,0,0);
				...
				foreach($subjects as $term => $term_array){
					...
					if ($term == "I SEMESTER" || $term == "III SEMESTER" || $term == "V SEMESTER" || $term == "VII SEMESTER" ) {
						...
						$pdfBig->MultiCell(92, 3, $term .' (SGPA : '.$term_array[0][7].')', 'TB', 'C', 0, 0, '', '', true, 0, true);
               ...
               $pdf->SetTextColor(0,0,0);
				...
				foreach($subjects as $term => $term_array){
					...
					if ($term == "I SEMESTER" || $term == "III SEMESTER" || $term == "V SEMESTER" || $term == "VII SEMESTER" ) {
						...
						$pdf->MultiCell(92, 3, $term .' (SGPA : '.$term_array[0][7].')', 'TB', 'C', 0, 0, '', '', true, 0, true);

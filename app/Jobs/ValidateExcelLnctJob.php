...
class ValidateExcelLnctJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        if($dropdown_template_id==1){
            if($columnsCount1==22){
                $photo_col=23;
				$columnArr=array("S.NO.","ROLL NO.","STUDENT NAME ","STUDENT NAME H","FATHER NAME ","FATHER NAME H","MOTHER NAME","MOTHER NAME H","Tital_E","Tital_H","COLLAGE NAME_E ","COLLAGE NAME_H","COURSE_E ","COURSE_H","PASSING YEAR ","DIVISION_E","DIVISION_H","TOTAL MARKS ","MARKS OBTEIN","PARSENTAGE","PLACE","DATE");

    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
		...
		if($studentDataOrg&&!empty($studentDataOrg)){
			foreach ($studentDataOrg as $studentData) {
				...
				$SEM7_COURSE_CODE_4=trim($studentData[339]);
				$SEM7_COURSE_TITLE_4=trim($studentData[340]);
				$SEM7_CREDIT_HOURS_4=trim($studentData[341]);
				$SEM7_GRADE_POINT_4=trim($studentData[342]);
				$SEM7_CREDIT_POINTS_4=trim($studentData[343]);
				$SEM7_COURSE_CODE_5=trim($studentData[344]);
				$SEM7_COURSE_TITLE_5=trim($studentData[345]);
				$SEM7_CREDIT_HOURS_5=trim($studentData[346]);
				$SEM7_GRADE_POINT_5=trim($studentData[347]);
				$SEM7_CREDIT_POINTS_5=trim($studentData[348]);
				$SEM7_COURSE_CODE_6=trim($studentData[349]);
				$SEM7_COURSE_TITLE_6=trim($studentData[350]);
				$SEM7_CREDIT_HOURS_6=trim($studentData[351]);
				$SEM7_GRADE_POINT_6=trim($studentData[352]);
				$SEM7_CREDIT_POINTS_6=trim($studentData[353]);
				$SEM7_COURSE_CODE_7=trim($studentData[354]);
				$SEM7_COURSE_TITLE_7=trim($studentData[355]);
				$SEM7_CREDIT_HOURS_7=trim($studentData[356]);
				$SEM7_GRADE_POINT_7=trim($studentData[357]);
				$SEM7_CREDIT_POINTS_7=trim($studentData[358]);	
				$SEM7_COURSE_CODE_8=trim($studentData[359]);
				$SEM7_COURSE_TITLE_8=trim($studentData[360]);
				$SEM7_CREDIT_HOURS_8=trim($studentData[361]);
				$SEM7_GRADE_POINT_8=trim($studentData[362]);
				$SEM7_CREDIT_POINTS_8=trim($studentData[363]);

				$VIII_SEM=trim($studentData[364]);
				$SEM8_COURSE_CODE_1=trim($studentData[365]);
				$SEM8_COURSE_TITLE_1=trim($studentData[366]);
				$SEM8_CREDIT_HOURS_1=trim($studentData[367]);
				$SEM8_GRADE_POINT_1=trim($studentData[368]);
				$SEM8_CREDIT_POINTS_1=trim($studentData[369]);
				$SEM8_COURSE_CODE_2=trim($studentData[370]);
				$SEM8_COURSE_TITLE_2=trim($studentData[371]);
				$SEM8_CREDIT_HOURS_2=trim($studentData[372]);
				$SEM8_GRADE_POINT_2=trim($studentData[373]);
				$SEM8_CREDIT_POINTS_2=trim($studentData[374]);
				$TOTAL_CREDITS_CREDIT_HOURS=trim($studentData[375]);
				$TOTAL_CREDITS_CREDIT_POINTS=trim($studentData[376]);
				$OVERALL_GRADE_POINT_AVERAGE=trim($studentData[377]);
				$DATE=trim($studentData[378]);
				$Photo=trim($studentData[379]);
				...
				for ($x = 1; $x <= 8; $x++) {
					...
					if($x == 1){
						...
						$pdfBig->MultiCell(11, 31, ${"SEM7_COURSE_CODE_" . $x}, 'LB', 'L', 0, 0, '', '', true, 0, true);
						$pdfBig->setCellPaddings( $left = '', $top = '0', $right = '', $bottom = '');
					}
					if($x == 8){
				...
				$pdf->SetFont($arialb, '', 8, '', false);
				$pdf->SetXY(138, 60);		
				$pdf->Cell(0, 0, date("Y", strtotime($Date_of_successful_completion)), 0, false, 'L');
				...
				for ($x = 1; $x <= 8; $x++) {
					...
					if($x == 1){
						...
						$pdf->MultiCell(11, 31, ${"SEM7_COURSE_CODE_" . $x}, 'LB', 'L', 0, 0, '', '', true, 0, true);
						$pdf->setCellPaddings( $left = '', $top = '0', $right = '', $bottom = '');
					}
					if($x == 8){

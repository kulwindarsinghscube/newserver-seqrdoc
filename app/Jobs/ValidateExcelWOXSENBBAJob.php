...
class ValidateExcelWOXSENBBAJob
{
      ...
      //  print_r($rowData2[0]);
        ...
        $dropdown_template_id=$pdf_data['dropdown_template_id'];
              ...
              $rowData1[0] = array_filter($rowData1[0]);
                ...
                if($columnsCount1==27&&$columnsCount2==6){

                    $columnArr=array('Unique_ID', 'Student_Name', 'Mother_Name', 'Father_Name', 'Program', 'Academic_Year', 'PGID', 'Admission_ID', 'TC-1', 'T1_GPA', 'TC-2', 'T2_GPA', 'TC-3', 'T3_GPA', 'TC-4', 'T4_GPA', 'TC-5', 'T5_GPA', 'TC-6', 'T6_GPA', 'Total_Credits_Earned', 'CGPA', 'Serial_No', 'Major1', 'Major2', 'Major/ Minor', 'Month and Year');

...
class ValidateExcelGhrstuJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        if($dropdown_template_id==1){
            if($columnsCount1==107){
                //$photo_col=23;
				$columnArr=array("UNIQUE ID", "S.NO.","ROLL NO", "ABC / APAAR ID", "NAME FOR GRADE CARD", "MOTHER NAME", "FATHER NAME", "REGISTRATION NO", "UNIVERSITY ENROLLMENT NO", "TERM","ACADEMIC YEAR","SESSION","EXAMINATION", "PROGRAMME","GENDER","DATE OF BIRTH","BRANCH","EXAM REGISTRATION CREDITS","EARN CREDITS","GRADE POINTS EARNED","SGPA","CUMULATIVE CREDITS","CUMULATIVE EGP","CGPA","RESULT","RESULT DATE",
                "COURSE CODE1","COURSE NAME1","COMPONENT NAME1","CREDITS1","GRADES1","COURSE CODE2","COURSE NAME2","COMPONENT NAME2","CREDITS2","GRADES2","COURSE CODE3","COURSE NAME3","COMPONENT NAME3","CREDITS3","GRADES3","COURSE CODE4","COURSE NAME4","COMPONENT NAME4","CREDITS4","GRADES4","COURSE CODE5","COURSE NAME5","COMPONENT NAME5","CREDITS5","GRADES5","COURSE CODE6","COURSE NAME6","COMPONENT NAME6","CREDITS6","GRADES6",
                "COURSE CODE7","COURSE NAME7","COMPONENT NAME7","CREDITS7","GRADES7","COURSE CODE8","COURSE NAME8","COMPONENT NAME8","CREDITS8","GRADES8","COURSE CODE9","COURSE NAME9","COMPONENT NAME9","CREDITS9","GRADES9","COURSE CODE10","COURSE NAME10","COMPONENT NAME10","CREDITS10","GRADES10","COURSE CODE11","COURSE NAME11","COMPONENT NAME11","CREDITS11","GRADES11","COURSE CODE12","COURSE NAME12","COMPONENT NAME12","CREDITS12","GRADES12",
                "COURSE CODE13","COURSE NAME13","COMPONENT NAME13","CREDITS13","GRADES13","COURSE CODE14","COURSE NAME14","COMPONENT NAME14","CREDITS14","GRADES14","COURSE CODE15","COURSE NAME15","COMPONENT NAME15","CREDITS15","GRADES15","COURSE CODE16","COURSE NAME16","COMPONENT NAME16","CREDITS16","GRADES16","Equivalent Percentage");

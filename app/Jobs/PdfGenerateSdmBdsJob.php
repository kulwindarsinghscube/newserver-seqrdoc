...
class PdfGenerateSdmBdsJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
			...
			$pdfBig->MultiCell(20, 13, '', 'LR', 'C', 0, 0); //UE
			$pdfBig->SetXY(108, 97);
			...
			$pdfBig->MultiCell(22, 5, 'UNIVERSITY EXAMINATION', 0, 'C', 0, 0);
			$pdfBig->SetXY(110, 100);
			...
			$pdfBig->MultiCell(10, 0, 'SEC', 0, 'C', 0, 0);
			/******End pdfBig ******/ 
			...
			$pdf->SetXY(89.5, 97);	
			$pdf->MultiCell(20, 13, '', 'LR', 'C', 0, 0); //UE
			$pdf->SetXY(108, 97);
			...
			$pdf->SetXY(88.5, 97.5);
			$pdf->MultiCell(22, 5, 'UNIVERSITY EXAMINATION', 0, 'C', 0, 0);
			$pdf->SetXY(110, 100);
			...
			$pdf->MultiCell(10, 0, 'SEC', 0, 'C', 0, 0);
			...
			$pdfBig->Cell(188, 0, "BDS", 0, false, 'C');
			...
			foreach ($subjectsArr as $subjectDatas){
				...
				if ($th_pr_val == 'TH|PR') {
					...
					$pdfBig->MultiCell(9.666666666666667, $th_height_half, $T_Max_TH, 1, 'C', 0, 0);
					$pdfBig->MultiCell(9.666666666666667, $th_height_half, $T_Min_TH, 1, 'C', 0, 0);
					$pdfBig->MultiCell(9.666666666666667, $th_height_half, $T_Sec_TH, 1, 'C', 0, 0);
					$pdfBig->MultiCell(17, $th_height_half, $Remark_TH, 1, 'C', 0, 0);
					...
					$pdfBig->MultiCell(9.666666666666667, $th_height_half, $T_Max_PR, 1, 'C', 0, 0);
					$pdfBig->MultiCell(9.666666666666667, $th_height_half, $T_Min_PR, 1, 'C', 0, 0);
					$pdfBig->MultiCell(9.666666666666667, $th_height_half, $T_Sec_PR, 1, 'C', 0, 0);
					$pdfBig->MultiCell(17, $th_height_half, $Remark_PR, 1, 'C', 0, 0);
					//pdf
					...
					$pdf->MultiCell(9.666666666666667, $th_height_half2, $T_Max_TH, 1, 'C', 0, 0);
					$pdf->MultiCell(9.666666666666667, $th_height_half2, $T_Min_TH, 1, 'C', 0, 0);
					$pdf->MultiCell(9.666666666666667, $th_height_half2, $T_Sec_TH, 1, 'C', 0, 0);
					$pdf->MultiCell(17, $th_height_half2, $Remark_TH, 1, 'C', 0, 0);
					...
					$pdf->MultiCell(9.666666666666667, $th_height_half2, $T_Max_PR, 1, 'C', 0, 0);
					$pdf->MultiCell(9.666666666666667, $th_height_half2, $T_Min_PR, 1, 'C', 0, 0);
					$pdf->MultiCell(9.666666666666667, $th_height_half2, $T_Sec_PR, 1, 'C', 0, 0);
					$pdf->MultiCell(17, $th_height_half2, $Remark_PR, 1, 'C', 0, 0);					
			...
			$pdfBig->SetFont($MyriadProRegular, '', 10, '', false);
			$pdfBig->MultiCell(9.666666666666667, 5, $Grand_Total_Max, 1, 'C', 0, 0); 
			$pdfBig->MultiCell(9.666666666666667, 5, $Grand_Total_Min, 1, 'C', 0, 0); 
			$pdfBig->MultiCell(9.666666666666667, 5, $Grand_Total_Sec, 1, 'C', 0, 0); 
			$pdfBig->MultiCell(17, 5, '', 1, 'C', 0, 0); 
			$pdfBig->SetFont($MyriadProBold, 'B', 10, '', false);
			...
			*/
			...
			$pdf->SetFont($MyriadProRegular, '', 10, '', false);
			$pdf->MultiCell(9.666666666666667, 5, $Grand_Total_Max, 1, 'C', 0, 0); 
			$pdf->MultiCell(9.666666666666667, 5, $Grand_Total_Min, 1, 'C', 0, 0); 
			$pdf->MultiCell(9.666666666666667, 5, $Grand_Total_Sec, 1, 'C', 0, 0); 
			$pdf->MultiCell(17, 5, '', 1, 'C', 0, 0); 
			$pdf->SetFont($MyriadProBold, 'B', 10, '', false);

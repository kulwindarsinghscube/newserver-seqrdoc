    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
			...
			for ($lx = 1; $lx <= 4; $lx++) {
				...
				$pdf->MultiCell(60, 35, '', 'LRTB', 'L', 0, 0);
				$pdf->MultiCell(10, 35, '', 'LRTB', 'C', 0, 0);
				$pdf->MultiCell(8.5, 35, '', 'LRTB', 'C', 0, 0);
				$pdf->MultiCell(10.3, 35, '', 'LRTB', 'C', 0, 0); 
				$startY+=38.5;	
            }			
			//2nd Sem            
            $startSY=88.8;
			...
			for ($lx = 1; $lx <= 4; $lx++) {
				...
				$pdfBig->MultiCell(60, 35, '', 'LRTB', 'L', 0, 0);
				$pdfBig->MultiCell(10, 35, '', 'LRTB', 'C', 0, 0);
				$pdfBig->MultiCell(8.5, 35, '', 'LRTB', 'C', 0, 0);
				$pdfBig->MultiCell(10.3, 35, '', 'LRTB', 'C', 0, 0); 
				$startY+=38.5;	
            }			
			//2nd Sem            
            $startSY=88.8;

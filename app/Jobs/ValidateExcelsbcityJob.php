...
class ValidateExcelsbcityJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        // $columnsCount1 = max(array_keys($rowData1[0])) + 1;
        $rowData1[0] = array_values($rowData1[0]);   // re-index after filter
        $columnsCount1 = count($rowData1[0]);        // accurate count
        ...
        if ($dropdown_template_id == 1) {
            ...
            //         "CIA Min_6","CIA Obt_6","SEM Max_6","SEM Min_6","SEM Obt_6","Total Max_6","Total Min_6","Total Obt_6","Grade_6","Grade Points_6","Credits Earned_6","CG_6","SGPI","Result","Credits Earned","Total","Î£C","Î£CG","Place","Print Date","Result Date","PHOTO");

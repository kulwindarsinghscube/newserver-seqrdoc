...
use Helper;
class PdfGenerateSdmMbbsIIIPartIIMainJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
			...
			$pdf->SetXY(69, 106);	
			$pdf->MultiCell(111, 0, '', 'T', 'C', 0, 0);	//UIT HR Line
			...
			$Sr_no3 = trim($studentData[26]);	//Subject 3		
			$Subject3 = trim($studentData[27]);
			$T_Max3 = trim($studentData[28]);
			$T_Min3 = trim($studentData[29]);
			$T_OBT3 = trim($studentData[30]);			
			$TA_Max2 = trim($studentData[31]);
			$TA_Min2 = trim($studentData[32]);
			$TA_OBT2 = trim($studentData[33]);
			$PV_MAX2 = trim($studentData[34]);
			$PV_MIN2 = trim($studentData[35]);
			$PV_OBT2 = trim($studentData[36]);
			$TOTAL_MAX2 = trim($studentData[37]);
			$TOTAL_MIN2 = trim($studentData[38]);
			$TOTAL_OBT2 = trim($studentData[39]);
			$REMARK2 = trim($studentData[40]);
			
			$Sr_no4 = trim($studentData[41]);			
			$Subject4 = trim($studentData[42]);
			$T_Max4 = trim($studentData[43]);
			$T_Min4 = trim($studentData[44]);
			$T_OBT4 = trim($studentData[45]);
			$Sr_no5 = trim($studentData[46]);	//Subject 5			
			$Subject5 = trim($studentData[47]);
			$T_Max5 = trim($studentData[48]);
			$T_Min5 = trim($studentData[49]);
			$T_OBT5 = trim($studentData[50]);			
			$TA_Max3 = trim($studentData[51]);
			$TA_Min3 = trim($studentData[52]);
			$TA_OBT3 = trim($studentData[53]);
			$PV_MAX3 = trim($studentData[54]);
			$PV_MIN3 = trim($studentData[55]);
			$PV_OBT3 = trim($studentData[56]);
			$TOTAL_MAX3 = trim($studentData[57]);
			$TOTAL_MIN3 = trim($studentData[58]);
			$TOTAL_OBT3 = trim($studentData[59]);
			$REMARK3 = trim($studentData[60]);
			
			$Sr_no6 = trim($studentData[61]);
			$Subject6 = trim($studentData[62]);
			$T_Max6 = trim($studentData[63]);
			$T_Min6 = trim($studentData[64]);
			$T_OBT6 = trim($studentData[65]);
			$Sr_no7 = trim($studentData[66]);			
			$Subject7 = trim($studentData[67]);
			$T_Max7 = trim($studentData[68]);
			$T_Min7 = trim($studentData[69]);
			$T_OBT7 = trim($studentData[70]);
			$TA_Max4 = trim($studentData[71]);
			$TA_Min4 = trim($studentData[72]);
			$TA_OBT4 = trim($studentData[73]);
			$PV_MAX4 = trim($studentData[74]);
			$PV_MIN4 = trim($studentData[75]);
			$PV_OBT4 = trim($studentData[76]);
			$TOTAL_MAX4 = trim($studentData[77]);
			$TOTAL_MIN4 = trim($studentData[78]);
			$TOTAL_OBT4 = trim($studentData[79]);
			$REMARK4 = trim($studentData[80]);
			
			$Total_UE_MAX = trim($studentData[81]);
			$Total_UE_MIN = trim($studentData[82]);
			$Total_UE_OBT = trim($studentData[83]);
			$Total_IA_MAX = trim($studentData[84]);
			$Total_IA_MIN = trim($studentData[85]);
			$Total_IA_OBT = trim($studentData[86]);			
			$Total_UEIA_MAX = trim($studentData[87]);
			$Total_UEIA_MIN = trim($studentData[88]);
			$Total_UEIA_OBT = trim($studentData[89]);
			$Grand_Total_In_Words = trim($studentData[90]);
			$Percentage = trim($studentData[91]);
			$Result = strtoupper(trim($studentData[92]));
			
			//INTERNAL ASSESSMENT(IA)
			$IA_SL_no1 = strtoupper(trim($studentData[93]));
			$IA_Subject_no1 = strtoupper(trim($studentData[94]));
			$IA_T_Max1 = strtoupper(trim($studentData[95]));
			$IA_T_Min1 = strtoupper(trim($studentData[96]));
			$IA_T_OBT1 = strtoupper(trim($studentData[97]));
			$IA_P_Max1 = strtoupper(trim($studentData[98]));
			$IA_P_Min1 = strtoupper(trim($studentData[99]));
			$IA_P_OBT1 = strtoupper(trim($studentData[100]));
			$IA_TO_MAX1 = strtoupper(trim($studentData[101]));
			$IA_TO_MIN1 = strtoupper(trim($studentData[102]));
			$IA_TO_OBT1 = strtoupper(trim($studentData[103]));
			
			$IA_SL_no2 = strtoupper(trim($studentData[104]));
			$IA_Subject_no2 = strtoupper(trim($studentData[105]));
			$IA_T_Max2 = strtoupper(trim($studentData[106]));
			$IA_T_Min2 = strtoupper(trim($studentData[107]));
			$IA_T_OBT2 = strtoupper(trim($studentData[108]));
			$IA_P_Max2 = strtoupper(trim($studentData[109]));
			$IA_P_Min2 = strtoupper(trim($studentData[110]));
			$IA_P_OBT2 = strtoupper(trim($studentData[111]));
			$IA_TO_MAX2 = strtoupper(trim($studentData[112]));
			$IA_TO_MIN2 = strtoupper(trim($studentData[113]));
			$IA_TO_OBT2 = strtoupper(trim($studentData[114]));
			
			$IA_SL_no3 = strtoupper(trim($studentData[115]));
			$IA_Subject_no3 = strtoupper(trim($studentData[116]));
			$IA_T_Max3 = strtoupper(trim($studentData[117]));
			$IA_T_Min3 = strtoupper(trim($studentData[118]));
			$IA_T_OBT3 = strtoupper(trim($studentData[119]));
			$IA_P_Max3 = strtoupper(trim($studentData[120]));
			$IA_P_Min3 = strtoupper(trim($studentData[121]));
			$IA_P_OBT3 = strtoupper(trim($studentData[122]));
			$IA_TO_MAX3 = strtoupper(trim($studentData[123]));
			$IA_TO_MIN3 = strtoupper(trim($studentData[124]));
			$IA_TO_OBT3 = strtoupper(trim($studentData[125]));
			
			$IA_SL_no4 = strtoupper(trim($studentData[126]));
			$IA_Subject_no4 = strtoupper(trim($studentData[127]));
			$IA_T_Max4 = strtoupper(trim($studentData[128]));
			$IA_T_Min4 = strtoupper(trim($studentData[129]));
			$IA_T_OBT4 = strtoupper(trim($studentData[130]));
			$IA_P_Max4 = strtoupper(trim($studentData[131]));
			$IA_P_Min4 = strtoupper(trim($studentData[132]));
			$IA_P_OBT4 = strtoupper(trim($studentData[133]));
			$IA_TO_MAX4 = strtoupper(trim($studentData[134]));
			$IA_TO_MIN4 = strtoupper(trim($studentData[135]));
			$IA_TO_OBT4 = strtoupper(trim($studentData[136]));
			
			$ELIGIBILITY_FOR_UE = strtoupper(trim($studentData[137]));
			$GRAND_TOTAL_MAX = strtoupper(trim($studentData[138]));
			$GRAND_TOTAL_MIN = strtoupper(trim($studentData[139]));
			$GRAND_TOTAL_OBT = strtoupper(trim($studentData[140]));			
			$Date = trim($studentData[141]);
			$batch_of_qr = trim($studentData[143]);
			$aadhar_number_qr = trim($studentData[144]);
			$DOB = trim($studentData[145]);			
			$course = strtoupper(trim($studentData[146]));            
			...
			$pdfBig->MultiCell(15, 10, $REMARK2, 'LR', 'C', 0, 0);
			...
			$pdf->MultiCell(15, 10, $REMARK2, 'LR', 'C', 0, 0);
			...
			$pdfBig->setCellPaddings( $left = '', $top = 3, $right = '', $bottom = '');
			$pdfBig->SetFont($MyriadProRegular, '', 7.5, '', false);
			$pdfBig->MultiCell(9.5, 10, '3', 'LR', 'C', 0, 0);
			$pdfBig->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			$pdfBig->SetFont($MyriadProRegular, '', 7, '', false);
			...
			$pdfBig->setCellPaddings( $left = '', $top = 3, $right = '', $bottom = '');
			$pdfBig->MultiCell(9, 10, $TA_Max3, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(9, 10, $TA_Min3, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(9, 10, $TA_OBT3, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(9, 10, $PV_MAX3, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(9, 10, $PV_MIN3, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(9, 10, $PV_OBT3, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(10, 10, $TOTAL_MAX3, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(10, 10, $TOTAL_MIN3, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(10, 10, $TOTAL_OBT3, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(15, 10, $REMARK3, 'LR', 'C', 0, 0);
			
			$pdf->SetXY($left_str_x, $subj_y);
			$pdf->setCellPaddings( $left = '', $top = 3, $right = '', $bottom = '');
			$pdf->SetFont($MyriadProRegular, '', 7.5, '', false);
			$pdf->MultiCell(9.5, 10, '3', 'LR', 'C', 0, 0);
			$pdf->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			$pdf->SetFont($MyriadProRegular, '', 7, '', false);
			...
			$pdf->setCellPaddings( $left = '', $top = 3, $right = '', $bottom = '');
			$pdf->MultiCell(9, 10, $TA_Max3, 'LR', 'C', 0, 0);
			$pdf->MultiCell(9, 10, $TA_Min3, 'LR', 'C', 0, 0);
			$pdf->MultiCell(9, 10, $TA_OBT3, 'LR', 'C', 0, 0);
			$pdf->MultiCell(9, 10, $PV_MAX3, 'LR', 'C', 0, 0);
			$pdf->MultiCell(9, 10, $PV_MIN3, 'LR', 'C', 0, 0);
			$pdf->MultiCell(9, 10, $PV_OBT3, 'LR', 'C', 0, 0);
			$pdf->MultiCell(10, 10, $TOTAL_MAX3, 'LR', 'C', 0, 0);
			$pdf->MultiCell(10, 10, $TOTAL_MIN3, 'LR', 'C', 0, 0);
			$pdf->MultiCell(10, 10, $TOTAL_OBT3, 'LR', 'C', 0, 0);
			$pdf->MultiCell(15, 10, $REMARK3, 'LR', 'C', 0, 0);
			...
			$pdfBig->SetFont($MyriadProRegular, '', 7.5, '', false);
			$pdfBig->MultiCell(9, 5, $T_Max5, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(9, 5, $T_Min5, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(9, 5, $T_OBT5, 'LR', 'C', 0, 0);	
			$pdfBig->setCellPaddings( $left = '', $top = 0, $right = '', $bottom = '');	
			...
			$pdf->SetFont($MyriadProRegular, '', 7.5, '', false);
			$pdf->MultiCell(9, 5, $T_Max5, 'LR', 'C', 0, 0);
			$pdf->MultiCell(9, 5, $T_Min5, 'LR', 'C', 0, 0);
			$pdf->MultiCell(9, 5, $T_OBT5, 'LR', 'C', 0, 0);	
			$pdf->setCellPaddings( $left = '', $top = 0, $right = '', $bottom = '');
			...
			$pdfBig->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			$pdfBig->SetFont($MyriadProRegular, '', 7, '', false);
			$pdfBig->MultiCell(44.5, 5, $Subject6, 0, 'L', 0, 0);					
			$pdfBig->SetFont($MyriadProRegular, '', 7.5, '', false);
			$pdfBig->MultiCell(9, 5, $T_Max6, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(9, 5, $T_Min6, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(9, 5, $T_OBT6, 'LR', 'C', 0, 0);
			$pdfBig->setCellPaddings( $left = '', $top = 3, $right = '', $bottom = '');
			$pdfBig->MultiCell(9, 10, $TA_Max4, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(9, 10, $TA_Min4, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(9, 10, $TA_OBT4, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(9, 10, $PV_MAX4, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(9, 10, $PV_MIN4, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(9, 10, $PV_OBT4, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(10, 10, $TOTAL_MAX4, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(10, 10, $TOTAL_MIN4, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(10, 10, $TOTAL_OBT4, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(15, 10, $REMARK4, 'LR', 'C', 0, 0);
			...
			$pdf->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			$pdf->SetFont($MyriadProRegular, '', 7, '', false);
			$pdf->MultiCell(44.5, 5, $Subject6, 0, 'L', 0, 0);					
			$pdf->SetFont($MyriadProRegular, '', 7.5, '', false);
			$pdf->MultiCell(9, 5, $T_Max6, 'LR', 'C', 0, 0);
			$pdf->MultiCell(9, 5, $T_Min6, 'LR', 'C', 0, 0);
			$pdf->MultiCell(9, 5, $T_OBT6, 'LR', 'C', 0, 0);
			$pdf->setCellPaddings( $left = '', $top = 3, $right = '', $bottom = '');
			$pdf->MultiCell(9, 10, $TA_Max4, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(9, 10, $TA_Min4, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(9, 10, $TA_OBT4, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(9, 10, $PV_MAX4, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(9, 10, $PV_MIN4, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(9, 10, $PV_OBT4, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(10, 10, $TOTAL_MAX4, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(10, 10, $TOTAL_MIN4, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(10, 10, $TOTAL_OBT4, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(15, 10, $REMARK4, 'LRB', 'C', 0, 0);
			
			$subj_y=$pdfBig->GetY()+5;
			$pdfBig->SetXY(24.5, $subj_y);
			$pdfBig->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			$pdfBig->SetFont($MyriadProRegular, '', 7, '', false);
			$pdfBig->MultiCell(44.5, 5, $Subject7, 'B', 'L', 0, 0);	
			$pdfBig->SetFont($MyriadProRegular, '', 7.5, '', false);	
			$pdfBig->MultiCell(9, 5, $T_Max7, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(9, 5, $T_Min7, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(9, 5, $T_OBT7, 'LRB', 'C', 0, 0);	
			$pdfBig->setCellPaddings( $left = '', $top = 0, $right = '', $bottom = '');		
			
			$pdf->SetXY(24.5, $subj_y);
			$pdf->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			$pdf->SetFont($MyriadProRegular, '', 7, '', false);
			$pdf->MultiCell(44.5, 5, $Subject7, 'B', 'L', 0, 0);	
			$pdf->SetFont($MyriadProRegular, '', 7.5, '', false);	
			$pdf->MultiCell(9, 5, $T_Max7, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(9, 5, $T_Min7, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(9, 5, $T_OBT7, 'LRB', 'C', 0, 0);	
			$pdf->setCellPaddings( $left = '', $top = 0, $right = '', $bottom = '');	
			...
			$pdfBig->SetXY($left_str_x, $subj_y);
			$pdfBig->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			$pdfBig->MultiCell(135, 5, 'GRAND TOTAL IN WORDS : ', 'L', 'R', 0, 0);
			$pdfBig->MultiCell(45, 5, $Grand_Total_In_Words, 'LR', 'L', 0, 0);
			
			$pdf->SetXY($left_str_x, $subj_y);
			$pdf->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			$pdf->MultiCell(135, 5, 'GRAND TOTAL IN WORDS : ', 'L', 'R', 0, 0);
			$pdf->MultiCell(45, 5, $Grand_Total_In_Words, 'LR', 'L', 0, 0);
			
			$subj_y=$pdfBig->GetY()+5;
			$pdfBig->SetXY($left_str_x, $subj_y);
			$pdfBig->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			$pdfBig->MultiCell(135, 5, 'PERCENTAGE : ', 'L', 'R', 0, 0);
			$pdfBig->MultiCell(45, 5, $Percentage, 'LR', 'L', 0, 0);
			
			$pdf->SetXY($left_str_x, $subj_y);
			$pdf->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			$pdf->MultiCell(135, 5, 'PERCENTAGE : ', 'L', 'R', 0, 0);
			$pdf->MultiCell(45, 5, $Percentage, 'LR', 'L', 0, 0);
			...
			$pdfBig->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			$pdfBig->SetFont($MyriadProRegular, '', 8.5, '', false);
			$pdfBig->SetXY(87, 177.8);
			$pdfBig->MultiCell(10, 4, 'MAX', 'RT', 'C', 0, 0);
			$pdfBig->MultiCell(10, 4, 'MIN', 'LRT', 'C', 0, 0);
			$pdfBig->MultiCell(10, 4, 'OBT', 'LT', 'C', 0, 0);
			$pdfBig->MultiCell(10, 4, 'MAX', 'RT', 'C', 0, 0);
			$pdfBig->MultiCell(10, 4, 'MIN', 'LRT', 'C', 0, 0);
			$pdfBig->MultiCell(10, 4, 'OBT', 'LT', 'C', 0, 0);
			$pdfBig->MultiCell(10, 4, 'MAX', 'RT', 'C', 0, 0);
			...
			$pdf->SetFont($MyriadProRegular, '', 8.5, '', false);
			$pdf->SetXY(87, 177.8);
			$pdf->MultiCell(10, 4, 'MAX', 'RT', 'C', 0, 0);
			$pdf->MultiCell(10, 4, 'MIN', 'LRT', 'C', 0, 0);
			$pdf->MultiCell(10, 4, 'OBT', 'LT', 'C', 0, 0);
			$pdf->MultiCell(10, 4, 'MAX', 'RT', 'C', 0, 0);
			$pdf->MultiCell(10, 4, 'MIN', 'LRT', 'C', 0, 0);
			$pdf->MultiCell(10, 4, 'OBT', 'LT', 'C', 0, 0);
			$pdf->MultiCell(10, 4, 'MAX', 'RT', 'C', 0, 0);

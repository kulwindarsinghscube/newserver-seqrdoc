...
class ValidateExcelLnctPhdJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        if($dropdown_template_id==1){
            if($columnsCount1==13){
                $photo_col=23;
				$columnArr=array("S.No.","Enrolment no","Name_E ","Name_H","Topic_E","Topic_H","Feculty_E","Feculty_H","Subject_E","Subject_H","Passing Year","PLACE","DATE");

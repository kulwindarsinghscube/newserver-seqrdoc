    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        if($studentData[$photo_col]!=''){
            ...
            if(file_exists($profile_path_org)) {
                ...
                // \File::copy($profile_path_org,$bw_location);
                }
               //
            }
        }
        ...
        $pdf->SetXY(15, 46);
        $pdf->Cell(0, 0, "Convocation Id: ".$studentData[1], 0, false, 'L');    
        
        $pdfBig->SetFont($arialNarrowB, '', 10, '', false);
        $pdfBig->SetXY(15, 46);
        $pdfBig->Cell(0, 0, "Convocation Id: ".$studentData[1], 0, false, 'L');
...
<table id="table1" cellspacing="0" cellpadding="2" border="0.1" width="86%" rules="rows">
   <tr>
    <td colspan="2"> Name of the Learner :  {$studentData[2]}</td>
   </tr>
   <tr>
    <td style="width:12%;"> Programme :</td>
    <td style="width:88%;">{$studentData[3]}</td>
   </tr>
   <tr>
    <td style="width:50%;"> Semester : {$studentData[4]}</td>
    <td style="width:50%;"> Month and Year of Examination : {$studentData[7]}</td>
   </tr>
   <tr>
    <td style="width:50%;"> Roll No.: {$studentData[5]}</td>
    <td style="width:50%;"> PRN/Reg.No.: {$studentData[8]}</td>
   </tr>
   <tr>
    <td style="width:50%;"> Seat No.: {$studentData[6]}</td>
    <td style="width:50%;"> UID No.: {$studentData[9]}</td>
   </tr>
  </table>
EOD;
...
//invisible data
        ...
        $invisible_namestr = $studentData[2];
   ...
   /* imagefilter($profile_path, IMG_FILTER_GRAYSCALE);
    ...
    $subjectData = array_slice($studentData, 10, 120);
    ...
    <th style="width:6%;text-align:center;"><b>'.$studentData[130].'</b></th>
    <th style="width:7%;text-align:center;"><b>'.$studentData[131].'</b></th>
    <th style="width:6%;text-align:center;"><b>'.$studentData[132].'</b></th>
    <th style="width:7%;text-align:center;"><b>'.$studentData[133].'</b></th>
    <th style="width:5%;text-align:center;"><b>'.$studentData[134].'</b></th>
    <th style="width:5%;text-align:center;"><b></b></th>
    <th style="width:6%;text-align:center;"><b>'.$studentData[135].'</b></th>
    <th style="width:6%;text-align:center;"><b>'.$studentData[136].'</b></th>
    <th style="width:6%;text-align:center;"><b>'.$studentData[137].'</b></th>
    <th style="width:6%;text-align:center;"><b>'.$studentData[138].'</b></th>
   </tr>';

    $strtdBig .= '<tr>
    <th style="width:11%;text-align:center;"></th>
    <th style="width:29%;text-align:center;">Total</th>
    <th style="width:6%;text-align:center;"><b>'.$studentData[130].'<br><span style="color:yellow;">'.$studentData[130].'</span></b></th>
    <th style="width:7%;text-align:center;"><b>'.$studentData[131].'<br><span style="color:yellow;">'.$studentData[131].'</span></b></th>
    <th style="width:6%;text-align:center;"><b>'.$studentData[132].'<br><span style="color:yellow;">'.$studentData[132].'</span></b></th>
    <th style="width:7%;text-align:center;"><b>'.$studentData[133].'<br><span style="color:yellow;">'.$studentData[133].'</span></b></th>
    <th style="width:5%;text-align:center;"><b>'.$studentData[134].'<br><span style="color:yellow;">'.$studentData[134].'</span></b></th>
    <th style="width:5%;text-align:center;"><b></b></th>
    <th style="width:6%;text-align:center;"><b>'.$studentData[135].'<br><span style="color:yellow;">'.$studentData[135].'</span></b></th>
    <th style="width:6%;text-align:center;"><b>'.$studentData[136].'<br><span style="color:yellow;">'.$studentData[136].'</span></b></th>
    <th style="width:6%;text-align:center;"><b>'.$studentData[137].'<br><span style="color:yellow;">'.$studentData[137].'</span></b></th>
    <th style="width:6%;text-align:center;"><b>'.$studentData[138].'<br><span style="color:yellow;">'.$studentData[138].'</span></b></th>
   </tr>';
...
$pdfBig->writeHTMLCell($w=0, $h=0, $x='12', $y='79', $htmlBig, $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true);//79
...
<table id="table4" cellspacing="0" cellpadding="2" border="0.1" width="99%">
    <tr>
    <th colspan="2" style="width:20%;text-align:left;">Remark : {$studentData[139]}</th>
    <th style="width:22%;text-align:left;">Grade : {$studentData[140]}</th>
    <th style="width:20%;text-align:left;">Credit Earned : {$studentData[141]}</th>
    <th style="width:13%;text-align:left;">SGPI : {$studentData[142]}</th>
    <th style="width:25%;text-align:left;"></th>
    </tr>
    <tr>
      <td style="width:16%;text-align:left;">Credit Earned</td>
    <td style="width:14%;text-align:left;">Sem I : <b>{$studentData[143]}</b></td>
    <td style="width:14%;text-align:left;">Sem II : <b>{$studentData[144]}</b></td>
    <td style="width:14%;text-align:left;">Sem III : <b>{$studentData[145]}</b></td>
    <td style="width:14%;text-align:left;">Sem IV : <b>{$studentData[146]}</b></td>
    <td style="width:14%;text-align:center;font-weight:normal;">Overall CGPI</td>
    <td style="width:14%;text-align:center;"><b>{$studentData[151]}</b></td>
    </tr>
    <tr>
      <td style="width:16%;text-align:left;">Grade Earned</td>
    <td style="width:14%;text-align:left;">Sem I : <b>{$studentData[147]}</b></td>
    <td style="width:14%;text-align:left;">Sem II : <b>{$studentData[148]}</b></td>
    <td style="width:14%;text-align:left;">Sem III : <b>{$studentData[149]}</b></td>
    <td style="width:14%;text-align:left;">Sem IV : <b>{$studentData[150]}</b></td>
    <td style="width:14%;text-align:center;font-weight:normal;">Overall Grade</td>
    <td style="width:14%;text-align:center;"><b>{$studentData[152]}</b></td>
    </tr>
</table>
EOD;
$pdf->writeHTMLCell($w=0, $h=0, $x='12', $y='199', $html, $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true);
$pdfBig->writeHTMLCell($w=0, $h=0, $x='12', $y='201', $html, $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true);//199
if(!empty($studentData[154])){

$issue_date=date('d/m/Y',strtotime($studentData[154])); 
...
<table id="table5" cellspacing="0" cellpadding="2" border="0" width="99%">
   ...
   <tr>
    ...
    <tr>
    <th style="width:20%;text-align:left;" class="no-border-right">Place : {$studentData[153]}</th>
    <th style="width:31%;text-align:center;" class="no-border-right">Date : {$issue_date}</th>
    <th style="width:12%;text-align:center;"></th>
    <th style="width:12%;text-align:center;"></th>
    <td style="width:12%;text-align:center;"></td>
    <td style="width:13%;text-align:center;"></td>
...
// Ghost image
        ...
        $codeContents = "Name of the Learner: ".$studentData[2]."\nPRN/Reg.No: ".$studentData[8]."\nMonths & Year of Examination: ".$studentData[7]."\n\n".$encryptedString;

...
class PdfGenerateSdmMscResitJob{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
			...
			$pdfBig->MultiCell(181.5, 13, '', 'LRTB', 'C', 0, 0);	//Entire Table
			...
			$pdfBig->MultiCell(19, 5, 'REMARK', 0, 'C', 0, 0);
			...
			$pdf->MultiCell(181.5, 13, '', 'LRTB', 'C', 0, 0);	//Entire Table
			$pdf->SetXY(62.5, 106);	
			...
			$pdf->SetXY(181, 100);
			$pdf->MultiCell(19, 5, 'REMARK', 0, 'C', 0, 0);
			$pdf->SetXY(62, 106);
			...
			foreach ($subjectsArr as $subjectDatas){
                ...
                $pdfBig->MultiCell(11.5, $th_height_half, $Remark, 1, 'C', 0, 0);
                ...
                $pdf->MultiCell(11.5, $th_height_half, $Remark, 1, 'C', 0, 0);
			...
			$pdfBig->MultiCell(11.5, 5, $Result, 1, 'C', 0, 0);
            ...
            $pdfBig->MultiCell(21, 5, 'AB', 1, 'C', 0, 0);
            ...
            $pdfBig->MultiCell(21, 5, '0', 1, 'C', 0, 0);
            ...
            $pdfBig->MultiCell(21, 5, 'ABSENT', 1, 'C', 0, 0);
            ...
            $pdf->MultiCell(21, 5, 'ABSENT', 1, 'C', 0, 0);

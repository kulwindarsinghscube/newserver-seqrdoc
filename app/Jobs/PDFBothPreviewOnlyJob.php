...
class PDFBothPreviewOnlyJob 
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        // echo $pdf_data['back_bg_template_img'];
        ...
        for($excel_row = $excel_row_num; $excel_row <= $highestRow; $excel_row++)
        {
            ...
            if(!$isPreview) {
                ...
                if ($FID['is_mapped'][0] == 'excel') {
                    ...
                    $firstRow =$sheet->rangeToArray('A1:' . $highestColumn .'1', NULL, TRUE, FALSE);  // Changes rohit 23/05/2023
                ...
                else
                {
                    ...
                    $firstRow = $get_mapped_data[0]; //Changes rohit 23/05/2023
                }
                            ...
                            if(!$isPreview) {
                                ...
                                if($FID['infinite_height'][$extra_fields] != 1){
                                    ...
                                    if ($FID['visible'][$extra_fields] == 0) {
                                        ...
                                        $pdfBig->SetAlpha(1);
                                       // if($subdomain[0]=="cu"){
                                       //  print_r($FID['data'][$extra_fields]);
                                       //  echo "<br>";
                                       // }

                                        if(($extra_fields==86&&isset($FID['data'][86])&&$template_name=="GalgotiyaUniversity")||($extra_fields==111&&isset($FID['data'][111])&&$template_name=="GalgotiyaUniversity-copy")||($subdomain[0]=="cu" && $FID['template_id']==1 && $extra_fields==9 && isset($FID['data'][9]))){
                                       ...
                                       foreach ($strArr as $character) {
                                            ...
                                            $i++;
                                            if($subdomain[0]=="cu" && $FID['template_id']==1 && $extra_fields==9 && isset($FID['data'][9])){
                                                $x=$x+3.5+$j; 
                                            }else{
                                                $x=$x+2.2+$j; 
                                            }
            ...
            if($subdomain[0] == 'demo') {
                if($FID['is_back_template'] == 1) {
                    ...
                    if($back_bg_template_img != ''){
                        ...
                        //echo $back_template_img;
                        $pdfBig->Image($back_template_img, 0, 0, $back_bg_template_width, $back_bg_template_height, $image_extension, '', 'R', true);



                        // $basename = basename($back_bg_template_img);
                        // $template_img = str_replace(' ', '_', $back_bg_template_img);
                        // // $template_img = $back_bg_template_img;    
                        // $ext = pathinfo($back_bg_template_img, PATHINFO_EXTENSION);
                        ...
                        // $pdfBig->Image($template_img_new, 0, 0, $back_bg_template_width, $back_bg_template_height, $image_extension, '', 'R', true);
                        ...
                        switch  ($security_type) {
                            ...
                            case 'Normal':
                                    ...
                                    if(!$isPreview) {
                                        ...
                                        $cell = $sheet->getCellByColumnAndRow($FID_BACK['mapped_excel_col'][$extra_fields], $excel_row);
                                        ...
                                        if($FID_BACK['infinite_height'][$extra_fields] != 1){
                                            ...
                                            if ($FID_BACK['visible'][$extra_fields] == 0) {
                                                ...
                                                $pdfBig->SetAlpha(1);
                                            // if($subdomain[0]=="cu"){
                                            //  print_r($FID_BACK['data'][$extra_fields]);
                                            //  echo "<br>";
                                            // }
                    
                                                if(($extra_fields==86&&isset($FID_BACK['data'][86])&&$template_name=="GalgotiyaUniversity")||($extra_fields==111&&isset($FID_BACK['data'][111])&&$template_name=="GalgotiyaUniversity-copy")||($subdomain[0]=="cu" && $FID_BACK['template_id']==1 && $extra_fields==9 && isset($FID_BACK['data'][9]))){
                                            $strArr = str_split($str);
                                            ...
                                            foreach ($strArr as $character) {
                                                    ...
                                                    $pdfBig->Cell($width, 0, $character, 0, $ln=0,  $text_align, 0, '', 0, false, 'B', 'B');
                                                    $i++;
                                                    if($subdomain[0]=="cu" && $FID_BACK['template_id']==1 && $extra_fields==9 && isset($FID_BACK['data'][9])){
                                                        $x=$x+3.5+$j; 
                                                    }else{
                                                        $x=$x+2.2+$j; 
                                                    }

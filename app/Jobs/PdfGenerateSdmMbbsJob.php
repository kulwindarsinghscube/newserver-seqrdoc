...
class PdfGenerateSdmMbbsJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
			...
			$pdfBig->MultiCell(15, 10, $REMARK1, 'LR', 'C', 0, 0);
			...
			$pdf->MultiCell(15, 10, $REMARK1, 'LR', 'C', 0, 0);
			...
			$pdfBig->MultiCell(9, 5, $T_Max6, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(9, 5, $T_Min6, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(9, 5, $T_OBT6, 'LRB', 'C', 0, 0);	
			$pdfBig->setCellPaddings( $left = '', $top = 0, $right = '', $bottom = '');	

			$pdf->SetXY(24.5, $subj_y);
			$pdf->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			$pdf->MultiCell(44.5, 5, $Subject6, 'B', 'L', 0, 0);					
			$pdf->MultiCell(9, 5, $T_Max6, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(9, 5, $T_Min6, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(9, 5, $T_OBT6, 'LRB', 'C', 0, 0);	
			$pdf->setCellPaddings( $left = '', $top = 0, $right = '', $bottom = '');	
			...
			$pdfBig->SetXY($left_str_x, $subj_y);
			$pdfBig->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			$pdfBig->MultiCell(135, 5, 'TOTAL IN WORDS ', 'L', 'R', 0, 0);
			$pdfBig->MultiCell(45, 5, $Grand_Total_In_Words, 'LR', 'L', 0, 0);
			
			$pdf->SetXY($left_str_x, $subj_y);
			$pdf->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			$pdf->MultiCell(135, 5, 'TOTAL IN WORDS ', 'L', 'R', 0, 0);

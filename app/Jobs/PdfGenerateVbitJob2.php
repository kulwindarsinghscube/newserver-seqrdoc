    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        if($studentDataOrg && !empty($studentDataOrg)){
            foreach ($studentDataOrg as $studentData) {
                ...
                //1st Sem            
                $pdf->SetXY(12.4, 88.5);   
                $pdf->MultiCell(8, 35, '','LRTB', 'L', 0, 0);
                $pdf->MultiCell(119, 35, '', 'LRTB', 'C', 0, 0);
                $pdf->MultiCell(18, 35, '', 'LRTB', 'C', 0, 0);
                $pdf->MultiCell(18, 35, '', 'LRTB', 'C', 0, 0);
                $pdf->MultiCell(19.5, 35, '', 'LRTB', 'C', 0, 0);            
                    
                //2nd Sem            
                $pdf->SetXY(12.4, 126.5);   //130.5
                $pdf->MultiCell(8, 35, '','LRTB', 'L', 0, 0);
                $pdf->MultiCell(119, 35, '', 'LRTB', 'C', 0, 0);
                $pdf->MultiCell(18, 35, '', 'LRTB', 'C', 0, 0);
                $pdf->MultiCell(18, 35, '', 'LRTB', 'C', 0, 0);
                ...
                $pdfBig->MultiCell(8, 35, '','LRTB', 'L', 0, 0);
                $pdfBig->MultiCell(119, 35, '', 'LRTB', 'C', 0, 0);
                $pdfBig->MultiCell(18, 35, '', 'LRTB', 'C', 0, 0);
                $pdfBig->MultiCell(18, 35, '', 'LRTB', 'C', 0, 0);
                $pdfBig->MultiCell(19.5, 35, '', 'LRTB', 'C', 0, 0);            
                    
                //2nd Sem            
                $pdfBig->SetXY(12.4, 126.5);   //130.5
                $pdfBig->MultiCell(8, 35, '','LRTB', 'L', 0, 0);
                $pdfBig->MultiCell(119, 35, '', 'LRTB', 'C', 0, 0);
                $pdfBig->MultiCell(18, 35, '', 'LRTB', 'C', 0, 0);
                $pdfBig->MultiCell(18, 35, '', 'LRTB', 'C', 0, 0);
                ...
                $pdf->SetXY($title1_x, $left_title6_y+2);
                ...
                $pdf->SetXY($left_str_x+15, $left_title6_y+2);
                ...
                $pdfBig->SetXY($left_str_x+15, $left_title6_y+2);

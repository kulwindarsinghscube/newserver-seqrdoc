...
class ValidateExcelAiimsJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        if($dropdown_template_id==1){
            if($columnsCount1 == 10){
                $columnArr=array("unique_id","serial_no","name","father_name","enrolment_no","Subject_Name","Pass out year","Admision date","pass out date","place","date");
        ...
        elseif($dropdown_template_id==2){
            if($columnsCount1 == 9){
                $columnArr=array("unique_id","name","enrolment_no","seat_no","attemptHindi ","attemptEnglish ","Pass out year","place","date");
                $mismatchColArr=array_diff($rowData1[0], $columnArr);
                if(count($mismatchColArr)>0){                    
                    return response()->json(['success'=>false,'type' => 'error', 'message' => 'Sheet1/Json : Column names not matching as per requirement. Please check columns : '.implode(',', $mismatchColArr)]);
                }
        ...
        elseif($dropdown_template_id==3){
            if($columnsCount1 == 8){
                $columnArr=array("unique_id","name","father_name","department ","from date","to date","place","date");
                $mismatchColArr=array_diff($rowData1[0], $columnArr);
                if(count($mismatchColArr)>0){                    
                    return response()->json(['success'=>false,'type' => 'error', 'message' => 'Sheet1/Json : Column names not matching as per requirement. Please check columns : '.implode(',', $mismatchColArr)]);
                }
        ...
        elseif($dropdown_template_id==4){
            if($columnsCount1 == 7){
                $columnArr=array("unique_id","name","father_name","enrolment_no","Pass out year","place","date");
                $mismatchColArr=array_diff($rowData1[0], $columnArr);
                if(count($mismatchColArr)>0){                    
                    return response()->json(['success'=>false,'type' => 'error', 'message' => 'Sheet1/Json : Column names not matching as per requirement. Please check columns : '.implode(',', $mismatchColArr)]);
                }
        ...
        elseif($dropdown_template_id==5){
            if($columnsCount1 == 7){
                $columnArr=array("unique_id","name","department","from date","to date","place","date");
                $mismatchColArr=array_diff($rowData1[0], $columnArr);
                if(count($mismatchColArr)>0){                    
                    return response()->json(['success'=>false,'type' => 'error', 'message' => 'Sheet1/Json : Column names not matching as per requirement. Please check columns : '.implode(',', $mismatchColArr)]);
                }
        ...
        elseif($dropdown_template_id==6){
            if($columnsCount1 == 8){
                $columnArr=array("unique_id","name","roll no","batch","passout year","Intership date ","place","date");
                $mismatchColArr=array_diff($rowData1[0], $columnArr);
                if(count($mismatchColArr)>0){                    
                    return response()->json(['success'=>false,'type' => 'error', 'message' => 'Sheet1/Json : Column names not matching as per requirement. Please check columns : '.implode(',', $mismatchColArr)]);
                }
        ...
        elseif($dropdown_template_id==7){
            if($columnsCount1 == 8){
                $columnArr=array("unique_id","name","father name","Enrollment no","subject","passout year","place","date");
                $mismatchColArr=array_diff($rowData1[0], $columnArr);
                if(count($mismatchColArr)>0){                    
                    return response()->json(['success'=>false,'type' => 'error', 'message' => 'Sheet1/Json : Column names not matching as per requirement. Please check columns : '.implode(',', $mismatchColArr)]);
                }
        ...
        elseif($dropdown_template_id==8){
            if($columnsCount1 == 11){
                $columnArr=array("unique_id","name","father name","mother_name","dob","roll_no","year_month","permanent address","present address","place","date");
                $mismatchColArr=array_diff($rowData1[0], $columnArr);
                if(count($mismatchColArr)>0){                    
                    return response()->json(['success'=>false,'type' => 'error', 'message' => 'Sheet1/Json : Column names not matching as per requirement. Please check columns : '.implode(',', $mismatchColArr)]);
                }
        ...
        elseif($dropdown_template_id==9){
            if($columnsCount1 == 9){
                $columnArr=array("unique_id","enrollment_no","name","father_name","mother_name","examination","date","photo","serial_no");
                $mismatchColArr=array_diff($rowData1[0], $columnArr);
                if(count($mismatchColArr)>0){                    
                    return response()->json(['success'=>false,'type' => 'error', 'message' => 'Sheet1/Json : Column names not matching as per requirement. Please check columns : '.implode(',', $mismatchColArr)]);
                }
        ...
        elseif($dropdown_template_id==10){
            if($columnsCount1 == 10){
                $columnArr=array("unique_id","enrollment_no","name","father_name","mother_name","degree","subject","date","photo","serial_no");
                $mismatchColArr=array_diff($rowData1[0], $columnArr);
                if(count($mismatchColArr)>0){                    
                    return response()->json(['success'=>false,'type' => 'error', 'message' => 'Sheet1/Json : Column names not matching as per requirement. Please check columns : '.implode(',', $mismatchColArr)]);
                }

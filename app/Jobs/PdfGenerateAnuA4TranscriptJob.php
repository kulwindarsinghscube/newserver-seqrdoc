    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
            ...
            //if($sign_name2=="Dr. Sridhar B Reddy"){
                $sign2Image = public_path().'\\'.$subdomain[0].'\backend\canvas\images\JasmineGohil_new.png';
            ...
            $pdf->Image($sign2Image, $sign2_x,$sign2_y,$sign2_Width,$sign2_Height, "PNG", '', 'L', true, 3600);
             ...
             if($sign_name2=="Ms. Jigisha Patel"||$sign_name2=="Prof. Suhas Toshniwal"||$sign_name2=="Prof. Jasmine Gohil"||$sign_name2=="Jigisha Patel"||$sign_name2=="Suhas Toshniwal"||$sign_name2=="Jasmine Gohil"||$sign_name2=="Hrishikesh Trivedi"||$sign_name2=="Sanjay Bhatnagar"||$sign_name2=='Brijesh Kumar Singh'){
            $pdfBig->SetFont($trebuc, '', 8, '', false);
            ...
            //if($sign_name3=="Dr. Sridhar B Reddy"){
                $sign3Image = public_path().'\\'.$subdomain[0].'\backend\canvas\images\JasmineGohil_new.png';
            ...
            if($sign_name3=="Ms. Jigisha Patel"||$sign_name3=="Prof. Suhas Toshniwal"||$sign_name3=="Prof. Jasmine Gohil"||$sign_name3=="Jigisha Patel"||$sign_name3=="Suhas Toshniwal"||$sign_name3=="Jasmine Gohil"||$sign_name3=="Hrishikesh Trivedi"||$sign_name3=="Sanjay Bhatnagar"||$sign_name3=='Brijesh Kumar Singh'){
            $pdfBig->SetXY(87, 271);
            ...
            //if($sign_name1=="Dr. Sridhar B Reddy"){
                $sign1Image = public_path().'\\'.$subdomain[0].'\backend\canvas\images\JasmineGohil_new.png';
			...
			*/
            ...
            if($previewPdf!=1){
			    $pdf->Image($back_img, 0, 0, '210', '297', "JPG", '', 'R', true);
			}
            $pdf->setPageMark();			
            if($points=="4"){
                $grade_title='Grade Points: <span style="font-size:10;font-family:'.$trebuc.';">4 point grading system with corresponding numeric grade & letter grade as given below</span>';
            ...
            elseif($points=="10_2"){
                ...
                $pdf->MultiCell(17, 11, 'Letter<br />Grade','LRTB',  'C', 0, 0, '', '', true, 0, true);
                $pdf->setCellPaddings( $left = '', $top = '1.5', $right = '', $bottom = '');
                $pdf->MultiCell(25, 11, 'Grade Point<br><span style="font-size:9;font-family:'.$trebucb.';">(10.0 pt scale)</span>','LRTB',  'C', 0, 0, '', '', true, 0, true);
                $pdf->setCellPaddings( $left = '', $top = '1', $right = '', $bottom = '');
                $pdf->MultiCell(40, 11, 'Descriptive<br />Performance','LRTB',  'L', 0, 0, '', '', true, 0, true);
                $pdf->setCellPaddings( $left = '', $top = '0', $right = '', $bottom = '');
                $pdf->SetFont($trebuc, '', 10, '', false);

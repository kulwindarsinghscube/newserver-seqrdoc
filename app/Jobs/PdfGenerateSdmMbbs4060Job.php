...
use Helper;
class PdfGenerateSdmMbbs4060Job
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
			...
			$pdfBig->SetXY(69, 106);	
			$pdfBig->MultiCell(110.5, 0, '', 'T', 'C', 0, 0);	//UIT HR Line
			...
			$pdfBig->MultiCell(26.5, 13, '', 'LR', 'C', 0, 0); //Theory
			...
			$pdfBig->MultiCell(15, 5, 'REMARKS', 0, 'C', 0, 0);
			
			$pdfBig->SetXY(69, 106);
			$pdfBig->MultiCell(13.3, 4, '', 'R', 'C', 0, 0);
			//$pdfBig->MultiCell(9, 4, '', 'R', 'C', 0, 0);
			$pdfBig->MultiCell(13.2, 4, '', 0, 'C', 0, 0);	
			$pdfBig->MultiCell(9, 4, '', 'R', 'C', 0, 0);
			$pdfBig->MultiCell(9, 4, '', 'R', 'C', 0, 0);
			...
			$pdf->SetXY(180, 102);
			$pdf->MultiCell(15, 5, 'REMARKS', 0, 'C', 0, 0);
			
			$pdf->SetXY(69, 106);
			$pdf->MultiCell(13.3, 4, '', 'R', 'C', 0, 0);
			//$pdf->MultiCell(9, 4, '', 'R', 'C', 0, 0);
			$pdf->MultiCell(13.2, 4, '', 0, 'C', 0, 0);	
			$pdf->MultiCell(9, 4, '', 'R', 'C', 0, 0);
			$pdf->MultiCell(9, 4, '', 'R', 'C', 0, 0);
			...
			$Sr_no2 = trim($studentData[11]);
			$Subject2 = trim($studentData[12]);
			$T_Max2 = trim($studentData[13]);
			$T_Min2 = trim($studentData[14]);
			$T_OBT2 = trim($studentData[15]);
			$TA_Max1 = trim($studentData[16]);
			$TA_Min1 = trim($studentData[17]);
			$TA_OBT1 = trim($studentData[18]);
			$PV_MAX1 = trim($studentData[19]);
			$PV_MIN1 = trim($studentData[20]);
			$PV_OBT1 = trim($studentData[21]);
			$TOTAL_MAX1 = trim($studentData[22]);
			$TOTAL_MIN1 = trim($studentData[23]);
			$TOTAL_OBT1 = trim($studentData[24]);
			$REMARK1 = trim($studentData[25]);
			
			$Sr_no3 = trim($studentData[26]);			
			$Subject3 = trim($studentData[27]);
			$T_Max3 = trim($studentData[28]);
			$T_Min3 = trim($studentData[29]);
			$T_OBT3 = trim($studentData[30]);			
			$Sr_no4 = trim($studentData[31]);
			$Subject4 = trim($studentData[32]);
			$T_Max4 = trim($studentData[33]);
			$T_Min4 = trim($studentData[34]);
			$T_OBT4 = trim($studentData[35]);
			$TA_Max2 = trim($studentData[36]);
			$TA_Min2 = trim($studentData[37]);
			$TA_OBT2 = trim($studentData[38]);
			$PV_MAX2 = trim($studentData[39]);
			$PV_MIN2 = trim($studentData[40]);
			$PV_OBT2 = trim($studentData[41]);
			$TOTAL_MAX2 = trim($studentData[42]);
			$TOTAL_MIN2 = trim($studentData[43]);
			$TOTAL_OBT2 = trim($studentData[44]);
			$REMARK2 = trim($studentData[45]);
			
			$Sr_no5 = trim($studentData[46]);			
			$Subject5 = trim($studentData[47]);
			$T_Max5 = trim($studentData[48]);
			$T_Min5 = trim($studentData[49]);
			$T_OBT5 = trim($studentData[50]);			
			$Sr_no6 = trim($studentData[51]);
			$Subject6 = trim($studentData[52]);
			$T_Max6 = trim($studentData[53]);
			$T_Min6 = trim($studentData[54]);
			$T_OBT6 = trim($studentData[55]);
			$TA_Max3 = trim($studentData[56]);
			$TA_Min3 = trim($studentData[57]);
			$TA_OBT3 = trim($studentData[58]);
			$PV_MAX3 = trim($studentData[59]);
			$PV_MIN3 = trim($studentData[60]);
			$PV_OBT3 = trim($studentData[61]);
			$TOTAL_MAX3 = trim($studentData[62]);
			$TOTAL_MIN3 = trim($studentData[63]);
			$TOTAL_OBT3 = trim($studentData[64]);
			$REMARK3 = trim($studentData[65]);
			
			$Total_UE_MAX = trim($studentData[66]);
			$Total_UE_MIN = trim($studentData[67]);
			$Total_UE_OBT = trim($studentData[68]);
			$Total_IA_MAX = trim($studentData[69]);
			$Total_IA_MIN = trim($studentData[70]);
			$Total_IA_OBT = trim($studentData[71]);			
			$Total_UEIA_MAX = trim($studentData[72]);
			$Total_UEIA_MIN = trim($studentData[73]);
			$Total_UEIA_OBT = trim($studentData[74]);
			$Grand_Total_In_Words = trim($studentData[75]);
			$Percentage = trim($studentData[76]);
			$Result = strtoupper(trim($studentData[77]));
			
			//INTERNAL ASSESSMENT(IA)
			$IA_SL_no1 = strtoupper(trim($studentData[78]));
			$IA_Subject_no1 = strtoupper(trim($studentData[79]));
			$IA_T_Max1 = strtoupper(trim($studentData[80]));
			$IA_T_Min1 = strtoupper(trim($studentData[81]));
			$IA_T_OBT1 = strtoupper(trim($studentData[82]));
			$IA_P_Max1 = strtoupper(trim($studentData[83]));
			$IA_P_Min1 = strtoupper(trim($studentData[84]));
			$IA_P_OBT1 = strtoupper(trim($studentData[85]));
			$IA_TO_MAX1 = strtoupper(trim($studentData[86]));
			$IA_TO_MIN1 = strtoupper(trim($studentData[87]));
			$IA_TO_OBT1 = strtoupper(trim($studentData[88]));
			
			$IA_SL_no2 = strtoupper(trim($studentData[89]));
			$IA_Subject_no2 = strtoupper(trim($studentData[90]));
			$IA_T_Max2 = strtoupper(trim($studentData[91]));
			$IA_T_Min2 = strtoupper(trim($studentData[92]));
			$IA_T_OBT2 = strtoupper(trim($studentData[93]));
			$IA_P_Max2 = strtoupper(trim($studentData[94]));
			$IA_P_Min2 = strtoupper(trim($studentData[95]));
			$IA_P_OBT2 = strtoupper(trim($studentData[96]));
			$IA_TO_MAX2 = strtoupper(trim($studentData[97]));
			$IA_TO_MIN2 = strtoupper(trim($studentData[98]));
			$IA_TO_OBT2 = strtoupper(trim($studentData[99]));
			
			$IA_SL_no3 = strtoupper(trim($studentData[100]));
			$IA_Subject_no3 = strtoupper(trim($studentData[101]));
			$IA_T_Max3 = strtoupper(trim($studentData[102]));
			$IA_T_Min3 = strtoupper(trim($studentData[103]));
			$IA_T_OBT3 = strtoupper(trim($studentData[104]));
			$IA_P_Max3 = strtoupper(trim($studentData[105]));
			$IA_P_Min3 = strtoupper(trim($studentData[106]));
			$IA_P_OBT3 = strtoupper(trim($studentData[107]));
			$IA_TO_MAX3 = strtoupper(trim($studentData[108]));
			$IA_TO_MIN3 = strtoupper(trim($studentData[109]));
			$IA_TO_OBT3 = strtoupper(trim($studentData[110]));
			
			$ELIGIBILITY_FOR_UE = strtoupper(trim($studentData[111]));
			$GRAND_TOTAL_MAX = strtoupper(trim($studentData[112]));
			$GRAND_TOTAL_MIN = strtoupper(trim($studentData[113]));
			$GRAND_TOTAL_OBT = strtoupper(trim($studentData[114]));			
			$Date = trim($studentData[115]);
			$batch_of_qr = trim($studentData[117]);
			$aadhar_number_qr = trim($studentData[118]);
			$DOB = trim($studentData[119]);			
			$course = strtoupper(trim($studentData[120]));            
            
			$QR_Output="Batch Of: $batch_of_qr\nName of the Student: $candidate_name\nAadhar Number: $aadhar_number_qr\nCourse: $course\nYear: $year\nDate Of Birth: $DOB";
			
			$pdfBig->SetFont($MyriadProRegular, '', 8.5, '', false);
			$pdfBig->SetXY(69, 106.5);
			$pdfBig->MultiCell(13.3, 0, 'MAX', 0, 'C', 0, 0);
			//$pdfBig->MultiCell(9, 0, 'MIN', 0, 'C', 0, 0);
			$pdfBig->MultiCell(13.2, 0, 'OBT', 0, 'C', 0, 0);
			...
			$pdf->SetFont($MyriadProRegular, '', 8.5, '', false);
			$pdf->SetXY(69, 106.5);
			$pdf->MultiCell(13.3, 0, 'MAX', 0, 'C', 0, 0);
			//$pdf->MultiCell(9, 0, 'MIN', 0, 'C', 0, 0);
			$pdf->MultiCell(13.2, 0, 'OBT', 0, 'C', 0, 0);
			...
			$pdfBig->SetFont($MyriadPrBoold, 'B', 9, '', false);	
			...
			$pdf->Cell(188, 0, $footer_note, 0, false, 'C');

			$pdf->SetFont($MyriadProBold, 'B', 15, '', false);
            $pdf->SetTextColor(0, 0, 0);
			$pdf->SetXY($title1_x, 56);
			$pdf->Cell(188, 0, "STATEMENT OF MARKS", 0, false, 'C');            
			$pdf->SetFont($MyriadProRegular, '', 15, '', false);
			$pdf->SetXY($title1_x, 63.5);
			$pdf->Cell(188, 0, $specilisation, 0, false, 'C');
			$pdf->SetFont($MinionProBold, '', 12, '', false);			
			$pdf->SetXY($title1_x, 70.8);
			$pdf->Cell(188, 0, $year_examination, 0, false, 'C');			
			...
			$pdfBig->MultiCell(9.5, 10, '1', 'LR', 'C', 0, 0);
			$pdfBig->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			$pdfBig->MultiCell(44.5, 5, $Subject1, 0, 'L', 0, 0);					
			$pdfBig->MultiCell(13.3, 5, $T_Max1, 'LR', 'C', 0, 0);
			//$pdfBig->MultiCell(9, 5, $T_Min1, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(13.2, 5, $T_OBT1, 'LR', 'C', 0, 0);
			$pdfBig->setCellPaddings( $left = '', $top = 3, $right = '', $bottom = '');
			$pdfBig->MultiCell(9, 10, $TA_Max1, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(9, 10, $TA_Min1, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(9, 10, $TA_OBT1, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(9, 10, $PV_MAX1, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(9, 10, $PV_MIN1, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(9, 10, $PV_OBT1, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(10, 10, $TOTAL_MAX1, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(10, 10, $TOTAL_MIN1, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(10, 10, $TOTAL_OBT1, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(15.5, 10, $REMARK1, 'LR', 'C', 0, 0);
			
			$pdf->SetXY($left_str_x, $subj_y);
			$pdf->setCellPaddings( $left = '', $top = 3, $right = '', $bottom = '');
			$pdf->MultiCell(9.5, 10, '1', 'LR', 'C', 0, 0);
			$pdf->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			$pdf->MultiCell(44.5, 5, $Subject1, 0, 'L', 0, 0);					
			$pdf->MultiCell(13.3, 5, $T_Max1, 'LR', 'C', 0, 0);
			//$pdf->MultiCell(9, 5, $T_Min1, 'LR', 'C', 0, 0);
			$pdf->MultiCell(13.2, 5, $T_OBT1, 'LR', 'C', 0, 0);
			$pdf->setCellPaddings( $left = '', $top = 3, $right = '', $bottom = '');
			$pdf->MultiCell(9, 10, $TA_Max1, 'LR', 'C', 0, 0);
			$pdf->MultiCell(9, 10, $TA_Min1, 'LR', 'C', 0, 0);
			$pdf->MultiCell(9, 10, $TA_OBT1, 'LR', 'C', 0, 0);
			$pdf->MultiCell(9, 10, $PV_MAX1, 'LR', 'C', 0, 0);
			$pdf->MultiCell(9, 10, $PV_MIN1, 'LR', 'C', 0, 0);
			$pdf->MultiCell(9, 10, $PV_OBT1, 'LR', 'C', 0, 0);
			$pdf->MultiCell(10, 10, $TOTAL_MAX1, 'LR', 'C', 0, 0);
			$pdf->MultiCell(10, 10, $TOTAL_MIN1, 'LR', 'C', 0, 0);
			$pdf->MultiCell(10, 10, $TOTAL_OBT1, 'LR', 'C', 0, 0);
			$pdf->MultiCell(15.5, 10, $REMARK1, 'LR', 'C', 0, 0);
			
			$subj_y=$pdfBig->GetY()+5;
			$pdfBig->SetXY(24.5, $subj_y);
			$pdfBig->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			$pdfBig->MultiCell(44.5, 5, $Subject2, 0, 'L', 0, 0);					
			$pdfBig->MultiCell(13.3, 5, $T_Max2, 'LR', 'C', 0, 0);
			//$pdfBig->MultiCell(9, 5, $T_Min2, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(13.2, 5, $T_OBT2, 'LR', 'C', 0, 0);
			$pdfBig->setCellPaddings( $left = '', $top = 0, $right = '', $bottom = '');
			
			$pdf->SetXY(24.5, $subj_y);
			$pdf->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			$pdf->MultiCell(44.5, 5, $Subject2, 0, 'L', 0, 0);					
			$pdf->MultiCell(13.3, 5, $T_Max2, 'LR', 'C', 0, 0);
			//$pdf->MultiCell(9, 5, $T_Min2, 'LR', 'C', 0, 0);
			$pdf->MultiCell(13.2, 5, $T_OBT2, 'LR', 'C', 0, 0);
			$pdf->setCellPaddings( $left = '', $top = 0, $right = '', $bottom = '');
			...
			$pdfBig->SetXY($left_str_x, $subj_y);
			$pdfBig->setCellPaddings( $left = '', $top = 3, $right = '', $bottom = '');
			$pdfBig->MultiCell(9.5, 10, '2', 'LR', 'C', 0, 0);
			$pdfBig->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			$pdfBig->MultiCell(44.5, 5, $Subject3, 0, 'L', 0, 0);					
			$pdfBig->MultiCell(13.3, 5, $T_Max3, 'LR', 'C', 0, 0);
			//$pdfBig->MultiCell(9, 5, $T_Min3, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(13.2, 5, $T_OBT3, 'LR', 'C', 0, 0);
			$pdfBig->setCellPaddings( $left = '', $top = 3, $right = '', $bottom = '');
			$pdfBig->MultiCell(9, 10, $TA_Max2, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(9, 10, $TA_Min2, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(9, 10, $TA_OBT2, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(9, 10, $PV_MAX2, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(9, 10, $PV_MIN2, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(9, 10, $PV_OBT2, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(10, 10, $TOTAL_MAX2, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(10, 10, $TOTAL_MIN2, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(10, 10, $TOTAL_OBT2, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(15.5, 10, $REMARK2, 'LR', 'C', 0, 0);
			
			$pdf->SetXY($left_str_x, $subj_y);
			$pdf->setCellPaddings( $left = '', $top = 3, $right = '', $bottom = '');
			$pdf->MultiCell(9.5, 10, '2', 'LR', 'C', 0, 0);
			$pdf->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			$pdf->MultiCell(44.5, 5, $Subject3, 0, 'L', 0, 0);					
			$pdf->MultiCell(13.3, 5, $T_Max3, 'LR', 'C', 0, 0);
			//$pdf->MultiCell(9, 5, $T_Min3, 'LR', 'C', 0, 0);
			$pdf->MultiCell(13.2, 5, $T_OBT3, 'LR', 'C', 0, 0);
			$pdf->setCellPaddings( $left = '', $top = 3, $right = '', $bottom = '');
			$pdf->MultiCell(9, 10, $TA_Max2, 'LR', 'C', 0, 0);
			$pdf->MultiCell(9, 10, $TA_Min2, 'LR', 'C', 0, 0);
			$pdf->MultiCell(9, 10, $TA_OBT2, 'LR', 'C', 0, 0);
			$pdf->MultiCell(9, 10, $PV_MAX2, 'LR', 'C', 0, 0);
			$pdf->MultiCell(9, 10, $PV_MIN2, 'LR', 'C', 0, 0);
			$pdf->MultiCell(9, 10, $PV_OBT2, 'LR', 'C', 0, 0);
			$pdf->MultiCell(10, 10, $TOTAL_MAX2, 'LR', 'C', 0, 0);
			$pdf->MultiCell(10, 10, $TOTAL_MIN2, 'LR', 'C', 0, 0);
			$pdf->MultiCell(10, 10, $TOTAL_OBT2, 'LR', 'C', 0, 0);
			$pdf->MultiCell(15.5, 10, $REMARK2, 'LR', 'C', 0, 0);
			
			$subj_y=$pdfBig->GetY()+5;
			$pdfBig->SetXY(24.5, $subj_y);
			$pdfBig->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			$pdfBig->MultiCell(44.5, 5, $Subject4, 0, 'L', 0, 0);					
			$pdfBig->MultiCell(13.3, 5, $T_Max4, 'LR', 'C', 0, 0);
			//$pdfBig->MultiCell(9, 5, $T_Min4, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(13.2, 5, $T_OBT4, 'LR', 'C', 0, 0);	
			$pdfBig->setCellPaddings( $left = '', $top = 0, $right = '', $bottom = '');
			
			$pdf->SetXY(24.5, $subj_y);
			$pdf->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			$pdf->MultiCell(44.5, 5, $Subject4, 0, 'L', 0, 0);					
			$pdf->MultiCell(13.3, 5, $T_Max4, 'LR', 'C', 0, 0);
			//$pdf->MultiCell(9, 5, $T_Min4, 'LR', 'C', 0, 0);
			$pdf->MultiCell(13.2, 5, $T_OBT4, 'LR', 'C', 0, 0);	
			$pdf->setCellPaddings( $left = '', $top = 0, $right = '', $bottom = '');			
			...
			$pdfBig->SetXY($left_str_x, $subj_y);
			$pdfBig->setCellPaddings( $left = '', $top = 3, $right = '', $bottom = '');
			$pdfBig->MultiCell(9.5, 10, '3', 'LRB', 'C', 0, 0);
			$pdfBig->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			$pdfBig->MultiCell(44.5, 5, $Subject5, 0, 'L', 0, 0);					
			$pdfBig->MultiCell(13.3, 5, $T_Max5, 'LR', 'C', 0, 0);
			//$pdfBig->MultiCell(9, 5, $T_Min5, 'LR', 'C', 0, 0);
			$pdfBig->MultiCell(13.2, 5, $T_OBT5, 'LR', 'C', 0, 0);
			$pdfBig->setCellPaddings( $left = '', $top = 3, $right = '', $bottom = '');
			$pdfBig->MultiCell(9, 10, $TA_Max3, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(9, 10, $TA_Min3, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(9, 10, $TA_OBT3, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(9, 10, $PV_MAX3, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(9, 10, $PV_MIN3, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(9, 10, $PV_OBT3, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(10, 10, $TOTAL_MAX3, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(10, 10, $TOTAL_MIN3, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(10, 10, $TOTAL_OBT3, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(15.5, 10, $REMARK3, 'LR', 'C', 0, 0);
			
			$pdf->SetXY($left_str_x, $subj_y);
			$pdf->setCellPaddings( $left = '', $top = 3, $right = '', $bottom = '');
			$pdf->MultiCell(9.5, 10, '3', 'LRB', 'C', 0, 0);
			$pdf->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			$pdf->MultiCell(44.5, 5, $Subject5, 0, 'L', 0, 0);					
			$pdf->MultiCell(13.3, 5, $T_Max5, 'LR', 'C', 0, 0);
			//$pdf->MultiCell(9, 5, $T_Min5, 'LR', 'C', 0, 0);
			$pdf->MultiCell(13.2, 5, $T_OBT5, 'LR', 'C', 0, 0);
			$pdf->setCellPaddings( $left = '', $top = 3, $right = '', $bottom = '');
			$pdf->MultiCell(9, 10, $TA_Max3, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(9, 10, $TA_Min3, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(9, 10, $TA_OBT3, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(9, 10, $PV_MAX3, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(9, 10, $PV_MIN3, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(9, 10, $PV_OBT3, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(10, 10, $TOTAL_MAX3, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(10, 10, $TOTAL_MIN3, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(10, 10, $TOTAL_OBT3, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(15.5, 10, $REMARK3, 'LR', 'C', 0, 0);
			
			$subj_y=$pdfBig->GetY()+5;
			$pdfBig->SetXY(24.5, $subj_y);
			$pdfBig->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			$pdfBig->MultiCell(44.5, 5, $Subject6, 'B', 'L', 0, 0);					
			$pdfBig->MultiCell(13.3, 5, $T_Max6, 'LRB', 'C', 0, 0);
			//$pdfBig->MultiCell(9, 5, $T_Min6, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(13.2, 5, $T_OBT6, 'LRB', 'C', 0, 0);	
			$pdfBig->setCellPaddings( $left = '', $top = 0, $right = '', $bottom = '');	

			$pdf->SetXY(24.5, $subj_y);
			$pdf->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			$pdf->MultiCell(44.5, 5, $Subject6, 'B', 'L', 0, 0);					
			$pdf->MultiCell(13.3, 5, $T_Max6, 'LRB', 'C', 0, 0);
			//$pdf->MultiCell(9, 5, $T_Min6, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(13.2, 5, $T_OBT6, 'LRB', 'C', 0, 0);	
			$pdf->setCellPaddings( $left = '', $top = 0, $right = '', $bottom = '');	
			...
			$pdfBig->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			$pdfBig->MultiCell(134.5, 5, 'GRAND TOTAL ', 'LB', 'R', 0, 0);					
			$pdfBig->MultiCell(10, 5, $Total_UE_MAX, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(10, 5, $Total_UE_MIN, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(10, 5, $Total_UE_OBT, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(15.5, 5, '', 'RB', 'C', 0, 0);
			
			$pdf->SetXY($left_str_x, $subj_y);
			$pdf->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			$pdf->MultiCell(134.5, 5, 'GRAND TOTAL ', 'LB', 'R', 0, 0);					
			$pdf->MultiCell(10, 5, $Total_UE_MAX, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(10, 5, $Total_UE_MIN, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(10, 5, $Total_UE_OBT, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(15.5, 5, '', 'RB', 'C', 0, 0);
			...
			// $pdfBig->SetXY($left_str_x, $subj_y);
			// $pdfBig->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			// $pdfBig->MultiCell(135, 5, 'GRAND TOTAL ', 'LB', 'R', 0, 0);					
			...
			// $pdf->SetXY($left_str_x, $subj_y);
			// $pdf->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			// $pdf->MultiCell(135, 5, 'GRAND TOTAL ', 'LB', 'R', 0, 0);					
			...
			$pdfBig->SetXY($left_str_x, $subj_y);
			$pdfBig->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			$pdfBig->MultiCell(134.5, 5, 'TOTAL IN WORDS ', 'L', 'R', 0, 0);
			$pdfBig->MultiCell(45.5, 5, $Grand_Total_In_Words, 'LR', 'L', 0, 0);
			
			$pdf->SetXY($left_str_x, $subj_y);
			$pdf->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			$pdf->MultiCell(134.5, 5, 'TOTAL IN WORDS ', 'L', 'R', 0, 0);
			$pdf->MultiCell(45.5, 5, $Grand_Total_In_Words, 'LR', 'L', 0, 0);
			
			$subj_y=$pdfBig->GetY()+5;
			$pdfBig->SetXY($left_str_x, $subj_y);
			$pdfBig->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			$pdfBig->MultiCell(134.5, 5, 'PERCENTAGE ', 'L', 'R', 0, 0);
			$pdfBig->MultiCell(45.5, 5, $Percentage, 'LR', 'L', 0, 0);
			
			$pdf->SetXY($left_str_x, $subj_y);
			$pdf->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			$pdf->MultiCell(134.5, 5, 'PERCENTAGE ', 'L', 'R', 0, 0);
			$pdf->MultiCell(45.5, 5, $Percentage, 'LR', 'L', 0, 0);
			
			$subj_y=$pdfBig->GetY()+5;
			$pdfBig->SetXY($left_str_x, $subj_y);
			$pdfBig->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			$pdfBig->MultiCell(134.5, 5, 'RESULT: ', 'LB', 'R', 0, 0);
			$pdfBig->MultiCell(45.5, 5, $Result, 'LRB', 'L', 0, 0);
			$pdfBig->setCellPaddings( $left = '', $top = 0, $right = '', $bottom = '');
			
			$pdf->SetXY($left_str_x, $subj_y);
			$pdf->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			$pdf->MultiCell(134.5, 5, 'RESULT: ', 'LB', 'R', 0, 0);
			$pdf->MultiCell(45.5, 5, $Result, 'LRB', 'L', 0, 0);
			$pdf->setCellPaddings( $left = '', $top = 0, $right = '', $bottom = '');
			
			/*IA start*/
			$subj_y=$pdfBig->GetY();
			$pdfBig->SetFont($MyriadProRegular, '', 9, '', false);				 
			$pdfBig->SetXY($left_str_x, $subj_y+7);
			$pdfBig->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');	
			$pdfBig->MultiCell(180, 5, 'INTERNAL ASSESSMENT (IA)', 'LRTB', 'C', 0, 0);
			
			$pdf->SetFont($MyriadProRegular, '', 9, '', false);				 
			$pdf->SetXY($left_str_x, $subj_y+7);
			$pdf->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');	
			...
			$pdfBig->MultiCell(18, 5, '', 'LR', 'C', 0, 0);
			// $pdfBig->setCellPaddings( $left = '', $top = 6, $right = '', $bottom = '');
			// $pdfBig->MultiCell(18, 20, $ELIGIBILITY_FOR_UE, 1, 'C', 0, 0);
			// $pdfBig->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			...
			$pdf->MultiCell(18, 5, '', 'LR', 'C', 0, 0);
			// $pdf->setCellPaddings( $left = '', $top = 6, $right = '', $bottom = '');
			// $pdf->MultiCell(18, 20, $ELIGIBILITY_FOR_UE, 1, 'C', 0, 0);
			// $pdf->setCellPaddings( $left = '', $top = 1, $right = '', $bottom = '');
			...
			$subj_y=$pdfBig->GetY()+5;
			$pdfBig->SetXY($left_str_x, $subj_y);
			$pdfBig->MultiCell(12, 5, $IA_SL_no3, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(60, 5, $IA_Subject_no3, 'LRB', 'L', 0, 0);
			$pdfBig->MultiCell(10, 5, $IA_T_Max3, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(10, 5, $IA_T_Min3, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(10, 5, $IA_T_OBT3, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(10, 5, $IA_P_Max3, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(10, 5, $IA_P_Min3, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(10, 5, $IA_P_OBT3, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(10, 5, $IA_TO_MAX3, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(10, 5, $IA_TO_MIN3, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(10, 5, $IA_TO_OBT3, 'LRB', 'C', 0, 0);
			$pdfBig->MultiCell(18, 5, '', 'LR', 'C', 0, 0);
			
			$pdf->SetXY($left_str_x, $subj_y);
			$pdf->MultiCell(12, 5, $IA_SL_no3, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(60, 5, $IA_Subject_no3, 'LRB', 'L', 0, 0);
			$pdf->MultiCell(10, 5, $IA_T_Max3, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(10, 5, $IA_T_Min3, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(10, 5, $IA_T_OBT3, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(10, 5, $IA_P_Max3, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(10, 5, $IA_P_Min3, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(10, 5, $IA_P_OBT3, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(10, 5, $IA_TO_MAX3, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(10, 5, $IA_TO_MIN3, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(10, 5, $IA_TO_OBT3, 'LRB', 'C', 0, 0);
			$pdf->MultiCell(18, 5, '', 'LR', 'C', 0, 0);
			...
			$pdfBig->MultiCell(18, 5, '', 'LRB', 'C', 0, 0);
			...
			$pdf->MultiCell(18, 5, '', 'LRB', 'C', 0, 0);
			
			/*IA End*/
			$notes="<span style='font-size:18;'>•</span> Minimum Marks for Eligibility to appear for University Examinations: Internal Assessment 50% combined in theory and practical (not less than 40% in each).
			<br><span style='font-size:18;'>•</span> University Examinations: Minimum marks to pass: 50% Theory + Practical Aggregate
			<br><span style='font-size:18;'>•</span> University Theory Examination: Minimum 40% in Theory
			<br><span style='font-size:18;'>•</span> University practical exam (Including viva voce): Minimum 40% in Practical
			";			

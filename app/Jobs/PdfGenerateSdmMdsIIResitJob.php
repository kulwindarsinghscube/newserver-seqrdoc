...
use Helper;
class PdfGenerateSdmMdsIIResitJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
			...
			$pdfBig->MultiCell(180, 66, '', 'LRTB', 'C', 0, 0);	//Entire Table
			...
			$pdfBig->MultiCell(112, 60, '', 'L', 'C', 0, 0); //middle vline
			...
			$pdf->MultiCell(180, 66, '', 'LRTB', 'C', 0, 0);	//Entire Table
			...
			$pdf->SetXY(123, 108);	
			$pdf->MultiCell(112, 60, '', 'L', 'C', 0, 0); //middle vline

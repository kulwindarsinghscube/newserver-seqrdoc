...
class PdfGenerateChanakyaMbaTrimesterJob
{
            ...
            foreach ($studentDataOrg as $studentData) 
            {
                ...
                foreach($subjects as $term => $term_array){
                    ...
                    if ($term == "I SEMESTER" || $term == "III SEMESTER" || $term == "V SEMESTER" || $term == "VII SEMESTER" ||$term == "I TRIMESTER" || $term == "III TRIMESTER" || $term == "V TRIMESTER" || $term == "VII TRIMESTER") {
						...
						$pdfBig->MultiCell(88.5, 6, $term , 'TB', 'C', 0, 0, '', '', true, 0, true);
                        $pdfBig->setCellPaddings( $left = '', $top = '0', $right = '', $bottom = '');
                         $dataArray[$term] = [
                                            'SGPA' => $term_array[0][6],
                ...
                $pdfBig->SetFont($arialb, '', 7);
                    ...
                    $rowH2 = 7;
                    $rowH3 = 7;
                    $pdfBig->SetFont($arialb, 'B', 10);
                    $pdfBig->MultiCell($yearWidth, $rowH1, 'YEAR 2023-2024', 'LT', 'C', 0, 0);
                    $pdfBig->MultiCell($yearWidth, $rowH1, 'YEAR 2024-2025', 'LTR', 'C', 0, 0);     
                    $pdfBig->SetXY($startX,$pdfBig->GetY()+$rowH1);
                            //     // Year 1
                    $pdfBig->MultiCell($subColWidth * 2, $rowH2, 'TRIMESTER I', 'TL', 'C', 0, 0);
                    $pdfBig->MultiCell($subColWidth * 2, $rowH2, 'TRIMESTER II', 'TL', 'C', 0, 0);
                    $pdfBig->MultiCell($subColWidth * 2, $rowH2, 'TRIMESTER III', 'TL', 'C', 0, 0);
                //     // Year 2
                    $pdfBig->MultiCell($subColWidth * 2, $rowH2, 'TRIMESTER IV', 'TL', 'C', 0, 0);
                    $pdfBig->MultiCell($subColWidth * 2, $rowH2, 'TRIMESTER V', 'TL', 'C', 0, 0);
                    $pdfBig->MultiCell($subColWidth * 2, $rowH2, 'TRIMESTER VI', 'TLR', 'C', 0, 0);
                    ...
                    for ($i = 0; $i < 12; $i++) {
                            if($i==11){
                                $pdfBig->MultiCell($subColWidth, 8, number_format($printValue[$i], 2, '.', ''), 'TRL', 'C', 0, 0);
                            }
                            else{
                                $pdfBig->MultiCell($subColWidth, 8, number_format($printValue[$i], 2, '.', ''), 'TL', 'C', 0, 0);
                            }
                  ...
                  $pdfBig->SetXY(15.5,  $pdfBig->GetY());
                  $pdfBig->SetFont($arialb, '', 10);	
				   $pdfBig->MultiCell(179, 0, 'C- Credits GP- Grade Point CP- Credit Point', '', 'L', 0, 0, '', '', true, 0, true);
                ...
                foreach($subjects as $term => $term_array){
                    ...
                    if ($term == "I SEMESTER" || $term == "III SEMESTER" || $term == "V SEMESTER" || $term == "VII SEMESTER" ||$term == "I TRIMESTER" || $term == "III TRIMESTER" || $term == "V TRIMESTER" || $term == "VII TRIMESTER") {
                        ...
                        $pdf->MultiCell(88.5, 6, $term , 'TB', 'C', 0, 0, '', '', true, 0, true);
                        $pdf->setCellPaddings( $left = '', $top = '0', $right = '', $bottom = '');
                         $dataArray[$term] = [
                                            'SGPA' => $term_array[0][6],
                                            'CGPA' => $term_array[0][7] ?? null
                ...
                $pdf->SetFont($arialb, '', 7);
                    ...
                    $pdf->MultiCell($yearWidth, $rowH1, 'YEAR 2023-2024', 'LT', 'C', 0, 0);
                    $pdf->MultiCell($yearWidth, $rowH1, 'YEAR 2024-2025', 'LTR', 'C', 0, 0);     
                    $pdf->SetXY($startX,$pdf->GetY()+$rowH1);
                            //     // Year 1
                    $pdf->MultiCell($subColWidth * 2, $rowH2, 'TRIMESTER I', 'TL', 'C', 0, 0);
                    $pdf->MultiCell($subColWidth * 2, $rowH2, 'TRIMESTER II', 'TL', 'C', 0, 0);
                    $pdf->MultiCell($subColWidth * 2, $rowH2, 'TRIMESTER III', 'TL', 'C', 0, 0);
                //     // Year 2
                    $pdf->MultiCell($subColWidth * 2, $rowH2, 'TRIMESTER IV', 'TL', 'C', 0, 0);
                    $pdf->MultiCell($subColWidth * 2, $rowH2, 'TRIMESTER V', 'TL', 'C', 0, 0);
                    $pdf->MultiCell($subColWidth * 2, $rowH2, 'TRIMESTER VI', 'TLR', 'C', 0, 0);
                    ...
                    for ($i = 0; $i < 12; $i++) {
                            if($i==11){
                                $pdf->MultiCell($subColWidth, 8, number_format($printValue[$i], 2, '.', ''), 'TRL', 'C', 0, 0);
                            }
                            else{
                                $pdf->MultiCell($subColWidth, 8, number_format($printValue[$i], 2, '.', ''), 'TL', 'C', 0, 0);
                            }
                  ...
                  $pdf->SetFont($arialb, '', 10);    
                   $pdf->MultiCell(179, 0, 'C- Credits GP- Grade Point CP- Credit Point', '', 'L', 0, 0, '', '', true, 0, true);

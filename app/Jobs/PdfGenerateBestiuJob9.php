...
class PdfGenerateBestiuJob9
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
		...
		//$card_serial_no="";
        $log_serial_no = 1;
        $cardDetails=$this->getNextCardNo('BestiuG');
        ...
        if($studentDataOrg&&!empty($studentDataOrg)){
            foreach ($studentDataOrg as $studentData) {
                ...
                $mothers_Name=trim($studentData[67]);
                $examination=trim($studentData[68]);
                ...
                $pdfBig->Cell(25, 7, "Semester", 0, false, 'L');	
                $pdfBig->SetXY($right_pos_two, 75);		
                $pdfBig->Cell(2, 7, ':', 0, false, 'L');
                $pdfBig->SetXY($right_pos_three, 75);		
                $pdfBig->Cell(38,7, $semester, 0, false, 'L');
                
                $pdfBig->SetXY($right_pos, 82);		
                $pdfBig->Cell(25, 7, "Examination", 0, false, 'L');	
                $pdfBig->SetXY($right_pos_two, 82);		
                $pdfBig->Cell(2, 7, ':', 0, false, 'L');
                $pdfBig->SetXY($right_pos_three, 82);		
                $pdfBig->Cell(38,7, $examination, 0, false, 'L');

                $pdfBig->SetXY($right_pos, 89);		
                $pdfBig->Cell(25, 7, 'Date', 0, false, 'L');
                $pdfBig->SetXY($right_pos_two, 89);		
                $pdfBig->Cell(2, 7, ':', 0, false, 'L');
                $pdfBig->SetXY($right_pos_three, 89);		
                $pdfBig->Cell(38,7, $DATE, 0, false, 'L');
                


                $pdfBig->SetXY($left_pos, 100);
                $pdfBig->Cell(12, 129, '', 1, false, 'L');
                $pdfBig->Cell(17, 129, '', 1, false, 'L');
                $pdfBig->Cell(105.5, 129, '', 1, false, 'L');
                $pdfBig->Cell(16.9, 129, '', 1, false, 'L');
                $pdfBig->Cell(17, 129, '', 1, false, 'L');
                $pdfBig->Cell(16.9, 129, '', 1, false, 'L');
                
                $pdfBig->SetXY($left_pos, 110.5);
                $pdfBig->Cell(185, 0, "", 'T', false, 'L');
                
                $pdfBig->SetFont($arialb, '', 9.5, '', false);
                $pdfBig->SetXY(12, 103.3);	
                $pdfBig->MultiCell(13, 10, 'Sl. No.', 0, 'C');
                $pdfBig->SetXY(23.5, 101);
                $pdfBig->MultiCell(18, 10, 'Course Code', 0, 'C');
                $pdfBig->SetXY(42, 103.3);
                $pdfBig->MultiCell(105.5, 10, 'Course Title', 0, 'C');
                $pdfBig->SetXY(146.5, 103.3);
                $pdfBig->MultiCell(17, 10, 'Credits', 0, 'C');
                $pdfBig->SetXY(163.5, 101);
                $pdfBig->MultiCell(17, 10, '^Grade Point', 0, 'C');
                $pdfBig->SetXY(180.5, 101);
                ...
                foreach ($subjectsArr as $subjectData){
                    ...
                    if($Course_Code != ''){		
                        ...
                        $pdfBig->MultiCell(13, 11, $sr, 0, 'C', 0, 0);
                    }
                    $pdfBig->SetXY(25, $subj_y);
                    $pdfBig->MultiCell(18, 11, $Course_Code, 0, 'L', 0, 0);
                ...
                $pdf->SetXY($right_pos, 68);		
                $pdf->Cell(25, 7, 'Reg. No.', 0, false, 'L');
                $pdf->SetXY($right_pos_two, 68);		
                $pdf->Cell(2, 7, ':', 0, false, 'L');
                $pdf->SetXY($right_pos_three, 68);		
                $pdf->Cell(38,7, $ID_No, 0, false, 'L');

                $pdf->SetXY($right_pos, 75);		
                $pdf->Cell(25, 7, "Semester", 0, false, 'L');	
                $pdf->SetXY($right_pos_two, 75);		
                $pdf->Cell(2, 7, ':', 0, false, 'L');
                $pdf->SetXY($right_pos_three, 75);		
                $pdf->Cell(38,7, $semester, 0, false, 'L');
                
                $pdf->SetXY($right_pos, 82);		
                $pdf->Cell(25, 7, "Examination", 0, false, 'L');	
                $pdf->SetXY($right_pos_two, 82);		
                $pdf->Cell(2, 7, ':', 0, false, 'L');
                $pdf->SetXY($right_pos_three, 82);		
                $pdf->Cell(38,7, $examination, 0, false, 'L');

                $pdf->SetXY($right_pos, 89);		
                $pdf->Cell(25, 7, 'Date', 0, false, 'L');
                $pdf->SetXY($right_pos_two, 89);		
                $pdf->Cell(2, 7, ':', 0, false, 'L');
                $pdf->SetXY($right_pos_three, 89);		
                $pdf->Cell(38,7, $DATE, 0, false, 'L');


                
                $pdf->SetXY($left_pos, 100);
                $pdf->Cell(12, 129, '', 1, false, 'L');
                $pdf->Cell(17, 129, '', 1, false, 'L');
                $pdf->Cell(105.5, 129, '', 1, false, 'L');
                $pdf->Cell(16.9, 129, '', 1, false, 'L');
                $pdf->Cell(17, 129, '', 1, false, 'L');
                $pdf->Cell(16.9, 129, '', 1, false, 'L');
                
                $pdf->SetXY($left_pos, 110.5);
                ...
                foreach ($subjectsArr as $subjectData){
                    ...
                    if($Course_Code != ''){	
                        $pdf->SetXY(12, $subj_y);
                        $pdf->MultiCell(13, 11, $sr, 0, 'C', 0, 0);
                    }
                    $pdf->SetXY(25, $subj_y);
                    $pdf->MultiCell(18, 11, $Course_Code, 0, 'L', 0, 0);
                    $pdf->SetXY(42, $subj_y);
        ...
        if($previewPdf!=1){
			$this->updateCardNo('BestiuG',$card_serial_no-$cardDetails->starting_serial_no,$card_serial_no);
        }
        $msg = '';
        
        $file_name =  str_replace("/", "_",'BestiuG'.date("Ymdhms")).'.pdf';

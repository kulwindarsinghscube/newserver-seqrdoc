    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        if($dropdown_template_id==1){
            if($columnsCount1==28){
				...
				$columnArr=array("PRN","Full Name (English)","Full Name (Hindi)","Full Name (Krutidev)","Mother Name (English)","Mother Name (Hindi)","Mother Name (Krutidev)","Father Name (English)","Father Name (Hindi)","Father Name (Krutidev)","Course Name (English)","Course Name (Hindi)","Course Name (Krutidev)","CGPA","CGPA (Hindi)","CGPA (Krutidev)","Photograph","Faculty Name","Faculty Name (Hindi)","Faculty Name (Krutidev)","Specialization","Specialization (Krutidev)","Certificate Id","Completion Date","Completion Date (Krutidev)","Issue Date","Issue Date (Krutidev)","Serial No");
            ...
            if($columnsCount1==28){
                $photo_col=151;
				$columnArr=array("PRN","Full Name (English)","Full Name (Hindi)","Full Name (Krutidev)","Mother Name (English)","Mother Name (Hindi)","Mother Name (Krutidev)","Father Name (English)","Father Name (Hindi)","Father Name (Krutidev)","Course Name (English)","Course Name (Hindi)","Course Name (Krutidev)","Photograph","Faculty Name","Faculty Name (Hindi)","Faculty Name (Krutidev)","Certificate Id","Completion Date","Completion Date (Krutidev)","Issue Date","Issue Date (Krutidev)","Medal Type","Medal Type (Krutidev)","Specialization","Specialization (Hindi)","Specialization (Krutidev)","Serial No" );
                $mismatchColArr=array_diff($rowData1[0], $columnArr);
                if(count($mismatchColArr)>0){                    
                    return response()->json(['success'=>false,'type' => 'error', 'message' => 'Sheet1/Json : Column names not matching as per requirement. Please check columns : '.implode(',', $mismatchColArr)]);
                }
        ...
        elseif($dropdown_template_id==3){
            ...
            if($columnsCount1==29){
                $photo_col=151;
				$columnArr=array("PRN","Full Name (English)","Full Name (Hindi)","Full Name (Krutidev)","Mother Name (English)","Mother Name (Hindi)","Mother Name (Krutidev)","Father Name (English)","Father Name (Hindi)","Father Name (Krutidev)","Course Name (English)","Course Name (Hindi)","Course Name (Krutidev)","Rank","Rank (Hindi)","Rank (Krutidev)","Photograph","Faculty Name","Faculty Name (Hindi)","Faculty Name (Krutidev)","Certificate Id","Completion Date","Completion Date (Krutidev)","Issue Date","Issue Date (Krutidev)","Specialization","Specialization (Hindi)","Specialization (Krutidev)","Serial No");
                $mismatchColArr=array_diff($rowData1[0], $columnArr);
                if(count($mismatchColArr)>0){                    
                    return response()->json(['success'=>false,'type' => 'error', 'message' => 'Sheet1/Json : Column names not matching as per requirement. Please check columns : '.implode(',', $mismatchColArr)]);
                }
        ...
        elseif($dropdown_template_id==4){
            ...
            if($columnsCount1==28){
                $photo_col=151;
				$columnArr=array("PRN","Full Name (English)","Full Name (Hindi)","Full Name (Krutidev)","Mother Name (English)","Mother Name (Hindi)","Mother Name (Krutidev)","Father Name (English)","Father Name (Hindi)","Father Name (Krutidev)","Course Name (English)","Course Name (Hindi)","Course Name (Krutidev)","Topic","Topic (Hindi)","Topic (Krutidev)","Photograph","Faculty Name","Faculty Name (Hindi)","Faculty Name (Krutidev)","Specialization","Specialization (Krutidev)","Certificate Id","Completion Date","Completion Date (Krutidev)","Issue Date","Issue Date (Krutidev)","Serial No");
                $mismatchColArr=array_diff($rowData1[0], $columnArr);
                if(count($mismatchColArr)>0){                    
                    return response()->json(['success'=>false,'type' => 'error', 'message' => 'Sheet1/Json : Column names not matching as per requirement. Please check columns : '.implode(',', $mismatchColArr)]);
                }

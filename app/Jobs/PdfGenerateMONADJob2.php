...
class PdfGenerateMONADJob2
{
        ...
        if($studentDataOrg&&!empty($studentDataOrg)){
            foreach ($studentDataOrg as $studentData) {
                ...
                */
                ...
                $IssueDate = $studentData[147];
                $date_of_issue = $studentData[149];
                ...
                $pdf->MultiCell(75.6, 10, '','RT', 'L', 0, 0);
                ...
                $pdfBig->SetXY(169, 102);
                $pdfBig->SetFont($arialb, '', 9, '', false);
                $pdfBig->Cell(0, 0, 'Grand Total', 0, false, 'L');
                ...
                $pdfBig->SetXY(128.7, 97.5);
                $pdfBig->Cell(0, 0, 'External Assessment', 0, false, 'L'); 
                // end    
                

                $subjectData = array_slice($studentData, 8, 132); //start subject and end subject 
                ...
                for ($i=0; $i < $actual_subj_count ; $i++) { 
                    ...
                    $numlines_pdf = $pdf->getNumLines($subjectsArr[$i][0], 75.6);
                    $numlines_pdfBig = $pdfBig->getNumLines($subjectsArr[$i][0], 75.6);
                    ...
                    //$pdf->MultiCell(10, $cell_height, $subjectsArr[$i][10].'<br><span style="color:yellow;">'.$subjectsArr[$i][10].'</span>', $cell_border, 'C', 0, 0, '', '', true, 0, true);
                ...
                $pdf->MultiCell(34, 4, $studentData[146]." (In Theory)", 0, 'L', 0, 0);
                $pdf->SetXY(13, 232);          
                $pdf->MultiCell(35, 4, "Maximum Marks:", 0, 'L', 0, 0);
                $pdf->MultiCell(40, 4, $studentData[144]." (In Theory)",0, 'L', 0, 0);
                $pdf->MultiCell(40, 4, $studentData[145]." (In Practical)", 0, 'L', 0, 0);     
                $pdf->MultiCell(35, 4, "", 0, 'L', 0, 0);     
                $pdf->MultiCell(34, 4, $studentData[146]." (In Practical)", 0, 'L', 0, 0);
                $pdf->SetXY(13, 229.5);          
                ...
                $pdfBig->MultiCell(34, 4, $studentData[146]." (In Theory)", 0, 'L', 0, 0);
                $pdfBig->SetXY(13, 232);          
                $pdfBig->MultiCell(31, 4, "Max. Marks", 0, 'L', 0, 0);
                $pdfBig->MultiCell(4, 4, ":", 0, 'L', 0, 0);
                $pdfBig->MultiCell(40, 4, $studentData[144]." (In Theory)",0, 'L', 0, 0);
                $pdfBig->MultiCell(40, 4, $studentData[145]." (In Practical)", 0, 'L', 0, 0);     
                $pdfBig->MultiCell(35, 4, "", 0, 'L', 0, 0);     
                $pdfBig->MultiCell(34, 4, $studentData[146]." (In Practical)", 0, 'L', 0, 0);
    ...
    public function addCertificate($serial_no, $certName, $dt,$template_id,$admin_id)
    {
        ...
        //echo $destination=public_path() . '/monad/test/'.$certName;
        //file transfer to monad server

...
use Helper;
class PdfGenerateGhribmjalMBAFirstYearJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
            ...
            $examRegistrasionCredits = $studentData[67];
            $examCredits = $studentData[68];
            $earnGradePoint1 = $studentData[69];
            $sgpa = $studentData[70];
            $cumulativeCreditsEarned = $studentData[71];
            $earnGradePoint2 = $studentData[72];
            $cgpa = $studentData[73];
            $place = $studentData[74];
            $date = \PhpOffice\PhpSpreadsheet\Shared\Date::excelToDateTimeObject($studentData[75])->format('d-m-Y');
            $photo = $studentData[76];

...
use Helper;
// F:\wamp64\www\seqrdoc\app\Jobs\PdfGenerateSdmBscAlliedResitJob.php
class PdfGenerateSdmBscAlliedResitNoVivaJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
		...
		$LT65_key=$pdf_data['LT65_key'];
		$remark_LT65_key=$pdf_data['remark_LT65_key'];
        ...
        foreach ($studentDataOrg as $studentData) {
			...
			$pdf->SetXY(108, 106);
			$pdf->MultiCell(9, 4, '', 'RL', 'C', 0, 0);
			$pdf->MultiCell(9, 4, '', 'RL', 'C', 0, 0);
			$pdf->MultiCell(9, 4, '', 0, 'C', 0, 0);	
			$pdf->MultiCell(9, 4, '', 1, 'C', 0, 0);
			$pdf->MultiCell(9, 4, '', 'LR', 'C', 0, 0);
			$pdf->MultiCell(9, 4, '', 'L', 'C', 0, 0);	
            ...
            $LT65 = trim($studentData[$LT65_key]);
            $remark_LT65 = trim($studentData[$remark_LT65_key]);
			...
			// }else{				
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp;40% marks in theory paper and 40% marks in practical separately<br>
                ...
                if($specilisation == 'B.Sc. IN ANAESTHESIOLOGY TECHNOLOGY' &&  $year == 'FIRST YEAR' ){
                    $notes="Min. Marks for Eligibility to appear for University Examination:  <br>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp;$LT65% in each Theory and Internal Assessment separately<br><br>
                        Min. Marks to Pass:  University Examination: <br>
                    ...
                    $notes="Min. Marks for Eligibility to appear for University Examination: <br>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp;$LT65% in each subject Theory Internal Assessment<br><br>
                    Min. Marks to Pass:  University Examination: <br>
                    ...
                    $LT65 % in each Theory and Practical Internal Assessment separately<br><br>
                ...
                }elseif($specilisation == 'B.Sc. IN EMERGENCY AND TRAUMA CARE TECHNOLOGY' && $year == 'FIRST YEAR' ){
                    $notes="Min. Marks for Eligibility to appear for University Examination: <br>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp;$LT65% in each subject Theory Internal Assessment<br><br>
                    Min. Marks to Pass:  University Examination: <br>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp;40% marks in theory paper to pass in each subject<br>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp; 50% aggregate including Theory+ IA";                  
                }elseif($specilisation == 'B.Sc. IN EMERGENCY AND TRAUMA CARE TECHNOLOGY' && $year == 'SECOND YEAR'){
                    $notes="Min. Marks for Eligibility to appear for University Examination:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp;
                    $LT65% in each Theory and Practical Internal Assessment separately<br><br>
                    Min. Marks to Pass:  University Examination: <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp;
                    40% marks in theory paper and 40% marks in practical (UE) separately 
                    <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp;
                    50% aggregate including Practical (UE) + IA in each subject";                  
                }elseif($specilisation == 'B.Sc. IN EMERGENCY AND TRAUMA CARE TECHNOLOGY' &&  $year == 'THIRD YEAR' ){
                    $notes="Min. Marks for Eligibility to appear for University Examination:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp;
                    $LT65% in each Theory and Practical Internal Assessment separately<br><br>
                    Min. Marks to Pass:  University Examination: <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp;
                    40% marks in theory paper and 40% marks in practical (UE) separately
                    <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp;
                    50% aggregate including Practical (UE) + IA in each subject";
                }elseif($specilisation == 'B.Sc. IN ANAESTHESIA TECHNOLOGY' && $year == 'FIRST YEAR'){
                    $notes="Min. Marks for Eligibility to appear for University Examination: <br>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp;$LT65% in each subject Theory Internal Assessment<br><br>
                    Min. Marks to Pass:  University Examination: <br>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp;40% marks in theory paper to pass in each subject<br>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp; 50% aggregate including Theory+ IA";                  
                }elseif($specilisation == 'B.Sc. IN ANAESTHESIA TECHNOLOGY' && $year == 'SECOND YEAR' ){
                    $notes="Min. Marks for Eligibility to appear for University Examination:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp;
                    $LT65% in each Theory and Practical Internal Assessment separately<br><br>
                    Min. Marks to Pass:  University Examination: <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp;
                    40% marks in theory paper and 40% marks in practical (UE) separately
                    <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp;
                    50% aggregate including Practical (UE) + IA in each subject";                
                }elseif($specilisation == 'B.Sc. IN ANAESTHESIA TECHNOLOGY' &&  $year == 'THIRD YEAR' ){
                    $notes="Min. Marks for Eligibility to appear for University Examination:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp;
                    $LT65% in each Theory and Practical Internal Assessment separately<br><br>
                    Min. Marks to Pass:  University Examination: <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp;
                    40% marks in theory paper and 40% marks in practical (UE) separately
                    <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp;
                    50% aggregate including Practical (UE) + IA in each subject"; 
                }elseif($specilisation == 'B.Sc. IN OPERATION THEATRE TECHNOLOGY' && $year == 'FIRST YEAR'){
                    $notes="Min. Marks for Eligibility to appear for University Examination: <br>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp;$LT65% in each Theory Internal Assessment separately<br><br>
                    Min. Marks to Pass:  University Examination: <br>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp;40% marks in theory paper to pass in each subject<br>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp; 50% aggregate including Theory+ IA"; 
                    
                }elseif($specilisation == 'B.Sc. IN OPERATION THEATRE TECHNOLOGY' && $year == 'SECOND YEAR'){
                    $notes="Min. Marks for Eligibility to appear for University Examination:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp;
                    $LT65% in each Theory and Practical Internal Assessment separately<br><br>
                    Min. Marks to Pass:  University Examination: <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp;
                    40% marks in theory paper and 40% marks in practical (UE) separately 
                    <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp;
                    50% aggregate including Practical (UE) + IA in each subject"; 
                }elseif($specilisation == 'B.Sc. IN OPERATION THEATRE TECHNOLOGY' && $year == 'THIRD YEAR' ){
                    $notes="Min. Marks for Eligibility to appear for University Examination:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp;
                    $LT65% in each Theory and Practical Internal Assessment separately<br><br>
                    Min. Marks to Pass:  University Examination: <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp;
                    40% marks in theory paper and 40% marks in practical (UE) separately 
                    ...
                    $notes="Min. Marks for Eligibility to appear for University Examination:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp;
                    $LT65% in each subject Theory Internal Assessment<br><br>
                    Min. Marks to Pass:  University Examination: <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp;
                    ...
                    $LT65% in each Theory and Practical Internal Assessment separately<br><br>
                    Min. Marks to Pass:  University Examination: <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp;
                    40% marks in theory and 40% marks in practical (UE) separately
                    <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp; 
                    50% aggregate including Theory (UE) + IA  + viva voce (UE) <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp;
                    50% aggregate including Practical (UE) + IA in each subject";  
                    
                }elseif($specilisation == 'B.Sc. IN ANAESTHESIOLOGY TECHNOLOGY' &&  $year == 'THIRD YEAR' ){
                    $notes="Min. Marks for Eligibility to appear for University Examination:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp;
                    $LT65% in each Theory and Practical Internal Assessment separately<br><br>
                    Min. Marks to Pass:  University Examination: <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp;
                    40% marks in theory paper and 40% marks in practical (UE) separately
                    <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp; 
                    50% aggregate including Theory (UE) + IA  + viva voce (UE) <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:18;'>•</span>&nbsp;&nbsp;&nbsp;
                    50% aggregate including Practical (UE) + IA"; 
			...
			foreach ($subjectsArr as $subjectDatas){
				...
				$lines = $pdfBig->MultiCell(74, 0, $Subject_Name, 0, 'L', 0, 0, '', '', true, 0, false,true, 0);
				$lines = $pdf->MultiCell(74, 0, $Subject_Name, 0, 'L', 0, 0, '', '', true, 0, false,true, 0);
                ...
                $pdfBig->MultiCell(74, $th_height, $Subject_Name, 1, 'L', 0, 0);					
                $pdfBig->SetXY(98.5, $subj_y);					
                ...
                $pdfBig->MultiCell(15, $th_height_half, $Remark, 1, 'C', 0, 0);

				$pdf->SetFont($MyriadProRegular, '', 8, '', false);	
                $pdf->SetXY($left_str_x, $subj_y);
                $pdf->MultiCell(9.5, $th_height, $Sr_no, 1, 'C', 0, 0);
                $pdf->MultiCell(74, $th_height, $Subject_Name, 1, 'L', 0, 0);					
                $pdf->SetXY(98.5, $subj_y);					
                ...
                $pdf->MultiCell(15, $th_height_half, $Remark, 1, 'C', 0, 0);
			...
			$pdfBig->SetFont($MyriadProBold, 'B', 9, '', false);
			$pdfBig->SetXY($left_str_x, $subj_y);	
			$pdfBig->MultiCell(138, 5, 'GRAND TOTAL:', 'LRB', 'R', 0, 0); 
			$pdfBig->SetFont($MyriadProRegular, '', 9, '', false);
			...
			$pdfBig->MultiCell(15, 5, '', 1, 'C', 0, 0); 
			$pdfBig->SetFont($MyriadProBold, 'B', 9, '', false);
			$pdfBig->SetXY($left_str_x, $subj_y+5);	
			$pdfBig->MultiCell(138, 5, 'GRAND TOTAL IN WORDS:', 'LR', 'R', 0, 0); 
			$pdfBig->MultiCell(42, 5, $Grand_Total_In_Words, 'R', 'L', 0, 0);
			$pdfBig->SetXY($left_str_x, $subj_y+10);	
			/*$pdfBig->MultiCell(138, 5, 'PERCENTAGE:', 'LR', 'R', 0, 0); 
			$pdfBig->MultiCell(42, 5, $Percentage, 'R', 'L', 0, 0);
			$pdfBig->SetXY($left_str_x, $subj_y+15); */	
			$pdfBig->MultiCell(138, 5, 'RESULT:', 'LRB', 'R', 0, 0); 
			$pdfBig->MultiCell(42, 5, $Result, 'LRB', 'L', 0, 0);
						

            $pdf->SetFont($MyriadProBold, 'B', 9, '', false);
			$pdf->SetXY($left_str_x, $subj_y);	
			$pdf->MultiCell(138, 5, 'GRAND TOTAL:', 'LRB', 'R', 0, 0); 
			$pdf->SetFont($MyriadProRegular, '', 9, '', false);
			...
			$pdf->MultiCell(15, 5, '', 1, 'C', 0, 0); 
			$pdf->SetFont($MyriadProBold, 'B', 9, '', false);
			$pdf->SetXY($left_str_x, $subj_y+5);	
			$pdf->MultiCell(138, 5, 'GRAND TOTAL IN WORDS:', 'LR', 'R', 0, 0); 
			$pdf->MultiCell(42, 5, $Grand_Total_In_Words, 'R', 'L', 0, 0);
			$pdf->SetXY($left_str_x, $subj_y+10);	
			/*$pdf->MultiCell(138, 5, 'PERCENTAGE:', 'LR', 'R', 0, 0); 
			$pdf->MultiCell(42, 5, $Percentage, 'R', 'L', 0, 0);
			$pdf->SetXY($left_str_x, $subj_y+15);*/	
			$pdf->MultiCell(138, 5, 'RESULT:', 'LRB', 'R', 0, 0); 
			$pdf->MultiCell(42, 5, $Result, 'LRB', 'L', 0, 0);
            

			$subj_y=$pdfBig->GetY()+6.5;
			$pdfBig->SetFont($MyriadProItalic, 'I', 8, '', false);
			$pdfBig->SetXY($left_str_x, $subj_y);			
			$pdfBig->MultiCell(180, 48, $notes, 1, 'L', 0, 0, '', '', true, 0, true);

            $subj_y=$pdf->GetY()+6.5;
            $pdf->SetFont($MyriadProItalic, 'I', 8, '', false);
            $pdf->SetXY($left_str_x, $subj_y);			
            $pdf->MultiCell(180, 48, $notes, 1, 'L', 0, 0, '', '', true, 0, true);
		
			$pdfBig->SetXY($left_str_x, $subj_y+30);	
			$pdfBig->MultiCell(180, 1, '', 'T', 'C', 0, 0); //2nd horizontal line
			$pdfBig->SetXY(51.5, $subj_y+30);//191
			$pdfBig->MultiCell(25.5, 18, '', 'LR', 'C', 0, 0);
			$pdfBig->SetXY(77, $subj_y+30);//191
			$pdfBig->MultiCell(39, 18, '', 'LR', 'C', 0, 0); //2 & 3 verticle line
			$pdfBig->SetXY(116, $subj_y+30);//191

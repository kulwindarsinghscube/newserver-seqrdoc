...
class ValidateExcelGhostYellowUtilityJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        if($columnsCount1==2){
            if($dropdown_template_id==1){
                ...
                $columnArr=array("Ghost Image Text", "File Name of Ghost Image");
                    ...
                    $columnArr=array("Yellow Patch Text", "File Name of Yellow Patch");

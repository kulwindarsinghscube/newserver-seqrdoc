...
class PdfGenerateBMCCSOMJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        $pdfBig->AddSpotColor('Spot Dark Green', 100, 50, 80, 45); // clear text on bottom red and in clear text logo
         // add spot colors
        $pdfBig->AddSpotColor('Special', 0, 0, 100, 0);        // For Invisible //Spot Red
        //set fonts
...
// Ghost image
        ...
        //Testing
        // $signature_path = public_path().'\\'.$subdomain[0].'\backend\templates\100\1_uv_special.jpg';
        // $signaturex = 285;
        // $signaturey = 260;
        // $signatureWidth = 30;
        // $signatureHeight = 30;
        ...
        //  $uv_location = public_path().'\\'.$subdomain[0].'\backend\templates\100\1_uv_special.jpg';
        //  $im = imagecreatefromjpeg($signature_path);
        // imagefilter($im, IMG_FILTER_GRAYSCALE);
        // imagefilter($im, IMG_FILTER_NEGATE);
     
        //     imagefilter($im, IMG_FILTER_COLORIZE, 255, 241, 1);
     
        // imagejpeg($im, $uv_location);
        // imagedestroy($im);  
         /********INVISIBLE Start****/
        // $pdfBig->SetOverprint(true, true, 0);
        // $pdfBig->SetFont($arialb, 'B', 11, '', false);
        // $pdfBig->SetTextSpotColor('Special', 100);
        // $pdfBig->setXY(330, 266);
        // $pdfBig->MultiCell(169, 0, $nameOrg, '', 'L', 0, 1);

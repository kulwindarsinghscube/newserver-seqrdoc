...
class PdfGenerateMallareddyBComComputerJobAPI
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        $subjectsMark=$pdf_data['subjectsDataOrg'];
        $subjectDataOrg=$pdf_data['subjectsDataOrg'];
        ...
        // if($studentDataOrg&&!empty($studentDataOrg)){
            ...
            foreach ($studentDataOrg as $studentData) {
                    ...
                    if ($year == "I" || $year == "II" || $year == "III" ) {
                        ...
                        foreach($year_array as $key => $val){
                            ...
                            if($val[2] == 'I') {
                                ...
                                $pdfBig->startTransaction();
                                $pdfBig->SetFont($palatino, '', 6, '', false); 
                                // get the number of lines
                ...
                $pdf->MultiCell(32, 7, ' :&nbsp;&nbsp;'.$class_awarded, 0, "L", 0, 0, '', '', true, 0, true);
                ...
                $pdf->SetFont($palatino, '', 7.5, '', false); 
                $pdf->SetXY(68,281);        
        ...
        // }
        // echo "Generated Successfully"; die;

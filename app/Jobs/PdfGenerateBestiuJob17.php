    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
		...
		if($studentDataOrg&&!empty($studentDataOrg)){
			foreach ($studentDataOrg as $studentData) {
				...
				$II_SEM=trim($studentData[63]);
				$SEM2_COURSE_CODE_1=trim($studentData[64]);
				$SEM2_COURSE_TITLE_1=trim($studentData[65]);
				$SEM2_CREDIT_HOURS_1=trim($studentData[66]);
				$SEM2_GRADE_POINT_1=trim($studentData[67]);
				$SEM2_CREDIT_POINTS_1=trim($studentData[68]);
				$SEM2_COURSE_CODE_2=trim($studentData[69]);
				$SEM2_COURSE_TITLE_2=trim($studentData[70]);
				$SEM2_CREDIT_HOURS_2=trim($studentData[71]);
				$SEM2_GRADE_POINT_2=trim($studentData[72]);
				$SEM2_CREDIT_POINTS_2=trim($studentData[73]);
				$SEM2_COURSE_CODE_3=trim($studentData[74]);
				$SEM2_COURSE_TITLE_3=trim($studentData[75]);
				$SEM2_CREDIT_HOURS_3=trim($studentData[76]);
				$SEM2_GRADE_POINT_3=trim($studentData[77]);
				$SEM2_CREDIT_POINTS_3=trim($studentData[78]);
				$SEM2_COURSE_CODE_4=trim($studentData[79]);
				$SEM2_COURSE_TITLE_4=trim($studentData[80]);
				$SEM2_CREDIT_HOURS_4=trim($studentData[81]);
				$SEM2_GRADE_POINT_4=trim($studentData[82]);
				$SEM2_CREDIT_POINTS_4=trim($studentData[83]);
				$SEM2_COURSE_CODE_5=trim($studentData[84]);
				$SEM2_COURSE_TITLE_5=trim($studentData[85]);
				$SEM2_CREDIT_HOURS_5=trim($studentData[86]);
				$SEM2_GRADE_POINT_5=trim($studentData[87]);
				$SEM2_CREDIT_POINTS_5=trim($studentData[88]);
				$SEM2_COURSE_CODE_6=trim($studentData[89]);
				$SEM2_COURSE_TITLE_6=trim($studentData[90]);
				$SEM2_CREDIT_HOURS_6=trim($studentData[91]);
				$SEM2_GRADE_POINT_6=trim($studentData[92]);
				$SEM2_CREDIT_POINTS_6=trim($studentData[93]);
				$SEM2_COURSE_CODE_7=trim($studentData[94]);
				$SEM2_COURSE_TITLE_7=trim($studentData[95]);
				$SEM2_CREDIT_HOURS_7=trim($studentData[96]);
				$SEM2_GRADE_POINT_7=trim($studentData[97]);
				$SEM2_CREDIT_POINTS_7=trim($studentData[98]);
				$SEM2_COURSE_CODE_8=trim($studentData[99]);
				$SEM2_COURSE_TITLE_8=trim($studentData[100]);
				$SEM2_CREDIT_HOURS_8=trim($studentData[101]);
				$SEM2_GRADE_POINT_8=trim($studentData[102]);
				$SEM2_CREDIT_POINTS_8=trim($studentData[103]);
				$SEM2_COURSE_CODE_9=trim($studentData[104]);
				$SEM2_COURSE_TITLE_9=trim($studentData[105]);
				$SEM2_CREDIT_HOURS_9=trim($studentData[106]);
				$SEM2_GRADE_POINT_9=trim($studentData[107]);
				$SEM2_CREDIT_POINTS_9=trim($studentData[108]);
				$III_SEM=trim($studentData[109]);
				$SEM3_COURSE_CODE_1=trim($studentData[110]);
				$SEM3_COURSE_TITLE_1=trim($studentData[111]);
				$SEM3_CREDIT_HOURS_1=trim($studentData[112]);
				$SEM3_GRADE_POINT_1=trim($studentData[113]);
				$SEM3_CREDIT_POINTS_1=trim($studentData[114]);
				$SEM3_COURSE_CODE_2=trim($studentData[115]);
				$SEM3_COURSE_TITLE_2=trim($studentData[116]);
				$SEM3_CREDIT_HOURS_2=trim($studentData[117]);
				$SEM3_GRADE_POINT_2=trim($studentData[118]);
				$SEM3_CREDIT_POINTS_2=trim($studentData[119]);
				$SEM3_COURSE_CODE_3=trim($studentData[120]);
				$SEM3_COURSE_TITLE_3=trim($studentData[121]);
				$SEM3_CREDIT_HOURS_3=trim($studentData[122]);
				$SEM3_GRADE_POINT_3=trim($studentData[123]);
				$SEM3_CREDIT_POINTS_3=trim($studentData[124]);
				$SEM3_COURSE_CODE_4=trim($studentData[125]);
				$SEM3_COURSE_TITLE_4=trim($studentData[126]);
				$SEM3_CREDIT_HOURS_4=trim($studentData[127]);
				$SEM3_GRADE_POINT_4=trim($studentData[128]);
				$SEM3_CREDIT_POINTS_4=trim($studentData[129]);
				$SEM3_COURSE_CODE_5=trim($studentData[130]);
				$SEM3_COURSE_TITLE_5=trim($studentData[131]);
				$SEM3_CREDIT_HOURS_5=trim($studentData[132]);
				$SEM3_GRADE_POINT_5=trim($studentData[133]);
				$SEM3_CREDIT_POINTS_5=trim($studentData[134]);
				$SEM3_COURSE_CODE_6=trim($studentData[135]);
				$SEM3_COURSE_TITLE_6=trim($studentData[136]);
				$SEM3_CREDIT_HOURS_6=trim($studentData[137]);
				$SEM3_GRADE_POINT_6=trim($studentData[138]);
				$SEM3_CREDIT_POINTS_6=trim($studentData[139]);
				$SEM3_COURSE_CODE_7=trim($studentData[140]);
				$SEM3_COURSE_TITLE_7=trim($studentData[141]);
				$SEM3_CREDIT_HOURS_7=trim($studentData[142]);
				$SEM3_GRADE_POINT_7=trim($studentData[143]);
				$SEM3_CREDIT_POINTS_7=trim($studentData[144]);
				$SEM3_COURSE_CODE_8=trim($studentData[145]);
				$SEM3_COURSE_TITLE_8=trim($studentData[146]);
				$SEM3_CREDIT_HOURS_8=trim($studentData[147]);
				$SEM3_GRADE_POINT_8=trim($studentData[148]);
				$SEM3_CREDIT_POINTS_8=trim($studentData[149]);
				$SEM3_COURSE_CODE_9=trim($studentData[150]);
				$SEM3_COURSE_TITLE_9=trim($studentData[151]);
				$SEM3_CREDIT_HOURS_9=trim($studentData[152]);
				$SEM3_GRADE_POINT_9=trim($studentData[153]);
				$SEM3_CREDIT_POINTS_9=trim($studentData[154]);
				
				$IV_SEM=trim($studentData[155]);
				$SEM4_COURSE_CODE_1=trim($studentData[156]);
				$SEM4_COURSE_TITLE_1=trim($studentData[157]);
				$SEM4_CREDIT_HOURS_1=trim($studentData[158]);
				$SEM4_GRADE_POINT_1=trim($studentData[159]);
				$SEM4_CREDIT_POINTS_1=trim($studentData[160]);
				$SEM4_COURSE_CODE_2=trim($studentData[161]);
				$SEM4_COURSE_TITLE_2=trim($studentData[162]);
				$SEM4_CREDIT_HOURS_2=trim($studentData[163]);
				$SEM4_GRADE_POINT_2=trim($studentData[164]);
				$SEM4_CREDIT_POINTS_2=trim($studentData[165]);
				$SEM4_COURSE_CODE_3=trim($studentData[166]);
				$SEM4_COURSE_TITLE_3=trim($studentData[167]);
				$SEM4_CREDIT_HOURS_3=trim($studentData[168]);
				$SEM4_GRADE_POINT_3=trim($studentData[169]);
				$SEM4_CREDIT_POINTS_3=trim($studentData[170]);
				$SEM4_COURSE_CODE_4=trim($studentData[171]);
				$SEM4_COURSE_TITLE_4=trim($studentData[172]);
				$SEM4_CREDIT_HOURS_4=trim($studentData[173]);
				$SEM4_GRADE_POINT_4=trim($studentData[174]);
				$SEM4_CREDIT_POINTS_4=trim($studentData[175]);
				$SEM4_COURSE_CODE_5=trim($studentData[176]);
				$SEM4_COURSE_TITLE_5=trim($studentData[177]);
				$SEM4_CREDIT_HOURS_5=trim($studentData[178]);
				$SEM4_GRADE_POINT_5=trim($studentData[179]);
				$SEM4_CREDIT_POINTS_5=trim($studentData[180]);
				$SEM4_COURSE_CODE_6=trim($studentData[181]);
				$SEM4_COURSE_TITLE_6=trim($studentData[182]);
				$SEM4_CREDIT_HOURS_6=trim($studentData[183]);
				$SEM4_GRADE_POINT_6=trim($studentData[184]);
				$SEM4_CREDIT_POINTS_6=trim($studentData[185]);
				$SEM4_COURSE_CODE_7=trim($studentData[186]);
				$SEM4_COURSE_TITLE_7=trim($studentData[187]);
				$SEM4_CREDIT_HOURS_7=trim($studentData[188]);
				$SEM4_GRADE_POINT_7=trim($studentData[189]);
				$SEM4_CREDIT_POINTS_7=trim($studentData[190]);
				$SEM4_COURSE_CODE_8=trim($studentData[191]);
				$SEM4_COURSE_TITLE_8=trim($studentData[192]);
				$SEM4_CREDIT_HOURS_8=trim($studentData[193]);
				$SEM4_GRADE_POINT_8=trim($studentData[194]);
				$SEM4_CREDIT_POINTS_8=trim($studentData[195]);
				$SEM4_COURSE_CODE_9=trim($studentData[196]);
				$SEM4_COURSE_TITLE_9=trim($studentData[197]);
				$SEM4_CREDIT_HOURS_9=trim($studentData[198]);
				$SEM4_GRADE_POINT_9=trim($studentData[199]);
				$SEM4_CREDIT_POINTS_9=trim($studentData[200]);			
				$V_SEM=trim($studentData[201]);
				$SEM5_COURSE_CODE_1=trim($studentData[202]);
				$SEM5_COURSE_TITLE_1=trim($studentData[203]);
				$SEM5_CREDIT_HOURS_1=trim($studentData[204]);
				$SEM5_GRADE_POINT_1=trim($studentData[205]);
				$SEM5_CREDIT_POINTS_1=trim($studentData[206]);
				$SEM5_COURSE_CODE_2=trim($studentData[207]);
				$SEM5_COURSE_TITLE_2=trim($studentData[208]);
				$SEM5_CREDIT_HOURS_2=trim($studentData[209]);
				$SEM5_GRADE_POINT_2=trim($studentData[210]);
				$SEM5_CREDIT_POINTS_2=trim($studentData[211]);
				$SEM5_COURSE_CODE_3=trim($studentData[212]);
				$SEM5_COURSE_TITLE_3=trim($studentData[213]);
				$SEM5_CREDIT_HOURS_3=trim($studentData[214]);
				$SEM5_GRADE_POINT_3=trim($studentData[215]);
				$SEM5_CREDIT_POINTS_3=trim($studentData[216]);
				$SEM5_COURSE_CODE_4=trim($studentData[217]);
				$SEM5_COURSE_TITLE_4=trim($studentData[218]);
				$SEM5_CREDIT_HOURS_4=trim($studentData[219]);
				$SEM5_GRADE_POINT_4=trim($studentData[220]);
				$SEM5_CREDIT_POINTS_4=trim($studentData[221]);
				$SEM5_COURSE_CODE_5=trim($studentData[222]);
				$SEM5_COURSE_TITLE_5=trim($studentData[223]);
				$SEM5_CREDIT_HOURS_5=trim($studentData[224]);
				$SEM5_GRADE_POINT_5=trim($studentData[225]);
				$SEM5_CREDIT_POINTS_5=trim($studentData[226]);
				$SEM5_COURSE_CODE_6=trim($studentData[227]);
				$SEM5_COURSE_TITLE_6=trim($studentData[228]);
				$SEM5_CREDIT_HOURS_6=trim($studentData[229]);
				$SEM5_GRADE_POINT_6=trim($studentData[230]);
				$SEM5_CREDIT_POINTS_6=trim($studentData[231]);
				$SEM5_COURSE_CODE_7=trim($studentData[232]);
				$SEM5_COURSE_TITLE_7=trim($studentData[233]);
				$SEM5_CREDIT_HOURS_7=trim($studentData[234]);
				$SEM5_GRADE_POINT_7=trim($studentData[235]);
				$SEM5_CREDIT_POINTS_7=trim($studentData[236]);
				$SEM5_COURSE_CODE_8=trim($studentData[237]);
				$SEM5_COURSE_TITLE_8=trim($studentData[238]);
				$SEM5_CREDIT_HOURS_8=trim($studentData[239]);
				$SEM5_GRADE_POINT_8=trim($studentData[240]);
				$SEM5_CREDIT_POINTS_8=trim($studentData[241]);

				$VI_SEM=trim($studentData[242]);
				$SEM6_COURSE_CODE_1=trim($studentData[243]);
				$SEM6_COURSE_TITLE_1=trim($studentData[244]);
				$SEM6_CREDIT_HOURS_1=trim($studentData[245]);
				$SEM6_GRADE_POINT_1=trim($studentData[246]);
				$SEM6_CREDIT_POINTS_1=trim($studentData[247]);
				$SEM6_COURSE_CODE_2=trim($studentData[248]);
				$SEM6_COURSE_TITLE_2=trim($studentData[249]);
				$SEM6_CREDIT_HOURS_2=trim($studentData[250]);
				$SEM6_GRADE_POINT_2=trim($studentData[251]);
				$SEM6_CREDIT_POINTS_2=trim($studentData[252]);
				$SEM6_COURSE_CODE_3=trim($studentData[253]);
				$SEM6_COURSE_TITLE_3=trim($studentData[254]);
				$SEM6_CREDIT_HOURS_3=trim($studentData[255]);
				$SEM6_GRADE_POINT_3=trim($studentData[256]);
				$SEM6_CREDIT_POINTS_3=trim($studentData[257]);
				$SEM6_COURSE_CODE_4=trim($studentData[258]);
				$SEM6_COURSE_TITLE_4=trim($studentData[259]);
				$SEM6_CREDIT_HOURS_4=trim($studentData[260]);
				$SEM6_GRADE_POINT_4=trim($studentData[261]);
				$SEM6_CREDIT_POINTS_4=trim($studentData[262]);
				$SEM6_COURSE_CODE_5=trim($studentData[263]);
				$SEM6_COURSE_TITLE_5=trim($studentData[264]);
				$SEM6_CREDIT_HOURS_5=trim($studentData[265]);
				$SEM6_GRADE_POINT_5=trim($studentData[266]);
				$SEM6_CREDIT_POINTS_5=trim($studentData[267]);
				$SEM6_COURSE_CODE_6=trim($studentData[268]);
				$SEM6_COURSE_TITLE_6=trim($studentData[269]);
				$SEM6_CREDIT_HOURS_6=trim($studentData[270]);
				$SEM6_GRADE_POINT_6=trim($studentData[271]);
				$SEM6_CREDIT_POINTS_6=trim($studentData[272]);
				$SEM6_COURSE_CODE_7=trim($studentData[273]);
				$SEM6_COURSE_TITLE_7=trim($studentData[274]);
				$SEM6_CREDIT_HOURS_7=trim($studentData[275]);
				$SEM6_GRADE_POINT_7=trim($studentData[276]);
				$SEM6_CREDIT_POINTS_7=trim($studentData[277]);
				$SEM6_COURSE_CODE_8=trim($studentData[278]);
				$SEM6_COURSE_TITLE_8=trim($studentData[279]);
				$SEM6_CREDIT_HOURS_8=trim($studentData[280]);
				$SEM6_GRADE_POINT_8=trim($studentData[281]);
				$SEM6_CREDIT_POINTS_8=trim($studentData[282]);						

				$VII_SEM=trim($studentData[283]);
				$SEM7_COURSE_CODE_1=trim($studentData[284]);
				$SEM7_COURSE_TITLE_1=trim($studentData[285]);
				$SEM7_CREDIT_HOURS_1=trim($studentData[286]);
				$SEM7_GRADE_POINT_1=trim($studentData[287]);
				$SEM7_CREDIT_POINTS_1=trim($studentData[288]);
				$SEM7_COURSE_CODE_2=trim($studentData[289]);
				$SEM7_COURSE_TITLE_2=trim($studentData[290]);
				$SEM7_CREDIT_HOURS_2=trim($studentData[291]);
				$SEM7_GRADE_POINT_2=trim($studentData[292]);
				$SEM7_CREDIT_POINTS_2=trim($studentData[293]);
				$SEM7_COURSE_CODE_3=trim($studentData[294]);
				$SEM7_COURSE_TITLE_3=trim($studentData[295]);
				$SEM7_CREDIT_HOURS_3=trim($studentData[296]);
				$SEM7_GRADE_POINT_3=trim($studentData[297]);
				$SEM7_CREDIT_POINTS_3=trim($studentData[298]);
				$SEM7_COURSE_CODE_4=trim($studentData[299]);
				$SEM7_COURSE_TITLE_4=trim($studentData[300]);
				$SEM7_CREDIT_HOURS_4=trim($studentData[301]);
				$SEM7_GRADE_POINT_4=trim($studentData[302]);
				$SEM7_CREDIT_POINTS_4=trim($studentData[303]);
				$SEM7_COURSE_CODE_5=trim($studentData[304]);
				$SEM7_COURSE_TITLE_5=trim($studentData[305]);
				$SEM7_CREDIT_HOURS_5=trim($studentData[306]);
				$SEM7_GRADE_POINT_5=trim($studentData[307]);
				$SEM7_CREDIT_POINTS_5=trim($studentData[308]);
				$SEM7_COURSE_CODE_6=trim($studentData[309]);
				$SEM7_COURSE_TITLE_6=trim($studentData[310]);
				$SEM7_CREDIT_HOURS_6=trim($studentData[311]);
				$SEM7_GRADE_POINT_6=trim($studentData[312]);
				$SEM7_CREDIT_POINTS_6=trim($studentData[313]);
				
				$VIII_SEM=trim($studentData[314]);
				$SEM8_COURSE_CODE_1=trim($studentData[315]);
				$SEM8_COURSE_TITLE_1=trim($studentData[316]);
				$SEM8_CREDIT_HOURS_1=trim($studentData[317]);
				$SEM8_GRADE_POINT_1=trim($studentData[318]);
				$SEM8_CREDIT_POINTS_1=trim($studentData[319]);
				$SEM8_COURSE_CODE_2=trim($studentData[320]);
				$SEM8_COURSE_TITLE_2=trim($studentData[321]);
				$SEM8_CREDIT_HOURS_2=trim($studentData[322]);
				$SEM8_GRADE_POINT_2=trim($studentData[323]);
				$SEM8_CREDIT_POINTS_2=trim($studentData[324]);
				$SEM8_COURSE_CODE_3=trim($studentData[325]);
				$SEM8_COURSE_TITLE_3=trim($studentData[326]);
				$SEM8_CREDIT_HOURS_3=trim($studentData[327]);
				$SEM8_GRADE_POINT_3=trim($studentData[328]);
				$SEM8_CREDIT_POINTS_3=trim($studentData[329]);
				$SEM8_COURSE_CODE_4=trim($studentData[330]);
				$SEM8_COURSE_TITLE_4=trim($studentData[331]);
				$SEM8_CREDIT_HOURS_4=trim($studentData[332]);
				$SEM8_GRADE_POINT_4=trim($studentData[333]);
				$SEM8_CREDIT_POINTS_4=trim($studentData[334]);
				$SEM8_COURSE_CODE_5=trim($studentData[335]);
				$SEM8_COURSE_TITLE_5=trim($studentData[336]);
				$SEM8_CREDIT_HOURS_5=trim($studentData[337]);
				$SEM8_GRADE_POINT_5=trim($studentData[338]);
				$SEM8_CREDIT_POINTS_5=trim($studentData[339]);
				$SEM8_COURSE_CODE_6=trim($studentData[340]);
				$SEM8_COURSE_TITLE_6=trim($studentData[341]);
				$SEM8_CREDIT_HOURS_6=trim($studentData[342]);
				$SEM8_GRADE_POINT_6=trim($studentData[343]);
				$SEM8_CREDIT_POINTS_6=trim($studentData[344]);
				$SEM8_COURSE_CODE_7=trim($studentData[345]);
				$SEM8_COURSE_TITLE_7=trim($studentData[346]);
				$SEM8_CREDIT_HOURS_7=trim($studentData[347]);
				$SEM8_GRADE_POINT_7=trim($studentData[348]);
				$SEM8_CREDIT_POINTS_7=trim($studentData[349]);

				$TOTAL_CREDITS_CREDIT_HOURS=trim($studentData[350]);
				$TOTAL_CREDITS_CREDIT_POINTS=trim($studentData[351]);
				$OVERALL_GRADE_POINT_AVERAGE=trim($studentData[352]);
				$DATE=trim($studentData[353]);
				$Photo=trim($studentData[354]);
				...
				for ($x = 1; $x <= 6; $x++) {
					...
					// 	$pdfBig->MultiCell(11, 20, ${"SEM8_COURSE_CODE_" . $x}, 'LB', 'L', 0, 0, '', '', true, 0, true);
					// 	$pdfBig->setCellPaddings( $left = '', $top = '0', $right = '', $bottom = '');
					// }
					// if($x == 6){
					//     $pdfBig->MultiCell(11, 4, ${"SEM8_COURSE_CODE_" . $x}, 'LBT', 'L', 0, 0, '', '', true, 0, true);
					// }
				...
				for ($x = 1; $x <= 7; $x++) {								
					...
					// if($x == 1){
					// 	$pdfBig->setCellPaddings( $left = '', $top = '12', $right = '', $bottom = '');
					// 	$pdfBig->MultiCell(11, 28, ${"SEM7_COURSE_CODE_" . $x}, 'LB', 'L', 0, 0, '', '', true, 0, true);
					// 	$pdfBig->setCellPaddings( $left = '', $top = '0', $right = '', $bottom = '');
					// }
					// if($x == 7){
				...
				for ($x = 1; $x <= 6; $x++) {
					...
					// 	$pdf->MultiCell(11, 20, ${"SEM8_COURSE_CODE_" . $x}, 'LB', 'L', 0, 0, '', '', true, 0, true);
					// 	$pdf->setCellPaddings( $left = '', $top = '0', $right = '', $bottom = '');
					// }
					// if($x == 6){
					//     $pdf->MultiCell(11, 4, ${"SEM8_COURSE_CODE_" . $x}, 'LBT', 'L', 0, 0, '', '', true, 0, true);
					// }
				...
				for ($x = 1; $x <= 7; $x++) {								
					...
					// if($x == 1){
					// 	$pdf->setCellPaddings( $left = '', $top = '12', $right = '', $bottom = '');
					// 	$pdf->MultiCell(11, 28, ${"SEM7_COURSE_CODE_" . $x}, 'LB', 'L', 0, 0, '', '', true, 0, true);
					// 	$pdf->setCellPaddings( $left = '', $top = '0', $right = '', $bottom = '');
					// }
					// if($x == 7){

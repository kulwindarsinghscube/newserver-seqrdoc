...
class ValidateExcelPepolesuniConsolidatedMedicalJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        if($columnsCount1==40&&$columnsCount2==12){

            $columnArr=array("Sr No","Enrollmentno","NameofStudent","FatherName","MotherName","CourseName","InstituteName","Specialization","EnrolledSession","Exam_Result_MonthYear","MarksheetNo","exam1_myop","examp1_status","exam1_tec","exam1_sgpa","exam2_myop","examp2_status","exam2_tec","exam2_sgpa","exam3_myop","examp3_status","exam3_tec","exam3_sgpa","exam4_myop","examp4_status","exam4_tec","exam4_sgpa","exam5_myop","examp5_status","exam5_tec","exam5_sgpa","exam6_myop","examp6_status","exam6_tec","exam6_sgpa","final_cgpa","final_result","division","place","issue_date");

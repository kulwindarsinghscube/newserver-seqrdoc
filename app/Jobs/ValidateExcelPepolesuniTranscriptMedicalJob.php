...
class ValidateExcelPepolesuniTranscriptMedicalJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        $columnsCount3=count($rowData3[0]);
        
        if($columnsCount1==48&&$columnsCount2==7 &&$columnsCount3==8){

            $columnArr=array("Unique_ID","Name of Student","FathersName","Enrollment Number","Enrollment Year","Name of Course","Name of  Institute","Duration of Course","I _Total_ Theory Min (Hours)","I_Total_Practical Min (Hours)","I_Total_ Clinical (Hours)","I_Total","II _Total_ Theory Min (Hours)","II_Total_Practical Min (Hours)","II_Total_ Clinical (Hours)","II_Total","III _Total_ Theory Min (Hours)","III_Total_Practical Min (Hours)","III_Total_ Clinical (Hours)","III_Total","IV _Total_ Theory Min (Hours)","IV_Total_Practical Min (Hours)","IV_Total_ Clinical (Hours)","IV_Total","I_Year Exam","I_Year Attempt","I_Year Total","I_Year Percentage","I_Year Division","II_Year Exam","II_Year Attempt","II_Year Total","II_Year Percentage","II_Year Division","III_Year Exam","III_Year Attempt","III_Year Total","III_Year Percentage","III_Year Division","IV_Year Exam","IV_Year Attempt","IV_Year Total","IV_Year Percentage","IV_Year Division","Grand_Total","Grand_Percentage","Grand_Division","duration_note");
            ...
            $columnArr=array("Unique_ID","Year","Paper Name","Theory Min (Hours)","Practical Min (Hours)","Clinical (Hours)","Total");
            ...
            $columnArr=array("Unique_ID","Year","Paper Code","Paper Name","Max Theory Marks","Theory Marks Obtained","Max Practical Marks","Practical Marks Obtained");
            $mismatchColArr3=array_diff($rowData3[0], $columnArr);
            if(count($mismatchColArr3)>0){
                return response()->json(['success'=>false,'type' => 'error', 'message' => 'Sheet3 : Column names not matching as per requirement. Please check columns : '.implode(',', $mismatchColArr3)]);
            }


        }elseif($columnsCount1!=48){

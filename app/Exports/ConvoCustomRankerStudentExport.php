...
class ConvoCustomRankerStudentExport implements FromCollection, WithHeadings, WithMapping
{
    protected $filters;
    ...
    public function headings(): array
    {
        ...
        return [
            ...
            'Rank (Hindi)',//Enable when rank data export
    ...
    public function map($convoStudent): array
    {
        ...
        return [
            ...
            // "DC_2024_".$convoStudent->prn, //Enable when degree and phd data export

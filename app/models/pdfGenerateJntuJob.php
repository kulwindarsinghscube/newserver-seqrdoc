...
class pdfGenerateJntuJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
            ...
            $old_y = $pdfBig->getY();  
            $pdfBig->SetXY($x_axis_main_info_second, $pdfBig->getY()+4);
            $content_font_size = 9; 
            $pdfBig->SetFont($timesb, '', $content_font_size, '', false);  
            ...
            $pdfBig->SetFont($times, '', $font_size); 
            // Measure the text width at the initial font size
            // $textWidth = $pdfBig->GetStringWidth(': '.$hall_ticket);
            ...
            $pdfBig->SetXY(154.5, $pdfBig->getY()-1);
            $pdfBig->MultiCell($max_width,  $main_info_height, "", 1, "L", 0, 0, '', '', true, 0, true); 

            $pdfBig->SetXY(154.5, $old_y);
            $pdfBig->ln();
            $pdfBig->SetXY($x_axis_main_info, $pdfBig->getY());
            $content_font_size = 9; 
            $pdfBig->SetFont($timesb, '', $content_font_size, '', false);
            ...
            $pdfBig->MultiCell(20, 12.5, 'SUBJECT CODE', 1, 'C', 0, 0, '', '', true, 0, true);    
			
            $pdfBig->setCellPaddings($left = '', $top = '4', $right = '', $bottom = '');
            $pdfBig->SetXY($pdfBig->getX(), $table_heading_y_axis);
			$pdfBig->MultiCell(68, 12.5, 'SUBJECT TITLE', 1, 'C', 0, 0, '', '', true, 0, true);
			...
			for ($s=0; $s < 12; $s++) {
                ...
                $pdfBig->MultiCell(20, $table_content_height1, $SubjectCode, "RL", 'L', 0, 0, '', '', true, 0, true);    
                $pdfBig->SetXY($pdfBig->getX(), $table_content_y);
                $pdfBig->MultiCell(68, $table_content_height1, $SubjectTitle, "RL", 'L', 0, 0, '', '', true, 0, true);
                $pdfBig->SetXY($pdfBig->getX(), $table_content_y);
            ...
            $old_y = $pdf->getY();
            $pdf->SetXY($x_axis_main_info_second, $pdf->getY()+4);
            $content_font_size = 9;
            $pdf->SetFont($timesb, '', $content_font_size, '', false);
            ...
            $pdf->SetFont($times, '', $font_size); 
            // Measure the text width at the initial font size
            // $textWidth = $pdf->GetStringWidth(': '.$hall_ticket);
            ...
            $pdf->SetXY(154.5, $pdf->getY()-1);
            $pdf->MultiCell($max_width,  $main_info_height, "", 1, "L", 0, 0, '', '', true, 0, true); 
             $pdf->SetXY(154.5, $old_y);
            $pdf->ln();
            $pdf->SetXY($x_axis_main_info, $pdf->getY());
            $content_font_size = 9;
            $pdf->SetFont($timesb, '', $content_font_size, '', false);
            ...
            $pdf->MultiCell(20, 12.5, 'SUBJECT CODE', 1, 'C', 0, 0, '', '', true, 0, true);    
			
            $pdf->setCellPaddings($left = '', $top = '4', $right = '', $bottom = '');
            $pdf->SetXY($pdf->getX(), $table_heading_y_axis);
			$pdf->MultiCell(68, 12.5, 'SUBJECT TITLE', 1, 'C', 0, 0, '', '', true, 0, true);
			...
			for ($s=0; $s < 12; $s++) {
                ...
                $pdf->MultiCell(20, $table_content_height1, $SubjectCode, "RL", 'L', 0, 0, '', '', true, 0, true);    
                $pdf->SetXY($pdf->getX(), $table_content_y);
                $pdf->MultiCell(68, $table_content_height1, $SubjectTitle, "RL", 'L', 0, 0, '', '', true, 0, true);
                $pdf->SetXY($pdf->getX(), $table_content_y);

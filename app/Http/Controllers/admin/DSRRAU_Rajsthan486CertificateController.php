...
class DSRRAU_Rajsthan486CertificateController extends Controller
{
...
//         $textcolor = imagecolorallocatealpha($image, 230, 230, 230, 100);
       ...
       // $pdf = new TCPDF('P', 'mm', array('210', '297'), true, 'UTF-8', false);
        ...
        $fileNameJob="486_400000_401000";
        for($i=1;$i<501;$i++){
        //$i=0;
        $serial_number=400000+$i;    
        $pdf->AddPage();
      ...
      */
       ...
       //$pdf->Output('sample.pdf', 'I');  
        ...
        $pdf->output($myPath . DIRECTORY_SEPARATOR .$fileNameJob.'.pdf', 'F');
           ...
           //  $bgPath="C:/Inetpub/vhosts/seqrdoc.com/httpdocs/demo/public/demo/backend/rajsthan_ayurveda/0486_Dr_S_R_Rajasthan_Ayurved_University_Migration_Certificate_DIGITAL.pdf";

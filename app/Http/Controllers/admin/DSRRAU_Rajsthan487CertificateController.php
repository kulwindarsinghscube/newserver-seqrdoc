...
class DSRRAU_Rajsthan487CertificateController extends Controller
{
...
//         $textcolor = imagecolorallocatealpha($image, 230, 230, 230, 100);
       ...
       // $pdf = new TCPDF('P', 'mm', array('210', '297'), true, 'UTF-8', false);
        $pdf = new TCPDF('P', 'mm', array('330.2', '482.6'), true, 'UTF-8', false);
        $pdf->SetCreator('TCPDF');
        $pdf->SetAuthor('TCPDF');
        $pdf->SetTitle('Certificate');
        $pdf->SetSubject('');
        ...
        $fileNameJob="487_301000_302000";
        for($i=1;$i<501;$i++){
       // $i=0;
        $serial_number=301000+$i;    
        $pdf->AddPage();
      ...
      */
       ...
       //$pdf->Output('sample.pdf', 'I');  
        ...
        $pdf->output($myPath . DIRECTORY_SEPARATOR .$fileNameJob.'.pdf', 'F');
            ...
            // $bgPath="C:/Inetpub/vhosts/seqrdoc.com/httpdocs/demo/public/demo/backend/rajsthan_ayurveda/0487_Dr_S_R_Rajasthan_Ayurved_University_Provisional_Certificate.pdf";

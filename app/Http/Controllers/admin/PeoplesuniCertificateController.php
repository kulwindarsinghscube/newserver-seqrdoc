...
use Helper;
use App\Jobs\ValidateExcelPepolesuniJob;
use App\Jobs\ValidateExcelPepolesuniTranscriptMedicalJob;
use App\Jobs\ValidateExcelPepolesuniTranscriptEngJob;
use App\Jobs\ValidateExcelPepolesuniConsolidatedJob;
use App\Jobs\ValidateExcelPepolesuniConsolidatedVIIIJob;
use App\Jobs\ValidateExcelPepolesuniTranscriptCivilJob;


use App\Jobs\PdfGeneratePeoplesuniJob; 
use App\Jobs\PdfGeneratePeopleUniDegreeJob; 
use App\Jobs\PdfGeneratePeopleUniPhdDegreeJob; 
use App\Jobs\PdfGeneratePeopleUniProvisionalJob; 
use App\Jobs\PdfGeneratePeopleUniMigrationJob; 
use App\Jobs\PdfGeneratePeopleTranscriptMedicalJob; 
use App\Jobs\PdfGeneratePeopleTranscriptEngJob; 
use App\Jobs\PdfGeneratePeoplesuniConsolidatedJob; 
use App\Jobs\PdfGeneratePeoplesuniConsolidatedIIJob;
use App\Jobs\PdfGeneratePeoplesuniConsolidatedVIIIJob;

use App\Jobs\PdfGeneratePeopleTranscriptCivilJob;


class PeoplesuniCertificateController extends Controller
{
    public function index(Request $request)
    {
       return view('admin.peoplesuni.index');
    }
    ...
    public function validateExcel(Request $request,CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal){
        ...
        if($request->hasFile('field_file')){
            ...
            if($request['field_file']->move($target_path,$excelfile)){
                ...
                if($dropdown_template_id == 1 || $dropdown_template_id == 2 || $dropdown_template_id == 3 || $dropdown_template_id == 4 || $dropdown_template_id == 5)
                {
                    $objReader = \PhpOffice\PhpSpreadsheet\IOFactory::createReader($inputFileType);
                    /**  Load $inputFileName to a Spreadsheet Object  **/
                    $objPHPExcel1 = $objReader->load($fullpath);
                    ...
                    $response = $this->dispatch(new ValidateExcelPepolesuniJob($excelData));
                    ...
                    $objPHPExcel3 = $objReader->load($fullpath);
                    $sheet3 = $objPHPExcel3->getSheet(2);
                    $highestColumn3 = $sheet3->getHighestColumn();
                    $highestRow3 = $sheet3->getHighestDataRow();
                    $rowData3 = $sheet3->rangeToArray('A1:' . $highestColumn3 . $highestRow3, NULL, TRUE, FALSE);

                    $excelData=array('rowData1'=>$rowData1,'rowData2'=>$rowData2,'rowData3'=>$rowData3,'auth_site_id'=>$auth_site_id,'dropdown_template_id'=>$dropdown_template_id);

                    $response = $this->dispatch(new ValidateExcelPepolesuniTranscriptMedicalJob($excelData));
                    ...
                    $response = $this->dispatch(new ValidateExcelPepolesuniTranscriptEngJob($excelData));
                    ...
                    $response = $this->dispatch(new ValidateExcelPepolesuniConsolidatedJob($excelData));
                ...
                elseif($dropdown_template_id == 9){
                    ...
                    $response = $this->dispatch(new ValidateExcelPepolesuniConsolidatedVIIIJob($excelData));
                 ...
                 elseif($dropdown_template_id == 11){
                    ...
                    $response = $this->dispatch(new ValidateExcelPepolesuniTranscriptCivilJob($excelData));
    ...
    public function uploadfile(Request $request,CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal){
        ...
        if($request->hasFile('field_file')){
            ...
            if($request['field_file']->move($target_path,$excelfile)){
                ...
                if($dropdown_template_id == 1 || $dropdown_template_id == 2 || $dropdown_template_id == 3 || $dropdown_template_id == 4 || $dropdown_template_id == 5)
                {
                    ...
                    $rowData3=array_values($rowData3);
                    ...
                    $rowData1=array_values($rowData1);
                    $rowData2=array_values($rowData2);
                }elseif ($dropdown_template_id == 8 || $dropdown_template_id == 9 || $dropdown_template_id == 10) {
                    $objReader = \PhpOffice\PhpSpreadsheet\IOFactory::createReader($inputFileType);
                    /**  Load $inputFileName to a Spreadsheet Object  **/
                    $objPHPExcel1 = $objReader->load($fullpath);
                    $sheet1 = $objPHPExcel1->getSheet(0);
        ...
        if($dropdown_template_id==1){
            ...
            $pdfData=array('studentDataOrg'=>$rowData1,'teachingDataOrg'=>$rowData2,'subjectDataOrg'=>$rowData3 ,'auth_site_id'=>$auth_site_id,'template_id'=>$template_id,'dropdown_template_id'=>$dropdown_template_id,'previewPdf'=>$previewPdf,'excelfile'=>$excelfile,'loader_token'=>$loader_token);
        } elseif ($dropdown_template_id == 7 || $dropdown_template_id == 8 || $dropdown_template_id == 9 || $dropdown_template_id == 10 || $dropdown_template_id == 11) {
            $pdfData=array('studentDataOrg'=>$rowData1,'subjectDataOrg'=>$rowData2 ,'auth_site_id'=>$auth_site_id,'template_id'=>$template_id,'dropdown_template_id'=>$dropdown_template_id,'previewPdf'=>$previewPdf,'excelfile'=>$excelfile,'loader_token'=>$loader_token);
        } 
        else{
        ...
        // exit;
        if($dropdown_template_id==1){
            $link = $this->dispatch(new PdfGeneratePeoplesuniJob($pdfData));
        } else if($dropdown_template_id==2){
            $link = $this->dispatch(new PdfGeneratePeopleUniDegreeJob($pdfData));
        } else if($dropdown_template_id==3){
            $link = $this->dispatch(new PdfGeneratePeopleUniPhdDegreeJob($pdfData));
        } else if($dropdown_template_id==4){
            $link = $this->dispatch(new PdfGeneratePeopleUniProvisionalJob($pdfData));
        } else if($dropdown_template_id==5){
            $link = $this->dispatch(new PdfGeneratePeopleUniMigrationJob($pdfData));
        } else if($dropdown_template_id==6){
            $link = $this->dispatch(new PdfGeneratePeopleTranscriptMedicalJob($pdfData));
        } else if($dropdown_template_id==7){
            $link = $this->dispatch(new PdfGeneratePeopleTranscriptEngJob($pdfData));
        } else if($dropdown_template_id==8){
            $link = $this->dispatch(new PdfGeneratePeoplesuniConsolidatedJob($pdfData));
        } else if($dropdown_template_id==9){
            $link = $this->dispatch(new PdfGeneratePeoplesuniConsolidatedIIJob($pdfData));
        } else if($dropdown_template_id==10){
            $link = $this->dispatch(new PdfGeneratePeoplesuniConsolidatedVIIIJob($pdfData));
        }else if($dropdown_template_id==11){
            // dd($dropdown_template_id);
            $link = $this->dispatch(new PdfGeneratePeopleTranscriptCivilJob($pdfData));
        }

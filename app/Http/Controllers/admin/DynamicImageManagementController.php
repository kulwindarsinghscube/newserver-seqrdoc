...
class DynamicImageManagementController extends Controller
{
    ...
    public function index(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal){
        ...
        //icat Changes
    	if($subdomain[0]=="icat" || $subdomain[0]=="demo"){
    		if(!isset($template_key)){$template_key=-1;}
    	...
    	if($subdomain[0]=="bestiu"){
			...
			//CSCACS Changes
    	if($subdomain[0]=="cscacs"){
    		if(!isset($template_key)){$template_key=-1;}
			$get_template_folder_image_count = count(glob(public_path()."/".$subdomain[0]."/backend/templates/100/*.{jpg,png,JPG,PNG,JPEG,jpeg,gif}", GLOB_BRACE));
			$template_data[$template_key+1]['template_name']='CSCACS_CUSTOM';
			$template_data[$template_key+1]['template_id']=100;
			$template_data[$template_key+1]['count']=$get_template_folder_image_count;
    	}
    	...
    	if($subdomain[0]=="mvsr"){
    		if(!isset($template_key)){$template_key=-1;}
			$get_template_folder_image_count = count(glob(public_path()."/".$subdomain[0]."/backend/templates/100/*.{jpg,png,JPG,PNG,JPEG,jpeg,gif}", GLOB_BRACE));
			$template_data[$template_key+1]['template_name']='MVSR_CUSTOM';
			$template_data[$template_key+1]['template_id']=100;
			$template_data[$template_key+1]['count']=$get_template_folder_image_count;
    	}
    	...
    	//SJCIT
    	if($subdomain[0]=="sjcit"){
    		if(!isset($template_key)){$template_key=-1;}
			$get_template_folder_image_count = count(glob(public_path()."/".$subdomain[0]."/backend/templates/100/*.{jpg,png,JPG,PNG,JPEG,jpeg,gif}", GLOB_BRACE));
			$template_data[$template_key+1]['template_name']='SJCIT_CUSTOM';
			$template_data[$template_key+1]['template_id']=100;
			$template_data[$template_key+1]['count']=$get_template_folder_image_count;
    	}
    	...
    	if($subdomain[0]=="anu"){
    		if(!isset($template_key)){$template_key=-1;}
			$get_template_folder_image_count = count(glob(public_path()."/".$subdomain[0]."/backend/templates/100/*.{jpg,png,JPG,PNG,JPEG,jpeg,gif}", GLOB_BRACE));
			$template_data[$template_key+1]['template_name']='ANU_CUSTOM';
			$template_data[$template_key+1]['template_id']=100;
			$template_data[$template_key+1]['count']=$get_template_folder_image_count;
    	}
		//Surana Changes
        ...
        //ghribmjal Changes
    	if($subdomain[0]=="ghribmjal"){
    		if(!isset($template_key)){$template_key=-1;}
            $get_template_folder_image_count = count(glob(public_path()."/".$subdomain[0]."/backend/templates/100/*.{jpg,png,JPG,PNG,JPEG,jpeg,gif}", GLOB_BRACE));
            $template_data[$template_key+1]['template_name']='ghribmjal_custom';
            $template_data[$template_key+1]['template_id']=100;
            $template_data[$template_key+1]['count']=$get_template_folder_image_count;
        ...
        //ghribmjal Changes
        if($subdomain[0]=="peoplesuni"){
            if(!isset($template_key)){$template_key=-1;}
            $get_template_folder_image_count = count(glob(public_path()."/".$subdomain[0]."/backend/templates/100/*.{jpg,png,JPG,PNG,JPEG,jpeg,gif}", GLOB_BRACE));
            $template_data[$template_key+1]['template_name']='peoplesuni_custom';
            $template_data[$template_key+1]['template_id']=100;
            $template_data[$template_key+1]['count']=$get_template_folder_image_count;
        }
        //KSWA Changes
        if($subdomain[0]=="aiimsnagpur"){
            if(!isset($template_key)){$template_key=-1;}
            $get_template_folder_image_count = count(glob(public_path()."/".$subdomain[0]."/backend/templates/100/*.{jpg,png,JPG,PNG,JPEG,jpeg,gif}", GLOB_BRACE));
            $template_data[$template_key+1]['template_name']='aiimsnagpur_custom';
            $template_data[$template_key+1]['template_id']=100;
            $template_data[$template_key+1]['count']=$get_template_folder_image_count;
        }
        ...
        if($subdomain[0]=="kswa"){
            if(!isset($template_key)){$template_key=-1;}
            $get_template_folder_image_count = count(glob(public_path()."/".$subdomain[0]."/backend/templates/100/*.{jpg,png,JPG,PNG,JPEG,jpeg,gif}", GLOB_BRACE));
            $template_data[$template_key+1]['template_name']='Yuva_Parivartan';
            $template_data[$template_key+1]['template_id']=100;
            $template_data[$template_key+1]['count']=$get_template_folder_image_count;
        }

        //KSWA Changes
        if($subdomain[0]=="mallareddyuniversity"){
            if(!isset($template_key)){$template_key=-1;}
            $get_template_folder_image_count = count(glob(public_path()."/".$subdomain[0]."/backend/templates/100/*.{jpg,png,JPG,PNG,JPEG,jpeg,gif}", GLOB_BRACE));
            $template_data[$template_key+1]['template_name']='mallareddyuniversity_custom';
            $template_data[$template_key+1]['template_id']=100;
            $template_data[$template_key+1]['count']=$get_template_folder_image_count;
        }

        //cambridgeit Changes
        if($subdomain[0]=="cambridgeit"){
            if(!isset($template_key)){$template_key=-1;}
            $get_template_folder_image_count = count(glob(public_path()."/".$subdomain[0]."/backend/templates/100/*.{jpg,png,JPG,PNG,JPEG,jpeg,gif}", GLOB_BRACE));
            $template_data[$template_key+1]['template_name']='cambridgeit_custom';
            $template_data[$template_key+1]['template_id']=100;
            $template_data[$template_key+1]['count']=$get_template_folder_image_count;
        }

        //eastpoint Changes
        if($subdomain[0]=="eastpoint"){
            if(!isset($template_key)){$template_key=-1;}
            $get_template_folder_image_count = count(glob(public_path()."/".$subdomain[0]."/backend/templates/100/*.{jpg,png,JPG,PNG,JPEG,jpeg,gif}", GLOB_BRACE));
            $template_data[$template_key+1]['template_name']='eastpoint_custom';
            $template_data[$template_key+1]['template_id']=100;
            $template_data[$template_key+1]['count']=$get_template_folder_image_count;
        }
    ...
    public function displayImage($sortBy,$value,$searchkey='',CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal){
        ...
        }else if($folder_name=="100"&&$subdomain[0]=="kswa"){
        	$template_name ='Yuva_Parivartan';
        	//$filenameArray=glob(public_path().'/'.$subdomain[0]."/backend/templates/100/*");
        	$folder_name=100;
        	if(!empty($searchkey)){
    		$filenameArray=glob(public_path().'/'.$subdomain[0].'/backend/templates/'.$folder_name."/".$searchkey."*.{jpg,JPG,png,PNG,jpeg,JPEG}",GLOB_BRACE);

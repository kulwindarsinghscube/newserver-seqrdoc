...
use Helper;
use App\Jobs\ValidateExcelMvsrJob;
use App\Jobs\PdfGenerateMvsrJob;
use App\Jobs\PdfGenerateMvsrCertificateJob2;
use App\Jobs\PdfGenerateMvsrTranscriptJob;
use App\Jobs\PdfGenerateMvsrCertificateJob4;
use App\Jobs\PdfGenerateMvsrCertificateJob5;
use App\Jobs\PdfGenerateMvsrCertificateJob7;
use App\Jobs\PdfGenerateMvsrCertificateJob8;
use App\Jobs\PdfGenerateMvsrCertificateJob9;


class MvsrCertificateController extends Controller
{
    public function index(Request $request)
    {
       return view('admin.mvsr.index');
    }
    ...
    public function validateExcel(Request $request,CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal){
        ...
        if($request->hasFile('field_file')){
            ...
            if($request['field_file']->move($target_path,$excelfile)){
                ...
                if($dropdown_template_id==4||$dropdown_template_id==5||$dropdown_template_id==9){
                ...
                $response = $this->dispatch(new ValidateExcelMvsrJob($excelData));
                //print_r($response);
    ...
    public function uploadfile(Request $request,CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal){
        ...
        if($request->hasFile('field_file')){
            ...
            if($request['field_file']->move($target_path,$excelfile)){
                ...
                if($dropdown_template_id==1||$dropdown_template_id==2||$dropdown_template_id==3||$dropdown_template_id==4||$dropdown_template_id==5||$dropdown_template_id==6||$dropdown_template_id==7||$dropdown_template_id==8||$dropdown_template_id==9){
                    ...
                    if($highestRow1>=$startRow){
                        ...
                        // $rowData1 = $sheet1->rangeToArray('A1:' . $highestColumn1 . $highestRow1, NULL, TRUE, FALSE);
                        if($dropdown_template_id==1 || $dropdown_template_id==3 || $dropdown_template_id==4 ||$dropdown_template_id==5||$dropdown_template_id==7||$dropdown_template_id==8||$dropdown_template_id==9) {
                            $sheet2 = $objPHPExcel1->getSheet(1);
                            $rowData2=$sheet2->toArray();
                            unset($rowData2[0]);
                ...
                // if($dropdown_template_id==4||$dropdown_template_id==5){
                //     $sheet2 = $objPHPExcel1->getSheet(1);
                //     $rowData2=$sheet2->toArray(); 
                //     unset($rowData2[0]);
                //     $rowData2=array_values($rowData2);  
        ...
        // }
        elseif($dropdown_template_id==2||$dropdown_template_id==6){
        ...
        if($dropdown_template_id==1){
            $link = $this->dispatch(new PdfGenerateMvsrJob($pdfData));
        }elseif($dropdown_template_id==2||$dropdown_template_id==6){
            $link = $this->dispatch(new PdfGenerateMvsrCertificateJob2($pdfData));
        }elseif($dropdown_template_id==3){
            $link = $this->dispatch(new PdfGenerateMvsrTranscriptJob($pdfData));
        }elseif($dropdown_template_id==4){
            $link = $this->dispatch(new PdfGenerateMvsrCertificateJob4($pdfData));
        } 
        elseif($dropdown_template_id==5)
        {
      
            $link = $this->dispatch(new PdfGenerateMvsrCertificateJob5($pdfData));
        }
         elseif($dropdown_template_id==7)
        {
      
            $link = $this->dispatch(new PdfGenerateMvsrCertificateJob7($pdfData));
        }
         elseif($dropdown_template_id==8){
            $link = $this->dispatch(new PdfGenerateMvsrCertificateJob8($pdfData));
        } 
         elseif($dropdown_template_id==9){
            $link = $this->dispatch(new PdfGenerateMvsrCertificateJob9($pdfData));
        } 

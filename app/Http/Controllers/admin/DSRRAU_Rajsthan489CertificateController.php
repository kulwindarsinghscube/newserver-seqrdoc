...
class DSRRAU_Rajsthan489CertificateController extends Controller
{
...
// list($width, $height, $type, $attr) = getimagesize($bg_yellow_patch);
       ...
       // $pdf = new TCPDF('P', 'mm', array('210', '297'), true, 'UTF-8', false);
        ...
        $fileNameJob="489_205001_206000";
        for($i=1;$i<501;$i++){
        //$i=0;
        $serial_number=205000+$i;  

        $serial_number2=205500+$i;    
        $pdf->AddPage();
       ...
       //$pdf->Output('sample.pdf', 'I');  
        ...
        $pdf->output($myPath . DIRECTORY_SEPARATOR .$fileNameJob.'.pdf', 'F');
            ...
            $bgPath="C:/Inetpub/vhosts/seqrdoc.com/httpdocs/demo/public/demo/backend/rajsthan_ayurveda/0489_Rajasthan_Ayurved_Nursing_Council_Marksheet_BG_A4_24_04.pdf";

...
use App\Jobs\PdfGenerateMONADJob6; 
use App\Jobs\PdfGenerateMONADJob7; 
...
class MONADCertificateController extends Controller
{
    ...
    public function uploadfile(Request $request,CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal){
		...
		elseif($dropdown_template_id==6){
            ...
            $link = $this->dispatch(new PdfGenerateMONADJob6($pdfData));
        }
         elseif($dropdown_template_id==8){
            $link = $this->dispatch(new PdfGenerateMONADJob7($pdfData));
        }

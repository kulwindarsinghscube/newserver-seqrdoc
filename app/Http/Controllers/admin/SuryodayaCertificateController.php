...
use Helper;
use App\Jobs\ValidateExcelSuryodayaCertificateJob;
use App\Jobs\PdfGenerateSuryodayaCertificateJob;


//     
class SuryodayaCertificateController extends Controller
{
    public function index(Request $request)
    {
       return view('admin.suryodaya.index');
       //newrrmu
    }
        ...
        if($request->hasFile('field_file')){
            ...
            if($request['field_file']->move($target_path,$excelfile)){
                ...
                if($dropdown_template_id == 1)
                {
                    ...
                    $response = $this->dispatch(new ValidateExcelSuryodayaCertificateJob($excelData));
    ...
    //  dd();
        ...
        if($dropdown_template_id==1){
            ...
            $link = $this->dispatch(new PdfGenerateSuryodayaCertificateJob($pdfData));

...
function addUpdateField(security_type){
	...
	var combo_qr_text = '';
	var is_meta_data = 0;
	var field_metadata_label= 'Label';
	var field_metadata_value= 'This is {{Field Name}}';
	...
	$('[name="is_meta_data[]"]')[i].setAttribute('value',is_meta_data),
	$('[name="field_metadata_label[]"]')[i].setAttribute('value',field_metadata_label),
	$('[name="field_metadata_value[]"]')[i].setAttribute('value',field_metadata_value),
...
function GetField() {
      ...
      elm += '<input type="hidden" name="is_meta_data[]">';
      elm += '<input type="hidden" name="field_metadata_label[]">';
      elm += '<input type="hidden" name="field_metadata_value[]">';
      return elm;
   }
window.postFrameMessage = function ($cmd, $id, $x='', $y='', $width='', $height='',$lock_index='', $security_type='', $fontId='', $fontSize='', $fontStyle='',$fontCase='', $text='', $color='',$excolor='', $align='',$image='',$template_name='',$angle='',$line_gap='',$length='',$uv_percentage='',$is_repeat='',$infinite_height='',$include_image,$grey_scale='',$water_mark='',$uvImage='',$transparentImage='',$text_opicity='',$visible='',$visible_varification='',$combo_qr_text='',$refresh='true')
{

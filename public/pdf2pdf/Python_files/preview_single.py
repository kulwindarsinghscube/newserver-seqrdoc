...
if get_blank:
	#print("Blank Data")
	#print(len(get_blank))
	get_blank_string = ','.join(get_blank)
        ...
        if placer_type == 'QR Default': 
            ...
            if box['qr_details']=='':  
                ...
                for inv in qr_list:
                    ...
                    inv_txt = inv_txt + str(extract_infoV1(extractor_details,str_val[1],str(str_val[0]),str(str_val[2]),page))
                ...
                #     print("QWr List:", qr_list)
                #     print("inv_txt type:", type(inv_txt))
                #     print("inv_txt value:", inv_txt)
                #     print("placer_font_size type:", type(placer_font_size))
                #     print("placer_font_size value:", placer_font_size)
            ...
            if box['qr_details']=='':
                ...
                wl_lst = fitz.getTextlength((mi_txt * int(Totalchrs))+remain_chrs, fontsize=placer_font_size)+1
                wl = sum([wl_lst])
                #print(str(wl)+" | "+str(page_rect.width)+" | "+str(textwidth)+" | "+str(chrPerLine))
                #exit()

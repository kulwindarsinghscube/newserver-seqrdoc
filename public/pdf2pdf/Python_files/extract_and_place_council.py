...
bucket = "securedoc"
client = boto3.client('s3', aws_access_key_id='aws_secret_key', aws_secret_access_key='aws_secret_access_key', region_name='ap-south-1')
for source_pdffile in test_pdffiles:
    pdffilename = source_pdffile.rsplit('/', 1)[-1]
    source_pdffile = source_pdffile.replace('\\\\', '\\')
    destination_path="public/council/varify/"
    destination_file="public/council/varify/" + pdffilename

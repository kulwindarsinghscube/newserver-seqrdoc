...
function excelToPdf($target_file,$pgType) {
    ...
    $excelExe = 'C:\\LibreOffice\\program\\soffice.exe';
    $input = $target_file;
    $cmd = 'C:\\inetpub\\vhosts\\seqrdoc.com\\httpdocs\\demo\\public\\pdf2pdf\\excel_to_pdf\\final_file.py '.$excelExe.' '.$input.' '.$pgType;

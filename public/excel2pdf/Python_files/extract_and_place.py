        ...
        if placer_type == 'QR Default': 
            ...
            if qr_show_flag==1:
                ...
                if sys.argv[7] == 'demo'
                    ...
                    baseName = base64.b64encode(dt_string)
                    qr_txt_new = 'https://demo.seqrdoclocal.com/pdf/'+baseName
                    qr.add_data(qr_txt_new)

                else:
                    qr.add_data(qr_txt)
                # https://demo.seqrdoclocal.com/pdf/%7Bserial_no%7D

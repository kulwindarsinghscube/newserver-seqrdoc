...
compressionInstancesArr = sys.argv[19].split('#')
test_pdffiles=[]
for i in doc:
    page = i
   ...
   # print(dirName)
    for box in boxes:
        ...
        if sys.argv[18] == '1':
            ...
            if (sys.argv[7] in compressionInstancesArr):
                arg2= rootDir+"/backend/pdf_file/sandbox/" + dt_string+".pdf"
            ...
            print(rootDir+"backend/pdf_file/" + dt_string+".pdf");
            ...
            if (sys.argv[7] in compressionInstancesArr):
                arg2= rootDir+"backend/pdf_file/" + dt_string+".pdf"
                arg1= '-sOutputFile='+pdf_file_path
                #subprocess.Popen(['C:/Program Files/gs/gs9.56.1/bin/gswin64c.exe', '-sDEVICE=pdfwrite', '-dCompatibilityLevel=1.4', '-dPDFSETTINGS=/ebook', '-dNOPAUSE', '-dBATCH',  '-dQUIET', str(arg1), arg2], stdout=subprocess.PIPE)
            #else:  
...
if (sys.argv[7] in awsS3InstancesArr):
          #  print(test_pdffiles)
            ...
            for source_pdffile in test_pdffiles:
                ...
                print(source_pdffile)
                destination_path="public/"+sys.argv[7]+"/backend/pdf_file/"

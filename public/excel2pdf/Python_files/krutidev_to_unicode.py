'''
#sys.argv[1] = --e or --d
#sys.argv[2] = input_string

Below are the cmd to run this script 

python krutidev_to_unicode.py -e "आपका हिंदी टेक्स्ट"
python krutidev_to_unicode.py -d "vkidk fganh VsDLV"
'''
import sys
import base64
...
inp_str = sys.argv[2]
#inp_str = 'बैचलर ऑफ़ आर्ट्स'
decodetext = Unicode_to_KrutiDev(inp_str)
encoded_data = base64.b64encode(decodetext.encode('utf-8')).decode('utf-8')
print(encoded_data)
# print(decodetext)

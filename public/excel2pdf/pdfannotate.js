                ...
                for(p = 0; p < total_pages; p++) {                 
                    ...
                    for(i = 0; i < total_objects; i++) {
                        ...
                        if(nature == 'extractor'){ 
                            ...
                            pdf.drawRectangle(id, name, nature, left_margin, top_margin, width, height, p, page_no, bcPlace, labelPlace, labelValue);                          
                        }
...
PDFAnnotate.prototype.drawRectangle = function (id,name,nature,left_margin,top_margin,width_val,height_val,canvas_no,page_no, bcPlace='', labelPlace='', labelValue='') {
	var inst = this;

...
Request for educational details verification of <b>{{$user_data['student_name']}}</b> is received to us. Institute will convey you the verification details within 24 hours.<br>
...
Document Details:<br/>
<table style='margin: auto;border: 1px solid #000;border-collapse: collapse;'>
	<?php if($user_data['provisional_degree_files']!="Not Uploaded"){ ?>
	<tr>
	<td style='border: 1px solid black;padding: 15px;'>Degree</td>
	...
	<?php } ?>
	<?php if($user_data['marksheet_files']!="Not Uploaded"){ ?>
	<tr>
...
<br/><br/>In case response not received within 24 hours, you can contact us on info@monad.edu.in, admissions@monad.edu.in or call us on +91-7055611819, 0122-2327000. <br/><br/>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form method="post" action="<?=route('copy-template.copy-template')?>" enctype="multipart/form-data" id="updfilefrm"> 
...
function deletepath(fm_id)
{
  ...
  var url = "<?=route('copy-template.viewtemplateslist',['instance'=>$instance])?>";     
  ...
  var oTable = $('#master_table').DataTable({
      ...
      "aoColumns": [
          ...
          { "mData": "status",sWidth: "10%",bSortable: true,bVisible:true,
...
$('#btn_copy_template').click(function(){
 var url="{{ URL::route('copy-template.copy-template') }}";
      var token="{{ csrf_token() }}";

	...
	<div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-7"> <br />
                <form method="post" id="processExcelForm" class="form-horizontal" enctype="multipart/form-data" action="<?=route('peoplesuni-certificate.uploadfile')?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="template_id" name="template_id">
                                ...
                                <option value="10" data-tempid="10">Consolidated Marksheet - VI & VIII Semester</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">

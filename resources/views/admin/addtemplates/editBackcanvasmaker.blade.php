		...
		<?php
			...
			if(isset($FONTS)){
				foreach ($FONTS as $key => $font) {
					...
					echo "src: url('http://{$domain}/{$domain_name}/backend/canvas/fonts/{$font['font_filename_N']}') format('truetype')";
					echo "}";
					if($font['font_filename_B'] != '') {
						...
						echo "@font-face {";
						echo "font-family: '{$fname}';";
						echo "src: url('http://{$domain}/{$domain_name}/backend/canvas/fonts/{$font['font_filename_B']}') format('truetype')";
...
@section('script')
	...
	<?php if($subdomain[0]=="demo" || $subdomain[0]=="print24x7"){ ?>
		<script type="text/javascript" src="{{asset('backend/canvas/back_blockchainjs/postFrame.js')}}"></script>
	<?php }else{ ?>
		<script type="text/javascript" src="{{asset('backend/canvas/back_blockchainjs/postFrame.js')}}"></script>
	<?php } ?>	
	<script type="text/javascript" src="{{asset('backend/canvas/back_blockchainjs/jquery.ruler.js')}}"></script>
	<script type="text/javascript">
		...
		yellowPatchImage.src = config_default+'/yellow_patch.png';

									...
									<tbody>
			                            ...
			                            ?>
											<div class="extrafields">
												...
												<input type="hidden" name="field_sample_text[]" class="form-control" value="<?php if(isset($FIELDS[$fc]["sample_text"])) echo $FIELDS[$fc]["sample_text"]; ?>">
												<!-- Add fields -->
	...
	<script type="text/javascript">
		...
		function fontStyleChange(font_id){
			...
			$.post(url, data, function (resp) {
				...
				var font_path = '<?= public_path()?>/backend/fonts/'+filename+'.ttf'
				console.log($('head'))

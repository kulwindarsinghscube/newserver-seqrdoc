                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="template_id" name="template_id">
                                ...
                                <option value="7" data-tempid="7"> Bachelor of Technology in Climate Change (BTCC) </option>                    
                            </select>
                        </div>
                    </div>
					<div class="form-group">
...
$('#btn_updfile').click(function (event) {
	...
	// else if(points == 0){
  else if ((template_id != 5 && template_id != 6 && template_id != 7) && points == 0){
 
		toastr["error"]("Please select grade points234.");
		return false;
	}
	else{
		validateUpload();

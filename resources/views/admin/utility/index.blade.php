        ...
        <div class="row">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="template_id" name="template_id">
                                <option value="0" data-tempid="0">Select Template</option>
                                 <option value="1" data-tempid="1">Rotak - Ghost | Yellow Patch</option>
                                <!--   <option value="2" data-tempid="2">NIIT Sikkim Grade Card - Ghost | QR</option> -->
 					   <option value="3" data-tempid="3">NIIT Sikkim Grade Card - Ghost | QR | Yellow Patch</option>
 					   <option value="4" data-tempid="4">NIIT Sikkim Degree Certificate - Ghost | Yellow Patch</option>
                               <!--  <option value="1" data-tempid="1">Letter of Verification of Results</option> -->
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-3" for="excel">Upload PDF:</label>
                        <div class="col-sm-9">
                            <input type="file" class="form-control" id="field_file_pdf" name="field_file_pdf">
                            <span id="pdf_data_error" class="help-inline text-danger"><?=$errors->first('pdf_data')?></span>
                        </div>
                    </div>
            ...
            <div class="col-lg-5" style="padding: 83px 1em;"> 
                <?php
                    ...
                    $excel_url_1=$path.$subdomain[0]."/backend/sample_excel/uneb_certificate.xlsx";
                   /* $excel_url_2=$path.$subdomain[0]."/backend/sample_excel/uneb_certificate.xlsx";
...
function validateUpload() {
	...
	var files_pdf = $('[name="field_file_pdf"]')[0].files[0];
	var token = "<?= csrf_token()?>";

	fd.append('field_file',files);
	fd.append('field_file_pdf',files_pdf);
	fd.append('_token',token);
  fd.append('template_id',template_id);
	$.ajax({
		url:'<?= route('utility.validateexcel')?>',
	  type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,

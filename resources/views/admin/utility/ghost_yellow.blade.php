...
<div class="container">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><i class="fa fa fa-file-excel-o"></i> Ghost Image & Yellow Patch Utility
        ...
        <div class="modal fade" id="uploadFile" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<h4 class="modal-title" id="myModalLabel3" style="display: none;">Images are processing... Please wait ..... <img src="/backend/images/loading.gif"> <button type="button" class="btn btn-primary" id="btn_refresh" style="margin-left: 45px;">Check Status</button></h4>
							</div>
						       ...
						       <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuemin="0" aria-valuemax="100" style="width: 1%;">1%
								...
								<div class="form-group clearfix" id="loaderDiv" style="display: none;">
									...
									<table class="table" style="max-width: 500px;border: 1px solid rgb(219 219 219) !important;">
										<tr><td style="width: 60%;">Generated Images Count</td><td id="generatedCertificates" style="width: 40%;padding-left: 10px;"></td></tr>
										<tr><td style="width: 60%;">Pending Images Count</td><td id="pendingCertificates" style="width: 40%;padding-left: 10px;"></td></tr>
										<tr><td style="width: 60%;">Total Images To Generate Count</td><td id="recordsToGenerate" style="width: 40%;padding-left: 10px;"></td></tr>
        ...
        <div class="row">
            <div class="col-lg-7"> <br />
                <form method="post" id="processExcelForm" class="form-horizontal" enctype="multipart/form-data" action="<?=route('utility.uploadfile')?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="template_id" name="template_id">
                                ...
                                <option value="1" data-tempid="1">Ghost Image</option>
                                <option value="2" data-tempid="2">Yellow Patch</option>
                            </select>
                        </div>
                    </div>
                     <div class="form-group">
            ...
            <div class="col-lg-5" style="padding: 83px 1em;"> 
                <?php
                    ...
                    $excel_url_1=$path."backend/sample_excel/ghost_sample.xlsx";
                   $excel_url_2=$path."backend/sample_excel/yellow_sample.xlsx";
                    /* $excel_url_3=$path.$subdomain[0]."/backend/sample_excel/uneb_certificate.xlsx";*/
...
function validateUpload() {
  ...
  fd.append('template_id',template_id);
	$.ajax({
		url:'<?= route('utility.validateexcelghostyellow')?>',
	  type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,
...
function uploadfile(){
	...
	$.ajax({
		url:'<?= route('utility.uploadfileghostyellow')?>',
	    type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,
		...
		success:function(resp){
			...
			{	
				...
				toastr["success"](resp.message);	
					...
					uploadfileAgain(resp.id,resp.completedCount);
				}
			}
		},
		error:function(resp){
...
function uploadfileAgain(recordId,offset){
...
$('#processExcelForm').validate({
	...
	rules:{
		...
		pdf_data:{'required':true, extension:'pdf|PDF'}
	},
	messages:{
		excel_data:{
    ...
    var loaderid =setTimeout(function () {
        $.ajax({
            ...
            error: function (error) {
				...
				//alert('Please click on check status button.');
				$('#btn_refresh').click();
			}

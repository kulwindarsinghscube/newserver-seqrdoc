					...
					<div class="container-fluid">
						...
						<div class="">
							<ul class="nav nav-pills" id="pills-filter">
							  ...
							  @if(App\Helpers\SitePermissionCheck::isPermitted('institutemaster.store'))
							  @if(App\Helpers\RolePermissionCheck::isPermitted('institutemaster.store'))
	...
	var oTable = $('#example').DataTable({
		...
		{mData: 'id',
            ...
            mRender: function(v, t, o) {
            	...
            	buttons += '@if(App\Helpers\SitePermissionCheck::isPermitted('institutemaster.update')) @if(App\Helpers\RolePermissionCheck::isPermitted('institutemaster.update'))<span data-toggle="tooltip" title="Edit" id="editData" class="" data-id="'+o['id']+'" data-institute_username="'+o['institute_username']+'" data-username="'+o['username']+'" data-status="'+o['status']+'" data-password="'+o['password']+'" data-role="'+o['role_id']+'"><i class="fa fa-edit fa-lg green"></i></span> &nbsp;&nbsp;@endif @endif';
            	buttons += '@if(App\Helpers\SitePermissionCheck::isPermitted('institutemaster.delete')) @if(App\Helpers\RolePermissionCheck::isPermitted('institutemaster.delete'))<span data-toggle="tooltip" title="Delete" id="delData" class="" data-id="'+o['id']+'"><i class="fa fa-trash fa-lg red"></i></span> &nbsp;&nbsp;@endif @endif';
				return buttons;
            },
...
@if(App\Helpers\RolePermissionCheck::isPermitted('institutemaster.delete'))
	//delete User data
...
@if(App\Helpers\RolePermissionCheck::isPermitted('institutemaster.update'))
	//edit data

...
$excel_url_2 = $path . $subdomain[0] . "/backend/sample_excel/cscacs_sample_certificate.xlsx";
                ?>
          <span style="display:none;" id="excel_url_1"><b>Please Click <a href="{{$excel_url_1}}" download>HERE</a> To
              Download Sample Excel</b></span>
          <span style="display:none;" id="excel_url_2"><b>Please Click <a href="{{$excel_url_2}}" download>HERE</a> To
              Download Sample Excel</b></span>

                                ...
                                <div class="modal-body">
                                        ...
                                        <div class="form-group clearfix">
                                            ...
                                            <div id="upload_btn">
                                                ...
                                                <button type="submit" class="btn btn-theme col-lg-2 col-md-2 col-sm-12 col-xs-12 col-md-offset-10" id="btn_updfile"><i class="fa fa-upload"></i> Upload</button>
                                            </div>
                                        </div>
                                    ...
                                    <form method="post"  enctype="multipart/form-data" id="updfilefrmExcel"> 
                                        ...
                                        <div class="form-group clearfix">
                                            ...
                                            <div id="upload_btn">
                                                ...
                                                <button type="button" class="btn btn-theme col-lg-2 col-md-2 col-sm-12 col-xs-12 col-md-offset-10" id="btn_updfile_excel"><i class="fa fa-upload"></i> Upload</button>
                                            </div>
                                        </div>
                                    </form>

...
<div class="container">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><i class="fa fa fa-file-excel-o"></i> Sangam
        ...
        <div class="row">
            <div class="col-lg-7"> <br />
                <form method="post" id="processExcelForm" class="form-horizontal" enctype="multipart/form-data" action="<?=route('sangamui-certificate.uploadfile')?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="template_id" name="template_id">
                                ...
                                <option value="1" data-tempid="1">Certificate of Civil Engineering/MBA</option>
                                <option value="2" data-tempid="2">Certificate of Pharmacy</option>
                                <option value="3" data-tempid="3">Certificate of Ph.d</option>
                                <option value="4" data-tempid="4">Certificate of DHA</option>
                                <option value="5" data-tempid="5">Certificate of Ag</option>
                                <option value="6" data-tempid="6">Certificate of Ph.d honorary</option>
                                <option value="7" data-tempid="7">Certificate of Diploma</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="col-lg-5" style="padding: 83px 1em;"> 
                <?php
                    ...
                    $excel_url_1=$path.$subdomain[0]."/backend/sample_excel/sangamui_certificate.xlsx";
                    $excel_url_2=$path.$subdomain[0]."/backend/sample_excel/sangamui_certificate_pharmacy.xlsx";
                    $excel_url_3=$path.$subdomain[0]."/backend/sample_excel/sangamui_certificate_phd.xlsx";
                    $excel_url_4=$path.$subdomain[0]."/backend/sample_excel/sangamui_certificate_dha.xlsx";
                    $excel_url_5=$path.$subdomain[0]."/backend/sample_excel/sangamui_certificate_ag.xlsx";
                    $excel_url_6=$path.$subdomain[0]."/backend/sample_excel/sangamui_certificate_phd.xlsx";
                    $excel_url_7=$path.$subdomain[0]."/backend/sample_excel/sangamui_certificate_diploma.xlsx";
                ?>
...
function validateUpload() {
	...
	$.ajax({
		url:'<?= route('sangamui-certificate.validateexcel')?>',
	    type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,
...
function uploadfile(){
	...
	$.ajax({
		url:'<?= route('sangamui-certificate.uploadfile')?>',
	    type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,

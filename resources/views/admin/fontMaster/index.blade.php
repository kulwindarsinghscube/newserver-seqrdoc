     ...
     <div id="">
      ...
      <div class="hello">
       <ul class="nav nav-pills" id="pills-filter">
         ...
         @if(App\Helpers\SitePermissionCheck::isPermitted('fontmaster.store'))
         @if(App\Helpers\RolePermissionCheck::isPermitted('fontmaster.store'))
...
{!! Form::open(array('id'=>'fontMatser_data','files'=>true)) !!} 
  @include('admin.fontMaster.model')
{!! Form::close() !!}
          ...
          if(!in_array($subdomain[0], $fontMasterExceptions)){ ?>
            {
              ...
              mRender:function(v, t, o){
                var act_html;
                       ...
                       act_html =  
                        '@if(App\Helpers\SitePermissionCheck::isPermitted('fontmaster.edit')) @if(App\Helpers\RolePermissionCheck::isPermitted('fontmaster.edit'))<a onclick="edit('+o['id']+')"><i class="fa fa-edit fa-lg green"></i></a>@endif @endif';
                       
                        act_html +='@if(App\Helpers\SitePermissionCheck::isPermitted('fontmaster.destroy')) @if(App\Helpers\RolePermissionCheck::isPermitted('fontmaster.destroy'))&nbsp;&nbsp;<a onclick="deletepath('+o['id']+')"><i class="fa fa-trash fa-lg red"></i></a>@endif @endif';

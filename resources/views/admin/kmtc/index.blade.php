	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><i class="fa fa fa-file-excel-o"></i> KMTC Documents
					<ol class="breadcrumb pull-right" style="background:transparent;font-size:14px;">{{ Breadcrumbs::render('generatekmtccertificates') }}</ol>
				</h1>
        ...
        <div class="row">
            ...
            <div class="col-lg-5" style="padding: 83px 1em;"> 
                ...
                <span style="display:block;" id="excel_url_3"><b>Please Click <a href="{{$excel_url_3}}" download>HERE</a> To Download Sample Excel</b></span>

	...
	var oTable = $('#example').DataTable({
		...
		{mData: 'id',
            ...
            mRender: function(v, t, o) {
            	...
            	buttons += '@if(App\Helpers\SitePermissionCheck::isPermitted('labmaster.update')) @if(App\Helpers\RolePermissionCheck::isPermitted('labmaster.update'))<span data-toggle="tooltip" title="Edit" id="editData" class="" data-id="'+o['id']+'" data-lab_title="'+o['lab_title']+'" data-status="'+o['status']+'"><i class="fa fa-edit fa-lg green"></i></span> &nbsp;&nbsp;@endif @endif';
            	buttons += '@if(App\Helpers\SitePermissionCheck::isPermitted('labmaster.delete')) @if(App\Helpers\RolePermissionCheck::isPermitted('labmaster.delete'))<span data-toggle="tooltip" title="Delete" id="delData" class="" data-id="'+o['id']+'"><i class="fa fa-trash fa-lg red"></i></span> &nbsp;&nbsp;@endif @endif';
				return buttons;
            },
...
@if(App\Helpers\RolePermissionCheck::isPermitted('labmaster.delete'))
	//delete User data
...
@if(App\Helpers\RolePermissionCheck::isPermitted('labmaster.update'))
	//edit data

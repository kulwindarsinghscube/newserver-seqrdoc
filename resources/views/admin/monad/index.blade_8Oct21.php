	...
	<div class="container-fluid">
        ...
        <div class="panel panel-default"><br />    
			<div class="form-group">
						<label class="control-label col-sm-2" id="generate_title" for="previewPdf">PDF Preview:</label>
						<label class="switch">  
		  	...
		  	<div class="form-group">
		    	<label class="control-label col-sm-2" for="temp">Template:</label>
		    	<div class="col-sm-5">
                ...
                <?php
                    ...
                    $excel_url_5=$path.$subdomain[0]."/backend/sample_excel/MONAD Sample Excel.xlsx";
                ?>

...
<div class="container">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><i class="fa fa fa-file-excel-o"></i>  Ghrusaikheda  College
					<ol class="breadcrumb pull-right" style="background:transparent;font-size:14px;">
						{{-- {{ Breadcrumbs::render('generatechanakyaucertificates') }} --}}
					</ol>
				</h1>
        ...
        <div class="row">
            ...
            <form method="post" id="processExcelForm" class="form-horizontal" enctype="multipart/form-data" action="<?=route('ghrusaikheda-certificate.uploadfile')?>">
                  ...
                  <div class="col-sm-9">
                      <select class="form-control" id="template_id" name="template_id">
                          <option value="0" data-tempid="0">Select Template</option>
                            {{-- <option value="2" data-tempid="2"> Engineering Grade Card 10 Subject</option> --}}
                          <option value="1" data-tempid="1"> Ghrusaikheda Grade Card </option>
                          {{-- <option value="2" data-tempid="2"> Engineering Grade Card 10 Subject</option>0 --}}
            ...
            <div class="col-lg-5" style="padding: 83px 1em;"> 
                <?php
                    ...
                    $excel_url_1=$path."$subdomain[0]"."/backend/sample_excel/GRADE_CARD_PRINTING_EXCEL.xlsx";
                    // $excel_url_2=$path."$subdomain[0]"."/backend/sample_excel/jntu_grade_card_10_subject.xlsx";
...
function validateUpload() {
  ...
  var previewPdf = $('#previewPdfValue').val();
	...
	$.ajax({
		url:'<?= route('ghrusaikheda-certificate.validateexcel')?>',
	    type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,
...
function uploadfile(startRow = 2, endRow = 2, highestRow = null) {
    ...
    $.ajax({
        url: '<?= route('ghrusaikheda-certificate.uploadfile') ?>',
        type: "POST",
        dataType: "JSON",
        data: fd,
        processData: false,

	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				...
				<ol class="breadcrumb pull-right" style="background:transparent;font-size:14px;">{{ Breadcrumbs::render('usersession') }}</ol>
	   ...
	   "bProcessing": false,
        ...
        "sAjaxSource":"<?= route('session-manager.index',['status'=>1]) ?>",
          ...
          {mData: "logout_time",bSortable:true,bVisible:false},
             ...
             act_html +='@if(App\Helpers\SitePermissionCheck::isPermitted('session-manager.destroy')) @if(App\Helpers\RolePermissionCheck::isPermitted('session-manager.destroy'))<a onclick="deletepath('+o['id']+')"><i class="fa fa-trash fa-lg red"></i></a>@endif @endif';

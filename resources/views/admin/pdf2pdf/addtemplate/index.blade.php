            ...
            <div class="mb-3 d-flex align-items-center">
                ...
                <div class="form-check form-check-inline">
                  <input 
                    ...
                    id="pdf-option" 
                    value="0" @if(@$template_data['verification_type'] == '0' || !isset($template_data['verification_type'])) checked @endif>
                ...
                <div class="form-check form-check-inline">
                  <input 
                    ...
                    name="verification_type" 
                    id="text-option" 
                    value="1" @if(@$template_data['verification_type'] == '1'  ) checked @endif>
...
<script src="{{asset('pdf2pdf/script.js?1234')}}"></script>

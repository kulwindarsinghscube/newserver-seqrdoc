								...
								<div class="modal-content">
									...
									<div class="modal-body">
										<form method="post" action='' id="UserData">
                                            ...
                                            <div style="display:none;"><div class="form-group bc_toggle">
...
<script type="text/javascript">
	...
	var oTable = $('#example').DataTable({
		...
		{mData: "template_title", sWidth: "25%"},
...
var token = "<?= csrf_token()?>"; 
    ...
    oTable.on('click', '#editTitle', function (e) { 
		...
		if(isblockchain==1){$('.bc_input').hide();$('.bc_toggle').hide();}
	});
...
@if(App\Helpers\RolePermissionCheck::isPermitted('pdf2pdf.templatemakeredit'))
	...
	$('#UserEdit').click(function(e){
		...
		var bc_document_description = $('#bc_document_description').val().trim(); 
		var bc_document_type = $('#bc_document_type').val().trim(); 

            ...
            <div class="modal-content">                                  
              ...
              <div class="modal-body mx-3">
                <div class="form-group mb-2">
                    ...
                    @foreach ($results as $got)
                        <option value="{{$got->id}}" data-file="{{$got->image_path}}">{{$got->background_name}}</option>
                    @endforeach                                             
...
<script type="text/javascript">
    ...
    var oTable = $('#example').DataTable({
      ...
      "aoColumns":[
            ...
            mRender: function(v, t, o) {
            	...
            	buttons = '@if(App\Helpers\SitePermissionCheck::isPermitted('pdf2pdf.templatemakeredit')) @if(App\Helpers\RolePermissionCheck::isPermitted('pdf2pdf.templatemakeredit')) <span style="cursor:pointer"><i title="Edit Template" id="editData" data-id="'+o['id']+'" data-temp="'+o['template_name']+'" data-page="'+o['pdf_page']+'" data-file="'+o['file_name']+'" data-toggle="tooltip" class="editrow fa fa-edit fa-lg green"></i> </span> @endif @endif';
              ...
              <?php } ?>
              buttons += '@if(App\Helpers\SitePermissionCheck::isPermitted('pdf2pdf.templatemakeredit')) @if(App\Helpers\RolePermissionCheck::isPermitted('pdf2pdf.templatemakeredit')) <span style="cursor:pointer"><i title="Edit Template Title" id="editTitle" data-id="'+o['id']+'" data-temp="'+o['template_name']+'" data-title="'+o['template_title']+'" data-isblockchain="'+o['is_block_chain']+'" data-toggle="tooltip" class="editrow fa fa-edit fa-lg"></i> </span> @endif @endif';
  			      <?php //if($subdomain[0]=="demo"){ ?>
              buttons += '@if(App\Helpers\SitePermissionCheck::isPermitted('pdf2pdf.templatemakeredit')) @if(App\Helpers\RolePermissionCheck::isPermitted('pdf2pdf.templatemakeredit')) <span style="cursor:pointer"><i title="Assign Background" id="assignBG" data-id="'+o['id']+'" data-title="'+o['template_title']+'" data-pbg = "'+o['print_bg_file']+'" data-pbgs = "'+o['print_bg_status']+'" data-vbg = "'+o['verification_bg_file']+'" data-vbgs = "'+o['verification_bg_status']+'" data-toggle="tooltip" class="editrow fa fa-image fa-lg green"></i> </span> @endif @endif';
              <?php //} ?>
              buttons += '@if(App\Helpers\SitePermissionCheck::isPermitted('pdf2pdf.processpdf')) @if(App\Helpers\RolePermissionCheck::isPermitted('pdf2pdf.processpdf')) <span style="cursor:pointer" id="processData" data-id="'+o['id']+'" data-temp="'+o['template_name']+'" data-pdf_page="'+o['pdf_page']+'" data-file="'+o['file_name']+'" data-template_name="'+o['template_name']+'" data-flag="invisible"><i title="Generate Invisible PDF"  class="pdfGenerate fa fa-file-pdf-o fa-lg yellow"></i></span> @endif @endif';
              if (o['verification_type'] == 1) {
                  buttons += '@if(App\Helpers\SitePermissionCheck::isPermitted('pdf2pdf.processpdf')) @if(App\Helpers\RolePermissionCheck::isPermitted('pdf2pdf.processpdf')) <span style="cursor:pointer" id="UpdateTextVerificationData" data-id="' + o['id'] + '" data-temp="' + o['template_name'] + '" data-pdf_page="' + o['pdf_page'] + '" data-file="' + o['file_name'] + '" data-template_name="' + o['template_name'] + '" data-flag="invisible"><i title="Text Verification Settings"  class="pdfGenerate fa fa-gear fa-lg yellow"></i></span> @endif @endif';
              }
              return buttons;
  ...
  @if(App\Helpers\RolePermissionCheck::isPermitted('pdf2pdf.templatemakeredit'))
  	//edit data

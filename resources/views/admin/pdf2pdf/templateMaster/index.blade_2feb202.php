	...
	var oTable = $('#example').DataTable({
		...
		{mData: 'id',
            ...
            mRender: function(v, t, o) {
                ...
                <?php } ?>
                buttons += '@if(App\Helpers\SitePermissionCheck::isPermitted('pdf2pdf.templatemakeredit')) @if(App\Helpers\RolePermissionCheck::isPermitted('pdf2pdf.templatemakeredit')) <span style="cursor:pointer"><i title="Edit Template Title" id="editTitle" data-id="'+o['id']+'" data-temp="'+o['template_name']+'" data-title="'+o['template_title']+'" data-toggle="tooltip" class="editrow fa fa-edit fa-lg"></i> </span> @endif @endif';

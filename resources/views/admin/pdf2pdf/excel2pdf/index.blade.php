...
<div class="container">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><i class="fa fa fa-file-excel-o"></i> Excel To PDF
					<ol class="breadcrumb pull-right" style="background:transparent;font-size:14px;">{{ Breadcrumbs::render('exceltopdf') }}</ol>
				</h1>
...
function validateUpload() {
	...
	$.ajax({
		url:'https://seqrdoc.com/pdf2pdf/excel2pdf.php',
	    type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,
...
$('#processExcelForm').validate({
	...
	rules:{
		excel_data:{'required':true, extension:'xls|xlsx|xlsm'}
	},
	messages:{
		excel_data:{

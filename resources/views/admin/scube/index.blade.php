...
<div class="container">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><i class="fa fa fa-file-excel-o"></i>  SCUBE  College
        ...
        <div class="row">
            ...
            <form method="post" id="processExcelForm" class="form-horizontal" enctype="multipart/form-data" action="<?=route('scube-certificate.uploadfile')?>">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-9">
                      <select class="form-control" id="template_id" name="template_id">
                          ...
                          <option value="1" data-tempid="1"> Scube Grade Card </option>
            ...
            <div class="col-lg-5" style="padding: 83px 1em;"> 
                <?php
                    ...
                    $excel_url_1=$path."$subdomain[0]"."/backend/sample_excel/SCUBE_grade_card.xlsx";
...
function validateUpload() {
  ...
  var previewPdf = $('#previewPdfValue').val();
	...
	$.ajax({
		url:'<?= route('scube-certificate.validateexcel')?>',
	    type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,
...
function uploadfile(startRow = 2, endRow = 2, highestRow = null) {
    ...
    $.ajax({
        url: '<?= route('scube-certificate.uploadfile') ?>',
        type: "POST",
        dataType: "JSON",
        data: fd,
        processData: false,

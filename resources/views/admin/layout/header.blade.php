...
if (
	...
	(App\Helpers\SitePermissionCheck::isPermitted('ghrusaikheda-certificate.uploadpage') && App\Helpers\RolePermissionCheck::isPermitted('ghrusaikheda-certificate.uploadpage'))
					...
					@endif -->
							...
							@if(App\Helpers\SitePermissionCheck::isPermitted('nnp-certificate.uploadpage'))
								@if(App\Helpers\RolePermissionCheck::isPermitted('nnp-certificate.uploadpage'))
									<li><a href="{{ URL::route('nnp-certificate.uploadpage') }}"><i
							...
							@if(App\Helpers\SitePermissionCheck::isPermitted('sbcity-certificate.uploadpage'))
								@if(App\Helpers\RolePermissionCheck::isPermitted('sbcity-certificate.uploadpage'))
									<li><a href="{{ URL::route('sbcity-certificate.uploadpage') }}"><i

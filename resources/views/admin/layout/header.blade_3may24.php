  ...
  <div class="container" style="width: 99%;">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
       ...
       if($subdomain[0]=="demo" ||$subdomain[0]=="uasb" || $subdomain[0]=="galgotias" || $subdomain[0]=="kessc" || $subdomain[0]=="iccs" || $subdomain[0]=="monad" || $subdomain[0]=="ghribmjal" || $subdomain[0]=="secura" ||$subdomain[0]=="po"|| $subdomain[0]=="auro" || $subdomain[0]=="woxsen"|| $subdomain[0]=="test" || $subdomain[0]=="rrmu" || $subdomain[0]=="spit" || $subdomain[0]=="vbit"|| $subdomain[0]=="cedp"|| $subdomain[0]=="iscnagpur" || $subdomain[0]=="sgrsa" || $subdomain[0]=="anu" || $subdomain[0]=="imt" || $subdomain[0]=="sangamuni" || $subdomain[0]=="bnmit" || $subdomain[0]=="uneb" || $subdomain[0]=="estamp" || $subdomain[0]=="minoshacloud" || $subdomain[0]=="secdoc" || $subdomain[0]=="cu" || $subdomain[0]=="srwcnagpur"|| $subdomain[0]=="lnctbhopal" || $subdomain[0]=="inct" ||
          ...
          <li><a href="{{ URL::route('utility.templates') }}"><i class="fa fa-file-excel-o fa-fw"></i> Utility - Ghost | Yellow Patch</a></li>
					@endif
					...
					<li><a href="{{ URL::route('exceltopdf.uploadpage') }}"><i class="fa fa-file-pdf-o fa-fw"></i>PDF Generate</a></li>
					@endif
					@endif
					...
					@if(App\Helpers\SitePermissionCheck::isPermitted('cavendish-certificate.uploadpage'))
					    ...
					    <li><a href="{{ URL::route('cavendish-certificate.uploadpage') }}"><i class="fa fa-file-excel-o fa-fw"></i> CAVENDISH Certificate</a></li>
					  @endif
					@endif
					...
					@if(App\Helpers\SitePermissionCheck::isPermitted('srwcnagpur-certificate.uploadpage'))
					    ...
					    <li><a href="{{ URL::route('srwcnagpur-certificate.uploadpage') }}"><i class="fa fa-file-excel-o fa-fw"></i> SRWCNAGPUR Certificate</a></li>
					  @endif
					@endif
                    ...
                    @if(App\Helpers\RolePermissionCheck::isPermitted('kessc-certificate.uploadpage'))
					 ...
					 <li><a href="{{ URL::route('kessc-addserial.uploadpage') }}"><i class="fa fa-file-pdf-o fa-fw"></i> KESSC Add Serial No.</a></li>
					@endif
					@endif
					...
					<li><a href="{{ URL::route('molwa-certificate.ImportPrint') }}"><i class="fa fa-file-excel-o fa-fw"></i> Import</a></li>
                    @endif
					@endif
					...
					<li><a href="{{ URL::route('molwa-certificate.index') }}"><i class="fa fa-file-excel-o fa-fw"></i> Manage Records</a></li>
					<li><a href="{{ URL::route('molwa-certificate.molwaRemarks') }}"><i class="fa fa-file-excel-o fa-fw"></i> Molwa Remark Records</a></li>
                    @endif
					@endif
					...
					<li><a href="{{ URL::route('molwa-certificate.ReImportPrint') }}"><i class="fa fa-file-excel-o fa-fw"></i> Re-Import</a></li>
					<li><a href="{{ URL::route('molwa-certificate.molwaReport') }}"><i class="fa fa-file-excel-o fa-fw"></i> Report</a></li>
                    @endif
					@endif
					<!--End Molwa-->
					...
					<li><a href="{{ URL::route('spit-certificate.uploadpage') }}"><i class="fa fa-file-excel-o fa-fw"></i> Grade Cards</a></li>
                     @endif
					@endif
					...
					<li><a href="{{ URL::route('vbit-certificate.uploadpage') }}"><i class="fa fa-file-excel-o fa-fw"></i> Grade Cards</a></li>
                     @endif
					@endif
					...
					<li><a href="{{ URL::route('cedp-certificate.uploadpage') }}"><i class="fa fa-file-excel-o fa-fw"></i> Grade Cards</a></li>
                     @endif
					@endif
					...
					<li><a href="{{ URL::route('iscn-certificate.uploadpage') }}"><i class="fa fa-file-excel-o fa-fw"></i> ISCN Grade Cards</a></li>
                     @endif
					@endif
					...
					<li><a href="{{ URL::route('rawatpura-certificate.uploadpage') }}"><i class="fa fa-file-excel-o fa-fw"></i> SRSU Raipur Certificate</a></li>
					 @endif
					@endif
					...
					<li><a href="{{ URL::route('bestiu-certificate.uploadpage') }}"><i class="fa fa-file-excel-o fa-fw"></i> Bestiu Certificate</a></li>
                     @endif
					@endif
					...
					<li><a href="{{ URL::route('sdm-certificate.uploadpage') }}"><i class="fa fa-file-excel-o fa-fw"></i> SDM Certificate</a></li>
					<li><a href="{{ URL::route('sdm-resit.uploadpage') }}"><i class="fa fa-file-excel-o fa-fw"></i> SDM RESIT</a></li>
                     @endif
					@endif
					...
					<li><a href="{{ URL::route('surana-certificate.uploadpage') }}"><i class="fa fa-file-excel-o fa-fw"></i> Surana Certificate</a></li>
                     @endif
					@endif
					...
					<li><a href="{{ URL::route('anu-certificate.uploadpage') }}"><i class="fa fa-file-excel-o fa-fw"></i> ANU Certificate</a></li>
                     @endif
					@endif
					...
					<li><a href="{{ URL::route('lnct-certificate.uploadpage') }}"><i class="fa fa-file-excel-o fa-fw"></i> LNCT Certificate</a></li>
                     @endif
					@endif
					...
					<li><a href="{{ URL::route('sgrsa-certificate.addform') }}"><i class="fa fa-file-pdf-o fa-fw"></i> New Record</a></li>
					<li><a href="{{ URL::route('sgrsa-previouscertificate.addform') }}"><i class="fa fa-file-pdf-o fa-fw"></i> Old Record</a></li>
					@endif
					@endif
					...
					<li><a href="{{ URL::route('sgrsa-supplier.addform') }}"><i class="fa fa-file-text-o fa-fw"></i> Suppliers</a></li>					
                    @endif
					@endif
					...
					<li><a href="{{ URL::route('sgrsa-agent.addform') }}"><i class="fa fa-file-text-o fa-fw"></i> Sub Agents</a></li>
				    <li><a href="{{ URL::route('sgrsa-governor.addform') }}"><i class="fa fa-file-text-o fa-fw"></i> Type of Governor</a></li>
					<li><a href="{{ URL::route('sgrsa-governor.adduform') }}"><i class="fa fa-file-text-o fa-fw"></i> Unit Serial Numbers</a></li>
					<li><a href="{{ URL::route('sgrsa-certificate.addform') }}"><i class="fa fa-file-pdf-o fa-fw"></i> Recall</a></li>
					@endif
					@endif
					...
					<li><a href="{{ URL::route('agent-allot.RecallList') }}"><i class="fa fa-file-text-o fa-fw"></i> Agent Allotment</a></li>					
                    @endif
					@endif
					...
					<li><a href="{{ URL::route('supplier-allot.addform') }}"><i class="fa fa-file-text-o fa-fw"></i> Allot HC to Agent</a></li>					
                    @endif
					@endif
					...
					<li><a href="{{ URL::route('allot-edit.editform') }}"><i class="fa fa-file-text-o fa-fw"></i> Damaged/Replaced HC</a></li>					
                    @endif
					@endif
					...
					<li><a href="{{ URL::route('supplier-uploadexcel.uploadExcelForm') }}"><i class="fa fa-file-text-o fa-fw"></i> Upload Previous Data</a></li>					
                    @endif
					@endif
					...
					<li><a href="{{ URL::route('sgrsa-supplier.editform') }}"><i class="fa fa-file-text-o fa-fw"></i> Supplier Profile</a></li>					
                    @endif
					@endif
					...
					<li><a href="{{ URL::route('sgrsa-allot.addform') }}"><i class="fa fa-file-text-o fa-fw"></i> Allot HC to Supplier</a></li>					
                    @endif
					@endif
					...
					<li><a href="{{ URL::route('sgrsa-previouscertificate.indexPC') }}"><i class="fa fa-file-text-o fa-fw"></i> Notification</a></li>					
                    @endif
					@endif
					...
					<li><a href="{{ URL::route('sangamui-certificate.uploadpage') }}"><i class="fa fa-file-excel-o fa-fw"></i> Sangam Certificate</a></li>
                     @endif
					@endif
					...
					<li><a href="{{ route('imt.index') }}"><i class="fa fa-file-excel-o fa-fw"></i> IMT Certificate</a></li>
                     @endif
					@endif
					...
					<li><a href="{{ route('ttd.index') }}"><i class="fa fa-file-excel-o fa-fw"></i> TTD Certificate</a></li>
                     @endif
					@endif
					...
					<li><a href="{{ route('bnm-certificate.uploadpage') }}"><i class="fa fa-file-excel-o fa-fw"></i> BNMI Certificate</a></li>
                     @endif
					@endif
					...
					<li><a href="{{ route('uneb-certificate.uploadpage') }}"><i class="fa fa-file-excel-o fa-fw"></i> UNEB Certificate</a></li>
                     @endif
					@endif
                    ...
                    @if(App\Helpers\RolePermissionCheck::isPermitted('bihar-estamp-certificate.uploadpage'))
					 <li><a href="{{ URL::route('bihar-estamp-certificate.uploadpage') }}"><i class="fa fa-file-excel-o fa-fw"></i> Certificate</a></li>
					  <li><a href="{{ URL::route('bihar-estamp-certificate.uploadpageutility') }}"><i class="fa fa-file-excel-o fa-fw"></i> Certificate - Utility</a></li>
					  <li><a href="{{ URL::route('bihar-estamp-certificate.uploadpageprinterutility') }}"><i class="fa fa-file-excel-o fa-fw"></i> Certificate - Printer Utility</a></li>
					 <li><a href="{{ URL::route('bihar-estamp-certificate.uploadpageapiutility') }}"><i class="fa fa-file-excel-o fa-fw"></i>Certificate - API Printer Utility</a></li>
					 <li><a href="{{ URL::route('bihar-estamp-certificate.uploadpageprinter') }}"><i class="fa fa-file-excel-o fa-fw"></i>Old Certificate - Printer</a></li>
					...
					<li><a href="{{ route('minosha-certificate.uploadpage') }}"><i class="fa fa-file-excel-o fa-fw"></i> Minosha Custom Templates</a></li>
          @endif
           @endif
				</ul>
			</li>
      ...
      @if(App\Helpers\SitePermissionCheck::isPermitted('pgconfig.index') || (App\Helpers\SitePermissionCheck::isPermitted('pgmaster.index')) || (App\Helpers\SitePermissionCheck::isPermitted('documentsratemaster.index')))
          ...
          @if(App\Helpers\SitePermissionCheck::isPermitted('pgmaster.index'))
					@if(App\Helpers\RolePermissionCheck::isPermitted('pgmaster.index'))
						<li>
							<a href="{{ URL::route('pgmaster.index') }}"><i class="fa fa-money fa-fw"></i>Payment Gateway</a>
						</li>
					@endif
					@endif
          ...
          @if(App\Helpers\RolePermissionCheck::isPermitted('pgconfig.index'))
						<li>
							<a href="{{ URL::route('pgconfig.index') }}"><i class="fa fa-gears fa-fw"></i> PG Configuration</a>
          ...
          @if(App\Helpers\RolePermissionCheck::isPermitted('documentsratemaster.index'))
						<li>
							<a href="{{ URL::route('documentsratemaster.index') }}"><i class="fa fa-gears fa-fw"></i> Document Rate Master</a>
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu">
					...
					<li><a href="{{ route('vgujaipur.create') }}"><i class="fa fa-file-text-o fa-fw"></i> Print Serial Number</a></li>
					@endif
					@endif
					...
					<li><a href="{{ URL::route('printing-detail.index') }}"><i class="fa fa-print fa-fw"></i> <?php if($subdomain[0]=="sales"){ echo "Generation details"; }else{ echo "Printing details"; } ?></a></li>
					@endif
					@endif
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu">
					...
					<li><a href="{{ route('sandboxing.printingDetails.index') }}"><i class="fa fa-file-powerpoint-o fa-fw"></i><?php if($subdomain[0]=="sales"){ echo "Generation details"; }else{ echo "Printing details"; } ?> </a></li>
					@endif
					@endif
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu">
					...
					<li><a href="{{ route('pdf2pdf-report.index') }}"><i class="fa fa-file-powerpoint-o fa-fw"></i> Pdf2pdf Report</a></li>
					@endif
					@endif
					...
					<li><a href="{{ URL::route('transactionVerification.index') }}"><i class="fa fa-cc-visa fa-fw"></i> Payment Verification Transactions</a></li>
					@endif
					@endif

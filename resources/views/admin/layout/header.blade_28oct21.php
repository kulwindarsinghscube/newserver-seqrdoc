...
<nav class="navbar navbar-default">
  <div class="container" style="width: 99%;">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
       ...
       if($subdomain[0]=="demo"||$subdomain[0]=="uasb"||$subdomain[0]=="galgotias"||$subdomain[0]=="kessc"||$subdomain[0]=="iccs"||$subdomain[0]=="monad"||$subdomain[0]=="ghribmjal"||(App\Helpers\SitePermissionCheck::isPermitted('pdf2pdf.templatelist')&&App\Helpers\RolePermissionCheck::isPermitted('pdf2pdf.templatelist'))||(App\Helpers\SitePermissionCheck::isPermitted('bmcc-certificate.uploadpage')&&App\Helpers\RolePermissionCheck::isPermitted('bmcc-certificate.uploadpage'))
       ...
       if($subdomain[0]=="mitadt" || $subdomain[0] == "localhost"){ ?>
			...
			@if(App\Helpers\RolePermissionCheck::isPermitted('degree-certifiate.index'))
				<li class="dropdown">
					<a class="dropdown-toggle" data-toggle="dropdown" href="#"><i class="fa fa-newspaper-o fa-fw"></i> Degree Certificate<span class="caret"></span></a>
					<ul class="dropdown-menu">

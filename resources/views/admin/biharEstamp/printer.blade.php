...
<div class="container">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><i class="fa fa fa-file-excel-o"></i> Bihar Estamp Certificate - Printer
        ...
        <div class="row">
            <div class="col-lg-7"> <br />
                <form method="post" id="processExcelForm" class="form-horizontal" enctype="multipart/form-data" action="<?=route('bihar-estamp-certificate.uploadfileprinter')?>">
            ...
            <div class="col-lg-5" style="padding: 83px 1em;"> 
                <?php
                    ...
                    $excel_url_1=$path.$subdomain[0]."/backend/sample_excel/data.json";
                ...
                <span style="display:none;" id="excel_url_1"><b>Please Click <a href="{{$excel_url_1}}" download>HERE</a> To Download Sample JSON File</b></span>
...
$('#btn_updfile').click(function (event) {
	...
	if(template_id == 0){
		...
		//alert("Please select template.");
		toastr["error"]("Please enter printer name.");
		return false;
	}
	else{
		validateUpload();
...
function validateUpload() {
	...
	$.ajax({
		url:'<?= route('bihar-estamp-certificate.validateexcelprinter')?>',
	  type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,
...
function uploadfile(){
	...
	$.ajax({
		url:'<?= route('bihar-estamp-certificate.uploadfileprinter')?>',
	    type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,

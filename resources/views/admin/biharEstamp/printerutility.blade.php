...
<div class="container">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><i class="fa fa fa-file-excel-o"></i> Bihar Estamp Certificate Utility
...
function uploadfile(){
  ...
  var printer_name_network=$('#printer_name_network').val();
	...
	$.ajax({
		url:'<?= route('bihar-estamp-certificate.uploadfileutility')?>',
	    type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,
	 ...
	 //    $('#predictedTimeText').text('Approx. Completion Time ');
      ...
      console.log(resp)
			...
			else
			{
                ...
                if(printer_name_network!=""){
                    if(resp.data!=""){
                        sendDataToPCP(resp.base64,resp.fileName,printer_name_network);
                    }
                }
               // 	
			}

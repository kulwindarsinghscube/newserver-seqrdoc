...
<script type="text/javascript">
    ...
    var oTable = $('#ttd-open-table').DataTable({
        ...
        "aoColumns":[
            ...
            },
            {
                ...
                mRender:function(v, t, o){
                    var act_html;
                    act_html ='@if(App\Helpers\SitePermissionCheck::isPermitted('ttd.statusUpdate')) @if(App\Helpers\RolePermissionCheck::isPermitted('ttd.statusUpdate'))<a onclick="approved('+o['id']+')"><i class="fa fa-check-circle fa-lg green"></i></a>@endif @endif';
                    return act_html;
                },
            },
	    ]
        ...
        "aoColumns":[
            ...
            },
            {
                ...
                mRender:function(v, t, o){
                    ...
                    act_html ='@if(App\Helpers\SitePermissionCheck::isPermitted('ttd.ajaxUpdate')) @if(App\Helpers\RolePermissionCheck::isPermitted('ttd.ajaxUpdate'))&nbsp;&nbsp;&nbsp;<a onclick="editForm('+o['id']+')"><i class="fa fa-edit fa-lg green"></i></a>@endif @endif';
    ...
    $("#TtdUpdate").click(function(e){
		...
		$.ajax({
            url: "{{ URL::route('ttd.statusUpdate') }}",

							...
							<form method="POST" enctype="multipart/form-data" id="student_doc">	
								...
								<div class="form-group clearfix">
									<div id="upload_btn">
										...
										<a style="float: left;border: 1px dotted red;background: green;color: #fff;font-size:12px;" class="btn btn-theme" href="{{ url('demo/backend/sample_excel/import_users_sample.xlsx') }}">Download Sample</a>
									</div>
								</div>
							</form>
							<div class="form-group">

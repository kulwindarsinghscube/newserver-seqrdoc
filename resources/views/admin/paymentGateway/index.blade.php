...
@section('content')
    ...
    <div class="container">
    	...
    	<div class="">
            ...
            @if(App\Helpers\SitePermissionCheck::isPermitted('pgmaster.store'))
            @if(App\Helpers\RolePermissionCheck::isPermitted('pgmaster.store'))
 ...
 @include('admin.paymentGateway.model')
          ...
          {mData: "pg_name",bSortable:true},
          {
            ...
            mRender:function(v, t, o){
                var act_html;
                     ...
                     act_html ='@if(App\Helpers\SitePermissionCheck::isPermitted('pgmaster.edit')) @if(App\Helpers\RolePermissionCheck::isPermitted('pgmaster.edit'))<a onclick="edit('+o['id']+')"><i class="fa fa-edit fa-lg green"></i></a>@endif @endif';
                       act_html +='@if(App\Helpers\SitePermissionCheck::isPermitted('pgmaster.destroy')) @if(App\Helpers\RolePermissionCheck::isPermitted('pgmaster.destroy'))&nbsp;&nbsp;<a onclick="deletepath('+o['id']+')"><i class="fa fa-trash fa-lg red"></i></a>@endif @endif';

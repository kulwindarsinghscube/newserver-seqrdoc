									...
									<div class="panel panel-primary" style="margin: 15px auto; width: 800px;">
										...
										<div class="panel-body">
											...
											<div class="form-group clearfix" style="">
												<div class="col-md-6"><h3>Back Template columns</h3></div>
	...
	$('.savefrm').validate({
	  ...
	  submitHandler: function(form) {
	     ...
	     var index_page="{{ URL::route('template-master.index') }}";
		         var url = " {{ URL::route('templateMaster.template-map.uploadcolumns_back') }} ";
		...
		//get mapping columns form Excel sheet
		 $("#btn_updfile").click(function(e){
            ...
            var val = $(this).val();
            var url = " {{ URL::route('templateMaster.template-map.uploadmap_back')}} ";
            var method_type = 'post';
      ...
      // database connection request
		$(".btn_connection").click(function(event) {	
            ...
            var url="{{ URL::route('templateMaster.template-map.mapdatabase_back') }}";
            var token="{{ csrf_token() }}";
            var method_type="post";

...
<nav class="navbar navbar-default">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="dashboard"><i class="fa fa-qrcode fa-fw"></i> SeQR WebApp</a>
    </div>
      ...
      <ul class="nav navbar-nav navbar-right">
		<li class="dropdown">
				...
				<ul class="dropdown-menu">	
					<li><a href="{{ URL::route('admin.dashboard') }}" id=""><span class="fa fa-user-secret fa-fw"></span> Web Admin</a></li>
					<li><a href="{{ URL::route('webapp-sessionManager') }}" id=""><span class="fa fa-lock fa-fw"></span> Session Manager</a></li>

...
<head>
    ...
    <link rel="stylesheet" href="{{asset('excel2pdf/bootstrap.css')}}">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/prettify/r298/prettify.min.css">
    <link rel="stylesheet" href="{{asset('excel2pdf/pdf_styles.css')}}">
    <link rel="stylesheet" href="{{asset('excel2pdf/pdfannotate.css')}}">
...
<div id="hidden-qrcode" style="display:none;"></div>  
    ...
    <!-- <iframe src="{{ asset('excel2pdf/blank.pdf') }}" width="100%" height="600px"></iframe>
    <iframe src="{{URL::route('canvasmaker.create')}}" width="100%" height="600px"></iframe> -->
    ...
    <div class="col-lg-3 mt-3 p-5"> 
        ...
        <div class="input-group text-white">
            <select id="placer_font" class="form-control" onchange="changePlacerFontName()" title="Font" style="width:70%;">
                ...
                @if($FontMasterList)
                @foreach($FontMasterList as $FontMaster)
                    @if($FontMaster->font_filename_N)
                        <option value = "{{ $FontMaster->font_filename_N }}">{{ $FontMaster->font_name }}</option>
                    @endif
                    @if($FontMaster->font_filename_B)
                    <option value = "{{ $FontMaster->font_filename_B }}">{{ $FontMaster->font_name }} bold</option>
                    @endif
                    @if($FontMaster->font_filename_I)
                    <option value = "{{ $FontMaster->font_filename_I }}">{{ $FontMaster->font_name }} italic</option>
                    @endif
                    @if($FontMaster->font_filename_BI)
                        <option value = "{{ $FontMaster->font_filename_BI }}">{{ $FontMaster->font_name }} bold italic</option>
                    @endif
...
<script src="{{asset('excel2pdf/arrow.fabric.js')}}"></script>
<script src="{{asset('excel2pdf/excel_pdfannotate.js')}}"></script>
<script src="{{asset('excel2pdf/excel_script.js')}}"></script>
...
<script type="text/javascript" src="{{asset('excel2pdf/RulersGuides/RulersGuides.js')}}"></script>
<script src="{{asset('excel2pdf/fitz_colours.js')}}"></script>
...
<script src="{{asset('excel2pdf/bootstrap/jquery.validate.js')}}"></script>

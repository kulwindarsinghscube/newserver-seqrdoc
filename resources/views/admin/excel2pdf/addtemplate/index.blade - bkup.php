...
<div class="toolbar" style="text-align: center;">
        ...
        <div class="tool dropdown">
            ...
            <div class="dropdown-content">
                ...
                <!--<a href="javascript:void(0);" onclick="enableGhostRectangle(event,16)">Font Size 16</a>
                <a href="javascript:void(0);" onclick="enableGhostRectangle(event,17)">Font Size 17</a>-->
            </div>            
		</div>
        ...
        <!--<div class="row" style="margin-bottom: -10px !important;">
            ...
            <div id="placer_elements" style="display:none;">
                ...
                <select id="placer_type" class="form-control" onchange="changePlacerType()" title="Placer Type">
                    ...
                    <?php if($subdomain[0]=="test" || $subdomain[0]=="council"){?>
                    <option value = "Print Serial No">Print Serial No</option>
                    <?php } ?> 
                ...
                <!--<div class="text-white" id="blockchain_show_div" style="display:flex;flex-wrap:wrap;-webkit-box-align:stretch; align-items:stretch; width:100%;">
                    <input type="checkbox" value="use" id="blockchain_show" onclick="changeBlockchainPlace()" style="width: 20px;" />&nbsp;Use For Block Chain Metadata
                    <input type="text" id="metadata_label" class="form-control input-sm" placeholder="Enter Metadata Label" autocomplete="off" style="display:none;" onkeyup="changePlacerMetaLabel()" title="Enter Metadata Label" /> 
                    <input type="text" id="metadata_value" class="form-control input-sm" placeholder="Enter Metadata Value" autocomplete="off" style="display:none;clear:both;margin-top:8px;" onkeyup="changePlacerMetaValue()" title="Enter Metadata Value" /> 
                </div>       
                <div class="py-1"></div>-->
            
            </div>
            <div id="extractor_elements" style="display:none;">
				<div class="text-white" id="blockchain_show_div" style="display:flex;flex-wrap:wrap;-webkit-box-align:stretch; align-items:stretch; width:100%;">
                    <input type="checkbox" value="use" id="blockchain_show" onclick="changeBlockchainPlace()" style="width: 20px;" />&nbsp;Use For Block Chain Metadata
                    <input type="text" id="metadata_label" class="form-control input-sm" placeholder="Enter Metadata Label" autocomplete="off" style="display:none;" onkeyup="changePlacerMetaLabel()" title="Enter Metadata Label" /> 
                    <input type="text" id="metadata_value" class="form-control input-sm" placeholder="Enter Metadata Value" autocomplete="off" style="display:none;clear:both;margin-top:8px;" onkeyup="changePlacerMetaValue()" title="Enter Metadata Value" /> 
...
<script src="{{asset('excel2pdf/pdfannotate.js')}}"></script>
<script src="{{asset('excel2pdf/script.js?1234')}}"></script>

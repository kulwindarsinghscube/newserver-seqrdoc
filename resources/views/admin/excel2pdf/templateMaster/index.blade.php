                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="form_process" method='post' action='' enctype="multipart/form-data">
                            ...
                            {{-- <div class="form-group">
                                <label class="control-label col-sm-3" id="generate_title" for="previewPdf">Blockchain PDF:</label>
                                <label class="switch">  
                                    <input type="checkbox" class="form-control" id="previewPdf" name="previewPdf" value="0" checked="">
                                    <span class="slider round"></span>
                                </label>
                                <input type="hidden" class="form-control" id="previewPdfValue" name="previewPdfValue" value="0">
                            </div> --}}

                            {{-- <div class="form-group blockchain_div" style="display: none">
                                <label class="control-label col-sm-12" for="blockchainPdf">Select Blockchain Generation Type: <label id="blockchain_generate_title"><span style="color: red;margin-left: 5px;    margin-top: 10px;"> Generating Test Blockchain Documents.</span> </label></label>
                                <label class="switch">  
                                    <input type="checkbox" class="form-control" id="blockchainPdf" name="blockchainPdf" value="0" checked="">
                                    <span class="slider round"></span>
                                </label>
                                <input type="hidden" class="form-control" id="blockchainPdfValue" name="blockchainPdfValue" value="0">
                            </div> --}}

                            {{-- <div class="form-group">
                                <p class="blockchainDiv col-sm-12" style="display:none;">Select Blockchain Generation Type: <label id="blockchainToggleText"> <span style="color: red;margin-left: 5px;    margin-top: 10px;">Generating Test Blockchain Documents.</span></label></p>
                                <label class="blockchain_switch" style="display:none;">  
                                    <input type="checkbox" class="form-control" id="blockchain_pdf_option" name="blockchain_pdf_option" value="0" checked data-toggle="toggle" data-on="Live" data-off="Preview Only" data-onstyle="success" data-offstyle="danger" data-width="100" data-height="75">
                                    <span class="slider round"></span>
                                </label>
                                <input type="hidden" name="blockchain_pdf_local_option" value="0" id="blockchain_pdf_local_option">
                            </div> --}}
					...
					<div class="container-fluid">
						...
						<div class="">
                            <ul class="nav nav-pills" id="pills-filter">
                                ...
                                @if(App\Helpers\SitePermissionCheck::isPermitted('excel2pdf.templatemaker'))
                                @if(App\Helpers\RolePermissionCheck::isPermitted('excel2pdf.templatemaker'))	
...
<script type="text/javascript">
      ...
      "aoColumns":[
        ...
        <?php } ?>
            ...
            mRender: function(v, t, o) {
            	...
            	buttons = '@if(App\Helpers\SitePermissionCheck::isPermitted('excel2pdf.templatemakeredit')) @if(App\Helpers\RolePermissionCheck::isPermitted('excel2pdf.templatemakeredit')) <span style="cursor:pointer"><i title="Edit Template" id="editData" data-id="'+o['id']+'" data-temp="'+o['template_name']+'" data-page="'+o['pdf_page']+'" data-file="'+o['file_name']+'" data-toggle="tooltip" class="editrow fa fa-edit fa-lg green"></i> </span> @endif @endif';

                buttons += '@if(App\Helpers\SitePermissionCheck::isPermitted('excel2pdf.duplicatetemplate')) @if(App\Helpers\RolePermissionCheck::isPermitted('excel2pdf.duplicatetemplate')) <span style="cursor:pointer" data-id="'+o['id']+'" id="dupData" class="duplicateData" ><i title="Copy Template" class="copyrow fa fa-copy fa-lg yellow"></i></span> @endif @endif';
                
                buttons += '@if(App\Helpers\SitePermissionCheck::isPermitted('excel2pdf.processpdf')) @if(App\Helpers\RolePermissionCheck::isPermitted('excel2pdf.processpdf')) <span style="cursor:pointer" id="processData" data-id="'+o['id']+'" data-temp="'+o['template_name']+'" data-pdf_page="'+o['pdf_page']+'" data-file="'+o['file_name']+'" data-template_name = "'+o['template_name']+'" data-flag=""><i title="Generate PDF"  class="pdfGenerate fa fa-file-pdf-o fa-lg blue"></i></span> @endif @endif';   
                
                if(o['publish']==1){ rcheck="checked"; title_str="Inactivate Template"; }else{ rcheck=""; title_str="Activate Template";}        
                buttons += '@if(App\Helpers\SitePermissionCheck::isPermitted('excel2pdf.templatemakeredit')) @if(App\Helpers\RolePermissionCheck::isPermitted('excel2pdf.templatemakeredit')) &nbsp;<span title="'+title_str+'" style="cursor:pointer"><input name="ai'+o['id']+'" value="'+o['id']+'" type="checkbox" '+rcheck+'></span> @endif @endif';
                <?php if($subdomain[0]=="icat"){ ?>
                    var assign_url = "{{route('excel2pdf.AssignLab',':id')}}"
                    assign_url = assign_url.replace(':id',o['id']);
                    buttons += '@if(App\Helpers\SitePermissionCheck::isPermitted('excel2pdf.templatemakeredit')) @if(App\Helpers\RolePermissionCheck::isPermitted('excel2pdf.templatemakeredit')) &nbsp;<span title="Assign Lab" style="cursor:pointer"><a href="'+assign_url+'"><i class="pdfGenerate fa fa-code-fork fa-lg blue"></i></a></span> @endif @endif';
                <?php } ?>
                buttons += '@if(App\Helpers\SitePermissionCheck::isPermitted('excel2pdf.templatemakeredit')) @if(App\Helpers\RolePermissionCheck::isPermitted('excel2pdf.templatemakeredit')) <span style="cursor:pointer"><i title="Edit Template Title" id="editTitle" data-id="'+o['id']+'" data-temp="'+o['template_name']+'" data-title="'+o['template_title']+'" data-isblockchain="'+o['is_block_chain']+'" data-toggle="tooltip" class="editrow fa fa-edit fa-lg"></i> </span> @endif @endif';
                <?php //if($subdomain[0]=="demo"){ ?>
                buttons += '@if(App\Helpers\SitePermissionCheck::isPermitted('excel2pdf.templatemakeredit')) @if(App\Helpers\RolePermissionCheck::isPermitted('excel2pdf.templatemakeredit')) <span style="cursor:pointer"><i title="Assign Background" id="assignBG" data-id="'+o['id']+'" data-title="'+o['template_title']+'" data-pbg = "'+o['print_bg_file']+'" data-pbgs = "'+o['print_bg_status']+'" data-vbg = "'+o['verification_bg_file']+'" data-vbgs = "'+o['verification_bg_status']+'" data-toggle="tooltip" class="editrow fa fa-image fa-lg green"></i> </span> @endif @endif';
                <?php //} ?>
  ...
  @if(App\Helpers\RolePermissionCheck::isPermitted('excel2pdf.templatemakeredit'))
  	//edit data

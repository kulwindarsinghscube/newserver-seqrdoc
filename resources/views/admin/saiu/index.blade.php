                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="template_id" name="template_id">
                                ...
                                {{-- <option value="7" data-tempid="7">Provisional Transcript</option>
                                 <option value="8" data-tempid="8">Provisional Transcript 8 Semester</option>
                                <option value="9" data-tempid="9">Provisional Transcript New</option> --}}
                        ...
                        <div class="col-sm-9">
                          ...
                          <option value="0" data-file="0">Select BG</option>
                            @foreach ($results as $got)
                                <option value="{{$got->image_path}}" data-file="{{$got->image_path}}">{{$got->background_name}}</option>
                            @endforeach 
                          </select>  
                        </div>
                    </div>

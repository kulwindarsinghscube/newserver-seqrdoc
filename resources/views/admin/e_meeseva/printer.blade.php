...
<div class="container">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><i class="fa fa fa-file-excel-o"></i> E-Meeseva Certificate - Printer
        ...
        <div class="row">
            <div class="col-lg-7"> <br />
                <form method="post" id="processExcelForm" class="form-horizontal" enctype="multipart/form-data" action="<?=route('e-meeseva-certificate.uploadfileprinter')?>">
...
function validateUpload() {
	...
	$.ajax({
		url:'<?= route('e-meeseva-certificate.validateexcelprinter')?>',
	  type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,
...
function uploadfile(){
	...
	$.ajax({
		url:'<?= route('e-meeseva-certificate.uploadfileprinter')?>',
	    type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,

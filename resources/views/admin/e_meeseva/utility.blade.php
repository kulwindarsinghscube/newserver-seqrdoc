...
<div class="container">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><i class="fa fa fa-file-excel-o"></i> E-Meeseva Certificate Utility</h1>
			</div>
		</div>
        <?php 
        ...
        <div class="row">
            <div class="col-lg-7"> <br />
                <form method="post" id="processExcelForm" class="form-horizontal" enctype="multipart/form-data" action="<?=route('e-meeseva-certificate.uploadfileutility')?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="template_id" name="template_id">
                                ...
                                <option value="1" data-tempid="1">E-Meeseva Certificate</option>
                            </select>
                        </div>
                    </div>
                    <!--<div class="form-group">
                    ...
                    <div class="form-group">
                      <label class="control-label col-sm-3" for="excel">Enter Printer Name:</label>
                      <div class="col-sm-9">
                          <input type="text" class="form-control" id="printer_name" name="printer_name"  />
                          <span id="printer_name_error" class="help-inline text-danger"><?=$errors->first('printer_name')?></span>
                      </div>
                    </div>
					...
					<div class="form-group">
						<label class="control-label col-sm-3" for="excel">Enter Tray Name:</label>
						<div class="col-sm-9">
							<input type="text" class="form-control" id="tray_name" name="tray_name" value="Tray 2"  />
							<span id="tray_name_error" class="help-inline text-danger"><?=$errors->first('tray_name')?></span>
						</div>
					</div>
					<?php } ?>
            ...
            <div class="col-lg-5" style="padding: 83px 1em;"> 
                <?php
                    ...
                    $excel_url_1=$path.$subdomain[0]."/backend/sample_excel/e_meeseva.json";
...
function uploadfile(){
  ...
  var printer_name=$('#printer_name').val();
	...
	$.ajax({
		url:'<?= route('e-meeseva-certificate.uploadfileutility')?>',
	    type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,
...
<script type="text/javascript">
	...
	*/
	...
	function sendDataToPCP(pdf_base64){


		<?php if($subdomain[0]=="demo" ){ ?>

		printer_name=document.getElementById('printer_name').value;
		tray_name=document.getElementById('tray_name').value;
		if(tray_name) {
			tray_name = tray_name;
		} else {
			tray_name = 'Tray 2'; 

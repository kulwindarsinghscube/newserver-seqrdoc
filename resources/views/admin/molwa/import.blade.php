				...
				<div id="">
					<div class="container-fluid">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12">  
                                        <div class="form-group">
                                            <div class="col-sm-4">
                                                <label class="control-label" for="temp">District</label>
                                                <select class="form-control" id="district_selector" name="district">
                                                </select>
                                            </div>
                                            <div class="col-sm-4">
                                                <label class="control-label" for="temp">Upazila</label>
                                                <select class="form-control" id="upazila_selector" name="upazila">
                                                </select>
                                            </div>
                                            <div class="col-sm-12">
                                                <label class="control-label" for="temp">Freedom Fighter Category</label>
                                                <select class="form-control" id="category_selector" name="category[]" multiple>
                                                </select>
                                            </div>
                                        </div>         
                                    </div>
                                        ...
                                        <div class="form-group">                                            
                                            ...
                                            <div class="col-sm-2">
                                                ...
                                                <select class="form-control" id="is_alive" name="is_alive">
                                                    <option value="yes" data-tempid="yes">Alive</option>
                                                    <option value="no" data-tempid="no">Dead</option>
                                                    <option value="all" data-tempid="all">All</option>
                                                </select>                                            
                                            </div>
                                        </div>         
                                    </div>
                        ...
                        <div class="col-xs-12 pull-right">
                            <button class="viewData" data-api="district">View Districts Count</button>&nbsp;&nbsp;
                            <button class="viewData" data-api="api">View API Response</button>  
                        </div>    
						<div class="">							
							<div class="col-xs-12">
...
<script src="{{asset('backend/js/district.js')}}"></script>
	...
	var oTable = $('#example').DataTable({
        ...
        {mData: 'fresh_records',
            ...
            mRender: function(v, t, o) {
                ...
                buttons += '&nbsp;<a data-toggle="tooltip" title="Export" href="ExportToExcel/'+o['record_unique_id']+'/import" target="_blank"><i class="fa fa-file-excel-o fa-lg green" style="font-size:23px;"></i></a>';
                }
				return buttons;
            },         		   
        }, 
        ...
        if (confirm('Do you want to generate ID Card?')) {
            $.ajax({
                ...
                beforeSend : function() {
                    ...
                    $('#'+msg).show();                   
                    interval = setInterval(function(){
                        $.getJSON('<?=route('molwa-certificate.getIdProgess')?>', function(data) {
        ...
        if (confirm('Do you want to generate Certificate?')) {
            $.ajax({
                ...
                beforeSend : function() {
                    ...
                    $('#'+msg).show();                   
                    interval = setInterval(function(){
                        $.getJSON('<?=route('molwa-certificate.getCtProgess')?>', function(data) {

...
<script type="text/javascript">
	...
	var oTable = $('#example').DataTable({
        ...
        {mData: "id",bSortable: true,
            bSortable: false,
            mRender: function(v, t, o) {
                generated_at=o['generated_at']; console.log(generated_at);
		...
		{mData: 'id',
            ...
            mRender: function(v, t, o) {
            	var buttons = '';
            	buttons += '<button title="View Details" class="details-control" id="'+o['id']+'" flag="ff_details"><i class="fa fa-eye fa-lg blue"></i></button>';  
            	buttons += '&nbsp;<button title="View Process" class="details-control" id="'+o['id']+'" flag="Process"><i class="fa fa-tasks fa-lg blue"></i></button>';  
                /*
    ...
    $('#example tbody').on('click', 'button.details-control', function () {
        ...
        if ( row.child.isShown() ) {
            ...
            row.child( format(row.data(),id,flag) ).show();
            tr.addClass('shown');
        }
    } );

    function format ( rowData,id,flag ) { //rowData[1] 
        var div = $('<div/>')
            .addClass( 'loading' )
            .text( 'Loading...' );

        ...
        <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="template_id" name="template_id">
                                ...
                                <option value="4" data-tempid="4">Grade Card</option>
                                <option value="5" data-tempid="5">Grade Card With Supplementary Exam</option>                       
                                <option value="6" data-tempid="6">Transcript New</option>                       
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="col-lg-5" style="padding: 83px 1em;"> 
                <?php
                    ...
                    $excel_url_4=$path.$subdomain[0]."/backend/sample_excel/SEM GRADE CARD.xlsx";

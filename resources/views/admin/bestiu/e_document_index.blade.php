	...
	<div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-5" style="padding: 83px 1em;"> 
                ...
                <span style="display:none;" id="excel_url_5_6"><b>Please Click <a href="{{$excel_url_5_6}}" download>HERE</a> To Download Sample Excel</b></span>
                <span style="display:none;" id="excel_url_5_8"><b>Please Click <a href="{{$excel_url_5_8}}" download>HERE</a> To Download Sample Excel</b></span>
                <span style="display:none;" id="excel_url_5_10"><b>Please Click <a href="{{$excel_url_5_10}}" download>HERE</a> To Download Sample Excel</b></span>
                <span style="display:none;" id="excel_url_5_12"><b>Please Click <a href="{{$excel_url_5_12}}" download>HERE</a> To Download Sample Excel</b></span>
                <span style="display:none;" id="excel_url_6_8"><b>Please Click <a href="{{$excel_url_6_8}}" download>HERE</a> To Download Sample Excel</b></span> 
                <span style="display:none;" id="excel_url_6_10"><b>Please Click <a href="{{$excel_url_6_10}}" download>HERE</a> To Download Sample Excel</b></span> 
                <span style="display:none;" id="excel_url_6_12"><b>Please Click <a href="{{$excel_url_6_12}}" download>HERE</a> To Download Sample Excel</b></span> 

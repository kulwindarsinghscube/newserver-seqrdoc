...
@section('content')
  	...
  	<div class="col-xs-12">
  		...
  		<div class="row">
  			<div class="col-lg-12">
  				<h1 class="page-header"><i class="fa fa-fw fa-users"></i> Student Management
  				  <ol class="breadcrumb pull-right" style="background:transparent;font-size:14px;">{{ Breadcrumbs::render('studentmanagement') }}</ol>
        ...
        @if(App\Helpers\SitePermissionCheck::isPermitted('student.upload'))
...
<iframe id="my_iframe" style="display:none;"></iframe>
 <!--  Model studentManagement -->
  @include('admin.studentManagement.model')
  ...
  // downlaod sample file
   ...
   @if(App\Helpers\RolePermissionCheck::isPermitted('student.upload'))
    ...
    $(".save").click(function(event){
       ...
       var url="{{ URL::route('student.upload') }}";

...
@section('content')
  <div class="container">
	<div class="container-fluid">
		 ...
		 @include('admin.raisoni.paymentGatewayConfig.documentRateMaster')	
		 @include('admin.raisoni.paymentGatewayConfig.templateRateMaster')	
	</div>
</div>
@stop
@section('script')
...
$(document).ready(function() {	
  ...
  $("#documentRateMastertbody").empty();
     var ajaxURL="{{ URL::route('documentsratemaster.index') }}";
   ...
   $("#update_save_document_rate").click(function(event) {
      ...
      var update_path="{{ URL::route('documentsratemaster.update') }}";
      var token="{{ csrf_token() }}";
   	...
   	var oTable = $('#example').DataTable({
		...
		{mData: 'id',
            ...
            mRender: function(v, t, o) {
            	...
            	buttons = '@if(App\Helpers\SitePermissionCheck::isPermitted('templateratemaster.update')) @if(App\Helpers\RolePermissionCheck::isPermitted('templateratemaster.update')) <span class="update_template_fee" onclick="updateFee('+o['id']+')" data-id="'+o['id']+'" style="cursor: pointer;padding: 8px;color: #fff;background-color: #0052cc;border-radius: 5px;">Update Fee</span> @endif @endif'; 				return buttons;
            },

...
@section('content')
    <div class="container">
    	<div class="container-fluid">
    		<div class="row">
    			<div class="col-lg-12">
    				...
    				<ol class="breadcrumb pull-right" style="background:transparent;font-size:14px;">{{ Breadcrumbs::render('sessionsmasterpage') }}</ol>
    	...
    	<div class="">
            ...
            @if(App\Helpers\SitePermissionCheck::isPermitted('sessionsmaster.store'))
            @if(App\Helpers\RolePermissionCheck::isPermitted('sessionsmaster.store'))
 ...
 @include('admin.raisoni.sessionsmaster.model')
          ...
          },
          {
            ...
            mRender:function(v, t, o){
                var act_html;
                     ...
                     act_html ='@if(App\Helpers\SitePermissionCheck::isPermitted('sessionsmaster.edit')) @if(App\Helpers\RolePermissionCheck::isPermitted('sessionsmaster.edit'))<a onclick="edit('+o['session_no']+')"><i class="fa fa-edit fa-lg green"></i></a>@endif @endif';

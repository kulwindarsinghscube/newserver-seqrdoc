                                        ...
                                        <div class="form-group">
											...
											<div class="col-xs-12">
												...
												<div class="col-sm-4">
													...
													<input type="text" class="form-control" id="tel_no_two" name="tel_no_two">
												</div>												
                                            </div>
											<div class="col-xs-12">
												<div class="col-sm-4">
												...
												<div class="col-sm-4">
													...
													<input type="file" name="company_logo" class="form-control" id="exampleInputFile" />
												</div>
												<div class="col-sm-4">
    ...
    */
    ...
    $('#processApiForm').validate({
        ...
        messages:{            
            ...
            initials:{required:'Enter Initials'},

			...
			<div class="clearfix">
				<div id="">
					<div class="container-fluid">
						<div class="row">
							<div class="col-lg-12">
								<h1 class="page-header"><i class="fa fa-fw fa-file"></i> Upload Previous Data</h1>	
							</div>
						</div>						
						...
						<?php if ($role_id==3){ ?>
                        <div class="col-xs-12" id="agent_div">                
                            <div class="card">                                
									...
									<div class="col-xs-12">  
                                        <div class="form-group">
                                            <div class="col-xs-12">												
                                                ...
                                                <br /><b>Please Click <a href="{{ asset('sgrsa/backend/sample_excel/previous_data.xlsx') }}" download>HERE</a> To Download Sample Excel.</b>
												</div>
                                            </div>
                                        </div>         
                                    </div>
...
<script type="text/javascript">
	...
	var oTable = $('#example').DataTable({
        ...
        "sAjaxSource":"<?= URL::route('supplier-uploadexcel.RecallList',['status'=>1])?>",        
    ...
    $('#processApiForm').validate({
        ...
        rules:{            
            file_name:{required: true, extension:'xls|xlsx'},
        },
        messages:{            
        ...
        submitHandler: function(form){            
            ...
            $('#processApiForm').ajaxSubmit({
                url:'<?= route('supplier-uploadexcel.saveExcelData')?>',
                type: "POST",

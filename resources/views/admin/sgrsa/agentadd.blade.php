			...
			<div class="clearfix">
				<div id="">
					<div class="container-fluid">
						<div class="row">
							<div class="col-lg-12">
								<h1 class="page-header"><i class="fa fa-fw fa-file"></i> Agent Form</h1>	
							</div>
						</div>						
                                    ...
                                    <div class="col-xs-12">  
                                        <div class="form-group">
                                            <div class="col-xs-12">
												...
												<div class="col-sm-3">
													<label class="control-label">Location</label>
													<input type="text" class="form-control" id="location_e" name="location_e">
												</div>
												<div class="col-sm-3">
													<label class="control-label">Contact Number</label>
													<input type="text" class="form-control" id="contact_no_e" name="contact_no_e">
												</div>
												<div class="col-sm-3">
													<label class="control-label">Email</label>
...
<script type="text/javascript">
	...
	var oTable = $('#example').DataTable({
        ...
        "sAjaxSource":"<?= URL::route('sgrsa-agent.AgentList',['status'=>1])?>",        
		...
		{mData: "contact_no",bSortable: true,},
		{mData: 'id',
            bSortable: false,
            sWidth: "5%",
            sClass: "text-center",
    ...
    */
    ...
    $('#processApiForm').validate({
        ...
        submitHandler: function(form){            
            ...
            $('#processApiForm').ajaxSubmit({
                url:'<?= route('sgrsa-agent.agentData')?>',
                type: "GET",
                dataType: "JSON",
	...
	$('#example tbody').on('click', 'a.edit-control', function () {
        ...
        //if (confirm("Do you want to edit a record?")) {
			$.ajax( {
				url: "<?=route('sgrsa-agent.EditRecord')?>",
				type: "GET",
				data: {
					'id':id
				},
				...
				success: function (resObj) {
					if(resObj.success == true){
						$("#div_add").hide();
						$("#div_edit").show();
						$('#name_e').val(resObj.res.name);
						$('#agent_id').val(resObj.agent_id);
						$('#location_e').val(resObj.res.location);
						$('#contact_no_e').val(resObj.res.contact_no);
	...
	$('#editForm').validate({
        ...
        submitHandler: function(form){            
            ...
            var token = "<?= csrf_token()?>"; 
            $('#editForm').ajaxSubmit({
                url:'<?= route('sgrsa-agent.editData')?>',
                type: "GET",
                dataType: "JSON",

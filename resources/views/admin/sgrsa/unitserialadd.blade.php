			...
			<div class="clearfix">
				<div id="">
					<div class="container-fluid">
						<div class="row">
							<div class="col-lg-12">
								<h1 class="page-header"><i class="fa fa-fw fa-file"></i> Unit Serial Numbers</h1>	
							</div>
						</div>						
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12">  
                                        <div class="form-group">                                            
											<div class="col-xs-12">
												<div class="col-sm-12">
													<label class="control-label">Governor Type</label> 
													<!--{!! Form::select('governor_type_id', $governors,[], array('class' => 'form-control select2', 'id' => 'governor_type_id')) !!}-->
													<select class="form-control select2" name="governor_type_id" id="governor_type_id">
											...
											<div class="col-xs-12">
												<div class="col-sm-12">
													<label class="control-label">Unit Serial Number</label>
                                    ...
                                    <button type="submit" class="btn btn-primary" id="btn_type">Submit</button> 
                                    </div>
                                    </form>
...
<script type="text/javascript">
	...
	var oTable = $('#example').DataTable({
        ...
        "sAjaxSource":"<?= URL::route('sgrsa-governor.UnitList',['status'=>1])?>",        
        ...
        {mData: "reg_number",bSortable: true,},  
        {mData: "used",bSortable: true,},  
		{mData: 'id',
            bSortable: false,
            sWidth: "5%",
            sClass: "text-center",
    ...
    $('#processApiForm').validate({
        ...
        rules:{            
            governor_type_id: { required: true },
            /*governor_type_id: { valueNotEquals: "0" },*/
            reg_number: { required: true },
        },
        messages:{            
            governor_type_id:{required:'Select Governor Type'},
            /*governor_type_id:{valueNotEquals:'Select Governor Type'},*/
            reg_number:{required:'Enter Unit Serial Number'},
        },
        submitHandler: function(form){            
            ...
            $('#processApiForm').ajaxSubmit({
                url:'<?= route('sgrsa-governor.saveUData')?>',
                type: "GET",
                dataType: "JSON",

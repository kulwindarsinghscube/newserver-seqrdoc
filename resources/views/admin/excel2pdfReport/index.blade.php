                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">
                                <i class="fa fa-file-powerpoint-o"></i></i> Excel2pdf Report
...
<script type="text/javascript">
    ...
    var oTable = $('#example').dataTable({
        ...
        "bServerSide": true,
        "autoWidth": true,
        "sAjaxSource": "{{URL::route('excel2pdf-report.index')}}",
        "aaSorting": [
            [0, "desc"]
        ],
        "oLanguage": {
        ...
        { 
            "mData":function (o,t,v){
				...
				var source_file = o.source_file;	
                var new_source_file = source_file.replace("xlsx", "pdf");
				var nameArr = source_file.split(',');    
				var count_source_file=nameArr.length
				var record_unique_id = o.record_unique_id;
				var pdf_page = o.pdf_page;	                    
				if(pdf_page == 'Multi'){
					...
					original= "<a href='https://<?=$subdomain[0];?>.seqrdoc.com/<?=$subdomain[0];?>/documents/"+template_name+"/"+record_unique_id+"/"+new_source_file+"' target='_blank' title='Click to download' class='btn btn-success'>"+new_source_file+"</a>";
				}
				return original;                
            },
            sWidth: "20%",

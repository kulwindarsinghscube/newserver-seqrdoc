                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="template_id" name="template_id">
								...
								<option value="8" data-tempid="8">MBBS PRFESSIONAL I & II</option>
								<option value="9" data-tempid="9">MBBS 3rd PRFESSIONAL - PART I</option>
								<option value="10" data-tempid="10">MBBS 3rd PRFESSIONAL - PART II</option>

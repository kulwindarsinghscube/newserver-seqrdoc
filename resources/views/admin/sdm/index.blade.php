	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><i class="fa fa fa-file-excel-o"></i> SDM
					<!--<ol class="breadcrumb pull-right" style="background:transparent;font-size:14px;">{{ Breadcrumbs::render('generatespitcertificates') }}</ol>-->
				</h1>
        ...
        <div class="row">
          ...
          $excel_url_28=$path.$subdomain[0]."/backend/sample_excel/BSCNUG.xlsx";
                ...
                <span style="display:none;" id="excel_url_5"><b>Please Click <a href="{{$excel_url_5}}" download>HERE</a> To Download Sample Excel</b></span>
				<span style="display:none;" id="excel_url_6"><b>Please Click <a href="{{$excel_url_6}}" download>HERE</a> To Download Sample Excel</b></span>	
				<span style="display:none;" id="excel_url_7"><b>Please Click <a href="{{$excel_url_7}}" download>HERE</a> To Download Sample Excel</b></span>	
				<span style="display:none;" id="excel_url_8"><b>Please Click <a href="{{$excel_url_8}}" download>HERE</a> To Download Sample Excel</b></span>	
				<span style="display:none;" id="excel_url_9"><b>Please Click <a href="{{$excel_url_9}}" download>HERE</a> To Download Sample Excel</b></span>	
				<span style="display:none;" id="excel_url_10"><b>Please Click <a href="{{$excel_url_10}}" download>HERE</a> To Download Sample Excel</b></span>
				<span style="display:none;" id="excel_url_11"><b>Please Click <a href="{{$excel_url_11}}" download>HERE</a> To Download Sample Excel</b></span>
				<span style="display:none;" id="excel_url_12"><b>Please Click <a href="{{$excel_url_12}}" download>HERE</a> To Download Sample Excel</b></span>	
				<span style="display:none;" id="excel_url_13"><b>Please Click <a href="{{$excel_url_13}}" download>HERE</a> To Download Sample Excel</b></span>	
				<span style="display:none;" id="excel_url_14"><b>Please Click <a href="{{$excel_url_14}}" download>HERE</a> To Download Sample Excel</b></span>	
				<span style="display:none;" id="excel_url_15"><b>Please Click <a href="{{$excel_url_15}}" download>HERE</a> To Download Sample Excel</b></span>	
				<span style="display:none;" id="excel_url_16"><b>Please Click <a href="{{$excel_url_16}}" download>HERE</a> To Download Sample Excel</b></span>	
				<span style="display:none;" id="excel_url_17"><b>Please Click <a href="{{$excel_url_17}}" download>HERE</a> To Download Sample Excel</b></span>	
				<span style="display:none;" id="excel_url_18"><b>Please Click <a href="{{$excel_url_18}}" download>HERE</a> To Download Sample Excel</b></span>	
				<span style="display:none;" id="excel_url_19"><b>Please Click <a href="{{$excel_url_19}}" download>HERE</a> To Download Sample Excel</b></span>	
				<span style="display:none;" id="excel_url_20"><b>Please Click <a href="{{$excel_url_20}}" download>HERE</a> To Download Sample Excel</b></span>	
				<span style="display:none;" id="excel_url_21"><b>Please Click <a href="{{$excel_url_21}}" download>HERE</a> To Download Sample Excel</b></span>
				<span style="display:none;" id="excel_url_22"><b>Please Click <a href="{{$excel_url_22}}" download>HERE</a> To Download Sample Excel</b></span>
        		<span style="display:none;" id="excel_url_23"><b>Please Click <a href="{{$excel_url_23}}" download>HERE</a> To Download Sample Excel</b></span>
				<span style="display:none;" id="excel_url_24"><b>Please Click <a href="{{$excel_url_24}}" download>HERE</a> To Download Sample Excel</b></span>
        		<span style="display:none;" id="excel_url_25"><b>Please Click <a href="{{$excel_url_25}}" download>HERE</a> To Download Sample Excel</b></span>
        		<span style="display:none;" id="excel_url_26"><b>Please Click <a href="{{$excel_url_26}}" download>HERE</a> To Download Sample Excel</b></span>
        		<span style="display:none;" id="excel_url_27"><b>Please Click <a href="{{$excel_url_27}}" download>HERE</a> To Download Sample Excel</b></span>
            <span style="display:none;" id="excel_url_28"><b>Please Click <a href="{{$excel_url_28}}" download>HERE</a> To Download Sample Excel</b></span>

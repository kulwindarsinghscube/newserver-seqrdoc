	...
	<div class="container-fluid">
        ...
        <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="template_id" name="template_id">
                                ...
                                {{-- <option value="16" data-tempid="16">B.Sc. Nursing (II III IV V VI VIII)SEMESTER (RESIT)</option>--}}
            ...
            <div class="col-lg-5" style="padding: 83px 1em;"> 
				...
				<span style="display:none;" id="excel_url_23"><b>Please Click <a href="{{$excel_url_21}}" download>HERE</a> To Download Sample Excel</b></span>

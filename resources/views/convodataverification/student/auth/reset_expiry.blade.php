...
<body>
    <div class="container">
        ...
        <p>If you need to reset your password again, please <a href="{{ route('convo_student.reset_password_all_details') }}" class="button">request a new password reset link</a>.</p>
    </div>
</body>
</html>

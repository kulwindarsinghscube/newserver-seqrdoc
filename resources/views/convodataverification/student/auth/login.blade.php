...
<style>
    ...
    body::before {
        ...
        width: 100%;
        height: 100%;
        background-image: url('{{ asset('backend/convodataverification/images/background_image.png') }}');
            ...
            <div class="login-form">
                ...
                <form id="loginForm">
                    ...
                    <div class="div text-center">
                        <a href="{{ route('convo_student.reset_password_all_details') }}" style="cursor: pointer">Forgotten password?</a>
                    </div>
                </form>
            </div>
        </div>

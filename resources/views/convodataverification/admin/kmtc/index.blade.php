            ...
            <div class="row">
                        ...
                        <div class="">
                            ...
                            <div class="card-body"
                                ...
                                <div class="col-md-4"
                                    ...
                                    <strong>Attending Convocation</strong>
                                    <br>
                                    <p style="font-size: 10px;margin-top: 4%;">
                                        Registration Completed Count :<span
                                            id="attending_convocation_registration_completed"></span>
                                    </p>
                                    <p style="font-size: 10px">
                                        All Count :<span id="attending_convocation_all"></span>
                                    </p>
                                </div>
                                <div class="col-md-4"
                                    style="flex: 1; border: 2px solid #007bff; padding: 1rem; border-radius: 0.25rem; background-color: white; text-align: center;">
                                    <strong>Accompanying People Count</strong>
                                    <br>
                                    <p style="font-size: 10px;margin-top: 4%;">
                                        Registration Completed Count : <span
                                            id="no_of_people_accompanied_registration_completed"></span>
                                    </p>
                                    <p style="font-size: 10px">
                                        Registration In Progress Count : <span id="no_of_people_accompanied_all"></span>
                                    </p>
                                </div>
                                <div class="col-md-4"
                                    style="flex: 1; border: 2px solid #007bff; padding: 1rem; border-radius: 0.25rem; background-color: white; text-align: center;">
                ...
                <div class="row">
                    <form method="post" id="processExcelForm" class="form-horizontal"
                        ...
                        action="<?= route('convocationkmtc.admin.upload_student') ?>">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                ...
                                <div align="center"><b>Please Click
                                        <a class="tab_student"
                                            href="{{ asset($subdomain[0] . '/backend/convocation/sampleExcel.xlsx') }}"
                                            download>HERE</a>
                                        <a class="tab_phd_student" style="display: none"
                                            href="{{ asset($subdomain[0] . '/backend/convocation/sampleExcelPhd.xls') }}"
                                            download>HERE</a>
                ...
                <div class="row other_students">
                    <div class="col-md-3">
                        ...
                        <select id="course_filter" class="form-control select2" >
                            <option value="">All</option>
                            @foreach ($other_student_program as $item)
                    ...
                    <div class="col-md-3">
                        ...
                        <select id="specialization" class="form-control select2" >
                            <option value="">All</option>
                            @foreach ($other_student_specialization as $item)
                    ...
                    <div class="col-md-3">
                        ...
                        <select id="faculty_name" class="form-control select2" >
                            <option value="">All</option>
                            @foreach ($other_student_faculty as $item)
                            <option value="{{ $item->faculty_name }}">{{ $item->faculty_name }}</option>
                            @endforeach
                            <!-- Add more courses as needed -->
                        </select>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <select id="completion_year" class="form-control select2" >
                            <option value="">All</option>
                            @foreach ($other_student_completion_year as $item)
                            <option value="{{ $item->completion_date }}">{{ $item->completion_date_formated }}</option>
                            @endforeach
                            <!-- Add more courses as needed -->
                        </select>
                    </div>
                ...
                <div class="row phd_students"  >
                    <div class="col-md-3">
                        ...
                        <select id="course_filter_phd" class="form-control select2" >
                            <option value="">All</option>
                            @foreach ($phd_student_program as $item)
                            <option value="{{ $item->course_name }}">{{ $item->course_name }}</option>
                            @endforeach
                            <!-- Add more courses as needed -->
                        </select>
                    ...
                    <div class="col-md-3">
                        ...
                        <select id="specialization_phd" class="form-control select2" >
                            <option value="">All</option>
                            @foreach ($phd_student_specialization as $item)
                            <option value="{{ $item->specialization }}">{{ $item->specialization }}</option>
                            @endforeach
                            <!-- Add more courses as needed -->
                        </select>
                    ...
                    <div class="col-md-3">
                        ...
                        <select id="faculty_name_phd" class="form-control select2" >
                            <option value="">All</option>
                            @foreach ($phd_student_faculty as $item)
                            <option value="{{ $item->faculty_name }}">{{ $item->faculty_name }}</option>
                            @endforeach
                            <!-- Add more courses as needed -->
                        </select>
                    ...
                    <div class="col-md-3">
                        ...
                        <select id="completion_year_phd" class="form-control select2" >
                            <option value="">All</option>
                            @foreach ($phd_student_completion_year as $item)
                            <option value="{{ $item->completion_date }}">{{ $item->completion_date_formated }}</option>
                            @endforeach
                            <!-- Add more courses as needed -->
                        </select>
                ...
                <div class="row tab_student">
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="{{ route('convocation.admin.upload_studentImage') }}" method="post" enctype="multipart/form-data" id="uploadImagesForm">
                                            @csrf
                                            <div class="form-group">
                                                <label for="imageUpload">Select Images</label>
                                                <input type="file" id="imageUpload" name="images[]" multiple class="form-control" accept="image/*">
                                            </div>
                                    </div>
                                    <div class="modal-footer">
                    ...
                    <div class="row" style="margin-top:1%;margin-bottom:1%">
                        ...
                        <div class="col-md-12" style="text-align: right;margin-top:1%">
                            <!-- <a id="" class="btn btn-success" data-toggle="modal" data-target="#UploadImagesModal">
                                <i class="fa fa-upload" aria-hidden="true" style="margin-right: 3%"></i>  Upload Image
                            </a> -->
                            
                            <!-- <a id="verified_image_btn" class="btn btn-success verified_image_btn">
                                <i class="fa fa-picture-o" style="margin-right: 3%"></i> Verified Images
                            </a> -->
                ...
                <div class="row tab_phd_student" style="display:none">
                    ...
                    <div class="row" style="margin-top:1%;margin-bottom:1%">
                        ...
                        <div class="col-md-12" style="text-align: right;margin-top:1%">
                            ...
                            <a id="verified_image_btn" class="btn btn-success">
                                <i class="fa fa-picture-o" style="margin-right: 3%"></i>  Verified Images
                            </a> -->
                ...
                'aoColumns': [{
                    ...
                    },
                    {
                        ...
                        mRender: function(data, type, row) {
                            ...
                            // var url = '/admin/convocation/convo_studentkmtc/' + row.id; // Example URL
                            var url = '/admin/convocation/studentkmtc_edit/' + row.id;
    ...
    //                     </div>`
            ...
            $(document).ready(function() {
                ...
                //kamini changes Start
                    ...
                    $('#verified_image_btn').on('click', function(e) {
                        e.preventDefault();
                        var baseUrl = '{{ route('convo_student.get_non_verified_student_data') }}';
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            console.log(response); // You can modify this part to handle the success as needed
                            if(response.uploaded_files.length > 0) {
                                toastr.success('Uploaded files are: ' + response.uploaded_files.join(', ') );

                               if(response.not_uploaded_files.length > 0){
                                toastr.error( 'This PRN no not found in record: ' + response.not_uploaded_files.join(', '));
                        ...
                        error: function (xhr, status, error) {
                            if (xhr.responseJSON && xhr.responseJSON.errors) {
                                $.each(xhr.responseJSON.errors, function (field, messages) {
                                    toastr.error(messages.join(', ')); // Show error messages
                                });
                            } else {
                                toastr.error('There was an error while uploading the images.');
                            }
                        }
                    });
                });

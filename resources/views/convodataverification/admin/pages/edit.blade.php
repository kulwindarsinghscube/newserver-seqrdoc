                    ...
                    <form id="student-form" enctype="multipart/form-data">
                        ...
                        <div class="form-row row">
                         {{-- <div class="form-group col-md-12">
                               <h2 style="border: 2px solid #FF0000; padding: 10px;   background-color: #FFEDED; color: #FF0000; font-weight: bold; text-align: center; border-radius: 5px; box-shadow: 2px 2px 5px rgba(0, 0, 0, 0.2);">
                                    UPDATE CLOSED
                                </h2>
                             </div> --}}
                            <div class="form-group col-md-6">

                    ...
                    <ul class="nav nav-pills" id="pills-filter" style="float: right;">
                        ...
                        <li class="active">
                            <a class=" active btn btn-primary dashboard_btn" style="font-size: 17px;" class="primary"
                                 data-toggle="collapse" href="#collapsibleDiv" role="button"
                                aria-expanded="false" aria-controls="collapsibleDiv">
                ...
                <div id="collapsibleDiv" class="collapse  col-md-12">
                    <div class="card card-body mt-2">
                        ...
                        <div class="">
                            ...
                            <div class="card-body" style="display: flex; flex-wrap: wrap; gap: 1rem; padding: 1rem; background-color: #f8f9fa; border: 1px solid #dee2e6; border-radius: 0.25rem;">
                                <div class="col-md-4" style="flex: 1; border: 2px solid #007bff; padding: 1rem; border-radius: 0.25rem; background-color: white; text-align: center;">
                                   <strong>Attending Convocation</strong> 
                                    <br>
                                    <span id="attending_convocation_registration_completed"></span> ( <span id="attending_convocation_all"></span>)
                                </div>
                                <div class="col-md-4" style="flex: 1; border: 2px solid #007bff; padding: 1rem; border-radius: 0.25rem; background-color: white; text-align: center;">
                                    <strong>Accompanying People Count</strong> 
                                    <br>
                                    <span id="no_of_people_accompanied_registration_completed"></span> ( <span id="no_of_people_accompanied_all"></span>)
                                </div>
                                <div class="col-md-4" style="flex: 1; border: 2px solid #007bff; padding: 1rem; border-radius: 0.25rem; background-color: white; text-align: center;">
                                    <strong>Collecting by Post (India)</strong> 
                                    <br>
                                    <span id="by_post_india_registration_completed"></span> ( <span id="by_post_india_all"></span>)

                                </div>
                                <div class="col-md-4" style="flex: 1; border: 2px solid #007bff; padding: 1rem; border-radius: 0.25rem; background-color: white; text-align: center;">
                                    <strong>Collecting by Post (International)</strong> 
                                    <br>
                                    <span id="by_post_international_registration_completed"></span> ( <span id="by_post_international_all"></span>)
                                </div>
                            </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            ...
                            <div align="center"><b>Please Click
                                    <a class="tab_student"
                                        href="{{ asset($subdomain[0] . '/backend/convocation/sampleExcel.xls') }}"
                                        download>HERE</a>
            ...
            <div class="row centered-card" style="text-align: center;">
                <div id="response" class="card col-md-4" style="display: none">
                    ...
                    <div class="card_body"
                        ...
                        <button type="button" id="close_reponse_card" style="margin-right: 3%;" class="btn btn-secondary">
                            Close</button>
                    </div>
                </div>
        ...
        function fetchStatusCounts() {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#attending_convocation_registration_completed').html(data.collectionData['attending_convocation_registration_completed']);
                    $('#attending_convocation_all').html(data.collectionData['attending_convocation_all']);

                    $('#by_post_international_registration_completed').html(data.collectionData['by_post_international_registration_completed']);
                    $('#by_post_international_all').html(data.collectionData['by_post_international_all']);

                    $('#by_post_india_registration_completed').html(data.collectionData['by_post_india_registration_completed']);
                    $('#by_post_india_all').html(data.collectionData['by_post_india_all']);

                    $('#no_of_people_accompanied_all').html(data.collectionData['no_of_people_accompanied_all']);
                    $('#no_of_people_accompanied_registration_completed').html(data.collectionData['no_of_people_accompanied_registration_completed']);

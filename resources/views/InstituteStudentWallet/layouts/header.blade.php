...
<nav class="navbar navbar-default">
  <div class="container" style="width:100%">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="{{ URL::route('inswebapp.dashboard') }}"><i class="fa fa-qrcode fa-fw"></i>{{ Session::get('site_name') }} SeQR WebApp</a>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li><a href="{{ URL::route('insdocuments') }}"><i class="fa fa-file"></i> Documents</a></li>
        <li><a href="{{ URL::route('inswebapp.dashboard') }}"><i class="fa fa-camera"></i> Scanner</a></li>
      ...
      <ul class="nav navbar-nav navbar-right">
		<li class="dropdown">
				...
				<ul class="dropdown-menu">	
					...
					<li><a href="{{ URL::route('inswebapp.profile.showprofile') }}" id=""><span class="fa fa-user fa-fw"></span> My Profile</a></li>
					<li><a href="{{ URL::route('inswebapp.logout') }}" id="logout"><span class="fa fa-fw fa-sign-out"></span>Logout </a></li>
				</ul>
		</li>
      </ul>
    </div>

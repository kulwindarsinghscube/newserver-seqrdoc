            ...
            <div class="tab-content">
              <div id="login-holder" class="tab-pane fade in active">
                <p>
                        ...
                        @csrf
                        <fieldset>
                            <h5>Verification link has been sent on <strong>{{$email}}</strong></h5> 
             ...
             <div id="success-holder" class="tab-pane fade in ">
                <p>
                        ...
                        <fieldset>
                            <h5><i class="fa fa-check-circle green"></i> Congrats! Your account has been verified successfully. <a href="{{ URL::route('webapp.index') }}">Click here</a> for login.</h5>
...
$(document).ready(function(){
    ...
    $("#resendVerification").click(function(e){
        ...
        e.preventDefault();     
        var login_url="{{ URL::route('webapp.resendverificationlink') }}";
        ...
        $.ajax({
              url:login_url,
              type:method_type,
              data:{'_token':token,'email_id':'{{$email}}'},
    ...
    $("#checkVerificationStatus").click(function(e){
        ...
        e.preventDefault();     
        var login_url="{{ URL::route('webapp.checkverificationstatus') }}";
        var method_type="post";
        var token="{{ csrf_token() }}";

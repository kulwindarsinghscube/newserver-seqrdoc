...
<div class="">
	<div class="container">
		<div class="col-xs-12 col-md-4 col-md-offset-4">
			<img src="{{asset('backend/images/SeQR.png')}}" class="center-block" style="height:90px;width:90px;">
		</div>
		<div class="col-xs-12 col-md-4 col-md-offset-4">
			<br><br><br>
			<div class="center-div">
				<center>
					@if($status == 1)
						...
						Congrats! Your account has been verified successfuly.<br> <a href="{{ URL::route('webapp.index') }}">Click here</a> to login with your username and password.
					@elseif($status == 2)

					...
					<form method="POST" action="#" class="passwordResetForm" id="passwordResetForm">
						...
						<fieldset>
							...
							<div class="form-group">
								<label>Email</label>
								<input class="form-control input-lg" id="email_id_l" placeholder="enter email_id here" name="email_id" type="text" value="{{ $email ?? old('email') }}" readonly>
						  ...
						  <button type="submit" id="password_reset" class="btn btn-sm btn-block"><i class="fa fa-key"></i> {{ __('Reset Password') }}</button>
						</fieldset>
					</form>
				</p>
			  </div>

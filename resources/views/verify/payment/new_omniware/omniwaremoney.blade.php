...
<?php
      ...
      $param_data['amount'] = $omniWareData['amount'];
      $param_data['city'] = 'vikhroli';
      $param_data['country'] = 'india';
      $param_data['currency'] = 'INR';
      $param_data['description'] =  (!isset($omniWareData['product_info'])) ? $omniWareData['product_info'] : 'scube';
      $param_data['email'] = 'dev7@scube.net.in';
      $param_data['name'] = (!isset($omniWareData['name'])) ? $omniWareData['name'] : 'scube';
      $param_data['order_id'] = $omniWareData['txnid'];
      $param_data['phone'] = '7083008499';
      $param_data['return_url'] = $omniWareData['return_url'];

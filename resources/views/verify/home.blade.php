...
@stop
@section('script')
<script src="{{asset('webcamjs/js/filereader.js')}}"></script>
<script src="{{asset('webcamjs/js/qrcodelib.js')}}"></script>
<script src="{{asset('webcamjs/js/webcodecamjs.js')}}"></script>
<script src="{{asset('webcamjs/js/main.js')}}"></script>
<script>
var key = '';
var pay = '';

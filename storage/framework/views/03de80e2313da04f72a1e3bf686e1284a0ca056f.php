<?php $__env->startSection('content'); ?>
  <div class="container">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><i class="fa fa-fw fa-gears"></i> Payment Gateway Configuration
		...
		<div class="panel panel-primary" style="margin: 0 auto; width: 560px;">
            ...
            <?php if(App\Helpers\SitePermissionCheck::isPermitted('pgconfig.update')): ?>
            <?php if(App\Helpers\RolePermissionCheck::isPermitted('pgconfig.update')): ?>
...
$(document).ready(function() {	
	...
	// show payment method on select input
     var ajaxURL="<?php echo e(URL::route('pgconfig.index')); ?>";
   ...
   // on change payment method call featch data
	 $("#opt_wl").change(function(event) {
	 	var pg_id=$(this).val();
        var show_path="<?php echo e(URL::route('pgconfig_fetch_dropdown_value.show')); ?>";
        var token="<?php echo e(csrf_token()); ?>";
	 	$.ajax({
             url:show_path,
   ...
   $("#update_save").click(function(event) {
      ...
      var update_path="<?php echo e(URL::route('pgconfig.update')); ?>";
      var token="<?php echo e(csrf_token()); ?>";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/paymentGatewayConfig/index.blade.php ENDPATH**/ ?>
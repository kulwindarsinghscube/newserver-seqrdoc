...
<body>
	<div class="keyboard" style="position:absolute;position: absolute;left:0%;">
		...
		<div style="z-index:0;position:absolute; top:0px; left:0px;">
			<img src="<?php echo e(asset("text_translator_images/images/Base_kbd.gif")); ?>" border="0" usemap="#Map_f" />
		...
		<div id="normal_f" style="z-index:1;position:absolute; top:0px; left:0px; visibility:visible">
			<img src="<?php echo e(asset("text_translator_images/images/Hindi_normal.gif")); ?>" border="0" usemap="#Map_f2" />
		...
		<div id="Shift_c_f" style="z-index:1;position:absolute; top:0px; left:0px; visibility:hidden">
			<img src="<?php echo e(asset("text_translator_images/images/Hindi_Shift.gif")); ?>" border="0" usemap="#Map_f3" />
		...
		<div id="caps_f" style="z-index:1;position:absolute; top:0px; left:0px; visibility:hidden">
			<img src="<?php echo e(asset("text_translator_images/images/Hindi_Shift.gif")); ?>" border="0" usemap="#Map_f4" />
	...
	</script><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/convodataverification/admin/pages/hindi_keyboard_father.blade.php ENDPATH**/ ?>
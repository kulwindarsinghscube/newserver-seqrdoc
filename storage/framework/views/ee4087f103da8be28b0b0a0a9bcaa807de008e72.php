...
<div class="container">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><i class="fa fa fa-file-excel-o"></i> Records
					<ol class="breadcrumb pull-right" style="background:transparent;font-size:14px;"><?php echo e(Breadcrumbs::render($breadcrums )); ?></ol>
				</h1>
    ...
    <span>Batch Name: <?php echo e($batch->name); ?></span> 
    <span>Date: <?php echo e($batch->created_date); ?></span>
    </label>
    <input type="hidden" id="BatchId" value="<?php echo e($id); ?>">


        <div class="mt-5">
         <input type="hidden" id="approver_flag" value="<?php echo e($flag); ?>" >
         <?php if(App\Helpers\SitePermissionCheck::isPermitted('add-records')): ?>
        <?php if(App\Helpers\RolePermissionCheck::isPermitted('add-records')): ?>
        ...
        <!-- <?php if(App\Helpers\SitePermissionCheck::isPermitted(' export.records')): ?>
          <?php if(App\Helpers\RolePermissionCheck::isPermitted(' export.records')): ?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="BatchForm">
          ...
          <input type="hidden" name="batch_id" id="batch_id" value="<?php echo e($decryptedId); ?>">
          <div class="form-group">
  ...
  $(document).ready(function() {
    ...
    // alert(approver_flag);
            var table = $('#tableYajra').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?php echo e(route('ksg-batch-records.datatable')); ?>",
                    method: 'POST',
                    data: {
                        batch_id: batch_id ,
    ...
    $('#tableYajra').on('click', '.editBatch', function() {
        var id = $(this).data('id'); 
        $.ajax({
            url: "<?php echo e(route('edit-record', '')); ?>/" + id,
            method: 'GET',
    ...
    $('#BatchForm').on('submit', function(event) {
        ...
        var url = $('#recordId').val() ? "<?php echo e(route('update-record')); ?>" : "<?php echo e(route('add-record')); ?>";
        $.ajax({
            url: url,
            method: 'POST',
            data: $(this).serialize(),
    ...
    $('body').on('click', '.DeleteBatch', function () {
     ...
     var url = "<?php echo e(url('delete-record')); ?>/" + id;
     if(userConfirmed){
             $.ajax({
                 type: "get",
                 url: url,
       ...
       $(document).on('click', '.approveRejectBatch', function() {
        ...
        $('#statusUpdateForm')[0].reset();
         ...
         var url = "<?php echo e(url('edit-record')); ?>/" + recordId;
           $.ajax({
            url: url,
            method: 'GET',
            data: $(this).serialize(),
        ...
        event.preventDefault();    
        var url = "<?php echo e(route('update-record-status')); ?>";
        $.ajax({
            url: url,
            method: 'POST',
            data: $(this).serialize(),
    ...
    if (confirm("Are you sure you want to approve the selected items?")) {
        ...
        $.ajax({
            url: "<?php echo e(route('approve-selected')); ?>",  
            method: "POST",
            data: {
...
$('#btn_view_records').on('click', function(e) {
   ...
   var BatchId = $('#BatchId').val(); 
    ...
    var exportUrl = "<?php echo e(url('export-records')); ?>/" + BatchId;
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/ksg/viewrecords.blade.php ENDPATH**/ ?>
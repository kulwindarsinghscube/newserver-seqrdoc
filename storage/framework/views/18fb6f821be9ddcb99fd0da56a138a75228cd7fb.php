...
<div class="container">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><i class="fa fa fa-file-excel-o"></i> LNCT Certificate
					<ol class="breadcrumb pull-right" style="background:transparent;font-size:14px;"><?php echo e(Breadcrumbs::render('generatelnctcertificates')); ?></ol>
				</h1>
        ...
        <div class="panel panel-default">
			<div class="row">
				<div class="col-lg-7"> <br />
					<form method="post" id="processExcelForm" class="form-horizontal" enctype="multipart/form-data" action="<?=route('lnct-certificate.uploadfile')?>">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<select class="form-control" id="template_id" name="template_id">
									...
									<option value="2" data-tempid="2">Hindi Degree Certificate</option>
									<option value="3" data-tempid="3">Ph.D Certificate</option>

									<option value="4" data-tempid="4">Diploma Certificate</option>
									<option value="5" data-tempid="5">Hindi Diploma Certificate</option>
				...
				<div class="col-lg-5" style="padding: 83px 1em;"> 
					<?php
						...
						$excel_url_1=$path.$subdomain[0]."/backend/sample_excel/lnct_sample.xlsx";
						$excel_url_2=$path.$subdomain[0]."/backend/sample_excel/lnct_hindi_sample.xlsx";
						$excel_url_3=$path.$subdomain[0]."/backend/sample_excel/phd_sample.xlsx";
						$excel_url_4=$path.$subdomain[0]."/backend/sample_excel/lnct_diploma_sample.xlsx";
						$excel_url_5=$path.$subdomain[0]."/backend/sample_excel/lnct_diploma_hindi_sample.xlsx";
					?>
...
function validateUpload() {
	...
	$.ajax({
		url:'<?= route('lnct-certificate.validateexcel')?>',
	    type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,
...
function uploadfile(){
	...
	$.ajax({
		url:'<?= route('lnct-certificate.uploadfile')?>',
	    type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/lnct/index.blade.php ENDPATH**/ ?>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <i class="fa fa-info-circle iconModalCss" title="User Manual" id="printingReportReportClick"></i>
                            </h1>
                        </div>
                    </div>
                    <div class="">
...
<script type="text/javascript">
    ...
    var oTable = $('#example').dataTable({
        ...
        "bServerSide": true,
        "autoWidth": true,
        "sAjaxSource": "<?php echo e(URL::route('printer-report.index')); ?>",
        "aaSorting": [
            [0, "desc"]
        ],
        "oLanguage": {
        ...
        {  
            "mData":function (o,t,v){
                ...
                console.log(o);
                <?php if ($subdomain[0]=='monad' || $subdomain[0]=='anu' || $subdomain[0]=='woxsen'){?>
                var path = path+'100/'+ o.excel_sheet_name;
                <?php }else{ ?>
                var path = path+(o.template_id ? o.template_id : 100)+'/'+ o.excel_sheet_name;
                <?php } ?>
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/printerReport/index.blade.php ENDPATH**/ ?>
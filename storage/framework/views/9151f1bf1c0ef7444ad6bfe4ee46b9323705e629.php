<?php $__env->startSection('content'); ?>	
	<div class="container">
		<h1 class="page-header"><i class="fa fa-cc-visa blue"></i>  Verification Transactions
...
<?php $__env->startSection('script'); ?>
  <script type="text/javascript">
   ...
   var oTable = $('#example').DataTable( {
        ...
        "sAjaxSource":"<?= URL::route('transactionVerification.index',['status'=>1]) ?>",
		"aoColumns":[
		/*{
          	mData: "rownum",
          	bSortable:false,
          ...
          { mData: "created_at",
           ...
           mRender:function(v)
           {
			...
			{mData: "student_key",bSortable:true,"sClass": "text-center"},	
...
$('#fail-pill').click(function(){
   ...
   var url="<?= URL::route('transactionVerification.index',['status'=>0])?>";
   oTable.ajax.url(url);
   oTable.ajax.reload();
...
$("#success-pill").click(function(event) {
	...
	var url="<?= URl::route('transactionVerification.index',['status'=>1])?>";
	oTable.ajax.url(url);
	oTable.ajax.reload();
	$('.loader').removeClass('hidden');
});
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/transaction/VerificationIndex.blade.php ENDPATH**/ ?>
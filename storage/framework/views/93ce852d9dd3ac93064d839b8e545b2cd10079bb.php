...
<div class="container">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><i class="fa fa fa-file-excel-o"></i> Generate MONAD
					<ol class="breadcrumb pull-right" style="background:transparent;font-size:14px;"><?php echo e(Breadcrumbs::render('generatemonadcertificates')); ?></ol>
				</h1>
        ...
        <div class="row">
            <div class="col-lg-7"> <br />
                <form method="post" id="processExcelForm" class="form-horizontal" enctype="multipart/form-data" action="<?=route('monad-certificate.uploadfile')?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="template_id" name="template_id">
                                ...
                                <option value="1" data-tempid="1">Basic</option>
                                <option value="2" data-tempid="2">B.Ed. 1st Year</option>
                                <option value="3" data-tempid="3">B.Ed. Final</option>
                                <option value="4" data-tempid="4">Grade Final</option>
                                <option value="5" data-tempid="5">Pharma</option>                        
                                <option value="6" data-tempid="6">Certificate</option>                        
                                <option value="7" data-tempid="7">B.El.Ed Final Year</option>    
                                 <option value="8" data-tempid="8"> BA LLB  Final SEM</option>                     
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">                        
                        <div class="col-sm-offset-3 col-sm-9">
                            <?php 
                            if($ftp_flag=="Not Connected"){ 
                                echo "<h5 class='text-danger'><strong>Failed to connect Monad server ($ftpHost). Please Check.</strong></h5>";
                            }else{ 
                            ?>                        
            ...
            <div class="col-lg-5" style="padding: 83px 1em;"> 
                <?php
                    ...
                    $excel_url_1=$path.$subdomain[0]."/backend/sample_excel/Basic Sample.xlsx";
                    $excel_url_2=$path.$subdomain[0]."/backend/sample_excel/B.Ed 1 year Sample.xlsx";
                    $excel_url_3=$path.$subdomain[0]."/backend/sample_excel/BedFinal Sample.xlsx";
                    $excel_url_4=$path.$subdomain[0]."/backend/sample_excel/FinalGrade Sample.xlsx";
                    $excel_url_5=$path.$subdomain[0]."/backend/sample_excel/Pharma Sample.xlsx";
                    $excel_url_6=$path.$subdomain[0]."/backend/sample_excel/monad-certificate.xlsx";
                    $excel_url_8=$path.$subdomain[0]."/backend/sample_excel/BaLlbFinalYear.xlsx";
                ?>
...
function validateUpload() {
	...
	$.ajax({
		url:'<?= route('monad-certificate.validateexcel')?>',
	    type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,
...
function uploadfile(startRow = 2, endRow = 2, highestRow = null) {
    ...
    $.ajax({
        url: '<?= route('monad-certificate.uploadfile') ?>',
        type: "POST",
        dataType: "JSON",
        data: fd,
        processData: false,
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/monad/index.blade.php ENDPATH**/ ?>
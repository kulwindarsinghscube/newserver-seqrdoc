...
?>
	<div class="container">
		<div class="container-fluid">
          ...
          <?php if(App\Helpers\SitePermissionCheck::isPermitted('adminmaster.create')): ?>
				  <?php if(App\Helpers\RolePermissionCheck::isPermitted('adminmaster.create')): ?>
	...
	<!-- // Admin Model  -->
	<?php echo $__env->make('admin.adminManagement.model', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;
  <!-- // End Admin Model  -->
           ...
           },	
    		{
    		  ...
    		  mRender:function(v, t, o){ 
                 ...
                 edit_path = edit_path.replace(':role_id',role_id);
                     act_html ='<?php if(App\Helpers\SitePermissionCheck::isPermitted('adminmaster.edit')): ?> <?php if(App\Helpers\RolePermissionCheck::isPermitted('adminmaster.edit')): ?><a href="'+edit_path+'"><i class="fa fa-edit fa-lg green"></i></a>&nbsp <?php endif; ?> <?php endif; ?>';
                    if(subdomain=="icat"){
                        var roleid= o['role_id'];
                        if(roleid != "1"){
                        var assign_url = "<?php echo e(route('adminmaster.AssignLab',':id')); ?>";
                        assign_url = assign_url.replace(':id',o['id']);                    
                        act_html +='<?php if(App\Helpers\SitePermissionCheck::isPermitted('adminmaster.edit')): ?> <?php if(App\Helpers\RolePermissionCheck::isPermitted('adminmaster.edit')): ?>&nbsp;&nbsp;<span title="Assign Lab" style="cursor:pointer"><a href="'+assign_url+'"><i class="fa fa-code-fork fa-lg blue"></i></a></span>&nbsp <?php endif; ?> <?php endif; ?>';
                        }
                    }
                    ...
                    if(subdomain == "ksg") {
                        var roleid = o['role_id'];
                        // if(roleid != "1"){
                        act_html += '<?php if(App\Helpers\SitePermissionCheck::isPermitted("adminmaster.edit")): ?> <?php if(App\Helpers\RolePermissionCheck::isPermitted("adminmaster.edit")): ?> &nbsp;&nbsp;' +
                                    '<span title="Assign Branch" style="cursor:pointer" class="assign-branch" data-id="'+o['id']+'">' +
                                    '<i class="fa fa-sitemap fa-lg blue"></i></span>&nbsp <?php endif; ?> <?php endif; ?>';
                        // }
                    }
					...
					if(subdomain=="sgrsa"){
						...
						var roleid= o['role_id'];
                        if(roleid == "3"){
                        var assign_url = "<?php echo e(route('adminmaster.AssignSupplier',':id')); ?>";
                        assign_url = assign_url.replace(':id',o['id']);                    
                        act_html +='<?php if(App\Helpers\SitePermissionCheck::isPermitted('adminmaster.edit')): ?> <?php if(App\Helpers\RolePermissionCheck::isPermitted('adminmaster.edit')): ?>&nbsp;&nbsp;<span title="Assign Supplier" style="cursor:pointer"><a href="'+assign_url+'"><i class="fa fa-user fa-lg blue"></i></a></span>&nbsp <?php endif; ?> <?php endif; ?>';
                        }
						if(roleid == "2"){
                        var assign_url = "<?php echo e(route('adminmaster.AssignAgent',':id')); ?>";
                        assign_url = assign_url.replace(':id',o['id']);                    
                        act_html +='<?php if(App\Helpers\SitePermissionCheck::isPermitted('adminmaster.edit')): ?> <?php if(App\Helpers\RolePermissionCheck::isPermitted('adminmaster.edit')): ?>&nbsp;&nbsp;<span title="Assign Agent & Supplier" style="cursor:pointer"><a href="'+assign_url+'"><i class="fa fa-users fa-lg green"></i></a></span>&nbsp <?php endif; ?> <?php endif; ?>';
                        }
                    }
					
                     act_html+='<?php if(App\Helpers\SitePermissionCheck::isPermitted('adminmaster.destroy')): ?> <?php if(App\Helpers\RolePermissionCheck::isPermitted('adminmaster.destroy')): ?>&nbsp;&nbsp;<a onclick="deletepath('+o['id']+')"><i class="fa fa-trash fa-lg red"></i></a><?php endif; ?> <?php endif; ?>';
                     return act_html;
    				},
    			},
...
$(document).on('click', '.assign-branch', function() {
    var id = $(this).data('id');
    $("#userId").val(id);
    var url = "<?php echo e(url('get-branch')); ?>/" + id;
    $.ajax({
            url: url,
            method: 'GET',
...
$('#assignBranchForm').on('submit', function(event) {
    ...
    var url = "<?php echo e(route('assign-branch')); ?>";
        $.ajax({
          url: url,
            method: 'POST',
            data: formData ,
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/adminManagement/index.blade.php ENDPATH**/ ?>
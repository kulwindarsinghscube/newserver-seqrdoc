...
<script type="text/javascript">
    ...
    var oTable = $('#example').dataTable({
        ...
        "bServerSide": true,
        "autoWidth": true,
        "sAjaxSource": "<?php echo e(URL::route('scan-history.index',['device_type'=>'WebApp'])); ?>",
        "aaSorting": [
            [0, "desc"]
        ],
        "oLanguage": {
	...
	oTable.on('click', '#infoData', function () {
		...
		$.ajax({
                url: "<?php echo e(URL::route('scanningHistory.show')); ?>",
                type: 'get',
                dataType:'json',
                data:{
                    key:key,
                ...
                success: function(data) {
                	...
                	if(resp != null){
						...
						var path   = resp['path'];
						// var src ="<?php echo e(asset('backend/canvas/images')); ?> "+'/'+resp['0']['path'];
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('webapp.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/webapp/scanHistory/index.blade.php ENDPATH**/ ?>
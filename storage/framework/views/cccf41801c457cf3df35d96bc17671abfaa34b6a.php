	...
	<div class="row">
		<div class="col-xs-12 col-md-6 col-md-offset-3">
			...
			<div class="list-group">
				<li class="list-group-item"><label>Username: </label> <?php echo e(Auth::guard('admin')->user()->username); ?> </li>
				<li class="list-group-item clearfix">
					...
					<?php if(App\Helpers\RolePermissionCheck::isPermitted('admin.profile.changepassword')): ?>
				...
				<li class="list-group-item"><label>Fullname: </label> <?php echo e(Auth::guard('admin')->user()->fullname); ?> </li>
				<li class="list-group-item"><label>Email ID: </label> <?php echo e(Auth::guard('admin')->user()->email); ?> </li>
				<li class="list-group-item"><label>Phone No: </label> <?php echo e(Auth::guard('admin')->user()->mobile_no); ?></li>
			</div>
		</div>
	   </div>
       ...
       // Changes password slide toggle
        ...
        $("#update_pass").click(function(event) {
		  ...
		  if (!$('.change_pass_form').valid()) 
		   ...
		   {
       	    var url="<?php echo e(URL::route('admin.profile.changepassword')); ?>";
...
<?php $__env->stopSection(); ?>	
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/profile/index.blade.php ENDPATH**/ ?>
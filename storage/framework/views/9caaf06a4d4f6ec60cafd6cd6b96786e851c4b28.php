...
<div class="container">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><i class="fa fa fa-file-excel-o"></i> Malla Reddy Certificate
					</h1>
        ...
        <div class="row">
            <div class="col-lg-7"> <br />
                <form method="post" id="processExcelForm" class="form-horizontal" enctype="multipart/form-data" action="<?=route('mallareddy-certificate.uploadfile')?>">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="template_id" name="template_id">
                                <option value="0" data-tempid="0">Select Template</option>
								                <option value="1" data-tempid="1">B.Com Computers</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="col-lg-5" style="padding: 83px 1em;"> 
                <?php
                    ...
                    $path = $protocol.'://'.$subdomain[0].'.'.$subdomain[1].'.com/';
					          ...
					          $excel_url_1=$path.$subdomain[0]."/backend/sample_excel/sample_excel_b_com_Computers.xlsx";
...
function validateUpload() {
	...
	$.ajax({
		url:'<?= route('mallareddy-certificate.validateexcel')?>',
	    type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,
...
function uploadfile(startRow = 2, endRow = 2, highestRow = null) {
    ...
    $.ajax({
		url:'<?= route('mallareddy-certificate.uploadfile')?>',
        type: "POST",
        dataType: "JSON",
        data: fd,
        processData: false,
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/mallareddy/index.blade.php ENDPATH**/ ?>
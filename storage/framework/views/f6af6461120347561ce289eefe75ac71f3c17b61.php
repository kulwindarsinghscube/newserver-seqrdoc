...
<div class="container">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><i class="fa fa fa-file-excel-o"></i>PDF Generate New
					<ol class="breadcrumb pull-right" style="background:transparent;font-size:14px;"><?php echo e(Breadcrumbs::render('generatepdf')); ?></ol>
				</h1>
...
function validateUpload() {
	...
	//var linkUrl = urlProtocol+'//'+baseUrl+'/pdf2pdf/excel_to_pdf/excel2pdf_api.php';
	var linkUrl ="https://aspose.seqrdoc.com/SSSLV2/excel2pdf_api.php";
	$.ajax({
		url:linkUrl,
	    type: "POST",
		dataType: "JSON",
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/exceltopdfnew/index.blade.php ENDPATH**/ ?>
...
<html lang="en">
    <head>
        ...
        <!-- Styles -->	
        <link href="<?php echo e(asset('manual/css/docs.css')); ?>" rel="stylesheet">
        <link href="<?php echo e(asset('manual/css/custom.css')); ?>" rel="stylesheet">
        <link rel="icon" href="<?php echo e(asset('manual/img/report.ico')); ?>">
    ...
    <body>
                ...
                <article class="col-md-11 col-sm-11 main-content" role="main">
                    ...
                    <section>
                        ...
                        <p>
                            ...
                            <a href="javascript:void(0);" file="<?php echo e(asset('manual/docs/user_mgt/login.jpg')); ?>" id="1" class="manual text-info">View</a>
                        </p>
                        <p>
                            2. Upon successfully logging into the SeQR Doc, a menu bar will appear the top side of your browser.&nbsp;
                            <a href="javascript:void(0);" file="<?php echo e(asset('manual/docs/user_mgt/dashboard.jpg')); ?>" id="3" class="manual text-info">
                                View
                            </a>
                        </p>
                        <p>
                        ...
                        <p>
                            ...
                            <ol id="master2" class="hide-object">
                                <li>
                                    ...
                                    <a href="javascript:void(0);" file="<?php echo e(asset('manual/docs/masters/qrcode.jpg')); ?>" id="10" class="manual text-info">View</a>
                                    <ul>
                                        <li>Select/Choose the image from the system that needs to be set upon the QR code.</li>
                                        <li>After an image has been selected, click on the <img src="<?php echo e(asset('manual/docs/upload_image.jpg')); ?>" /> button to upload the desired file.</li>
                                    </ul>
                                </li>
                            </ol>
                        </p>
                        ...
                        <p>
                            ...
                            <ol id="Utilities5" class="hide-object">
                                <li>
                                    ...
                                    <a href="javascript:void(0);" file="<?php echo e(asset('manual/docs/system_config/permission_management.jpg')); ?>" id="pm-1" class="manual text-info">View</a>
                                    <p>First you have to select a Role form the dropdown list to assign permissions for it.<br />You can use the checkboxes to select or unselect certain modules and press the <img src="<?php echo e(asset('manual/docs/check.jpg')); ?>" /> button to store the permissions.</p>
                                </li>
                            </ol>
                        </p>
                        <p>
                    ...
                    <section>
                        ...
                        <p>
                            ...
                            &nbsp;<a href="javascript:void(0);" file="<?php echo e(asset('manual/docs/Galgotias Degree Certificate/Galgotias Degree Certificate 1.png')); ?>" id="galgotiasDegreeCertificate1" class="manual text-info">View</a> 
                        </p>
                        <p>2. Click on the PDF sign, beside a record to generate PDF file.
                        </p>
                        <p>3. You have to upload the excel sheet and click on upload. &nbsp;<a href="javascript:void(0);" file="<?php echo e(asset('manual/docs/Galgotias Degree Certificate/Galgotias Degree Certificate 2.png')); ?>" id="galgotiasDegreeCertificate2" class="manual text-info">View</a> </p>
        ...
        <!-- END Footer -->
        <!-- Scripts -->
        <script src="<?php echo e(asset('manual/js/docs.js')); ?>"></script>
        <script src="<?php echo e(asset('manual/js/custom.js')); ?>"></script>
        <script>
...
</html><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/manual/index.blade.php ENDPATH**/ ?>
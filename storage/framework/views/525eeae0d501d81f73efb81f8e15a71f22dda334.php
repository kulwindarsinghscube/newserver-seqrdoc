<?php $__env->startSection('style'); ?>
    <link href="<?php echo e(asset('backend/canvas/css/all.css')); ?>" rel="stylesheet" type="text/css">
	<link rel="stylesheet" href="<?php echo e(asset('backend/canvas/css/custom.css')); ?>">
	<style>
	...
	<div id="wrapper">
		...
		<?= Form::open(['id'=>'template_frm','files'=>true])?>
								...
								<table class="table table-condensed">  
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<?php if(isset($TEMPLATE["actual_template_name"])): ?>
										...
										<tr id="bcDocumentDescriptionDiv" style="display: none;">
											...
											<td>
												<?php if(isset($TEMPLATE["bc_document_description"])): ?>
										...
										<tr id="bcDocumentTypeDiv" style="display: none;">
											...
											<td>
												<?php if(isset($TEMPLATE["bc_document_type"])): ?>
										...
										<!-- Rohit Changes -->
										<?php if($subdomain[0]=="demo"){ ?>
										<?php if(\Route::currentRouteName() == "template-master.edit"): ?>
			                            ...
			                            ?>
											<div class="extrafields">
												...
												<?php if($FIELDS[$fc]["security_type"] == 'Qr Code'): ?>
			...
			<div class="container">
				...
				<iframe id="myframe" src="<?php echo e(URL::route('canvasmaker.create')); ?>" style="width :710px;"></iframe>
			</div>
		</div> 
	</div>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('script'); ?>
	...
	<script type="text/javascript" src="<?php echo e(asset('backend/canvas/blockchainjs/canvas.js')); ?>"></script>
	<script type="text/javascript" src="<?php echo e(asset('backend/canvas/blockchainjs/templatestyle.js')); ?>"></script>
	<script type="text/javascript" src="<?php echo e(asset('backend/canvas/blockchainjs/extraField.js')); ?>"></script>
	<?php }else{ ?>
	<script type="text/javascript" src="<?php echo e(asset('backend/canvas/js/canvas.js')); ?>"></script>
	<script type="text/javascript" src="<?php echo e(asset('backend/canvas/js/templatestyle.js')); ?>"></script>
	<script type="text/javascript" src="<?php echo e(asset('backend/canvas/js/extraField.js')); ?>"></script>
	<?php } ?>
	<!-- End Blockchain -->

	<script type="text/javascript" src="<?php echo e(asset('backend/canvas/js/colorpicker.js')); ?>"></script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\wwwroot\demo\resources\views/admin/addtemplates/canvas.blade.php ENDPATH**/ ?>
<?php $__env->startSection('content'); ?>
    <div class="container">
        <div class="container-fluid">
            ...
            <form action="<?php echo e(route('functionalusers.exportLoginHistory')); ?>" method="GET" style="display:inline;">
                <?php echo csrf_field(); ?>
      ...
      $('#card_category').select2({
        ...
        <?php if(App\Helpers\RolePermissionCheck::isPermitted('student.upload')): ?>
            ...
            $(".save").click(function(event) {
                ...
                var url = "<?php echo e(URL::route('functionalusers.upload')); ?>";
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/functionalusers/idCardReport.blade.php ENDPATH**/ ?>
...
var table;
        ...
        table = $('#courses-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '<?php echo e(route("get.instituteStud.certificates")); ?>'
            },
            columns: [
...
<?php $__env->stopSection(); ?>	  
<?php echo $__env->make('InstituteStudentWallet.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/InstituteStudentWallet/documents/index.blade.php ENDPATH**/ ?>
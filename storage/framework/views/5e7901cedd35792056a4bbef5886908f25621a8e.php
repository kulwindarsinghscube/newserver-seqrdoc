...
$(document).ready(function(){
	...
	var oTable = $('#example').DataTable( {
        "processing": true,
        "serverSide": true,
        "sAjaxSource": "<?php echo e(URL::route('verify.pending.payments')); ?>",
        "order": [[5, 'desc']],
		"bInfo":false,
		"aoColumns": [
	...
	oTable.on('click','#infoData',function(e){
		...
		$.post("<?php echo e(URL::route('verify.pending.payments.info')); ?>",
    ...
    oTable.on('click', '#delete', function (e) {
		...
		bootbox.confirm('Are you sure to this request ?',function(result){
			if(result){
				$.ajax({
			            url: '<?php echo e(URL::route("verify.payments.remove")); ?>',
			            type: 'POST',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('verify.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/verify/pending_payment.blade.php ENDPATH**/ ?>
    ...
    <div class="container">
        <div class="container-fluid">
            ...
            <div class="row" style="margin-bottom: 1%;">
                ...
                <div class="col-md-3">
                    ...
                    <select id="card_hub" class="form-control">
                        <option value="" selected>All</option> 
                        <?php $__currentLoopData = $Hub_Name; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($hub); ?>"><?php echo e($hub); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>   
            </div>
            ...
            <form id="exportForm" action="" method="POST" style="display: none;">
                ...
                <input type="hidden" name="start_date" id="hidden_start_date" value=<?php echo e($endDate); ?>>
                <input type="hidden" name="end_date" id="hidden_end_date" value=<?php echo e($startDate); ?>>
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/functionalusers/cards_listing.blade.php ENDPATH**/ ?>
            ...
            <div class="reset-form">
                ...
                <form method="POST" action="#" id="resetForm" class="resetForm">
                    ...
                    <div class="div mb-3 mt-2">
                        ...
                        <input readonly type="text" id="prn" name="prn" class="form-control" value="<?php echo e($student->prn); ?>">
                    </div>
        ...
        $(document).ready(function() {
            $("form#resetForm").submit(function(e){
                ...
                if (!$('.resetForm').valid())
                {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('convo_student.resetPasswordUpdate')); ?>",
                        type: 'POST',
                        data: formData,
                        cache: false,
                        contentType: false,
...
<?php echo $__env->make('admin.layout.layoutnonheader', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/convodataverification/student/auth/reset_password.blade.php ENDPATH**/ ?>
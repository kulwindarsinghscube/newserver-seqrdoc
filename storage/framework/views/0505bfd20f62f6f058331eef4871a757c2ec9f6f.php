...
<div class="container"> 
    ...
    <?php endif; ?>  
<?php echo Form::open(['action' =>['admin\pdf2pdf\TemplateDataController@AssignLabSave',$id], 'method' => 'put']); ?>    
    ...
    <div class="row" style="margin-top:0 !important;">
        <div class="col-lg-11"><h4 class="htag">Template: <?php echo e($template_name); ?></h4></div>
        <div class="col-lg-1 text-center"><h4 class="htag"><a href="<?php echo e(route('pdf2pdf.templatelist')); ?>">Back</a></h4></div>
    </div>
    <div class="row">
        <div class="col-lg-5 text-center text-primary">        
            ...
            <select name="sbOne" id="sbOne" multiple size="20" class="form-control">
                <?php $__currentLoopData = $LabData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($value->id); ?>"><?php echo e($value->lab_title); ?></option>
        ...
        <div class="col-lg-5 text-center text-primary" id="selected-items">        
            ...
            <select name="sbTwo[]" id="sbTwo" multiple size="20" class="form-control">                			
                <?php $__currentLoopData = $LabDataAssigned; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($value->id); ?>"><?php echo e($value->lab_title); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>	
            </select>
        </div>
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/pdf2pdf/templateMaster/assignlab.blade.php ENDPATH**/ ?>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                ...
                                <div align="center"><b>Please Click
                                        <a class="tab_student"
                                            href="<?php echo e(asset($subdomain[0] . '/backend/convocation/sampleExcel.xlsx')); ?>"
                                            download>HERE</a>
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="<?php echo e(route('convocation.admin.upload_studentImage')); ?>" method="post" enctype="multipart/form-data" id="uploadImagesForm">
                                            <?php echo csrf_field(); ?>
                                            <div class="form-group">
            ...
            $(document).ready(function() {
                ...
                //kamini changes Start
                    ...
                    $('#verified_image_btn').on('click', function(e) {
                        e.preventDefault();
                        var baseUrl = '<?php echo e(route('convo_student.get_non_verified_student_data')); ?>';
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/convodataverification/admin/kmtc/index.blade.php ENDPATH**/ ?>
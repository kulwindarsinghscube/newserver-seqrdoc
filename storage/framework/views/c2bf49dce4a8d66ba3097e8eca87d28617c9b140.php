...
<br><div class="row">
	...
	<div class="row" style="margin: auto;border: 2px solid #dbdbdb;">
	    ...
	    <div class="card" style="margin: auto;display: none;" id="cardDownload">
			  ...
			  <ul class="list-group list-group-flush">
			    <li class="list-group-item" style="  word-wrap: break-word;"><b><a id="downloadPdf" href="<?php echo $data['pdfUrl'];?>" target="_blank">Click here to download.</a></b></li>
			  </ul>
			</div>
		</div>
...
<?php echo $__env->make('bverify.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/bverify/preview_index.blade.php ENDPATH**/ ?>
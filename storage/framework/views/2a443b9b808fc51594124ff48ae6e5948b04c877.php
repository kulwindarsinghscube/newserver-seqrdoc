...
<div class="container">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><i class="fa fa fa-file-excel-o"></i> Yuvaparivartan University
					<ol class="breadcrumb pull-right" style="background:transparent;font-size:14px;"><?php echo e(Breadcrumbs::render('generateyuvaparivartancertificates')); ?></ol>
				</h1>
        ...
        <div class="row">
            ...
            <form method="post" id="processExcelForm" class="form-horizontal" enctype="multipart/form-data" action="<?=route('yuvaparivartan-certificate.uploadfile')?>">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-9">
                      <select class="form-control" id="template_id" name="template_id">
                          ...
                          <option value="2" data-tempid="2">Certificate New Without logo</option>
                          <option value="3" data-tempid="3">Certificate New With logo</option>
                      </select>
                  </div>
              </div>
            ...
            <div class="col-lg-5" style="padding: 83px 1em;"> 
                <?php
                    ...
                    $excel_url_1=$path.$subdomain[0]."/backend/sample_excel/yuva_parivartan_certificate.xlsx";
                    $excel_url_2=$path.$subdomain[0]."/backend/sample_excel/yuva_parivartan_certificate_new.xlsx";
                    $excel_url_3=$path.$subdomain[0]."/backend/sample_excel/yuva_parivartan_certificate_new_v1.xlsx";
                ?>
...
function validateUpload() {
  ...
  var previewPdf = $('#previewPdfValue').val();
	...
	$.ajax({
		url:'<?= route('yuvaparivartan-certificate.validateexcel')?>',
	    type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,
...
function olduploadfile(){
	...
	$.ajax({
		url:'<?= route('yuvaparivartan-certificate.uploadfile')?>',
	    type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/yuvaparivartan/index.blade.php ENDPATH**/ ?>
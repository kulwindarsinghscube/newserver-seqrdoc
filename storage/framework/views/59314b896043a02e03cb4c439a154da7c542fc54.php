...
Request for educational details verification of <b><?php echo e($user_data['student_name']); ?></b> is received to us. Institute will convey you the verification details within 24 hours.<br>
Your request number is <b><?php echo e($user_data['key']); ?></b>. Remember this number for our future communication references.
<br><br/>
...
<table style='margin: auto;border: 1px solid #000;border-collapse: collapse;'>
	...
	<td style='border: 1px solid black;padding: 15px;'><?php echo e($user_data['student_institute']); ?></td>
	</tr>
	<tr>
	...
	<td style='border: 1px solid black;padding: 15px;'><?php echo e($user_data['student_degree']); ?></td>
	</tr>
	<tr>
	<td style='border: 1px solid black;padding: 15px;'>Branch</td>
	<td style='border: 1px solid black;padding: 15px;'><?php echo e($user_data['student_branch']); ?></td>
	</tr>
	<tr>
	<td style='border: 1px solid black;padding: 15px;'>Registration Number</td>
	<td style='border: 1px solid black;padding: 15px;'><?php echo e($user_data['student_reg_no']); ?></td>
	</tr>
	<tr>
	...
	<td style='border: 1px solid black;padding: 15px;'><?php echo e($user_data['date_time_registraion']); ?></td>
	</tr>
</table><br/><br/>
Document Details:<br/>
<table style='margin: auto;border: 1px solid #000;border-collapse: collapse;'>
	...
	<td style='border: 1px solid black;padding: 15px;'><?php echo e($user_data['grade_card_amount']); ?> RS</td>
	</tr>
	<tr>
	...
	<td style='border: 1px solid black;padding: 15px;'><?php echo e($user_data['provisional_degree_amount']); ?> RS</td>
	</tr>
	<tr>
	...
	<td style='border: 1px solid black;padding: 15px;'><?php echo e($user_data['original_degree_amount']); ?> RS</td>
	</tr>
	<tr>
	...
	<td style='border: 1px solid black;padding: 15px;'><?php echo e($user_data['marksheet_amount']); ?> RS</td>
	</tr>
</table><br/><br/>
...
<table style='margin: auto;border: 1px solid #000;border-collapse: collapse;'>
	...
	<td style='border: 1px solid black;padding: 15px;'><?php echo e($user_data['trans_id']); ?></td>
	</tr>
	<tr>
	...
	<tr>
	<td style='border: 1px solid black;padding: 15px;'>Date & Time</td>
	<td style='border: 1px solid black;padding: 15px;'><?php echo e($user_data['date']); ?></td>
	</tr>
</table>
<br/><br/>In case response not received within 24 hours, you can contact us on deanstudents.ghrce@raisoni.net, registrar_ghrce@raisoni.net, principal.ghrce@raisoni.net or call us on +91-9604787184, +91-9689903286. <br/><br/><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/mail/verify/transaction.blade.php ENDPATH**/ ?>
            ...
            <div class="login-bg clearfix">
                ...
                <div class="tab-content">
                    <div id="" class="tab-pane fade in active text-center">
                        ...
                        <a href="<?php echo e(url('/')); ?>" class="btn btn-danger">Resend Password Reset Link</a>
                    </div>
                </div>
            </div>
        </div>
...
</script><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/auth/password_reset_expiry.blade.php ENDPATH**/ ?>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				...
				<ol class="breadcrumb pull-right" style="background:transparent;font-size:14px;"><?php echo e(Breadcrumbs::render('setting')); ?></ol>
		...
		<form method="post" id="printing_template"  autocomplete="off">
			...
			<input type="hidden" name="id" value="<?php echo e($systemConfig['id']); ?>"> 
			...
			<!-- <div class="panel panel-primary" style="margin: 0 auto; width: 800px;"> -->
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="printer_name" name="printer_name" value="<?php echo e($systemConfig['printer_name']); ?>">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="smtp" name="smtp" placeholder="Please enter smtp" value="<?php echo e($systemConfig['smtp']); ?>">
						<span id="smtp_error" class="help-inline text-danger"></span>
					</div>
					<div class="form-group">
						<label for="Port">Port</label>
						<input type="text" class="form-control allow_number" id="port" name="port" placeholder="Please enter port" value="<?php echo e($systemConfig['port']); ?>" maxlength="6">
						<span id="port_error" class="help-inline text-danger"></span>
					</div>
					<div class="form-group">
						<label for="Sender Email Id">Sender Email Id</label>
						<input type="text" class="form-control" id="sender_email" name="sender_email" placeholder="Please enter sender email" value="<?php echo e($systemConfig['sender_email']); ?>">
						 <span id="sender_email_error" class="help-inline text-danger"></span>
					</div>
					<div class="form-group">
						<label for="text">Password</label>
						<input type="password" class="form-control" id="password" name="password" placeholder="Please enter password" value="<?php echo e($systemConfig['password']); ?>">
          ...
          <input type="hidden" id="file_aws_local_value" name="file_aws_local" value="<?php 
					...
					<div class="form-group clearfix tmpl">
						<?php if(App\Helpers\SitePermissionCheck::isPermitted('systemconfig.store')): ?>
						<?php if(App\Helpers\RolePermissionCheck::isPermitted('systemconfig.store')): ?>
        ...
        <div class="panel-body">
          <div class="col-lg-6">
            <div class="form-group">
                ...
                <span><?php echo e($site_data['start_date']); ?></span>
            </div>
            <div class="form-group">
                <label>Last Date :</label>
                <span><?php echo e($site_data['end_date']); ?></span>
            </div>
          </div>
          <div class="col-lg-6">
            <div class="form-group">
                <label>License key :</label>
                <span><?php echo e($site_data['license_key']); ?></span>
            </div>
            <div class="form-group">
                <label>Printed Document Left :</label>
                <span><?php echo e($printing_value['value'] - $printing_value['current_value']); ?></span>
            </div>
          </div>
        </div>
      </div>
...
<?php $__env->startSection('script'); ?>
 ...
 $(document).ready(function() {
       ...
       $('#time_zone').val("<?php echo e($systemConfig['timezone']); ?>");    	 
       	if ($('#time_zone').val() == undefined){
			
			$('#time_zone').val('Asia/Kolkata');
		}
	  $("#print_color").val("<?php echo e($systemConfig['print_color']); ?>");
       ...
       var url="<?php echo e(URL::route('systemconfig.store')); ?>";
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/systemSetting/index.blade.php ENDPATH**/ ?>
<?php $__env->startSection('content'); ?>
    <div class="container">
    	<div class="container-fluid">
    		<div class="row">
    			<div class="col-lg-12">
    				...
    				<ol class="breadcrumb pull-right" style="background:transparent;font-size:14px;"><?php echo e(Breadcrumbs::render('degreemasterpage')); ?></ol>
    	...
    	<div class="">
            ...
            <?php if(App\Helpers\SitePermissionCheck::isPermitted('degreemaster.store')): ?>
            <?php if(App\Helpers\RolePermissionCheck::isPermitted('degreemaster.store')): ?>
 ...
 <?php echo $__env->make('admin.raisoni.degreemaster.model', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
          ...
          },
          {
            ...
            mRender:function(v, t, o){
                var act_html;
                     ...
                     act_html ='<?php if(App\Helpers\SitePermissionCheck::isPermitted('degreemaster.edit')): ?> <?php if(App\Helpers\RolePermissionCheck::isPermitted('degreemaster.edit')): ?><a onclick="edit('+o['id']+')"><i class="fa fa-edit fa-lg green"></i></a><?php endif; ?> <?php endif; ?>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/raisoni/degreemaster/index.blade.php ENDPATH**/ ?>
...
<head>
    ...
    <!-- MetisMenu CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('backend/css/metisMenu.min.css')); ?>">
...
?>
			...
			<h2>
				...
				<?php if ($subdomain[0] == "monad") {?>
				<a href="https://play.google.com/store/apps/details?id=com.monad_seqr" target="_blank"><img src="<?php echo e(asset('backend/gplay.png')); ?>"/></a>
				<a href="https://apps.apple.com/in/app/monad-seqr-scan/id1597741035" target="_blank"><img src="<?php echo e(asset('backend/store.png')); ?>" /></a>
			<?php } else {?>
				<a href="https://play.google.com/store/apps/details?id=com.raisoni" target="_blank"><img src="<?php echo e(asset('backend/gplay.png')); ?>"/></a>
				<a href="https://apps.apple.com/us/app/raisoni-group/id1468248125?ls=1" target="_blank"><img src="<?php echo e(asset('backend/store.png')); ?>" /></a>
			<?php }?>
			</h2>
			</div>
		</div>
...
<script src="<?php echo e(asset('backend/canvas/js/canvas.js')); ?>"></script>
...
$(document).ready(function(){
	...
	$.ajax({
        url: "<?php echo e(url('/verify/raisoni-degree-master')); ?>",
        type: 'POST',
        dataType:'json',
        data :{_token:token},
    ...
    $("#student_degree").change(function(){
		...
		$.ajax({
	        url: "<?php echo e(url('/verify/raisoni-branch-master')); ?>",
	        type: 'POST',
	...
	$("form#signupform").submit(function(e){
		...
		if (!$('.signupform').valid())
		{
			...
			$.ajax({
	            url: "<?php echo e(url('/verify/raisoni-registration')); ?>",
	            type: 'POST',
	            data: formData,
	            dataType:'JSON',
	            cache: false,
...
$('#verification_type').val(data.verification_type);
	...
	$("form#verificationform").submit(function(e){
		...
		if (!$('.verificationform').valid())
		{
	      ...
	      $('#otpError').show();
			...
			var formData = new FormData($(this)[0]);
			$.ajax({
	            url: "<?php echo e(url('/verify/verification')); ?>",
	            type: 'POST',
	            data: formData,
	            dataType:'JSON',
	            cache: false,
	...
	$("#resend-otp-btn").click(function() {
		 var token = "<?php echo e(csrf_token()); ?>";
	      $.ajax({
		        url: "<?php echo e(url('/verify/resend-otp')); ?>",
		        type: 'POST',
		        dataType:'json',
	...
	$("form#forgotpasswordform").submit(function(e){
		...
		if (!$('.forgotpasswordform').valid())
		{
			...
			var formData = new FormData($(this)[0]);
			$.ajax({
	            url: "<?php echo e(url('/verify/forgot-password')); ?>",
	            type: 'POST',
	            data: formData,
	            success: function (data) {
	                if(data.status == true){
...
</script><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/verify/auth.blade.php ENDPATH**/ ?>
	...
	<div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-7"> <br />
                <form method="post" id="processExcelForm" class="form-horizontal" enctype="multipart/form-data" action="<?=route('sdm-resit.uploadfile')?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="template_id" name="template_id">
                                ...
                                <option value="6" data-tempid="6">MPT I (RESIT)</option>
                                <option value="1" data-tempid="1">MPT II (RESIT)</option>
                                <option value="5" data-tempid="5">BPT (RESIT)</option>
                                <option value="3" data-tempid="3">BDS (RESIT)</option>
                                <option value="7" data-tempid="7">Nursing (RESIT)</option>
                                <option value="11" data-tempid="11">M.Sc. (RESIT)</option>
                                <option value="13" data-tempid="13">M.Sc. III (RESIT)</option>
                                <option value="12" data-tempid="12">B.Sc.(I II III IV)Year  (RESIT)</option>
                                <option value="15" data-tempid="15">MDS Part I (RESIT)</option>
                                <option value="14" data-tempid="14">MDS Part II (RESIT)</option>
                                
                                <option value="19" data-tempid="19">MBBS PRFESSIONAL I &amp; II (RESIT)</option>
                                <option value="23" data-tempid="23">MBBS PRFESSIONAL I &amp; II (RESIT) - 40-60</option>
                                ...
                                <option value="24" data-tempid="24">MBBS THIRD PROFESSIONAL PART I (RESIT)</option>
                                <option value="25" data-tempid="25">MBBS THIRD PROFESSIONAL PART II (RESIT)</option>
                                <option value="26" data-tempid="26">BSC Allied (RESIT)</option>
                                <option value="28" data-tempid="28">BSC Allied - No VIVA  (RESIT)</option>
                                <option value="27" data-tempid="27">MBBS 3rd PROFESSIONAL - PART I (3 Subjects) (RESIT)</option>
            ...
            <div class="col-lg-5" style="padding: 83px 1em;"> 
                <?php
					...
					$excel_url_24=$path.$subdomain[0]."/backend/sample_excel/MBBS_THIRD_PROFESSIONAL_PART_I_(RESIT).xlsx";
					$excel_url_25=$path.$subdomain[0]."/backend/sample_excel/MBBS_THIRD_PROFESSIONAL_PART_II_(RESIT).xlsx";
                    ...
                    $excel_url_28=$path.$subdomain[0]."/backend/sample_excel/BSCAllied.xlsx";
                ?>
				...
				<span style="display:none;" id="excel_url_23"><b>Please Click <a href="<?php echo e($excel_url_21); ?>" download>HERE</a> To Download Sample Excel</b></span>
...
function validateUpload() {
	...
	$.ajax({
		url:'<?= route('sdm-resit.validateexcel')?>',
	    type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,
...
function uploadfile(startRow = 2, endRow = 2, highestRow = null) {
    ...
    $.ajax({
		url:'<?= route('sdm-resit.uploadfile')?>',
        type: "POST",
        dataType: "JSON",
        data: fd,
        processData: false,
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/sdm/index-resit.blade.php ENDPATH**/ ?>
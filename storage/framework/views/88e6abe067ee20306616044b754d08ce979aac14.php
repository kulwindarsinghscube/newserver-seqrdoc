...
<div class="container">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><i class="fa fa fa-file-excel-o"></i>Generate BMCC Passing Certificate
					<ol class="breadcrumb pull-right" style="background:transparent;font-size:14px;"><?php echo e(Breadcrumbs::render('generatebmccpassingcertificates')); ?></ol>
				</h1>
		...
		<form method="post" id="processExcelForm" class="form-horizontal" enctype="multipart/form-data" action="<?=route('bmcc-certificate.uploadfilePassing')?>">
			...
			<div class="form-group">
		  	...
		  	<div class="form-group"> 
		    	<div class="col-sm-offset-2 col-sm-10">
        			...
        			?>
		    		<!-- <div align="center"><b>Please Click <a href="<?php echo e(asset('backend/processExcel/sampleExcel.xlsx')); ?>" download>HERE</a> To Download Sample Excel</b></div> -->
...
function validateUpload() {
	...
	$.ajax({
		url:'<?= route('bmcc-certificate.validateexcelPassing')?>',
	    type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,
...
function uploadfile(){
	...
	fd.append('_token',token);
	$.ajax({
		url:'<?= route('bmcc-certificate.uploadfilePassing')?>',
	    type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/statementsofmarks/passing.blade.php ENDPATH**/ ?>
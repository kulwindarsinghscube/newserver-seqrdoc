<?php $__env->startSection('content'); ?>
    	...
    	<div class="container-fluid">
    		<div class="row">
    			<div class="col-lg-12">
    				...
    				<ol class="breadcrumb pull-right" style="background:transparent;font-size:14px;"><?php echo e(Breadcrumbs::render('paymentgateway_new')); ?></ol>
    	  ...
    	  <div class="">
            ...
            <?php if(App\Helpers\SitePermissionCheck::isPermitted('pgmaster_new.store')): ?>
            <?php if(App\Helpers\RolePermissionCheck::isPermitted('pgmaster_new.store')): ?>
 ...
 <?php echo $__env->make('admin.paymentGatewayNew.model', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        "aoColumns":[
          ...
          {mData: "pg_title",bSortable:true},
          {
            ...
            mRender:function(v, t, o){
                var act_html;
                act_html ='<?php if(App\Helpers\SitePermissionCheck::isPermitted('pgmaster_new.edit')): ?> <?php if(App\Helpers\RolePermissionCheck::isPermitted('pgmaster_new.edit')): ?><a onclick="edit('+o['id']+')"><i class="fa fa-edit fa-lg green"></i></a><?php endif; ?> <?php endif; ?>';
                act_html +='<?php if(App\Helpers\SitePermissionCheck::isPermitted('pgmaster_new.destroy')): ?> <?php if(App\Helpers\RolePermissionCheck::isPermitted('pgmaster_new.destroy')): ?>&nbsp;&nbsp;<a onclick="deletepath('+o['id']+')"><i class="fa fa-trash fa-lg red"></i></a><?php endif; ?> <?php endif; ?>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/paymentGatewayNew/index.blade.php ENDPATH**/ ?>
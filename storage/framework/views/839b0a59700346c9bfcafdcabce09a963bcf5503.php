...
<div class="container">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><i class="fa fa fa-file-excel-o"></i> East Point
        ...
        <div class="row">
            <div class="col-lg-7"> <br />
               <form method="post" id="processExcelForm" class="form-horizontal" enctype="multipart/form-data" action="<?=route('eastpoint-certificate.uploadfile')?>">
...
<!-- Message below toggle, centered -->
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                   <!-- Toggle message above the dropdown -->
        <div id="previewMessage" style="font-weight: bold; display: none; margin-bottom: 5px;">
            <span id="previewText"></span>
        </div>
                    <select class="form-control" id="template_id" name="template_id">
                        <option value="0" data-tempid="0">Select Template</option>
                        <option value="1" data-tempid="1">Semester Grade Card Report</option>
                         <option value="2" data-tempid="2">Semester Grade Card Report New</option>
                    </select>
                </div>
            </div>
            ...
            <div class="col-lg-5" style="padding: 83px 1em;"> 
                <?php
                    ...
                    $excel_url_1=$path.$subdomain[0]."/backend/sample_excel/Final EPCET Grade card Data.xlsx";
                    $excel_url_2=$path.$subdomain[0]."/backend/sample_excel/BECV1_MARKS CARD DATA.xlsx";
...
$.ajax({
    ...
    function updatePreviewMessage() {
        ...
        if(value == 1){
            $('#previewMessage').text('Generating preview pdf.').css('color', 'red').show();
        } else {
            $('#previewMessage').text('Generating live pdf.').css('color', 'green').show();
        }
    }
    ...
    // Set default to 'on' and show red message
    $('#previewPdfValue').val(1); // Default state is 'on'
    updatePreviewMessage();      // Show message on page load
...
function validateUpload() {
	...
	$.ajax({
		url:'<?= route('eastpoint-certificate.validateexcel')?>',
	    type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,
...
function uploadfile(startRow = 2, endRow = 2, highestRow = null) {
    ...
    $.ajax({
        url: '<?= route('eastpoint-certificate.uploadfile') ?>',
        type: "POST",
        dataType: "JSON",
        data: fd,
        processData: false,
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/eastpoint/index.blade.php ENDPATH**/ ?>
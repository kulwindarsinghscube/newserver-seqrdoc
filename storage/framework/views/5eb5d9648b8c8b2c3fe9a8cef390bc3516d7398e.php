...
<div class="container">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><i class="fa fa fa-file-excel-o"></i> BESTIU E Document
        ...
        <div class="row">
            <div class="col-lg-7"> <br />
                <form method="post" id="processExcelForm" class="form-horizontal" enctype="multipart/form-data" action="<?=route('bestiu-e-document.uploadfile')?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select class="form-control" id="template_id" name="template_id">
                                ...
                                <option value="1" data-tempid="1">Grade Card (1 or 2 or 3 semester)</option>
                                <option value="2" data-tempid="2">Transcript (1 or 1&2 or 1&2&3 semesters)</option>
                                <option value="3" data-tempid="3">Transcript (1  semesters)</option>
                                 <option value="4" data-tempid="4">Transcript ( 1&2  semesters)</option>
                                 <option value="5" data-tempid="5">Transcript (four-semesters)</option>
                                 <option value="6" data-tempid="6">Transcript (six-semesters)</option>
                                 <option value="7" data-tempid="7">Transcript (eight-semesters)</option>
                                 <option value="8" data-tempid="8">Degree Certificates</option>
                            </select>
                        </div>
                    </div>
                    <!-- placeholder where child dropdown will be appended -->
                    <div class="form-group" id="subjects_block" style="display:none;">
                        <label class="control-label col-sm-4" for="temp">Subjects:</label>
                     <div class="col-sm-8"> 
            ...
            <div class="col-lg-5" style="padding: 83px 1em;"> 
                <?php
                    ...
                    $excel_url_1=$path.$subdomain[0]."/backend/sample_excel/GRADE_CARD_document_sample_excel.xlsx";
                    $excel_url_2=$path.$subdomain[0]."/backend/sample_excel/transcript_document_sample_excel.xlsx";
                    $excel_url_3=$path.$subdomain[0]."/backend/sample_excel/transcript_document_sample_excel.xlsx";
                    $excel_url_4=$path.$subdomain[0]."/backend/sample_excel/2semester transcript.xlsx";
                    // $excel_url_4=$path.$subdomain[0]."/backend/sample_excel/transcript_document_sample_excel.xlsx";
                    // $excel_url_5=$path.$subdomain[0]."/backend/sample_excel/4sems_12subjects_transcript_document_sample_excel.xlsx";
                    $excel_url_5_6=$path.$subdomain[0]."/backend/sample_excel/4sems_6subjects_transcript_document_sample_excel.xlsx";
                    $excel_url_5_8=$path.$subdomain[0]."/backend/sample_excel/4sems_8subjects_transcript_document_sample_excel.xlsx";
                    $excel_url_5_10=$path.$subdomain[0]."/backend/sample_excel/4sems_10subjects_transcript_document_sample_excel.xlsx";
                    $excel_url_5_12=$path.$subdomain[0]."/backend/sample_excel/4sems_12subjects_transcript_document_sample_excel.xlsx";
                    $excel_url_6_8=$path.$subdomain[0]."/backend/sample_excel/6sems_8subjects_transcript_document_sample_excel.xlsx";
                    $excel_url_6_10=$path.$subdomain[0]."/backend/sample_excel/6sems_10subjects_transcript_document_sample_excel.xlsx";
                    $excel_url_6_12=$path.$subdomain[0]."/backend/sample_excel/6sems_12subjects_transcript_document_sample_excel.xlsx";
                    $excel_url_7=$path.$subdomain[0]."/backend/sample_excel/8sems_transcript_document_sample_excel.xlsx";
                    $excel_url_8=$path.$subdomain[0]."/backend/sample_excel/DMT_1.xlsx";
                ...
                <span style="display:none;" id="excel_url_5_6"><b>Please Click <a href="<?php echo e($excel_url_5_6); ?>" download>HERE</a> To Download Sample Excel</b></span>
                <span style="display:none;" id="excel_url_5_8"><b>Please Click <a href="<?php echo e($excel_url_5_8); ?>" download>HERE</a> To Download Sample Excel</b></span>
                <span style="display:none;" id="excel_url_5_10"><b>Please Click <a href="<?php echo e($excel_url_5_10); ?>" download>HERE</a> To Download Sample Excel</b></span>
                <span style="display:none;" id="excel_url_5_12"><b>Please Click <a href="<?php echo e($excel_url_5_12); ?>" download>HERE</a> To Download Sample Excel</b></span>
                <span style="display:none;" id="excel_url_6_8"><b>Please Click <a href="<?php echo e($excel_url_6_8); ?>" download>HERE</a> To Download Sample Excel</b></span> 
                <span style="display:none;" id="excel_url_6_10"><b>Please Click <a href="<?php echo e($excel_url_6_10); ?>" download>HERE</a> To Download Sample Excel</b></span> 
                <span style="display:none;" id="excel_url_6_12"><b>Please Click <a href="<?php echo e($excel_url_6_12); ?>" download>HERE</a> To Download Sample Excel</b></span> 
...
function validateUpload() {
	...
	$.ajax({
		url:'<?= route('bestiu-e-document.validateexcel')?>',
	    type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,
...
// 	$.ajax({
// 		url:'<?= route('bestiu-e-document.uploadfile')?>',
// 	    type: "POST",
// 		dataType: "JSON",
// 		data:fd,
// 		processData: false,
...
// Combine into a string: YYYY-MM-DD HH:MM:SS
...
function uploadfile(startRow = 2, endRow = 2, highestRow = null) {
    ...
    fd.append('record_textfile', formattedDateTime+'.txt');
    $.ajax({
        url: '<?= route('bestiu-e-document.uploadfile') ?>',
        type: "POST",
        dataType: "JSON",
...
$(document).on('change', '#child', function() {
  let parent=$('#template_id').find(':selected').data('tempid');
  let child=$(this).find(':selected').val();
  if(parent==5){
  let childs = [6,8,10,12];
    $("#excel_url_"+parent+"_"+child).show();
    childs.forEach(function(num) {
        if(num!=child){
          $("#excel_url_"+parent+"_"+num).hide();  
        }
    });
  }else if(parent==6){
  let childs = [8,10,12];
    ...
    $("#excel_url_"+parent+"_"+child).hide();
  }  
});
$('#template_id').change(function(){
    ...
    let childs = [6,8,10,12];
        childs.forEach(function(num) {
         $("#excel_url_5_"+num).hide();  
         $("#excel_url_6_"+num).hide();  
        });
    if(tempid=="0"||tempid=="5"||tempid=="6"){
        for (let i = 1; i <= 14; i++) {
          $("#excel_url_"+i).hide();
        }             
    }else{
...
$(document).ready(function () {
    $("#template_id").change(function () {
        ...
        $("#subjects_block").hide();
        // Clear previous child dropdown
        $("#child-container").empty();

        // If specific value (say 'fruits') is selected, append another dropdown
        if (selected === "5") {
            var childDropdown = `
                <select name="subjects" class="form-control" id="child">
            ...
            `;
            $("#subjects_block").show();
            $("#child-container").append(childDropdown);
        }

        // Another example for "vehicles"
        if (selected === "6") {
            var childDropdown = `
                <select name="subjects" class="form-control" id="child">
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/bestiu/e_document_index.blade.php ENDPATH**/ ?>
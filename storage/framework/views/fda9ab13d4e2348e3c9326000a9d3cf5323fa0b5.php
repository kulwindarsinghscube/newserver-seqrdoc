...
<div class="container">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><i class="fa fa fa-file-excel-o"></i> KMTC Documents
					<ol class="breadcrumb pull-right" style="background:transparent;font-size:14px;"><?php echo e(Breadcrumbs::render('generatekmtccertificates')); ?></ol>
				</h1>
        ...
        <div class="row">
            <div class="col-lg-7"> <br />
                <form method="post" id="processExcelForm" class="form-horizontal" enctype="multipart/form-data" action="<?=route('kmtc-certificate.uploadfile')?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="template_id" name="template_id">
                                ...
                                <option value="1" data-tempid="1">1 Year</option>
                                <option value="2" data-tempid="2">2 Year</option>-->
                                <option value="3" data-tempid="3" selected>Transcript</option>                  
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="col-lg-5" style="padding: 83px 1em;"> 
                <?php
                    ...
                    $excel_url_1=$path.$subdomain[0]."/backend/sample excel/Sample.xlsx";
                    $excel_url_2=$path.$subdomain[0]."/backend/sample excel/Sample.xlsx";
                    $excel_url_3=$path.$subdomain[0]."/backend/sample excel/Transcripts Excel.xlsx";
                ?>
                     
                <span style="display:none;" id="excel_url_1"><b></b></span>
                <span style="display:none;" id="excel_url_2"><b></b></span>
                <span style="display:block;" id="excel_url_3"><b>Please Click <a href="<?php echo e($excel_url_3); ?>" download>HERE</a> To Download Sample Excel</b></span>
...
function validateUpload() {
	...
	$.ajax({
		url:'<?= route('kmtc-certificate.validateexcel')?>',
	    type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,
...
function uploadfile(){
	...
	fd.append('_token',token);
	$.ajax({
		url:'<?= route('kmtc-certificate.uploadfile')?>',
	    type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/kmtc/index.blade.php ENDPATH**/ ?>
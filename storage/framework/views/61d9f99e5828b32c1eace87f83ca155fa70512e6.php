...
<head>
	...
	<link rel="stylesheet" href="<?php echo e(asset('pdf2pdf/bootstrap.css')); ?>">
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/prettify/r298/prettify.min.css">
	<link rel="stylesheet" href="<?php echo e(asset('pdf2pdf/pdf_styles.css')); ?>">
	<link rel="stylesheet" href="<?php echo e(asset('pdf2pdf/pdfannotate.css')); ?>">
...
<div class="row">    
    ...
    <div class="col-lg-3 mt-3 p-5"> 
        <div class="overflow-auto" style="position: fixed; left:75%; right: 35px;z-index:9999;overflow-x:hidden;height:85%;">
            ...
            <?php if($subdomain[0] == "po"){ ?>
            <div class="mb-3 d-flex align-items-center">
                <label class="form-label  mr-2 me-4 mb-0" style="color: var(--yellow);">Verification Type</label>
                <div class="form-check form-check-inline">
                  <input 
                    class="form-check-input verification_type" 
                    type="radio" 
                    name="verification_type" 
                    id="pdf-option" 
                    value="0" <?php if(@$template_data['verification_type'] == '0' || !isset($template_data['verification_type'])): ?> checked <?php endif; ?>>
                  <label class="form-check-label" style="color: var(--orange);" for="pdf-option">PDF</label>
                </div>
                <div class="form-check form-check-inline">
                  <input 
                    class="form-check-input verification_type" 
                    ...
                    name="verification_type" 
                    id="text-option" 
                    value="1" <?php if(@$template_data['verification_type'] == '1'  ): ?> checked <?php endif; ?>>
                  <label class="form-check-label" for="text-option" style="color: var(--orange);">Text</label>
                </div>
            </div>
            <?php } ?>
        ...
        <!--<div class="row" style="margin-bottom: -10px !important;">
            ...
            <div id="extractor_elements" style="display:none;">
                ...
                <?php if($subdomain[0] == "po"){ ?>
                <div class="text-white" id="verification_text_show_div" style=" border-top: 1px solid #fff; padding-top: 5px;margin-top: 5px;display:flex;flex-wrap:wrap;-webkit-box-align:stretch; align-items:stretch; width:100%;">
                          <input type="checkbox" value="use" id="verification_text_show" onclick="changeQrMetaDataPlace()" style="width: 20px;" />&nbsp;Use For Text Verification Metadata
                          <input type="text" id="verification_text_label" class="form-control input-sm" placeholder="Enter Metadata Label" autocomplete="off" style="display:none;"  title="Enter Text Verification Metadata Label" onkeyup="changeQrPlacerMetaLabel()"/> 
                          <input type="text" id="verification_text_value" class="form-control input-sm" placeholder="Enter Metadata Value" autocomplete="off" style="display:none;clear:both;margin-top:8px;"  title="Enter Text Verification Metadata Value" onkeyup="changeQrPlacerMetaValue()" /> 
                </div>
                <?php } ?>
...
<img src="../pdf2pdf/images/preview_icon.png" width="31" height="31" id="pdf_preview" title="Preview">
...
<script>
    ...
    var config = {
        routes: {
            ...
            pdfPreview: "<?=route('pdf2pdf.pdfPreview')?>"
        },
...
<script src="<?php echo e(asset('pdf2pdf/arrow.fabric.js')); ?>"></script>
<script src="<?php echo e(asset('pdf2pdf/pdfannotate.js')); ?>"></script>
<script src="<?php echo e(asset('pdf2pdf/script.js?1234')); ?>"></script>
...
<script type="text/javascript" src="<?php echo e(asset('pdf2pdf/RulersGuides/RulersGuides.js')); ?>"></script>
<script src="<?php echo e(asset('pdf2pdf/fitz_colours.js')); ?>"></script>
<script type="text/javascript">
var evt     = new Event(),
dragdrop    = new Dragdrop(evt),
rg          = new RulersGuides(evt, dragdrop);
</script>
<script src="<?php echo e(asset('pdf2pdf/bootstrap/jquery.validate.js')); ?>"></script>
<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
</body>
</html>
<?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/pdf2pdf/addtemplate/index.blade.php ENDPATH**/ ?>
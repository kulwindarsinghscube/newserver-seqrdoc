...
padding: 10px;font-size: 17px; display:none ;">
    ...
    <script>
        const fileHashInstances = <?php echo json_encode(\Config::get('constant.fileHashInstances'), 15, 512) ?>;
        const currentSubdomain = "<?php echo e($subdomain[0]); ?>";
    </script>
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                         ...
                         //   console.log(response.response.pinataIpfsHash);
                            ...
                            //if (subdomain[0] == 'anu') {
                            //    formDataNew.append("pdfData", response.response);
                            ...
                            if (fileHashInstances.includes(subdomain[0])) {
                                formDataNew.append("pdfData", response.response);
                                console.log(response.response);
                            } else {
                                formDataNew.append("pdfData", response.response.pinataIpfsHash);
...
</html><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/bverify.blade.php ENDPATH**/ ?>
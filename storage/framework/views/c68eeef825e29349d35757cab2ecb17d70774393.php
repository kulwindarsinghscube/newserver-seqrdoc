...
<div class="container">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><i class="fa fa fa-file-excel-o"></i> Aiims
        ...
        <div class="row">
            <div class="col-lg-7"> <br />
                <form method="post" id="processExcelForm" class="form-horizontal" enctype="multipart/form-data" action="<?=route('aiims-certificate.uploadfile')?>">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="template_id" name="template_id">
                                <option value="0" data-tempid="0">Select Template</option>
								                <option value="1" data-tempid="1">Provisional Degree Certificate -PG</option>
								                <option value="4" data-tempid="4">Provisional Degree Certificate -MBBS</option>
								                <option value="2" data-tempid="2">MBBS Passing Certificate</option>
								                <option value="3" data-tempid="3">Character Certificate</option>
								                <option value="5" data-tempid="5">Experience Certificate</option>
								                <option value="6" data-tempid="6">Internship Certificate</option>
								                <option value="7" data-tempid="7">Migration Certificate</option>
								                <option value="8" data-tempid="8">Bonafide Certificate</option>
                                <option value="9" data-tempid="9">MBBS Certificate for convocation</option>
                                <option value="10" data-tempid="10">MD Certificate for convocation</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="col-lg-5" style="padding: 83px 1em;"> 
                <?php
                    ...
                    $path = $protocol.'://'.$subdomain[0].'.'.$subdomain[1].'.com/';
					          ...
					          $excel_url_1=$path.$subdomain[0]."/backend/sample_excel/aiims_provisional_certificate.xlsx";
					          $excel_url_2=$path.$subdomain[0]."/backend/sample_excel/aiims_mbbs_certificate.xlsx";
					          $excel_url_3=$path.$subdomain[0]."/backend/sample_excel/aiims_character_certificate.xlsx";
					          $excel_url_4=$path.$subdomain[0]."/backend/sample_excel/aiims_provisional_mbbs_certificate.xlsx";
					          $excel_url_5=$path.$subdomain[0]."/backend/sample_excel/aiims_experience_certificate.xlsx";
					          $excel_url_6=$path.$subdomain[0]."/backend/sample_excel/aiims_internship_certificate.xlsx";
					          $excel_url_7=$path.$subdomain[0]."/backend/sample_excel/aiims_migration_certificate.xlsx";
					          $excel_url_8=$path.$subdomain[0]."/backend/sample_excel/aiims_bonafide_certificate.xlsx";
                    $excel_url_9=$path.$subdomain[0]."/backend/sample_excel/aiims_mbbs_convocation_certificate.xlsx";
                    $excel_url_10=$path.$subdomain[0]."/backend/sample_excel/aiims_md_convocation_certificate.xlsx";
...
function validateUpload() {
	...
	$.ajax({
		url:'<?= route('aiims-certificate.validateexcel')?>',
	    type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,
...
function uploadfile(startRow = 2, endRow = 2, highestRow = null) {
    ...
    $.ajax({
		url:'<?= route('aiims-certificate.uploadfile')?>',
        type: "POST",
        dataType: "JSON",
        data: fd,
        processData: false,
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/aiims/index.blade.php ENDPATH**/ ?>
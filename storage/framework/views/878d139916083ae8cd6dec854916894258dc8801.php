...
?>
	 <div class="container">
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header"><i class="fa fa-fw fa-users"></i> User Management
					 <ol class="breadcrumb pull-right" style="background:transparent;font-size:14px;"><?php echo e(Breadcrumbs::render('usermanagement')); ?></ol>
          ...
          <?php if(App\Helpers\SitePermissionCheck::isPermitted('usermaster.store')): ?>
				  <?php if(App\Helpers\RolePermissionCheck::isPermitted('usermaster.store')): ?>
...
<!--  // User Create Model -->	
<?php echo $__env->make('admin.userManagement.model', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
//console.log(userType);
 ...
 // get user information 
  ...
  {
      var show_info="<?php echo e(URL::route('usermaster.show',array(':id'))); ?>";
      ...
      $.get(show_info,{ '_token':token} ,function(data) {
       ...
       // get Role Name 
       var ajaxUrl="<?php echo e(URl::route('user-master.role.get')); ?>";
       var token="<?php echo e(csrf_token()); ?>";
              ...
              mRender:function(v)
              {
          ...
          },		
    			{
    				...
    				mRender:function(v, t, o){
                     ...
                     act_html ='<?php if(App\Helpers\SitePermissionCheck::isPermitted('usermaster.show')): ?> <?php if(App\Helpers\RolePermissionCheck::isPermitted('usermaster.show')): ?><a onclick="user_info('+o['id']+')"><i class="fa fa-info-circle fa-lg blue"></i></a>&nbsp <?php endif; ?> <?php endif; ?>';
                     act_html +='<?php if(App\Helpers\SitePermissionCheck::isPermitted('usermaster.edit')): ?> <?php if(App\Helpers\RolePermissionCheck::isPermitted('usermaster.edit')): ?> &nbsp;&nbsp;<a onclick="user_edit('+o['id']+')"><i class="fa fa-edit fa-lg green"></i></a>&nbsp <?php endif; ?> <?php endif; ?>';
                     
                     act_html +='<?php if(App\Helpers\SitePermissionCheck::isPermitted('usermaster.logout')): ?> <?php if(App\Helpers\RolePermissionCheck::isPermitted('usermaster.logout')): ?>  &nbsp;&nbsp;<a onclick="logout('+o['id']+')" title="logout"><i class="fa fa-sign-out fa-lg green"></i></a> <?php endif; ?> <?php endif; ?>';

                     act_html +='<?php if(App\Helpers\SitePermissionCheck::isPermitted('usermaster.destroy')): ?> <?php if(App\Helpers\RolePermissionCheck::isPermitted('usermaster.destroy')): ?>  &nbsp;&nbsp;<a onclick="deletepath('+o['id']+')"><i class="fa fa-trash fa-lg red"></i></a> <?php endif; ?> <?php endif; ?>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/userManagement/index.blade.php ENDPATH**/ ?>
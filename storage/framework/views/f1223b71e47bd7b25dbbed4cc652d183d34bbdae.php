		...
		<div class="container" style="width: 99%;">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo e(URL::route('admin.dashboard')); ?>"><i
						class="fa fa-user-secret fa-fw"></i><?php echo e(Session::get('site_name')); ?> SeQR Web Admin</a>
			</div>
								...
								<ul class="dropdown-menu">
									...
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('fontmaster.index')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('fontmaster.index')): ?>
											<li><a href="<?php echo e(URL::route('fontmaster.index')); ?>"><i class="fa fa-foursquare fa-fw"></i>
													Font Master</a></li>
										<?php endif; ?>
									<?php endif; ?>
									...
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('background-master.index')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('background-master.index')): ?>
											<li><a href="<?php echo e(URL::route('background-master.index')); ?>"><i class="fa fa-file-o"></i>
									...
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('processExcel.index')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('processExcel.index')): ?>
											<li><a href="<?php echo e(URL::route('processExcel.index')); ?>"><i class="fa fa-file-excel-o"></i>
													Process Excel</a></li>
										<?php endif; ?>
									<?php endif; ?>
									...
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('idcards.index')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('idcards.index')): ?>
											<li><a href="<?php echo e(route('idcards.index')); ?>"><i class="fa fa-credit-card fa-fw"></i>Generate
													ID cards</a></li>
										<?php endif; ?>
									<?php endif; ?>
									...
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('functionalusers.cards_listing')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('functionalusers.cards_listing')): ?>
...
if (
	...
	(App\Helpers\SitePermissionCheck::isPermitted('nnp-certificate.uploadpage') && App\Helpers\RolePermissionCheck::isPermitted('nnp-certificate.uploadpage')) ||
	(App\Helpers\SitePermissionCheck::isPermitted('sbcity-certificate.uploadpage') && App\Helpers\RolePermissionCheck::isPermitted('sbcity-certificate.uploadpage')) ||
	...
	(App\Helpers\SitePermissionCheck::isPermitted('ghrusaikheda-certificate.uploadpage') && App\Helpers\RolePermissionCheck::isPermitted('ghrusaikheda-certificate.uploadpage'))
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<!-- <?php if(App\Helpers\SitePermissionCheck::isPermitted('convocation.dashboard')): ?>
                    <?php if(App\Helpers\RolePermissionCheck::isPermitted('convocation.dashboard')): ?>

						<li><a href="<?= URL::route('convocation.dashboard')?>"><i class="fa fa-file-o fa-fw"></i> Convocation</a></li>
					<?php endif; ?>
					<?php endif; ?> -->

							<?php if($subdomain[0] == "mitwpu" || @$subdomain[1] == "mitwpu"): ?>
								<li><a href="<?= URL::route('convocation.dashboard')?>"><i class="fa fa-file-o fa-fw"></i>
										Convocation</a></li>
							<?php endif; ?>

							<?php if($subdomain[0] == "jntuacek" || @$subdomain[1] == "jntuacek"): ?>
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('pdf2pdf.templatelist')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('pdf2pdf.templatelist')): ?>
									<li><a href="<?php echo e(URL::route('pdf2pdf.templatelist')); ?>"><i
												class="fa fa-list fa-fw"></i>Pdf2Pdf Templates</a></li>
								<?php endif; ?>
							<?php endif; ?>

							<?php if(App\Helpers\SitePermissionCheck::isPermitted('excel2pdf.templatelist')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('excel2pdf.templatelist')): ?>
									<li><a href="<?php echo e(URL::route('excel2pdf.templatelist')); ?>"><i
												class="fa fa-list fa-fw"></i>Excel2Pdf Templates</a></li>
								<?php endif; ?>
							<?php endif; ?>


							<?php if(App\Helpers\SitePermissionCheck::isPermitted('wordtopdf.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('wordtopdf.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('wordtopdf.uploadpage')); ?>"><i
							...
							<?php if($subdomain[0] == "demo" || $subdomain[0] == "test"): ?>
								<li><a href="<?php echo e(URL::route('utility.templates')); ?>"><i class="fa fa-file-excel-o fa-fw"></i>
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('exceltopdf.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('exceltopdf.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('exceltopdf.uploadpage')); ?>"><i
												class="fa fa-file-pdf-o fa-fw"></i>PDF Generate</a></li>

									<li><a href="<?php echo e(URL::route('exceltopdfnew.uploadpage')); ?>"><i
												class="fa fa-file-pdf-o fa-fw"></i>PDF Generate New Utility</a></li>
								<?php endif; ?>
							<?php endif; ?>

							<?php if($subdomain[0] == "demo"): ?>
								<li><a href="<?php echo e(URL::route('answerbooklet.index')); ?>"><i class="fa fa-money fa-fw"></i>
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('bmcc-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('bmcc-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('bmcc-certificate.uploadpage')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('woxsen-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('woxsen-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('woxsen-certificate.uploadpage')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('bmcc-certificate.uploadpagePassing')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('bmcc-certificate.uploadpagePassing')): ?>
									<li><a href="<?php echo e(URL::route('bmcc-certificate.uploadpagePassing')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('fergusson-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('fergusson-certificate.uploadpage')): ?>
									...
									<li><a href="<?php echo e(URL::route('fergusson-certificate.uploadpage')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('galgotias-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('galgotias-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('galgotias-certificate.uploadpage')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('uasb-certifiate.dbUploadfileugpg')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('uasb-certifiate.dbUploadfileugpg')): ?>
									...
									<li><a href="<?php echo e(URL::route('uasb-certificate.index')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('auro-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('auro-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('auro-certificate.uploadpage')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('rrmu-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('rrmu-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('rrmu-certificate.uploadpage')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('cavendish-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('cavendish-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('cavendish-certificate.uploadpage')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('srwcnagpur-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('srwcnagpur-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('srwcnagpur-certificate.uploadpage')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('kessc-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('kessc-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('kessc-certificate.uploadpage')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i> KESSC Certificate</a></li>
									<li><a href="<?php echo e(URL::route('kessc-addserial.uploadpage')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('iccs-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('iccs-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('iccs-certificate.uploadpage')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('monad-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('monad-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('monad-certificate.uploadpage')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('ghribmjal-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('ghribmjal-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('ghribmjal-certificate.uploadpage')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('secura-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('secura-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('secura-certificate.uploadpage')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('molwa-certificate.ImportPrint')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('molwa-certificate.ImportPrint')): ?>
									<li><a href="<?php echo e(URL::route('molwa-certificate.ImportPrint')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('molwa-certificate.index')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('molwa-certificate.index')): ?>
									<li><a href="<?php echo e(URL::route('molwa-certificate.index')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i> Manage Records</a></li>
									<li><a href="<?php echo e(URL::route('molwa-certificate.molwaRemarks')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('molwa-certificate.ReImportPrint')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('molwa-certificate.ReImportPrint')): ?>
									<li><a href="<?php echo e(URL::route('molwa-certificate.ReImportPrint')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i> Re-Import</a></li>
									<li><a href="<?php echo e(URL::route('molwa-certificate.molwaReport')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('kmtc-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('kmtc-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('kmtc-certificate.uploadpage')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i> Kmtc Documents</a></li>
								<?php endif; ?>
							<?php endif; ?>
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('kmtc-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('kmtc-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('convocationkmtc.dashboard')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('spit-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('spit-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('spit-certificate.uploadpage')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('vbit-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('vbit-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('vbit-certificate.uploadpage')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i> Grade Cards</a></li>
								<?php endif; ?>
							<?php endif; ?>
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('cedp-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('cedp-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('cedp-certificate.uploadpage')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i> Grade Cards</a></li>
								<?php endif; ?>
							<?php endif; ?>
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('iscn-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('iscn-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('iscn-certificate.uploadpage')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('rawatpura-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('rawatpura-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('rawatpura-certificate.uploadpage')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('bestiu-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('bestiu-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('bestiu-certificate.uploadpage')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i> Bestiu Certificate</a></li>
								<?php endif; ?>
							<?php endif; ?>

							<?php if(App\Helpers\SitePermissionCheck::isPermitted('mvsr-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('mvsr-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('mvsr-certificate.uploadpage')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i> MVSR Certificate</a></li>
								<?php endif; ?>
							<?php endif; ?>

							<?php if(App\Helpers\SitePermissionCheck::isPermitted('eastpoint-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('eastpoint-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('eastpoint-certificate.uploadpage')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i> East Point Certificate</a></li>
								<?php endif; ?>
							<?php endif; ?>


							<?php if(App\Helpers\SitePermissionCheck::isPermitted('nnp-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('nnp-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('nnp-certificate.uploadpage')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i> Nnp Certificate</a></li>
								<?php endif; ?>
							<?php endif; ?>



							<?php if(App\Helpers\SitePermissionCheck::isPermitted('sbcity-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('sbcity-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('sbcity-certificate.uploadpage')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i> SBCT Certificate</a></li>
								<?php endif; ?>
							<?php endif; ?>
	...
	if ($subdomain[0] == "bestiu") { ?>
							<li><a href="<?php echo e(URL::route('bestiu-e-document.uploadpage')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('sdm-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('sdm-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('sdm-certificate.uploadpage')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i> SDM Certificate</a></li>
									<li><a href="<?php echo e(URL::route('sdm-resit.uploadpage')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i> SDM RESIT</a></li>
								<?php endif; ?>
							<?php endif; ?>

							<?php if(App\Helpers\SitePermissionCheck::isPermitted('pjlcp-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('pjlcp-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('pjlcp-certificate.uploadpage')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i> PJLCP Certificate</a></li>
								<?php endif; ?>
							<?php endif; ?>

							<?php if(App\Helpers\SitePermissionCheck::isPermitted('sjcit-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('sjcit-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(route('sjcit-certificate.uploadpage')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i> SJCIT Certificate</a></li>
								<?php endif; ?>
							<?php endif; ?>

							<?php if(App\Helpers\SitePermissionCheck::isPermitted('ghrusaikheda-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('ghrusaikheda-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(route('ghrusaikheda-certificate.uploadpage')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('surana-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('surana-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('surana-certificate.uploadpage')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('anu-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('anu-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('anu-certificate.uploadpage')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i> ANU Certificate</a></li>
								<?php endif; ?>
							<?php endif; ?>


							<?php if(App\Helpers\SitePermissionCheck::isPermitted('lnct-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('lnct-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('lnct-certificate.uploadpage')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('sgrsa-certificate.addform')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('sgrsa-certificate.addform')): ?>
									<li><a href="<?php echo e(URL::route('sgrsa-certificate.addform')); ?>"><i
												class="fa fa-file-pdf-o fa-fw"></i> New Record</a></li>
									<li><a href="<?php echo e(URL::route('sgrsa-previouscertificate.addform')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('sgrsa-supplier.addform')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('sgrsa-supplier.addform')): ?>
									<li><a href="<?php echo e(URL::route('sgrsa-supplier.addform')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('sgrsa-agent.addform')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('sgrsa-agent.addform')): ?>
									<li><a href="<?php echo e(URL::route('sgrsa-agent.addform')); ?>"><i
												class="fa fa-file-text-o fa-fw"></i> Sub Agents</a></li>
									<li><a href="<?php echo e(URL::route('sgrsa-governor.addform')); ?>"><i
												class="fa fa-file-text-o fa-fw"></i> Type of Governor</a></li>
									<li><a href="<?php echo e(URL::route('sgrsa-governor.adduform')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('agent-allot.RecallList')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('agent-allot.RecallList')): ?>
									<li><a href="<?php echo e(URL::route('agent-allot.RecallList')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('supplier-allot.addform')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('supplier-allot.addform')): ?>
									<li><a href="<?php echo e(URL::route('supplier-allot.addform')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('allot-edit.editform')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('allot-edit.editform')): ?>
									<li><a href="<?php echo e(URL::route('allot-edit.editform')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('supplier-uploadexcel.uploadExcelForm')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('supplier-uploadexcel.uploadExcelForm')): ?>
									<li><a href="<?php echo e(URL::route('supplier-uploadexcel.uploadExcelForm')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('sgrsa-supplier.editform')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('sgrsa-supplier.editform')): ?>
									<li><a href="<?php echo e(URL::route('sgrsa-supplier.editform')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('sgrsa-allot.addform')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('sgrsa-allot.addform')): ?>
									<li><a href="<?php echo e(URL::route('sgrsa-allot.addform')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('sgrsa-previouscertificate.indexPC')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('sgrsa-previouscertificate.indexPC')): ?>
									<li><a href="<?php echo e(URL::route('sgrsa-previouscertificate.indexPC')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('sangamui-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('sangamui-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('sangamui-certificate.uploadpage')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('imt-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('imt-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(route('imt.index')); ?>"><i class="fa fa-file-excel-o fa-fw"></i> IMT
											Certificate</a></li>
								<?php endif; ?>
							<?php endif; ?>

							<?php if(App\Helpers\SitePermissionCheck::isPermitted('ttd-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('ttd-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(route('ttd.index')); ?>"><i class="fa fa-file-excel-o fa-fw"></i> TTD
											Certificate</a></li>
								<?php endif; ?>
							<?php endif; ?>
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('bnm-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('bnm-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(route('bnm-certificate.uploadpage')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('uneb-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('uneb-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(route('uneb-certificate.uploadpage')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i> UNEB Certificate</a></li>
								<?php endif; ?>
							<?php endif; ?>

							<?php if(App\Helpers\SitePermissionCheck::isPermitted('saiu-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('saiu-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(route('saiu-certificate.uploadpage')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i> SAIU Certificate</a></li>
								<?php endif; ?>
							<?php endif; ?>


							<?php if(App\Helpers\SitePermissionCheck::isPermitted('mitwpu-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('mitwpu-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(route('mitwpu-certificate.uploadpage')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i> MITWPU Certificate</a></li>
								<?php endif; ?>
							<?php endif; ?>

							<?php if(App\Helpers\SitePermissionCheck::isPermitted('peoplesuni-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('peoplesuni-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(route('peoplesuni-certificate.uploadpage')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('chanakya-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('chanakya-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(route('chanakya-certificate.uploadpage')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i> Chanakya Certificate</a></li>
								<?php endif; ?>
							<?php endif; ?>


							<?php if(App\Helpers\SitePermissionCheck::isPermitted('aiims-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('aiims-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(route('aiims-certificate.uploadpage')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i> Aiims Certificate</a></li>
								<?php endif; ?>
							<?php endif; ?>


							<?php if(App\Helpers\SitePermissionCheck::isPermitted('yuvaparivartan-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('yuvaparivartan-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(route('yuvaparivartan-certificate.uploadpage')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i>
											Yuvaparivartan Certificate</a></li>
									<li><a href="<?php echo e(URL::route('yuvaparivartan-records.uploadpage')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i> Verify E-Certificate Details</a></li>
								<?php endif; ?>
							<?php endif; ?>


							<?php if(App\Helpers\SitePermissionCheck::isPermitted('mallareddy-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('mallareddy-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(route('mallareddy-certificate.uploadpage')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i> Malla Reddy Certificate</a></li>
								<?php endif; ?>
							<?php endif; ?>


							<?php if(App\Helpers\SitePermissionCheck::isPermitted('cambridge-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('cambridge-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(route('cambridge-certificate.uploadpage')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i> Cambridge Certificate</a></li>
								<?php endif; ?>
							<?php endif; ?>


							<?php if(App\Helpers\SitePermissionCheck::isPermitted('kdkn-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('kdkn-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(route('kdkn-certificate.uploadpage')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('mitaoe-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('mitaoe-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(route('mitaoe-certificate.uploadpage')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i> Mitaoe Certificate</a></li>
								<?php endif; ?>
							<?php endif; ?>


							<?php if(App\Helpers\SitePermissionCheck::isPermitted('tpsdi-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('tpsdi-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(route('tpsdi-certificate.uploadpage')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i> TPSDI Certificate</a></li>
								<?php endif; ?>
							<?php endif; ?>

							<?php if(App\Helpers\SitePermissionCheck::isPermitted('cscacs-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('cscacs-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(route('cscacs-certificate.uploadpage')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i> CSCACS Certificate</a></li>
								<?php endif; ?>
							<?php endif; ?>


							<?php if(App\Helpers\SitePermissionCheck::isPermitted('ghrstu-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('ghrstu-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(route('ghrstu-certificate.uploadpage')); ?>"><i
							...
							<!--ksg -->
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('ksg-branch.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('ksg-branch.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('ksg-branch.uploadpage')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('ksg-branch.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('ksg-branch.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('ksg-certificate.uploadpage')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i> KSG Custom</a></li>
								<?php endif; ?>
							<?php endif; ?>

							<?php if(App\Helpers\SitePermissionCheck::isPermitted('ksg-batch.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('ksg-batch.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('ksg-batch.uploadpage')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i> Batch</a></li>
								<?php endif; ?>
							<?php endif; ?>

							<?php if(App\Helpers\SitePermissionCheck::isPermitted('ksg-approval.page')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('ksg-approval.page')): ?>
									<li><a href="<?php echo e(URL::route('ksg-approval.page')); ?>"><i class="fa fa-file-excel-o fa-fw"></i>
											Approval page</a></li>
								<?php endif; ?>
							<?php endif; ?>

							<?php if(App\Helpers\SitePermissionCheck::isPermitted('ksg-print.page')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('ksg-print.page')): ?>
									<li><a href="<?php echo e(URL::route('ksg-print.page')); ?>"><i class="fa fa-file-excel-o fa-fw"></i>
											Printer page</a></li>
								<?php endif; ?>
							<?php endif; ?>

							<?php if(App\Helpers\SitePermissionCheck::isPermitted('machakos.index')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('machakos.index')): ?>
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('bihar-estamp-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('bihar-estamp-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('bihar-estamp-certificate.uploadpage')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i> Certificate</a></li>
									<li><a href="<?php echo e(URL::route('bihar-estamp-certificate.uploadpageutility')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i> Certificate - Utility</a></li>
									<li><a href="<?php echo e(URL::route('bihar-estamp-certificate.uploadpageprinterutility')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i> Certificate - Printer Utility</a></li>
									<li><a href="<?php echo e(URL::route('bihar-estamp-certificate.uploadpageapiutility')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i>Certificate - API Printer Utility</a></li>
									<li><a href="<?php echo e(URL::route('bihar-estamp-certificate.uploadpageprinter')); ?>"><i
							...
							<?php if(App\Helpers\SitePermissionCheck::isPermitted('minosha-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('minosha-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(route('minosha-certificate.uploadpage')); ?>"><i
												class="fa fa-file-excel-o fa-fw"></i> Minosha Custom Templates</a></li>
								<?php endif; ?>
							<?php endif; ?>

							<?php if(App\Helpers\SitePermissionCheck::isPermitted('suryodaya-certificate.uploadpage')): ?>
								<?php if(App\Helpers\RolePermissionCheck::isPermitted('suryodaya-certificate.uploadpage')): ?>
									<li><a href="<?php echo e(URL::route('suryodaya-certificate.uploadpage')); ?>"><i
...
if ($subdomain[0] == "mitadt" || $subdomain[0] == "localhost") { ?>
					<li class="dropdown">
						<a class="dropdown-toggle" data-toggle="dropdown" href="#"><i
								class="fa fa-file-o fa-fw"></i>Customs<span class="caret"></span></a>
						<ul class="dropdown-menu">
							<li><a href="<?php echo e(URL::route('passing-certificate.uploadpage')); ?>"><i
						...
						<?php if(App\Helpers\RolePermissionCheck::isPermitted('degree-certifiate.index')): ?>
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li><a href="<?php echo e(route('degree-certifiate.index')); ?>"><i class="fa fa-file-text-o fa-fw"></i>
						...
						<?php if(App\Helpers\RolePermissionCheck::isPermitted('pgconfig.index') || (App\Helpers\RolePermissionCheck::isPermitted('pgmaster.index')) || (App\Helpers\RolePermissionCheck::isPermitted('documentsratemaster.index'))): ?>
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									<?php if($subdomain[0] == "raisoni"): ?>
										...
										<?php if(App\Helpers\SitePermissionCheck::isPermitted('pgmaster.index')): ?>
											<?php if(App\Helpers\RolePermissionCheck::isPermitted('pgmaster.index')): ?>
												<li>
													<a href="<?php echo e(URL::route('pgmaster.index')); ?>"><i class="fa fa-money fa-fw"></i>Payment
														Gateway</a>
												</li>
											<?php endif; ?>
										<?php endif; ?>
										...
										<?php if(App\Helpers\SitePermissionCheck::isPermitted('pgconfig.index')): ?>
											<?php if(App\Helpers\RolePermissionCheck::isPermitted('pgconfig.index')): ?>
												<li>
													<a href="<?php echo e(URL::route('pgconfig.index')); ?>"><i class="fa fa-gears fa-fw"></i> PG
														Configuration</a>
									...
									<?php else: ?>
										<?php if(App\Helpers\SitePermissionCheck::isPermitted('pgmaster_new.index')): ?>
											<?php if(App\Helpers\RolePermissionCheck::isPermitted('pgmaster_new.index')): ?>
												<li>
													<a href="<?php echo e(URL::route('pgmaster_new.index')); ?>"><i
															class="fa fa-money fa-fw"></i>Payment Gateway</a>
												</li>
											<?php endif; ?>
										<?php endif; ?>

										<?php if(App\Helpers\SitePermissionCheck::isPermitted('pg_newconfig.index')): ?>
											<?php if(App\Helpers\RolePermissionCheck::isPermitted('pg_newconfig.index')): ?>
												<li>
													<a href="<?php echo e(URL::route('pg_newconfig.index')); ?>"><i class="fa fa-gears fa-fw"></i> PG
														Configuration</a>
									...
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('documentsratemaster.index')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('documentsratemaster.index')): ?>
											<li>
												<a href="<?php echo e(URL::route('documentsratemaster.index')); ?>"><i
								...
								<ul class="dropdown-menu">
									...
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('certificateManagement.index')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('certificateManagement.index')): ?>
											<li><a href="<?php echo e(route('certificateManagement.index')); ?>"><i
									...
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('vgujaipur.create')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('vgujaipur.create')): ?>
											<li><a href="<?php echo e(route('vgujaipur.create')); ?>"><i class="fa fa-file-text-o fa-fw"></i> Print
													Serial Number</a></li>
										<?php endif; ?>
									<?php endif; ?>
									...
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('printing-detail.index')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('printing-detail.index')): ?>
														<li><a href="<?php echo e(URL::route('printing-detail.index')); ?>"><i class="fa fa-print fa-fw"></i>
...
if ($subdomain[0] == \Config('constant.raisoni_subdomain') || $subdomain[0] == 'demo' || $subdomain[0] == 'galgotias' || $subdomain[0] == 'monad') {
								...
								<ul class="dropdown-menu">
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('sessionsmaster.index')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('sessionsmaster.index')): ?>
											<li><a href="<?php echo e(URL::route('sessionsmaster.index')); ?>"><i class="fa fa-list fa-fw"></i>
													Session</a></li>
										<?php endif; ?>
									<?php endif; ?>
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('degreemaster.index')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('degreemaster.index')): ?>
											<li><a href="<?php echo e(URL::route('degreemaster.index')); ?>"><i class="fa fa-list fa-fw"></i>
													Degree</a></li>
										<?php endif; ?>
									<?php endif; ?>
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('branch.index')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('branch.index')): ?>
											<li><a href="<?php echo e(URL::route('branch.index')); ?>"><i class="fa fa-list fa-fw"></i> Branch</a>
											</li>
										<?php endif; ?>
									<?php endif; ?>
									...
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('semester.index')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('semester.index')): ?>
											<li><a href="<?php echo e(URL::route('semester.index')); ?>"><i class="fa fa-list fa-fw"></i>
													Semester</a></li>
										<?php endif; ?>
									<?php endif; ?>
								</ul>
								...
								<ul class="dropdown-menu">
									...
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('oldverification.index')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('oldverification.index')): ?>
											<li><a href="<?php echo e(URL::route('oldverification.index')); ?>"><i class="fa fa-list-ul"></i> Old
													Documents</a></li>
										<?php endif; ?>
									<?php endif; ?>
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('request_testing')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('request_testing')): ?>
											<li><a href="<?php echo e(URL::route('request_testing')); ?>"><i class="fa fa-list-ul"></i> SeQR
													Documents</a></li>
										<?php endif; ?>
									<?php endif; ?>
								...
								<ul class="dropdown-menu">
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('stationarystock.index')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('stationarystock.index')): ?>
											<li><a href="<?php echo e(URL::route('stationarystock.index')); ?>"><i class="fa fa-th-large fa-fw"></i>
									...
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('damagedstock.index')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('damagedstock.index')): ?>
											<li><a href="<?php echo e(URL::route('damagedstock.index')); ?>"><i
									...
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('consumptionreport.index')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('consumptionreport.index')): ?>
											<li><a href="<?php echo e(URL::route('consumptionreport.index')); ?>"><i
									...
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('consumptionreportexport.index')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('consumptionreportexport.index')): ?>
											<li><a href="<?php echo e(URL::route('consumptionreportexport.index')); ?>"><i
			...
			?>
								...
								<ul class="dropdown-menu">
									...
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('usermaster.index')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('usermaster.index')): ?>
											<li><a href="<?php echo e(URL::route('usermaster.index')); ?>"><i class="fa fa-users fa-fw"></i> User
													Management</a></li>
										<?php endif; ?>
									<?php endif; ?>

									<?php if(App\Helpers\SitePermissionCheck::isPermitted('functionalusers.index')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('functionalusers.index')): ?>
											<li><a href="<?php echo e(URL::route('functionalusers.index')); ?>"><i class="fa fa-users fa-fw"></i>
									...
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('student.index')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('student.index')): ?>
											<li><a href="<?php echo e(URL::route('student.index')); ?>"><i class="fa fa-users fa-fw"></i> Student
													Management </a></li>
										<?php endif; ?>
									<?php endif; ?>
									...
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('adminmaster.index')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('adminmaster.index')): ?>
											<li><a href="<?php echo e(URL::route('adminmaster.index')); ?>"><i class="fa fa-users fa-fw"></i> Admin
													Management</a></li>
										<?php endif; ?>
									<?php endif; ?>
									...
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('roles.index')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('roles.index')): ?>
											<li><a href="<?php echo e(URL::route('roles.index')); ?>"><i class="fa fa-users fa-fw"></i> Roles
													Management</a></li>
										<?php endif; ?>
									<?php endif; ?>
									...
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('systemconfig.index')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('systemconfig.index')): ?>
											<li><a href="<?php echo e(URL::route('systemconfig.index')); ?>"><i class="fa fa-cog fa-fw"></i>
													Settings</a></li>
										<?php endif; ?>
									<?php endif; ?>
								...
								<ul class="dropdown-menu">
									...
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('sandboxing.printingDetails.index')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('sandboxing.printingDetails.index')): ?>
														<li><a href="<?php echo e(route('sandboxing.printingDetails.index')); ?>"><i
									...
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('sandboxing.templateData.index')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('sandboxing.templateData.index')): ?>
											<li><a href="<?php echo e(URL::route('sandboxing.templateData.index')); ?>"><i
									...
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('sandboxing.printingReport.index')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('sandboxing.printingReport.index')): ?>
											<li><a href="<?php echo e(URL::route('sandboxing.printingReport.index')); ?>"><i
									...
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('sandboxing.scanHistory.index')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('sandboxing.scanHistory.index')): ?>
											<li><a href="<?php echo e(route('sandboxing.scanHistory.index')); ?>"><i class="fa fa-lock fa-fw"></i>
													Scan history</a></li>
										<?php endif; ?>
									<?php endif; ?>
									...
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('sandboxing.paymentTransaction.index')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('sandboxing.paymentTransaction.index')): ?>
											<li><a href="<?php echo e(route('sandboxing.paymentTransaction.index')); ?>"><i
								...
								<ul class="dropdown-menu">
									...
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('printer-report.index')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('printer-report.index')): ?>
											<li><a href="<?php echo e(route('printer-report.index')); ?>"><i
														class="fa fa-file-powerpoint-o fa-fw"></i> Printing Report</a></li>
										<?php endif; ?>
									<?php endif; ?>
									...
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('pdf2pdf-report.index')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('pdf2pdf-report.index')): ?>
											<li><a href="<?php echo e(route('pdf2pdf-report.index')); ?>"><i
														class="fa fa-file-powerpoint-o fa-fw"></i> Pdf2pdf Report</a></li>
										<?php endif; ?>
									<?php endif; ?>

									<?php if(App\Helpers\SitePermissionCheck::isPermitted('functionalusers.idcard_report')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('functionalusers.idcard_report')): ?>
											<li><a href="<?php echo e(route('functionalusers.idcard_report')); ?>"><i
									...
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('scanHistory.index')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('scanHistory.index')): ?>
											<li><a href="<?php echo e(URL::route('scanHistory.index')); ?>"><i class="fa fa-envira fa-fw"></i> Scan
													History</a></li>
										<?php endif; ?>
									<?php endif; ?>
									...
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('transaction.index')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('transaction.index')): ?>
											<li><a href="<?php echo e(URL::route('transaction.index')); ?>"><i class="fa fa-cc-visa fa-fw"></i>
									...
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('transactionVerification.index')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('transactionVerification.index')): ?>
											<li><a href="<?php echo e(URL::route('transactionVerification.index')); ?>"><i
									...
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('session-manager.index')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('session-manager.index')): ?>
											<li><a href="<?php echo e(route('session-manager.index')); ?>"><i class="fa fa-lock fa-fw"></i> User
					...
					<li><a href="<?php echo e(route('functionalusers.datamapping')); ?>"><i class="fa fa-file-pdf-o fa-fw"></i> Map
							Old Data</a></li>
					<?php } ?>
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="<?php echo e(route('BlockchainAuthorization.live')); ?>"><i class="fa fa-link fa-fw"></i>
									Live Blockchain Authorization</a></li>

							<li><a href="<?php echo e(route('BlockchainAuthorization.test')); ?>"><i class="fa fa-link fa-fw"></i>
								...
								<ul class="dropdown-menu">
									...
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('admin.profile.showprofile')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('admin.profile.showprofile')): ?>
											<li><a href="<?php echo e(URL::route('admin.profile.showprofile')); ?>"><i class="fa fa-user fa-fw"></i>
													My Profile</a></li>
										<?php endif; ?>
									<?php endif; ?>
									...
									<?php if(App\Helpers\SitePermissionCheck::isPermitted('admin.manual.showmanual')): ?>
										<?php if(App\Helpers\RolePermissionCheck::isPermitted('admin.manual.showmanual')): ?>
											<li><a href="<?php echo e(URL::route('admin.manual.showmanual')); ?>" target="_blank"><i
	...
	</nav><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/layout/header.blade.php ENDPATH**/ ?>
...
<script type="text/javascript">
    ...
    var oTable = $('#example').dataTable({
        ...
        "bServerSide": true,
        "autoWidth": true,
        "sAjaxSource": "<?php echo e(URL::route('sandboxing.certificate.index',['status'=>1])); ?>",
        "aaSorting": [
            [4, "desc"]
        ],
        "oLanguage": {
        ...
        
        {
            ...
            mRender: function(v, t, o) {
                ...
                var act_html = "<div class='btn-group'>"
                                ...
                                +"<?php if(App\Helpers\SitePermissionCheck::isPermitted('sandboxing.certificate.generateQR')): ?> <?php if(App\Helpers\RolePermissionCheck::isPermitted('sandboxing.certificate.generateQR')): ?><a href='javascript:void(0);' onclick='generateQRCode("+ o['id'] +")' data-toggle='tooltip' title='Generate QR Code' data-placement='top' class='editrow'><i class='fa fa-info-circle fa-lg blue'></i></a><?php endif; ?> <?php endif; ?>"

                                +"<?php if(App\Helpers\SitePermissionCheck::isPermitted('sandboxing.certificate.update')): ?> <?php if(App\Helpers\RolePermissionCheck::isPermitted('sandboxing.certificate.update')): ?> <label class='switch'><input type='checkbox' id ='action' data-id = '"+o.id+"' data-status='"+ o.status +"' ><span class='slider round'></label><?php endif; ?> <?php endif; ?>"
        ...
        bootbox.confirm({
            ...
            callback: 
                function(result) {
                    if(result) {
                        $.ajax({
                            url: "<?php echo e(URL::route('sandboxing.certificate.update')); ?>",
                            type: 'post',
                            dataType:'html',
                            data:{
                                id:id,
    ...
    function generateQRCode(id) {
        ...
        // console.log(id);
            $.ajax({
                url: "<?php echo e(URL::route('sandboxing.certificate.generateQR')); ?>",
                type: 'post',
                dataType:'html',
                data:{
                    id:id,
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/sandboxing/certificate.blade.php ENDPATH**/ ?>
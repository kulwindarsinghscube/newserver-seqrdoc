...
<div class="container">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><i class="fa fa fa-file-excel-o"></i> SDM
        ...
        <div class="row">
            <div class="col-lg-7"> <br />
                <form method="post" id="processExcelForm" class="form-horizontal" enctype="multipart/form-data" action="<?=route('sdm-certificate.uploadfile')?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="template_id" name="template_id">
                                ...
                                <option value="1" data-tempid="1">MPT II</option>                                
                                <option value="2" data-tempid="2">PDC</option>
                                <option value="3" data-tempid="3">BDS</option>
                                <option value="4" data-tempid="4">Dental PDC</option>
                                <option value="17" data-tempid="17">Nursing/Physio PDC</option>
                                <option value="5" data-tempid="5">BPT</option>
								<option value="6" data-tempid="6">MPT I</option>
								<option value="7" data-tempid="7">Nursing</option>
								<option value="8" data-tempid="8">MBBS PROFESSIONAL I & II</option>
                <option value="23" data-tempid="23">MBBS PROFESSIONAL I & II - 40-60</option>
								<option value="9" data-tempid="9">MBBS 3rd PROFESSIONAL - PART I</option>
								<option value="10" data-tempid="10">MBBS 3rd PROFESSIONAL - PART II</option>
								<option value="11" data-tempid="11">M.Sc.</option>
								<option value="13" data-tempid="13">M.Sc. III</option>
								<option value="12" data-tempid="12">BSC</option>
								<option value="15" data-tempid="15">MDS Part I</option>
								<option value="14" data-tempid="14">MDS Part II</option>
								<option value="16" data-tempid="16">B.Sc. Nursing (I II III IV V VI VII VIII)SEMESTER</option>
								<!--<option value="18" data-tempid="18">B.Sc. Nursing (I and VII)SEMESTER  </option>-->
								<!--<option value="19" data-tempid="19">MBBS PRFESSIONAL I & II (RESIT)</option>
								<option value="20" data-tempid="20">MBBS 3rd PRFESSIONAL - PART I (RESIT)</option>
								<option value="21" data-tempid="21">MBBS 3rd PRFESSIONAL - PART II (RESIT)</option>-->
                                <option value="22" data-tempid="22">MDS - 6 Subjects</option>
								<option value="24" data-tempid="24">MBBS THIRD PROFESSIONAL PART I (MAIN)</option>
								<option value="25" data-tempid="25">MBBS THIRD PROFESSIONAL PART II (MAIN)</option>
								<option value="26" data-tempid="26">BSC Allied</option>
                	<option value="29" data-tempid="29">BSC Allied with no viva</option>
								<option value="27" data-tempid="27">MBBS 3rd PROFESSIONAL - PART I (3 Subjects)</option>
                <option value="28" data-tempid="28">B.Sc. Nursing UG (I II III IV V VI VII VIII)SEMESTER</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="col-lg-5" style="padding: 83px 1em;"> 
                <?php
                    ...
                    $excel_url_1=$path.$subdomain[0]."/backend/sample_excel/SY_SDM_Sample.xlsx";
                    $excel_url_2=$path.$subdomain[0]."/backend/sample_excel/PDC_Sample.xlsx";
                    $excel_url_3=$path.$subdomain[0]."/backend/sample_excel/BDS_sample.xlsx";
                    $excel_url_4=$path.$subdomain[0]."/backend/sample_excel/Dental_PDC.xlsx";
                    $excel_url_5=$path.$subdomain[0]."/backend/sample_excel/BPT_Sample.xlsx";
					$excel_url_6=$path.$subdomain[0]."/backend/sample_excel/MPT_I_Sample.xlsx";
					$excel_url_7=$path.$subdomain[0]."/backend/sample_excel/nursing_sample.xlsx";
					$excel_url_8=$path.$subdomain[0]."/backend/sample_excel/MBBS.xlsx";
					$excel_url_9=$path.$subdomain[0]."/backend/sample_excel/MBBS.xlsx";
					$excel_url_10=$path.$subdomain[0]."/backend/sample_excel/MBBS.xlsx";
					$excel_url_11=$path.$subdomain[0]."/backend/sample_excel/MSC.xlsx";
					$excel_url_12=$path.$subdomain[0]."/backend/sample_excel/BSCMedicalLab.xlsx";
					$excel_url_13=$path.$subdomain[0]."/backend/sample_excel/MSC3.xlsx";
					$excel_url_14=$path.$subdomain[0]."/backend/sample_excel/MDSII.xlsx";
					$excel_url_15=$path.$subdomain[0]."/backend/sample_excel/MDSI.xlsx";
					$excel_url_16=$path.$subdomain[0]."/backend/sample_excel/BSCN.xlsx";
					$excel_url_17=$path.$subdomain[0]."/backend/sample_excel/Dental_PDC.xlsx";
					$excel_url_18=$path.$subdomain[0]."/backend/sample_excel/BSCN.xlsx";
					$excel_url_19=$path.$subdomain[0]."/backend/sample_excel/MBBS.xlsx";
					$excel_url_20=$path.$subdomain[0]."/backend/sample_excel/MBBS.xlsx";
					$excel_url_21=$path.$subdomain[0]."/backend/sample_excel/MBBS.xlsx";
					$excel_url_22=$path.$subdomain[0]."/backend/sample_excel/MDSII_SixSubjects.xlsx";
          			$excel_url_23=$path.$subdomain[0]."/backend/sample_excel/MBBS.xlsx";
					$excel_url_24=$path.$subdomain[0]."/backend/sample_excel/MBBS_THIRD_PROFESSIONAL_PART_I_(MAIN).xlsx";
					$excel_url_25=$path.$subdomain[0]."/backend/sample_excel/MBBS_THIRD_PROFESSIONAL_PART_II_(MAIN).xlsx";
					$excel_url_26=$path.$subdomain[0]."/backend/sample_excel/BSCAllied.xlsx";
					$excel_url_27=$path.$subdomain[0]."/backend/sample_excel/MBBS_3subjects.xlsx";
          $excel_url_28=$path.$subdomain[0]."/backend/sample_excel/BSCNUG.xlsx";
                ...
                <span style="display:none;" id="excel_url_3"><b>Please Click <a href="<?php echo e($excel_url_3); ?>" download>HERE</a> To Download Sample Excel</b></span>
                <span style="display:none;" id="excel_url_4"><b>Please Click <a href="<?php echo e($excel_url_4); ?>" download>HERE</a> To Download Sample Excel</b></span>
                <span style="display:none;" id="excel_url_5"><b>Please Click <a href="<?php echo e($excel_url_5); ?>" download>HERE</a> To Download Sample Excel</b></span>
				<span style="display:none;" id="excel_url_6"><b>Please Click <a href="<?php echo e($excel_url_6); ?>" download>HERE</a> To Download Sample Excel</b></span>	
				<span style="display:none;" id="excel_url_7"><b>Please Click <a href="<?php echo e($excel_url_7); ?>" download>HERE</a> To Download Sample Excel</b></span>	
				<span style="display:none;" id="excel_url_8"><b>Please Click <a href="<?php echo e($excel_url_8); ?>" download>HERE</a> To Download Sample Excel</b></span>	
				<span style="display:none;" id="excel_url_9"><b>Please Click <a href="<?php echo e($excel_url_9); ?>" download>HERE</a> To Download Sample Excel</b></span>	
				<span style="display:none;" id="excel_url_10"><b>Please Click <a href="<?php echo e($excel_url_10); ?>" download>HERE</a> To Download Sample Excel</b></span>
				<span style="display:none;" id="excel_url_11"><b>Please Click <a href="<?php echo e($excel_url_11); ?>" download>HERE</a> To Download Sample Excel</b></span>
				<span style="display:none;" id="excel_url_12"><b>Please Click <a href="<?php echo e($excel_url_12); ?>" download>HERE</a> To Download Sample Excel</b></span>	
				<span style="display:none;" id="excel_url_13"><b>Please Click <a href="<?php echo e($excel_url_13); ?>" download>HERE</a> To Download Sample Excel</b></span>	
				<span style="display:none;" id="excel_url_14"><b>Please Click <a href="<?php echo e($excel_url_14); ?>" download>HERE</a> To Download Sample Excel</b></span>	
				<span style="display:none;" id="excel_url_15"><b>Please Click <a href="<?php echo e($excel_url_15); ?>" download>HERE</a> To Download Sample Excel</b></span>	
				<span style="display:none;" id="excel_url_16"><b>Please Click <a href="<?php echo e($excel_url_16); ?>" download>HERE</a> To Download Sample Excel</b></span>	
				<span style="display:none;" id="excel_url_17"><b>Please Click <a href="<?php echo e($excel_url_17); ?>" download>HERE</a> To Download Sample Excel</b></span>	
				<span style="display:none;" id="excel_url_18"><b>Please Click <a href="<?php echo e($excel_url_18); ?>" download>HERE</a> To Download Sample Excel</b></span>	
				<span style="display:none;" id="excel_url_19"><b>Please Click <a href="<?php echo e($excel_url_19); ?>" download>HERE</a> To Download Sample Excel</b></span>	
				<span style="display:none;" id="excel_url_20"><b>Please Click <a href="<?php echo e($excel_url_20); ?>" download>HERE</a> To Download Sample Excel</b></span>	
				<span style="display:none;" id="excel_url_21"><b>Please Click <a href="<?php echo e($excel_url_21); ?>" download>HERE</a> To Download Sample Excel</b></span>
				<span style="display:none;" id="excel_url_22"><b>Please Click <a href="<?php echo e($excel_url_22); ?>" download>HERE</a> To Download Sample Excel</b></span>
        		<span style="display:none;" id="excel_url_23"><b>Please Click <a href="<?php echo e($excel_url_23); ?>" download>HERE</a> To Download Sample Excel</b></span>
				<span style="display:none;" id="excel_url_24"><b>Please Click <a href="<?php echo e($excel_url_24); ?>" download>HERE</a> To Download Sample Excel</b></span>
        		<span style="display:none;" id="excel_url_25"><b>Please Click <a href="<?php echo e($excel_url_25); ?>" download>HERE</a> To Download Sample Excel</b></span>
        		<span style="display:none;" id="excel_url_26"><b>Please Click <a href="<?php echo e($excel_url_26); ?>" download>HERE</a> To Download Sample Excel</b></span>
        		<span style="display:none;" id="excel_url_27"><b>Please Click <a href="<?php echo e($excel_url_27); ?>" download>HERE</a> To Download Sample Excel</b></span>
            <span style="display:none;" id="excel_url_28"><b>Please Click <a href="<?php echo e($excel_url_28); ?>" download>HERE</a> To Download Sample Excel</b></span>
...
function validateUpload() {
	...
	$.ajax({
		url:'<?= route('sdm-certificate.validateexcel')?>',
	    type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,
...
function uploadfile(startRow = 2, endRow = 2, highestRow = null) {
    ...
    $.ajax({
		url:'<?= route('sdm-certificate.uploadfile')?>',
        type: "POST",
        dataType: "JSON",
        data: fd,
        processData: false,
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/sdm/index.blade.php ENDPATH**/ ?>
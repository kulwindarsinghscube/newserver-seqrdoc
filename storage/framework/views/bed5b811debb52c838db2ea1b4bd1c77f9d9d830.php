...
<div class="container">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><i class="fa fa fa-file-excel-o"></i> VBIT
        ...
        <div class="row">
            <div class="col-lg-7"> <br />
                <form method="post" id="processExcelForm" class="form-horizontal" enctype="multipart/form-data" action="<?=route('vbit-certificate.uploadfile')?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="template_id" name="template_id">
                                ...
                                <option value="1" data-tempid="1">Memorandum</option>
                                <option value="2" data-tempid="2">PG-Consolidated</option>
                                <option value="3" data-tempid="3">UG-CGM</option>
                                <option value="4" data-tempid="4">UG Memorandum</option>
                                <option value="5" data-tempid="5">Provisional Certificate</option>
								<option value="6" data-tempid="6">UG-Honors/Minor</option>
								<option value="7" data-tempid="7">UG -CGM Direct 2nd Year</option>
								<option value="8" data-tempid="8">UG-Honors/Minor Direct 2nd Year</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="col-lg-5" style="padding: 83px 1em;"> 
                <?php
                    ...
                    $excel_url_1=$path.$subdomain[0]."/backend/sample_excel/Memorandum Sample.xlsx";
                    $excel_url_2=$path.$subdomain[0]."/backend/sample_excel/Consolidated Sample.xlsx";
                    $excel_url_3=$path.$subdomain[0]."/backend/sample_excel/UG_CGM_Sample.xlsx";
                    $excel_url_4=$path.$subdomain[0]."/backend/sample_excel/UG_Memorandum_Sample.xlsx";
                    $excel_url_5=$path.$subdomain[0]."/backend/sample_excel/ProvisionalCertificate.xlsx";
					$excel_url_6=$path.$subdomain[0]."/backend/sample_excel/CMM_Honors_Minors.xlsx";
					$excel_url_7=$path.$subdomain[0]."/backend/sample_excel/UG_CGM_2.xlsx";
					$excel_url_8=$path.$subdomain[0]."/backend/sample_excel/CMM_Honors_Minors_2.xlsx";
                ?>
...
function validateUpload() {
	...
	$.ajax({
		url:'<?= route('vbit-certificate.validateexcel')?>',
	    type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,
...
/*function uploadfile(){
	...
	$.ajax({
		url:'<?= route('vbit-certificate.uploadfile')?>',
	    type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/vbit/index.blade.php ENDPATH**/ ?>
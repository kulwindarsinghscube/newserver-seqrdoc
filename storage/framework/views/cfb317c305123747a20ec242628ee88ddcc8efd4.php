                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">
                                ...
                                <ol class="breadcrumb pull-right" style="background:transparent;font-size:14px;"><?php echo e(Breadcrumbs::render('backgroundmaster')); ?></ol>
                    ...
                    <div class="">
                        <ul class="nav nav-pills" id="pills-filter">
                            ...
                            <?php if(App\Helpers\SitePermissionCheck::isPermitted('background-master.excelExport')): ?>
                            <?php if(App\Helpers\RolePermissionCheck::isPermitted('background-master.excelExport')): ?>
                            <li style="float: right;">
                                <a href="<?php echo e(route('background-master.excelExport')); ?>" style="background: #0052CC;padding-top:5px; color: #fff;border-radius: 2px;box-shadow: 2px 2px 5px #999;border: 1px solid transparent;height: 35px;" id="report" ><i class="fa fa-file"></i> Generate Report</a> 
                            </li>
                            <?php endif; ?>
                            <?php endif; ?>

                            <?php if(App\Helpers\SitePermissionCheck::isPermitted('background-master.create')): ?>
                            <?php if(App\Helpers\RolePermissionCheck::isPermitted('background-master.create')): ?>
                            <li style="float: right;">
                                <button onclick="location.href = '<?php echo e(route('background-master.create')); ?>'" class="btn btn-theme" type="button" id="addtemplate"><i class="fa fa-plus"></i> Add Background Template</button>    
                            </li>
                            <?php endif; ?>
                            <?php endif; ?>
...
<script type="text/javascript">
    ...
    var bg_template = $('#example').dataTable({
        ...
        "bServerSide": true,
        "autoWidth": true,
        "sAjaxSource": "<?php echo e(URL::route('background-master.index',['status'=>1])); ?>",
        "aaSorting": [
            [0, "desc"]
        ],
        "oLanguage": {
...

        {
            ...
            mRender: function(v, t, o) {
                ...
                var editurl = '<?php echo e(route("background-master.edit", ":id")); ?>';
                ...
                var act_html = "<div class='btn-group'>"
                                ...
                                +"<?php if(App\Helpers\SitePermissionCheck::isPermitted('background-master.edit')): ?> <?php if(App\Helpers\RolePermissionCheck::isPermitted('background-master.edit')): ?><a href='"+editurl+"' data-toggle='tooltip' title='Edit background Template' data-placement='top' class='editrow'><i class='fa fa-edit fa-lg green'></i></a> <?php endif; ?> <?php endif; ?>"

                                +"<?php if(App\Helpers\SitePermissionCheck::isPermitted('background-master.showDetail')): ?> <?php if(App\Helpers\RolePermissionCheck::isPermitted('background-master.showDetail')): ?><a href='javascript:void(0);' onclick='openImage("+id+")' data-toggle='tooltip' title='Edit background Template' data-placement='top' class='editrow'><i class='fa fa-image fa-lg pink'></i></a><?php endif; ?> <?php endif; ?>"

                                // +"<?php if(App\Helpers\SitePermissionCheck::isPermitted('background-master.showDetail')): ?> <?php if(App\Helpers\RolePermissionCheck::isPermitted('background-master.showDetail')): ?><a href='"+showDetailurl+"' data-toggle='tooltip' title='Show background Template' data-placement='top' class='editrow'><i class='fa fa-image fa-lg pink'></i></a> <?php endif; ?> <?php endif; ?>"
    
                                +"<?php if(App\Helpers\SitePermissionCheck::isPermitted('background-master.show')): ?> <?php if(App\Helpers\RolePermissionCheck::isPermitted('background-master.show')): ?><a href='javascript:void(0);' onclick='preview("+ o['id'] +")' data-toggle='tooltip' title='Preview' data-placement='top' class='editrow bgTempletePreview'><i class='fa fa-fw fa-eye blue'></i></a><?php endif; ?> <?php endif; ?>"
    ...
    function preview(id) {
        ...
        var id = id;
            $.ajax({
                url: "<?php echo e(URL::route('background-master.show')); ?>",
                type: 'get',
                dataType:'html',
                data:{
                    id:id,
...
<script type="text/javascript">
    function openImage(id) {
        ...
        var id = id;
            $.ajax({
                url: "<?php echo e(URL::route('background-master.showDetail')); ?>",
                type: 'get',
                dataType:'html',
                data:{
                    id:id,
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/backgroundTemplateMaster/index.blade.php ENDPATH**/ ?>
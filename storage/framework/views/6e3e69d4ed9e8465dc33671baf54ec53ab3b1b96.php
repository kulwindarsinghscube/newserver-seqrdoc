...
<div class="container">
    ...
    <select class="form-control" id="institute-select">
        ...
        <?php $__currentLoopData = $institutes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $institute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($institute->site_id); ?>"><?php echo e($institute->site_url); ?></option>
...
$('#institute-select').on('change', function () {
    ...
    if ($.fn.DataTable.isDataTable('#courses-table')) {
        ...
        table = $('#courses-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '<?php echo e(route("get.institute.certificates")); ?>',
                data: function (d) {
       ...
       // Changes password slide toggle
        ...
        $("#update_pass").click(function(event) {
		  ...
		  if (!$('.change_pass_form').valid()) 
		   ...
		   {
       	    var url="<?php echo e(URL::route('gswebapp.profile.changepassword')); ?>";
...
<?php $__env->stopSection(); ?>	  
<?php echo $__env->make('StudentWallet.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/StudentWallet/documents/index.blade.php ENDPATH**/ ?>
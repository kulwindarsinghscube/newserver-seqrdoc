...
<script type="text/javascript">
	...
	var oTable = $('#example').DataTable({
        ...
        "bServerSide": true,
        "autoWidth": true,
        <?php if($subdomain[0]=="icat" || $subdomain[0]=="demo"){ ?>
        "aaSorting": [[4, "desc"] ],
        <?php } else{ ?>
        "aaSorting": [[3, "desc"] ],
        <?php } ?>
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\wwwroot\demo\resources\views/admin/pdf2pdf/templateMaster/index.blade.php ENDPATH**/ ?>
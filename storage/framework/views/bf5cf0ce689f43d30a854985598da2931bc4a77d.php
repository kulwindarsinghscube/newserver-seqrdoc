...
<div class="col-md-4 col-md-offset-4 col-sm-12 col-xs-12">
      ...
      <div class="card">
            ...
            <div class="text-center" >
                  <img style="width: 120px;" src="<?php echo e(\Config::get("constant.payment_image").'/mpesa_images.png'); ?>">
            </div>
...
function timeFunc() {
      ...
      var my_url="<?php echo e(URL::route('payment.mPesaTransactionProcess')); ?>";
            ...
            success:function(data){
                  ...
                  {     
                        ...
                        if(data.data.ResultCode == 0 || data.data.ResultCode == '0') {
                              ...
                              window.location.href = "<?php echo e(URL::route('payment.mPesaResponse')); ?>";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('webapp.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/webapp/payment/mPesaTranscationStatus.blade.php ENDPATH**/ ?>
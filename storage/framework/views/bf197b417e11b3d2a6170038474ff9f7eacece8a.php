                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">
                               ...
                               <ol class="breadcrumb pull-right" style="background:transparent;font-size:14px;"><?php echo e(Breadcrumbs::render('generateidcard')); ?></ol>
...
<script type="text/javascript">
    ...
    var oTable = $('#example').dataTable({
        ...
        "bServerSide": true,
        "autoWidth": true,
        "sAjaxSource": "<?php echo e(URL::route('idcards.index')); ?>",
        "aaSorting": [
            [1, "asc"]
        ],
        "oLanguage": {
        ...
        
        {
            ...
            mRender: function(v, t, o) {
                ...
                buttons += '<?php if(App\Helpers\SitePermissionCheck::isPermitted('idcards.manageExcel')): ?> <?php if(App\Helpers\RolePermissionCheck::isPermitted('idcards.manageExcel')): ?> <span style="cursor:pointer;margin-right:6px;"><i title="Generate PDF" data-id="'+o['id']+'" class="pdfGenerate fa fa-file-excel-o fa-lg blue"></i></span>' <?php endif; ?>  <?php endif; ?>;
        ...
        $.ajax({
            ...
            success: function(response) 
            {
                ...
                if(response.success == false){
                    ...
                    setTimeout(function(){
                            window.location = '<?php echo e(route("idcards.index")); ?>';
                        },3000)
                }
            }
        });
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/idCards/index.blade.php ENDPATH**/ ?>
				...
				bootbox.confirm("Are you sure to update password?",function(result){
					if(result){
						...
						$.ajax({
							...
							url: "<?php echo e(URL::route('raisoni.changepassword')); ?>",
							type: 'post',
							data:{
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('verify.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/verify/profile.blade.php ENDPATH**/ ?>
 ...
 <script type="text/javascript">
   ...
   // show information  Student's info
 	oTable.on('click', '#infoData', function () {
        ...
        var url_path="<?php echo e(URL::route('sand-box.scanHistory.getdata')); ?>";
...
.iconModalCss {
 ...
 <?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/sandboxing/scanHistory.blade.php ENDPATH**/ ?>
...
<div class="container">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><i class="fa fa fa-file-excel-o"></i> MVSR
        ...
        <div class="row">
            <div class="col-lg-7"> <br />
                <form method="post" id="processExcelForm" class="form-horizontal" enctype="multipart/form-data" action="<?=route('mvsr-certificate.uploadfile')?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="template_id" name="template_id">
                                ...
                                <option value="1" data-tempid="1">Consolidated Grade Card</option>
                                <option value="2" data-tempid="2">Provisional Certificate </option>
                                <option value="6" data-tempid="6">TRANSCRIPT PROVISIONAL CERTIFICATE </option>
                                <option value="3" data-tempid="3">Transcript</option>
                                <option value="4" data-tempid="4">Semester Grade Card Report </option>
                                <option value="5" data-tempid="5"> Semester Transcript Report </option>
                                <option value="7" data-tempid="7">PG CMM </option>
                                <option value="8" data-tempid="8">Consolidated Grade Card - Dynamic </option>
                                <option value="9" data-tempid="9">Minor. </option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="col-lg-5" style="padding: 83px 1em;"> 
                <?php
                    ...
                    $excel_url_1=$path.$subdomain[0]."/backend/sample_excel/Consolidated Grade Card Sample Excel.xlsx";
                    $excel_url_2=$path.$subdomain[0]."/backend/sample_excel/Provisional_Certificate_sampleExcel.xlsx";
                    $excel_url_3=$path.$subdomain[0]."/backend/sample_excel/Transcript_Sample Excel.xlsx";
                    $excel_url_4=$path.$subdomain[0]."/backend/sample_excel/Mvsr_grade_card_sample_excel.xlsx";
                    $excel_url_5=$path.$subdomain[0]."/backend/sample_excel/Mvsr_grade_card_sample_excel.xlsx";
                    $excel_url_6=$path.$subdomain[0]."/backend/sample_excel/Provisional_Certificate_sampleExcel.xlsx";
                     $excel_url_7=$path.$subdomain[0]."/backend/sample_excel/PG CMM.xlsx";
                     $excel_url_8=$path.$subdomain[0]."/backend/sample_excel/Consolidated Grade Card Dynamic Sample Excel.xlsx";
                     $excel_url_9=$path.$subdomain[0]."/backend/sample_excel/Mvsr_minor_sample_excel.xlsx";
                ?>
...
function validateUpload() {
	...
	$.ajax({
		url:'<?= route('mvsr-certificate.validateexcel')?>',
	    type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,
...
function uploadfile(startRow = 2, endRow = 2, highestRow = null) {
    ...
    $.ajax({
        url: '<?= route('mvsr-certificate.uploadfile') ?>',
        type: "POST",
        dataType: "JSON",
        data: fd,
        processData: false,
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/mvsr/index.blade.php ENDPATH**/ ?>
...
<i class="fa fa-info-circle iconModalCss" title="User Manual" id="paymentTransactionSandboxingClick"></i>
		</h1>
	<div class="">
...
<?php $__env->startSection('script'); ?>
  <script type="text/javascript">
   ...
   var oTable = $('#example').DataTable( {
        ...
        "sAjaxSource":"<?= URL::route('sandboxing.paymentTransaction.index',['status'=>1]) ?>",
		"aoColumns":[
		{
          	mData: "rownum",
          	bSortable:false,
...
$('#fail-pill').click(function(){
   ...
   var url="<?= URL::route('sandboxing.paymentTransaction.index',['status'=>0])?>";
   oTable.ajax.url(url);
   oTable.ajax.reload();
...
$("#success-pill").click(function(event) {
	...
	var url="<?= URl::route('sandboxing.paymentTransaction.index',['status'=>1])?>";
	oTable.ajax.url(url);
	oTable.ajax.reload();
	$('.loader').removeClass('hidden');
});
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/sandboxing/paymentTransaction.blade.php ENDPATH**/ ?>
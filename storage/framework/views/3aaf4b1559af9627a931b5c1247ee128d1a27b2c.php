	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<ol class="breadcrumb pull-right" style="background:transparent;font-size:14px;"><?php echo e(Breadcrumbs::render('idcardstatus')); ?></ol>
		...
		{mData: "created_on",
			...
			mRender: function(v, t, o) {
				...
				if(o.status == 'Received'){
					...
					buttons += '<?php if(App\Helpers\SitePermissionCheck::isPermitted('idcard-status.update.complete')): ?> <?php if(App\Helpers\RolePermissionCheck::isPermitted('idcard-status.update.complete')): ?><span style="cursor:pointer"><i title="update status" data-request_number="'+o.request_number+'" class="update_status fa fa-pencil-square fa-lg green"></i> </span> <?php endif; ?> <?php endif; ?>';
	...
	$.ajax({
		...
		success:function(response){
			if(response.success == false){
				...
				toastr["success"](response.message);
				setTimeout(function(){
                            window.location = '<?php echo e(route("idcard-status.index")); ?>';
                        },2000)
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/idcardStatus/index.blade.php ENDPATH**/ ?>
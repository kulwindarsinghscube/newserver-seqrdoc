...
<div class="container">
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header"><i class="fa fa fa-file-excel-o"></i> S.B CITY COLLEGE
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <!--
							...
							-->
            <h4 class="modal-title" id="myModalLabel2" style="display: none;">PDF is ready to download. <button
                type="button" class="btn btn-primary" id="btn_refresh1" style="margin-left: 45px;">Check Status</button>
            </h4>
            <h4 class="modal-title" id="myModalLabel3" style="display: none;">Cetificates are processing... Please wait
          ...
          <div class="modal-body">
            <h4 id="sandboxing_message" class="text-center" style="color: red;"><b>Under Sandboxing environment</b></h5>
              ...
              <div class="form-group" id="process" style="display:none;">
                <div class="progress">
                  <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuemin="0"
                    aria-valuemax="100" style="width: 1%;">1%
                  </div>
                </div>
              </div>
              <div class="form-group clearfix" id="loaderDiv" style="display: none;">
                ...
                <table class="table" style="max-width: 500px;border: 1px solid rgb(219 219 219) !important;">
                  ...
                  <tr id="totalTimeGenerationDiv" style="display: none;">
                    <td id="totalTimeGenerationText" style="width: 60%;">Total Time For Generation </td>
              ...
              <div class="form-group clearfix">
                ...
                <div id="upload_btn">
                  <a href="#" class="btn btn-theme col-lg-2 col-md-2 col-sm-12 col-xs-12 col-md-offset-7"
                    id="btn_updfile_back" class="close" data-dismiss="modal" aria-hidden="true"
                    style="display: none;"><i class="fa fa-arrow-left"></i>Back</a>
                  <button type="button" class="btn btn-theme" value="pdf_generate" id="pdf_generate" name="pdf_generate"
                    style="display: none;"><i class="fa fa-upload"></i>PDF Generate</button>
                </div>
              </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-7"> <br />
          <form method="post" id="processExcelForm" class="form-horizontal" enctype="multipart/form-data"
            action="<?=route('sbcity-certificate.uploadfile')?>">
            ...
            <div class="form-group">
              ...
              <label id="previewPdfCheckbox" style="position: absolute;margin: 3px 30px;color: #000000bd;"><input
                  type="checkbox" name="previewWithoutBg" id="previewWithoutBg"
                  style="height: 20px;width: 20px;vertical-align: bottom;" /> <span>Select this to preview without
...
$excel_url_1 = $path . $subdomain[0] . "/backend/sample_excel/sbcity_sample.xlsx";
$excel_url_2 = $path . $subdomain[0] . "/backend/sample_excel/cscacs_sample_certificate.xlsx";
                ?>
          <span style="display:none;" id="excel_url_1"><b>Please Click <a href="<?php echo e($excel_url_1); ?>" download>HERE</a> To
              Download Sample Excel</b></span>
          <span style="display:none;" id="excel_url_2"><b>Please Click <a href="<?php echo e($excel_url_2); ?>" download>HERE</a> To
              Download Sample Excel</b></span>
    ...
    <div class="col-sm-12">
      ...
      <blockquote>If the unique serial number is repeated or found duplicate in the excel data, then it will replace the
...
<script type="text/javascript">
  ...
  function validateUpload() {
    ...
    $.ajax({
      url: '<?= route('sbcity-certificate.validateexcel')?>',
      type: "POST",
      dataType: "JSON",
      data: fd,
      processData: false,
  ...
  var isLoading = false;
  function uploadfile(startRow = 4, endRow = 4, highestRow = null) {
    var fd = new FormData();
    var files = $('[name="field_file"]')[0].files[0];
    var token = "<?= csrf_token()?>";
    var previewPdf = $('#previewPdfValue').val();
    ...
    $.ajax({
      url: '<?= route('sbcity-certificate.uploadfile') ?>',
      type: "POST",
      dataType: "JSON",
      data: fd,
      processData: false,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/sbcity/index.blade.php ENDPATH**/ ?>
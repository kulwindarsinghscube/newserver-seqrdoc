...
<body>
	<style>
	body {
        background-image: url('<?php echo e(($subdomain[0] == "kmtc") ? asset("assets/media/auth/B4.jpg") : asset("assets/media/auth/bg4.jpg")); ?>');
	...
	<div class="row" style="margin-top: 15%;">
		<div class="col-xs-12">
			...
			<div class="col-md-4 col-sm-12 col-xs-12">
				...
				<img class="img-responsive center-block" src="<?php echo e(url('assets/media/auth/logo.PNG')); ?>" style="width:37%;">
				<?php } ?>
				 <?php if($subdomain[0] != 'kmtc'): ?>
				<h2 class="center-block" style="text-align: center; font-family: 'Abel', sans-serif; font-weight: bold; color:#fff;">
				   
				        Welcome to <?php echo e($sitename); ?> SeQR Web App
				    
				</h2>
				<h3 class="center-block" style="text-align: center;font-family: 'Abel', sans-serif;font-weight: bold;<?= ($subdomain[0]=='kmtc')?'color:#fff;':'color:#fff;'; ?>">Secure Documents Management System</h3>

				<?php else: ?>
				<h2 class="center-block" style="text-align: center; font-family: 'Abel', sans-serif; font-weight: bold; color:#fff;font-size: xxx-large;">
				        <?php echo e(strtoupper($sitename)); ?> Certificate Portal
				</h2>
				<?php endif; ?>
			</div>
			<div class="col-md-4 col-sm-12 col-xs-12">
							...
							<form method="POST" action="#" id="web_login">
								...
								<fieldset>
									...
									<div class="form-group">
										...
										<input class="form-control input-lg"  id="username_l" placeholder="Enter Email Id" name="username" type="text" autofocus required>
										<span id="username_errors" class="help-inline text-danger"><?=$errors->first('username')?></span>
									</div>
									<div class="form-group">
										<label>Password</label>
										<input class="form-control input-lg" id="password_l" placeholder="Enter Password" name="password" type="password" value="" required>
								  ...
								  <button type="submit" id="login" class="btn btn-lg <?php echo e(($subdomain[0]=='kmtc')?'btn-tpsdi':'btn-primary'); ?> btn-block"><i class="fa fa-unlock"></i> Login</button>
								  </div>
...
<style>
	...
	.btn-tpsdi:focus, .btn-tpsdi.focus {
	    color: #fff;
	    background-color: #fab906;
	    border-color: #0062cc;
	...
	.btn-tpsdi:disabled, .btn-tpsdi.disabled {
	    color: #fff;
	    background-color: #6d1927;
	    border-color: #6d1927;
	    opacity: 0.65;
...
$(document).ready(function(){
	...
	$("#login,#verify,#set_password").click(function(e){
		...
		e.preventDefault();		
		var login_url="<?php echo e(URL::route('inswebapp.login')); ?>";
		...
		$("#web_login").ajaxSubmit({
              ...
              success:function(data)
              {
                if(data.success==true)
                {
                   ...
                   window.location.href="<?php echo e(URL::route('insdocuments')); ?>";
...
</script><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/auth/inststudentlogin.blade.php ENDPATH**/ ?>
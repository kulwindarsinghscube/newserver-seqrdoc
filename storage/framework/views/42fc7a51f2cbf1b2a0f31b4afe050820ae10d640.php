...
<div class="container">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><i class="fa fa fa-file-excel-o"></i> Nnp
                    <ol class="breadcrumb pull-right" style="background:transparent;font-size:14px;">
                        <?php echo e(Breadcrumbs::render('generatespitcertificates')); ?>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel3" style="display: none;">Cetificates are processing...
                            Please wait
                            ..... <img src="/backend/images/loading.gif"> <button type="button" class="btn btn-primary"
                                id="btn_refresh" style="margin-left: 45px;">Check Status</button></h4>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-7"> <br />
                    <form method="post" id="processExcelForm" class="form-horizontal" enctype="multipart/form-data"
                        action="<?=route('cscacs-certificate.uploadfile')?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" id="template_id" name="template_id">
                                    ...
                                    <option value="2" data-tempid="2">Certificate</option>
...
$excel_url_1 = $path . $subdomain[0] . "/backend/sample_excel/cscacs_sample.xlsx";
$excel_url_2 = $path . $subdomain[0] . "/backend/sample_excel/Cohort_NNP_Sample.xlsx";
                ?>
                    <span style="display:none;" id="excel_url_1"><b>Please Click <a href="<?php echo e($excel_url_1); ?>"
                                download>HERE</a> To
                            Download Sample Excel</b></span>
        ...
        <div class="col-sm-12">
            ...
            <blockquote>If the unique serial number is repeated or found duplicate in the excel data, then it will
                replace the
                already existing data (making them inactive), with the current excel data.</blockquote>
...
<script type="text/javascript">
    ...
    function validateUpload() {
        ...
        $.ajax({
            url: '<?= route('nnp-certificate.validateexcel')?>',
            type: "POST",
            dataType: "JSON",
            data: fd,
            processData: false,
    ...
    function uploadfile(startRow = 2, endRow = 2, highestRow = null) {
        ...
        $.ajax({
            url: '<?= route('nnp-certificate.uploadfile') ?>',
            type: "POST",
            dataType: "JSON",
            data: fd,
            processData: false,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/nnp/index.blade.php ENDPATH**/ ?>
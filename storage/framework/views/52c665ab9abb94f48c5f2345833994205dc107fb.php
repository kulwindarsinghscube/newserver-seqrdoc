                        ...
                        <div class="col-lg-12">
                            <h1 class="page-header">
                                ...
                                <ol class="breadcrumb pull-right" style="background:transparent;font-size:14px;">
                                    <?php echo e(Breadcrumbs::render('generateidcard')); ?>
...
<script type="text/javascript">
    ...
    $('#doc_type').change(function () {
        ...
        if(doc_type != '') {
            $.ajax({
                url: "<?php echo e(route('functionalusers.getTemplates', ':doc')); ?>".replace(':doc', doc_type),
                type: 'GET',
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/idCards/old_map.blade.php ENDPATH**/ ?>
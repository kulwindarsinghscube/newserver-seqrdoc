...
<div id="">
    <div class="container-fluid">
        ...
        <div class="col-lg-12">
            <a href="<?php echo e(route('background-master.index')); ?>" class="btn btn-theme" id="backto"><i class="fa fa-arrow-left"></i> Back</a>	
        </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group clearfix">
                        ...
                        <div class="col-md-8">
                            ...
                            <span class='text-danger'><?php echo e($errors->first('background_name')); ?></span>
                        </div>
                    </div>
                    <div class="form-group clearfix">
                    ...
                    <div class="form-group clearfix">
                        ...
                        <div class="col-md-6">
                            ...
                            ?>
                            <?php if($get_file_aws_local_flag['file_aws_local'] == '1'): ?>
                                <img data-enlargeable src="<?= Config::get('constant.amazone_path').$subdomain[0]?>/backend/canvas/bg_images/<?php echo e($backgroundTemplate->image_path); ?>" style="height: 100px;width:100px;" /> <br>
                            <?php else: ?>
                                <img data-enlargeable src="<?= Config::get('constant.local_base_path').$subdomain[0]?>/backend/canvas/bg_images/<?php echo e($backgroundTemplate->image_path); ?>" style="height: 100px;width:100px;" /> <br>
                            <?php endif; ?>
                            <?php echo e($backgroundTemplate->image_path); ?>
                    ...
                    <div class="form-group clearfix">
                        ...
                        <div class="col-md-9">
                            ...
                            <span class='text-danger'><?php echo e($errors->first('image_path')); ?></span>
                    ...
                    <div class="form-group clearfix tmpl">
                        ...
                        <a href="<?php echo e(route('background-master.index')); ?>" class="btn btn-danger col-lg-2 col-md-2 col-md-offset-1 col-sm-12 col-xs-12" id="btnCancel"><i class="fa fa-close"></i>Cancel</a>
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/backgroundTemplateMaster/edit.blade.php ENDPATH**/ ?>
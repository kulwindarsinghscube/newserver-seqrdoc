...
$(document).ready(function(){
	...
	oTable.on('click','#infoData',function(e){
		$id = $(this).data('id');
		var token = "<?php echo e(csrf_token()); ?>";
		var url = "<?php echo e(URL::route('document-request-data')); ?>"
		$.post(url,
...
function preview(id)
{
	...
	var id = id;
    $.ajax({
        url: "<?php echo e(URL::route('document-request-data')); ?>",
        type: 'get',
        dataType:'json',
        data:{
            id:id,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/raisoni/seqrDocumentRequests/index.blade.php ENDPATH**/ ?>
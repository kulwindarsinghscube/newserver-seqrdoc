...
<?php $__env->startSection('content'); ?>
    ...
    <?php if($is_payment_completed || $isPdfEligibleForApproval || $isPdfApproved): ?>
        <style>
            .on_complete {
                ...
                <div class="col-lg-12">
                    <form id="verificationForm" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                            ...
                            <?php if($is_admin_action_pending): ?>
                                <div class="row"
                            ...
                            <?php endif; ?>
                            <?php if(@$student->status == 'admin performed correction but student’s re-acknowledgement pending'): ?>
                                <div class="row"
                                    style="text-align: center; border: 1px solid #d3d3d3; margin-bottom: 12px; padding-bottom: 10px !important;">
                            ...
                            <div class="row is_payment_pending <?php echo e(!$is_payment_pending ? 'hidden_1' : ''); ?>"
                                style="text-align: center; border: 1px solid #d3d3d3; margin-bottom: 12px; padding-bottom: 10px !important;">
                            ...
                            <div class="row is_payment_completed <?php echo e(!$is_payment_completed ? 'hidden_1' : ''); ?>"
                                style="text-align: center; border: 1px solid #d3d3d3; margin-bottom: 12px; padding-bottom: 10px !important;">
                                <h4 style="color:#eea959">Status : Payment is completed, but PDF approval is still pending.
                                </h4>
                            </div>

                            <div class="row isPdfApproved <?php echo e(!$isPdfApproved ? 'hidden_1' : ''); ?>"
                                style="text-align: center; border: 1px solid #d3d3d3; margin-bottom: 12px; padding-bottom: 10px !important;">
                                <h4 style="color:#55c047"> Status : <?php echo e($status); ?></h4>
                            </div>
                        ...
                        <?php if(!empty($student->correction_message)): ?>
                                ...
                                <div class="col-md-12"> 
                                    <div class="row" style="text-align: center; margin-bottom: 12px; padding-bottom: 0px !important; color:red">
                                        <p style="color: #FF9800; font-size: 18px; text-align: justify; line-height: 1.5; padding: 2%;">
                                                ...
                                                <i style="color: #32404D;    font-size: 14px;"><?php echo e($student->correction_message); ?></i>
                                        </p>  
                                    </div> 
                                </div>
                            </div>
                        ...
                        <div class="row mb-4 fields_div">
                            <div class="col-md-3">
                                <div class="border p-3" style="font-size: 20px">
                                    <label for="prn">PRN: <?php echo e(@$student->prn); ?></p></label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4 fields_div">
                            <div class="col-md-3">
                                <div class="form-group border p-3">
                                    ...
                                    <p id="full_name" class="form-control-plaintext"><?php echo e(@$student->full_name); ?></p>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-check">
                                    <input type="radio" class="radio_option" id="full_name_correct" name="full_name_correct" value="1"
                                        <?php echo e(@$student->studentAckLogs->fn_en_status == 1 || empty(@$student->studentAckLogs) ? 'checked' : ''); ?>
                                ...
                                <div class="form-check on_complete">
                                    <input type="radio" class="incorrect_option radio_option" id="full_name_incorrect" name="full_name_correct" value="0"
                                        <?php echo e(@$student->studentAckLogs->fn_en_status === 0 ? 'checked' : ''); ?>
                            ...
                            <div class="col-md-6 remark-upload-section">
                                <div class="form-group border p-3">
                                    ...
                                    <textarea id="full_name_correction_remarks" name="full_name_correction_remarks" class="form-control"><?php echo e(@$student->studentAckLogs->fn_en_remark); ?></textarea>
                                    ...
                                    <?php if(@$student->studentAckLogs->fn_en_image): ?>
                                        <a target="_blank"
                                            href="<?php echo e(url($baseDirectoryPath . $student->studentAckLogs->fn_en_image)); ?>">
                                            <?php echo e(@$student->studentAckLogs->fn_en_image); ?></a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4 fields_div">
                            <div class="col-md-3">
                                <div class="form-group border p-3">
                                    ...
                                    <p id="full_name_hindi" class="form-control-plaintext"><?php echo e(@$student->full_name_hindi); ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-check">
                                    <input type="radio" class="radio_option" id="full_name_hindi_correct" name="full_name_hindi_correct"
                                        value="1"
                                        <?php echo e(@$student->studentAckLogs->fn_hi_status == 1 || empty(@$student->studentAckLogs) ? 'checked' : ''); ?>
                                ...
                                <div class="form-check on_complete">
                                    <input type="radio" class="incorrect_option radio_option" id="full_name_hindi_incorrect" name="full_name_hindi_correct"
                                        value="0" <?php echo e(@$student->studentAckLogs->fn_hi_status === 0 ? 'checked' : ''); ?>
                            ...
                            <div class="col-md-6 remark-upload-section">
                                <div class="form-group border p-3">
                                    ...
                                    <textarea id="full_name_hindi_correction_remarks" name="full_name_hindi_correction_remarks" class="form-control"><?php echo e(@$student->studentAckLogs->fn_hi_remark); ?></textarea>
                                   
                                    <input type="file" name="full_name_hindi_correction_file" class="form-control mt-2"
                                        style="margin-top: 1%" accept="image/*">
                                         <p style="color:orange;">Grade Card or Aadhaar Card is the preferred option.</p>

                                    <?php if(@$student->studentAckLogs->fn_hi_image): ?>
                                        <a target="_blank"
                                            href="<?php echo e(url($baseDirectoryPath . $student->studentAckLogs->fn_hi_image)); ?>">
                                            <?php echo e(@$student->studentAckLogs->fn_hi_image); ?></a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4 fields_div">
                            <div class="col-md-3">
                                <div class="form-group border p-3">
                                    ...
                                    <p  class="form-control-plaintext"><?php echo e(@$student->father_name); ?></p>
                            ...
                            <div class="col-md-3">
                                <div class="form-check">
                                    <input type="radio" class="radio_option" id="father_name_correct" name="father_name_correct"
                                        value="1"
                                        <?php echo e(@$student->studentAckLogs->ftn_en_status == 1 || empty(@$student->studentAckLogs) ? 'checked' : ''); ?>
                                ...
                                <div class="form-check on_complete">
                                    <input type="radio" class="incorrect_option radio_option" id="father_name_incorrect" name="father_name_correct"
                                        value="0"
                                        <?php echo e(@$student->studentAckLogs->ftn_en_status === 0 ? 'checked' : ''); ?>
                            ...
                            <div class="col-md-6 remark-upload-section">
                                <div class="form-group border p-3">
                                    ...
                                    <textarea id="father_name_correction_remarks" name="father_name_correction_remarks" class="form-control"><?php echo e(@$student->studentAckLogs->ftn_en_remark); ?></textarea>
                                    
                                    <input type="file" name="father_name_correction_file" class="form-control mt-2"
                                        style="margin-top: 1%" accept="image/*">
                                         <p style="color:orange;">Grade Card or Aadhaar Card is the preferred option.</p>
                                    <?php if(@$student->studentAckLogs->ftn_en_image): ?>
                                        <a target="_blank"
                                            href="<?php echo e(url($baseDirectoryPath . $student->studentAckLogs->ftn_en_image)); ?>">
                                            <?php echo e(@$student->studentAckLogs->ftn_en_image); ?></a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4 fields_div">
                            <div class="col-md-3">
                                <div class="form-group border p-3">
                                    ...
                                    <input class="form-control" id="father_name_hindi" name="father_name_hindi" readonly
                                        type="text" value="<?php echo e(@$student->father_name_hindi); ?>">
                            ...
                            <div class="col-md-3">
                                <div class="form-check">
                                    <input type="radio" class="radio_option" id="father_name_hindi_correct" name="father_name_hindi_correct"
                                        value="1"
                                        <?php echo e(@$student->studentAckLogs->ftn_hi_status == 1 || empty(@$student->studentAckLogs) ? 'checked' : ''); ?>
                                ...
                                <div class="form-check on_complete">
                                    <input type="radio" class="incorrect_option radio_option" id="father_name_hindi_incorrect"
                                        ...
                                        <?php echo e(@$student->studentAckLogs->ftn_hi_status === 0 ? 'checked' : ''); ?>
                            ...
                            <div class="col-md-6 remark-upload-section">
                                <div class="form-group border p-3">
                                    ...
                                    <textarea id="father_name_hindi_correction_remarks" name="father_name_hindi_correction_remarks" class="form-control"><?php echo e(@$student->studentAckLogs->ftn_hi_remark); ?></textarea>
                                   
                                    <input type="file" name="father_name_hindi_correction_file"
                                        class="form-control mt-2" style="margin-top: 1%" accept="image/*">
                                         <p style="color:orange;">Grade Card or Aadhaar Card is the preferred option.</p>
                                    <?php if(@$student->studentAckLogs->ftn_hi_image): ?>
                                        <a target="_blank"
                                            href="<?php echo e(url($baseDirectoryPath . $student->studentAckLogs->ftn_hi_image)); ?>">
                                            <?php echo e(@$student->studentAckLogs->ftn_hi_image); ?></a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4 fields_div">
                            ...
                            <div class="col-md-3">
                                <div class="form-check">
                                    <input type="radio" class="radio_option" id="mother_name_correct" name="mother_name_correct"
                                        value="1"
                                        <?php echo e(@$student->studentAckLogs->mn_en_status == 1 || empty(@$student->studentAckLogs) ? 'checked' : ''); ?>
                                ...
                                <div class="form-check on_complete">
                                    <input type="radio" class="incorrect_option radio_option" id="mother_name_incorrect" name="mother_name_correct"
                                        value="0"
                                        <?php echo e(@$student->studentAckLogs->mn_en_status === 0 ? 'checked' : ''); ?>
                            ...
                            <div class="col-md-6 remark-upload-section">
                                <div class="form-group border p-3">
                                    ...
                                    <textarea id="mother_name_correction_remarks" name="mother_name_correction_remarks" class="form-control"><?php echo e(@$student->studentAckLogs->mn_en_remark); ?></textarea>
                                   
                                    <input type="file" name="mother_name_correction_file" class="form-control mt-2"
                                        style="margin-top: 1%" accept="image/*">
                                         <p style="color:orange;">Grade Card or Aadhaar Card is the preferred option.</p>
                                    <?php if(@$student->studentAckLogs->mn_en_image): ?>
                                        <a target="_blank"
                                            href="<?php echo e(url($baseDirectoryPath . $student->studentAckLogs->mn_en_image)); ?>">
                                            <?php echo e(@$student->studentAckLogs->mn_en_image); ?></a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4 fields_div">
                            <div class="col-md-3">
                                <div class="form-group border p-3">
                                    ...
                                    <input class="form-control" id="mother_name_hindi" name="mother_name_hindi" readonly
                                        type="text" value="<?php echo e(@$student->mother_name_hindi); ?>">
                            ...
                            <div class="col-md-3">
                                <div class="form-check">
                                    <input type="radio" class="radio_option" id="mother_name_hindi_correct" name="mother_name_hindi_correct"
                                        value="1"
                                        <?php echo e(@$student->studentAckLogs->mn_hi_status == 1 || empty(@$student->studentAckLogs) ? 'checked' : ''); ?>
                                ...
                                <div class="form-check on_complete">
                                    <input type="radio" class="incorrect_option radio_option" id="mother_name_hindi_incorrect"
                                        ...
                                        <?php echo e(@$student->studentAckLogs->mn_hi_status === 0 ? 'checked' : ''); ?>
                            ...
                            <div class="col-md-6 remark-upload-section">
                                <div class="form-group border p-3">
                                    ...
                                    <textarea id="mother_name_hindi_correction_remarks" name="mother_name_hindi_correction_remarks" class="form-control"><?php echo e(@$student->studentAckLogs->mn_hi_remark); ?></textarea>
                                   
                                    <input type="file" name="mother_name_hindi_correction_file"
                                        class="form-control mt-2" style="margin-top: 1%" accept="image/*">
                                         <p style="color:orange;">Grade Card or Aadhaar Card is the preferred option.</p>
                                    <?php if(@$student->studentAckLogs->mn_hi_image): ?>
                                        <a target="_blank"
                                            href="<?php echo e(url($baseDirectoryPath . $student->studentAckLogs->mn_hi_image)); ?>">
                                            <?php echo e(@$student->studentAckLogs->mn_hi_image); ?></a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4 fields_div">
                            <div class="col-md-3">
                                <div class="form-group border p-3">
                                    ...
                                    <p id="program_english" class="form-control-plaintext"><?php echo e(@$student->course_name); ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-check">
                                    <input type="radio" class="radio_option" id="program_english_correct" name="program_english_correct"
                                        value="1"
                                        <?php echo e(@$student->studentAckLogs->cs_en_status == 1 || empty(@$student->studentAckLogs) ? 'checked' : ''); ?>
                                ...
                                <div class="form-check on_complete">
                                    <input type="radio" class="incorrect_option radio_option" id="program_english_incorrect" name="program_english_correct"
                                        value="0"
                                        <?php echo e(@$student->studentAckLogs->cs_en_status === 0 ? 'checked' : ''); ?>
                            ...
                            <div class="col-md-6 remark-upload-section">
                                <div class="form-group border p-3">
                                    ...
                                    <textarea id="program_english_correction_remarks" name="program_english_correction_remarks" class="form-control"><?php echo e(@$student->studentAckLogs->cs_en_remark); ?></textarea>
                                   
                                    <input type="file" name="program_english_correction_file"
                                        class="form-control mt-2" style="margin-top: 1%" accept="image/*">
                                         <p style="color:orange;">Grade Card or Aadhaar Card is the preferred option.</p>
                                    <?php if(@$student->studentAckLogs->cs_en_image): ?>
                                        <a target="_blank"
                                            href="<?php echo e(url($baseDirectoryPath . $student->studentAckLogs->cs_en_image)); ?>">
                                            <?php echo e(@$student->studentAckLogs->cs_en_image); ?></a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4 fields_div">
                            <div class="col-md-3">
                                <div class="form-group border p-3">
                                    ...
                                    <p id="program_hindi" class="form-control-plaintext">
                                        <?php echo e(@$student->course_name_hindi); ?></p>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-check">
                                    <input type="radio" class="radio_option" id="program_hindi_correct" name="program_hindi_correct"
                                        value="1"
                                        <?php echo e(@$student->studentAckLogs->cs_hi_status == 1 || empty(@$student->studentAckLogs) ? 'checked' : ''); ?>
                                ...
                                <div class="form-check on_complete">
                                    <input type="radio" class="incorrect_option radio_option" id="program_hindi_incorrect" name="program_hindi_correct"
                                        value="0"
                                        <?php echo e(@$student->studentAckLogs->cs_hi_status === 0 ? 'checked' : ''); ?>
                            ...
                            <div class="col-md-6 remark-upload-section">
                                <div class="form-group border p-3">
                                    ...
                                    <textarea id="program_hindi_correction_remarks" name="program_hindi_correction_remarks" class="form-control"><?php echo e(@$student->studentAckLogs->cs_hi_remark); ?></textarea>
                                   
                                    <input type="file" name="program_hindi_correction_file" class="form-control mt-2"
                                        style="margin-top: 1%" accept="image/*">
                                         <p style="color:orange;">Grade Card or Aadhaar Card is the preferred option.</p>
                                    <?php if(@$student->studentAckLogs->cs_hi_image): ?>
                                        <a target="_blank"
                                            href="<?php echo e(url($baseDirectoryPath . $student->studentAckLogs->cs_hi_image)); ?>">
                                            <?php echo e(@$student->studentAckLogs->cs_hi_image); ?></a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4 fields_div">
                            <div class="col-md-3">
                                <div class="form-group border p-3">
                                    ...
                                    <p id="secondary_email" class="form-control-plaintext">
                                        <?php echo e(@$student->secondary_email); ?></p>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-check">
                                    <input type="radio" class="radio_option" id="email_correct" name="email_correct" value="1"
                                        <?php echo e(@$student->studentAckLogs->se_status == 1 || empty(@$student->studentAckLogs) ? 'checked' : ''); ?>
                                ...
                                <div class="form-check on_complete">
                                    <input type="radio" class="incorrect_option radio_option" id="email_incorrect" name="email_correct" value="0"
                                        <?php echo e(@$student->studentAckLogs->se_status === 0 ? 'checked' : ''); ?>
                            ...
                            <div class="col-md-6 remark-upload-section">
                                <div class="form-group border p-3">
                                    ...
                                    <textarea id="secondary_email_correction_remarks" name="secondary_email_correction_remarks" class="form-control"><?php echo e(@$student->studentAckLogs->se_remark); ?></textarea>
                                   
                                    <input type="file" name="secondary_email_correction_file"
                                        class="form-control mt-2" style="margin-top: 1%" accept="image/*">
                                     <?php if(@$student->studentAckLogs->se_image): ?>
                                        <a target="_blank"
                                            href="<?php echo e(url($baseDirectoryPath . $student->studentAckLogs->se_image)); ?>">
                                            <?php echo e(@$student->studentAckLogs->se_image); ?></a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group border p-3">
                                    ...
                                    <div class="form-check">
                                            <input class="form-check-input" type="radio" name="collection_mode"
                                                ...
                                                <?php if($student->collection_mode == 'Attending Convocation'): ?> checked <?php endif; ?>>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="collection_mode"
                                                ...
                                                <?php if($student->collection_mode == 'By Post'): ?> checked <?php endif; ?>>
                                            <label class="form-check-label radio_button_lable" for="by_post">
                                                Receiving Certificate by Post  &nbsp;&nbsp; &nbsp;<span style="">(Rs.3000/-)</span>
                        ...
                        <div id="in_person_details"
                            style="background-color: #e6fbf1;<?php if($student->collection_mode == 'Attending Convocation'): ?> display:block !important; <?php endif; ?>"
                            ...
                            <div class="col-md-3">
                                <div class="form-group border p-3">
                                    ...
                                    <select class="form-control" id="attire_size" name="attire_size">
                                        ...
                                        <option value="SXX" <?php echo e(@$student->attire_size == 'SXX' ? 'selected' : ''); ?>>SXX</option>

                                        <option value="XS" <?php echo e(@$student->attire_size == 'XS' ? 'selected' : ''); ?>>XS</option>
                                        <option value="S" <?php echo e(@$student->attire_size == 'S' ? 'selected' : ''); ?>>S</option>
                                        <option value="M" <?php echo e(@$student->attire_size == 'M' ? 'selected' : ''); ?>>M</option>
                                        <option value="L" <?php echo e(@$student->attire_size == 'L' ? 'selected' : ''); ?>>L</option>
                                        <option value="XL" <?php echo e(@$student->attire_size == 'XL' ? 'selected' : ''); ?>>XL</option>
                                        <option value="XLL" <?php echo e(@$student->attire_size == 'XLL' ? 'selected' : ''); ?>>XLL</option>
                                        <option value="2XL" <?php echo e(@$student->attire_size == '2XL' ? 'selected' : ''); ?>>2XL</option>
                                        <option value="3XL" <?php echo e(@$student->attire_size == '3XL' ? 'selected' : ''); ?>>3XL</option>
                                        <option value="4XL" <?php echo e(@$student->attire_size == '4XL' ? 'selected' : ''); ?>>4XL</option>
                                        <option value="5XL" <?php echo e(@$student->attire_size == '5XL' ? 'selected' : ''); ?>>5XL</option>
                                    </select>
                                        ...
                                        <a onclick="$('.attire_size_div').toggle()"
                                            data-href="<?php echo e(url($baseDirectoryPath2 . '/attrie_size.png')); ?>"  style="cursor: pointer;"
                                            target="_blank">Click here to view the size chart</a>
                                        <div class="attire_size_div" style="display: none">
                                            <img src="<?php echo e(url($baseDirectoryPath2 . '/attrie_size.png')); ?>"
                        ...
                        <div id="by_post_details"
                            style="<?php if($student->collection_mode == 'By Post'): ?> display:block !important; <?php endif; ?> background-color: #e6fbf1;"
                            class="row mb-4 fields_div conditional-fields ">
                            <div class="col-md-6">
                                <div class="form-group border p-3">
                                    ...
                                    <textarea class="form-control" name="delivery_address" id="delivery_address" cols="50" rows="4"
                                        placeholder="Street Address, City, State/Province"><?php echo e(@$student->delivery_address); ?></textarea>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <label for="postal_code">Pincode:</label>
                                <input type="text" value="<?php echo e(@$student->delivery_pincode); ?>" class="form-control"
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-control" id="delivery_country" name="delivery_country"
                                    value="<?php echo e(@$student->delivery_country); ?>">
                                    ...
                                    <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($value->name); ?>"
                                            <?php echo e(@$student->delivery_country == $value->name ? 'selected' : ''); ?>>
                                ...
                                <div class="form-group border p-3">
                                    <label>
                                        <input type="checkbox" name="student_declaration" value="1"
                                            <?php if(@$student->student_declaration == 1): ?> checked <?php endif; ?> required>
                        ...
                        <button type="submit" id="submitBtn" 
                            class="btn btn-primary submit_button mt-4 <?php echo e(!(!$isReadonly && !$is_payment_pending) ? 'hidden_1' : ''); ?>">Save & Make Payment</button>



                        <a href="<?php echo e(route('convo_student.payment')); ?>"
                            class="btn btn-primary mt-4 make_payment_button <?php echo e(!$is_payment_pending ? 'hidden_1' : ''); ?>">Make
                            Payment</a>
                                ...
                                <?php if(!empty($student->certificate_pdf)): ?>
                                    <div class="row pdf_view" style="display:none;margin-top:2%">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <embed src="<?php echo e($certificate_pdf); ?>?t=<?php echo e(time()); ?>#toolbar=0&navpanes=0&scrollbar=0"
                    ...
                    <?php endif; ?>
                    <?php endif; ?>
                    <div class="row isPdfEligibleForApproval <?php echo e(!$isPdfEligibleForApproval ? 'hidden_1' : ''); ?>"
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $convo_student_logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $convo_student_log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($convo_student_log->full_name ? $convo_student_log->full_name : '-'); ?>
                                            ...
                                            <td><?php echo e($convo_student_log->last_name ? $convo_student_log->last_name : '-'); ?>
                                            ...
                                            <td><?php echo e($convo_student_log->cohort_id ? $convo_student_log->cohort_id : '-'); ?>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($payment->txn_date->format('Y-m-d h:i A')); ?></td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <br> <br>
                    You have already paid RS.<?php echo e($paid_amount); ?>/-.
                    <br><br> Please remit the remaining balance of RS. <?php echo e((3000-$paid_amount)); ?>/-.
...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        $('#pdfApproveButton').on('click', function() {
            ...
            $.ajax({
                url: '<?php echo e(route('convo_student.approve_pdf_preview')); ?>', // Replace with your server endpoint
    ...
    <script>
        ...
        $('#change_collection_mode_btn').on('click', function(e) {
            ...
            var url = "<?php echo e(route('convo_student.change_collection_mode_payment', ':size')); ?>".replace(':size', size);
...
<script>
    $(document).ready(function() {
        ...
        $('#cropButton_close').on('click', function() {
            ...
            $("#verificationForm").validate().element($('#photograph'));
...
<?php echo $__env->make('convodataverification.student.pages.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/convodataverification/student/pages/index.blade.php ENDPATH**/ ?>
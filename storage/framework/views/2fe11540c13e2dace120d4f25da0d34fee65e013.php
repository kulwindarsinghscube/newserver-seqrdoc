...
$(document).ready(function(){
      ...
      var oTable = $('#example').DataTable( {
        "processing": true,
        "serverSide": true,
         "sAjaxSource": "<?php echo e(URL::route('verify.verification.status')); ?>",
        "order": [[6, 'desc']],
            "bInfo":false,
            "aoColumns": [
      ...
      oTable.on('click','#infoData',function(e){
            ...
            $.post("<?php echo e(URL::route('verify.verification.status.info')); ?>",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('verify.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/verify/verification_status.blade.php ENDPATH**/ ?>
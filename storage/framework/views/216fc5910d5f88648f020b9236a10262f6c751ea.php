			...
			<div class="clearfix">
				...
				<div id="">
					<div class="container-fluid">
						...
						<div class="row">
							<a href="<?php echo e(URL::route('template-master.index')); ?>" class="btn btn-theme"><i class="fa fa-arrow-left"></i> Back</a>	
						</div>
						<form id="savefrm" class="savefrm"  action="" method="post">
								<input type="hidden" name="id" value="<?php echo e($template_data['id']); ?>">		
								<!-- start pratik code   -->
									...
									<div class="panel panel-primary" style="margin: 15px auto; width: 800px;">
										...
										<div class="panel-body">
											<div class="form-group">
												<h2>Template : <?php echo e($template_data['actual_template_name']); ?></h2>
											</div>
   ...
   else
   {
	...
	$('.savefrm').validate({
	  ...
	  submitHandler: function(form) {
	     ...
	     var index_page="<?php echo e(URL::route('template-master.index')); ?>";
		         var url = " <?php echo e(URL::route('templateMaster.template-map.uploadcolumns')); ?> ";
		...
		//get mapping columns form Excel sheet
		 $("#btn_updfile").click(function(e){
            ...
            var val = $(this).val();
            var url = " <?php echo e(URL::route('templateMaster.template-map.uploadmap')); ?> ";
            var method_type = 'post';
      ...
      // database connection request
		$(".btn_connection").click(function(event) {	
            ...
            var url="<?php echo e(URL::route('templateMaster.template-map.mapdatabase')); ?>";
            var token="<?php echo e(csrf_token()); ?>";
            var method_type="post";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/templateMaster/template_map.blade.php ENDPATH**/ ?>
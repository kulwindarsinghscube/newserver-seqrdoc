...
function ajaxCall(val,update='0'){
	...
	$.ajax({
        url: "<?php echo e(URL::route('insdashboard.store')); ?>",
        type: 'post',
        data:{
            qrcode:qrcode,
            _token:token,
...
<?php echo $__env->make('InstituteStudentWallet.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/InstituteStudentWallet/dashboard/show.blade.php ENDPATH**/ ?>
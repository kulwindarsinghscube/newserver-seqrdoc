...
<div class="container">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><i class="fa fa fa-file-excel-o"></i> BESTIU
        ...
        <div class="row">
            <div class="col-lg-7"> <br />
                <form method="post" id="processExcelForm" class="form-horizontal" enctype="multipart/form-data" action="<?=route('bestiu-certificate.uploadfile')?>">
                    <input type="hidden" name="func" id="func" value="uploadFile"> 
                    <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>"> 
                  
                    <div class="form-group">
                                <label class="control-label col-sm-4" id="generate_title" for="previewPdf">Generating Preview PDF:</label>
                                <label class="switch">  
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="temp">Template:</label>
                        <div class="col-sm-8">
                            <select class="form-control" id="template_id" name="template_id">
                                <option value="0" data-tempid="0">Select Template</option>
                                <option value="1" data-tempid="1">Degree Certificate</option>
                                 <option value="19" data-tempid="19">Degree Certificate new</option>
                                <option value="2" data-tempid="2">Provisional Degree Certificate</option>
                                <option value="3" data-tempid="3">Agriculture 2018 Batch (Transcript)</option>
                                <option value="4" data-tempid="4">Grade Card Old</option>
                                <option value="10" data-tempid="10">Grade Card With Supplementary Exam Old</option>                       
                                <option value="9" data-tempid="9">Grade Card </option>
                                <option value="5" data-tempid="5">Grade Card With Supplementary Exam</option>                       
                                <option value="6" data-tempid="6">Agriculture 2019 Batch (Transcript) Old</option>                       
                                <option value="7" data-tempid="7">Forestry 2019 Batch (Transcript)</option>
								                <option value="8" data-tempid="8">Grade Card (B Tech)</option>
                                <option value="20" data-tempid="20">New Grade Card (B Tech)</option>
                                <option value="11" data-tempid="11">B.Tech CMM (Transcript)</option>                       
                                <option value="12" data-tempid="12">Agriculture 2020-2024 Batch (Transcript) New</option>   
                                <option value="13" data-tempid="13">CMMT BVoc</option>        
                                <option value="14" data-tempid="14">CMM-SEM1&2</option>    
                                <option value="15" data-tempid="15">B.Tech CMM (Transcript) New</option>    
                                <option value="16" data-tempid="16">Agriculture 2020-2024 Batch (Transcript) New Chnages</option>                   
                                <option value="17" data-tempid="17">Forestry Transcripts New Chnages</option>                   
                                <option value="18" data-tempid="18">Ph. D. Degree Certificate</option>                   
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="excel">Upload Excel:</label>
                        <div class="col-sm-8">
            ...
            <div class="col-lg-5" style="padding: 83px 1em;"> 
                <?php
                    ...
                    $excel_url_1=$path.$subdomain[0]."/backend/sample_excel/DEGREE_CERTIFICATE.xlsx";
                    $excel_url_2=$path.$subdomain[0]."/backend/sample_excel/pdc.xlsx";
                    $excel_url_3=$path.$subdomain[0]."/backend/sample_excel/TRANSCRIPT.xlsx";
                    $excel_url_4=$path.$subdomain[0]."/backend/sample_excel/SEM GRADE CARD OLD.xlsx";
                    $excel_url_5=$path.$subdomain[0]."/backend/sample_excel/Grde Card with supplementary.xlsx";
                    $excel_url_6=$path.$subdomain[0]."/backend/sample_excel/TRANSCRIPT 2019.xlsx";
                    $excel_url_7=$path.$subdomain[0]."/backend/sample_excel/2019 BATCH FORESTRY.xlsx";
                    $excel_url_8=$path.$subdomain[0]."/backend/sample_excel/grade_card_btech.xlsx";
                    $excel_url_20=$path.$subdomain[0]."/backend/sample_excel/grade_card_btech.xlsx";
                    $excel_url_9=$path.$subdomain[0]."/backend/sample_excel/SEM GRADE CARD.xlsx";
                    $excel_url_10=$path.$subdomain[0]."/backend/sample_excel/Grde Card with supplementary old.xlsx";
                    $excel_url_11=$path.$subdomain[0]."/backend/sample_excel/B.TECH CMM_Sample Excel.xlsx";
                    $excel_url_12=$path.$subdomain[0]."/backend/sample_excel/TRANSCRIPT 2020.xlsx";
                    $excel_url_13=$path.$subdomain[0]."/backend/sample_excel/Sample Transcripts for School of Vocational Education.xlsx";
                    $excel_url_14=$path.$subdomain[0]."/backend/sample_excel/DMMT_CMM.xlsx";
                    $excel_url_15=$path.$subdomain[0]."/backend/sample_excel/B.TECH CMM_Sample Excel new.xlsx";
                    $excel_url_16=$path.$subdomain[0]."/backend/sample_excel/TRANSCRIPT 2020 new.xlsx";
                    $excel_url_17=$path.$subdomain[0]."/backend/sample_excel/Forestry Transcripts new.xlsx";
                    $excel_url_18=$path.$subdomain[0]."/backend/sample_excel/sample_dc.xlsx";
                ...
                <span style="display:none;" id="excel_url_18"><b>Please Click <a href="<?php echo e($excel_url_18); ?>" download>HERE</a> To Download Sample Excel</b></span>
                    <span style="display:none;" id="excel_url_19"><b>Please Click <a href="<?php echo e($excel_url_1); ?>" download>HERE</a> To Download Sample Excel</b></span>
            </div>
        </div> 
        </div> 
...
function validateUpload() {
	...
	$.ajax({
		url:'<?= route('bestiu-certificate.validateexcel')?>',
	    type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,
...
// 	$.ajax({
// 		url:'<?= route('bestiu-certificate.uploadfile')?>',
// 	    type: "POST",
// 		dataType: "JSON",
// 		data:fd,
// 		processData: false,
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/bestiu/index.blade.php ENDPATH**/ ?>
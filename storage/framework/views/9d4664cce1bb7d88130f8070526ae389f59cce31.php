...
<div class="container">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><i class="fa fa fa-file-excel-o"></i>Generate KESSC
        ...
        <div class="row">
            ...
            <div class="form-group">
		  	...
		  	<div class="form-group"> 
		    	<div class="col-sm-offset-2 col-sm-10">
        			...
        			?>
		    		 <div align="center"><b>Please Click <a href="<?php echo e($excel_url); ?>" download>HERE</a> To Download Sample Excel</b></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="template_id" name="template_id">
                                ...
                                <option value="1" data-tempid="1">UG (7 Subjects)</option>
								<option value="3" data-tempid="3">UG (12 Subjects)</option>
                                <option value="2" data-tempid="2">PG</option>                
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="col-lg-5" style="padding: 83px 1em;"> 
                <?php
                    ...
                    $protocol = isset($_SERVER["HTTPS"]) ? 'https' : 'http';
                    $path = $protocol.'://'.$subdomain[0].'.'.$subdomain[1].'.com/';
                    $excel_url_1=$path.$subdomain[0]."/backend/sample_excel/KESSC Sample Excel.xlsx";
                    $excel_url_2=$path.$subdomain[0]."/backend/sample_excel/2_KESSC Sample Excel.xlsx";
                    $excel_url_3=$path.$subdomain[0]."/backend/sample_excel/12_KESSC Sample Excel.xlsx";
                ?>
...
function validateUpload() {
	...
	$.ajax({
		url:'<?= route('kessc-certificate.validateexcel')?>',
	    type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,
...
function clearTimeoutFunction(id,isGenerationCompleted,recordsToGenerate){
	 ...
	 if(isGenerationCompleted==1){
	 	/*var totalSeconds=Math.round((parseInt(recordsToGenerate)/100));
	 	//console.log(totalSeconds);
	 	if(totalSeconds==0){
	 	var	totalSeconds=1
	 	}
	 	var totalSeconds=parseInt(totalSeconds)*parseInt(3);

	 	//console.log(totalSeconds);

		var timeout=(parseInt(totalSeconds)*parseInt(1000))+parseInt(2000);	
		console.log(timeout);*/
		//$('#downloadLink').html('<b>Preparing for download link.</b>');
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/kessc/index.blade.php ENDPATH**/ ?>
...
<div class="container">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><i class="fa fa fa-file-excel-o"></i> UNEB
        ...
        <div class="row">
            <div class="col-lg-7"> <br />
                <form method="post" id="processExcelForm" class="form-horizontal" enctype="multipart/form-data" action="<?=route('uneb-certificate.uploadfile')?>">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="template_id" name="template_id">
                                <option value="0" data-tempid="0">Select Template</option>
                                 <option value="3" data-tempid="3">Examination For The Uganda Certificate of Education</option>
                                <option value="2" data-tempid="2">Uganda Certificate of Education</option>
...
function validateUpload() {
	...
	$.ajax({
		url:'<?= route('uneb-certificate.validateexcel')?>',
	  type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,
...
function uploadfile(){
	...
	$.ajax({
		url:'<?= route('uneb-certificate.uploadfile')?>',
	    type: "POST",
		dataType: "JSON",
		data:fd,
		processData: false,
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/admin/uneb/index.blade.php ENDPATH**/ ?>
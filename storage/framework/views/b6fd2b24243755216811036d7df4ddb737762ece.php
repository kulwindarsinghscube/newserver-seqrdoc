...
*/
        ...
        .card-body p {
            ...
            word-break: break-word; /* Updated for better support */
        }
        .mb-5 {
            margin-bottom: 1rem !important; /* Bootstrap 5 spacing */
        }
    ...
    <div class="container">
        <div class="row rows">
            ...
            <div class=" col-sm-12 col-md-6">
                ...
                <div class="upload-area" id="mintDataDiv" style="display:none ;    margin-top: 30px;">
                    <div class="col-lg-12 col-md-12 col-sm-12" >
                        <div class="card card-success  mint-details">
                            <div class="card-header">
                                <h3 class="card-title"><img src="https://demo.seqrdoc.com/backend/images/green_tick.png" style="height: 30px;width: 30px;" /> Proof Verification</h3>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="row mb-5">
                                    ...
                                    <div class="col-md-12 col-sm-6 col-xs-12">
                                        <p id="name_data" >&nbsp;&nbsp;&nbsp;&nbsp;<span id="bc_name"></span> </p>
                                ...
                                <div class="row mb-5">
                                    ...
                                    <div class="col-md-12 col-sm-6 col-xs-12">
                                         <p class="description">&nbsp;&nbsp;&nbsp;&nbsp;<span id="bc_description"></span></p>
                                ...
                                <div class="row mb-5">
                                    <div class="col-md-12 col-sm-6 col-xs-12 ">
                                         <p class="cardDownload"><i class="fa fa-angle-double-right"></i><strong>&nbsp;&nbsp;&nbsp;Download PDF:</strong></p>
                                    </div>
                                    <div class="col-md-12 col-sm-6 col-xs-12">
                                        <p class="cardDownload">
                                            &nbsp;&nbsp;&nbsp;<a href=""  id="bc_pdfUrl" target="_blank">Click here to download.</a>
                                        </p>
                        ...
                        <div class="card card-primary mint-details">
                            <div class="card-header">
                                <h3 class="card-title" id="showMint">Issuer's Information</h3>
                            </div>
                            <div class="card-body mint-details">
                                <p ><strong>Wallet Address:</strong><br><span id="bc_walletID"></span></p>
                                <p><strong>Polygon Transaction URL:</strong><br>
                                    <a href="" id="hrefpolygonTxnUrl" target="_blank" title="Click to check on Polygon Network"><b>View Transaction</b></a>
                                </p>
                                <p><strong>Smart Contract Address:</strong><br><span id="bc_contractAddress"></span></p>
                                <p><strong>Transaction Hash:</strong><br><span id="bc_txnHash"></span></p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        function uploadFile(file) {
            ...
            if (fileValidate(fileType, fileSize)) {
                ...
                async function start() {
                    ...
                    if(url=="verification.anu.edu.in"){
                        subdomain[0]="anu"
                    }

                    $.ajax({
                        url: 'https://'+subdomain[0]+'.seqrdoc.com/api/callPdfDataV1',
                        type: 'POST',
                        dataType: 'json',
                        data: formData,
                        processData: false,
                        ...
                        success: function (response) {
                         ...
                         //   console.log(response.response.pinataIpfsHash);
                            ...
                            $('.drop-zoon__paragraph').css('display', 'none');
                             $('#metaContainer').empty();
                            $.ajax({
                                url: 'https://'+subdomain[0]+'.seqrdoc.com/api/verifyPdf',
                                type: 'POST',
                                dataType: 'json',
                                data: formDataNew,
                                processData: false,
                                ...
                                success: function (data, textStatus, xhr) {
                                   ...
                                   // console.log(data);
                                    if (data.success == true) {
                                        ...
                                        if (!data.pdfUrl.startsWith("https")) {
                                            // Add 'https://' prefix if not already present
                                            var pdfUrl = "https://ipfs.io/ipfs/" + data.pdfUrl.substring(7);
                                        } else {
                                        ...
                                        for (let i = 0; i < dLen; i++) {
                                            ...
                                            if(metadata[i]['key']!=undefined){
                                                var data_val=metadata[i]['key'];
                                            }else{
                                                var data_val=metadata[i]['trait_type'];
                                            }
                                            ...
                                            $('#metaContainer').append('<div class="row mb-5">'+
                                                '<div class="col-md-12 col-sm-6 col-xs-12 ">'+
                                                     '<p class="metadata_'+dLen+'"><i class="fa fa-angle-double-right"></i> <strong>'+data_val+' : </strong></p>'+
                                                '</div>'+
                                                '<div class="col-md-12 col-sm-6 col-xs-12">'+
                                                    '<p class="metadata_'+dLen+'">&nbsp;&nbsp;&nbsp;&nbsp;' + metadata[i]['value'] +
                                                    '</p>'+
                                                '</div>'+
                                            '</div>');
...
</html><?php /**PATH C:\inetpub\vhosts\seqrdoc.com\httpdocs\demo\resources\views/bverify_new.blade.php ENDPATH**/ ?>